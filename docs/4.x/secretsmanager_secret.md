...
`aws.secretsmanager_secret.withDescription` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withForceOverwriteReplicaSecret` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withKmsKeyId` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withName` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withNamePrefix` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withPolicy` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withRecoveryWindowInDays` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withReplica` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withReplicaMixin` constructs a mixin object that can be merged into the `secretsmanager_secret`
Terraform resource block to set or update the replica field.
...
`aws.secretsmanager_secret.withRotationLambdaArn` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withRotationRules` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withRotationRulesMixin` constructs a mixin object that can be merged into the `secretsmanager_secret`
Terraform resource block to set or update the rotation_rules field.
...
`aws.secretsmanager_secret.withTags` constructs a mixin object that can be merged into the `secretsmanager_secret`
...
`aws.secretsmanager_secret.withTagsAll` constructs a mixin object that can be merged into the `secretsmanager_secret`
