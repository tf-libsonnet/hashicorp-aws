...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_event_subscription.timeouts.new](#fn-dms_event_subscriptiontimeoutsnew) constructor.
...
Unlike [aws.dms_event_subscription.new](#fn-dms_event_subscriptionnew), this function will not inject the `resource`
