...
`aws.ec2_client_vpn_authorization_rule.withAccessGroupId` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`
...
`aws.ec2_client_vpn_authorization_rule.withAuthorizeAllGroups` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`
...
`aws.ec2_client_vpn_authorization_rule.withClientVpnEndpointId` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`
...
`aws.ec2_client_vpn_authorization_rule.withDescription` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`
...
`aws.ec2_client_vpn_authorization_rule.withTargetNetworkCidr` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`
...
`aws.ec2_client_vpn_authorization_rule.withTimeouts` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`
...
`aws.ec2_client_vpn_authorization_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`
Terraform resource block to set or update the timeouts field.
