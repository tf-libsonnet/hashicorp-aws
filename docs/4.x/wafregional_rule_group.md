...
`aws.wafregional_rule_group.withActivatedRule` constructs a mixin object that can be merged into the `wafregional_rule_group`
...
`aws.wafregional_rule_group.withActivatedRuleMixin` constructs a mixin object that can be merged into the `wafregional_rule_group`
Terraform resource block to set or update the activated_rule field.
...
`aws.wafregional_rule_group.withMetricName` constructs a mixin object that can be merged into the `wafregional_rule_group`
...
`aws.wafregional_rule_group.withName` constructs a mixin object that can be merged into the `wafregional_rule_group`
...
`aws.wafregional_rule_group.withTags` constructs a mixin object that can be merged into the `wafregional_rule_group`
...
`aws.wafregional_rule_group.withTagsAll` constructs a mixin object that can be merged into the `wafregional_rule_group`
