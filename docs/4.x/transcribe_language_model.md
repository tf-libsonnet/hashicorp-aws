...
`aws.transcribe_language_model.withBaseModelName` constructs a mixin object that can be merged into the `transcribe_language_model`
...
`aws.transcribe_language_model.withInputDataConfig` constructs a mixin object that can be merged into the `transcribe_language_model`
...
`aws.transcribe_language_model.withInputDataConfigMixin` constructs a mixin object that can be merged into the `transcribe_language_model`
Terraform resource block to set or update the input_data_config field.
...
`aws.transcribe_language_model.withLanguageCode` constructs a mixin object that can be merged into the `transcribe_language_model`
...
`aws.transcribe_language_model.withModelName` constructs a mixin object that can be merged into the `transcribe_language_model`
...
`aws.transcribe_language_model.withTags` constructs a mixin object that can be merged into the `transcribe_language_model`
...
`aws.transcribe_language_model.withTagsAll` constructs a mixin object that can be merged into the `transcribe_language_model`
...
`aws.transcribe_language_model.withTimeouts` constructs a mixin object that can be merged into the `transcribe_language_model`
...
`aws.transcribe_language_model.withTimeoutsMixin` constructs a mixin object that can be merged into the `transcribe_language_model`
Terraform resource block to set or update the timeouts field.
