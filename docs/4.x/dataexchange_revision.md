...
`aws.dataexchange_revision.withComment` constructs a mixin object that can be merged into the `dataexchange_revision`
...
`aws.dataexchange_revision.withDataSetId` constructs a mixin object that can be merged into the `dataexchange_revision`
...
`aws.dataexchange_revision.withTags` constructs a mixin object that can be merged into the `dataexchange_revision`
...
`aws.dataexchange_revision.withTagsAll` constructs a mixin object that can be merged into the `dataexchange_revision`
