...
`aws.dms_endpoint.withCertificateArn` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withDatabaseName` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withElasticsearchSettings` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withElasticsearchSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`
Terraform resource block to set or update the elasticsearch_settings field.
...
`aws.dms_endpoint.withEndpointId` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withEndpointType` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withEngineName` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withExtraConnectionAttributes` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withKafkaSettings` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withKafkaSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`
Terraform resource block to set or update the kafka_settings field.
...
`aws.dms_endpoint.withKinesisSettings` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withKinesisSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`
Terraform resource block to set or update the kinesis_settings field.
...
`aws.dms_endpoint.withKmsKeyArn` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withMongodbSettings` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withMongodbSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`
Terraform resource block to set or update the mongodb_settings field.
...
`aws.dms_endpoint.withPassword` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withPort` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withRedisSettings` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withRedisSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`
Terraform resource block to set or update the redis_settings field.
...
`aws.dms_endpoint.withRedshiftSettings` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withRedshiftSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`
Terraform resource block to set or update the redshift_settings field.
...
`aws.dms_endpoint.withS3Settings` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withS3SettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`
Terraform resource block to set or update the s3_settings field.
...
`aws.dms_endpoint.withSecretsManagerAccessRoleArn` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withSecretsManagerArn` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withServerName` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withServiceAccessRole` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withSslMode` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withTags` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withTagsAll` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withTimeouts` constructs a mixin object that can be merged into the `dms_endpoint`
...
`aws.dms_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `dms_endpoint`
Terraform resource block to set or update the timeouts field.
...
`aws.dms_endpoint.withUsername` constructs a mixin object that can be merged into the `dms_endpoint`
