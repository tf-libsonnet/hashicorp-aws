...
`aws.lightsail_container_service.withIsDisabled` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withName` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withPower` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withPrivateRegistryAccess` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withPrivateRegistryAccessMixin` constructs a mixin object that can be merged into the `lightsail_container_service`
Terraform resource block to set or update the private_registry_access field.
...
`aws.lightsail_container_service.withPublicDomainNames` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withPublicDomainNamesMixin` constructs a mixin object that can be merged into the `lightsail_container_service`
Terraform resource block to set or update the public_domain_names field.
...
`aws.lightsail_container_service.withScale` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withTags` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withTagsAll` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withTimeouts` constructs a mixin object that can be merged into the `lightsail_container_service`
...
`aws.lightsail_container_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `lightsail_container_service`
Terraform resource block to set or update the timeouts field.
