...
`aws.config_remediation_configuration.withAutomatic` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withConfigRuleName` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withExecutionControls` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withExecutionControlsMixin` constructs a mixin object that can be merged into the `config_remediation_configuration`
Terraform resource block to set or update the execution_controls field.
...
`aws.config_remediation_configuration.withMaximumAutomaticAttempts` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withParameter` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withParameterMixin` constructs a mixin object that can be merged into the `config_remediation_configuration`
Terraform resource block to set or update the parameter field.
...
`aws.config_remediation_configuration.withResourceType` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withRetryAttemptSeconds` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withTargetId` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withTargetType` constructs a mixin object that can be merged into the `config_remediation_configuration`
...
`aws.config_remediation_configuration.withTargetVersion` constructs a mixin object that can be merged into the `config_remediation_configuration`
