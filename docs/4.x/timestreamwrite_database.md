...
`aws.timestreamwrite_database.withDatabaseName` constructs a mixin object that can be merged into the `timestreamwrite_database`
...
`aws.timestreamwrite_database.withKmsKeyId` constructs a mixin object that can be merged into the `timestreamwrite_database`
...
`aws.timestreamwrite_database.withTags` constructs a mixin object that can be merged into the `timestreamwrite_database`
...
`aws.timestreamwrite_database.withTagsAll` constructs a mixin object that can be merged into the `timestreamwrite_database`
