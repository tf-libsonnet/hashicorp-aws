...
**Args**:
  ...
  - `user_name` (`string`): 
  - `home_directory_mappings` (`list[obj]`):  When `null`, the `home_directory_mappings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.transfer_user.home_directory_mappings.new](#fn-transfer_userhome_directory_mappingsnew) constructor.
  - `posix_profile` (`list[obj]`):  When `null`, the `posix_profile` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.transfer_user.posix_profile.new](#fn-transfer_userposix_profilenew) constructor.
...
Unlike [aws.transfer_user.new](#fn-transfer_usernew), this function will not inject the `resource`
