...
`aws.sagemaker_model.withContainer` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withContainerMixin` constructs a mixin object that can be merged into the `sagemaker_model`
Terraform resource block to set or update the container field.
...
`aws.sagemaker_model.withEnableNetworkIsolation` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withExecutionRoleArn` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withInferenceExecutionConfig` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withInferenceExecutionConfigMixin` constructs a mixin object that can be merged into the `sagemaker_model`
Terraform resource block to set or update the inference_execution_config field.
...
`aws.sagemaker_model.withName` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withPrimaryContainer` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withPrimaryContainerMixin` constructs a mixin object that can be merged into the `sagemaker_model`
Terraform resource block to set or update the primary_container field.
...
`aws.sagemaker_model.withTags` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withVpcConfig` constructs a mixin object that can be merged into the `sagemaker_model`
...
`aws.sagemaker_model.withVpcConfigMixin` constructs a mixin object that can be merged into the `sagemaker_model`
Terraform resource block to set or update the vpc_config field.
