...
`aws.s3_bucket_website_configuration.withBucket` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
...
`aws.s3_bucket_website_configuration.withErrorDocument` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
...
`aws.s3_bucket_website_configuration.withErrorDocumentMixin` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
Terraform resource block to set or update the error_document field.
...
`aws.s3_bucket_website_configuration.withExpectedBucketOwner` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
...
`aws.s3_bucket_website_configuration.withIndexDocument` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
...
`aws.s3_bucket_website_configuration.withIndexDocumentMixin` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
Terraform resource block to set or update the index_document field.
...
`aws.s3_bucket_website_configuration.withRedirectAllRequestsTo` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
...
`aws.s3_bucket_website_configuration.withRedirectAllRequestsToMixin` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
Terraform resource block to set or update the redirect_all_requests_to field.
...
`aws.s3_bucket_website_configuration.withRoutingRule` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
...
`aws.s3_bucket_website_configuration.withRoutingRuleMixin` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
Terraform resource block to set or update the routing_rule field.
...
`aws.s3_bucket_website_configuration.withRoutingRules` constructs a mixin object that can be merged into the `s3_bucket_website_configuration`
