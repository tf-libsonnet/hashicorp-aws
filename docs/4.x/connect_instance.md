...
`aws.connect_instance.withAutoResolveBestVoicesEnabled` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withContactFlowLogsEnabled` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withContactLensEnabled` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withDirectoryId` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withEarlyMediaEnabled` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withIdentityManagementType` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withInboundCallsEnabled` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withMultiPartyConferenceEnabled` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withOutboundCallsEnabled` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withTimeouts` constructs a mixin object that can be merged into the `connect_instance`
...
`aws.connect_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `connect_instance`
Terraform resource block to set or update the timeouts field.
