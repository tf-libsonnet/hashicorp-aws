...
`aws.ecs_cluster.withCapacityProviders` constructs a mixin object that can be merged into the `ecs_cluster`
...
`aws.ecs_cluster.withConfiguration` constructs a mixin object that can be merged into the `ecs_cluster`
...
`aws.ecs_cluster.withConfigurationMixin` constructs a mixin object that can be merged into the `ecs_cluster`
Terraform resource block to set or update the configuration field.
...
`aws.ecs_cluster.withDefaultCapacityProviderStrategy` constructs a mixin object that can be merged into the `ecs_cluster`
...
`aws.ecs_cluster.withDefaultCapacityProviderStrategyMixin` constructs a mixin object that can be merged into the `ecs_cluster`
Terraform resource block to set or update the default_capacity_provider_strategy field.
...
`aws.ecs_cluster.withName` constructs a mixin object that can be merged into the `ecs_cluster`
...
`aws.ecs_cluster.withServiceConnectDefaults` constructs a mixin object that can be merged into the `ecs_cluster`
...
`aws.ecs_cluster.withServiceConnectDefaultsMixin` constructs a mixin object that can be merged into the `ecs_cluster`
Terraform resource block to set or update the service_connect_defaults field.
...
`aws.ecs_cluster.withSetting` constructs a mixin object that can be merged into the `ecs_cluster`
...
`aws.ecs_cluster.withSettingMixin` constructs a mixin object that can be merged into the `ecs_cluster`
Terraform resource block to set or update the setting field.
...
`aws.ecs_cluster.withTags` constructs a mixin object that can be merged into the `ecs_cluster`
...
`aws.ecs_cluster.withTagsAll` constructs a mixin object that can be merged into the `ecs_cluster`
