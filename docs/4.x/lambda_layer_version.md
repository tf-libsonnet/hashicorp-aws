...
`aws.lambda_layer_version.withCompatibleArchitectures` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withCompatibleRuntimes` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withDescription` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withFilename` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withLicenseInfo` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withS3Bucket` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withS3Key` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withS3ObjectVersion` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withSkipDestroy` constructs a mixin object that can be merged into the `lambda_layer_version`
...
`aws.lambda_layer_version.withSourceCodeHash` constructs a mixin object that can be merged into the `lambda_layer_version`
