...
Unlike [aws.api_gateway_vpc_link.new](#fn-api_gateway_vpc_linknew), this function will not inject the `resource`
...
`aws.list.withTargetArns` constructs a mixin object that can be merged into the `list`
