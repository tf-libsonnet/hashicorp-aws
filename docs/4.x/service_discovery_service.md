...
`aws.service_discovery_service.withDescription` constructs a mixin object that can be merged into the `service_discovery_service`
...
`aws.service_discovery_service.withDnsConfig` constructs a mixin object that can be merged into the `service_discovery_service`
...
`aws.service_discovery_service.withDnsConfigMixin` constructs a mixin object that can be merged into the `service_discovery_service`
Terraform resource block to set or update the dns_config field.
...
`aws.service_discovery_service.withForceDestroy` constructs a mixin object that can be merged into the `service_discovery_service`
...
`aws.service_discovery_service.withHealthCheckConfig` constructs a mixin object that can be merged into the `service_discovery_service`
...
`aws.service_discovery_service.withHealthCheckConfigMixin` constructs a mixin object that can be merged into the `service_discovery_service`
Terraform resource block to set or update the health_check_config field.
...
`aws.service_discovery_service.withHealthCheckCustomConfig` constructs a mixin object that can be merged into the `service_discovery_service`
...
`aws.service_discovery_service.withHealthCheckCustomConfigMixin` constructs a mixin object that can be merged into the `service_discovery_service`
Terraform resource block to set or update the health_check_custom_config field.
