...
`aws.lambda_event_source_mapping.withAmazonManagedKafkaEventSourceConfig` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withAmazonManagedKafkaEventSourceConfigMixin` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
Terraform resource block to set or update the amazon_managed_kafka_event_source_config field.
...
`aws.lambda_event_source_mapping.withBatchSize` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withBisectBatchOnFunctionError` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withDestinationConfig` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withDestinationConfigMixin` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
Terraform resource block to set or update the destination_config field.
...
`aws.lambda_event_source_mapping.withEnabled` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withEventSourceArn` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withFilterCriteria` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withFilterCriteriaMixin` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
Terraform resource block to set or update the filter_criteria field.
...
`aws.lambda_event_source_mapping.withFunctionName` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withFunctionResponseTypes` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withMaximumBatchingWindowInSeconds` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withMaximumRecordAgeInSeconds` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withMaximumRetryAttempts` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withParallelizationFactor` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withQueues` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withSelfManagedEventSource` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withSelfManagedEventSourceMixin` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
Terraform resource block to set or update the self_managed_event_source field.
...
`aws.lambda_event_source_mapping.withSelfManagedKafkaEventSourceConfig` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withSelfManagedKafkaEventSourceConfigMixin` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
Terraform resource block to set or update the self_managed_kafka_event_source_config field.
...
`aws.lambda_event_source_mapping.withSourceAccessConfiguration` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withSourceAccessConfigurationMixin` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
Terraform resource block to set or update the source_access_configuration field.
...
`aws.lambda_event_source_mapping.withStartingPosition` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withStartingPositionTimestamp` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withTopics` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
...
`aws.lambda_event_source_mapping.withTumblingWindowInSeconds` constructs a mixin object that can be merged into the `lambda_event_source_mapping`
