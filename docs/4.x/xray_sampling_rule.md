...
`aws.xray_sampling_rule.withAttributes` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withFixedRate` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withHost` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withHttpMethod` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withPriority` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withReservoirSize` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withResourceArn` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withRuleName` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withServiceName` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withServiceType` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withTags` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withTagsAll` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withUrlPath` constructs a mixin object that can be merged into the `xray_sampling_rule`
...
`aws.xray_sampling_rule.withVersion` constructs a mixin object that can be merged into the `xray_sampling_rule`
