...
`aws.rolesanywhere_trust_anchor.withEnabled` constructs a mixin object that can be merged into the `rolesanywhere_trust_anchor`
...
`aws.rolesanywhere_trust_anchor.withName` constructs a mixin object that can be merged into the `rolesanywhere_trust_anchor`
...
`aws.rolesanywhere_trust_anchor.withSource` constructs a mixin object that can be merged into the `rolesanywhere_trust_anchor`
...
`aws.rolesanywhere_trust_anchor.withSourceMixin` constructs a mixin object that can be merged into the `rolesanywhere_trust_anchor`
Terraform resource block to set or update the source field.
...
`aws.rolesanywhere_trust_anchor.withTags` constructs a mixin object that can be merged into the `rolesanywhere_trust_anchor`
...
`aws.rolesanywhere_trust_anchor.withTagsAll` constructs a mixin object that can be merged into the `rolesanywhere_trust_anchor`
