...
`aws.cloudsearch_domain.withEndpointOptions` constructs a mixin object that can be merged into the `cloudsearch_domain`
...
`aws.cloudsearch_domain.withEndpointOptionsMixin` constructs a mixin object that can be merged into the `cloudsearch_domain`
Terraform resource block to set or update the endpoint_options field.
...
`aws.cloudsearch_domain.withIndexField` constructs a mixin object that can be merged into the `cloudsearch_domain`
...
`aws.cloudsearch_domain.withIndexFieldMixin` constructs a mixin object that can be merged into the `cloudsearch_domain`
Terraform resource block to set or update the index_field field.
...
`aws.cloudsearch_domain.withMultiAz` constructs a mixin object that can be merged into the `cloudsearch_domain`
...
`aws.cloudsearch_domain.withName` constructs a mixin object that can be merged into the `cloudsearch_domain`
...
`aws.cloudsearch_domain.withScalingParameters` constructs a mixin object that can be merged into the `cloudsearch_domain`
...
`aws.cloudsearch_domain.withScalingParametersMixin` constructs a mixin object that can be merged into the `cloudsearch_domain`
Terraform resource block to set or update the scaling_parameters field.
...
`aws.cloudsearch_domain.withTimeouts` constructs a mixin object that can be merged into the `cloudsearch_domain`
...
`aws.cloudsearch_domain.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudsearch_domain`
Terraform resource block to set or update the timeouts field.
