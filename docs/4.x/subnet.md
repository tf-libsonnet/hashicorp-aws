...
`aws.subnet.withAssignIpv6AddressOnCreation` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withCustomerOwnedIpv4Pool` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withEnableDns64` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withEnableResourceNameDnsARecordOnLaunch` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withEnableResourceNameDnsAaaaRecordOnLaunch` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withIpv6Native` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withMapCustomerOwnedIpOnLaunch` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withMapPublicIpOnLaunch` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withOutpostArn` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withPrivateDnsHostnameTypeOnLaunch` constructs a mixin object that can be merged into the `subnet`
...
`aws.subnet.withTagsAll` constructs a mixin object that can be merged into the `subnet`
