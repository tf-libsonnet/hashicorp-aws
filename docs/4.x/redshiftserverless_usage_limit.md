...
`aws.redshiftserverless_usage_limit.withAmount` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`
...
`aws.redshiftserverless_usage_limit.withBreachAction` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`
...
`aws.redshiftserverless_usage_limit.withPeriod` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`
...
`aws.redshiftserverless_usage_limit.withResourceArn` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`
...
`aws.redshiftserverless_usage_limit.withUsageType` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`
