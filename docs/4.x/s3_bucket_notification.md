...
`aws.s3_bucket_notification.withBucket` constructs a mixin object that can be merged into the `s3_bucket_notification`
...
`aws.s3_bucket_notification.withEventbridge` constructs a mixin object that can be merged into the `s3_bucket_notification`
...
`aws.s3_bucket_notification.withLambdaFunction` constructs a mixin object that can be merged into the `s3_bucket_notification`
...
`aws.s3_bucket_notification.withLambdaFunctionMixin` constructs a mixin object that can be merged into the `s3_bucket_notification`
Terraform resource block to set or update the lambda_function field.
...
`aws.s3_bucket_notification.withQueue` constructs a mixin object that can be merged into the `s3_bucket_notification`
...
`aws.s3_bucket_notification.withQueueMixin` constructs a mixin object that can be merged into the `s3_bucket_notification`
Terraform resource block to set or update the queue field.
...
`aws.s3_bucket_notification.withTopic` constructs a mixin object that can be merged into the `s3_bucket_notification`
...
`aws.s3_bucket_notification.withTopicMixin` constructs a mixin object that can be merged into the `s3_bucket_notification`
Terraform resource block to set or update the topic field.
