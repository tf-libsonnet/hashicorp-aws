...
`aws.opsworks_application.withAppSource` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withAppSourceMixin` constructs a mixin object that can be merged into the `opsworks_application`
Terraform resource block to set or update the app_source field.
...
`aws.opsworks_application.withAutoBundleOnDeploy` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withAwsFlowRubySettings` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withDataSourceArn` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withDataSourceDatabaseName` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withDataSourceType` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withDescription` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withDocumentRoot` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withDomains` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withEnableSsl` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withEnvironment` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withEnvironmentMixin` constructs a mixin object that can be merged into the `opsworks_application`
Terraform resource block to set or update the environment field.
...
`aws.opsworks_application.withName` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withRailsEnv` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withShortName` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withSslConfiguration` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withSslConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_application`
Terraform resource block to set or update the ssl_configuration field.
...
`aws.opsworks_application.withStackId` constructs a mixin object that can be merged into the `opsworks_application`
...
`aws.opsworks_application.withType` constructs a mixin object that can be merged into the `opsworks_application`
