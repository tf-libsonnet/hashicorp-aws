...
`aws.apigatewayv2_route.withApiId` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withApiKeyRequired` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withAuthorizationScopes` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withAuthorizationType` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withAuthorizerId` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withModelSelectionExpression` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withOperationName` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withRequestModels` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withRequestParameter` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withRequestParameterMixin` constructs a mixin object that can be merged into the `apigatewayv2_route`
Terraform resource block to set or update the request_parameter field.
...
`aws.apigatewayv2_route.withRouteKey` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withRouteResponseSelectionExpression` constructs a mixin object that can be merged into the `apigatewayv2_route`
...
`aws.apigatewayv2_route.withTarget` constructs a mixin object that can be merged into the `apigatewayv2_route`
