...
`aws.pinpoint_apns_channel.withApplicationId` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
...
`aws.pinpoint_apns_channel.withBundleId` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
...
`aws.pinpoint_apns_channel.withCertificate` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
...
`aws.pinpoint_apns_channel.withDefaultAuthenticationMethod` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
...
`aws.pinpoint_apns_channel.withEnabled` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
...
`aws.pinpoint_apns_channel.withPrivateKey` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
...
`aws.pinpoint_apns_channel.withTeamId` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
...
`aws.pinpoint_apns_channel.withTokenKey` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
...
`aws.pinpoint_apns_channel.withTokenKeyId` constructs a mixin object that can be merged into the `pinpoint_apns_channel`
