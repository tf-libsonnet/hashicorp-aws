...
`aws.route53_zone.withComment` constructs a mixin object that can be merged into the `route53_zone`
...
`aws.route53_zone.withDelegationSetId` constructs a mixin object that can be merged into the `route53_zone`
...
`aws.route53_zone.withForceDestroy` constructs a mixin object that can be merged into the `route53_zone`
...
`aws.route53_zone.withTagsAll` constructs a mixin object that can be merged into the `route53_zone`
...
`aws.route53_zone.withVpc` constructs a mixin object that can be merged into the `route53_zone`
...
`aws.route53_zone.withVpcMixin` constructs a mixin object that can be merged into the `route53_zone`
Terraform resource block to set or update the vpc field.
