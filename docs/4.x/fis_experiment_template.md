...
`aws.fis_experiment_template.withAction` constructs a mixin object that can be merged into the `fis_experiment_template`
...
`aws.fis_experiment_template.withActionMixin` constructs a mixin object that can be merged into the `fis_experiment_template`
Terraform resource block to set or update the action field.
...
`aws.fis_experiment_template.withDescription` constructs a mixin object that can be merged into the `fis_experiment_template`
...
`aws.fis_experiment_template.withRoleArn` constructs a mixin object that can be merged into the `fis_experiment_template`
...
`aws.fis_experiment_template.withStopCondition` constructs a mixin object that can be merged into the `fis_experiment_template`
...
`aws.fis_experiment_template.withStopConditionMixin` constructs a mixin object that can be merged into the `fis_experiment_template`
Terraform resource block to set or update the stop_condition field.
...
`aws.fis_experiment_template.withTags` constructs a mixin object that can be merged into the `fis_experiment_template`
...
`aws.fis_experiment_template.withTagsAll` constructs a mixin object that can be merged into the `fis_experiment_template`
...
`aws.fis_experiment_template.withTarget` constructs a mixin object that can be merged into the `fis_experiment_template`
...
`aws.fis_experiment_template.withTargetMixin` constructs a mixin object that can be merged into the `fis_experiment_template`
Terraform resource block to set or update the target field.
...
`aws.fis_experiment_template.withTimeouts` constructs a mixin object that can be merged into the `fis_experiment_template`
...
`aws.fis_experiment_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `fis_experiment_template`
Terraform resource block to set or update the timeouts field.
