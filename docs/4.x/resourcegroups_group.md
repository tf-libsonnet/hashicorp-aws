...
`aws.resourcegroups_group.withConfiguration` constructs a mixin object that can be merged into the `resourcegroups_group`
...
`aws.resourcegroups_group.withConfigurationMixin` constructs a mixin object that can be merged into the `resourcegroups_group`
Terraform resource block to set or update the configuration field.
...
`aws.resourcegroups_group.withDescription` constructs a mixin object that can be merged into the `resourcegroups_group`
...
`aws.resourcegroups_group.withName` constructs a mixin object that can be merged into the `resourcegroups_group`
...
`aws.resourcegroups_group.withResourceQuery` constructs a mixin object that can be merged into the `resourcegroups_group`
...
`aws.resourcegroups_group.withResourceQueryMixin` constructs a mixin object that can be merged into the `resourcegroups_group`
Terraform resource block to set or update the resource_query field.
...
`aws.resourcegroups_group.withTags` constructs a mixin object that can be merged into the `resourcegroups_group`
...
`aws.resourcegroups_group.withTagsAll` constructs a mixin object that can be merged into the `resourcegroups_group`
...
`aws.resourcegroups_group.withTimeouts` constructs a mixin object that can be merged into the `resourcegroups_group`
...
`aws.resourcegroups_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `resourcegroups_group`
Terraform resource block to set or update the timeouts field.
