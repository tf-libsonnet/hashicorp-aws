...
`aws.cloudwatch_metric_alarm.withActionsEnabled` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withAlarmActions` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withAlarmDescription` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withAlarmName` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withComparisonOperator` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withDatapointsToAlarm` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withDimensions` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withEvaluateLowSampleCountPercentiles` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withEvaluationPeriods` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withExtendedStatistic` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withInsufficientDataActions` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withMetricName` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withMetricQuery` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withMetricQueryMixin` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
Terraform resource block to set or update the metric_query field.
...
`aws.cloudwatch_metric_alarm.withNamespace` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withOkActions` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withPeriod` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withStatistic` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withTags` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withTagsAll` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withThreshold` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withThresholdMetricId` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withTreatMissingData` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
...
`aws.cloudwatch_metric_alarm.withUnit` constructs a mixin object that can be merged into the `cloudwatch_metric_alarm`
