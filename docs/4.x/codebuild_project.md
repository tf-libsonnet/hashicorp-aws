...
`aws.codebuild_project.withArtifacts` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withArtifactsMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the artifacts field.
...
`aws.codebuild_project.withBadgeEnabled` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withBuildBatchConfig` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withBuildBatchConfigMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the build_batch_config field.
...
`aws.codebuild_project.withBuildTimeout` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withCache` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withCacheMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the cache field.
...
`aws.codebuild_project.withConcurrentBuildLimit` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withDescription` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withEncryptionKey` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withEnvironment` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withEnvironmentMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the environment field.
...
`aws.codebuild_project.withFileSystemLocations` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withFileSystemLocationsMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the file_system_locations field.
...
`aws.codebuild_project.withLogsConfig` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withLogsConfigMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the logs_config field.
...
`aws.codebuild_project.withName` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withProjectVisibility` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withQueuedTimeout` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withResourceAccessRole` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withSecondaryArtifacts` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withSecondaryArtifactsMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the secondary_artifacts field.
...
`aws.codebuild_project.withSecondarySourceVersion` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withSecondarySourceVersionMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the secondary_source_version field.
...
`aws.codebuild_project.withSecondarySources` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withSecondarySourcesMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the secondary_sources field.
...
`aws.codebuild_project.withServiceRole` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withSource` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withSourceMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the source field.
...
`aws.codebuild_project.withSourceVersion` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withTags` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withTagsAll` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withVpcConfig` constructs a mixin object that can be merged into the `codebuild_project`
...
`aws.codebuild_project.withVpcConfigMixin` constructs a mixin object that can be merged into the `codebuild_project`
Terraform resource block to set or update the vpc_config field.
