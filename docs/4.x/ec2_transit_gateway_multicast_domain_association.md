...
Unlike [aws.ec2_transit_gateway_multicast_domain_association.new](#fn-ec2_transit_gateway_multicast_domain_associationnew), this function will not inject the `resource`
