---
permalink: /ec2_transit_gateway_multicast_domain_association/
---

# ec2_transit_gateway_multicast_domain_association

`ec2_transit_gateway_multicast_domain_association` represents the `aws_ec2_transit_gateway_multicast_domain_association` Terraform resource.
...
Unlike [aws.ec2_transit_gateway_multicast_domain_association.new](#fn-ec2transitgatewaymulticastdomainassociationnew), this function will not inject the `resource`
...
`aws.ec2_transit_gateway_multicast_domain_association.withSubnetId` constructs a mixin object that can be merged into the `ec2_transit_gateway_multicast_domain_association`
...
`aws.ec2_transit_gateway_multicast_domain_association.withTimeouts` constructs a mixin object that can be merged into the `ec2_transit_gateway_multicast_domain_association`
...
`aws.ec2_transit_gateway_multicast_domain_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_transit_gateway_multicast_domain_association`
Terraform resource block to set or update the timeouts field.

This function will merge the passed in value to the existing map. If you wish
to instead replace the entire map with the passed in `value`, use the [aws.ec2_transit_gateway_multicast_domain_association.withTimeouts](TODO)
function.
...
`aws.ec2_transit_gateway_multicast_domain_association.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_multicast_domain_association`
...
`aws.ec2_transit_gateway_multicast_domain_association.withTransitGatewayMulticastDomainId` constructs a mixin object that can be merged into the `ec2_transit_gateway_multicast_domain_association`
