...
`aws.config_configuration_recorder.withName` constructs a mixin object that can be merged into the `config_configuration_recorder`
...
`aws.config_configuration_recorder.withRecordingGroup` constructs a mixin object that can be merged into the `config_configuration_recorder`
...
`aws.config_configuration_recorder.withRecordingGroupMixin` constructs a mixin object that can be merged into the `config_configuration_recorder`
Terraform resource block to set or update the recording_group field.
...
`aws.config_configuration_recorder.withRoleArn` constructs a mixin object that can be merged into the `config_configuration_recorder`
