...
`aws.guardduty_organization_configuration.withAutoEnable` constructs a mixin object that can be merged into the `guardduty_organization_configuration`
...
`aws.guardduty_organization_configuration.withDatasources` constructs a mixin object that can be merged into the `guardduty_organization_configuration`
...
`aws.guardduty_organization_configuration.withDatasourcesMixin` constructs a mixin object that can be merged into the `guardduty_organization_configuration`
Terraform resource block to set or update the datasources field.
...
`aws.guardduty_organization_configuration.withDetectorId` constructs a mixin object that can be merged into the `guardduty_organization_configuration`
