...
`aws.fsx_openzfs_volume.withCopyTagsToSnapshots` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withDataCompressionType` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withName` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withNfsExports` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withNfsExportsMixin` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
Terraform resource block to set or update the nfs_exports field.
...
`aws.fsx_openzfs_volume.withOriginSnapshot` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withOriginSnapshotMixin` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
Terraform resource block to set or update the origin_snapshot field.
...
`aws.fsx_openzfs_volume.withParentVolumeId` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withReadOnly` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withRecordSizeKib` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withStorageCapacityQuotaGib` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withStorageCapacityReservationGib` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withTags` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withTagsAll` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withTimeouts` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withTimeoutsMixin` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
Terraform resource block to set or update the timeouts field.
...
`aws.fsx_openzfs_volume.withUserAndGroupQuotas` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
...
`aws.fsx_openzfs_volume.withUserAndGroupQuotasMixin` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
Terraform resource block to set or update the user_and_group_quotas field.
...
`aws.fsx_openzfs_volume.withVolumeType` constructs a mixin object that can be merged into the `fsx_openzfs_volume`
