...
`aws.s3_access_point.withAccountId` constructs a mixin object that can be merged into the `s3_access_point`
...
`aws.s3_access_point.withBucket` constructs a mixin object that can be merged into the `s3_access_point`
...
`aws.s3_access_point.withName` constructs a mixin object that can be merged into the `s3_access_point`
...
`aws.s3_access_point.withPolicy` constructs a mixin object that can be merged into the `s3_access_point`
...
`aws.s3_access_point.withPublicAccessBlockConfiguration` constructs a mixin object that can be merged into the `s3_access_point`
...
`aws.s3_access_point.withPublicAccessBlockConfigurationMixin` constructs a mixin object that can be merged into the `s3_access_point`
Terraform resource block to set or update the public_access_block_configuration field.
...
`aws.s3_access_point.withVpcConfiguration` constructs a mixin object that can be merged into the `s3_access_point`
...
`aws.s3_access_point.withVpcConfigurationMixin` constructs a mixin object that can be merged into the `s3_access_point`
Terraform resource block to set or update the vpc_configuration field.
