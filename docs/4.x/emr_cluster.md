...
`aws.emr_cluster.withAdditionalInfo` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withApplications` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withAutoTerminationPolicy` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withAutoTerminationPolicyMixin` constructs a mixin object that can be merged into the `emr_cluster`
Terraform resource block to set or update the auto_termination_policy field.
...
`aws.emr_cluster.withAutoscalingRole` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withBootstrapAction` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withBootstrapActionMixin` constructs a mixin object that can be merged into the `emr_cluster`
Terraform resource block to set or update the bootstrap_action field.
...
`aws.emr_cluster.withConfigurations` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withConfigurationsJson` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withCoreInstanceFleet` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withCoreInstanceFleetMixin` constructs a mixin object that can be merged into the `emr_cluster`
Terraform resource block to set or update the core_instance_fleet field.
...
`aws.emr_cluster.withCoreInstanceGroup` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withCoreInstanceGroupMixin` constructs a mixin object that can be merged into the `emr_cluster`
Terraform resource block to set or update the core_instance_group field.
...
`aws.emr_cluster.withCustomAmiId` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withEbsRootVolumeSize` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withEc2Attributes` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withEc2AttributesMixin` constructs a mixin object that can be merged into the `emr_cluster`
Terraform resource block to set or update the ec2_attributes field.
...
`aws.emr_cluster.withKeepJobFlowAliveWhenNoSteps` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withKerberosAttributes` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withKerberosAttributesMixin` constructs a mixin object that can be merged into the `emr_cluster`
Terraform resource block to set or update the kerberos_attributes field.
...
`aws.emr_cluster.withListStepsStates` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withLogEncryptionKmsKeyId` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withLogUri` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withMasterInstanceFleet` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withMasterInstanceFleetMixin` constructs a mixin object that can be merged into the `emr_cluster`
Terraform resource block to set or update the master_instance_fleet field.
...
`aws.emr_cluster.withMasterInstanceGroup` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withMasterInstanceGroupMixin` constructs a mixin object that can be merged into the `emr_cluster`
Terraform resource block to set or update the master_instance_group field.
...
`aws.emr_cluster.withName` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withReleaseLabel` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withScaleDownBehavior` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withSecurityConfiguration` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withServiceRole` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withStep` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withStepConcurrencyLevel` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withTags` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withTagsAll` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withTerminationProtection` constructs a mixin object that can be merged into the `emr_cluster`
...
`aws.emr_cluster.withVisibleToAllUsers` constructs a mixin object that can be merged into the `emr_cluster`
