...
`aws.autoscalingplans_scaling_plan.withApplicationSource` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`
...
`aws.autoscalingplans_scaling_plan.withApplicationSourceMixin` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`
Terraform resource block to set or update the application_source field.
...
`aws.autoscalingplans_scaling_plan.withName` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`
...
`aws.autoscalingplans_scaling_plan.withScalingInstruction` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`
...
`aws.autoscalingplans_scaling_plan.withScalingInstructionMixin` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`
Terraform resource block to set or update the scaling_instruction field.
