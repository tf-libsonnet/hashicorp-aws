...
**Args**:
  ...
  - `network_services` (`list`): Set the `network_services` field on the resulting resource block. When `null`, the `network_services` field will be omitted from the resulting object.
...
Unlike [aws.ec2_traffic_mirror_filter.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `network_services` (`list`): Set the `network_services` field on the resulting object. When `null`, the `network_services` field will be omitted from the resulting object.
