...
`aws.fsx_ontap_volume.withJunctionPath` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withName` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withSecurityStyle` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withSizeInMegabytes` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withStorageEfficiencyEnabled` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withStorageVirtualMachineId` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withTags` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withTagsAll` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withTieringPolicy` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withTieringPolicyMixin` constructs a mixin object that can be merged into the `fsx_ontap_volume`
Terraform resource block to set or update the tiering_policy field.
...
`aws.fsx_ontap_volume.withTimeouts` constructs a mixin object that can be merged into the `fsx_ontap_volume`
...
`aws.fsx_ontap_volume.withTimeoutsMixin` constructs a mixin object that can be merged into the `fsx_ontap_volume`
Terraform resource block to set or update the timeouts field.
...
`aws.fsx_ontap_volume.withVolumeType` constructs a mixin object that can be merged into the `fsx_ontap_volume`
