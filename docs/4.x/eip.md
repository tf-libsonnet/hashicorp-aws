...
`aws.eip.withAddress` constructs a mixin object that can be merged into the `eip`
...
`aws.eip.withAssociateWithPrivateIp` constructs a mixin object that can be merged into the `eip`
...
`aws.eip.withCustomerOwnedIpv4Pool` constructs a mixin object that can be merged into the `eip`
...
`aws.eip.withInstance` constructs a mixin object that can be merged into the `eip`
...
`aws.eip.withNetworkBorderGroup` constructs a mixin object that can be merged into the `eip`
...
`aws.eip.withNetworkInterface` constructs a mixin object that can be merged into the `eip`
...
`aws.eip.withPublicIpv4Pool` constructs a mixin object that can be merged into the `eip`
...
`aws.eip.withTagsAll` constructs a mixin object that can be merged into the `eip`
...
`aws.eip.withVpc` constructs a mixin object that can be merged into the `eip`
