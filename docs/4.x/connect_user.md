...
`aws.connect_user.withDirectoryUserId` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withHierarchyGroupId` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withIdentityInfo` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withIdentityInfoMixin` constructs a mixin object that can be merged into the `connect_user`
Terraform resource block to set or update the identity_info field.
...
`aws.connect_user.withInstanceId` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withName` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withPassword` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withPhoneConfig` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withPhoneConfigMixin` constructs a mixin object that can be merged into the `connect_user`
Terraform resource block to set or update the phone_config field.
...
`aws.connect_user.withRoutingProfileId` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withSecurityProfileIds` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withTags` constructs a mixin object that can be merged into the `connect_user`
...
`aws.connect_user.withTagsAll` constructs a mixin object that can be merged into the `connect_user`
