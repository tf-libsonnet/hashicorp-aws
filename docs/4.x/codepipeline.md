...
`aws.codepipeline.withArtifactStore` constructs a mixin object that can be merged into the `codepipeline`
...
`aws.codepipeline.withArtifactStoreMixin` constructs a mixin object that can be merged into the `codepipeline`
Terraform resource block to set or update the artifact_store field.
...
`aws.codepipeline.withName` constructs a mixin object that can be merged into the `codepipeline`
...
`aws.codepipeline.withRoleArn` constructs a mixin object that can be merged into the `codepipeline`
...
`aws.codepipeline.withStage` constructs a mixin object that can be merged into the `codepipeline`
...
`aws.codepipeline.withStageMixin` constructs a mixin object that can be merged into the `codepipeline`
Terraform resource block to set or update the stage field.
...
`aws.codepipeline.withTags` constructs a mixin object that can be merged into the `codepipeline`
...
`aws.codepipeline.withTagsAll` constructs a mixin object that can be merged into the `codepipeline`
