...
`aws.appmesh_route.withMeshName` constructs a mixin object that can be merged into the `appmesh_route`
...
`aws.appmesh_route.withMeshOwner` constructs a mixin object that can be merged into the `appmesh_route`
...
`aws.appmesh_route.withName` constructs a mixin object that can be merged into the `appmesh_route`
...
`aws.appmesh_route.withSpec` constructs a mixin object that can be merged into the `appmesh_route`
...
`aws.appmesh_route.withSpecMixin` constructs a mixin object that can be merged into the `appmesh_route`
Terraform resource block to set or update the spec field.
...
`aws.appmesh_route.withTags` constructs a mixin object that can be merged into the `appmesh_route`
...
`aws.appmesh_route.withTagsAll` constructs a mixin object that can be merged into the `appmesh_route`
...
`aws.appmesh_route.withVirtualRouterName` constructs a mixin object that can be merged into the `appmesh_route`
