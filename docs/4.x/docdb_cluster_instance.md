...
`aws.docdb_cluster_instance.withApplyImmediately` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withAutoMinorVersionUpgrade` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withAvailabilityZone` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withCaCertIdentifier` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withClusterIdentifier` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withEnablePerformanceInsights` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withEngine` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withIdentifier` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withIdentifierPrefix` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withInstanceClass` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withPerformanceInsightsKmsKeyId` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withPreferredMaintenanceWindow` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withPromotionTier` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withTags` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withTagsAll` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withTimeouts` constructs a mixin object that can be merged into the `docdb_cluster_instance`
...
`aws.docdb_cluster_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `docdb_cluster_instance`
Terraform resource block to set or update the timeouts field.
