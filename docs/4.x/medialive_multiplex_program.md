...
`aws.medialive_multiplex_program.withMultiplexId` constructs a mixin object that can be merged into the `medialive_multiplex_program`
...
`aws.medialive_multiplex_program.withMultiplexProgramSettings` constructs a mixin object that can be merged into the `medialive_multiplex_program`
...
`aws.medialive_multiplex_program.withMultiplexProgramSettingsMixin` constructs a mixin object that can be merged into the `medialive_multiplex_program`
Terraform resource block to set or update the multiplex_program_settings field.
...
`aws.medialive_multiplex_program.withProgramName` constructs a mixin object that can be merged into the `medialive_multiplex_program`
