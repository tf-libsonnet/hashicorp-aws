...
`aws.shield_protection.withName` constructs a mixin object that can be merged into the `shield_protection`
...
`aws.shield_protection.withResourceArn` constructs a mixin object that can be merged into the `shield_protection`
...
`aws.shield_protection.withTags` constructs a mixin object that can be merged into the `shield_protection`
...
`aws.shield_protection.withTagsAll` constructs a mixin object that can be merged into the `shield_protection`
