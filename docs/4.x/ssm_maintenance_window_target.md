...
`aws.ssm_maintenance_window_target.withDescription` constructs a mixin object that can be merged into the `ssm_maintenance_window_target`
...
`aws.ssm_maintenance_window_target.withName` constructs a mixin object that can be merged into the `ssm_maintenance_window_target`
...
`aws.ssm_maintenance_window_target.withOwnerInformation` constructs a mixin object that can be merged into the `ssm_maintenance_window_target`
...
`aws.ssm_maintenance_window_target.withResourceType` constructs a mixin object that can be merged into the `ssm_maintenance_window_target`
...
`aws.ssm_maintenance_window_target.withTargets` constructs a mixin object that can be merged into the `ssm_maintenance_window_target`
...
`aws.ssm_maintenance_window_target.withTargetsMixin` constructs a mixin object that can be merged into the `ssm_maintenance_window_target`
Terraform resource block to set or update the targets field.
...
`aws.ssm_maintenance_window_target.withWindowId` constructs a mixin object that can be merged into the `ssm_maintenance_window_target`
