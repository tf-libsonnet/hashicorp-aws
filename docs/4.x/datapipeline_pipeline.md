...
`aws.datapipeline_pipeline.withDescription` constructs a mixin object that can be merged into the `datapipeline_pipeline`
...
`aws.datapipeline_pipeline.withName` constructs a mixin object that can be merged into the `datapipeline_pipeline`
...
`aws.datapipeline_pipeline.withTagsAll` constructs a mixin object that can be merged into the `datapipeline_pipeline`
