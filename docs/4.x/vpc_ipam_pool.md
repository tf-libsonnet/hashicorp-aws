...
`aws.vpc_ipam_pool.withAddressFamily` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withAllocationDefaultNetmaskLength` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withAllocationMaxNetmaskLength` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withAllocationMinNetmaskLength` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withAutoImport` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withAwsService` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withDescription` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withIpamScopeId` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withLocale` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withPubliclyAdvertisable` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withSourceIpamPoolId` constructs a mixin object that can be merged into the `vpc_ipam_pool`
...
`aws.vpc_ipam_pool.withTagsAll` constructs a mixin object that can be merged into the `vpc_ipam_pool`
