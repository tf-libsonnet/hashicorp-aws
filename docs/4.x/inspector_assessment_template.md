...
`aws.inspector_assessment_template.withDuration` constructs a mixin object that can be merged into the `inspector_assessment_template`
...
`aws.inspector_assessment_template.withEventSubscription` constructs a mixin object that can be merged into the `inspector_assessment_template`
...
`aws.inspector_assessment_template.withEventSubscriptionMixin` constructs a mixin object that can be merged into the `inspector_assessment_template`
Terraform resource block to set or update the event_subscription field.
...
`aws.inspector_assessment_template.withName` constructs a mixin object that can be merged into the `inspector_assessment_template`
...
`aws.inspector_assessment_template.withRulesPackageArns` constructs a mixin object that can be merged into the `inspector_assessment_template`
...
`aws.inspector_assessment_template.withTags` constructs a mixin object that can be merged into the `inspector_assessment_template`
...
`aws.inspector_assessment_template.withTagsAll` constructs a mixin object that can be merged into the `inspector_assessment_template`
...
`aws.inspector_assessment_template.withTargetArn` constructs a mixin object that can be merged into the `inspector_assessment_template`
