...
`aws.acm_certificate.withCertificateAuthorityArn` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withCertificateBody` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withCertificateChain` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withDomainName` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withEarlyRenewalDuration` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withKeyAlgorithm` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withOptions` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withOptionsMixin` constructs a mixin object that can be merged into the `acm_certificate`
Terraform resource block to set or update the options field.
...
`aws.acm_certificate.withPrivateKey` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withSubjectAlternativeNames` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withTagsAll` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withValidationMethod` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withValidationOption` constructs a mixin object that can be merged into the `acm_certificate`
...
`aws.acm_certificate.withValidationOptionMixin` constructs a mixin object that can be merged into the `acm_certificate`
Terraform resource block to set or update the validation_option field.
