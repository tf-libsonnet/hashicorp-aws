...
`aws.appmesh_virtual_node.withMeshName` constructs a mixin object that can be merged into the `appmesh_virtual_node`
...
`aws.appmesh_virtual_node.withMeshOwner` constructs a mixin object that can be merged into the `appmesh_virtual_node`
...
`aws.appmesh_virtual_node.withName` constructs a mixin object that can be merged into the `appmesh_virtual_node`
...
`aws.appmesh_virtual_node.withSpec` constructs a mixin object that can be merged into the `appmesh_virtual_node`
...
`aws.appmesh_virtual_node.withSpecMixin` constructs a mixin object that can be merged into the `appmesh_virtual_node`
Terraform resource block to set or update the spec field.
...
`aws.appmesh_virtual_node.withTags` constructs a mixin object that can be merged into the `appmesh_virtual_node`
...
`aws.appmesh_virtual_node.withTagsAll` constructs a mixin object that can be merged into the `appmesh_virtual_node`
