...
`aws.batch_job_definition.withContainerProperties` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withName` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withParameters` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withPlatformCapabilities` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withPropagateTags` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withRetryStrategy` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withRetryStrategyMixin` constructs a mixin object that can be merged into the `batch_job_definition`
Terraform resource block to set or update the retry_strategy field.
...
`aws.batch_job_definition.withTags` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withTagsAll` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withTimeout` constructs a mixin object that can be merged into the `batch_job_definition`
...
`aws.batch_job_definition.withTimeoutMixin` constructs a mixin object that can be merged into the `batch_job_definition`
Terraform resource block to set or update the timeout field.
...
`aws.batch_job_definition.withType` constructs a mixin object that can be merged into the `batch_job_definition`
