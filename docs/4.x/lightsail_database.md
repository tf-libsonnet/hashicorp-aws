...
`aws.lightsail_database.withApplyImmediately` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withAvailabilityZone` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withBackupRetentionEnabled` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withBlueprintId` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withBundleId` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withFinalSnapshotName` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withMasterDatabaseName` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withMasterPassword` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withMasterUsername` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withPreferredBackupWindow` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withPreferredMaintenanceWindow` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withPubliclyAccessible` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withRelationalDatabaseName` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withSkipFinalSnapshot` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withTags` constructs a mixin object that can be merged into the `lightsail_database`
...
`aws.lightsail_database.withTagsAll` constructs a mixin object that can be merged into the `lightsail_database`
