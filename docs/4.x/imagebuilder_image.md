...
`aws.imagebuilder_image.withContainerRecipeArn` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withDistributionConfigurationArn` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withEnhancedImageMetadataEnabled` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withImageRecipeArn` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withImageTestsConfiguration` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withImageTestsConfigurationMixin` constructs a mixin object that can be merged into the `imagebuilder_image`
Terraform resource block to set or update the image_tests_configuration field.
...
`aws.imagebuilder_image.withInfrastructureConfigurationArn` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withTags` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withTagsAll` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withTimeouts` constructs a mixin object that can be merged into the `imagebuilder_image`
...
`aws.imagebuilder_image.withTimeoutsMixin` constructs a mixin object that can be merged into the `imagebuilder_image`
Terraform resource block to set or update the timeouts field.
