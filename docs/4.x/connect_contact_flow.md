...
`aws.connect_contact_flow.withContent` constructs a mixin object that can be merged into the `connect_contact_flow`
...
`aws.connect_contact_flow.withContentHash` constructs a mixin object that can be merged into the `connect_contact_flow`
...
`aws.connect_contact_flow.withDescription` constructs a mixin object that can be merged into the `connect_contact_flow`
...
`aws.connect_contact_flow.withFilename` constructs a mixin object that can be merged into the `connect_contact_flow`
...
`aws.connect_contact_flow.withTagsAll` constructs a mixin object that can be merged into the `connect_contact_flow`
