...
`aws.globalaccelerator_listener.withAcceleratorArn` constructs a mixin object that can be merged into the `globalaccelerator_listener`
...
`aws.globalaccelerator_listener.withClientAffinity` constructs a mixin object that can be merged into the `globalaccelerator_listener`
...
`aws.globalaccelerator_listener.withPortRange` constructs a mixin object that can be merged into the `globalaccelerator_listener`
...
`aws.globalaccelerator_listener.withPortRangeMixin` constructs a mixin object that can be merged into the `globalaccelerator_listener`
Terraform resource block to set or update the port_range field.
...
`aws.globalaccelerator_listener.withProtocol` constructs a mixin object that can be merged into the `globalaccelerator_listener`
...
`aws.globalaccelerator_listener.withTimeouts` constructs a mixin object that can be merged into the `globalaccelerator_listener`
...
`aws.globalaccelerator_listener.withTimeoutsMixin` constructs a mixin object that can be merged into the `globalaccelerator_listener`
Terraform resource block to set or update the timeouts field.
