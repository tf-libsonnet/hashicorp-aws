...
`aws.cloudfront_field_level_encryption_profile.withComment` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_profile`
...
`aws.cloudfront_field_level_encryption_profile.withEncryptionEntities` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_profile`
...
`aws.cloudfront_field_level_encryption_profile.withEncryptionEntitiesMixin` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_profile`
Terraform resource block to set or update the encryption_entities field.
...
`aws.cloudfront_field_level_encryption_profile.withName` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_profile`
