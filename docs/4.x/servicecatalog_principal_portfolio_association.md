...
Unlike [aws.servicecatalog_principal_portfolio_association.new](#fn-servicecatalog_principal_portfolio_associationnew), this function will not inject the `resource`
