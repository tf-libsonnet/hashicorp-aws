---
permalink: /ec2_carrier_gateway/
---

# ec2_carrier_gateway

`ec2_carrier_gateway` represents the `aws_ec2_carrier_gateway` Terraform resource.
...
`aws.ec2_carrier_gateway.withTags` constructs a mixin object that can be merged into the `ec2_carrier_gateway`
...
`aws.ec2_carrier_gateway.withTagsAll` constructs a mixin object that can be merged into the `ec2_carrier_gateway`
...
`aws.ec2_carrier_gateway.withVpcId` constructs a mixin object that can be merged into the `ec2_carrier_gateway`
