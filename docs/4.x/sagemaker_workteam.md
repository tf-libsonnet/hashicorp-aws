...
`aws.sagemaker_workteam.withDescription` constructs a mixin object that can be merged into the `sagemaker_workteam`
...
`aws.sagemaker_workteam.withMemberDefinition` constructs a mixin object that can be merged into the `sagemaker_workteam`
...
`aws.sagemaker_workteam.withMemberDefinitionMixin` constructs a mixin object that can be merged into the `sagemaker_workteam`
Terraform resource block to set or update the member_definition field.
...
`aws.sagemaker_workteam.withNotificationConfiguration` constructs a mixin object that can be merged into the `sagemaker_workteam`
...
`aws.sagemaker_workteam.withNotificationConfigurationMixin` constructs a mixin object that can be merged into the `sagemaker_workteam`
Terraform resource block to set or update the notification_configuration field.
...
`aws.sagemaker_workteam.withTags` constructs a mixin object that can be merged into the `sagemaker_workteam`
...
`aws.sagemaker_workteam.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_workteam`
...
`aws.sagemaker_workteam.withWorkforceName` constructs a mixin object that can be merged into the `sagemaker_workteam`
...
`aws.sagemaker_workteam.withWorkteamName` constructs a mixin object that can be merged into the `sagemaker_workteam`
