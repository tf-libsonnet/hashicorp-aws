...
**Args**:
  ...
  - `member_definition` (`list[obj]`):  When `null`, the `member_definition` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.sagemaker_workteam.member_definition.new](#fn-sagemaker_workteammember_definitionnew) constructor.
  - `notification_configuration` (`list[obj]`):  When `null`, the `notification_configuration` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.sagemaker_workteam.notification_configuration.new](#fn-sagemaker_workteamnotification_configurationnew) constructor.
...
Unlike [aws.sagemaker_workteam.new](#fn-sagemaker_workteamnew), this function will not inject the `resource`
