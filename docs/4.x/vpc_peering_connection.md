...
`aws.vpc_peering_connection.withAccepter` constructs a mixin object that can be merged into the `vpc_peering_connection`
...
`aws.vpc_peering_connection.withAccepterMixin` constructs a mixin object that can be merged into the `vpc_peering_connection`
Terraform resource block to set or update the accepter field.
...
`aws.vpc_peering_connection.withAutoAccept` constructs a mixin object that can be merged into the `vpc_peering_connection`
...
`aws.vpc_peering_connection.withRequester` constructs a mixin object that can be merged into the `vpc_peering_connection`
...
`aws.vpc_peering_connection.withRequesterMixin` constructs a mixin object that can be merged into the `vpc_peering_connection`
Terraform resource block to set or update the requester field.
...
`aws.vpc_peering_connection.withTagsAll` constructs a mixin object that can be merged into the `vpc_peering_connection`
