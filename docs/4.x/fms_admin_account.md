---
permalink: /fms_admin_account/
---

# fms_admin_account

`fms_admin_account` represents the `aws_fms_admin_account` Terraform resource.
...
`aws.fms_admin_account.withAccountId` constructs a mixin object that can be merged into the `fms_admin_account`
