...
`aws.glue_catalog_table.withDescription` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withOwner` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withParameters` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withPartitionIndex` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withPartitionIndexMixin` constructs a mixin object that can be merged into the `glue_catalog_table`
Terraform resource block to set or update the partition_index field.
...
`aws.glue_catalog_table.withPartitionKeys` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withPartitionKeysMixin` constructs a mixin object that can be merged into the `glue_catalog_table`
Terraform resource block to set or update the partition_keys field.
...
`aws.glue_catalog_table.withRetention` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withStorageDescriptor` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withStorageDescriptorMixin` constructs a mixin object that can be merged into the `glue_catalog_table`
Terraform resource block to set or update the storage_descriptor field.
...
`aws.glue_catalog_table.withTableType` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withTargetTable` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withTargetTableMixin` constructs a mixin object that can be merged into the `glue_catalog_table`
Terraform resource block to set or update the target_table field.
...
`aws.glue_catalog_table.withViewExpandedText` constructs a mixin object that can be merged into the `glue_catalog_table`
...
`aws.glue_catalog_table.withViewOriginalText` constructs a mixin object that can be merged into the `glue_catalog_table`
