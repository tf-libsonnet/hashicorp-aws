...
`aws.alb_listener.withAlpnPolicy` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withCertificateArn` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withDefaultAction` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withDefaultActionMixin` constructs a mixin object that can be merged into the `alb_listener`
Terraform resource block to set or update the default_action field.
...
`aws.alb_listener.withLoadBalancerArn` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withPort` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withProtocol` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withSslPolicy` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withTags` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withTagsAll` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withTimeouts` constructs a mixin object that can be merged into the `alb_listener`
...
`aws.alb_listener.withTimeoutsMixin` constructs a mixin object that can be merged into the `alb_listener`
Terraform resource block to set or update the timeouts field.
