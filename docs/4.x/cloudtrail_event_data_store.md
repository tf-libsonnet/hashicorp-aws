...
`aws.cloudtrail_event_data_store.withAdvancedEventSelector` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withAdvancedEventSelectorMixin` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
Terraform resource block to set or update the advanced_event_selector field.
...
`aws.cloudtrail_event_data_store.withMultiRegionEnabled` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withName` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withOrganizationEnabled` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withRetentionPeriod` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withTags` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withTagsAll` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withTerminationProtectionEnabled` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withTimeouts` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
...
`aws.cloudtrail_event_data_store.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudtrail_event_data_store`
Terraform resource block to set or update the timeouts field.
