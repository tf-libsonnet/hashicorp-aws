---
permalink: /opsworks_mysql_layer/
---

# opsworks_mysql_layer

`opsworks_mysql_layer` represents the `aws_opsworks_mysql_layer` Terraform resource.
...
* [`fn withRootPasswordOnAllInstances()`](#fn-withrootpasswordonallinstances)
...
`aws.opsworks_mysql_layer.withAutoAssignElasticIps` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withAutoAssignPublicIps` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withAutoHealing` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCloudwatchConfiguration` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCloudwatchConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
Terraform resource block to set or update the cloudwatch_configuration field.
...
`aws.opsworks_mysql_layer.withCustomConfigureRecipes` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCustomDeployRecipes` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCustomInstanceProfileArn` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCustomJson` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCustomSecurityGroupIds` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCustomSetupRecipes` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCustomShutdownRecipes` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withCustomUndeployRecipes` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withDrainElbOnShutdown` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withEbsVolume` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withEbsVolumeMixin` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
Terraform resource block to set or update the ebs_volume field.
...
`aws.opsworks_mysql_layer.withElasticLoadBalancer` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withInstallUpdatesOnBoot` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withInstanceShutdownTimeout` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withLoadBasedAutoScaling` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withLoadBasedAutoScalingMixin` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
Terraform resource block to set or update the load_based_auto_scaling field.
...
`aws.opsworks_mysql_layer.withName` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withRootPassword` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
### fn withRootPasswordOnAllInstances

```ts
withRootPasswordOnAllInstances()
```

`aws.opsworks_mysql_layer.withRootPasswordOnAllInstances` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withStackId` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withSystemPackages` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withTags` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withTagsAll` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
...
`aws.opsworks_mysql_layer.withUseEbsOptimizedInstances` constructs a mixin object that can be merged into the `opsworks_mysql_layer`
