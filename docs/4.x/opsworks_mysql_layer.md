...
**Args**:
  ...
  - `log_streams` (`list[obj]`):  When `null`, the `log_streams` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opsworks_mysql_layer.cloudwatch_configuration.log_streams.new](#fn-opsworks_mysql_layerlog_streamsnew) constructor.
...
**Args**:
  ...
  - `downscaling` (`list[obj]`):  When `null`, the `downscaling` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opsworks_mysql_layer.load_based_auto_scaling.downscaling.new](#fn-opsworks_mysql_layerdownscalingnew) constructor.
  - `upscaling` (`list[obj]`):  When `null`, the `upscaling` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opsworks_mysql_layer.load_based_auto_scaling.upscaling.new](#fn-opsworks_mysql_layerupscalingnew) constructor.
