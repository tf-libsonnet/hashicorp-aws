...
`aws.ec2_transit_gateway_connect.withProtocol` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect`
...
`aws.ec2_transit_gateway_connect.withTagsAll` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect`
...
`aws.ec2_transit_gateway_connect.withTransitGatewayDefaultRouteTableAssociation` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect`
...
`aws.ec2_transit_gateway_connect.withTransitGatewayDefaultRouteTablePropagation` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect`
...
`aws.ec2_transit_gateway_connect.withTransitGatewayId` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect`
...
`aws.ec2_transit_gateway_connect.withTransportAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect`
