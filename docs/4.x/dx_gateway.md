...
**Args**:
  ...
  - `name` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dx_gateway.timeouts.new](#fn-dx_gatewaytimeoutsnew) constructor.
...
Unlike [aws.dx_gateway.new](#fn-dx_gatewaynew), this function will not inject the `resource`
