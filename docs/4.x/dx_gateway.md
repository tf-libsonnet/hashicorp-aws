---
permalink: /dx_gateway/
---

# dx_gateway

`dx_gateway` represents the `aws_dx_gateway` Terraform resource.
...
`aws.dx_gateway.withAmazonSideAsn` constructs a mixin object that can be merged into the `dx_gateway`
...
`aws.dx_gateway.withName` constructs a mixin object that can be merged into the `dx_gateway`
...
`aws.dx_gateway.withTimeouts` constructs a mixin object that can be merged into the `dx_gateway`
...
`aws.dx_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `dx_gateway`
Terraform resource block to set or update the timeouts field.
