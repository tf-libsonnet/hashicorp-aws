...
`aws.emrcontainers_virtual_cluster.withContainerProvider` constructs a mixin object that can be merged into the `emrcontainers_virtual_cluster`
...
`aws.emrcontainers_virtual_cluster.withContainerProviderMixin` constructs a mixin object that can be merged into the `emrcontainers_virtual_cluster`
Terraform resource block to set or update the container_provider field.
...
`aws.emrcontainers_virtual_cluster.withName` constructs a mixin object that can be merged into the `emrcontainers_virtual_cluster`
...
`aws.emrcontainers_virtual_cluster.withTagsAll` constructs a mixin object that can be merged into the `emrcontainers_virtual_cluster`
...
`aws.emrcontainers_virtual_cluster.withTimeouts` constructs a mixin object that can be merged into the `emrcontainers_virtual_cluster`
...
`aws.emrcontainers_virtual_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `emrcontainers_virtual_cluster`
Terraform resource block to set or update the timeouts field.
