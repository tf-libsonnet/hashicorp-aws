...
`aws.waf_rule.withMetricName` constructs a mixin object that can be merged into the `waf_rule`
...
`aws.waf_rule.withPredicates` constructs a mixin object that can be merged into the `waf_rule`
...
`aws.waf_rule.withPredicatesMixin` constructs a mixin object that can be merged into the `waf_rule`
Terraform resource block to set or update the predicates field.
...
`aws.waf_rule.withTags` constructs a mixin object that can be merged into the `waf_rule`
...
`aws.waf_rule.withTagsAll` constructs a mixin object that can be merged into the `waf_rule`
