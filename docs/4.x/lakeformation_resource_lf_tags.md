...
`aws.lakeformation_resource_lf_tags.withCatalogId` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
...
`aws.lakeformation_resource_lf_tags.withDatabase` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
...
`aws.lakeformation_resource_lf_tags.withDatabaseMixin` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
Terraform resource block to set or update the database field.
...
`aws.lakeformation_resource_lf_tags.withLfTag` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
...
`aws.lakeformation_resource_lf_tags.withLfTagMixin` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
Terraform resource block to set or update the lf_tag field.
...
`aws.lakeformation_resource_lf_tags.withTable` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
...
`aws.lakeformation_resource_lf_tags.withTableMixin` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
Terraform resource block to set or update the table field.
...
`aws.lakeformation_resource_lf_tags.withTableWithColumns` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
...
`aws.lakeformation_resource_lf_tags.withTableWithColumnsMixin` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
Terraform resource block to set or update the table_with_columns field.
...
`aws.lakeformation_resource_lf_tags.withTimeouts` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
...
`aws.lakeformation_resource_lf_tags.withTimeoutsMixin` constructs a mixin object that can be merged into the `lakeformation_resource_lf_tags`
Terraform resource block to set or update the timeouts field.
