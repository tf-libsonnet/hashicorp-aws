...
`aws.evidently_feature.withDefaultVariation` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withDescription` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withEntityOverrides` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withEvaluationStrategy` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withName` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withProject` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withTags` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withTagsAll` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withTimeouts` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withTimeoutsMixin` constructs a mixin object that can be merged into the `evidently_feature`
Terraform resource block to set or update the timeouts field.
...
`aws.evidently_feature.withVariations` constructs a mixin object that can be merged into the `evidently_feature`
...
`aws.evidently_feature.withVariationsMixin` constructs a mixin object that can be merged into the `evidently_feature`
Terraform resource block to set or update the variations field.
