...
`aws.batch_compute_environment.withComputeEnvironmentNamePrefix` constructs a mixin object that can be merged into the `batch_compute_environment`
...
`aws.batch_compute_environment.withComputeResources` constructs a mixin object that can be merged into the `batch_compute_environment`
...
`aws.batch_compute_environment.withComputeResourcesMixin` constructs a mixin object that can be merged into the `batch_compute_environment`
Terraform resource block to set or update the compute_resources field.
...
`aws.batch_compute_environment.withEksConfiguration` constructs a mixin object that can be merged into the `batch_compute_environment`
...
`aws.batch_compute_environment.withEksConfigurationMixin` constructs a mixin object that can be merged into the `batch_compute_environment`
Terraform resource block to set or update the eks_configuration field.
...
`aws.batch_compute_environment.withServiceRole` constructs a mixin object that can be merged into the `batch_compute_environment`
...
`aws.batch_compute_environment.withState` constructs a mixin object that can be merged into the `batch_compute_environment`
...
`aws.batch_compute_environment.withTagsAll` constructs a mixin object that can be merged into the `batch_compute_environment`
...
`aws.batch_compute_environment.withType` constructs a mixin object that can be merged into the `batch_compute_environment`
