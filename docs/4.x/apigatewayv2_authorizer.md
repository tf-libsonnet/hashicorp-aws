...
`aws.apigatewayv2_authorizer.withApiId` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withAuthorizerCredentialsArn` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withAuthorizerPayloadFormatVersion` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withAuthorizerResultTtlInSeconds` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withAuthorizerType` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withAuthorizerUri` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withEnableSimpleResponses` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withIdentitySources` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withJwtConfiguration` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
...
`aws.apigatewayv2_authorizer.withJwtConfigurationMixin` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
Terraform resource block to set or update the jwt_configuration field.
...
`aws.apigatewayv2_authorizer.withName` constructs a mixin object that can be merged into the `apigatewayv2_authorizer`
