...
`aws.ivs_recording_configuration.withDestinationConfiguration` constructs a mixin object that can be merged into the `ivs_recording_configuration`
...
`aws.ivs_recording_configuration.withDestinationConfigurationMixin` constructs a mixin object that can be merged into the `ivs_recording_configuration`
Terraform resource block to set or update the destination_configuration field.
...
`aws.ivs_recording_configuration.withName` constructs a mixin object that can be merged into the `ivs_recording_configuration`
...
`aws.ivs_recording_configuration.withRecordingReconnectWindowSeconds` constructs a mixin object that can be merged into the `ivs_recording_configuration`
...
`aws.ivs_recording_configuration.withTags` constructs a mixin object that can be merged into the `ivs_recording_configuration`
...
`aws.ivs_recording_configuration.withTagsAll` constructs a mixin object that can be merged into the `ivs_recording_configuration`
...
`aws.ivs_recording_configuration.withThumbnailConfiguration` constructs a mixin object that can be merged into the `ivs_recording_configuration`
...
`aws.ivs_recording_configuration.withThumbnailConfigurationMixin` constructs a mixin object that can be merged into the `ivs_recording_configuration`
Terraform resource block to set or update the thumbnail_configuration field.
...
`aws.ivs_recording_configuration.withTimeouts` constructs a mixin object that can be merged into the `ivs_recording_configuration`
...
`aws.ivs_recording_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `ivs_recording_configuration`
Terraform resource block to set or update the timeouts field.
