...
`aws.dlm_lifecycle_policy.withDescription` constructs a mixin object that can be merged into the `dlm_lifecycle_policy`
...
`aws.dlm_lifecycle_policy.withExecutionRoleArn` constructs a mixin object that can be merged into the `dlm_lifecycle_policy`
...
`aws.dlm_lifecycle_policy.withPolicyDetails` constructs a mixin object that can be merged into the `dlm_lifecycle_policy`
...
`aws.dlm_lifecycle_policy.withPolicyDetailsMixin` constructs a mixin object that can be merged into the `dlm_lifecycle_policy`
Terraform resource block to set or update the policy_details field.
...
`aws.dlm_lifecycle_policy.withState` constructs a mixin object that can be merged into the `dlm_lifecycle_policy`
...
`aws.dlm_lifecycle_policy.withTags` constructs a mixin object that can be merged into the `dlm_lifecycle_policy`
...
`aws.dlm_lifecycle_policy.withTagsAll` constructs a mixin object that can be merged into the `dlm_lifecycle_policy`
