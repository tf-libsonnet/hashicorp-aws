...
**Args**:
  ...
  - `target_arn` (`string`): 
  - `type` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_phone_number.timeouts.new](#fn-connect_phone_numbertimeoutsnew) constructor.
...
Unlike [aws.connect_phone_number.new](#fn-connect_phone_numbernew), this function will not inject the `resource`
