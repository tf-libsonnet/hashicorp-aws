...
`aws.iot_indexing_configuration.withThingGroupIndexingConfiguration` constructs a mixin object that can be merged into the `iot_indexing_configuration`
...
`aws.iot_indexing_configuration.withThingGroupIndexingConfigurationMixin` constructs a mixin object that can be merged into the `iot_indexing_configuration`
Terraform resource block to set or update the thing_group_indexing_configuration field.
...
`aws.iot_indexing_configuration.withThingIndexingConfiguration` constructs a mixin object that can be merged into the `iot_indexing_configuration`
...
`aws.iot_indexing_configuration.withThingIndexingConfigurationMixin` constructs a mixin object that can be merged into the `iot_indexing_configuration`
Terraform resource block to set or update the thing_indexing_configuration field.
