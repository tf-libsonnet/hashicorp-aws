...
`aws.fsx_file_cache.withCopyTagsToDataRepositoryAssociations` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withDataRepositoryAssociation` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withDataRepositoryAssociationMixin` constructs a mixin object that can be merged into the `fsx_file_cache`
Terraform resource block to set or update the data_repository_association field.
...
`aws.fsx_file_cache.withFileCacheType` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withFileCacheTypeVersion` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withKmsKeyId` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withLustreConfiguration` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withLustreConfigurationMixin` constructs a mixin object that can be merged into the `fsx_file_cache`
Terraform resource block to set or update the lustre_configuration field.
...
`aws.fsx_file_cache.withSecurityGroupIds` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withStorageCapacity` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withSubnetIds` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withTags` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withTagsAll` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withTimeouts` constructs a mixin object that can be merged into the `fsx_file_cache`
...
`aws.fsx_file_cache.withTimeoutsMixin` constructs a mixin object that can be merged into the `fsx_file_cache`
Terraform resource block to set or update the timeouts field.
