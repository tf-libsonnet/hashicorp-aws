...
**Args**:
  ...
  - `rules` (`list[obj]`): Set the `rules` field on the resulting resource block. When `null`, the `rules` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.waf_web_acl.rules.new](#fn-rulesnew) constructor.
...
Unlike [aws.waf_web_acl.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `rules` (`list[obj]`): Set the `rules` field on the resulting object. When `null`, the `rules` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.waf_web_acl.rules.new](#fn-rulesnew) constructor.
...
**Args**:
  ...
  - `action` (`list[obj]`): Set the `action` field on the resulting object. When `null`, the `action` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.waf_web_acl.rules.action.new](#fn-rulesactionnew) constructor.
  - `override_action` (`list[obj]`): Set the `override_action` field on the resulting object. When `null`, the `override_action` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.waf_web_acl.rules.override_action.new](#fn-rulesoverride_actionnew) constructor.
