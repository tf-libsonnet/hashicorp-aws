...
`aws.sagemaker_endpoint_configuration.withAsyncInferenceConfig` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
...
`aws.sagemaker_endpoint_configuration.withAsyncInferenceConfigMixin` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
Terraform resource block to set or update the async_inference_config field.
...
`aws.sagemaker_endpoint_configuration.withDataCaptureConfig` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
...
`aws.sagemaker_endpoint_configuration.withDataCaptureConfigMixin` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
Terraform resource block to set or update the data_capture_config field.
...
`aws.sagemaker_endpoint_configuration.withKmsKeyArn` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
...
`aws.sagemaker_endpoint_configuration.withName` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
...
`aws.sagemaker_endpoint_configuration.withProductionVariants` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
...
`aws.sagemaker_endpoint_configuration.withProductionVariantsMixin` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
Terraform resource block to set or update the production_variants field.
...
`aws.sagemaker_endpoint_configuration.withShadowProductionVariants` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
...
`aws.sagemaker_endpoint_configuration.withShadowProductionVariantsMixin` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
Terraform resource block to set or update the shadow_production_variants field.
...
`aws.sagemaker_endpoint_configuration.withTags` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
...
`aws.sagemaker_endpoint_configuration.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_endpoint_configuration`
