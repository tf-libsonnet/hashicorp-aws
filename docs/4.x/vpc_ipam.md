...
`aws.vpc_ipam.withCascade` constructs a mixin object that can be merged into the `vpc_ipam`
...
`aws.vpc_ipam.withDescription` constructs a mixin object that can be merged into the `vpc_ipam`
...
`aws.vpc_ipam.withOperatingRegions` constructs a mixin object that can be merged into the `vpc_ipam`
...
`aws.vpc_ipam.withOperatingRegionsMixin` constructs a mixin object that can be merged into the `vpc_ipam`
Terraform resource block to set or update the operating_regions field.
...
`aws.vpc_ipam.withTags` constructs a mixin object that can be merged into the `vpc_ipam`
...
`aws.vpc_ipam.withTagsAll` constructs a mixin object that can be merged into the `vpc_ipam`
...
`aws.vpc_ipam.withTimeouts` constructs a mixin object that can be merged into the `vpc_ipam`
...
`aws.vpc_ipam.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpc_ipam`
Terraform resource block to set or update the timeouts field.
