...
Unlike [aws.route53_resolver_firewall_rule_group_association.new](#fn-route53_resolver_firewall_rule_group_associationnew), this function will not inject the `resource`
