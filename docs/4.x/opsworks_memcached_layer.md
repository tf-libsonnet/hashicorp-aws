...
`aws.opsworks_memcached_layer.withAllocatedMemory` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withAutoAssignElasticIps` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withAutoAssignPublicIps` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withAutoHealing` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCloudwatchConfiguration` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCloudwatchConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
Terraform resource block to set or update the cloudwatch_configuration field.
...
`aws.opsworks_memcached_layer.withCustomConfigureRecipes` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCustomDeployRecipes` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCustomInstanceProfileArn` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCustomJson` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCustomSecurityGroupIds` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCustomSetupRecipes` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCustomShutdownRecipes` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withCustomUndeployRecipes` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withDrainElbOnShutdown` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withEbsVolume` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withEbsVolumeMixin` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
Terraform resource block to set or update the ebs_volume field.
...
`aws.opsworks_memcached_layer.withElasticLoadBalancer` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withInstallUpdatesOnBoot` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withInstanceShutdownTimeout` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withLoadBasedAutoScaling` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withLoadBasedAutoScalingMixin` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
Terraform resource block to set or update the load_based_auto_scaling field.
...
`aws.opsworks_memcached_layer.withName` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withStackId` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withSystemPackages` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withTags` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withTagsAll` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
...
`aws.opsworks_memcached_layer.withUseEbsOptimizedInstances` constructs a mixin object that can be merged into the `opsworks_memcached_layer`
