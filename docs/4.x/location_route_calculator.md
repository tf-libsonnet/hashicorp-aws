...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.location_route_calculator.timeouts.new](#fn-location_route_calculatortimeoutsnew) constructor.
...
Unlike [aws.location_route_calculator.new](#fn-location_route_calculatornew), this function will not inject the `resource`
