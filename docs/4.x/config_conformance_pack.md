...
`aws.config_conformance_pack.withDeliveryS3Bucket` constructs a mixin object that can be merged into the `config_conformance_pack`
...
`aws.config_conformance_pack.withDeliveryS3KeyPrefix` constructs a mixin object that can be merged into the `config_conformance_pack`
...
`aws.config_conformance_pack.withInputParameter` constructs a mixin object that can be merged into the `config_conformance_pack`
...
`aws.config_conformance_pack.withInputParameterMixin` constructs a mixin object that can be merged into the `config_conformance_pack`
Terraform resource block to set or update the input_parameter field.
...
`aws.config_conformance_pack.withName` constructs a mixin object that can be merged into the `config_conformance_pack`
...
`aws.config_conformance_pack.withTemplateBody` constructs a mixin object that can be merged into the `config_conformance_pack`
...
`aws.config_conformance_pack.withTemplateS3Uri` constructs a mixin object that can be merged into the `config_conformance_pack`
