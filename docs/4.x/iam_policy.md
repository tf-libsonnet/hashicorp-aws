...
`aws.iam_policy.withDescription` constructs a mixin object that can be merged into the `iam_policy`
...
`aws.iam_policy.withNamePrefix` constructs a mixin object that can be merged into the `iam_policy`
...
`aws.iam_policy.withPath` constructs a mixin object that can be merged into the `iam_policy`
...
`aws.iam_policy.withPolicy` constructs a mixin object that can be merged into the `iam_policy`
...
`aws.iam_policy.withTagsAll` constructs a mixin object that can be merged into the `iam_policy`
