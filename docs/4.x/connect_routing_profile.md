...
`aws.connect_routing_profile.withDefaultOutboundQueueId` constructs a mixin object that can be merged into the `connect_routing_profile`
...
`aws.connect_routing_profile.withDescription` constructs a mixin object that can be merged into the `connect_routing_profile`
...
`aws.connect_routing_profile.withMediaConcurrencies` constructs a mixin object that can be merged into the `connect_routing_profile`
...
`aws.connect_routing_profile.withMediaConcurrenciesMixin` constructs a mixin object that can be merged into the `connect_routing_profile`
Terraform resource block to set or update the media_concurrencies field.
...
`aws.connect_routing_profile.withQueueConfigs` constructs a mixin object that can be merged into the `connect_routing_profile`
...
`aws.connect_routing_profile.withQueueConfigsMixin` constructs a mixin object that can be merged into the `connect_routing_profile`
Terraform resource block to set or update the queue_configs field.
...
`aws.connect_routing_profile.withTagsAll` constructs a mixin object that can be merged into the `connect_routing_profile`
