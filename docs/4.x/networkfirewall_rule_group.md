...
`aws.networkfirewall_rule_group.withCapacity` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
...
`aws.networkfirewall_rule_group.withDescription` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
...
`aws.networkfirewall_rule_group.withEncryptionConfiguration` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
...
`aws.networkfirewall_rule_group.withEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
Terraform resource block to set or update the encryption_configuration field.
...
`aws.networkfirewall_rule_group.withName` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
...
`aws.networkfirewall_rule_group.withRuleGroup` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
...
`aws.networkfirewall_rule_group.withRuleGroupMixin` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
Terraform resource block to set or update the rule_group field.
...
`aws.networkfirewall_rule_group.withRules` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
...
`aws.networkfirewall_rule_group.withTags` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
...
`aws.networkfirewall_rule_group.withTagsAll` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
...
`aws.networkfirewall_rule_group.withType` constructs a mixin object that can be merged into the `networkfirewall_rule_group`
