...
`aws.efs_access_point.withFileSystemId` constructs a mixin object that can be merged into the `efs_access_point`
...
`aws.efs_access_point.withPosixUser` constructs a mixin object that can be merged into the `efs_access_point`
...
`aws.efs_access_point.withPosixUserMixin` constructs a mixin object that can be merged into the `efs_access_point`
Terraform resource block to set or update the posix_user field.
...
`aws.efs_access_point.withRootDirectory` constructs a mixin object that can be merged into the `efs_access_point`
...
`aws.efs_access_point.withRootDirectoryMixin` constructs a mixin object that can be merged into the `efs_access_point`
Terraform resource block to set or update the root_directory field.
...
`aws.efs_access_point.withTagsAll` constructs a mixin object that can be merged into the `efs_access_point`
