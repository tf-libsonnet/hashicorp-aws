...
`aws.ecs_capacity_provider.withAutoScalingGroupProvider` constructs a mixin object that can be merged into the `ecs_capacity_provider`
...
`aws.ecs_capacity_provider.withAutoScalingGroupProviderMixin` constructs a mixin object that can be merged into the `ecs_capacity_provider`
Terraform resource block to set or update the auto_scaling_group_provider field.
...
`aws.ecs_capacity_provider.withName` constructs a mixin object that can be merged into the `ecs_capacity_provider`
...
`aws.ecs_capacity_provider.withTags` constructs a mixin object that can be merged into the `ecs_capacity_provider`
...
`aws.ecs_capacity_provider.withTagsAll` constructs a mixin object that can be merged into the `ecs_capacity_provider`
