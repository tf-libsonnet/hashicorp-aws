...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.networkmanager_connection.timeouts.new](#fn-networkmanager_connectiontimeoutsnew) constructor.
...
Unlike [aws.networkmanager_connection.new](#fn-networkmanager_connectionnew), this function will not inject the `resource`
