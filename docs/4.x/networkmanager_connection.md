...
**Args**:
  ...
  - `connected_device_id` (`string`): Set the `connected_device_id` field on the resulting resource block.
  - `connected_link_id` (`string`): Set the `connected_link_id` field on the resulting resource block. When `null`, the `connected_link_id` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.networkmanager_connection.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [aws.networkmanager_connection.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  - `connected_device_id` (`string`): Set the `connected_device_id` field on the resulting object.
  - `connected_link_id` (`string`): Set the `connected_link_id` field on the resulting object. When `null`, the `connected_link_id` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.networkmanager_connection.timeouts.new](#fn-timeoutsnew) constructor.
...
`aws.string.withConnectedDeviceId` constructs a mixin object that can be merged into the `string`
...
`aws.string.withConnectedLinkId` constructs a mixin object that can be merged into the `string`
