...
`aws.api_gateway_usage_plan.withApiStages` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
...
`aws.api_gateway_usage_plan.withApiStagesMixin` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
Terraform resource block to set or update the api_stages field.
...
`aws.api_gateway_usage_plan.withDescription` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
...
`aws.api_gateway_usage_plan.withName` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
...
`aws.api_gateway_usage_plan.withProductCode` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
...
`aws.api_gateway_usage_plan.withQuotaSettings` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
...
`aws.api_gateway_usage_plan.withQuotaSettingsMixin` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
Terraform resource block to set or update the quota_settings field.
...
`aws.api_gateway_usage_plan.withTags` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
...
`aws.api_gateway_usage_plan.withTagsAll` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
...
`aws.api_gateway_usage_plan.withThrottleSettings` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
...
`aws.api_gateway_usage_plan.withThrottleSettingsMixin` constructs a mixin object that can be merged into the `api_gateway_usage_plan`
Terraform resource block to set or update the throttle_settings field.
