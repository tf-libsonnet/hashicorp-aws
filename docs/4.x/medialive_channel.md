...
`aws.medialive_channel.withCdiInputSpecification` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withCdiInputSpecificationMixin` constructs a mixin object that can be merged into the `medialive_channel`
Terraform resource block to set or update the cdi_input_specification field.
...
`aws.medialive_channel.withChannelClass` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withDestinations` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withDestinationsMixin` constructs a mixin object that can be merged into the `medialive_channel`
Terraform resource block to set or update the destinations field.
...
`aws.medialive_channel.withEncoderSettings` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withEncoderSettingsMixin` constructs a mixin object that can be merged into the `medialive_channel`
Terraform resource block to set or update the encoder_settings field.
...
`aws.medialive_channel.withInputAttachments` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withInputAttachmentsMixin` constructs a mixin object that can be merged into the `medialive_channel`
Terraform resource block to set or update the input_attachments field.
...
`aws.medialive_channel.withInputSpecification` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withInputSpecificationMixin` constructs a mixin object that can be merged into the `medialive_channel`
Terraform resource block to set or update the input_specification field.
...
`aws.medialive_channel.withLogLevel` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withMaintenance` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withMaintenanceMixin` constructs a mixin object that can be merged into the `medialive_channel`
Terraform resource block to set or update the maintenance field.
...
`aws.medialive_channel.withName` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withRoleArn` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withStartChannel` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withTags` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withTagsAll` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withTimeouts` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withTimeoutsMixin` constructs a mixin object that can be merged into the `medialive_channel`
Terraform resource block to set or update the timeouts field.
...
`aws.medialive_channel.withVpc` constructs a mixin object that can be merged into the `medialive_channel`
...
`aws.medialive_channel.withVpcMixin` constructs a mixin object that can be merged into the `medialive_channel`
Terraform resource block to set or update the vpc field.
