...
`aws.networkmanager_transit_gateway_route_table_attachment.withPeeringId` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_route_table_attachment`
...
`aws.networkmanager_transit_gateway_route_table_attachment.withTags` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_route_table_attachment`
...
`aws.networkmanager_transit_gateway_route_table_attachment.withTagsAll` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_route_table_attachment`
...
`aws.networkmanager_transit_gateway_route_table_attachment.withTimeouts` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_route_table_attachment`
...
`aws.networkmanager_transit_gateway_route_table_attachment.withTimeoutsMixin` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_route_table_attachment`
Terraform resource block to set or update the timeouts field.
...
`aws.networkmanager_transit_gateway_route_table_attachment.withTransitGatewayRouteTableArn` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_route_table_attachment`
