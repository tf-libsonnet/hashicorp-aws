...
**Args**:
  ...
  - `phone_number` (`string`): 
  - `title` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.account_alternate_contact.timeouts.new](#fn-account_alternate_contacttimeoutsnew) constructor.
...
Unlike [aws.account_alternate_contact.new](#fn-account_alternate_contactnew), this function will not inject the `resource`
