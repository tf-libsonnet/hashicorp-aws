...
`aws.kinesisanalyticsv2_application.withApplicationConfiguration` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withApplicationConfigurationMixin` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
Terraform resource block to set or update the application_configuration field.
...
`aws.kinesisanalyticsv2_application.withCloudwatchLoggingOptions` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withCloudwatchLoggingOptionsMixin` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
Terraform resource block to set or update the cloudwatch_logging_options field.
...
`aws.kinesisanalyticsv2_application.withDescription` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withForceStop` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withName` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withRuntimeEnvironment` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withServiceExecutionRole` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withStartApplication` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withTags` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withTagsAll` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withTimeouts` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
...
`aws.kinesisanalyticsv2_application.withTimeoutsMixin` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application`
Terraform resource block to set or update the timeouts field.
