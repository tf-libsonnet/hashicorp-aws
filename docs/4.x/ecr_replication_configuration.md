...
`aws.ecr_replication_configuration.withReplicationConfiguration` constructs a mixin object that can be merged into the `ecr_replication_configuration`
...
`aws.ecr_replication_configuration.withReplicationConfigurationMixin` constructs a mixin object that can be merged into the `ecr_replication_configuration`
Terraform resource block to set or update the replication_configuration field.
