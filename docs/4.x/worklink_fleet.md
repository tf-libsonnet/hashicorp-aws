...
`aws.worklink_fleet.withAuditStreamArn` constructs a mixin object that can be merged into the `worklink_fleet`
...
`aws.worklink_fleet.withDeviceCaCertificate` constructs a mixin object that can be merged into the `worklink_fleet`
...
`aws.worklink_fleet.withDisplayName` constructs a mixin object that can be merged into the `worklink_fleet`
...
`aws.worklink_fleet.withIdentityProvider` constructs a mixin object that can be merged into the `worklink_fleet`
...
`aws.worklink_fleet.withIdentityProviderMixin` constructs a mixin object that can be merged into the `worklink_fleet`
Terraform resource block to set or update the identity_provider field.
...
`aws.worklink_fleet.withName` constructs a mixin object that can be merged into the `worklink_fleet`
...
`aws.worklink_fleet.withNetwork` constructs a mixin object that can be merged into the `worklink_fleet`
...
`aws.worklink_fleet.withNetworkMixin` constructs a mixin object that can be merged into the `worklink_fleet`
Terraform resource block to set or update the network field.
...
`aws.worklink_fleet.withOptimizeForEndUserLocation` constructs a mixin object that can be merged into the `worklink_fleet`
