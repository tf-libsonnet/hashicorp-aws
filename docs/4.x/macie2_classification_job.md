...
`aws.macie2_classification_job.withCustomDataIdentifierIds` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withDescription` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withInitialRun` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withJobStatus` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withJobType` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withName` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withNamePrefix` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withS3JobDefinition` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withS3JobDefinitionMixin` constructs a mixin object that can be merged into the `macie2_classification_job`
Terraform resource block to set or update the s3_job_definition field.
...
`aws.macie2_classification_job.withSamplingPercentage` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withScheduleFrequency` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withScheduleFrequencyMixin` constructs a mixin object that can be merged into the `macie2_classification_job`
Terraform resource block to set or update the schedule_frequency field.
...
`aws.macie2_classification_job.withTags` constructs a mixin object that can be merged into the `macie2_classification_job`
...
`aws.macie2_classification_job.withTagsAll` constructs a mixin object that can be merged into the `macie2_classification_job`
