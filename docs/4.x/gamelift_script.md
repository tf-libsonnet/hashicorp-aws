...
`aws.gamelift_script.withName` constructs a mixin object that can be merged into the `gamelift_script`
...
`aws.gamelift_script.withStorageLocation` constructs a mixin object that can be merged into the `gamelift_script`
...
`aws.gamelift_script.withStorageLocationMixin` constructs a mixin object that can be merged into the `gamelift_script`
Terraform resource block to set or update the storage_location field.
...
`aws.gamelift_script.withTags` constructs a mixin object that can be merged into the `gamelift_script`
...
`aws.gamelift_script.withTagsAll` constructs a mixin object that can be merged into the `gamelift_script`
...
`aws.gamelift_script.withVersion` constructs a mixin object that can be merged into the `gamelift_script`
...
`aws.gamelift_script.withZipFile` constructs a mixin object that can be merged into the `gamelift_script`
