...
**Args**:
  ...
  - `event_source_name` (`string`): Set the `event_source_name` field on the resulting resource block. When `null`, the `event_source_name` field will be omitted from the resulting object.
...
Unlike [aws.cloudwatch_event_bus.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  - `event_source_name` (`string`): Set the `event_source_name` field on the resulting object. When `null`, the `event_source_name` field will be omitted from the resulting object.
...
`aws.string.withEventSourceName` constructs a mixin object that can be merged into the `string`
