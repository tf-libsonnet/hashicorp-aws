...
`aws.workspaces_directory.withIpGroupIds` constructs a mixin object that can be merged into the `workspaces_directory`
...
`aws.workspaces_directory.withSelfServicePermissions` constructs a mixin object that can be merged into the `workspaces_directory`
...
`aws.workspaces_directory.withSelfServicePermissionsMixin` constructs a mixin object that can be merged into the `workspaces_directory`
Terraform resource block to set or update the self_service_permissions field.
...
`aws.workspaces_directory.withSubnetIds` constructs a mixin object that can be merged into the `workspaces_directory`
...
`aws.workspaces_directory.withTagsAll` constructs a mixin object that can be merged into the `workspaces_directory`
...
`aws.workspaces_directory.withWorkspaceAccessProperties` constructs a mixin object that can be merged into the `workspaces_directory`
...
`aws.workspaces_directory.withWorkspaceAccessPropertiesMixin` constructs a mixin object that can be merged into the `workspaces_directory`
Terraform resource block to set or update the workspace_access_properties field.
...
`aws.workspaces_directory.withWorkspaceCreationProperties` constructs a mixin object that can be merged into the `workspaces_directory`
...
`aws.workspaces_directory.withWorkspaceCreationPropertiesMixin` constructs a mixin object that can be merged into the `workspaces_directory`
Terraform resource block to set or update the workspace_creation_properties field.
