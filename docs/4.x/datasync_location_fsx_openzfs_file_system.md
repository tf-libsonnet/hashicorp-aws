...
`aws.datasync_location_fsx_openzfs_file_system.withFsxFilesystemArn` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`
...
`aws.datasync_location_fsx_openzfs_file_system.withProtocol` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`
...
`aws.datasync_location_fsx_openzfs_file_system.withProtocolMixin` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`
Terraform resource block to set or update the protocol field.
...
`aws.datasync_location_fsx_openzfs_file_system.withSecurityGroupArns` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`
...
`aws.datasync_location_fsx_openzfs_file_system.withSubdirectory` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`
...
`aws.datasync_location_fsx_openzfs_file_system.withTags` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`
...
`aws.datasync_location_fsx_openzfs_file_system.withTagsAll` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`
