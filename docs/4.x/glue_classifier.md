...
`aws.glue_classifier.withCsvClassifier` constructs a mixin object that can be merged into the `glue_classifier`
...
`aws.glue_classifier.withCsvClassifierMixin` constructs a mixin object that can be merged into the `glue_classifier`
Terraform resource block to set or update the csv_classifier field.
...
`aws.glue_classifier.withGrokClassifier` constructs a mixin object that can be merged into the `glue_classifier`
...
`aws.glue_classifier.withGrokClassifierMixin` constructs a mixin object that can be merged into the `glue_classifier`
Terraform resource block to set or update the grok_classifier field.
...
`aws.glue_classifier.withJsonClassifier` constructs a mixin object that can be merged into the `glue_classifier`
...
`aws.glue_classifier.withJsonClassifierMixin` constructs a mixin object that can be merged into the `glue_classifier`
Terraform resource block to set or update the json_classifier field.
...
`aws.glue_classifier.withName` constructs a mixin object that can be merged into the `glue_classifier`
...
`aws.glue_classifier.withXmlClassifier` constructs a mixin object that can be merged into the `glue_classifier`
...
`aws.glue_classifier.withXmlClassifierMixin` constructs a mixin object that can be merged into the `glue_classifier`
Terraform resource block to set or update the xml_classifier field.
