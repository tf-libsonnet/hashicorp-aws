...
`aws.db_parameter_group.withDescription` constructs a mixin object that can be merged into the `db_parameter_group`
...
`aws.db_parameter_group.withFamily` constructs a mixin object that can be merged into the `db_parameter_group`
...
`aws.db_parameter_group.withName` constructs a mixin object that can be merged into the `db_parameter_group`
...
`aws.db_parameter_group.withNamePrefix` constructs a mixin object that can be merged into the `db_parameter_group`
...
`aws.db_parameter_group.withParameter` constructs a mixin object that can be merged into the `db_parameter_group`
...
`aws.db_parameter_group.withParameterMixin` constructs a mixin object that can be merged into the `db_parameter_group`
Terraform resource block to set or update the parameter field.
...
`aws.db_parameter_group.withTags` constructs a mixin object that can be merged into the `db_parameter_group`
...
`aws.db_parameter_group.withTagsAll` constructs a mixin object that can be merged into the `db_parameter_group`
