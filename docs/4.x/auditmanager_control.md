...
`aws.auditmanager_control.withActionPlanInstructions` constructs a mixin object that can be merged into the `auditmanager_control`
...
`aws.auditmanager_control.withActionPlanTitle` constructs a mixin object that can be merged into the `auditmanager_control`
...
`aws.auditmanager_control.withControlMappingSources` constructs a mixin object that can be merged into the `auditmanager_control`
...
`aws.auditmanager_control.withControlMappingSourcesMixin` constructs a mixin object that can be merged into the `auditmanager_control`
Terraform resource block to set or update the control_mapping_sources field.
...
`aws.auditmanager_control.withDescription` constructs a mixin object that can be merged into the `auditmanager_control`
...
`aws.auditmanager_control.withName` constructs a mixin object that can be merged into the `auditmanager_control`
...
`aws.auditmanager_control.withTags` constructs a mixin object that can be merged into the `auditmanager_control`
...
`aws.auditmanager_control.withTestingInformation` constructs a mixin object that can be merged into the `auditmanager_control`
