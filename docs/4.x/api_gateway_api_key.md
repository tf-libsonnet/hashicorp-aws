---
permalink: /api_gateway_api_key/
---

# api_gateway_api_key

`api_gateway_api_key` represents the `aws_api_gateway_api_key` Terraform resource.
...
`aws.api_gateway_api_key.withDescription` constructs a mixin object that can be merged into the `api_gateway_api_key`
...
`aws.api_gateway_api_key.withEnabled` constructs a mixin object that can be merged into the `api_gateway_api_key`
...
`aws.api_gateway_api_key.withName` constructs a mixin object that can be merged into the `api_gateway_api_key`
...
`aws.api_gateway_api_key.withTagsAll` constructs a mixin object that can be merged into the `api_gateway_api_key`
...
`aws.api_gateway_api_key.withValue` constructs a mixin object that can be merged into the `api_gateway_api_key`
