...
`aws.transfer_workflow.withDescription` constructs a mixin object that can be merged into the `transfer_workflow`
...
`aws.transfer_workflow.withOnExceptionSteps` constructs a mixin object that can be merged into the `transfer_workflow`
...
`aws.transfer_workflow.withOnExceptionStepsMixin` constructs a mixin object that can be merged into the `transfer_workflow`
Terraform resource block to set or update the on_exception_steps field.
...
`aws.transfer_workflow.withSteps` constructs a mixin object that can be merged into the `transfer_workflow`
...
`aws.transfer_workflow.withStepsMixin` constructs a mixin object that can be merged into the `transfer_workflow`
Terraform resource block to set or update the steps field.
...
`aws.transfer_workflow.withTags` constructs a mixin object that can be merged into the `transfer_workflow`
...
`aws.transfer_workflow.withTagsAll` constructs a mixin object that can be merged into the `transfer_workflow`
