...
**Args**:
  ...
  - `lifecycle_policy` (`list[obj]`):  When `null`, the `lifecycle_policy` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.efs_file_system.lifecycle_policy.new](#fn-efs_file_systemlifecycle_policynew) constructor.
...
Unlike [aws.efs_file_system.new](#fn-efs_file_systemnew), this function will not inject the `resource`
