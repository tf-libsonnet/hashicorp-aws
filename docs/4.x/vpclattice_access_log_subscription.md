---
permalink: /vpclattice_access_log_subscription/
---

# vpclattice_access_log_subscription

`vpclattice_access_log_subscription` represents the `aws_vpclattice_access_log_subscription` Terraform resource.
