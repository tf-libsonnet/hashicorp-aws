...
`aws.ec2_transit_gateway_vpc_attachment_accepter.withTags` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`
...
`aws.ec2_transit_gateway_vpc_attachment_accepter.withTagsAll` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`
...
`aws.ec2_transit_gateway_vpc_attachment_accepter.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`
...
`aws.ec2_transit_gateway_vpc_attachment_accepter.withTransitGatewayDefaultRouteTableAssociation` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`
...
`aws.ec2_transit_gateway_vpc_attachment_accepter.withTransitGatewayDefaultRouteTablePropagation` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`
