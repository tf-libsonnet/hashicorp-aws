---
permalink: /sagemaker_image/
---

# sagemaker_image

`sagemaker_image` represents the `aws_sagemaker_image` Terraform resource.
...
`aws.sagemaker_image.withDescription` constructs a mixin object that can be merged into the `sagemaker_image`
...
`aws.sagemaker_image.withDisplayName` constructs a mixin object that can be merged into the `sagemaker_image`
...
`aws.sagemaker_image.withImageName` constructs a mixin object that can be merged into the `sagemaker_image`
...
`aws.sagemaker_image.withRoleArn` constructs a mixin object that can be merged into the `sagemaker_image`
...
`aws.sagemaker_image.withTags` constructs a mixin object that can be merged into the `sagemaker_image`
...
`aws.sagemaker_image.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_image`
