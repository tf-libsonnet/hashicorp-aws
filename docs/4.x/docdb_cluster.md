...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.docdb_cluster.timeouts.new](#fn-docdb_clustertimeoutsnew) constructor.
...
Unlike [aws.docdb_cluster.new](#fn-docdb_clusternew), this function will not inject the `resource`
