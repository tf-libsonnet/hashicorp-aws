...
`aws.codeartifact_repository.withDescription` constructs a mixin object that can be merged into the `codeartifact_repository`
...
`aws.codeartifact_repository.withDomain` constructs a mixin object that can be merged into the `codeartifact_repository`
...
`aws.codeartifact_repository.withDomainOwner` constructs a mixin object that can be merged into the `codeartifact_repository`
...
`aws.codeartifact_repository.withExternalConnections` constructs a mixin object that can be merged into the `codeartifact_repository`
...
`aws.codeartifact_repository.withExternalConnectionsMixin` constructs a mixin object that can be merged into the `codeartifact_repository`
Terraform resource block to set or update the external_connections field.
...
`aws.codeartifact_repository.withRepository` constructs a mixin object that can be merged into the `codeartifact_repository`
...
`aws.codeartifact_repository.withTags` constructs a mixin object that can be merged into the `codeartifact_repository`
...
`aws.codeartifact_repository.withTagsAll` constructs a mixin object that can be merged into the `codeartifact_repository`
...
`aws.codeartifact_repository.withUpstream` constructs a mixin object that can be merged into the `codeartifact_repository`
...
`aws.codeartifact_repository.withUpstreamMixin` constructs a mixin object that can be merged into the `codeartifact_repository`
Terraform resource block to set or update the upstream field.
