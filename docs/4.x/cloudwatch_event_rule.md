...
`aws.cloudwatch_event_rule.withDescription` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withEventBusName` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withEventPattern` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withIsEnabled` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withName` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withNamePrefix` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withRoleArn` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withScheduleExpression` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withTags` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
...
`aws.cloudwatch_event_rule.withTagsAll` constructs a mixin object that can be merged into the `cloudwatch_event_rule`
