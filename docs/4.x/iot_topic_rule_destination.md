...
`aws.iot_topic_rule_destination.withEnabled` constructs a mixin object that can be merged into the `iot_topic_rule_destination`
...
`aws.iot_topic_rule_destination.withTimeouts` constructs a mixin object that can be merged into the `iot_topic_rule_destination`
...
`aws.iot_topic_rule_destination.withTimeoutsMixin` constructs a mixin object that can be merged into the `iot_topic_rule_destination`
Terraform resource block to set or update the timeouts field.
...
`aws.iot_topic_rule_destination.withVpcConfiguration` constructs a mixin object that can be merged into the `iot_topic_rule_destination`
...
`aws.iot_topic_rule_destination.withVpcConfigurationMixin` constructs a mixin object that can be merged into the `iot_topic_rule_destination`
Terraform resource block to set or update the vpc_configuration field.
