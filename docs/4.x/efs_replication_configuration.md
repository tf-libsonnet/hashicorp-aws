...
`aws.efs_replication_configuration.withDestination` constructs a mixin object that can be merged into the `efs_replication_configuration`
...
`aws.efs_replication_configuration.withDestinationMixin` constructs a mixin object that can be merged into the `efs_replication_configuration`
Terraform resource block to set or update the destination field.
...
`aws.efs_replication_configuration.withSourceFileSystemId` constructs a mixin object that can be merged into the `efs_replication_configuration`
...
`aws.efs_replication_configuration.withTimeouts` constructs a mixin object that can be merged into the `efs_replication_configuration`
...
`aws.efs_replication_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `efs_replication_configuration`
Terraform resource block to set or update the timeouts field.
