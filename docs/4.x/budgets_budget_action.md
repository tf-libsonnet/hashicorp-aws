...
`aws.budgets_budget_action.withAccountId` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withActionThreshold` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withActionThresholdMixin` constructs a mixin object that can be merged into the `budgets_budget_action`
Terraform resource block to set or update the action_threshold field.
...
`aws.budgets_budget_action.withActionType` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withApprovalModel` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withBudgetName` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withDefinition` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withDefinitionMixin` constructs a mixin object that can be merged into the `budgets_budget_action`
Terraform resource block to set or update the definition field.
...
`aws.budgets_budget_action.withExecutionRoleArn` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withNotificationType` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withSubscriber` constructs a mixin object that can be merged into the `budgets_budget_action`
...
`aws.budgets_budget_action.withSubscriberMixin` constructs a mixin object that can be merged into the `budgets_budget_action`
Terraform resource block to set or update the subscriber field.
