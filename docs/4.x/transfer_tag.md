...
`aws.transfer_tag.withKey` constructs a mixin object that can be merged into the `transfer_tag`
...
`aws.transfer_tag.withResourceArn` constructs a mixin object that can be merged into the `transfer_tag`
...
`aws.transfer_tag.withValue` constructs a mixin object that can be merged into the `transfer_tag`
