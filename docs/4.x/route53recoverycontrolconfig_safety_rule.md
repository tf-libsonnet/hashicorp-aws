...
`aws.route53recoverycontrolconfig_safety_rule.withAssertedControls` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_safety_rule`
...
`aws.route53recoverycontrolconfig_safety_rule.withControlPanelArn` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_safety_rule`
...
`aws.route53recoverycontrolconfig_safety_rule.withGatingControls` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_safety_rule`
...
`aws.route53recoverycontrolconfig_safety_rule.withName` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_safety_rule`
...
`aws.route53recoverycontrolconfig_safety_rule.withRuleConfig` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_safety_rule`
...
`aws.route53recoverycontrolconfig_safety_rule.withRuleConfigMixin` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_safety_rule`
Terraform resource block to set or update the rule_config field.
...
`aws.route53recoverycontrolconfig_safety_rule.withTargetControls` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_safety_rule`
...
`aws.route53recoverycontrolconfig_safety_rule.withWaitPeriodMs` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_safety_rule`
