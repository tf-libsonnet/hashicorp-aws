...
`aws.lex_bot.withAbortStatement` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withAbortStatementMixin` constructs a mixin object that can be merged into the `lex_bot`
Terraform resource block to set or update the abort_statement field.
...
`aws.lex_bot.withChildDirected` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withClarificationPrompt` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withClarificationPromptMixin` constructs a mixin object that can be merged into the `lex_bot`
Terraform resource block to set or update the clarification_prompt field.
...
`aws.lex_bot.withCreateVersion` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withDescription` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withDetectSentiment` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withEnableModelImprovements` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withIdleSessionTtlInSeconds` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withIntent` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withIntentMixin` constructs a mixin object that can be merged into the `lex_bot`
Terraform resource block to set or update the intent field.
...
`aws.lex_bot.withLocale` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withName` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withNluIntentConfidenceThreshold` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withProcessBehavior` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withTimeouts` constructs a mixin object that can be merged into the `lex_bot`
...
`aws.lex_bot.withTimeoutsMixin` constructs a mixin object that can be merged into the `lex_bot`
Terraform resource block to set or update the timeouts field.
...
`aws.lex_bot.withVoiceId` constructs a mixin object that can be merged into the `lex_bot`
