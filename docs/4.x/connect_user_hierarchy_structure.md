...
`aws.connect_user_hierarchy_structure.withHierarchyStructure` constructs a mixin object that can be merged into the `connect_user_hierarchy_structure`
...
`aws.connect_user_hierarchy_structure.withHierarchyStructureMixin` constructs a mixin object that can be merged into the `connect_user_hierarchy_structure`
Terraform resource block to set or update the hierarchy_structure field.
...
`aws.connect_user_hierarchy_structure.withInstanceId` constructs a mixin object that can be merged into the `connect_user_hierarchy_structure`
