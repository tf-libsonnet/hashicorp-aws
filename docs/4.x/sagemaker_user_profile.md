...
`aws.sagemaker_user_profile.withDomainId` constructs a mixin object that can be merged into the `sagemaker_user_profile`
...
`aws.sagemaker_user_profile.withSingleSignOnUserIdentifier` constructs a mixin object that can be merged into the `sagemaker_user_profile`
...
`aws.sagemaker_user_profile.withSingleSignOnUserValue` constructs a mixin object that can be merged into the `sagemaker_user_profile`
...
`aws.sagemaker_user_profile.withTags` constructs a mixin object that can be merged into the `sagemaker_user_profile`
...
`aws.sagemaker_user_profile.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_user_profile`
...
`aws.sagemaker_user_profile.withUserProfileName` constructs a mixin object that can be merged into the `sagemaker_user_profile`
...
`aws.sagemaker_user_profile.withUserSettings` constructs a mixin object that can be merged into the `sagemaker_user_profile`
...
`aws.sagemaker_user_profile.withUserSettingsMixin` constructs a mixin object that can be merged into the `sagemaker_user_profile`
Terraform resource block to set or update the user_settings field.
