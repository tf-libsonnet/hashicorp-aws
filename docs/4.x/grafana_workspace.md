...
`aws.grafana_workspace.withAccountAccessType` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withAuthenticationProviders` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withDataSources` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withDescription` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withName` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withNotificationDestinations` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withOrganizationRoleName` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withOrganizationalUnits` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withPermissionType` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withRoleArn` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withStackSetName` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withTags` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withTagsAll` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withTimeouts` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withTimeoutsMixin` constructs a mixin object that can be merged into the `grafana_workspace`
Terraform resource block to set or update the timeouts field.
...
`aws.grafana_workspace.withVpcConfiguration` constructs a mixin object that can be merged into the `grafana_workspace`
...
`aws.grafana_workspace.withVpcConfigurationMixin` constructs a mixin object that can be merged into the `grafana_workspace`
Terraform resource block to set or update the vpc_configuration field.
