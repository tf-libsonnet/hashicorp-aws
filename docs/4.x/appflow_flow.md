...
`aws.appflow_flow.withDescription` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withDestinationFlowConfig` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withDestinationFlowConfigMixin` constructs a mixin object that can be merged into the `appflow_flow`
Terraform resource block to set or update the destination_flow_config field.
...
`aws.appflow_flow.withKmsArn` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withName` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withSourceFlowConfig` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withSourceFlowConfigMixin` constructs a mixin object that can be merged into the `appflow_flow`
Terraform resource block to set or update the source_flow_config field.
...
`aws.appflow_flow.withTags` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withTagsAll` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withTask` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withTaskMixin` constructs a mixin object that can be merged into the `appflow_flow`
Terraform resource block to set or update the task field.
...
`aws.appflow_flow.withTriggerConfig` constructs a mixin object that can be merged into the `appflow_flow`
...
`aws.appflow_flow.withTriggerConfigMixin` constructs a mixin object that can be merged into the `appflow_flow`
Terraform resource block to set or update the trigger_config field.
