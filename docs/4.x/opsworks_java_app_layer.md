...
`aws.opsworks_java_app_layer.withAppServer` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withAppServerVersion` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withAutoAssignElasticIps` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withAutoAssignPublicIps` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withAutoHealing` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCloudwatchConfiguration` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCloudwatchConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
Terraform resource block to set or update the cloudwatch_configuration field.
...
`aws.opsworks_java_app_layer.withCustomConfigureRecipes` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCustomDeployRecipes` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCustomInstanceProfileArn` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCustomJson` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCustomSecurityGroupIds` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCustomSetupRecipes` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCustomShutdownRecipes` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withCustomUndeployRecipes` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withDrainElbOnShutdown` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withEbsVolume` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withEbsVolumeMixin` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
Terraform resource block to set or update the ebs_volume field.
...
`aws.opsworks_java_app_layer.withElasticLoadBalancer` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withInstallUpdatesOnBoot` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withInstanceShutdownTimeout` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withJvmOptions` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withJvmType` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withJvmVersion` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withLoadBasedAutoScaling` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withLoadBasedAutoScalingMixin` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
Terraform resource block to set or update the load_based_auto_scaling field.
...
`aws.opsworks_java_app_layer.withName` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withStackId` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withSystemPackages` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withTags` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withTagsAll` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
...
`aws.opsworks_java_app_layer.withUseEbsOptimizedInstances` constructs a mixin object that can be merged into the `opsworks_java_app_layer`
