...
`aws.wafregional_web_acl.withDefaultAction` constructs a mixin object that can be merged into the `wafregional_web_acl`
...
`aws.wafregional_web_acl.withDefaultActionMixin` constructs a mixin object that can be merged into the `wafregional_web_acl`
Terraform resource block to set or update the default_action field.
...
`aws.wafregional_web_acl.withLoggingConfiguration` constructs a mixin object that can be merged into the `wafregional_web_acl`
...
`aws.wafregional_web_acl.withLoggingConfigurationMixin` constructs a mixin object that can be merged into the `wafregional_web_acl`
Terraform resource block to set or update the logging_configuration field.
...
`aws.wafregional_web_acl.withMetricName` constructs a mixin object that can be merged into the `wafregional_web_acl`
...
`aws.wafregional_web_acl.withRule` constructs a mixin object that can be merged into the `wafregional_web_acl`
...
`aws.wafregional_web_acl.withRuleMixin` constructs a mixin object that can be merged into the `wafregional_web_acl`
Terraform resource block to set or update the rule field.
...
`aws.wafregional_web_acl.withTags` constructs a mixin object that can be merged into the `wafregional_web_acl`
...
`aws.wafregional_web_acl.withTagsAll` constructs a mixin object that can be merged into the `wafregional_web_acl`
