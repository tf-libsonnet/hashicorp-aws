...
`aws.kinesis_analytics_application.withCloudwatchLoggingOptions` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withCloudwatchLoggingOptionsMixin` constructs a mixin object that can be merged into the `kinesis_analytics_application`
Terraform resource block to set or update the cloudwatch_logging_options field.
...
`aws.kinesis_analytics_application.withCode` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withDescription` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withInputs` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withInputsMixin` constructs a mixin object that can be merged into the `kinesis_analytics_application`
Terraform resource block to set or update the inputs field.
...
`aws.kinesis_analytics_application.withName` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withOutputs` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withOutputsMixin` constructs a mixin object that can be merged into the `kinesis_analytics_application`
Terraform resource block to set or update the outputs field.
...
`aws.kinesis_analytics_application.withReferenceDataSources` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withReferenceDataSourcesMixin` constructs a mixin object that can be merged into the `kinesis_analytics_application`
Terraform resource block to set or update the reference_data_sources field.
...
`aws.kinesis_analytics_application.withStartApplication` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withTags` constructs a mixin object that can be merged into the `kinesis_analytics_application`
...
`aws.kinesis_analytics_application.withTagsAll` constructs a mixin object that can be merged into the `kinesis_analytics_application`
