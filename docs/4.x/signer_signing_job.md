...
`aws.signer_signing_job.withDestination` constructs a mixin object that can be merged into the `signer_signing_job`
...
`aws.signer_signing_job.withDestinationMixin` constructs a mixin object that can be merged into the `signer_signing_job`
Terraform resource block to set or update the destination field.
...
`aws.signer_signing_job.withIgnoreSigningJobFailure` constructs a mixin object that can be merged into the `signer_signing_job`
...
`aws.signer_signing_job.withProfileName` constructs a mixin object that can be merged into the `signer_signing_job`
...
`aws.signer_signing_job.withSource` constructs a mixin object that can be merged into the `signer_signing_job`
...
`aws.signer_signing_job.withSourceMixin` constructs a mixin object that can be merged into the `signer_signing_job`
Terraform resource block to set or update the source field.
