...
`aws.organizations_policy.withContent` constructs a mixin object that can be merged into the `organizations_policy`
...
`aws.organizations_policy.withDescription` constructs a mixin object that can be merged into the `organizations_policy`
...
`aws.organizations_policy.withName` constructs a mixin object that can be merged into the `organizations_policy`
...
`aws.organizations_policy.withTags` constructs a mixin object that can be merged into the `organizations_policy`
...
`aws.organizations_policy.withTagsAll` constructs a mixin object that can be merged into the `organizations_policy`
...
`aws.organizations_policy.withType` constructs a mixin object that can be merged into the `organizations_policy`
