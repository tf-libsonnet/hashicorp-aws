...
`aws.vpc_endpoint_policy.withPolicy` constructs a mixin object that can be merged into the `vpc_endpoint_policy`
...
`aws.vpc_endpoint_policy.withTimeouts` constructs a mixin object that can be merged into the `vpc_endpoint_policy`
...
`aws.vpc_endpoint_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpc_endpoint_policy`
Terraform resource block to set or update the timeouts field.
...
`aws.vpc_endpoint_policy.withVpcEndpointId` constructs a mixin object that can be merged into the `vpc_endpoint_policy`
