...
`aws.db_proxy_default_target_group.withConnectionPoolConfig` constructs a mixin object that can be merged into the `db_proxy_default_target_group`
...
`aws.db_proxy_default_target_group.withConnectionPoolConfigMixin` constructs a mixin object that can be merged into the `db_proxy_default_target_group`
Terraform resource block to set or update the connection_pool_config field.
...
`aws.db_proxy_default_target_group.withDbProxyName` constructs a mixin object that can be merged into the `db_proxy_default_target_group`
...
`aws.db_proxy_default_target_group.withTimeouts` constructs a mixin object that can be merged into the `db_proxy_default_target_group`
...
`aws.db_proxy_default_target_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `db_proxy_default_target_group`
Terraform resource block to set or update the timeouts field.
