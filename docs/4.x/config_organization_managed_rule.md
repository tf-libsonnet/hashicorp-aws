...
`aws.config_organization_managed_rule.withDescription` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withExcludedAccounts` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withInputParameters` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withMaximumExecutionFrequency` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withName` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withResourceIdScope` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withResourceTypesScope` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withRuleIdentifier` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withTagKeyScope` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withTagValueScope` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withTimeouts` constructs a mixin object that can be merged into the `config_organization_managed_rule`
...
`aws.config_organization_managed_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `config_organization_managed_rule`
Terraform resource block to set or update the timeouts field.
