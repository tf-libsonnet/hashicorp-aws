...
`aws.kendra_thesaurus.withDescription` constructs a mixin object that can be merged into the `kendra_thesaurus`
...
`aws.kendra_thesaurus.withName` constructs a mixin object that can be merged into the `kendra_thesaurus`
...
`aws.kendra_thesaurus.withRoleArn` constructs a mixin object that can be merged into the `kendra_thesaurus`
...
`aws.kendra_thesaurus.withSourceS3Path` constructs a mixin object that can be merged into the `kendra_thesaurus`
...
`aws.kendra_thesaurus.withSourceS3PathMixin` constructs a mixin object that can be merged into the `kendra_thesaurus`
Terraform resource block to set or update the source_s3_path field.
...
`aws.kendra_thesaurus.withTagsAll` constructs a mixin object that can be merged into the `kendra_thesaurus`
...
`aws.kendra_thesaurus.withTimeouts` constructs a mixin object that can be merged into the `kendra_thesaurus`
...
`aws.kendra_thesaurus.withTimeoutsMixin` constructs a mixin object that can be merged into the `kendra_thesaurus`
Terraform resource block to set or update the timeouts field.
