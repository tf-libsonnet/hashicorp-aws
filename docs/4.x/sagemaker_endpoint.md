...
`aws.sagemaker_endpoint.withDeploymentConfig` constructs a mixin object that can be merged into the `sagemaker_endpoint`
...
`aws.sagemaker_endpoint.withDeploymentConfigMixin` constructs a mixin object that can be merged into the `sagemaker_endpoint`
Terraform resource block to set or update the deployment_config field.
...
`aws.sagemaker_endpoint.withEndpointConfigName` constructs a mixin object that can be merged into the `sagemaker_endpoint`
...
`aws.sagemaker_endpoint.withName` constructs a mixin object that can be merged into the `sagemaker_endpoint`
...
`aws.sagemaker_endpoint.withTags` constructs a mixin object that can be merged into the `sagemaker_endpoint`
...
`aws.sagemaker_endpoint.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_endpoint`
