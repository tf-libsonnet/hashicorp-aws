...
`aws.opsworks_static_web_layer.withAutoAssignElasticIps` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withAutoAssignPublicIps` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withAutoHealing` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCloudwatchConfiguration` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCloudwatchConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
Terraform resource block to set or update the cloudwatch_configuration field.
...
`aws.opsworks_static_web_layer.withCustomConfigureRecipes` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCustomDeployRecipes` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCustomInstanceProfileArn` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCustomJson` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCustomSecurityGroupIds` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCustomSetupRecipes` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCustomShutdownRecipes` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withCustomUndeployRecipes` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withDrainElbOnShutdown` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withEbsVolume` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withEbsVolumeMixin` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
Terraform resource block to set or update the ebs_volume field.
...
`aws.opsworks_static_web_layer.withElasticLoadBalancer` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withInstallUpdatesOnBoot` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withInstanceShutdownTimeout` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withLoadBasedAutoScaling` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withLoadBasedAutoScalingMixin` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
Terraform resource block to set or update the load_based_auto_scaling field.
...
`aws.opsworks_static_web_layer.withName` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withStackId` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withSystemPackages` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withTags` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withTagsAll` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
...
`aws.opsworks_static_web_layer.withUseEbsOptimizedInstances` constructs a mixin object that can be merged into the `opsworks_static_web_layer`
