...
`aws.neptune_event_subscription.withEnabled` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withEventCategories` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withName` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withNamePrefix` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withSnsTopicArn` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withSourceIds` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withSourceType` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withTags` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withTagsAll` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withTimeouts` constructs a mixin object that can be merged into the `neptune_event_subscription`
...
`aws.neptune_event_subscription.withTimeoutsMixin` constructs a mixin object that can be merged into the `neptune_event_subscription`
Terraform resource block to set or update the timeouts field.
