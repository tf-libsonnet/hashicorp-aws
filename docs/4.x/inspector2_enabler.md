...
`aws.inspector2_enabler.withAccountIds` constructs a mixin object that can be merged into the `inspector2_enabler`
...
`aws.inspector2_enabler.withResourceTypes` constructs a mixin object that can be merged into the `inspector2_enabler`
...
`aws.inspector2_enabler.withTimeouts` constructs a mixin object that can be merged into the `inspector2_enabler`
...
`aws.inspector2_enabler.withTimeoutsMixin` constructs a mixin object that can be merged into the `inspector2_enabler`
Terraform resource block to set or update the timeouts field.
