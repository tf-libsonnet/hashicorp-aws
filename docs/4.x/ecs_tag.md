...
`aws.ecs_tag.withKey` constructs a mixin object that can be merged into the `ecs_tag`
...
`aws.ecs_tag.withResourceArn` constructs a mixin object that can be merged into the `ecs_tag`
...
`aws.ecs_tag.withValue` constructs a mixin object that can be merged into the `ecs_tag`
