...
`aws.evidently_project.withDataDelivery` constructs a mixin object that can be merged into the `evidently_project`
...
`aws.evidently_project.withDataDeliveryMixin` constructs a mixin object that can be merged into the `evidently_project`
Terraform resource block to set or update the data_delivery field.
...
`aws.evidently_project.withDescription` constructs a mixin object that can be merged into the `evidently_project`
...
`aws.evidently_project.withName` constructs a mixin object that can be merged into the `evidently_project`
...
`aws.evidently_project.withTags` constructs a mixin object that can be merged into the `evidently_project`
...
`aws.evidently_project.withTagsAll` constructs a mixin object that can be merged into the `evidently_project`
...
`aws.evidently_project.withTimeouts` constructs a mixin object that can be merged into the `evidently_project`
...
`aws.evidently_project.withTimeoutsMixin` constructs a mixin object that can be merged into the `evidently_project`
Terraform resource block to set or update the timeouts field.
