---
permalink: /glue_data_quality_ruleset/
---

# glue_data_quality_ruleset

`glue_data_quality_ruleset` represents the `aws_glue_data_quality_ruleset` Terraform resource.
...
`aws.string.withRuleset` constructs a mixin object that can be merged into the `string`
