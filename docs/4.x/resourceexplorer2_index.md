...
`aws.resourceexplorer2_index.withTags` constructs a mixin object that can be merged into the `resourceexplorer2_index`
...
`aws.resourceexplorer2_index.withTimeouts` constructs a mixin object that can be merged into the `resourceexplorer2_index`
...
`aws.resourceexplorer2_index.withTimeoutsMixin` constructs a mixin object that can be merged into the `resourceexplorer2_index`
Terraform resource block to set or update the timeouts field.

This function will merge the passed in value to the existing map. If you wish
to instead replace the entire map with the passed in `value`, use the [aws.resourceexplorer2_index.withTimeouts](TODO)
function.
...
`aws.resourceexplorer2_index.withType` constructs a mixin object that can be merged into the `resourceexplorer2_index`
