...
`aws.ebs_snapshot_import.withClientData` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withClientDataMixin` constructs a mixin object that can be merged into the `ebs_snapshot_import`
Terraform resource block to set or update the client_data field.
...
`aws.ebs_snapshot_import.withDescription` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withDiskContainer` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withDiskContainerMixin` constructs a mixin object that can be merged into the `ebs_snapshot_import`
Terraform resource block to set or update the disk_container field.
...
`aws.ebs_snapshot_import.withEncrypted` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withKmsKeyId` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withPermanentRestore` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withRoleName` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withStorageTier` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withTags` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withTagsAll` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withTemporaryRestoreDays` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withTimeouts` constructs a mixin object that can be merged into the `ebs_snapshot_import`
...
`aws.ebs_snapshot_import.withTimeoutsMixin` constructs a mixin object that can be merged into the `ebs_snapshot_import`
Terraform resource block to set or update the timeouts field.
