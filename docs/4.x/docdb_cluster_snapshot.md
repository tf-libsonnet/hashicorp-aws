...
`aws.docdb_cluster_snapshot.withDbClusterIdentifier` constructs a mixin object that can be merged into the `docdb_cluster_snapshot`
...
`aws.docdb_cluster_snapshot.withDbClusterSnapshotIdentifier` constructs a mixin object that can be merged into the `docdb_cluster_snapshot`
...
`aws.docdb_cluster_snapshot.withTimeouts` constructs a mixin object that can be merged into the `docdb_cluster_snapshot`
...
`aws.docdb_cluster_snapshot.withTimeoutsMixin` constructs a mixin object that can be merged into the `docdb_cluster_snapshot`
Terraform resource block to set or update the timeouts field.
