...
`aws.kms_replica_key.withBypassPolicyLockoutSafetyCheck` constructs a mixin object that can be merged into the `kms_replica_key`
...
`aws.kms_replica_key.withDeletionWindowInDays` constructs a mixin object that can be merged into the `kms_replica_key`
...
`aws.kms_replica_key.withDescription` constructs a mixin object that can be merged into the `kms_replica_key`
...
`aws.kms_replica_key.withEnabled` constructs a mixin object that can be merged into the `kms_replica_key`
...
`aws.kms_replica_key.withPolicy` constructs a mixin object that can be merged into the `kms_replica_key`
...
`aws.kms_replica_key.withPrimaryKeyArn` constructs a mixin object that can be merged into the `kms_replica_key`
...
`aws.kms_replica_key.withTags` constructs a mixin object that can be merged into the `kms_replica_key`
...
`aws.kms_replica_key.withTagsAll` constructs a mixin object that can be merged into the `kms_replica_key`
