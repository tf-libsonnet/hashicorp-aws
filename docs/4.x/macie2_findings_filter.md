...
`aws.macie2_findings_filter.withAction` constructs a mixin object that can be merged into the `macie2_findings_filter`
...
`aws.macie2_findings_filter.withDescription` constructs a mixin object that can be merged into the `macie2_findings_filter`
...
`aws.macie2_findings_filter.withFindingCriteria` constructs a mixin object that can be merged into the `macie2_findings_filter`
...
`aws.macie2_findings_filter.withFindingCriteriaMixin` constructs a mixin object that can be merged into the `macie2_findings_filter`
Terraform resource block to set or update the finding_criteria field.
...
`aws.macie2_findings_filter.withName` constructs a mixin object that can be merged into the `macie2_findings_filter`
...
`aws.macie2_findings_filter.withNamePrefix` constructs a mixin object that can be merged into the `macie2_findings_filter`
...
`aws.macie2_findings_filter.withPosition` constructs a mixin object that can be merged into the `macie2_findings_filter`
...
`aws.macie2_findings_filter.withTags` constructs a mixin object that can be merged into the `macie2_findings_filter`
...
`aws.macie2_findings_filter.withTagsAll` constructs a mixin object that can be merged into the `macie2_findings_filter`
