...
`aws.cloudfront_response_headers_policy.withComment` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
...
`aws.cloudfront_response_headers_policy.withCorsConfig` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
...
`aws.cloudfront_response_headers_policy.withCorsConfigMixin` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
Terraform resource block to set or update the cors_config field.
...
`aws.cloudfront_response_headers_policy.withCustomHeadersConfig` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
...
`aws.cloudfront_response_headers_policy.withCustomHeadersConfigMixin` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
Terraform resource block to set or update the custom_headers_config field.
...
`aws.cloudfront_response_headers_policy.withEtag` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
...
`aws.cloudfront_response_headers_policy.withSecurityHeadersConfig` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
...
`aws.cloudfront_response_headers_policy.withSecurityHeadersConfigMixin` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
Terraform resource block to set or update the security_headers_config field.
...
`aws.cloudfront_response_headers_policy.withServerTimingHeadersConfig` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
...
`aws.cloudfront_response_headers_policy.withServerTimingHeadersConfigMixin` constructs a mixin object that can be merged into the `cloudfront_response_headers_policy`
Terraform resource block to set or update the server_timing_headers_config field.
