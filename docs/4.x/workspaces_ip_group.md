...
**Args**:
  ...
  - `rules` (`list[obj]`):  When `null`, the `rules` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.workspaces_ip_group.rules.new](#fn-workspaces_ip_grouprulesnew) constructor.
...
Unlike [aws.workspaces_ip_group.new](#fn-workspaces_ip_groupnew), this function will not inject the `resource`
