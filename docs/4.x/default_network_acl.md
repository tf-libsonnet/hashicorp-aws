...
`aws.default_network_acl.withDefaultNetworkAclId` constructs a mixin object that can be merged into the `default_network_acl`
...
`aws.default_network_acl.withEgress` constructs a mixin object that can be merged into the `default_network_acl`
...
`aws.default_network_acl.withEgressMixin` constructs a mixin object that can be merged into the `default_network_acl`
Terraform resource block to set or update the egress field.
...
`aws.default_network_acl.withIngress` constructs a mixin object that can be merged into the `default_network_acl`
...
`aws.default_network_acl.withIngressMixin` constructs a mixin object that can be merged into the `default_network_acl`
Terraform resource block to set or update the ingress field.
...
`aws.default_network_acl.withSubnetIds` constructs a mixin object that can be merged into the `default_network_acl`
...
`aws.default_network_acl.withTags` constructs a mixin object that can be merged into the `default_network_acl`
...
`aws.default_network_acl.withTagsAll` constructs a mixin object that can be merged into the `default_network_acl`
