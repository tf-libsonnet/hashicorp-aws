...
`aws.connect_security_profile.withDescription` constructs a mixin object that can be merged into the `connect_security_profile`
...
`aws.connect_security_profile.withPermissions` constructs a mixin object that can be merged into the `connect_security_profile`
...
`aws.connect_security_profile.withTagsAll` constructs a mixin object that can be merged into the `connect_security_profile`
