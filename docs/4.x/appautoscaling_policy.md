...
`aws.appautoscaling_policy.withName` constructs a mixin object that can be merged into the `appautoscaling_policy`
...
`aws.appautoscaling_policy.withPolicyType` constructs a mixin object that can be merged into the `appautoscaling_policy`
...
`aws.appautoscaling_policy.withResourceId` constructs a mixin object that can be merged into the `appautoscaling_policy`
...
`aws.appautoscaling_policy.withScalableDimension` constructs a mixin object that can be merged into the `appautoscaling_policy`
...
`aws.appautoscaling_policy.withServiceNamespace` constructs a mixin object that can be merged into the `appautoscaling_policy`
...
`aws.appautoscaling_policy.withStepScalingPolicyConfiguration` constructs a mixin object that can be merged into the `appautoscaling_policy`
...
`aws.appautoscaling_policy.withStepScalingPolicyConfigurationMixin` constructs a mixin object that can be merged into the `appautoscaling_policy`
Terraform resource block to set or update the step_scaling_policy_configuration field.
...
`aws.appautoscaling_policy.withTargetTrackingScalingPolicyConfiguration` constructs a mixin object that can be merged into the `appautoscaling_policy`
...
`aws.appautoscaling_policy.withTargetTrackingScalingPolicyConfigurationMixin` constructs a mixin object that can be merged into the `appautoscaling_policy`
Terraform resource block to set or update the target_tracking_scaling_policy_configuration field.
