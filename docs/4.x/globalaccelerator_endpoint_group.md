...
`aws.globalaccelerator_endpoint_group.withEndpointConfiguration` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withEndpointConfigurationMixin` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
Terraform resource block to set or update the endpoint_configuration field.
...
`aws.globalaccelerator_endpoint_group.withEndpointGroupRegion` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withHealthCheckIntervalSeconds` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withHealthCheckPath` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withHealthCheckPort` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withHealthCheckProtocol` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withListenerArn` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withPortOverride` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withPortOverrideMixin` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
Terraform resource block to set or update the port_override field.
...
`aws.globalaccelerator_endpoint_group.withThresholdCount` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withTimeouts` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
...
`aws.globalaccelerator_endpoint_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
Terraform resource block to set or update the timeouts field.
...
`aws.globalaccelerator_endpoint_group.withTrafficDialPercentage` constructs a mixin object that can be merged into the `globalaccelerator_endpoint_group`
