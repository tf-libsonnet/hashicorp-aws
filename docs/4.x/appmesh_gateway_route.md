...
`aws.appmesh_gateway_route.withMeshName` constructs a mixin object that can be merged into the `appmesh_gateway_route`
...
`aws.appmesh_gateway_route.withMeshOwner` constructs a mixin object that can be merged into the `appmesh_gateway_route`
...
`aws.appmesh_gateway_route.withName` constructs a mixin object that can be merged into the `appmesh_gateway_route`
...
`aws.appmesh_gateway_route.withSpec` constructs a mixin object that can be merged into the `appmesh_gateway_route`
...
`aws.appmesh_gateway_route.withSpecMixin` constructs a mixin object that can be merged into the `appmesh_gateway_route`
Terraform resource block to set or update the spec field.
...
`aws.appmesh_gateway_route.withTags` constructs a mixin object that can be merged into the `appmesh_gateway_route`
...
`aws.appmesh_gateway_route.withTagsAll` constructs a mixin object that can be merged into the `appmesh_gateway_route`
...
`aws.appmesh_gateway_route.withVirtualGatewayName` constructs a mixin object that can be merged into the `appmesh_gateway_route`
