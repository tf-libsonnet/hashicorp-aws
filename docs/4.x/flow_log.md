...
`aws.flow_log.withDestinationOptions` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withDestinationOptionsMixin` constructs a mixin object that can be merged into the `flow_log`
Terraform resource block to set or update the destination_options field.
...
`aws.flow_log.withEniId` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withIamRoleArn` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withLogDestination` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withLogDestinationType` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withLogFormat` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withLogGroupName` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withMaxAggregationInterval` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withSubnetId` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withTags` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withTagsAll` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withTrafficType` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withTransitGatewayId` constructs a mixin object that can be merged into the `flow_log`
...
`aws.flow_log.withVpcId` constructs a mixin object that can be merged into the `flow_log`
