...
**Args**:
  ...
  - `workflow_execution_retention_period_in_days` (`string`): Set the `workflow_execution_retention_period_in_days` field on the resulting resource block.
...
**Args**:
  ...
  - `workflow_execution_retention_period_in_days` (`string`): Set the `workflow_execution_retention_period_in_days` field on the resulting object.
...
`aws.string.withWorkflowExecutionRetentionPeriodInDays` constructs a mixin object that can be merged into the `string`
