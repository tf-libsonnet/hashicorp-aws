...
`aws.elasticache_user.withArn` constructs a mixin object that can be merged into the `elasticache_user`
...
`aws.elasticache_user.withTags` constructs a mixin object that can be merged into the `elasticache_user`
...
`aws.elasticache_user.withTagsAll` constructs a mixin object that can be merged into the `elasticache_user`
