...
`aws.lightsail_container_service_deployment_version.withContainer` constructs a mixin object that can be merged into the `lightsail_container_service_deployment_version`
...
`aws.lightsail_container_service_deployment_version.withContainerMixin` constructs a mixin object that can be merged into the `lightsail_container_service_deployment_version`
Terraform resource block to set or update the container field.
...
`aws.lightsail_container_service_deployment_version.withPublicEndpoint` constructs a mixin object that can be merged into the `lightsail_container_service_deployment_version`
...
`aws.lightsail_container_service_deployment_version.withPublicEndpointMixin` constructs a mixin object that can be merged into the `lightsail_container_service_deployment_version`
Terraform resource block to set or update the public_endpoint field.
...
`aws.lightsail_container_service_deployment_version.withServiceName` constructs a mixin object that can be merged into the `lightsail_container_service_deployment_version`
...
`aws.lightsail_container_service_deployment_version.withTimeouts` constructs a mixin object that can be merged into the `lightsail_container_service_deployment_version`
...
`aws.lightsail_container_service_deployment_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `lightsail_container_service_deployment_version`
Terraform resource block to set or update the timeouts field.
