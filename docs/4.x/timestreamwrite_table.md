...
`aws.timestreamwrite_table.withDatabaseName` constructs a mixin object that can be merged into the `timestreamwrite_table`
...
`aws.timestreamwrite_table.withMagneticStoreWriteProperties` constructs a mixin object that can be merged into the `timestreamwrite_table`
...
`aws.timestreamwrite_table.withMagneticStoreWritePropertiesMixin` constructs a mixin object that can be merged into the `timestreamwrite_table`
Terraform resource block to set or update the magnetic_store_write_properties field.
...
`aws.timestreamwrite_table.withRetentionProperties` constructs a mixin object that can be merged into the `timestreamwrite_table`
...
`aws.timestreamwrite_table.withRetentionPropertiesMixin` constructs a mixin object that can be merged into the `timestreamwrite_table`
Terraform resource block to set or update the retention_properties field.
...
`aws.timestreamwrite_table.withTableName` constructs a mixin object that can be merged into the `timestreamwrite_table`
...
`aws.timestreamwrite_table.withTags` constructs a mixin object that can be merged into the `timestreamwrite_table`
...
`aws.timestreamwrite_table.withTagsAll` constructs a mixin object that can be merged into the `timestreamwrite_table`
