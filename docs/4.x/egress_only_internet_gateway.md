---
permalink: /egress_only_internet_gateway/
---

# egress_only_internet_gateway

`egress_only_internet_gateway` represents the `aws_egress_only_internet_gateway` Terraform resource.
...
`aws.egress_only_internet_gateway.withTags` constructs a mixin object that can be merged into the `egress_only_internet_gateway`
...
`aws.egress_only_internet_gateway.withTagsAll` constructs a mixin object that can be merged into the `egress_only_internet_gateway`
...
`aws.egress_only_internet_gateway.withVpcId` constructs a mixin object that can be merged into the `egress_only_internet_gateway`
