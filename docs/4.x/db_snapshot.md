...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.db_snapshot.timeouts.new](#fn-db_snapshottimeoutsnew) constructor.
...
Unlike [aws.db_snapshot.new](#fn-db_snapshotnew), this function will not inject the `resource`
