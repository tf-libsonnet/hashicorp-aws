...
`aws.athena_database.withAclConfiguration` constructs a mixin object that can be merged into the `athena_database`
...
`aws.athena_database.withAclConfigurationMixin` constructs a mixin object that can be merged into the `athena_database`
Terraform resource block to set or update the acl_configuration field.
...
`aws.athena_database.withBucket` constructs a mixin object that can be merged into the `athena_database`
...
`aws.athena_database.withComment` constructs a mixin object that can be merged into the `athena_database`
...
`aws.athena_database.withEncryptionConfiguration` constructs a mixin object that can be merged into the `athena_database`
...
`aws.athena_database.withEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `athena_database`
Terraform resource block to set or update the encryption_configuration field.
...
`aws.athena_database.withExpectedBucketOwner` constructs a mixin object that can be merged into the `athena_database`
...
`aws.athena_database.withForceDestroy` constructs a mixin object that can be merged into the `athena_database`
...
`aws.athena_database.withName` constructs a mixin object that can be merged into the `athena_database`
...
`aws.athena_database.withProperties` constructs a mixin object that can be merged into the `athena_database`
