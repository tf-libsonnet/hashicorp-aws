...
`aws.fsx_data_repository_association.withBatchImportMetaDataOnCreate` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withDataRepositoryPath` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withDeleteDataInFilesystem` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withFileSystemId` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withFileSystemPath` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withImportedFileChunkSize` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withS3` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withS3Mixin` constructs a mixin object that can be merged into the `fsx_data_repository_association`
Terraform resource block to set or update the s3 field.
...
`aws.fsx_data_repository_association.withTags` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withTagsAll` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withTimeouts` constructs a mixin object that can be merged into the `fsx_data_repository_association`
...
`aws.fsx_data_repository_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `fsx_data_repository_association`
Terraform resource block to set or update the timeouts field.
