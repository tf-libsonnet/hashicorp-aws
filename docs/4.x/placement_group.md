...
`aws.placement_group.withName` constructs a mixin object that can be merged into the `placement_group`
...
`aws.placement_group.withPartitionCount` constructs a mixin object that can be merged into the `placement_group`
...
`aws.placement_group.withSpreadLevel` constructs a mixin object that can be merged into the `placement_group`
...
`aws.placement_group.withStrategy` constructs a mixin object that can be merged into the `placement_group`
...
`aws.placement_group.withTags` constructs a mixin object that can be merged into the `placement_group`
...
`aws.placement_group.withTagsAll` constructs a mixin object that can be merged into the `placement_group`
