...
`aws.vpc_endpoint.withAutoAccept` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withDnsOptions` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withDnsOptionsMixin` constructs a mixin object that can be merged into the `vpc_endpoint`
Terraform resource block to set or update the dns_options field.
...
`aws.vpc_endpoint.withIpAddressType` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withPolicy` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withPrivateDnsEnabled` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withRouteTableIds` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withSecurityGroupIds` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withServiceName` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withSubnetIds` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withTags` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withTagsAll` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withTimeouts` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpc_endpoint`
Terraform resource block to set or update the timeouts field.
...
`aws.vpc_endpoint.withVpcEndpointType` constructs a mixin object that can be merged into the `vpc_endpoint`
...
`aws.vpc_endpoint.withVpcId` constructs a mixin object that can be merged into the `vpc_endpoint`
