---
permalink: /ses_domain_identity_verification/
---

# ses_domain_identity_verification

`ses_domain_identity_verification` represents the `aws_ses_domain_identity_verification` Terraform resource.
...
`aws.ses_domain_identity_verification.withDomain` constructs a mixin object that can be merged into the `ses_domain_identity_verification`
...
`aws.ses_domain_identity_verification.withTimeouts` constructs a mixin object that can be merged into the `ses_domain_identity_verification`
...
`aws.ses_domain_identity_verification.withTimeoutsMixin` constructs a mixin object that can be merged into the `ses_domain_identity_verification`
Terraform resource block to set or update the timeouts field.
