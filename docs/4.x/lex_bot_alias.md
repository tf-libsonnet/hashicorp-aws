...
`aws.lex_bot_alias.withBotVersion` constructs a mixin object that can be merged into the `lex_bot_alias`
...
`aws.lex_bot_alias.withConversationLogs` constructs a mixin object that can be merged into the `lex_bot_alias`
...
`aws.lex_bot_alias.withConversationLogsMixin` constructs a mixin object that can be merged into the `lex_bot_alias`
Terraform resource block to set or update the conversation_logs field.
...
`aws.lex_bot_alias.withDescription` constructs a mixin object that can be merged into the `lex_bot_alias`
...
`aws.lex_bot_alias.withTimeouts` constructs a mixin object that can be merged into the `lex_bot_alias`
...
`aws.lex_bot_alias.withTimeoutsMixin` constructs a mixin object that can be merged into the `lex_bot_alias`
Terraform resource block to set or update the timeouts field.
