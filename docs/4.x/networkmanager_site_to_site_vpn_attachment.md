...
`aws.networkmanager_site_to_site_vpn_attachment.withCoreNetworkId` constructs a mixin object that can be merged into the `networkmanager_site_to_site_vpn_attachment`
...
`aws.networkmanager_site_to_site_vpn_attachment.withTags` constructs a mixin object that can be merged into the `networkmanager_site_to_site_vpn_attachment`
...
`aws.networkmanager_site_to_site_vpn_attachment.withTagsAll` constructs a mixin object that can be merged into the `networkmanager_site_to_site_vpn_attachment`
...
`aws.networkmanager_site_to_site_vpn_attachment.withTimeouts` constructs a mixin object that can be merged into the `networkmanager_site_to_site_vpn_attachment`
...
`aws.networkmanager_site_to_site_vpn_attachment.withTimeoutsMixin` constructs a mixin object that can be merged into the `networkmanager_site_to_site_vpn_attachment`
Terraform resource block to set or update the timeouts field.
...
`aws.networkmanager_site_to_site_vpn_attachment.withVpnConnectionArn` constructs a mixin object that can be merged into the `networkmanager_site_to_site_vpn_attachment`
