...
`aws.cloudfront_monitoring_subscription.withDistributionId` constructs a mixin object that can be merged into the `cloudfront_monitoring_subscription`
...
`aws.cloudfront_monitoring_subscription.withMonitoringSubscription` constructs a mixin object that can be merged into the `cloudfront_monitoring_subscription`
...
`aws.cloudfront_monitoring_subscription.withMonitoringSubscriptionMixin` constructs a mixin object that can be merged into the `cloudfront_monitoring_subscription`
Terraform resource block to set or update the monitoring_subscription field.
