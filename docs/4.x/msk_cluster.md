...
`aws.msk_cluster.withBrokerNodeGroupInfo` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withBrokerNodeGroupInfoMixin` constructs a mixin object that can be merged into the `msk_cluster`
Terraform resource block to set or update the broker_node_group_info field.
...
`aws.msk_cluster.withClientAuthentication` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withClientAuthenticationMixin` constructs a mixin object that can be merged into the `msk_cluster`
Terraform resource block to set or update the client_authentication field.
...
`aws.msk_cluster.withConfigurationInfo` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withConfigurationInfoMixin` constructs a mixin object that can be merged into the `msk_cluster`
Terraform resource block to set or update the configuration_info field.
...
`aws.msk_cluster.withEncryptionInfo` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withEncryptionInfoMixin` constructs a mixin object that can be merged into the `msk_cluster`
Terraform resource block to set or update the encryption_info field.
...
`aws.msk_cluster.withEnhancedMonitoring` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withKafkaVersion` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withLoggingInfo` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withLoggingInfoMixin` constructs a mixin object that can be merged into the `msk_cluster`
Terraform resource block to set or update the logging_info field.
...
`aws.msk_cluster.withNumberOfBrokerNodes` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withOpenMonitoring` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withOpenMonitoringMixin` constructs a mixin object that can be merged into the `msk_cluster`
Terraform resource block to set or update the open_monitoring field.
...
`aws.msk_cluster.withStorageMode` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withTagsAll` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withTimeouts` constructs a mixin object that can be merged into the `msk_cluster`
...
`aws.msk_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `msk_cluster`
Terraform resource block to set or update the timeouts field.
