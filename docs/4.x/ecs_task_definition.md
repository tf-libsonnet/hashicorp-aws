...
`aws.ecs_task_definition.withContainerDefinitions` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withCpu` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withEphemeralStorage` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withEphemeralStorageMixin` constructs a mixin object that can be merged into the `ecs_task_definition`
Terraform resource block to set or update the ephemeral_storage field.
...
`aws.ecs_task_definition.withExecutionRoleArn` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withFamily` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withInferenceAccelerator` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withInferenceAcceleratorMixin` constructs a mixin object that can be merged into the `ecs_task_definition`
Terraform resource block to set or update the inference_accelerator field.
...
`aws.ecs_task_definition.withIpcMode` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withMemory` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withNetworkMode` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withPidMode` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withPlacementConstraints` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withPlacementConstraintsMixin` constructs a mixin object that can be merged into the `ecs_task_definition`
Terraform resource block to set or update the placement_constraints field.
...
`aws.ecs_task_definition.withProxyConfiguration` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withProxyConfigurationMixin` constructs a mixin object that can be merged into the `ecs_task_definition`
Terraform resource block to set or update the proxy_configuration field.
...
`aws.ecs_task_definition.withRequiresCompatibilities` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withRuntimePlatform` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withRuntimePlatformMixin` constructs a mixin object that can be merged into the `ecs_task_definition`
Terraform resource block to set or update the runtime_platform field.
...
`aws.ecs_task_definition.withSkipDestroy` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withTags` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withTagsAll` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withTaskRoleArn` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withVolume` constructs a mixin object that can be merged into the `ecs_task_definition`
...
`aws.ecs_task_definition.withVolumeMixin` constructs a mixin object that can be merged into the `ecs_task_definition`
Terraform resource block to set or update the volume field.
