...
`aws.elasticsearch_domain_saml_options.withDomainName` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`
...
`aws.elasticsearch_domain_saml_options.withSamlOptions` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`
...
`aws.elasticsearch_domain_saml_options.withSamlOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`
Terraform resource block to set or update the saml_options field.
...
`aws.elasticsearch_domain_saml_options.withTimeouts` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`
...
`aws.elasticsearch_domain_saml_options.withTimeoutsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`
Terraform resource block to set or update the timeouts field.
