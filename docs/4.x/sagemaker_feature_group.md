...
`aws.sagemaker_feature_group.withDescription` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withEventTimeFeatureName` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withFeatureDefinition` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withFeatureDefinitionMixin` constructs a mixin object that can be merged into the `sagemaker_feature_group`
Terraform resource block to set or update the feature_definition field.
...
`aws.sagemaker_feature_group.withFeatureGroupName` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withOfflineStoreConfig` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withOfflineStoreConfigMixin` constructs a mixin object that can be merged into the `sagemaker_feature_group`
Terraform resource block to set or update the offline_store_config field.
...
`aws.sagemaker_feature_group.withOnlineStoreConfig` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withOnlineStoreConfigMixin` constructs a mixin object that can be merged into the `sagemaker_feature_group`
Terraform resource block to set or update the online_store_config field.
...
`aws.sagemaker_feature_group.withRecordIdentifierFeatureName` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withRoleArn` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withTags` constructs a mixin object that can be merged into the `sagemaker_feature_group`
...
`aws.sagemaker_feature_group.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_feature_group`
