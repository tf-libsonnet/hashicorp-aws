...
`aws.elasticsearch_domain.withAccessPolicies` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withAdvancedOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withAdvancedSecurityOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withAdvancedSecurityOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the advanced_security_options field.
...
`aws.elasticsearch_domain.withAutoTuneOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withAutoTuneOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the auto_tune_options field.
...
`aws.elasticsearch_domain.withClusterConfig` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withClusterConfigMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the cluster_config field.
...
`aws.elasticsearch_domain.withCognitoOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withCognitoOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the cognito_options field.
...
`aws.elasticsearch_domain.withDomainEndpointOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withDomainEndpointOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the domain_endpoint_options field.
...
`aws.elasticsearch_domain.withDomainName` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withEbsOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withEbsOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the ebs_options field.
...
`aws.elasticsearch_domain.withElasticsearchVersion` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withEncryptAtRest` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withEncryptAtRestMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the encrypt_at_rest field.
...
`aws.elasticsearch_domain.withLogPublishingOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withLogPublishingOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the log_publishing_options field.
...
`aws.elasticsearch_domain.withNodeToNodeEncryption` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withNodeToNodeEncryptionMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the node_to_node_encryption field.
...
`aws.elasticsearch_domain.withSnapshotOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withSnapshotOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the snapshot_options field.
...
`aws.elasticsearch_domain.withTags` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withTagsAll` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withTimeouts` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withTimeoutsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the timeouts field.
...
`aws.elasticsearch_domain.withVpcOptions` constructs a mixin object that can be merged into the `elasticsearch_domain`
...
`aws.elasticsearch_domain.withVpcOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain`
Terraform resource block to set or update the vpc_options field.
