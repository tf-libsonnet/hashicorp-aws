...
`aws.sesv2_configuration_set.withConfigurationSetName` constructs a mixin object that can be merged into the `sesv2_configuration_set`
...
`aws.sesv2_configuration_set.withDeliveryOptions` constructs a mixin object that can be merged into the `sesv2_configuration_set`
...
`aws.sesv2_configuration_set.withDeliveryOptionsMixin` constructs a mixin object that can be merged into the `sesv2_configuration_set`
Terraform resource block to set or update the delivery_options field.
...
`aws.sesv2_configuration_set.withReputationOptions` constructs a mixin object that can be merged into the `sesv2_configuration_set`
...
`aws.sesv2_configuration_set.withReputationOptionsMixin` constructs a mixin object that can be merged into the `sesv2_configuration_set`
Terraform resource block to set or update the reputation_options field.
...
`aws.sesv2_configuration_set.withSendingOptions` constructs a mixin object that can be merged into the `sesv2_configuration_set`
...
`aws.sesv2_configuration_set.withSendingOptionsMixin` constructs a mixin object that can be merged into the `sesv2_configuration_set`
Terraform resource block to set or update the sending_options field.
...
`aws.sesv2_configuration_set.withSuppressionOptions` constructs a mixin object that can be merged into the `sesv2_configuration_set`
...
`aws.sesv2_configuration_set.withSuppressionOptionsMixin` constructs a mixin object that can be merged into the `sesv2_configuration_set`
Terraform resource block to set or update the suppression_options field.
...
`aws.sesv2_configuration_set.withTags` constructs a mixin object that can be merged into the `sesv2_configuration_set`
...
`aws.sesv2_configuration_set.withTagsAll` constructs a mixin object that can be merged into the `sesv2_configuration_set`
...
`aws.sesv2_configuration_set.withTrackingOptions` constructs a mixin object that can be merged into the `sesv2_configuration_set`
...
`aws.sesv2_configuration_set.withTrackingOptionsMixin` constructs a mixin object that can be merged into the `sesv2_configuration_set`
Terraform resource block to set or update the tracking_options field.
