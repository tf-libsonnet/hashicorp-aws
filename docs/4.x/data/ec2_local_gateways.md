...
`aws.ec2_local_gateways.withFilter` constructs a mixin object that can be merged into the `ec2_local_gateways`
...
`aws.ec2_local_gateways.withFilterMixin` constructs a mixin object that can be merged into the `ec2_local_gateways`
Terraform data source block to set or update the filter field.
...
`aws.ec2_local_gateways.withTags` constructs a mixin object that can be merged into the `ec2_local_gateways`
...
`aws.ec2_local_gateways.withTimeouts` constructs a mixin object that can be merged into the `ec2_local_gateways`
...
`aws.ec2_local_gateways.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_local_gateways`
Terraform data source block to set or update the timeouts field.
