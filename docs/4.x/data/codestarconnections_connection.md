---
permalink: /data/codestarconnections_connection/
---

# data.codestarconnections_connection

`codestarconnections_connection` represents the `aws_codestarconnections_connection` Terraform data source.
...
Unlike [aws.data.codestarconnections_connection.new](#fn-codestarconnections_connectionnew), this function will not inject the `data source`
