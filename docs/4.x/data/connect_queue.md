...
Unlike [aws.data.connect_queue.new](#fn-new), this function will not inject the `data source`
...
`aws.string.withQueueId` constructs a mixin object that can be merged into the `string`
