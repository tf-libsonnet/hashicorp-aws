...
`aws.identitystore_user.withAlternateIdentifier` constructs a mixin object that can be merged into the `identitystore_user`
...
`aws.identitystore_user.withAlternateIdentifierMixin` constructs a mixin object that can be merged into the `identitystore_user`
Terraform data source block to set or update the alternate_identifier field.
...
`aws.identitystore_user.withFilter` constructs a mixin object that can be merged into the `identitystore_user`
...
`aws.identitystore_user.withFilterMixin` constructs a mixin object that can be merged into the `identitystore_user`
Terraform data source block to set or update the filter field.
...
`aws.identitystore_user.withUserId` constructs a mixin object that can be merged into the `identitystore_user`
