---
permalink: /data/elasticache_subnet_group/
---

# data.elasticache_subnet_group

`elasticache_subnet_group` represents the `aws_elasticache_subnet_group` Terraform data source.
...
Unlike [aws.data.elasticache_subnet_group.new](#fn-elasticache_subnet_groupnew), this function will not inject the `data source`
