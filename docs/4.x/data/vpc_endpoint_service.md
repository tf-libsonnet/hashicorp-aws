...
`aws.vpc_endpoint_service.withFilter` constructs a mixin object that can be merged into the `vpc_endpoint_service`
...
`aws.vpc_endpoint_service.withFilterMixin` constructs a mixin object that can be merged into the `vpc_endpoint_service`
Terraform data source block to set or update the filter field.
...
`aws.vpc_endpoint_service.withService` constructs a mixin object that can be merged into the `vpc_endpoint_service`
...
`aws.vpc_endpoint_service.withServiceName` constructs a mixin object that can be merged into the `vpc_endpoint_service`
...
`aws.vpc_endpoint_service.withServiceType` constructs a mixin object that can be merged into the `vpc_endpoint_service`
