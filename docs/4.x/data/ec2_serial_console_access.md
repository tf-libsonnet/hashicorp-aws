...
`aws.ec2_serial_console_access.withTimeouts` constructs a mixin object that can be merged into the `ec2_serial_console_access`
...
`aws.ec2_serial_console_access.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_serial_console_access`
Terraform data source block to set or update the timeouts field.
