---
permalink: /data/networkmanager_sites/
---

# data.networkmanager_sites

`networkmanager_sites` represents the `aws_networkmanager_sites` Terraform data source.
...
Unlike [aws.data.networkmanager_sites.new](#fn-networkmanagersitesnew), this function will not inject the `data source`
...
`aws.networkmanager_sites.withGlobalNetworkId` constructs a mixin object that can be merged into the `networkmanager_sites`
...
`aws.networkmanager_sites.withTags` constructs a mixin object that can be merged into the `networkmanager_sites`
