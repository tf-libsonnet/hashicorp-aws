...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.servicecatalog_constraint.timeouts.new](#fn-servicecatalog_constrainttimeoutsnew) constructor.
...
Unlike [aws.data.servicecatalog_constraint.new](#fn-servicecatalog_constraintnew), this function will not inject the `data source`
