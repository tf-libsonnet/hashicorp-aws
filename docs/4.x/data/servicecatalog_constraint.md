---
permalink: /data/servicecatalog_constraint/
---

# data.servicecatalog_constraint

`servicecatalog_constraint` represents the `aws_servicecatalog_constraint` Terraform data source.
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting data source block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.servicecatalog_constraint.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [aws.data.servicecatalog_constraint.new](#fn-new), this function will not inject the `data source`
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.servicecatalog_constraint.timeouts.new](#fn-timeoutsnew) constructor.
