...
`aws.glue_script.withDagEdge` constructs a mixin object that can be merged into the `glue_script`
...
`aws.glue_script.withDagEdgeMixin` constructs a mixin object that can be merged into the `glue_script`
Terraform data source block to set or update the dag_edge field.
...
`aws.glue_script.withDagNode` constructs a mixin object that can be merged into the `glue_script`
...
`aws.glue_script.withDagNodeMixin` constructs a mixin object that can be merged into the `glue_script`
Terraform data source block to set or update the dag_node field.
...
`aws.glue_script.withLanguage` constructs a mixin object that can be merged into the `glue_script`
