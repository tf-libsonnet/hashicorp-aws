...
`aws.route53_traffic_policy_document.withEndpoint` constructs a mixin object that can be merged into the `route53_traffic_policy_document`
...
`aws.route53_traffic_policy_document.withEndpointMixin` constructs a mixin object that can be merged into the `route53_traffic_policy_document`
Terraform data source block to set or update the endpoint field.
...
`aws.route53_traffic_policy_document.withRecordType` constructs a mixin object that can be merged into the `route53_traffic_policy_document`
...
`aws.route53_traffic_policy_document.withRule` constructs a mixin object that can be merged into the `route53_traffic_policy_document`
...
`aws.route53_traffic_policy_document.withRuleMixin` constructs a mixin object that can be merged into the `route53_traffic_policy_document`
Terraform data source block to set or update the rule field.
...
`aws.route53_traffic_policy_document.withStartEndpoint` constructs a mixin object that can be merged into the `route53_traffic_policy_document`
...
`aws.route53_traffic_policy_document.withStartRule` constructs a mixin object that can be merged into the `route53_traffic_policy_document`
...
`aws.route53_traffic_policy_document.withVersion` constructs a mixin object that can be merged into the `route53_traffic_policy_document`
