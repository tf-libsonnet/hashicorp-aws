...
`aws.ec2_transit_gateway_dx_gateway_attachment.withTransitGatewayId` constructs a mixin object that can be merged into the `ec2_transit_gateway_dx_gateway_attachment`
