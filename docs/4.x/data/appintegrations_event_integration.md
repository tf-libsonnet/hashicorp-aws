---
permalink: /data/appintegrations_event_integration/
---

# data.appintegrations_event_integration

`appintegrations_event_integration` represents the `aws_appintegrations_event_integration` Terraform data source.
