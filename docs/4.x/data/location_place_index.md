...
**Args**:
  ...
  - `index_name` (`string`): Set the `index_name` field on the resulting data source block.
...
Unlike [aws.data.location_place_index.new](#fn-new), this function will not inject the `data source`
