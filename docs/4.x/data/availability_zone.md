...
`aws.availability_zone.withAllAvailabilityZones` constructs a mixin object that can be merged into the `availability_zone`
...
`aws.availability_zone.withFilter` constructs a mixin object that can be merged into the `availability_zone`
...
`aws.availability_zone.withFilterMixin` constructs a mixin object that can be merged into the `availability_zone`
Terraform data source block to set or update the filter field.
...
`aws.availability_zone.withName` constructs a mixin object that can be merged into the `availability_zone`
...
`aws.availability_zone.withState` constructs a mixin object that can be merged into the `availability_zone`
...
`aws.availability_zone.withTimeouts` constructs a mixin object that can be merged into the `availability_zone`
...
`aws.availability_zone.withTimeoutsMixin` constructs a mixin object that can be merged into the `availability_zone`
Terraform data source block to set or update the timeouts field.
...
`aws.availability_zone.withZoneId` constructs a mixin object that can be merged into the `availability_zone`
