---
permalink: /data/alb_listener/
---

# data.alb_listener

`alb_listener` represents the `aws_alb_listener` Terraform data source.
...
`aws.alb_listener.withArn` constructs a mixin object that can be merged into the `alb_listener`
