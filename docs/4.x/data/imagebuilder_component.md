---
permalink: /data/imagebuilder_component/
---

# data.imagebuilder_component

`imagebuilder_component` represents the `aws_imagebuilder_component` Terraform data source.
...
Unlike [aws.data.imagebuilder_component.new](#fn-imagebuildercomponentnew), this function will not inject the `data source`
...
`aws.imagebuilder_component.withArn` constructs a mixin object that can be merged into the `imagebuilder_component`
