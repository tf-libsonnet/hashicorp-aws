...
`aws.networkmanager_core_network_policy_document.withAttachmentPolicies` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
...
`aws.networkmanager_core_network_policy_document.withAttachmentPoliciesMixin` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
Terraform data source block to set or update the attachment_policies field.
...
`aws.networkmanager_core_network_policy_document.withCoreNetworkConfiguration` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
...
`aws.networkmanager_core_network_policy_document.withCoreNetworkConfigurationMixin` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
Terraform data source block to set or update the core_network_configuration field.
...
`aws.networkmanager_core_network_policy_document.withSegmentActions` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
...
`aws.networkmanager_core_network_policy_document.withSegmentActionsMixin` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
Terraform data source block to set or update the segment_actions field.
...
`aws.networkmanager_core_network_policy_document.withSegments` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
...
`aws.networkmanager_core_network_policy_document.withSegmentsMixin` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
Terraform data source block to set or update the segments field.
...
`aws.networkmanager_core_network_policy_document.withVersion` constructs a mixin object that can be merged into the `networkmanager_core_network_policy_document`
