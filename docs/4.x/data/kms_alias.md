---
permalink: /data/kms_alias/
---

# data.kms_alias

`kms_alias` represents the `aws_kms_alias` Terraform data source.
...
Unlike [aws.data.kms_alias.new](#fn-kms_aliasnew), this function will not inject the `data source`
