...
`aws.route_table.withFilter` constructs a mixin object that can be merged into the `route_table`
...
`aws.route_table.withFilterMixin` constructs a mixin object that can be merged into the `route_table`
Terraform data source block to set or update the filter field.
...
`aws.route_table.withGatewayId` constructs a mixin object that can be merged into the `route_table`
...
`aws.route_table.withRouteTableId` constructs a mixin object that can be merged into the `route_table`
...
`aws.route_table.withSubnetId` constructs a mixin object that can be merged into the `route_table`
