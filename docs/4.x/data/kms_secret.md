...
**Args**:
  ...
  - `secret` (`list[obj]`):  When `null`, the `secret` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.kms_secret.secret.new](#fn-kms_secretsecretnew) constructor.
...
Unlike [aws.data.kms_secret.new](#fn-kms_secretnew), this function will not inject the `data source`
