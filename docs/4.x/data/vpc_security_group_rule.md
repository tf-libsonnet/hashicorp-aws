---
permalink: /data/vpc_security_group_rule/
---

# data.vpc_security_group_rule

`vpc_security_group_rule` represents the `aws_vpc_security_group_rule` Terraform data source.
...
* [`fn withSecurityGroupRuleId()`](#fn-withsecuritygroupruleid)
...
### fn withSecurityGroupRuleId

```ts
withSecurityGroupRuleId()
```

`aws.string.withSecurityGroupRuleId` constructs a mixin object that can be merged into the `string`
