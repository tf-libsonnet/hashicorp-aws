---
permalink: /data/imagebuilder_image/
---

# data.imagebuilder_image

`imagebuilder_image` represents the `aws_imagebuilder_image` Terraform data source.
...
Unlike [aws.data.imagebuilder_image.new](#fn-imagebuilderimagenew), this function will not inject the `data source`
...
`aws.imagebuilder_image.withArn` constructs a mixin object that can be merged into the `imagebuilder_image`
