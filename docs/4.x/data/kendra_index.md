---
permalink: /data/kendra_index/
---

# data.kendra_index

`kendra_index` represents the `aws_kendra_index` Terraform data source.
...
Unlike [aws.data.kendra_index.new](#fn-kendra_indexnew), this function will not inject the `data source`
