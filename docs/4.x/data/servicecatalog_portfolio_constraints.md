...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.servicecatalog_portfolio_constraints.timeouts.new](#fn-servicecatalog_portfolio_constraintstimeoutsnew) constructor.
...
Unlike [aws.data.servicecatalog_portfolio_constraints.new](#fn-servicecatalog_portfolio_constraintsnew), this function will not inject the `data source`
