...
`aws.route53_resolver_firewall_domain_list.withFirewallDomainListId` constructs a mixin object that can be merged into the `route53_resolver_firewall_domain_list`
