...
`aws.resourcegroupstaggingapi_resources.withResourceTypeFilters` constructs a mixin object that can be merged into the `resourcegroupstaggingapi_resources`
