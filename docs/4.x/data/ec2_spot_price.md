...
`aws.ec2_spot_price.withAvailabilityZone` constructs a mixin object that can be merged into the `ec2_spot_price`
...
`aws.ec2_spot_price.withFilter` constructs a mixin object that can be merged into the `ec2_spot_price`
...
`aws.ec2_spot_price.withFilterMixin` constructs a mixin object that can be merged into the `ec2_spot_price`
Terraform data source block to set or update the filter field.
...
`aws.ec2_spot_price.withInstanceType` constructs a mixin object that can be merged into the `ec2_spot_price`
...
`aws.ec2_spot_price.withTimeouts` constructs a mixin object that can be merged into the `ec2_spot_price`
...
`aws.ec2_spot_price.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_spot_price`
Terraform data source block to set or update the timeouts field.
