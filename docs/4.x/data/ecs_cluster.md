---
permalink: /data/ecs_cluster/
---

# data.ecs_cluster

`ecs_cluster` represents the `aws_ecs_cluster` Terraform data source.
...
`aws.ecs_cluster.withClusterName` constructs a mixin object that can be merged into the `ecs_cluster`
