...
`aws.nat_gateway.withFilter` constructs a mixin object that can be merged into the `nat_gateway`
...
`aws.nat_gateway.withFilterMixin` constructs a mixin object that can be merged into the `nat_gateway`
Terraform data source block to set or update the filter field.
...
`aws.nat_gateway.withState` constructs a mixin object that can be merged into the `nat_gateway`
...
`aws.nat_gateway.withTimeouts` constructs a mixin object that can be merged into the `nat_gateway`
...
`aws.nat_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `nat_gateway`
Terraform data source block to set or update the timeouts field.
...
`aws.nat_gateway.withVpcId` constructs a mixin object that can be merged into the `nat_gateway`
