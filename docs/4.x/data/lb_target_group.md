...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.lb_target_group.timeouts.new](#fn-lb_target_grouptimeoutsnew) constructor.
...
Unlike [aws.data.lb_target_group.new](#fn-lb_target_groupnew), this function will not inject the `data source`
