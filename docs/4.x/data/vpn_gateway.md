...
`aws.vpn_gateway.withAttachedVpcId` constructs a mixin object that can be merged into the `vpn_gateway`
...
`aws.vpn_gateway.withFilter` constructs a mixin object that can be merged into the `vpn_gateway`
...
`aws.vpn_gateway.withFilterMixin` constructs a mixin object that can be merged into the `vpn_gateway`
Terraform data source block to set or update the filter field.
...
`aws.vpn_gateway.withState` constructs a mixin object that can be merged into the `vpn_gateway`
...
`aws.vpn_gateway.withTimeouts` constructs a mixin object that can be merged into the `vpn_gateway`
...
`aws.vpn_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpn_gateway`
Terraform data source block to set or update the timeouts field.
