...
`aws.glue_dev_endpoint.withArguments` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withExtraJarsS3Path` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withExtraPythonLibsS3Path` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withGlueVersion` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withName` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withNumberOfNodes` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withNumberOfWorkers` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withPublicKey` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withPublicKeys` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withRoleArn` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withSecurityConfiguration` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withSecurityGroupIds` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withSubnetId` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withTags` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withTagsAll` constructs a mixin object that can be merged into the `glue_dev_endpoint`
...
`aws.glue_dev_endpoint.withWorkerType` constructs a mixin object that can be merged into the `glue_dev_endpoint`
