...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.neptune_cluster_instance.timeouts.new](#fn-neptune_cluster_instancetimeoutsnew) constructor.
...
Unlike [aws.neptune_cluster_instance.new](#fn-neptune_cluster_instancenew), this function will not inject the `resource`
