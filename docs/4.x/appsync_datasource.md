...
`aws.appsync_datasource.withApiId` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withDescription` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withDynamodbConfig` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withDynamodbConfigMixin` constructs a mixin object that can be merged into the `appsync_datasource`
Terraform resource block to set or update the dynamodb_config field.
...
`aws.appsync_datasource.withElasticsearchConfig` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withElasticsearchConfigMixin` constructs a mixin object that can be merged into the `appsync_datasource`
Terraform resource block to set or update the elasticsearch_config field.
...
`aws.appsync_datasource.withHttpConfig` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withHttpConfigMixin` constructs a mixin object that can be merged into the `appsync_datasource`
Terraform resource block to set or update the http_config field.
...
`aws.appsync_datasource.withLambdaConfig` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withLambdaConfigMixin` constructs a mixin object that can be merged into the `appsync_datasource`
Terraform resource block to set or update the lambda_config field.
...
`aws.appsync_datasource.withName` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withRelationalDatabaseConfig` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withRelationalDatabaseConfigMixin` constructs a mixin object that can be merged into the `appsync_datasource`
Terraform resource block to set or update the relational_database_config field.
...
`aws.appsync_datasource.withServiceRoleArn` constructs a mixin object that can be merged into the `appsync_datasource`
...
`aws.appsync_datasource.withType` constructs a mixin object that can be merged into the `appsync_datasource`
