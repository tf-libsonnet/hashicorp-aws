...
`aws.config_config_rule.withDescription` constructs a mixin object that can be merged into the `config_config_rule`
...
`aws.config_config_rule.withInputParameters` constructs a mixin object that can be merged into the `config_config_rule`
...
`aws.config_config_rule.withMaximumExecutionFrequency` constructs a mixin object that can be merged into the `config_config_rule`
...
`aws.config_config_rule.withName` constructs a mixin object that can be merged into the `config_config_rule`
...
`aws.config_config_rule.withScope` constructs a mixin object that can be merged into the `config_config_rule`
...
`aws.config_config_rule.withScopeMixin` constructs a mixin object that can be merged into the `config_config_rule`
Terraform resource block to set or update the scope field.
...
`aws.config_config_rule.withSource` constructs a mixin object that can be merged into the `config_config_rule`
...
`aws.config_config_rule.withSourceMixin` constructs a mixin object that can be merged into the `config_config_rule`
Terraform resource block to set or update the source field.
...
`aws.config_config_rule.withTags` constructs a mixin object that can be merged into the `config_config_rule`
...
`aws.config_config_rule.withTagsAll` constructs a mixin object that can be merged into the `config_config_rule`
