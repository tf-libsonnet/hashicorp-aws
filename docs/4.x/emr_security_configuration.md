...
`aws.emr_security_configuration.withConfiguration` constructs a mixin object that can be merged into the `emr_security_configuration`
...
`aws.emr_security_configuration.withName` constructs a mixin object that can be merged into the `emr_security_configuration`
...
`aws.emr_security_configuration.withNamePrefix` constructs a mixin object that can be merged into the `emr_security_configuration`
