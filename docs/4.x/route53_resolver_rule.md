...
`aws.route53_resolver_rule.withTagsAll` constructs a mixin object that can be merged into the `route53_resolver_rule`
...
`aws.route53_resolver_rule.withTargetIp` constructs a mixin object that can be merged into the `route53_resolver_rule`
...
`aws.route53_resolver_rule.withTargetIpMixin` constructs a mixin object that can be merged into the `route53_resolver_rule`
Terraform resource block to set or update the target_ip field.
...
`aws.route53_resolver_rule.withTimeouts` constructs a mixin object that can be merged into the `route53_resolver_rule`
...
`aws.route53_resolver_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `route53_resolver_rule`
Terraform resource block to set or update the timeouts field.
