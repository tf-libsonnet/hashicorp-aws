...
`aws.default_route_table.withDefaultRouteTableId` constructs a mixin object that can be merged into the `default_route_table`
...
`aws.default_route_table.withPropagatingVgws` constructs a mixin object that can be merged into the `default_route_table`
...
`aws.default_route_table.withRoute` constructs a mixin object that can be merged into the `default_route_table`
...
`aws.default_route_table.withTags` constructs a mixin object that can be merged into the `default_route_table`
...
`aws.default_route_table.withTagsAll` constructs a mixin object that can be merged into the `default_route_table`
...
`aws.default_route_table.withTimeouts` constructs a mixin object that can be merged into the `default_route_table`
...
`aws.default_route_table.withTimeoutsMixin` constructs a mixin object that can be merged into the `default_route_table`
Terraform resource block to set or update the timeouts field.
