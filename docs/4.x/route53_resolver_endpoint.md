...
`aws.route53_resolver_endpoint.withDirection` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
...
`aws.route53_resolver_endpoint.withIpAddress` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
...
`aws.route53_resolver_endpoint.withIpAddressMixin` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
Terraform resource block to set or update the ip_address field.
...
`aws.route53_resolver_endpoint.withName` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
...
`aws.route53_resolver_endpoint.withSecurityGroupIds` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
...
`aws.route53_resolver_endpoint.withTags` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
...
`aws.route53_resolver_endpoint.withTagsAll` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
...
`aws.route53_resolver_endpoint.withTimeouts` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
...
`aws.route53_resolver_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `route53_resolver_endpoint`
Terraform resource block to set or update the timeouts field.
