...
`aws.bool.withManageBundler` constructs a mixin object that can be merged into the `bool`
...
`aws.string.withRubygemsVersion` constructs a mixin object that can be merged into the `string`
