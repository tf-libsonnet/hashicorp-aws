...
`aws.opensearch_outbound_connection.withConnectionAlias` constructs a mixin object that can be merged into the `opensearch_outbound_connection`
...
`aws.opensearch_outbound_connection.withLocalDomainInfo` constructs a mixin object that can be merged into the `opensearch_outbound_connection`
...
`aws.opensearch_outbound_connection.withLocalDomainInfoMixin` constructs a mixin object that can be merged into the `opensearch_outbound_connection`
Terraform resource block to set or update the local_domain_info field.
...
`aws.opensearch_outbound_connection.withRemoteDomainInfo` constructs a mixin object that can be merged into the `opensearch_outbound_connection`
...
`aws.opensearch_outbound_connection.withRemoteDomainInfoMixin` constructs a mixin object that can be merged into the `opensearch_outbound_connection`
Terraform resource block to set or update the remote_domain_info field.
...
`aws.opensearch_outbound_connection.withTimeouts` constructs a mixin object that can be merged into the `opensearch_outbound_connection`
...
`aws.opensearch_outbound_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `opensearch_outbound_connection`
Terraform resource block to set or update the timeouts field.
