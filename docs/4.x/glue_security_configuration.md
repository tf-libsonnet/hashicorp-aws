...
`aws.glue_security_configuration.withEncryptionConfiguration` constructs a mixin object that can be merged into the `glue_security_configuration`
...
`aws.glue_security_configuration.withEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `glue_security_configuration`
Terraform resource block to set or update the encryption_configuration field.
...
`aws.glue_security_configuration.withName` constructs a mixin object that can be merged into the `glue_security_configuration`
