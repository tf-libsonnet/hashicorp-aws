...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.vpc_ipam_scope.timeouts.new](#fn-vpc_ipam_scopetimeoutsnew) constructor.
...
Unlike [aws.vpc_ipam_scope.new](#fn-vpc_ipam_scopenew), this function will not inject the `resource`
