...
`aws.glue_partition.withCatalogId` constructs a mixin object that can be merged into the `glue_partition`
...
`aws.glue_partition.withDatabaseName` constructs a mixin object that can be merged into the `glue_partition`
...
`aws.glue_partition.withParameters` constructs a mixin object that can be merged into the `glue_partition`
...
`aws.glue_partition.withPartitionValues` constructs a mixin object that can be merged into the `glue_partition`
...
`aws.glue_partition.withStorageDescriptor` constructs a mixin object that can be merged into the `glue_partition`
...
`aws.glue_partition.withStorageDescriptorMixin` constructs a mixin object that can be merged into the `glue_partition`
Terraform resource block to set or update the storage_descriptor field.
...
`aws.glue_partition.withTableName` constructs a mixin object that can be merged into the `glue_partition`
