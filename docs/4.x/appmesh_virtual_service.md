...
`aws.appmesh_virtual_service.withSpec` constructs a mixin object that can be merged into the `appmesh_virtual_service`
...
`aws.appmesh_virtual_service.withSpecMixin` constructs a mixin object that can be merged into the `appmesh_virtual_service`
Terraform resource block to set or update the spec field.
...
`aws.appmesh_virtual_service.withTagsAll` constructs a mixin object that can be merged into the `appmesh_virtual_service`
