...
`aws.lambda_function.withArchitectures` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withCodeSigningConfigArn` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withDeadLetterConfig` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withDeadLetterConfigMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the dead_letter_config field.
...
`aws.lambda_function.withDescription` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withEnvironment` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withEnvironmentMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the environment field.
...
`aws.lambda_function.withEphemeralStorage` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withEphemeralStorageMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the ephemeral_storage field.
...
`aws.lambda_function.withFileSystemConfig` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withFileSystemConfigMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the file_system_config field.
...
`aws.lambda_function.withFilename` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withHandler` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withImageConfig` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withImageConfigMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the image_config field.
...
`aws.lambda_function.withImageUri` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withKmsKeyArn` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withLayers` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withMemorySize` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withPackageType` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withPublish` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withReservedConcurrentExecutions` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withRole` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withRuntime` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withS3Bucket` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withS3Key` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withS3ObjectVersion` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withSnapStart` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withSnapStartMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the snap_start field.
...
`aws.lambda_function.withSourceCodeHash` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withTagsAll` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withTimeout` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withTimeouts` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withTimeoutsMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the timeouts field.
...
`aws.lambda_function.withTracingConfig` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withTracingConfigMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the tracing_config field.
...
`aws.lambda_function.withVpcConfig` constructs a mixin object that can be merged into the `lambda_function`
...
`aws.lambda_function.withVpcConfigMixin` constructs a mixin object that can be merged into the `lambda_function`
Terraform resource block to set or update the vpc_config field.
