...
`aws.licensemanager_license_configuration.withDescription` constructs a mixin object that can be merged into the `licensemanager_license_configuration`
...
`aws.licensemanager_license_configuration.withLicenseCount` constructs a mixin object that can be merged into the `licensemanager_license_configuration`
...
`aws.licensemanager_license_configuration.withLicenseCountHardLimit` constructs a mixin object that can be merged into the `licensemanager_license_configuration`
...
`aws.licensemanager_license_configuration.withLicenseCountingType` constructs a mixin object that can be merged into the `licensemanager_license_configuration`
...
`aws.licensemanager_license_configuration.withLicenseRules` constructs a mixin object that can be merged into the `licensemanager_license_configuration`
...
`aws.licensemanager_license_configuration.withName` constructs a mixin object that can be merged into the `licensemanager_license_configuration`
...
`aws.licensemanager_license_configuration.withTags` constructs a mixin object that can be merged into the `licensemanager_license_configuration`
...
`aws.licensemanager_license_configuration.withTagsAll` constructs a mixin object that can be merged into the `licensemanager_license_configuration`
