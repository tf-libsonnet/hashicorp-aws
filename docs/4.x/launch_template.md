...
`aws.launch_template.withBlockDeviceMappings` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withBlockDeviceMappingsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the block_device_mappings field.
...
`aws.launch_template.withCapacityReservationSpecification` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withCapacityReservationSpecificationMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the capacity_reservation_specification field.
...
`aws.launch_template.withCpuOptions` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withCpuOptionsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the cpu_options field.
...
`aws.launch_template.withCreditSpecification` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withCreditSpecificationMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the credit_specification field.
...
`aws.launch_template.withDefaultVersion` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withDescription` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withDisableApiStop` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withDisableApiTermination` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withEbsOptimized` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withElasticGpuSpecifications` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withElasticGpuSpecificationsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the elastic_gpu_specifications field.
...
`aws.launch_template.withElasticInferenceAccelerator` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withElasticInferenceAcceleratorMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the elastic_inference_accelerator field.
...
`aws.launch_template.withEnclaveOptions` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withEnclaveOptionsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the enclave_options field.
...
`aws.launch_template.withHibernationOptions` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withHibernationOptionsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the hibernation_options field.
...
`aws.launch_template.withIamInstanceProfile` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withIamInstanceProfileMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the iam_instance_profile field.
...
`aws.launch_template.withImageId` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withInstanceInitiatedShutdownBehavior` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withInstanceMarketOptions` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withInstanceMarketOptionsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the instance_market_options field.
...
`aws.launch_template.withInstanceRequirements` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withInstanceRequirementsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the instance_requirements field.
...
`aws.launch_template.withInstanceType` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withKernelId` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withKeyName` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withLicenseSpecification` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withLicenseSpecificationMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the license_specification field.
...
`aws.launch_template.withMaintenanceOptions` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withMaintenanceOptionsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the maintenance_options field.
...
`aws.launch_template.withMetadataOptions` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withMetadataOptionsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the metadata_options field.
...
`aws.launch_template.withMonitoring` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withMonitoringMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the monitoring field.
...
`aws.launch_template.withNamePrefix` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withNetworkInterfaces` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withNetworkInterfacesMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the network_interfaces field.
...
`aws.launch_template.withPlacement` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withPlacementMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the placement field.
...
`aws.launch_template.withPrivateDnsNameOptions` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withPrivateDnsNameOptionsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the private_dns_name_options field.
...
`aws.launch_template.withRamDiskId` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withSecurityGroupNames` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withTagSpecifications` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withTagSpecificationsMixin` constructs a mixin object that can be merged into the `launch_template`
Terraform resource block to set or update the tag_specifications field.
...
`aws.launch_template.withTagsAll` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withUpdateDefaultVersion` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withUserData` constructs a mixin object that can be merged into the `launch_template`
...
`aws.launch_template.withVpcSecurityGroupIds` constructs a mixin object that can be merged into the `launch_template`
