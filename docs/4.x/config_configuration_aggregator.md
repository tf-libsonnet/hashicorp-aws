...
`aws.config_configuration_aggregator.withAccountAggregationSource` constructs a mixin object that can be merged into the `config_configuration_aggregator`
...
`aws.config_configuration_aggregator.withAccountAggregationSourceMixin` constructs a mixin object that can be merged into the `config_configuration_aggregator`
Terraform resource block to set or update the account_aggregation_source field.
...
`aws.config_configuration_aggregator.withName` constructs a mixin object that can be merged into the `config_configuration_aggregator`
...
`aws.config_configuration_aggregator.withOrganizationAggregationSource` constructs a mixin object that can be merged into the `config_configuration_aggregator`
...
`aws.config_configuration_aggregator.withOrganizationAggregationSourceMixin` constructs a mixin object that can be merged into the `config_configuration_aggregator`
Terraform resource block to set or update the organization_aggregation_source field.
...
`aws.config_configuration_aggregator.withTags` constructs a mixin object that can be merged into the `config_configuration_aggregator`
...
`aws.config_configuration_aggregator.withTagsAll` constructs a mixin object that can be merged into the `config_configuration_aggregator`
