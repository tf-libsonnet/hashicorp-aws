...
`aws.glue_data_catalog_encryption_settings.withDataCatalogEncryptionSettings` constructs a mixin object that can be merged into the `glue_data_catalog_encryption_settings`
...
`aws.glue_data_catalog_encryption_settings.withDataCatalogEncryptionSettingsMixin` constructs a mixin object that can be merged into the `glue_data_catalog_encryption_settings`
Terraform resource block to set or update the data_catalog_encryption_settings field.
