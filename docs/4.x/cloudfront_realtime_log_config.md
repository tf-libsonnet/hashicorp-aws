...
`aws.cloudfront_realtime_log_config.withEndpoint` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`
...
`aws.cloudfront_realtime_log_config.withEndpointMixin` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`
Terraform resource block to set or update the endpoint field.
...
`aws.cloudfront_realtime_log_config.withFields` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`
...
`aws.cloudfront_realtime_log_config.withSamplingRate` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`
