...
`aws.ssm_parameter.withAllowedPattern` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withArn` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withDataType` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withDescription` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withInsecureValue` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withKeyId` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withOverwrite` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withTags` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withTagsAll` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withTier` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withType` constructs a mixin object that can be merged into the `ssm_parameter`
...
`aws.ssm_parameter.withValue` constructs a mixin object that can be merged into the `ssm_parameter`
