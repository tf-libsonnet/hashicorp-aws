...
`aws.connect_hours_of_operation.withConfig` constructs a mixin object that can be merged into the `connect_hours_of_operation`
...
`aws.connect_hours_of_operation.withConfigMixin` constructs a mixin object that can be merged into the `connect_hours_of_operation`
Terraform resource block to set or update the config field.
...
`aws.connect_hours_of_operation.withDescription` constructs a mixin object that can be merged into the `connect_hours_of_operation`
...
`aws.connect_hours_of_operation.withTagsAll` constructs a mixin object that can be merged into the `connect_hours_of_operation`
...
`aws.connect_hours_of_operation.withTimeZone` constructs a mixin object that can be merged into the `connect_hours_of_operation`
