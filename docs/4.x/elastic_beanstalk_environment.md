...
`aws.elastic_beanstalk_environment.withApplication` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withCnamePrefix` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withDescription` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withName` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withPlatformArn` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withPollInterval` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withSetting` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withSettingMixin` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
Terraform resource block to set or update the setting field.
...
`aws.elastic_beanstalk_environment.withSolutionStackName` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withTags` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withTagsAll` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withTemplateName` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withTier` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withVersionLabel` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
...
`aws.elastic_beanstalk_environment.withWaitForReadyTimeout` constructs a mixin object that can be merged into the `elastic_beanstalk_environment`
