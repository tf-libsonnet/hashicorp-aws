...
`aws.kms_replica_external_key.withBypassPolicyLockoutSafetyCheck` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withDeletionWindowInDays` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withDescription` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withEnabled` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withKeyMaterialBase64` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withPolicy` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withPrimaryKeyArn` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withTags` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withTagsAll` constructs a mixin object that can be merged into the `kms_replica_external_key`
...
`aws.kms_replica_external_key.withValidTo` constructs a mixin object that can be merged into the `kms_replica_external_key`
