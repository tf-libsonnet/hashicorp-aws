...
`aws.apprunner_connection.withConnectionName` constructs a mixin object that can be merged into the `apprunner_connection`
...
`aws.apprunner_connection.withProviderType` constructs a mixin object that can be merged into the `apprunner_connection`
...
`aws.apprunner_connection.withTags` constructs a mixin object that can be merged into the `apprunner_connection`
...
`aws.apprunner_connection.withTagsAll` constructs a mixin object that can be merged into the `apprunner_connection`
