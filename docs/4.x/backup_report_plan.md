...
`aws.backup_report_plan.withDescription` constructs a mixin object that can be merged into the `backup_report_plan`
...
`aws.backup_report_plan.withName` constructs a mixin object that can be merged into the `backup_report_plan`
...
`aws.backup_report_plan.withReportDeliveryChannel` constructs a mixin object that can be merged into the `backup_report_plan`
...
`aws.backup_report_plan.withReportDeliveryChannelMixin` constructs a mixin object that can be merged into the `backup_report_plan`
Terraform resource block to set or update the report_delivery_channel field.
...
`aws.backup_report_plan.withReportSetting` constructs a mixin object that can be merged into the `backup_report_plan`
...
`aws.backup_report_plan.withReportSettingMixin` constructs a mixin object that can be merged into the `backup_report_plan`
Terraform resource block to set or update the report_setting field.
...
`aws.backup_report_plan.withTags` constructs a mixin object that can be merged into the `backup_report_plan`
...
`aws.backup_report_plan.withTagsAll` constructs a mixin object that can be merged into the `backup_report_plan`
