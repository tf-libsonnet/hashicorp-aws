...
`aws.ses_receipt_rule.withAddHeaderAction` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withAddHeaderActionMixin` constructs a mixin object that can be merged into the `ses_receipt_rule`
Terraform resource block to set or update the add_header_action field.
...
`aws.ses_receipt_rule.withAfter` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withBounceAction` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withBounceActionMixin` constructs a mixin object that can be merged into the `ses_receipt_rule`
Terraform resource block to set or update the bounce_action field.
...
`aws.ses_receipt_rule.withEnabled` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withLambdaAction` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withLambdaActionMixin` constructs a mixin object that can be merged into the `ses_receipt_rule`
Terraform resource block to set or update the lambda_action field.
...
`aws.ses_receipt_rule.withName` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withRecipients` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withRuleSetName` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withS3Action` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withS3ActionMixin` constructs a mixin object that can be merged into the `ses_receipt_rule`
Terraform resource block to set or update the s3_action field.
...
`aws.ses_receipt_rule.withScanEnabled` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withSnsAction` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withSnsActionMixin` constructs a mixin object that can be merged into the `ses_receipt_rule`
Terraform resource block to set or update the sns_action field.
...
`aws.ses_receipt_rule.withStopAction` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withStopActionMixin` constructs a mixin object that can be merged into the `ses_receipt_rule`
Terraform resource block to set or update the stop_action field.
...
`aws.ses_receipt_rule.withTlsPolicy` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withWorkmailAction` constructs a mixin object that can be merged into the `ses_receipt_rule`
...
`aws.ses_receipt_rule.withWorkmailActionMixin` constructs a mixin object that can be merged into the `ses_receipt_rule`
Terraform resource block to set or update the workmail_action field.
