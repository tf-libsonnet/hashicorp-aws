...
`aws.codestarnotifications_notification_rule.withResource` constructs a mixin object that can be merged into the `codestarnotifications_notification_rule`
