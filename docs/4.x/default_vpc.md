...
`aws.default_vpc.withAssignGeneratedIpv6CidrBlock` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withEnableClassiclink` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withEnableClassiclinkDnsSupport` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withEnableDnsHostnames` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withEnableDnsSupport` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withEnableNetworkAddressUsageMetrics` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withForceDestroy` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withIpv6CidrBlock` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withIpv6CidrBlockNetworkBorderGroup` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withIpv6IpamPoolId` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withIpv6NetmaskLength` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withTags` constructs a mixin object that can be merged into the `default_vpc`
...
`aws.default_vpc.withTagsAll` constructs a mixin object that can be merged into the `default_vpc`
