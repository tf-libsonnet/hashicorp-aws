...
`aws.ami_copy.withDeprecationTime` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withDescription` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withDestinationOutpostArn` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withEbsBlockDevice` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withEbsBlockDeviceMixin` constructs a mixin object that can be merged into the `ami_copy`
Terraform resource block to set or update the ebs_block_device field.
...
`aws.ami_copy.withEncrypted` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withEphemeralBlockDevice` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withEphemeralBlockDeviceMixin` constructs a mixin object that can be merged into the `ami_copy`
Terraform resource block to set or update the ephemeral_block_device field.
...
`aws.ami_copy.withKmsKeyId` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withName` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withSourceAmiId` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withSourceAmiRegion` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withTags` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withTagsAll` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withTimeouts` constructs a mixin object that can be merged into the `ami_copy`
...
`aws.ami_copy.withTimeoutsMixin` constructs a mixin object that can be merged into the `ami_copy`
Terraform resource block to set or update the timeouts field.
