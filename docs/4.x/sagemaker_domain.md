...
`aws.sagemaker_domain.withAppNetworkAccessType` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withAppSecurityGroupManagement` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withAuthMode` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withDefaultSpaceSettings` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withDefaultSpaceSettingsMixin` constructs a mixin object that can be merged into the `sagemaker_domain`
Terraform resource block to set or update the default_space_settings field.
...
`aws.sagemaker_domain.withDefaultUserSettings` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withDefaultUserSettingsMixin` constructs a mixin object that can be merged into the `sagemaker_domain`
Terraform resource block to set or update the default_user_settings field.
...
`aws.sagemaker_domain.withDomainName` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withDomainSettings` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withDomainSettingsMixin` constructs a mixin object that can be merged into the `sagemaker_domain`
Terraform resource block to set or update the domain_settings field.
...
`aws.sagemaker_domain.withKmsKeyId` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withRetentionPolicy` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withRetentionPolicyMixin` constructs a mixin object that can be merged into the `sagemaker_domain`
Terraform resource block to set or update the retention_policy field.
...
`aws.sagemaker_domain.withSubnetIds` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withTags` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_domain`
...
`aws.sagemaker_domain.withVpcId` constructs a mixin object that can be merged into the `sagemaker_domain`
