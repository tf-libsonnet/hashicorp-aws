...
`aws.guardduty_detector.withDatasources` constructs a mixin object that can be merged into the `guardduty_detector`
...
`aws.guardduty_detector.withDatasourcesMixin` constructs a mixin object that can be merged into the `guardduty_detector`
Terraform resource block to set or update the datasources field.
...
`aws.guardduty_detector.withEnable` constructs a mixin object that can be merged into the `guardduty_detector`
...
`aws.guardduty_detector.withFindingPublishingFrequency` constructs a mixin object that can be merged into the `guardduty_detector`
...
`aws.guardduty_detector.withTags` constructs a mixin object that can be merged into the `guardduty_detector`
...
`aws.guardduty_detector.withTagsAll` constructs a mixin object that can be merged into the `guardduty_detector`
