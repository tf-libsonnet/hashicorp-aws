...
`aws.auditmanager_framework.withComplianceType` constructs a mixin object that can be merged into the `auditmanager_framework`
...
`aws.auditmanager_framework.withControlSets` constructs a mixin object that can be merged into the `auditmanager_framework`
...
`aws.auditmanager_framework.withControlSetsMixin` constructs a mixin object that can be merged into the `auditmanager_framework`
Terraform resource block to set or update the control_sets field.
...
`aws.auditmanager_framework.withDescription` constructs a mixin object that can be merged into the `auditmanager_framework`
...
`aws.auditmanager_framework.withName` constructs a mixin object that can be merged into the `auditmanager_framework`
...
`aws.auditmanager_framework.withTags` constructs a mixin object that can be merged into the `auditmanager_framework`
