...
`aws.appstream_stack.withAccessEndpoints` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withAccessEndpointsMixin` constructs a mixin object that can be merged into the `appstream_stack`
Terraform resource block to set or update the access_endpoints field.
...
`aws.appstream_stack.withApplicationSettings` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withApplicationSettingsMixin` constructs a mixin object that can be merged into the `appstream_stack`
Terraform resource block to set or update the application_settings field.
...
`aws.appstream_stack.withDescription` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withDisplayName` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withEmbedHostDomains` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withFeedbackUrl` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withName` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withRedirectUrl` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withStorageConnectors` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withStorageConnectorsMixin` constructs a mixin object that can be merged into the `appstream_stack`
Terraform resource block to set or update the storage_connectors field.
...
`aws.appstream_stack.withTags` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withTagsAll` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withUserSettings` constructs a mixin object that can be merged into the `appstream_stack`
...
`aws.appstream_stack.withUserSettingsMixin` constructs a mixin object that can be merged into the `appstream_stack`
Terraform resource block to set or update the user_settings field.
