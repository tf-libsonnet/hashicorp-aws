...
`aws.security_group.withDescription` constructs a mixin object that can be merged into the `security_group`
...
`aws.security_group.withEgress` constructs a mixin object that can be merged into the `security_group`
...
`aws.security_group.withIngress` constructs a mixin object that can be merged into the `security_group`
...
`aws.security_group.withNamePrefix` constructs a mixin object that can be merged into the `security_group`
...
`aws.security_group.withRevokeRulesOnDelete` constructs a mixin object that can be merged into the `security_group`
...
`aws.security_group.withTagsAll` constructs a mixin object that can be merged into the `security_group`
