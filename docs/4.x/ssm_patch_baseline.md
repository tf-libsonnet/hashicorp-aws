...
`aws.ssm_patch_baseline.withApprovalRule` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withApprovalRuleMixin` constructs a mixin object that can be merged into the `ssm_patch_baseline`
Terraform resource block to set or update the approval_rule field.
...
`aws.ssm_patch_baseline.withApprovedPatches` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withApprovedPatchesComplianceLevel` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withApprovedPatchesEnableNonSecurity` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withDescription` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withGlobalFilter` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withGlobalFilterMixin` constructs a mixin object that can be merged into the `ssm_patch_baseline`
Terraform resource block to set or update the global_filter field.
...
`aws.ssm_patch_baseline.withName` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withRejectedPatches` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withRejectedPatchesAction` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withSource` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withSourceMixin` constructs a mixin object that can be merged into the `ssm_patch_baseline`
Terraform resource block to set or update the source field.
...
`aws.ssm_patch_baseline.withTags` constructs a mixin object that can be merged into the `ssm_patch_baseline`
...
`aws.ssm_patch_baseline.withTagsAll` constructs a mixin object that can be merged into the `ssm_patch_baseline`
