...
`aws.budgets_budget.withAccountId` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withAutoAdjustData` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withAutoAdjustDataMixin` constructs a mixin object that can be merged into the `budgets_budget`
Terraform resource block to set or update the auto_adjust_data field.
...
`aws.budgets_budget.withBudgetType` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withCostFilter` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withCostFilterMixin` constructs a mixin object that can be merged into the `budgets_budget`
Terraform resource block to set or update the cost_filter field.
...
`aws.budgets_budget.withCostFilters` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withCostTypes` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withCostTypesMixin` constructs a mixin object that can be merged into the `budgets_budget`
Terraform resource block to set or update the cost_types field.
...
`aws.budgets_budget.withLimitAmount` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withLimitUnit` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withName` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withNamePrefix` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withNotification` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withNotificationMixin` constructs a mixin object that can be merged into the `budgets_budget`
Terraform resource block to set or update the notification field.
...
`aws.budgets_budget.withPlannedLimit` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withPlannedLimitMixin` constructs a mixin object that can be merged into the `budgets_budget`
Terraform resource block to set or update the planned_limit field.
...
`aws.budgets_budget.withTimePeriodEnd` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withTimePeriodStart` constructs a mixin object that can be merged into the `budgets_budget`
...
`aws.budgets_budget.withTimeUnit` constructs a mixin object that can be merged into the `budgets_budget`
