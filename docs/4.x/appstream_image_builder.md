...
`aws.appstream_image_builder.withAccessEndpoint` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withAccessEndpointMixin` constructs a mixin object that can be merged into the `appstream_image_builder`
Terraform resource block to set or update the access_endpoint field.
...
`aws.appstream_image_builder.withAppstreamAgentVersion` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withDescription` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withDisplayName` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withDomainJoinInfo` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withDomainJoinInfoMixin` constructs a mixin object that can be merged into the `appstream_image_builder`
Terraform resource block to set or update the domain_join_info field.
...
`aws.appstream_image_builder.withEnableDefaultInternetAccess` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withIamRoleArn` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withImageArn` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withImageName` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withInstanceType` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withName` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withTags` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withTagsAll` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withVpcConfig` constructs a mixin object that can be merged into the `appstream_image_builder`
...
`aws.appstream_image_builder.withVpcConfigMixin` constructs a mixin object that can be merged into the `appstream_image_builder`
Terraform resource block to set or update the vpc_config field.
