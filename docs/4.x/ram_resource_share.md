...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.ram_resource_share.timeouts.new](#fn-ram_resource_sharetimeoutsnew) constructor.
...
Unlike [aws.ram_resource_share.new](#fn-ram_resource_sharenew), this function will not inject the `resource`
