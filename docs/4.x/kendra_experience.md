...
`aws.kendra_experience.withConfiguration` constructs a mixin object that can be merged into the `kendra_experience`
...
`aws.kendra_experience.withConfigurationMixin` constructs a mixin object that can be merged into the `kendra_experience`
Terraform resource block to set or update the configuration field.
...
`aws.kendra_experience.withDescription` constructs a mixin object that can be merged into the `kendra_experience`
...
`aws.kendra_experience.withName` constructs a mixin object that can be merged into the `kendra_experience`
...
`aws.kendra_experience.withRoleArn` constructs a mixin object that can be merged into the `kendra_experience`
...
`aws.kendra_experience.withTimeouts` constructs a mixin object that can be merged into the `kendra_experience`
...
`aws.kendra_experience.withTimeoutsMixin` constructs a mixin object that can be merged into the `kendra_experience`
Terraform resource block to set or update the timeouts field.
