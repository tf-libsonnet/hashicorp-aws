...
`aws.fsx_lustre_file_system.withAutoImportPolicy` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withAutomaticBackupRetentionDays` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withBackupId` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withCopyTagsToBackups` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withDailyAutomaticBackupStartTime` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withDataCompressionType` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withDeploymentType` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withDriveCacheType` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withExportPath` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withFileSystemTypeVersion` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withImportPath` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withImportedFileChunkSize` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withKmsKeyId` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withLogConfiguration` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withLogConfigurationMixin` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
Terraform resource block to set or update the log_configuration field.
...
`aws.fsx_lustre_file_system.withPerUnitStorageThroughput` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withSecurityGroupIds` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withStorageCapacity` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withStorageType` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withSubnetIds` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withTags` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withTagsAll` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withTimeouts` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
...
`aws.fsx_lustre_file_system.withTimeoutsMixin` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
Terraform resource block to set or update the timeouts field.
...
`aws.fsx_lustre_file_system.withWeeklyMaintenanceStartTime` constructs a mixin object that can be merged into the `fsx_lustre_file_system`
