...
`aws.sagemaker_project.withProjectDescription` constructs a mixin object that can be merged into the `sagemaker_project`
...
`aws.sagemaker_project.withProjectName` constructs a mixin object that can be merged into the `sagemaker_project`
...
`aws.sagemaker_project.withServiceCatalogProvisioningDetails` constructs a mixin object that can be merged into the `sagemaker_project`
...
`aws.sagemaker_project.withServiceCatalogProvisioningDetailsMixin` constructs a mixin object that can be merged into the `sagemaker_project`
Terraform resource block to set or update the service_catalog_provisioning_details field.
...
`aws.sagemaker_project.withTags` constructs a mixin object that can be merged into the `sagemaker_project`
...
`aws.sagemaker_project.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_project`
