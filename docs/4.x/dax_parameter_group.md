...
**Args**:
  ...
  - `name` (`string`): 
  - `parameters` (`list[obj]`):  When `null`, the `parameters` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dax_parameter_group.parameters.new](#fn-dax_parameter_groupparametersnew) constructor.
...
Unlike [aws.dax_parameter_group.new](#fn-dax_parameter_groupnew), this function will not inject the `resource`
