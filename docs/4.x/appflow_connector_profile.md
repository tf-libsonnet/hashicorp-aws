...
`aws.appflow_connector_profile.withConnectionMode` constructs a mixin object that can be merged into the `appflow_connector_profile`
...
`aws.appflow_connector_profile.withConnectorLabel` constructs a mixin object that can be merged into the `appflow_connector_profile`
...
`aws.appflow_connector_profile.withConnectorProfileConfig` constructs a mixin object that can be merged into the `appflow_connector_profile`
...
`aws.appflow_connector_profile.withConnectorProfileConfigMixin` constructs a mixin object that can be merged into the `appflow_connector_profile`
Terraform resource block to set or update the connector_profile_config field.
...
`aws.appflow_connector_profile.withConnectorType` constructs a mixin object that can be merged into the `appflow_connector_profile`
...
`aws.appflow_connector_profile.withKmsArn` constructs a mixin object that can be merged into the `appflow_connector_profile`
...
`aws.appflow_connector_profile.withName` constructs a mixin object that can be merged into the `appflow_connector_profile`
