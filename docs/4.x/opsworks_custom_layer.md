...
`aws.opsworks_custom_layer.withAutoAssignElasticIps` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withAutoAssignPublicIps` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withAutoHealing` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCloudwatchConfiguration` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCloudwatchConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_custom_layer`
Terraform resource block to set or update the cloudwatch_configuration field.
...
`aws.opsworks_custom_layer.withCustomConfigureRecipes` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCustomDeployRecipes` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCustomInstanceProfileArn` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCustomJson` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCustomSecurityGroupIds` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCustomSetupRecipes` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCustomShutdownRecipes` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withCustomUndeployRecipes` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withDrainElbOnShutdown` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withEbsVolume` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withEbsVolumeMixin` constructs a mixin object that can be merged into the `opsworks_custom_layer`
Terraform resource block to set or update the ebs_volume field.
...
`aws.opsworks_custom_layer.withElasticLoadBalancer` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withInstallUpdatesOnBoot` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withInstanceShutdownTimeout` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withLoadBasedAutoScaling` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withLoadBasedAutoScalingMixin` constructs a mixin object that can be merged into the `opsworks_custom_layer`
Terraform resource block to set or update the load_based_auto_scaling field.
...
`aws.opsworks_custom_layer.withName` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withShortName` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withStackId` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withSystemPackages` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withTags` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withTagsAll` constructs a mixin object that can be merged into the `opsworks_custom_layer`
...
`aws.opsworks_custom_layer.withUseEbsOptimizedInstances` constructs a mixin object that can be merged into the `opsworks_custom_layer`
