...
`aws.connect_instance_storage_config.withStorageConfig` constructs a mixin object that can be merged into the `connect_instance_storage_config`
...
`aws.connect_instance_storage_config.withStorageConfigMixin` constructs a mixin object that can be merged into the `connect_instance_storage_config`
Terraform resource block to set or update the storage_config field.
