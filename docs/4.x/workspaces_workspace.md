...
`aws.workspaces_workspace.withBundleId` constructs a mixin object that can be merged into the `workspaces_workspace`
...
`aws.workspaces_workspace.withRootVolumeEncryptionEnabled` constructs a mixin object that can be merged into the `workspaces_workspace`
...
`aws.workspaces_workspace.withTagsAll` constructs a mixin object that can be merged into the `workspaces_workspace`
...
`aws.workspaces_workspace.withTimeouts` constructs a mixin object that can be merged into the `workspaces_workspace`
...
`aws.workspaces_workspace.withTimeoutsMixin` constructs a mixin object that can be merged into the `workspaces_workspace`
Terraform resource block to set or update the timeouts field.
...
`aws.workspaces_workspace.withUserVolumeEncryptionEnabled` constructs a mixin object that can be merged into the `workspaces_workspace`
...
`aws.workspaces_workspace.withVolumeEncryptionKey` constructs a mixin object that can be merged into the `workspaces_workspace`
...
`aws.workspaces_workspace.withWorkspaceProperties` constructs a mixin object that can be merged into the `workspaces_workspace`
...
`aws.workspaces_workspace.withWorkspacePropertiesMixin` constructs a mixin object that can be merged into the `workspaces_workspace`
Terraform resource block to set or update the workspace_properties field.
