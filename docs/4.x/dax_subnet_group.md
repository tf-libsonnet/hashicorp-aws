...
`aws.dax_subnet_group.withDescription` constructs a mixin object that can be merged into the `dax_subnet_group`
...
`aws.dax_subnet_group.withName` constructs a mixin object that can be merged into the `dax_subnet_group`
...
`aws.dax_subnet_group.withSubnetIds` constructs a mixin object that can be merged into the `dax_subnet_group`
