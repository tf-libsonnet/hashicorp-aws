...
`aws.dx_hosted_public_virtual_interface.withAddressFamily` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withAmazonAddress` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withBgpAsn` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withBgpAuthKey` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withConnectionId` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withCustomerAddress` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withName` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withOwnerAccountId` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withRouteFilterPrefixes` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withTimeouts` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
...
`aws.dx_hosted_public_virtual_interface.withTimeoutsMixin` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
Terraform resource block to set or update the timeouts field.
...
`aws.dx_hosted_public_virtual_interface.withVlan` constructs a mixin object that can be merged into the `dx_hosted_public_virtual_interface`
