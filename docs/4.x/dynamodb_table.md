...
`aws.dynamodb_table.withAttribute` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withAttributeMixin` constructs a mixin object that can be merged into the `dynamodb_table`
Terraform resource block to set or update the attribute field.
...
`aws.dynamodb_table.withBillingMode` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withGlobalSecondaryIndex` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withGlobalSecondaryIndexMixin` constructs a mixin object that can be merged into the `dynamodb_table`
Terraform resource block to set or update the global_secondary_index field.
...
`aws.dynamodb_table.withHashKey` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withLocalSecondaryIndex` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withLocalSecondaryIndexMixin` constructs a mixin object that can be merged into the `dynamodb_table`
Terraform resource block to set or update the local_secondary_index field.
...
`aws.dynamodb_table.withPointInTimeRecovery` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withPointInTimeRecoveryMixin` constructs a mixin object that can be merged into the `dynamodb_table`
Terraform resource block to set or update the point_in_time_recovery field.
...
`aws.dynamodb_table.withRangeKey` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withReadCapacity` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withReplica` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withReplicaMixin` constructs a mixin object that can be merged into the `dynamodb_table`
Terraform resource block to set or update the replica field.
...
`aws.dynamodb_table.withRestoreDateTime` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withRestoreSourceName` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withRestoreToLatestTime` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withStreamEnabled` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withStreamViewType` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withTableClass` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withTagsAll` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withTimeouts` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withTimeoutsMixin` constructs a mixin object that can be merged into the `dynamodb_table`
Terraform resource block to set or update the timeouts field.
...
`aws.dynamodb_table.withTtl` constructs a mixin object that can be merged into the `dynamodb_table`
...
`aws.dynamodb_table.withTtlMixin` constructs a mixin object that can be merged into the `dynamodb_table`
Terraform resource block to set or update the ttl field.
...
`aws.dynamodb_table.withWriteCapacity` constructs a mixin object that can be merged into the `dynamodb_table`
