...
`aws.serverlessapplicationrepository_cloudformation_stack.withParameters` constructs a mixin object that can be merged into the `serverlessapplicationrepository_cloudformation_stack`
