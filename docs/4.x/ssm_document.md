...
`aws.ssm_document.withAttachmentsSource` constructs a mixin object that can be merged into the `ssm_document`
...
`aws.ssm_document.withAttachmentsSourceMixin` constructs a mixin object that can be merged into the `ssm_document`
Terraform resource block to set or update the attachments_source field.
...
`aws.ssm_document.withContent` constructs a mixin object that can be merged into the `ssm_document`
...
`aws.ssm_document.withDocumentType` constructs a mixin object that can be merged into the `ssm_document`
...
`aws.ssm_document.withPermissions` constructs a mixin object that can be merged into the `ssm_document`
...
`aws.ssm_document.withTags` constructs a mixin object that can be merged into the `ssm_document`
...
`aws.ssm_document.withTagsAll` constructs a mixin object that can be merged into the `ssm_document`
...
`aws.ssm_document.withTargetType` constructs a mixin object that can be merged into the `ssm_document`
...
`aws.ssm_document.withVersionName` constructs a mixin object that can be merged into the `ssm_document`
