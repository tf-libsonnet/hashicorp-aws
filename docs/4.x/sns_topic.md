...
`aws.sns_topic.withApplicationFailureFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withApplicationSuccessFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withApplicationSuccessFeedbackSampleRate` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withContentBasedDeduplication` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withDeliveryPolicy` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withDisplayName` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withFifoTopic` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withFirehoseFailureFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withFirehoseSuccessFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withFirehoseSuccessFeedbackSampleRate` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withHttpFailureFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withHttpSuccessFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withHttpSuccessFeedbackSampleRate` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withKmsMasterKeyId` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withLambdaFailureFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withLambdaSuccessFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withLambdaSuccessFeedbackSampleRate` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withName` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withNamePrefix` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withPolicy` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withSqsFailureFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withSqsSuccessFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withSqsSuccessFeedbackSampleRate` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withTags` constructs a mixin object that can be merged into the `sns_topic`
...
`aws.sns_topic.withTagsAll` constructs a mixin object that can be merged into the `sns_topic`
