...
`aws.ecr_repository.withEncryptionConfiguration` constructs a mixin object that can be merged into the `ecr_repository`
...
`aws.ecr_repository.withEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `ecr_repository`
Terraform resource block to set or update the encryption_configuration field.
...
`aws.ecr_repository.withForceDelete` constructs a mixin object that can be merged into the `ecr_repository`
...
`aws.ecr_repository.withImageScanningConfiguration` constructs a mixin object that can be merged into the `ecr_repository`
...
`aws.ecr_repository.withImageScanningConfigurationMixin` constructs a mixin object that can be merged into the `ecr_repository`
Terraform resource block to set or update the image_scanning_configuration field.
...
`aws.ecr_repository.withImageTagMutability` constructs a mixin object that can be merged into the `ecr_repository`
...
`aws.ecr_repository.withTagsAll` constructs a mixin object that can be merged into the `ecr_repository`
...
`aws.ecr_repository.withTimeouts` constructs a mixin object that can be merged into the `ecr_repository`
...
`aws.ecr_repository.withTimeoutsMixin` constructs a mixin object that can be merged into the `ecr_repository`
Terraform resource block to set or update the timeouts field.
