...
`aws.vpn_connection.withCustomerGatewayId` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withEnableAcceleration` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withLocalIpv4NetworkCidr` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withLocalIpv6NetworkCidr` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withOutsideIpAddressType` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withRemoteIpv4NetworkCidr` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withRemoteIpv6NetworkCidr` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withStaticRoutesOnly` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTags` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTagsAll` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTransitGatewayId` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTransportTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1DpdTimeoutAction` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1DpdTimeoutSeconds` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1IkeVersions` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1InsideCidr` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1InsideIpv6Cidr` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1LogOptions` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1LogOptionsMixin` constructs a mixin object that can be merged into the `vpn_connection`
Terraform resource block to set or update the tunnel1_log_options field.
...
`aws.vpn_connection.withTunnel1Phase1DhGroupNumbers` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1Phase1EncryptionAlgorithms` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1Phase1IntegrityAlgorithms` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1Phase1LifetimeSeconds` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1Phase2DhGroupNumbers` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1Phase2EncryptionAlgorithms` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1Phase2IntegrityAlgorithms` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1Phase2LifetimeSeconds` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1PresharedKey` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1RekeyFuzzPercentage` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1RekeyMarginTimeSeconds` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1ReplayWindowSize` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel1StartupAction` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2DpdTimeoutAction` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2DpdTimeoutSeconds` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2IkeVersions` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2InsideCidr` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2InsideIpv6Cidr` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2LogOptions` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2LogOptionsMixin` constructs a mixin object that can be merged into the `vpn_connection`
Terraform resource block to set or update the tunnel2_log_options field.
...
`aws.vpn_connection.withTunnel2Phase1DhGroupNumbers` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2Phase1EncryptionAlgorithms` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2Phase1IntegrityAlgorithms` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2Phase1LifetimeSeconds` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2Phase2DhGroupNumbers` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2Phase2EncryptionAlgorithms` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2Phase2IntegrityAlgorithms` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2Phase2LifetimeSeconds` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2PresharedKey` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2RekeyFuzzPercentage` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2RekeyMarginTimeSeconds` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2ReplayWindowSize` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnel2StartupAction` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withTunnelInsideIpVersion` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withType` constructs a mixin object that can be merged into the `vpn_connection`
...
`aws.vpn_connection.withVpnGatewayId` constructs a mixin object that can be merged into the `vpn_connection`
