...
`aws.opsworks_ganglia_layer.withAutoAssignElasticIps` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withAutoAssignPublicIps` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withAutoHealing` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCloudwatchConfiguration` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCloudwatchConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
Terraform resource block to set or update the cloudwatch_configuration field.
...
`aws.opsworks_ganglia_layer.withCustomConfigureRecipes` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCustomDeployRecipes` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCustomInstanceProfileArn` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCustomJson` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCustomSecurityGroupIds` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCustomSetupRecipes` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCustomShutdownRecipes` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withCustomUndeployRecipes` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withDrainElbOnShutdown` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withEbsVolume` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withEbsVolumeMixin` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
Terraform resource block to set or update the ebs_volume field.
...
`aws.opsworks_ganglia_layer.withElasticLoadBalancer` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withInstallUpdatesOnBoot` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withInstanceShutdownTimeout` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withLoadBasedAutoScaling` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withLoadBasedAutoScalingMixin` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
Terraform resource block to set or update the load_based_auto_scaling field.
...
`aws.opsworks_ganglia_layer.withName` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withPassword` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withStackId` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withSystemPackages` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withTags` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withTagsAll` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withUrl` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withUseEbsOptimizedInstances` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
...
`aws.opsworks_ganglia_layer.withUsername` constructs a mixin object that can be merged into the `opsworks_ganglia_layer`
