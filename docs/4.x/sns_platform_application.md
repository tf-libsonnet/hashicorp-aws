...
`aws.sns_platform_application.withApplePlatformBundleId` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withApplePlatformTeamId` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withEventDeliveryFailureTopicArn` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withEventEndpointCreatedTopicArn` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withEventEndpointDeletedTopicArn` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withEventEndpointUpdatedTopicArn` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withFailureFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withName` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withPlatform` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withPlatformCredential` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withPlatformPrincipal` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withSuccessFeedbackRoleArn` constructs a mixin object that can be merged into the `sns_platform_application`
...
`aws.sns_platform_application.withSuccessFeedbackSampleRate` constructs a mixin object that can be merged into the `sns_platform_application`
