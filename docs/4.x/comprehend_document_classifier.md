...
`aws.comprehend_document_classifier.withDataAccessRoleArn` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withInputDataConfig` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withInputDataConfigMixin` constructs a mixin object that can be merged into the `comprehend_document_classifier`
Terraform resource block to set or update the input_data_config field.
...
`aws.comprehend_document_classifier.withLanguageCode` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withMode` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withModelKmsKeyId` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withName` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withOutputDataConfig` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withOutputDataConfigMixin` constructs a mixin object that can be merged into the `comprehend_document_classifier`
Terraform resource block to set or update the output_data_config field.
...
`aws.comprehend_document_classifier.withTags` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withTagsAll` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withTimeouts` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withTimeoutsMixin` constructs a mixin object that can be merged into the `comprehend_document_classifier`
Terraform resource block to set or update the timeouts field.
...
`aws.comprehend_document_classifier.withVersionName` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withVersionNamePrefix` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withVolumeKmsKeyId` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withVpcConfig` constructs a mixin object that can be merged into the `comprehend_document_classifier`
...
`aws.comprehend_document_classifier.withVpcConfigMixin` constructs a mixin object that can be merged into the `comprehend_document_classifier`
Terraform resource block to set or update the vpc_config field.
