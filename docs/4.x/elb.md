...
`aws.elb.withAccessLogs` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withAccessLogsMixin` constructs a mixin object that can be merged into the `elb`
Terraform resource block to set or update the access_logs field.
...
`aws.elb.withAvailabilityZones` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withConnectionDraining` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withConnectionDrainingTimeout` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withCrossZoneLoadBalancing` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withDesyncMitigationMode` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withHealthCheck` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withHealthCheckMixin` constructs a mixin object that can be merged into the `elb`
Terraform resource block to set or update the health_check field.
...
`aws.elb.withIdleTimeout` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withInstances` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withInternal` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withListener` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withListenerMixin` constructs a mixin object that can be merged into the `elb`
Terraform resource block to set or update the listener field.
...
`aws.elb.withNamePrefix` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withSecurityGroups` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withSourceSecurityGroup` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withSubnets` constructs a mixin object that can be merged into the `elb`
...
`aws.elb.withTagsAll` constructs a mixin object that can be merged into the `elb`
