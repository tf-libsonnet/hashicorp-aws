...
`aws.kendra_data_source.withConfiguration` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withConfigurationMixin` constructs a mixin object that can be merged into the `kendra_data_source`
Terraform resource block to set or update the configuration field.
...
`aws.kendra_data_source.withCustomDocumentEnrichmentConfiguration` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withCustomDocumentEnrichmentConfigurationMixin` constructs a mixin object that can be merged into the `kendra_data_source`
Terraform resource block to set or update the custom_document_enrichment_configuration field.
...
`aws.kendra_data_source.withDescription` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withIndexId` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withLanguageCode` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withName` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withRoleArn` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withSchedule` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withTags` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withTagsAll` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withTimeouts` constructs a mixin object that can be merged into the `kendra_data_source`
...
`aws.kendra_data_source.withTimeoutsMixin` constructs a mixin object that can be merged into the `kendra_data_source`
Terraform resource block to set or update the timeouts field.
...
`aws.kendra_data_source.withType` constructs a mixin object that can be merged into the `kendra_data_source`
