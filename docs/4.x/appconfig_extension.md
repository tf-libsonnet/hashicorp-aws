...
`aws.appconfig_extension.withActionPoint` constructs a mixin object that can be merged into the `appconfig_extension`
...
`aws.appconfig_extension.withActionPointMixin` constructs a mixin object that can be merged into the `appconfig_extension`
Terraform resource block to set or update the action_point field.
...
`aws.appconfig_extension.withDescription` constructs a mixin object that can be merged into the `appconfig_extension`
...
`aws.appconfig_extension.withName` constructs a mixin object that can be merged into the `appconfig_extension`
...
`aws.appconfig_extension.withParameter` constructs a mixin object that can be merged into the `appconfig_extension`
...
`aws.appconfig_extension.withParameterMixin` constructs a mixin object that can be merged into the `appconfig_extension`
Terraform resource block to set or update the parameter field.
...
`aws.appconfig_extension.withTags` constructs a mixin object that can be merged into the `appconfig_extension`
...
`aws.appconfig_extension.withTagsAll` constructs a mixin object that can be merged into the `appconfig_extension`
