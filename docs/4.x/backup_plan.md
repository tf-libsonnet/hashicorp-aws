...
`aws.backup_plan.withAdvancedBackupSetting` constructs a mixin object that can be merged into the `backup_plan`
...
`aws.backup_plan.withAdvancedBackupSettingMixin` constructs a mixin object that can be merged into the `backup_plan`
Terraform resource block to set or update the advanced_backup_setting field.
...
`aws.backup_plan.withName` constructs a mixin object that can be merged into the `backup_plan`
...
`aws.backup_plan.withRule` constructs a mixin object that can be merged into the `backup_plan`
...
`aws.backup_plan.withRuleMixin` constructs a mixin object that can be merged into the `backup_plan`
Terraform resource block to set or update the rule field.
...
`aws.backup_plan.withTagsAll` constructs a mixin object that can be merged into the `backup_plan`
