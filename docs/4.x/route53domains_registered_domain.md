...
`aws.route53domains_registered_domain.withAdminContact` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withAdminContactMixin` constructs a mixin object that can be merged into the `route53domains_registered_domain`
Terraform resource block to set or update the admin_contact field.
...
`aws.route53domains_registered_domain.withAdminPrivacy` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withAutoRenew` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withDomainName` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withNameServer` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withNameServerMixin` constructs a mixin object that can be merged into the `route53domains_registered_domain`
Terraform resource block to set or update the name_server field.
...
`aws.route53domains_registered_domain.withRegistrantContact` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withRegistrantContactMixin` constructs a mixin object that can be merged into the `route53domains_registered_domain`
Terraform resource block to set or update the registrant_contact field.
...
`aws.route53domains_registered_domain.withRegistrantPrivacy` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withTags` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withTagsAll` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withTechContact` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withTechContactMixin` constructs a mixin object that can be merged into the `route53domains_registered_domain`
Terraform resource block to set or update the tech_contact field.
...
`aws.route53domains_registered_domain.withTechPrivacy` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withTimeouts` constructs a mixin object that can be merged into the `route53domains_registered_domain`
...
`aws.route53domains_registered_domain.withTimeoutsMixin` constructs a mixin object that can be merged into the `route53domains_registered_domain`
Terraform resource block to set or update the timeouts field.
...
`aws.route53domains_registered_domain.withTransferLock` constructs a mixin object that can be merged into the `route53domains_registered_domain`
