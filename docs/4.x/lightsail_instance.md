...
`aws.lightsail_instance.withAvailabilityZone` constructs a mixin object that can be merged into the `lightsail_instance`
...
`aws.lightsail_instance.withBlueprintId` constructs a mixin object that can be merged into the `lightsail_instance`
...
`aws.lightsail_instance.withBundleId` constructs a mixin object that can be merged into the `lightsail_instance`
...
`aws.lightsail_instance.withIpAddressType` constructs a mixin object that can be merged into the `lightsail_instance`
...
`aws.lightsail_instance.withKeyPairName` constructs a mixin object that can be merged into the `lightsail_instance`
...
`aws.lightsail_instance.withName` constructs a mixin object that can be merged into the `lightsail_instance`
...
`aws.lightsail_instance.withTags` constructs a mixin object that can be merged into the `lightsail_instance`
...
`aws.lightsail_instance.withTagsAll` constructs a mixin object that can be merged into the `lightsail_instance`
...
`aws.lightsail_instance.withUserData` constructs a mixin object that can be merged into the `lightsail_instance`
