---
permalink: /opsworks_ecs_cluster_layer/
---

# opsworks_ecs_cluster_layer

`opsworks_ecs_cluster_layer` represents the `aws_opsworks_ecs_cluster_layer` Terraform resource.
...
`aws.opsworks_ecs_cluster_layer.withAutoAssignElasticIps` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withAutoAssignPublicIps` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withAutoHealing` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCloudwatchConfiguration` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCloudwatchConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
Terraform resource block to set or update the cloudwatch_configuration field.
...
`aws.opsworks_ecs_cluster_layer.withCustomConfigureRecipes` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCustomDeployRecipes` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCustomInstanceProfileArn` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCustomJson` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCustomSecurityGroupIds` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCustomSetupRecipes` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCustomShutdownRecipes` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withCustomUndeployRecipes` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withDrainElbOnShutdown` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withEbsVolume` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withEbsVolumeMixin` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
Terraform resource block to set or update the ebs_volume field.
...
`aws.opsworks_ecs_cluster_layer.withEcsClusterArn` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withElasticLoadBalancer` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withInstallUpdatesOnBoot` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withInstanceShutdownTimeout` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withLoadBasedAutoScaling` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withLoadBasedAutoScalingMixin` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
Terraform resource block to set or update the load_based_auto_scaling field.
...
`aws.opsworks_ecs_cluster_layer.withName` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withStackId` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withSystemPackages` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withTags` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withTagsAll` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
...
`aws.opsworks_ecs_cluster_layer.withUseEbsOptimizedInstances` constructs a mixin object that can be merged into the `opsworks_ecs_cluster_layer`
