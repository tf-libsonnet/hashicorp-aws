...
`aws.network_interface.withAttachment` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withAttachmentMixin` constructs a mixin object that can be merged into the `network_interface`
Terraform resource block to set or update the attachment field.
...
`aws.network_interface.withDescription` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withInterfaceType` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withIpv4PrefixCount` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withIpv4Prefixes` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withIpv6AddressCount` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withIpv6AddressList` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withIpv6AddressListEnabled` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withIpv6Addresses` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withIpv6PrefixCount` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withIpv6Prefixes` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withPrivateIp` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withPrivateIpList` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withPrivateIpListEnabled` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withPrivateIps` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withPrivateIpsCount` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withSecurityGroups` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withSourceDestCheck` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withSubnetId` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withTags` constructs a mixin object that can be merged into the `network_interface`
...
`aws.network_interface.withTagsAll` constructs a mixin object that can be merged into the `network_interface`
