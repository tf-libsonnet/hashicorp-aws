...
`aws.acmpca_certificate_authority.withCertificateAuthorityConfiguration` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
...
`aws.acmpca_certificate_authority.withCertificateAuthorityConfigurationMixin` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
Terraform resource block to set or update the certificate_authority_configuration field.
...
`aws.acmpca_certificate_authority.withEnabled` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
...
`aws.acmpca_certificate_authority.withPermanentDeletionTimeInDays` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
...
`aws.acmpca_certificate_authority.withTagsAll` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
...
`aws.acmpca_certificate_authority.withTimeouts` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
...
`aws.acmpca_certificate_authority.withTimeoutsMixin` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
Terraform resource block to set or update the timeouts field.
...
`aws.acmpca_certificate_authority.withType` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
...
`aws.acmpca_certificate_authority.withUsageMode` constructs a mixin object that can be merged into the `acmpca_certificate_authority`
