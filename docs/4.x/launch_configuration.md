...
`aws.launch_configuration.withAssociatePublicIpAddress` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withEbsBlockDevice` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withEbsBlockDeviceMixin` constructs a mixin object that can be merged into the `launch_configuration`
Terraform resource block to set or update the ebs_block_device field.
...
`aws.launch_configuration.withEbsOptimized` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withEnableMonitoring` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withEphemeralBlockDevice` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withEphemeralBlockDeviceMixin` constructs a mixin object that can be merged into the `launch_configuration`
Terraform resource block to set or update the ephemeral_block_device field.
...
`aws.launch_configuration.withIamInstanceProfile` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withImageId` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withInstanceType` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withKeyName` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withMetadataOptions` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withMetadataOptionsMixin` constructs a mixin object that can be merged into the `launch_configuration`
Terraform resource block to set or update the metadata_options field.
...
`aws.launch_configuration.withName` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withNamePrefix` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withPlacementTenancy` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withRootBlockDevice` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withRootBlockDeviceMixin` constructs a mixin object that can be merged into the `launch_configuration`
Terraform resource block to set or update the root_block_device field.
...
`aws.launch_configuration.withSecurityGroups` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withSpotPrice` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withUserData` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withUserDataBase64` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withVpcClassicLinkId` constructs a mixin object that can be merged into the `launch_configuration`
...
`aws.launch_configuration.withVpcClassicLinkSecurityGroups` constructs a mixin object that can be merged into the `launch_configuration`
