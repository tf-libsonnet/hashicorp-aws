...
`aws.lb.withAccessLogs` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withAccessLogsMixin` constructs a mixin object that can be merged into the `lb`
Terraform resource block to set or update the access_logs field.
...
`aws.lb.withCustomerOwnedIpv4Pool` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withDesyncMitigationMode` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withDropInvalidHeaderFields` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withEnableCrossZoneLoadBalancing` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withEnableDeletionProtection` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withEnableHttp2` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withEnableWafFailOpen` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withIdleTimeout` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withInternal` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withIpAddressType` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withLoadBalancerType` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withName` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withNamePrefix` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withPreserveHostHeader` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withSecurityGroups` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withSubnetMapping` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withSubnetMappingMixin` constructs a mixin object that can be merged into the `lb`
Terraform resource block to set or update the subnet_mapping field.
...
`aws.lb.withSubnets` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withTags` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withTagsAll` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withTimeouts` constructs a mixin object that can be merged into the `lb`
...
`aws.lb.withTimeoutsMixin` constructs a mixin object that can be merged into the `lb`
Terraform resource block to set or update the timeouts field.
