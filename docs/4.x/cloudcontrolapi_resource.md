...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.cloudcontrolapi_resource.timeouts.new](#fn-cloudcontrolapi_resourcetimeoutsnew) constructor.
...
Unlike [aws.cloudcontrolapi_resource.new](#fn-cloudcontrolapi_resourcenew), this function will not inject the `resource`
