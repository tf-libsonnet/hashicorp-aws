...
`aws.kms_key.withBypassPolicyLockoutSafetyCheck` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withCustomKeyStoreId` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withCustomerMasterKeySpec` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withDeletionWindowInDays` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withDescription` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withEnableKeyRotation` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withIsEnabled` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withKeyUsage` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withMultiRegion` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withPolicy` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withTags` constructs a mixin object that can be merged into the `kms_key`
...
`aws.kms_key.withTagsAll` constructs a mixin object that can be merged into the `kms_key`
