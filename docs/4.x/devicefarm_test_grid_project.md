...
`aws.devicefarm_test_grid_project.withDescription` constructs a mixin object that can be merged into the `devicefarm_test_grid_project`
...
`aws.devicefarm_test_grid_project.withName` constructs a mixin object that can be merged into the `devicefarm_test_grid_project`
...
`aws.devicefarm_test_grid_project.withTags` constructs a mixin object that can be merged into the `devicefarm_test_grid_project`
...
`aws.devicefarm_test_grid_project.withTagsAll` constructs a mixin object that can be merged into the `devicefarm_test_grid_project`
...
`aws.devicefarm_test_grid_project.withVpcConfig` constructs a mixin object that can be merged into the `devicefarm_test_grid_project`
...
`aws.devicefarm_test_grid_project.withVpcConfigMixin` constructs a mixin object that can be merged into the `devicefarm_test_grid_project`
Terraform resource block to set or update the vpc_config field.
