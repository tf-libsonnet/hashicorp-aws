...
`aws.synthetics_canary.withArtifactConfig` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withArtifactConfigMixin` constructs a mixin object that can be merged into the `synthetics_canary`
Terraform resource block to set or update the artifact_config field.
...
`aws.synthetics_canary.withArtifactS3Location` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withDeleteLambda` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withExecutionRoleArn` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withFailureRetentionPeriod` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withHandler` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withName` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withRunConfig` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withRunConfigMixin` constructs a mixin object that can be merged into the `synthetics_canary`
Terraform resource block to set or update the run_config field.
...
`aws.synthetics_canary.withRuntimeVersion` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withS3Bucket` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withS3Key` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withS3Version` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withSchedule` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withScheduleMixin` constructs a mixin object that can be merged into the `synthetics_canary`
Terraform resource block to set or update the schedule field.
...
`aws.synthetics_canary.withStartCanary` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withSuccessRetentionPeriod` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withTags` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withTagsAll` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withVpcConfig` constructs a mixin object that can be merged into the `synthetics_canary`
...
`aws.synthetics_canary.withVpcConfigMixin` constructs a mixin object that can be merged into the `synthetics_canary`
Terraform resource block to set or update the vpc_config field.
...
`aws.synthetics_canary.withZipFile` constructs a mixin object that can be merged into the `synthetics_canary`
