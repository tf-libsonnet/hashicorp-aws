...
`aws.networkfirewall_firewall_policy.withDescription` constructs a mixin object that can be merged into the `networkfirewall_firewall_policy`
...
`aws.networkfirewall_firewall_policy.withEncryptionConfiguration` constructs a mixin object that can be merged into the `networkfirewall_firewall_policy`
...
`aws.networkfirewall_firewall_policy.withEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `networkfirewall_firewall_policy`
Terraform resource block to set or update the encryption_configuration field.
...
`aws.networkfirewall_firewall_policy.withFirewallPolicy` constructs a mixin object that can be merged into the `networkfirewall_firewall_policy`
...
`aws.networkfirewall_firewall_policy.withFirewallPolicyMixin` constructs a mixin object that can be merged into the `networkfirewall_firewall_policy`
Terraform resource block to set or update the firewall_policy field.
...
`aws.networkfirewall_firewall_policy.withTagsAll` constructs a mixin object that can be merged into the `networkfirewall_firewall_policy`
