...
Unlike [aws.pinpoint_adm_channel.new](#fn-pinpoint_adm_channelnew), this function will not inject the `resource`
...
`aws.string.withClientSecret` constructs a mixin object that can be merged into the `string`
