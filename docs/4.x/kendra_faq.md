...
`aws.kendra_faq.withDescription` constructs a mixin object that can be merged into the `kendra_faq`
...
`aws.kendra_faq.withFileFormat` constructs a mixin object that can be merged into the `kendra_faq`
...
`aws.kendra_faq.withLanguageCode` constructs a mixin object that can be merged into the `kendra_faq`
...
`aws.kendra_faq.withName` constructs a mixin object that can be merged into the `kendra_faq`
...
`aws.kendra_faq.withRoleArn` constructs a mixin object that can be merged into the `kendra_faq`
...
`aws.kendra_faq.withS3Path` constructs a mixin object that can be merged into the `kendra_faq`
...
`aws.kendra_faq.withS3PathMixin` constructs a mixin object that can be merged into the `kendra_faq`
Terraform resource block to set or update the s3_path field.
...
`aws.kendra_faq.withTagsAll` constructs a mixin object that can be merged into the `kendra_faq`
...
`aws.kendra_faq.withTimeouts` constructs a mixin object that can be merged into the `kendra_faq`
...
`aws.kendra_faq.withTimeoutsMixin` constructs a mixin object that can be merged into the `kendra_faq`
Terraform resource block to set or update the timeouts field.
