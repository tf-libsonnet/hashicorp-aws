...
`aws.datasync_task.withCloudwatchLogGroupArn` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withDestinationLocationArn` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withExcludes` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withExcludesMixin` constructs a mixin object that can be merged into the `datasync_task`
Terraform resource block to set or update the excludes field.
...
`aws.datasync_task.withIncludes` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withIncludesMixin` constructs a mixin object that can be merged into the `datasync_task`
Terraform resource block to set or update the includes field.
...
`aws.datasync_task.withName` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withOptions` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withOptionsMixin` constructs a mixin object that can be merged into the `datasync_task`
Terraform resource block to set or update the options field.
...
`aws.datasync_task.withSchedule` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withScheduleMixin` constructs a mixin object that can be merged into the `datasync_task`
Terraform resource block to set or update the schedule field.
...
`aws.datasync_task.withSourceLocationArn` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withTags` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withTagsAll` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withTimeouts` constructs a mixin object that can be merged into the `datasync_task`
...
`aws.datasync_task.withTimeoutsMixin` constructs a mixin object that can be merged into the `datasync_task`
Terraform resource block to set or update the timeouts field.
