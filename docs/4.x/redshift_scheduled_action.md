...
`aws.redshift_scheduled_action.withDescription` constructs a mixin object that can be merged into the `redshift_scheduled_action`
...
`aws.redshift_scheduled_action.withEnable` constructs a mixin object that can be merged into the `redshift_scheduled_action`
...
`aws.redshift_scheduled_action.withEndTime` constructs a mixin object that can be merged into the `redshift_scheduled_action`
...
`aws.redshift_scheduled_action.withIamRole` constructs a mixin object that can be merged into the `redshift_scheduled_action`
...
`aws.redshift_scheduled_action.withName` constructs a mixin object that can be merged into the `redshift_scheduled_action`
...
`aws.redshift_scheduled_action.withSchedule` constructs a mixin object that can be merged into the `redshift_scheduled_action`
...
`aws.redshift_scheduled_action.withStartTime` constructs a mixin object that can be merged into the `redshift_scheduled_action`
...
`aws.redshift_scheduled_action.withTargetAction` constructs a mixin object that can be merged into the `redshift_scheduled_action`
...
`aws.redshift_scheduled_action.withTargetActionMixin` constructs a mixin object that can be merged into the `redshift_scheduled_action`
Terraform resource block to set or update the target_action field.
