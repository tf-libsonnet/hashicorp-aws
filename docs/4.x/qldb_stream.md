...
`aws.qldb_stream.withExclusiveEndTime` constructs a mixin object that can be merged into the `qldb_stream`
...
`aws.qldb_stream.withInclusiveStartTime` constructs a mixin object that can be merged into the `qldb_stream`
...
`aws.qldb_stream.withKinesisConfiguration` constructs a mixin object that can be merged into the `qldb_stream`
...
`aws.qldb_stream.withKinesisConfigurationMixin` constructs a mixin object that can be merged into the `qldb_stream`
Terraform resource block to set or update the kinesis_configuration field.
...
`aws.qldb_stream.withLedgerName` constructs a mixin object that can be merged into the `qldb_stream`
...
`aws.qldb_stream.withRoleArn` constructs a mixin object that can be merged into the `qldb_stream`
...
`aws.qldb_stream.withStreamName` constructs a mixin object that can be merged into the `qldb_stream`
...
`aws.qldb_stream.withTags` constructs a mixin object that can be merged into the `qldb_stream`
...
`aws.qldb_stream.withTagsAll` constructs a mixin object that can be merged into the `qldb_stream`
