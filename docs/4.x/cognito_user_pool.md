...
`aws.cognito_user_pool.withAccountRecoverySetting` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withAccountRecoverySettingMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the account_recovery_setting field.
...
`aws.cognito_user_pool.withAdminCreateUserConfig` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withAdminCreateUserConfigMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the admin_create_user_config field.
...
`aws.cognito_user_pool.withAliasAttributes` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withAutoVerifiedAttributes` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withDeletionProtection` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withDeviceConfiguration` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withDeviceConfigurationMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the device_configuration field.
...
`aws.cognito_user_pool.withEmailConfiguration` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withEmailConfigurationMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the email_configuration field.
...
`aws.cognito_user_pool.withEmailVerificationMessage` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withEmailVerificationSubject` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withLambdaConfig` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withLambdaConfigMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the lambda_config field.
...
`aws.cognito_user_pool.withMfaConfiguration` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withName` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withPasswordPolicy` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withPasswordPolicyMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the password_policy field.
...
`aws.cognito_user_pool.withSchema` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withSchemaMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the schema field.
...
`aws.cognito_user_pool.withSmsAuthenticationMessage` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withSmsConfiguration` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withSmsConfigurationMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the sms_configuration field.
...
`aws.cognito_user_pool.withSmsVerificationMessage` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withSoftwareTokenMfaConfiguration` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withSoftwareTokenMfaConfigurationMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the software_token_mfa_configuration field.
...
`aws.cognito_user_pool.withTags` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withTagsAll` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withUserAttributeUpdateSettings` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withUserAttributeUpdateSettingsMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the user_attribute_update_settings field.
...
`aws.cognito_user_pool.withUserPoolAddOns` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withUserPoolAddOnsMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the user_pool_add_ons field.
...
`aws.cognito_user_pool.withUsernameAttributes` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withUsernameConfiguration` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withUsernameConfigurationMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the username_configuration field.
...
`aws.cognito_user_pool.withVerificationMessageTemplate` constructs a mixin object that can be merged into the `cognito_user_pool`
...
`aws.cognito_user_pool.withVerificationMessageTemplateMixin` constructs a mixin object that can be merged into the `cognito_user_pool`
Terraform resource block to set or update the verification_message_template field.
