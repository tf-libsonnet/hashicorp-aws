...
`aws.instance.withAmi` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withAssociatePublicIpAddress` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withAvailabilityZone` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withCapacityReservationSpecification` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withCapacityReservationSpecificationMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the capacity_reservation_specification field.
...
`aws.instance.withCpuCoreCount` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withCpuThreadsPerCore` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withCreditSpecification` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withCreditSpecificationMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the credit_specification field.
...
`aws.instance.withDisableApiStop` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withDisableApiTermination` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withEbsBlockDevice` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withEbsBlockDeviceMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the ebs_block_device field.
...
`aws.instance.withEbsOptimized` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withEnclaveOptions` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withEnclaveOptionsMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the enclave_options field.
...
`aws.instance.withEphemeralBlockDevice` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withEphemeralBlockDeviceMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the ephemeral_block_device field.
...
`aws.instance.withHibernation` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withHostId` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withHostResourceGroupArn` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withIamInstanceProfile` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withInstanceInitiatedShutdownBehavior` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withInstanceType` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withIpv6AddressCount` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withIpv6Addresses` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withKeyName` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withLaunchTemplate` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withLaunchTemplateMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the launch_template field.
...
`aws.instance.withMaintenanceOptions` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withMaintenanceOptionsMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the maintenance_options field.
...
`aws.instance.withMetadataOptions` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withMetadataOptionsMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the metadata_options field.
...
`aws.instance.withMonitoring` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withNetworkInterface` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withNetworkInterfaceMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the network_interface field.
...
`aws.instance.withPlacementGroup` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withPlacementPartitionNumber` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withPrivateDnsNameOptions` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withPrivateDnsNameOptionsMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the private_dns_name_options field.
...
`aws.instance.withPrivateIp` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withRootBlockDevice` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withRootBlockDeviceMixin` constructs a mixin object that can be merged into the `instance`
Terraform resource block to set or update the root_block_device field.
...
`aws.instance.withSecondaryPrivateIps` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withSecurityGroups` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withSourceDestCheck` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withSubnetId` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withTagsAll` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withTenancy` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withUserData` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withUserDataBase64` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withUserDataReplaceOnChange` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withVolumeTags` constructs a mixin object that can be merged into the `instance`
...
`aws.instance.withVpcSecurityGroupIds` constructs a mixin object that can be merged into the `instance`
