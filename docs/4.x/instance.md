...
Unlike [aws.instance.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `capacity_reservation_target` (`list[obj]`):  When `null`, the `capacity_reservation_target` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.instance.capacity_reservation_specification.capacity_reservation_target.new](#fn-instancecapacity_reservation_targetnew) constructor.
