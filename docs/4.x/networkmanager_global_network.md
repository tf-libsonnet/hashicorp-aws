...
`aws.networkmanager_global_network.withDescription` constructs a mixin object that can be merged into the `networkmanager_global_network`
...
`aws.networkmanager_global_network.withTagsAll` constructs a mixin object that can be merged into the `networkmanager_global_network`
...
`aws.networkmanager_global_network.withTimeouts` constructs a mixin object that can be merged into the `networkmanager_global_network`
...
`aws.networkmanager_global_network.withTimeoutsMixin` constructs a mixin object that can be merged into the `networkmanager_global_network`
Terraform resource block to set or update the timeouts field.
