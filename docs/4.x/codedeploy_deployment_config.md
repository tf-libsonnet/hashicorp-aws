...
`aws.codedeploy_deployment_config.withComputePlatform` constructs a mixin object that can be merged into the `codedeploy_deployment_config`
...
`aws.codedeploy_deployment_config.withDeploymentConfigName` constructs a mixin object that can be merged into the `codedeploy_deployment_config`
...
`aws.codedeploy_deployment_config.withMinimumHealthyHosts` constructs a mixin object that can be merged into the `codedeploy_deployment_config`
...
`aws.codedeploy_deployment_config.withMinimumHealthyHostsMixin` constructs a mixin object that can be merged into the `codedeploy_deployment_config`
Terraform resource block to set or update the minimum_healthy_hosts field.
...
`aws.codedeploy_deployment_config.withTrafficRoutingConfig` constructs a mixin object that can be merged into the `codedeploy_deployment_config`
...
`aws.codedeploy_deployment_config.withTrafficRoutingConfigMixin` constructs a mixin object that can be merged into the `codedeploy_deployment_config`
Terraform resource block to set or update the traffic_routing_config field.
