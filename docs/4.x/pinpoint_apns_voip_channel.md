...
`aws.pinpoint_apns_voip_channel.withApplicationId` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
...
`aws.pinpoint_apns_voip_channel.withBundleId` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
...
`aws.pinpoint_apns_voip_channel.withCertificate` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
...
`aws.pinpoint_apns_voip_channel.withDefaultAuthenticationMethod` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
...
`aws.pinpoint_apns_voip_channel.withEnabled` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
...
`aws.pinpoint_apns_voip_channel.withPrivateKey` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
...
`aws.pinpoint_apns_voip_channel.withTeamId` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
...
`aws.pinpoint_apns_voip_channel.withTokenKey` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
...
`aws.pinpoint_apns_voip_channel.withTokenKeyId` constructs a mixin object that can be merged into the `pinpoint_apns_voip_channel`
