...
`aws.storagegateway_gateway.withActivationKey` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withAverageDownloadRateLimitInBitsPerSec` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withAverageUploadRateLimitInBitsPerSec` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withCloudwatchLogGroupArn` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withGatewayIpAddress` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withGatewayName` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withGatewayTimezone` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withGatewayType` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withGatewayVpcEndpoint` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withMaintenanceStartTime` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withMaintenanceStartTimeMixin` constructs a mixin object that can be merged into the `storagegateway_gateway`
Terraform resource block to set or update the maintenance_start_time field.
...
`aws.storagegateway_gateway.withMediumChangerType` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withSmbActiveDirectorySettings` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withSmbActiveDirectorySettingsMixin` constructs a mixin object that can be merged into the `storagegateway_gateway`
Terraform resource block to set or update the smb_active_directory_settings field.
...
`aws.storagegateway_gateway.withSmbFileShareVisibility` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withSmbGuestPassword` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withSmbSecurityStrategy` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withTags` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withTagsAll` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withTapeDriveType` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withTimeouts` constructs a mixin object that can be merged into the `storagegateway_gateway`
...
`aws.storagegateway_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `storagegateway_gateway`
Terraform resource block to set or update the timeouts field.
