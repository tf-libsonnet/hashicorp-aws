...
`aws.memorydb_snapshot.withClusterName` constructs a mixin object that can be merged into the `memorydb_snapshot`
...
`aws.memorydb_snapshot.withKmsKeyArn` constructs a mixin object that can be merged into the `memorydb_snapshot`
...
`aws.memorydb_snapshot.withName` constructs a mixin object that can be merged into the `memorydb_snapshot`
...
`aws.memorydb_snapshot.withNamePrefix` constructs a mixin object that can be merged into the `memorydb_snapshot`
...
`aws.memorydb_snapshot.withTags` constructs a mixin object that can be merged into the `memorydb_snapshot`
...
`aws.memorydb_snapshot.withTagsAll` constructs a mixin object that can be merged into the `memorydb_snapshot`
...
`aws.memorydb_snapshot.withTimeouts` constructs a mixin object that can be merged into the `memorydb_snapshot`
...
`aws.memorydb_snapshot.withTimeoutsMixin` constructs a mixin object that can be merged into the `memorydb_snapshot`
Terraform resource block to set or update the timeouts field.
