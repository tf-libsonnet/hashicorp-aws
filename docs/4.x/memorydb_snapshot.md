...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.memorydb_snapshot.timeouts.new](#fn-memorydb_snapshottimeoutsnew) constructor.
...
Unlike [aws.memorydb_snapshot.new](#fn-memorydb_snapshotnew), this function will not inject the `resource`
