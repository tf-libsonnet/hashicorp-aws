...
`aws.elastictranscoder_preset.withAudio` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withAudioCodecOptions` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withAudioCodecOptionsMixin` constructs a mixin object that can be merged into the `elastictranscoder_preset`
Terraform resource block to set or update the audio_codec_options field.
...
`aws.elastictranscoder_preset.withAudioMixin` constructs a mixin object that can be merged into the `elastictranscoder_preset`
Terraform resource block to set or update the audio field.
...
`aws.elastictranscoder_preset.withContainer` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withDescription` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withName` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withThumbnails` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withThumbnailsMixin` constructs a mixin object that can be merged into the `elastictranscoder_preset`
Terraform resource block to set or update the thumbnails field.
...
`aws.elastictranscoder_preset.withType` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withVideo` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withVideoCodecOptions` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withVideoMixin` constructs a mixin object that can be merged into the `elastictranscoder_preset`
Terraform resource block to set or update the video field.
...
`aws.elastictranscoder_preset.withVideoWatermarks` constructs a mixin object that can be merged into the `elastictranscoder_preset`
...
`aws.elastictranscoder_preset.withVideoWatermarksMixin` constructs a mixin object that can be merged into the `elastictranscoder_preset`
Terraform resource block to set or update the video_watermarks field.
