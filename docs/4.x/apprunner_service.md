...
`aws.apprunner_service.withAutoScalingConfigurationArn` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withEncryptionConfiguration` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `apprunner_service`
Terraform resource block to set or update the encryption_configuration field.
...
`aws.apprunner_service.withHealthCheckConfiguration` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withHealthCheckConfigurationMixin` constructs a mixin object that can be merged into the `apprunner_service`
Terraform resource block to set or update the health_check_configuration field.
...
`aws.apprunner_service.withInstanceConfiguration` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withInstanceConfigurationMixin` constructs a mixin object that can be merged into the `apprunner_service`
Terraform resource block to set or update the instance_configuration field.
...
`aws.apprunner_service.withNetworkConfiguration` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withNetworkConfigurationMixin` constructs a mixin object that can be merged into the `apprunner_service`
Terraform resource block to set or update the network_configuration field.
...
`aws.apprunner_service.withObservabilityConfiguration` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withObservabilityConfigurationMixin` constructs a mixin object that can be merged into the `apprunner_service`
Terraform resource block to set or update the observability_configuration field.
...
`aws.apprunner_service.withServiceName` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withSourceConfiguration` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withSourceConfigurationMixin` constructs a mixin object that can be merged into the `apprunner_service`
Terraform resource block to set or update the source_configuration field.
...
`aws.apprunner_service.withTags` constructs a mixin object that can be merged into the `apprunner_service`
...
`aws.apprunner_service.withTagsAll` constructs a mixin object that can be merged into the `apprunner_service`
