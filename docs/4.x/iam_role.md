...
`aws.iam_role.withAssumeRolePolicy` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withDescription` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withForceDetachPolicies` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withInlinePolicy` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withInlinePolicyMixin` constructs a mixin object that can be merged into the `iam_role`
Terraform resource block to set or update the inline_policy field.
...
`aws.iam_role.withManagedPolicyArns` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withMaxSessionDuration` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withNamePrefix` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withPath` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withPermissionsBoundary` constructs a mixin object that can be merged into the `iam_role`
...
`aws.iam_role.withTagsAll` constructs a mixin object that can be merged into the `iam_role`
