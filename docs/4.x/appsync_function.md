...
`aws.appsync_function.withApiId` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withCode` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withDataSource` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withDescription` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withFunctionVersion` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withMaxBatchSize` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withName` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withRequestMappingTemplate` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withResponseMappingTemplate` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withRuntime` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withRuntimeMixin` constructs a mixin object that can be merged into the `appsync_function`
Terraform resource block to set or update the runtime field.
...
`aws.appsync_function.withSyncConfig` constructs a mixin object that can be merged into the `appsync_function`
...
`aws.appsync_function.withSyncConfigMixin` constructs a mixin object that can be merged into the `appsync_function`
Terraform resource block to set or update the sync_config field.
