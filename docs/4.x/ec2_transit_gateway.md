...
`aws.ec2_transit_gateway.withAmazonSideAsn` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withAutoAcceptSharedAttachments` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withDefaultRouteTableAssociation` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withDefaultRouteTablePropagation` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withDescription` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withDnsSupport` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withMulticastSupport` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withTags` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withTagsAll` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withTimeouts` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_transit_gateway`
Terraform resource block to set or update the timeouts field.
...
`aws.ec2_transit_gateway.withTransitGatewayCidrBlocks` constructs a mixin object that can be merged into the `ec2_transit_gateway`
...
`aws.ec2_transit_gateway.withVpnEcmpSupport` constructs a mixin object that can be merged into the `ec2_transit_gateway`
