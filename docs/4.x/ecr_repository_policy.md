...
`aws.ecr_repository_policy.withPolicy` constructs a mixin object that can be merged into the `ecr_repository_policy`
...
`aws.ecr_repository_policy.withRepository` constructs a mixin object that can be merged into the `ecr_repository_policy`
