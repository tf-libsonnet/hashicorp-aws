...
`aws.s3_bucket.withAccelerationStatus` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withAcl` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withBucket` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withBucketPrefix` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withCorsRule` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withCorsRuleMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the cors_rule field.
...
`aws.s3_bucket.withForceDestroy` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withGrant` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withGrantMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the grant field.
...
`aws.s3_bucket.withLifecycleRule` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withLifecycleRuleMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the lifecycle_rule field.
...
`aws.s3_bucket.withLogging` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withLoggingMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the logging field.
...
`aws.s3_bucket.withObjectLockConfiguration` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withObjectLockConfigurationMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the object_lock_configuration field.
...
`aws.s3_bucket.withObjectLockEnabled` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withPolicy` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withReplicationConfiguration` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withReplicationConfigurationMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the replication_configuration field.
...
`aws.s3_bucket.withRequestPayer` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withServerSideEncryptionConfiguration` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withServerSideEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the server_side_encryption_configuration field.
...
`aws.s3_bucket.withTags` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withTagsAll` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withTimeouts` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withTimeoutsMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the timeouts field.
...
`aws.s3_bucket.withVersioning` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withVersioningMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the versioning field.
...
`aws.s3_bucket.withWebsite` constructs a mixin object that can be merged into the `s3_bucket`
...
`aws.s3_bucket.withWebsiteMixin` constructs a mixin object that can be merged into the `s3_bucket`
Terraform resource block to set or update the website field.
