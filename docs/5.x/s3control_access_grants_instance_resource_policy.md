---
permalink: /s3control_access_grants_instance_resource_policy/
---

# s3control_access_grants_instance_resource_policy

`s3control_access_grants_instance_resource_policy` represents the `aws_s3control_access_grants_instance_resource_policy` Terraform resource.
