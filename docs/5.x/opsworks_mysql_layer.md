...
**Args**:
  ...
  - `root_password` (`string`): Set the `root_password` field on the resulting resource block. When `null`, the `root_password` field will be omitted from the resulting object.
  - `root_password_on_all_instances` (`bool`): Set the `root_password_on_all_instances` field on the resulting resource block. When `null`, the `root_password_on_all_instances` field will be omitted from the resulting object.
...
**Args**:
  ...
  - `root_password` (`string`): Set the `root_password` field on the resulting object. When `null`, the `root_password` field will be omitted from the resulting object.
  - `root_password_on_all_instances` (`bool`): Set the `root_password_on_all_instances` field on the resulting object. When `null`, the `root_password_on_all_instances` field will be omitted from the resulting object.
  ...
  - `ebs_volume` (`list[obj]`): Set the `ebs_volume` field on the resulting object. When `null`, the `ebs_volume` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opsworks_mysql_layer.ebs_volume.new](#fn-ebs_volumenew) constructor.
