---
permalink: /workspaces_connection_alias/
---

# workspaces_connection_alias

`workspaces_connection_alias` represents the `aws_workspaces_connection_alias` Terraform resource.
...
`aws.string.withConnectionString` constructs a mixin object that can be merged into the `string`
