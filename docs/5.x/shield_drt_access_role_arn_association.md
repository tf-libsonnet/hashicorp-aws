---
permalink: /shield_drt_access_role_arn_association/
---

# shield_drt_access_role_arn_association

`shield_drt_access_role_arn_association` represents the `aws_shield_drt_access_role_arn_association` Terraform resource.
