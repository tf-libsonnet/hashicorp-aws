---
permalink: /verifiedaccess_instance/
---

# verifiedaccess_instance

`verifiedaccess_instance` represents the `aws_verifiedaccess_instance` Terraform resource.
...
`aws.bool.withFipsEnabled` constructs a mixin object that can be merged into the `bool`
