...
**Args**:
  ...
  - `rules` (`list[obj]`): Set the `rules` field on the resulting resource block. When `null`, the `rules` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.workspaces_ip_group.rules.new](#fn-rulesnew) constructor.
...
Unlike [aws.workspaces_ip_group.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `rules` (`list[obj]`): Set the `rules` field on the resulting object. When `null`, the `rules` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.workspaces_ip_group.rules.new](#fn-rulesnew) constructor.
