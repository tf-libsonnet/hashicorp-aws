...
**Args**:
  ...
  - `registration_limit` (`number`): Set the `registration_limit` field on the resulting resource block. When `null`, the `registration_limit` field will be omitted from the resulting object.
...
**Args**:
  ...
  - `registration_limit` (`number`): Set the `registration_limit` field on the resulting object. When `null`, the `registration_limit` field will be omitted from the resulting object.
