...
**Args**:
  ...
  - `service_principal` (`string`): Set the `service_principal` field on the resulting resource block.
...
**Args**:
  ...
  - `service_principal` (`string`): Set the `service_principal` field on the resulting object.
