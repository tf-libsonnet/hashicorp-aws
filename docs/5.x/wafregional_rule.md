...
**Args**:
  ...
  - `predicate` (`list[obj]`): Set the `predicate` field on the resulting resource block. When `null`, the `predicate` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.wafregional_rule.predicate.new](#fn-predicatenew) constructor.
...
**Args**:
  ...
  - `predicate` (`list[obj]`): Set the `predicate` field on the resulting object. When `null`, the `predicate` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.wafregional_rule.predicate.new](#fn-predicatenew) constructor.
