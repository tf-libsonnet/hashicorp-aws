---
permalink: /resourceexplorer2_index/
---

# resourceexplorer2_index

`resourceexplorer2_index` represents the `aws_resourceexplorer2_index` Terraform resource.
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.resourceexplorer2_index.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [aws.resourceexplorer2_index.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.resourceexplorer2_index.timeouts.new](#fn-timeoutsnew) constructor.
