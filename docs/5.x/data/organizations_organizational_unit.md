---
permalink: /data/organizations_organizational_unit/
---

# data.organizations_organizational_unit

`organizations_organizational_unit` represents the `aws_organizations_organizational_unit` Terraform data source.
