---
permalink: /data/opensearchserverless_lifecycle_policy/
---

# data.opensearchserverless_lifecycle_policy

`opensearchserverless_lifecycle_policy` represents the `aws_opensearchserverless_lifecycle_policy` Terraform data source.
