---
permalink: /data/ssoadmin_application_assignments/
---

# data.ssoadmin_application_assignments

`ssoadmin_application_assignments` represents the `aws_ssoadmin_application_assignments` Terraform data source.
