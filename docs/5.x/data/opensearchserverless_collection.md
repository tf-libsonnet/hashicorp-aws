---
permalink: /data/opensearchserverless_collection/
---

# data.opensearchserverless_collection

`opensearchserverless_collection` represents the `aws_opensearchserverless_collection` Terraform data source.
