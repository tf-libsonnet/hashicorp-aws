---
permalink: /data/ec2_transit_gateway_route_table_routes/
---

# data.ec2_transit_gateway_route_table_routes

`ec2_transit_gateway_route_table_routes` represents the `aws_ec2_transit_gateway_route_table_routes` Terraform data source.
