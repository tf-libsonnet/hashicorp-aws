---
permalink: /data/opensearchserverless_access_policy/
---

# data.opensearchserverless_access_policy

`opensearchserverless_access_policy` represents the `aws_opensearchserverless_access_policy` Terraform data source.
