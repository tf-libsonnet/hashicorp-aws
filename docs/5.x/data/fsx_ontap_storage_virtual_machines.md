---
permalink: /data/fsx_ontap_storage_virtual_machines/
---

# data.fsx_ontap_storage_virtual_machines

`fsx_ontap_storage_virtual_machines` represents the `aws_fsx_ontap_storage_virtual_machines` Terraform data source.
