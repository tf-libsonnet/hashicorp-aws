...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  software_update_options:: {
    ...
    new(
      auto_software_update_enabled=null
    ):: std.prune(a={
  ...
  withOffPeakWindowOptions(resourceLabel, value): {
    resource+: {
      aws_opensearch_domain+: {
        [resourceLabel]+: {
  ...
  withOffPeakWindowOptionsMixin(resourceLabel, value): {
    resource+: {
      aws_opensearch_domain+: {
        [resourceLabel]+: {
  ...
  '#withSoftwareUpdateOptionsMixin':: d.fn(help='`aws.list[obj].withSoftwareUpdateOptionsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the software_update_options field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withSoftwareUpdateOptions](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `software_update_options` field.\n', args=[]),
  withSoftwareUpdateOptionsMixin(resourceLabel, value): {
    resource+: {
      aws_opensearch_domain+: {
        [resourceLabel]+: {
          software_update_options+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
