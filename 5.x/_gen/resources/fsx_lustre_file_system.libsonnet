...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    root_squash_configuration=null,
  ...
  '#withRootSquashConfigurationMixin':: d.fn(help='`aws.list[obj].withRootSquashConfigurationMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the root_squash_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withRootSquashConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `root_squash_configuration` field.\n', args=[]),
  withRootSquashConfigurationMixin(resourceLabel, value): {
    resource+: {
      aws_fsx_lustre_file_system+: {
        [resourceLabel]+: {
          root_squash_configuration+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
