...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    sagemaker_pipeline_target=null,
    sqs_target=null,
    target_id=null,
    _meta={}
  ):: tf.withResource(
  ...
  '#withSagemakerPipelineTargetMixin':: d.fn(help='`aws.list[obj].withSagemakerPipelineTargetMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the sagemaker_pipeline_target field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withSagemakerPipelineTarget](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `sagemaker_pipeline_target` field.\n', args=[]),
  withSagemakerPipelineTargetMixin(resourceLabel, value): {
    resource+: {
      aws_cloudwatch_event_target+: {
        [resourceLabel]+: {
          sagemaker_pipeline_target+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
