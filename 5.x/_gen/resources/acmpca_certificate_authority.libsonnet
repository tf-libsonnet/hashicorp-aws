...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    enabled=null,
    key_storage_security_standard=null,
  ...
  '#withKeyStorageSecurityStandard':: d.fn(help='`aws.string.withKeyStorageSecurityStandard` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the key_storage_security_standard field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `key_storage_security_standard` field.\n', args=[]),
  withKeyStorageSecurityStandard(resourceLabel, value): {
    resource+: {
      aws_acmpca_certificate_authority+: {
        [resourceLabel]+: {
