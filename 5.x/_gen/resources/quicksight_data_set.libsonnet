...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRefreshPropertiesMixin':: d.fn(help='`aws.list[obj].withRefreshPropertiesMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the refresh_properties field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withRefreshProperties](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `refresh_properties` field.\n', args=[]),
  withRefreshPropertiesMixin(resourceLabel, value): {
    resource+: {
      aws_quicksight_data_set+: {
        [resourceLabel]+: {
          refresh_properties+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
