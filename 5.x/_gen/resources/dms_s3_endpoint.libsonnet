...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGlueCatalogGeneration':: d.fn(help='`aws.bool.withGlueCatalogGeneration` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the glue_catalog_generation field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `glue_catalog_generation` field.\n', args=[]),
  withGlueCatalogGeneration(resourceLabel, value): {
    resource+: {
      aws_dms_s3_endpoint+: {
        [resourceLabel]+: {
