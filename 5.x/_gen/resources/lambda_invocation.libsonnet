...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLifecycleScope':: d.fn(help='`aws.string.withLifecycleScope` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the lifecycle_scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `lifecycle_scope` field.\n', args=[]),
  withLifecycleScope(resourceLabel, value): {
    resource+: {
      aws_lambda_invocation+: {
        [resourceLabel]+: {
  ...
  '#withTerraformKey':: d.fn(help='`aws.string.withTerraformKey` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the terraform_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `terraform_key` field.\n', args=[]),
  withTerraformKey(resourceLabel, value): {
    resource+: {
      aws_lambda_invocation+: {
        [resourceLabel]+: {
          terraform_key: value,
