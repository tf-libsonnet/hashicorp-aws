...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    scaling_group_configuration=null,
    tags=null,
    tags_all=null,
    tickerplant_log_configuration=null,
    timeouts=null,
  ...
  '#withScalingGroupConfigurationMixin':: d.fn(help='`aws.list[obj].withScalingGroupConfigurationMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the scaling_group_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withScalingGroupConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `scaling_group_configuration` field.\n', args=[]),
  withScalingGroupConfigurationMixin(resourceLabel, value): {
    resource+: {
      aws_finspace_kx_cluster+: {
        [resourceLabel]+: {
          scaling_group_configuration+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withTickerplantLogConfigurationMixin':: d.fn(help='`aws.list[obj].withTickerplantLogConfigurationMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the tickerplant_log_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withTickerplantLogConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `tickerplant_log_configuration` field.\n', args=[]),
  withTickerplantLogConfigurationMixin(resourceLabel, value): {
    resource+: {
      aws_finspace_kx_cluster+: {
        [resourceLabel]+: {
          tickerplant_log_configuration+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
