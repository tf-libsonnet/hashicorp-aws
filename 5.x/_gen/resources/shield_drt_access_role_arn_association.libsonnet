...
{
  '#':: d.pkg(name='shield_drt_access_role_arn_association', url='', help='`shield_drt_access_role_arn_association` represents the `aws_shield_drt_access_role_arn_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(role_arn=role_arn, timeouts=timeouts),
    _meta=_meta
  ),
