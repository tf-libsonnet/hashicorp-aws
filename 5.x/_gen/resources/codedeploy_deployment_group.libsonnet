...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    outdated_instances_strategy=null,
    tags=null,
    tags_all=null,
  ...
  '#withOutdatedInstancesStrategy':: d.fn(help='`aws.string.withOutdatedInstancesStrategy` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the outdated_instances_strategy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `outdated_instances_strategy` field.\n', args=[]),
  withOutdatedInstancesStrategy(resourceLabel, value): {
    resource+: {
      aws_codedeploy_deployment_group+: {
        [resourceLabel]+: {
