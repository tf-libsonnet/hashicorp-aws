...
{
  '#':: d.pkg(name='kms_key_policy', url='', help='`kms_key_policy` represents the `aws_kms_key_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(bypass_policy_lockout_safety_check=bypass_policy_lockout_safety_check, key_id=key_id, policy=policy),
    _meta=_meta
  ),
