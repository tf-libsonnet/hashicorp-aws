...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDesiredCapacityType':: d.fn(help='`aws.string.withDesiredCapacityType` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the desired_capacity_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `desired_capacity_type` field.\n', args=[]),
  withDesiredCapacityType(resourceLabel, value): {
    resource+: {
      aws_autoscaling_group+: {
        [resourceLabel]+: {
  ...
  '#withIgnoreFailedScalingActivities':: d.fn(help='`aws.bool.withIgnoreFailedScalingActivities` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the ignore_failed_scaling_activities field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `ignore_failed_scaling_activities` field.\n', args=[]),
  withIgnoreFailedScalingActivities(resourceLabel, value): {
    resource+: {
      aws_autoscaling_group+: {
        [resourceLabel]+: {
  ...
  '#withInstanceMaintenancePolicyMixin':: d.fn(help='`aws.list[obj].withInstanceMaintenancePolicyMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the instance_maintenance_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withInstanceMaintenancePolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `instance_maintenance_policy` field.\n', args=[]),
  withInstanceMaintenancePolicyMixin(resourceLabel, value): {
    resource+: {
      aws_autoscaling_group+: {
        [resourceLabel]+: {
          instance_maintenance_policy+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
