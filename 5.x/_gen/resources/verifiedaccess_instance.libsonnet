...
{
  '#':: d.pkg(name='verifiedaccess_instance', url='', help='`verifiedaccess_instance` represents the `aws_verifiedaccess_instance` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
