...
{
  '#':: d.pkg(name='cognito_managed_user_pool_client', url='', help='`cognito_managed_user_pool_client` represents the `aws_cognito_managed_user_pool_client` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withNamePattern':: d.fn(help='`aws.string.withNamePattern` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the name_pattern field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `name_pattern` field.\n', args=[]),
  withNamePattern(resourceLabel, value): {
    resource+: {
      aws_cognito_managed_user_pool_client+: {
        [resourceLabel]+: {
          name_pattern: value,
