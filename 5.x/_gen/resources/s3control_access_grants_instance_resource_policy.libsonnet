...
{
  '#':: d.pkg(name='s3control_access_grants_instance_resource_policy', url='', help='`s3control_access_grants_instance_resource_policy` represents the `aws_s3control_access_grants_instance_resource_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(account_id=account_id, policy=policy),
    _meta=_meta
  ),
