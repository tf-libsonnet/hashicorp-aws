...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  postgres_settings:: {
    ...
    new(
      ...
      fail_tasks_on_lob_truncation=null,
      heartbeat_enable=null,
      heartbeat_frequency=null,
      heartbeat_schema=null,
      map_boolean_as_boolean=null,
  ...
  '#withPauseReplicationTasks':: d.fn(help='`aws.bool.withPauseReplicationTasks` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the pause_replication_tasks field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `pause_replication_tasks` field.\n', args=[]),
  withPauseReplicationTasks(resourceLabel, value): {
    resource+: {
      aws_dms_endpoint+: {
        [resourceLabel]+: {
  ...
  '#withPostgresSettingsMixin':: d.fn(help='`aws.list[obj].withPostgresSettingsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the postgres_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withPostgresSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `postgres_settings` field.\n', args=[]),
  withPostgresSettingsMixin(resourceLabel, value): {
    resource+: {
      aws_dms_endpoint+: {
        [resourceLabel]+: {
          postgres_settings+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
