...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    replace_existing_association=null,
    _meta={}
  ):: tf.withResource(
    type='aws_ec2_transit_gateway_route_table_association',
    label=resourceLabel,
    attrs=self.newAttrs(replace_existing_association=replace_existing_association, transit_gateway_attachment_id=transit_gateway_attachment_id, transit_gateway_route_table_id=transit_gateway_route_table_id),
    _meta=_meta
  ),
  ...
  '#withReplaceExistingAssociation':: d.fn(help='`aws.bool.withReplaceExistingAssociation` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the replace_existing_association field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `replace_existing_association` field.\n', args=[]),
  withReplaceExistingAssociation(resourceLabel, value): {
    resource+: {
