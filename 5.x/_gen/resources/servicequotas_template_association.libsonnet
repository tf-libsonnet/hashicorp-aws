...
{
  '#':: d.pkg(name='servicequotas_template_association', url='', help='`servicequotas_template_association` represents the `aws_servicequotas_template_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(skip_destroy=skip_destroy),
    _meta=_meta
  ),
