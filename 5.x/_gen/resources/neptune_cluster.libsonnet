...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNeptuneInstanceParameterGroupName':: d.fn(help='`aws.string.withNeptuneInstanceParameterGroupName` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the neptune_instance_parameter_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `neptune_instance_parameter_group_name` field.\n', args=[]),
  withNeptuneInstanceParameterGroupName(resourceLabel, value): {
    resource+: {
      aws_neptune_cluster+: {
        [resourceLabel]+: {
