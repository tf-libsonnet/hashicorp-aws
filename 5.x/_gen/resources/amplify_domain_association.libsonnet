...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnableAutoSubDomain':: d.fn(help='`aws.bool.withEnableAutoSubDomain` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_auto_sub_domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_auto_sub_domain` field.\n', args=[]),
  withEnableAutoSubDomain(resourceLabel, value): {
    resource+: {
      aws_amplify_domain_association+: {
        [resourceLabel]+: {
