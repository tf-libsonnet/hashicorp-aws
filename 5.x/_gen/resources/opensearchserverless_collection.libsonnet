...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStandbyReplicas':: d.fn(help='`aws.string.withStandbyReplicas` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the standby_replicas field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `standby_replicas` field.\n', args=[]),
  withStandbyReplicas(resourceLabel, value): {
    resource+: {
      aws_opensearchserverless_collection+: {
        [resourceLabel]+: {
