...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  protocol_details:: {
    ...
    new(
      as2_transports=null,
      passive_ip=null,
      set_stat_option=null,
      tls_session_resumption_mode=null
    ):: std.prune(a={
  ...
  '#withProtocolDetailsMixin':: d.fn(help='`aws.list[obj].withProtocolDetailsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the protocol_details field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withProtocolDetails](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `protocol_details` field.\n', args=[]),
  withProtocolDetailsMixin(resourceLabel, value): {
    resource+: {
      aws_transfer_server+: {
        [resourceLabel]+: {
          protocol_details+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withStructuredLogDestinations':: d.fn(help='`aws.list.withStructuredLogDestinations` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the structured_log_destinations field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `structured_log_destinations` field.\n', args=[]),
  withStructuredLogDestinations(resourceLabel, value): {
    resource+: {
      aws_transfer_server+: {
        [resourceLabel]+: {
          structured_log_destinations: value,
        },
      },
    },
  },
