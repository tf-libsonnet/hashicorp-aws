...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStartupScriptS3ObjectVersion':: d.fn(help='`aws.string.withStartupScriptS3ObjectVersion` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the startup_script_s3_object_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `startup_script_s3_object_version` field.\n', args=[]),
  withStartupScriptS3ObjectVersion(resourceLabel, value): {
    resource+: {
      aws_mwaa_environment+: {
        [resourceLabel]+: {
  ...
  '#withStartupScriptS3Path':: d.fn(help='`aws.string.withStartupScriptS3Path` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the startup_script_s3_path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `startup_script_s3_path` field.\n', args=[]),
  withStartupScriptS3Path(resourceLabel, value): {
    resource+: {
      aws_mwaa_environment+: {
        [resourceLabel]+: {
