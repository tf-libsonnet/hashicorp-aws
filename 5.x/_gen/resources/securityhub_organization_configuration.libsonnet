...
{
  '#':: d.pkg(name='securityhub_organization_configuration', url='', help='`securityhub_organization_configuration` represents the `aws_securityhub_organization_configuration` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    resourceLabel,
    auto_enable,
    auto_enable_standards=null,
    _meta={}
  ):: tf.withResource(
    type='aws_securityhub_organization_configuration',
    label=resourceLabel,
    attrs=self.newAttrs(auto_enable=auto_enable, auto_enable_standards=auto_enable_standards),
    _meta=_meta
  ),
  ...
  '#withAutoEnableStandards':: d.fn(help='`aws.string.withAutoEnableStandards` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the auto_enable_standards field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `auto_enable_standards` field.\n', args=[]),
  withAutoEnableStandards(resourceLabel, value): {
    resource+: {
      aws_securityhub_organization_configuration+: {
        [resourceLabel]+: {
