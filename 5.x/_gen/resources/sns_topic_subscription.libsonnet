...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withReplayPolicy':: d.fn(help='`aws.string.withReplayPolicy` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the replay_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `replay_policy` field.\n', args=[]),
  withReplayPolicy(resourceLabel, value): {
    resource+: {
      aws_sns_topic_subscription+: {
        [resourceLabel]+: {
          replay_policy: value,
