...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuthTokenUpdateStrategy':: d.fn(help='`aws.string.withAuthTokenUpdateStrategy` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the auth_token_update_strategy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `auth_token_update_strategy` field.\n', args=[]),
  withAuthTokenUpdateStrategy(resourceLabel, value): {
    resource+: {
      aws_elasticache_replication_group+: {
        [resourceLabel]+: {
