...
{
  '#':: d.pkg(name='licensemanager_grant_accepter', url='', help='`licensemanager_grant_accepter` represents the `aws_licensemanager_grant_accepter` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(grant_arn=grant_arn),
    _meta=_meta
  ),
  ...
  '#withGrantArn':: d.fn(help='`aws.string.withGrantArn` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the grant_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `grant_arn` field.\n', args=[]),
  withGrantArn(resourceLabel, value): {
    resource+: {
