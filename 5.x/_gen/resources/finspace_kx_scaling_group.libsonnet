...
{
  '#':: d.pkg(name='finspace_kx_scaling_group', url='', help='`finspace_kx_scaling_group` represents the `aws_finspace_kx_scaling_group` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
