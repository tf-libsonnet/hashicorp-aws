...
{
  '#':: d.pkg(name='ssoadmin_application_assignment_configuration', url='', help='`ssoadmin_application_assignment_configuration` represents the `aws_ssoadmin_application_assignment_configuration` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(application_arn=application_arn, assignment_required=assignment_required),
    _meta=_meta
  ),
  ...
  '#withAssignmentRequired':: d.fn(help='`aws.bool.withAssignmentRequired` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the assignment_required field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `assignment_required` field.\n', args=[]),
  withAssignmentRequired(resourceLabel, value): {
    resource+: {
      aws_ssoadmin_application_assignment_configuration+: {
        [resourceLabel]+: {
