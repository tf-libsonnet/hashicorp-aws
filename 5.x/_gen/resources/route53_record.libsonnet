...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCidrRoutingPolicyMixin':: d.fn(help='`aws.list[obj].withCidrRoutingPolicyMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the cidr_routing_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withCidrRoutingPolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `cidr_routing_policy` field.\n', args=[]),
  withCidrRoutingPolicyMixin(resourceLabel, value): {
    resource+: {
      aws_route53_record+: {
        [resourceLabel]+: {
          cidr_routing_policy+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
