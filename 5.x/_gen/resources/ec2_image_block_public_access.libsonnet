...
{
  '#':: d.pkg(name='ec2_image_block_public_access', url='', help='`ec2_image_block_public_access` represents the `aws_ec2_image_block_public_access` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(state=state, timeouts=timeouts),
    _meta=_meta
  ),
