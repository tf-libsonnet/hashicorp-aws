...
{
  '#':: d.pkg(name='detective_organization_configuration', url='', help='`detective_organization_configuration` represents the `aws_detective_organization_configuration` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(auto_enable=auto_enable, graph_arn=graph_arn),
    _meta=_meta
  ),
