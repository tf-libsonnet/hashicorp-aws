...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConnectionLogsMixin':: d.fn(help='`aws.list[obj].withConnectionLogsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the connection_logs field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withConnectionLogs](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `connection_logs` field.\n', args=[]),
  withConnectionLogsMixin(resourceLabel, value): {
    resource+: {
      aws_lb+: {
        [resourceLabel]+: {
          connection_logs+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withDnsRecordClientRoutingPolicy':: d.fn(help='`aws.string.withDnsRecordClientRoutingPolicy` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the dns_record_client_routing_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `dns_record_client_routing_policy` field.\n', args=[]),
  withDnsRecordClientRoutingPolicy(resourceLabel, value): {
    resource+: {
      aws_lb+: {
        [resourceLabel]+: {
  ...
  '#withEnforceSecurityGroupInboundRulesOnPrivateLinkTraffic':: d.fn(help='`aws.string.withEnforceSecurityGroupInboundRulesOnPrivateLinkTraffic` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the enforce_security_group_inbound_rules_on_private_link_traffic field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `enforce_security_group_inbound_rules_on_private_link_traffic` field.\n', args=[]),
  withEnforceSecurityGroupInboundRulesOnPrivateLinkTraffic(resourceLabel, value): {
    resource+: {
      aws_lb+: {
        [resourceLabel]+: {
