...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClientSideTimestampsMixin':: d.fn(help='`aws.list[obj].withClientSideTimestampsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the client_side_timestamps field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withClientSideTimestamps](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `client_side_timestamps` field.\n', args=[]),
  withClientSideTimestampsMixin(resourceLabel, value): {
    resource+: {
      aws_keyspaces_table+: {
        [resourceLabel]+: {
          client_side_timestamps+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
