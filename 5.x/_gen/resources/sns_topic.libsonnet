...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withArchivePolicy':: d.fn(help='`aws.string.withArchivePolicy` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the archive_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `archive_policy` field.\n', args=[]),
  withArchivePolicy(resourceLabel, value): {
    resource+: {
      aws_sns_topic+: {
        [resourceLabel]+: {
  ...
  '#withSignatureVersion':: d.fn(help='`aws.number.withSignatureVersion` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the signature_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `signature_version` field.\n', args=[]),
  withSignatureVersion(resourceLabel, value): {
    resource+: {
      aws_sns_topic+: {
        [resourceLabel]+: {
