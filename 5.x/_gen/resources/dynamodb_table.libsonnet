...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  import_table:: {
    ...
    new(
      input_format,
      input_compression_type=null,
      input_format_options=null,
      s3_bucket_source=null
    ):: std.prune(a={
  ...
  '#withDeletionProtectionEnabled':: d.fn(help='`aws.bool.withDeletionProtectionEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the deletion_protection_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `deletion_protection_enabled` field.\n', args=[]),
  withDeletionProtectionEnabled(resourceLabel, value): {
    resource+: {
      aws_dynamodb_table+: {
        [resourceLabel]+: {
  ...
  '#withImportTableMixin':: d.fn(help='`aws.list[obj].withImportTableMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the import_table field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withImportTable](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `import_table` field.\n', args=[]),
  withImportTableMixin(resourceLabel, value): {
    resource+: {
      aws_dynamodb_table+: {
        [resourceLabel]+: {
          import_table+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
