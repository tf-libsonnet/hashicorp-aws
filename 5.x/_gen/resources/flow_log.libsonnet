...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeliverCrossAccountRole':: d.fn(help='`aws.string.withDeliverCrossAccountRole` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the deliver_cross_account_role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `deliver_cross_account_role` field.\n', args=[]),
  withDeliverCrossAccountRole(resourceLabel, value): {
    resource+: {
      aws_flow_log+: {
        [resourceLabel]+: {
