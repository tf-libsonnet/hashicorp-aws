...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withContinuousDeploymentPolicyId':: d.fn(help='`aws.string.withContinuousDeploymentPolicyId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the continuous_deployment_policy_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `continuous_deployment_policy_id` field.\n', args=[]),
  withContinuousDeploymentPolicyId(resourceLabel, value): {
    resource+: {
      aws_cloudfront_distribution+: {
        [resourceLabel]+: {
  ...
  '#withStaging':: d.fn(help='`aws.bool.withStaging` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the staging field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `staging` field.\n', args=[]),
  withStaging(resourceLabel, value): {
    resource+: {
      aws_cloudfront_distribution+: {
        [resourceLabel]+: {
          staging: value,
