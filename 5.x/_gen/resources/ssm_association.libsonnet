...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSyncCompliance':: d.fn(help='`aws.string.withSyncCompliance` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the sync_compliance field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `sync_compliance` field.\n', args=[]),
  withSyncCompliance(resourceLabel, value): {
    resource+: {
      aws_ssm_association+: {
        [resourceLabel]+: {
