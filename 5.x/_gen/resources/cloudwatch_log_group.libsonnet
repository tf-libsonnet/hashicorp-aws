...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLogGroupClass':: d.fn(help='`aws.string.withLogGroupClass` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the log_group_class field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `log_group_class` field.\n', args=[]),
  withLogGroupClass(resourceLabel, value): {
    resource+: {
      aws_cloudwatch_log_group+: {
        [resourceLabel]+: {
