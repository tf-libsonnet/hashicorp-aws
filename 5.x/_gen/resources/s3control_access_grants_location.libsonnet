...
{
  '#':: d.pkg(name='s3control_access_grants_location', url='', help='`s3control_access_grants_location` represents the `aws_s3control_access_grants_location` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withLocationScope':: d.fn(help='`aws.string.withLocationScope` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the location_scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `location_scope` field.\n', args=[]),
  withLocationScope(resourceLabel, value): {
    resource+: {
      aws_s3control_access_grants_location+: {
        [resourceLabel]+: {
