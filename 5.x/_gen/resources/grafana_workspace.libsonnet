...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGrafanaVersion':: d.fn(help='`aws.string.withGrafanaVersion` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the grafana_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `grafana_version` field.\n', args=[]),
  withGrafanaVersion(resourceLabel, value): {
    resource+: {
      aws_grafana_workspace+: {
        [resourceLabel]+: {
