...
{
  '#':: d.pkg(name='globalaccelerator_custom_routing_accelerator', url='', help='`globalaccelerator_custom_routing_accelerator` represents the `aws_globalaccelerator_custom_routing_accelerator` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  attributes:: {
