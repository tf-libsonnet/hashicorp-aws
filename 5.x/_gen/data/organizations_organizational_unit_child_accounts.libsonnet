...
{
  '#':: d.pkg(name='organizations_organizational_unit_child_accounts', url='', help='`organizations_organizational_unit_child_accounts` represents the `aws_organizations_organizational_unit_child_accounts` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
