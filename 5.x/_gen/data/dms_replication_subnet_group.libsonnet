...
{
  '#':: d.pkg(name='dms_replication_subnet_group', url='', help='`dms_replication_subnet_group` represents the `aws_dms_replication_subnet_group` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(replication_subnet_group_id=replication_subnet_group_id, tags=tags),
    _meta=_meta
  ),
  ...
  withReplicationSubnetGroupId(dataSrcLabel, value): {
    data+: {
