...
{
  '#':: d.pkg(name='licensemanager_received_license', url='', help='`licensemanager_received_license` represents the `aws_licensemanager_received_license` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(license_arn=license_arn),
    _meta=_meta
  ),
  ...
  withLicenseArn(dataSrcLabel, value): {
    data+: {
