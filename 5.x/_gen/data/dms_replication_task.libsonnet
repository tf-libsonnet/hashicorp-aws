...
{
  '#':: d.pkg(name='dms_replication_task', url='', help='`dms_replication_task` represents the `aws_dms_replication_task` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(replication_task_id=replication_task_id, tags=tags),
    _meta=_meta
  ),
  ...
  withReplicationTaskId(dataSrcLabel, value): {
    data+: {
