...
{
  '#':: d.pkg(name='ssoadmin_principal_application_assignments', url='', help='`ssoadmin_principal_application_assignments` represents the `aws_ssoadmin_principal_application_assignments` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  withPrincipalId(dataSrcLabel, value): {
    data+: {
      aws_ssoadmin_principal_application_assignments+: {
        [dataSrcLabel]+: {
          principal_id: value,
  ...
  withPrincipalType(dataSrcLabel, value): {
    data+: {
      aws_ssoadmin_principal_application_assignments+: {
        [dataSrcLabel]+: {
