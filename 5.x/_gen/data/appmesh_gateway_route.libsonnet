...
{
  '#':: d.pkg(name='appmesh_gateway_route', url='', help='`appmesh_gateway_route` represents the `aws_appmesh_gateway_route` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  withVirtualGatewayName(dataSrcLabel, value): {
    data+: {
      aws_appmesh_gateway_route+: {
        [dataSrcLabel]+: {
