...
{
  '#':: d.pkg(name='redshiftserverless_namespace', url='', help='`redshiftserverless_namespace` represents the `aws_redshiftserverless_namespace` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(namespace_name=namespace_name),
    _meta=_meta
  ),
