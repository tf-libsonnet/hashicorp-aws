...
{
  '#':: d.pkg(name='networkfirewall_resource_policy', url='', help='`networkfirewall_resource_policy` represents the `aws_networkfirewall_resource_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(resource_arn=resource_arn),
    _meta=_meta
  ),
  ...
  withResourceArn(dataSrcLabel, value): {
    data+: {
