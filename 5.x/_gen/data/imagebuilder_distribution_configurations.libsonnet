...
{
  '#':: d.pkg(name='imagebuilder_distribution_configurations', url='', help='`imagebuilder_distribution_configurations` represents the `aws_imagebuilder_distribution_configurations` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filter:: {
