...
{
  '#':: d.pkg(name='verifiedpermissions_policy_store', url='', help='`verifiedpermissions_policy_store` represents the `aws_verifiedpermissions_policy_store` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
