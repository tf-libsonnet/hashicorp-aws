...
{
  '#':: d.pkg(name='ec2_network_insights_path', url='', help='`ec2_network_insights_path` represents the `aws_ec2_network_insights_path` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filter:: {
  ...
  '#newAttrs':: d.fn(help='\n`aws.data.ec2_network_insights_path.newAttrs` constructs a new object with attributes and blocks configured for the `ec2_network_insights_path`\nTerraform data source.\n\nUnlike [aws.data.ec2_network_insights_path.new](#fn-new), this function will not inject the `data source`\nblock into the root Terraform document. Instead, this must be passed in as the `attrs` argument for the\n[tf.withData](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withdata) function to build a complete block.\n\nThis is most useful when you need to preprocess the attributes with functions, conditional, or looping logic prior to\ninjecting into a complete block.\n\n**Args**:\n  - `network_insights_path_id` (`string`): Set the `network_insights_path_id` field on the resulting object. When `null`, the `network_insights_path_id` field will be omitted from the resulting object.\n  - `tags` (`obj`): Set the `tags` field on the resulting object. When `null`, the `tags` field will be omitted from the resulting object.\n  - `filter` (`list[obj]`): Set the `filter` field on the resulting object. When `null`, the `filter` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.ec2_network_insights_path.filter.new](#fn-filternew) constructor.\n\n**Returns**:\n  - An attribute object that can be used with [tf.withData](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withdata) to construct a new `ec2_network_insights_path` data source into the root Terraform configuration.\n', args=[]),
  newAttrs(
    filter=null,
    network_insights_path_id=null,
    tags=null
