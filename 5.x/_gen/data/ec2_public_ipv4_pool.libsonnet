...
{
  '#':: d.pkg(name='ec2_public_ipv4_pool', url='', help='`ec2_public_ipv4_pool` represents the `aws_ec2_public_ipv4_pool` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(pool_id=pool_id, tags=tags),
    _meta=_meta
  ),
