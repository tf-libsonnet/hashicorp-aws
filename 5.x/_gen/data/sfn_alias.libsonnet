...
{
  '#':: d.pkg(name='sfn_alias', url='', help='`sfn_alias` represents the `aws_sfn_alias` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    type='aws_sfn_alias',
    label=dataSrcLabel,
    attrs=self.newAttrs(description=description, name=name, statemachine_arn=statemachine_arn),
    _meta=_meta
  ),
