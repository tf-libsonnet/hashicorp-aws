...
{
  '#':: d.pkg(name='quicksight_group', url='', help='`quicksight_group` represents the `aws_quicksight_group` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(aws_account_id=aws_account_id, group_name=group_name, namespace=namespace),
    _meta=_meta
  ),
