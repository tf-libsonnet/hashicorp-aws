...
{
  '#':: d.pkg(name='opensearchserverless_lifecycle_policy', url='', help='`opensearchserverless_lifecycle_policy` represents the `aws_opensearchserverless_lifecycle_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
