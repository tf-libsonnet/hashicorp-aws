...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.data.route53_traffic_policy_document.new` injects a new `data_aws_route53_traffic_policy_document` Terraform `data source`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.data.route53_traffic_policy_document.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.data.route53_traffic_policy_document` using the reference:\n\n    $._ref.data_aws_route53_traffic_policy_document.some_id.get('id')\n\nThis is the same as directly entering `\"${ data_aws_route53_traffic_policy_document.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block.\n  - `record_type` (`string`): Set the `record_type` field on the resulting data source block. When `null`, the `record_type` field will be omitted from the resulting object.\n  - `start_endpoint` (`string`): Set the `start_endpoint` field on the resulting data source block. When `null`, the `start_endpoint` field will be omitted from the resulting object.\n  - `start_rule` (`string`): Set the `start_rule` field on the resulting data source block. When `null`, the `start_rule` field will be omitted from the resulting object.\n  - `version` (`string`): Set the `version` field on the resulting data source block. When `null`, the `version` field will be omitted from the resulting object.\n  - `endpoint` (`list[obj]`): Set the `endpoint` field on the resulting data source block. When `null`, the `endpoint` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.route53_traffic_policy_document.endpoint.new](#fn-endpointnew) constructor.\n  - `rule` (`list[obj]`): Set the `rule` field on the resulting data source block. When `null`, the `rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.route53_traffic_policy_document.rule.new](#fn-rulenew) constructor.\n\n**Returns**:\n- A mixin object that injects the new data source into the root Terraform configuration.\n", args=[]),
  new(
    dataSrcLabel,
    endpoint=null,
    record_type=null,
  ...
  '#newAttrs':: d.fn(help='\n`aws.data.route53_traffic_policy_document.newAttrs` constructs a new object with attributes and blocks configured for the `route53_traffic_policy_document`\nTerraform data source.\n\nUnlike [aws.data.route53_traffic_policy_document.new](#fn-new), this function will not inject the `data source`\nblock into the root Terraform document. Instead, this must be passed in as the `attrs` argument for the\n[tf.withData](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withdata) function to build a complete block.\n\nThis is most useful when you need to preprocess the attributes with functions, conditional, or looping logic prior to\ninjecting into a complete block.\n\n**Args**:\n  - `record_type` (`string`): Set the `record_type` field on the resulting object. When `null`, the `record_type` field will be omitted from the resulting object.\n  - `start_endpoint` (`string`): Set the `start_endpoint` field on the resulting object. When `null`, the `start_endpoint` field will be omitted from the resulting object.\n  - `start_rule` (`string`): Set the `start_rule` field on the resulting object. When `null`, the `start_rule` field will be omitted from the resulting object.\n  - `version` (`string`): Set the `version` field on the resulting object. When `null`, the `version` field will be omitted from the resulting object.\n  - `endpoint` (`list[obj]`): Set the `endpoint` field on the resulting object. When `null`, the `endpoint` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.route53_traffic_policy_document.endpoint.new](#fn-endpointnew) constructor.\n  - `rule` (`list[obj]`): Set the `rule` field on the resulting object. When `null`, the `rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.data.route53_traffic_policy_document.rule.new](#fn-rulenew) constructor.\n\n**Returns**:\n  - An attribute object that can be used with [tf.withData](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withdata) to construct a new `route53_traffic_policy_document` data source into the root Terraform configuration.\n', args=[]),
  newAttrs(
    endpoint=null,
    record_type=null,
    rule=null,
  ...
  rule:: {
    ...
    '#new':: d.fn(help='\n`aws.route53_traffic_policy_document.rule.new` constructs a new object with attributes and blocks configured for the `rule`\nTerraform sub block.\n\n\n\n**Args**:\n  - `type` (`string`): Set the `type` field on the resulting object. When `null`, the `type` field will be omitted from the resulting object.\n  - `geo_proximity_location` (`list[obj]`): Set the `geo_proximity_location` field on the resulting object. When `null`, the `geo_proximity_location` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.geo_proximity_location.new](#fn-rulegeo_proximity_locationnew) constructor.\n  - `items` (`list[obj]`): Set the `items` field on the resulting object. When `null`, the `items` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.items.new](#fn-ruleitemsnew) constructor.\n  - `location` (`list[obj]`): Set the `location` field on the resulting object. When `null`, the `location` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.location.new](#fn-rulelocationnew) constructor.\n  - `primary` (`list[obj]`): Set the `primary` field on the resulting object. When `null`, the `primary` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.primary.new](#fn-ruleprimarynew) constructor.\n  - `region` (`list[obj]`): Set the `region` field on the resulting object. When `null`, the `region` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.region.new](#fn-ruleregionnew) constructor.\n  - `secondary` (`list[obj]`): Set the `secondary` field on the resulting object. When `null`, the `secondary` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.secondary.new](#fn-rulesecondarynew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `rule` sub block.\n', args=[]),
    new(
