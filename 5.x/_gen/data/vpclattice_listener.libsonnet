...
{
  '#':: d.pkg(name='vpclattice_listener', url='', help='`vpclattice_listener` represents the `aws_vpclattice_listener` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(listener_identifier=listener_identifier, service_identifier=service_identifier, tags=tags),
    _meta=_meta
  ),
  ...
  withListenerIdentifier(dataSrcLabel, value): {
    data+: {
  ...
  withServiceIdentifier(dataSrcLabel, value): {
    data+: {
      aws_vpclattice_listener+: {
        [dataSrcLabel]+: {
