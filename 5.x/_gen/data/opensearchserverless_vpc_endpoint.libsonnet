...
{
  '#':: d.pkg(name='opensearchserverless_vpc_endpoint', url='', help='`opensearchserverless_vpc_endpoint` represents the `aws_opensearchserverless_vpc_endpoint` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(vpc_endpoint_id=vpc_endpoint_id),
    _meta=_meta
  ),
  ...
  withVpcEndpointId(dataSrcLabel, value): {
    data+: {
