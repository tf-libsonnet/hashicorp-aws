...
{
  '#':: d.pkg(name='imagebuilder_image_recipes', url='', help='`imagebuilder_image_recipes` represents the `aws_imagebuilder_image_recipes` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filter:: {
