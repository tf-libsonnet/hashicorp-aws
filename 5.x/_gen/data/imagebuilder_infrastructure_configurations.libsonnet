...
{
  '#':: d.pkg(name='imagebuilder_infrastructure_configurations', url='', help='`imagebuilder_infrastructure_configurations` represents the `aws_imagebuilder_infrastructure_configurations` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filter:: {
