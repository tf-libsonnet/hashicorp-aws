...
{
  '#':: d.pkg(name='vpclattice_service', url='', help='`vpclattice_service` represents the `aws_vpclattice_service` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(name=name, service_identifier=service_identifier, tags=tags),
    _meta=_meta
  ),
