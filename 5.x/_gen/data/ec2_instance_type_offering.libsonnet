...
{
  '#':: d.pkg(name='ec2_instance_type_offering', url='', help='`ec2_instance_type_offering` represents the `aws_ec2_instance_type_offering` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filter:: {
