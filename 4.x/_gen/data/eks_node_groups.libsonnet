...
{
  '#':: d.pkg(name='eks_node_groups', url='', help='`eks_node_groups` represents the `aws_eks_node_groups` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
