...
{
  '#':: d.pkg(name='kinesis_stream', url='', help='`kinesis_stream` represents the `aws_kinesis_stream` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
