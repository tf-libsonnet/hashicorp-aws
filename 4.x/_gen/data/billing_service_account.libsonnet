...
{
  '#':: d.pkg(name='billing_service_account', url='', help='`billing_service_account` represents the `aws_billing_service_account` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
