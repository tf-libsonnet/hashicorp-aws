...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withParameters':: d.fn(help='`aws.api_gateway_sdk.withParameters` constructs a mixin object that can be merged into the `api_gateway_sdk`\nTerraform data source block to set or update the parameters field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters` field.\n', args=[]),
  ...
  '#withRestApiId':: d.fn(help='`aws.api_gateway_sdk.withRestApiId` constructs a mixin object that can be merged into the `api_gateway_sdk`\nTerraform data source block to set or update the rest_api_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rest_api_id` field.\n', args=[]),
  ...
  '#withSdkType':: d.fn(help='`aws.api_gateway_sdk.withSdkType` constructs a mixin object that can be merged into the `api_gateway_sdk`\nTerraform data source block to set or update the sdk_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sdk_type` field.\n', args=[]),
  ...
  '#withStageName':: d.fn(help='`aws.api_gateway_sdk.withStageName` constructs a mixin object that can be merged into the `api_gateway_sdk`\nTerraform data source block to set or update the stage_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage_name` field.\n', args=[]),
