...
{
  '#':: d.pkg(name='eks_addon_version', url='', help='`eks_addon_version` represents the `aws_eks_addon_version` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withAddonName':: d.fn(help='`aws.eks_addon_version.withAddonName` constructs a mixin object that can be merged into the `eks_addon_version`\nTerraform data source block to set or update the addon_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `addon_name` field.\n', args=[]),
  ...
  '#withKubernetesVersion':: d.fn(help='`aws.eks_addon_version.withKubernetesVersion` constructs a mixin object that can be merged into the `eks_addon_version`\nTerraform data source block to set or update the kubernetes_version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kubernetes_version` field.\n', args=[]),
  ...
  '#withMostRecent':: d.fn(help='`aws.eks_addon_version.withMostRecent` constructs a mixin object that can be merged into the `eks_addon_version`\nTerraform data source block to set or update the most_recent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `most_recent` field.\n', args=[]),
