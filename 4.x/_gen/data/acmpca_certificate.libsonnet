...
{
  '#':: d.pkg(name='acmpca_certificate', url='', help='`acmpca_certificate` represents the `aws_acmpca_certificate` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.acmpca_certificate.withArn` constructs a mixin object that can be merged into the `acmpca_certificate`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
