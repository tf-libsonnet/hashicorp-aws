...
{
  '#':: d.pkg(name='docdb_engine_version', url='', help='`docdb_engine_version` represents the `aws_docdb_engine_version` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withEngine':: d.fn(help='`aws.docdb_engine_version.withEngine` constructs a mixin object that can be merged into the `docdb_engine_version`\nTerraform data source block to set or update the engine field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `engine` field.\n', args=[]),
  ...
  '#withParameterGroupFamily':: d.fn(help='`aws.docdb_engine_version.withParameterGroupFamily` constructs a mixin object that can be merged into the `docdb_engine_version`\nTerraform data source block to set or update the parameter_group_family field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameter_group_family` field.\n', args=[]),
  ...
  '#withPreferredVersions':: d.fn(help='`aws.docdb_engine_version.withPreferredVersions` constructs a mixin object that can be merged into the `docdb_engine_version`\nTerraform data source block to set or update the preferred_versions field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `preferred_versions` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`aws.docdb_engine_version.withVersion` constructs a mixin object that can be merged into the `docdb_engine_version`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
