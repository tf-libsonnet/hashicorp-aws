...
{
  '#':: d.pkg(name='imagebuilder_image_recipe', url='', help='`imagebuilder_image_recipe` represents the `aws_imagebuilder_image_recipe` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.imagebuilder_image_recipe.withArn` constructs a mixin object that can be merged into the `imagebuilder_image_recipe`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
