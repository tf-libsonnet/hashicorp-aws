...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterId':: d.fn(help='`aws.cloudhsm_v2_cluster.withClusterId` constructs a mixin object that can be merged into the `cloudhsm_v2_cluster`\nTerraform data source block to set or update the cluster_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_id` field.\n', args=[]),
  ...
  '#withClusterState':: d.fn(help='`aws.cloudhsm_v2_cluster.withClusterState` constructs a mixin object that can be merged into the `cloudhsm_v2_cluster`\nTerraform data source block to set or update the cluster_state field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_state` field.\n', args=[]),
