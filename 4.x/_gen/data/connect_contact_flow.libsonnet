...
{
  '#':: d.pkg(name='connect_contact_flow', url='', help='`connect_contact_flow` represents the `aws_connect_contact_flow` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withContactFlowId':: d.fn(help='`aws.connect_contact_flow.withContactFlowId` constructs a mixin object that can be merged into the `connect_contact_flow`\nTerraform data source block to set or update the contact_flow_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `contact_flow_id` field.\n', args=[]),
