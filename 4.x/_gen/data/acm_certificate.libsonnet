...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomain':: d.fn(help='`aws.acm_certificate.withDomain` constructs a mixin object that can be merged into the `acm_certificate`\nTerraform data source block to set or update the domain field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain` field.\n', args=[]),
  ...
  '#withKeyTypes':: d.fn(help='`aws.acm_certificate.withKeyTypes` constructs a mixin object that can be merged into the `acm_certificate`\nTerraform data source block to set or update the key_types field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_types` field.\n', args=[]),
  ...
  '#withMostRecent':: d.fn(help='`aws.acm_certificate.withMostRecent` constructs a mixin object that can be merged into the `acm_certificate`\nTerraform data source block to set or update the most_recent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `most_recent` field.\n', args=[]),
  ...
  '#withStatuses':: d.fn(help='`aws.acm_certificate.withStatuses` constructs a mixin object that can be merged into the `acm_certificate`\nTerraform data source block to set or update the statuses field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `statuses` field.\n', args=[]),
  ...
  '#withTypes':: d.fn(help='`aws.acm_certificate.withTypes` constructs a mixin object that can be merged into the `acm_certificate`\nTerraform data source block to set or update the types field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `types` field.\n', args=[]),
