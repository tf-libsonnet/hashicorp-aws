...
{
  '#':: d.pkg(name='route53_resolver_endpoint', url='', help='`route53_resolver_endpoint` represents the `aws_route53_resolver_endpoint` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filter:: {
  ...
  '#withFilter':: d.fn(help='`aws.route53_resolver_endpoint.withFilter` constructs a mixin object that can be merged into the `route53_resolver_endpoint`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.route53_resolver_endpoint.withFilterMixin` constructs a mixin object that can be merged into the `route53_resolver_endpoint`\nTerraform data source block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.route53_resolver_endpoint.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withResolverEndpointId':: d.fn(help='`aws.route53_resolver_endpoint.withResolverEndpointId` constructs a mixin object that can be merged into the `route53_resolver_endpoint`\nTerraform data source block to set or update the resolver_endpoint_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resolver_endpoint_id` field.\n', args=[]),
