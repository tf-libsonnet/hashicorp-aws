...
{
  '#':: d.pkg(name='iam_user', url='', help='`iam_user` represents the `aws_iam_user` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
