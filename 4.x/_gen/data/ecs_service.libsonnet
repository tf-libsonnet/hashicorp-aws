...
{
  '#':: d.pkg(name='ecs_service', url='', help='`ecs_service` represents the `aws_ecs_service` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withServiceName':: d.fn(help='`aws.ecs_service.withServiceName` constructs a mixin object that can be merged into the `ecs_service`\nTerraform data source block to set or update the service_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_name` field.\n', args=[]),
