...
{
  '#':: d.pkg(name='connect_instance', url='', help='`connect_instance` represents the `aws_connect_instance` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withInstanceId':: d.fn(help='`aws.connect_instance.withInstanceId` constructs a mixin object that can be merged into the `connect_instance`\nTerraform data source block to set or update the instance_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_id` field.\n', args=[]),
