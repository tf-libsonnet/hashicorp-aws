...
{
  '#':: d.pkg(name='lex_intent', url='', help='`lex_intent` represents the `aws_lex_intent` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withVersion':: d.fn(help='`aws.lex_intent.withVersion` constructs a mixin object that can be merged into the `lex_intent`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
