...
{
  '#':: d.pkg(name='eks_cluster_auth', url='', help='`eks_cluster_auth` represents the `aws_eks_cluster_auth` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.eks_cluster_auth.withName` constructs a mixin object that can be merged into the `eks_cluster_auth`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
