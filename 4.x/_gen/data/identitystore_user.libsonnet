...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  alternate_identifier:: {
    ...
    '#new':: d.fn(help='\n`aws.identitystore_user.alternate_identifier.new` constructs a new object with attributes and blocks configured for the `alternate_identifier`\nTerraform sub block.\n\n\n\n**Args**:\n  - `external_id` (`list[obj]`):  When `null`, the `external_id` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.identitystore_user.alternate_identifier.external_id.new](#fn-alternateidentifierexternalidnew) constructor.\n  - `unique_attribute` (`list[obj]`):  When `null`, the `unique_attribute` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.identitystore_user.alternate_identifier.unique_attribute.new](#fn-alternateidentifieruniqueattributenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `alternate_identifier` sub block.\n', args=[]),
    new(
      external_id=null,
  ...
  '#withAlternateIdentifier':: d.fn(help='`aws.identitystore_user.withAlternateIdentifier` constructs a mixin object that can be merged into the `identitystore_user`\nTerraform data source block to set or update the alternate_identifier field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `alternate_identifier` field.\n', args=[]),
  ...
  '#withAlternateIdentifierMixin':: d.fn(help='`aws.identitystore_user.withAlternateIdentifierMixin` constructs a mixin object that can be merged into the `identitystore_user`\nTerraform data source block to set or update the alternate_identifier field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.identitystore_user.withAlternateIdentifier](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `alternate_identifier` field.\n', args=[]),
  ...
  '#withFilter':: d.fn(help='`aws.identitystore_user.withFilter` constructs a mixin object that can be merged into the `identitystore_user`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.identitystore_user.withFilterMixin` constructs a mixin object that can be merged into the `identitystore_user`\nTerraform data source block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.identitystore_user.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withUserId':: d.fn(help='`aws.identitystore_user.withUserId` constructs a mixin object that can be merged into the `identitystore_user`\nTerraform data source block to set or update the user_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_id` field.\n', args=[]),
