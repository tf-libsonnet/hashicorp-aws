...
{
  '#':: d.pkg(name='organizations_resource_tags', url='', help='`organizations_resource_tags` represents the `aws_organizations_resource_tags` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withResourceId':: d.fn(help='`aws.organizations_resource_tags.withResourceId` constructs a mixin object that can be merged into the `organizations_resource_tags`\nTerraform data source block to set or update the resource_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.organizations_resource_tags.withTags` constructs a mixin object that can be merged into the `organizations_resource_tags`\nTerraform data source block to set or update the tags field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
