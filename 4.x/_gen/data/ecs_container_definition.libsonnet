...
{
  '#':: d.pkg(name='ecs_container_definition', url='', help='`ecs_container_definition` represents the `aws_ecs_container_definition` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withContainerName':: d.fn(help='`aws.ecs_container_definition.withContainerName` constructs a mixin object that can be merged into the `ecs_container_definition`\nTerraform data source block to set or update the container_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `container_name` field.\n', args=[]),
  ...
  '#withTaskDefinition':: d.fn(help='`aws.ecs_container_definition.withTaskDefinition` constructs a mixin object that can be merged into the `ecs_container_definition`\nTerraform data source block to set or update the task_definition field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `task_definition` field.\n', args=[]),
