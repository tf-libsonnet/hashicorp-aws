...
{
  '#':: d.pkg(name='directory_service_directory', url='', help='`directory_service_directory` represents the `aws_directory_service_directory` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDirectoryId':: d.fn(help='`aws.directory_service_directory.withDirectoryId` constructs a mixin object that can be merged into the `directory_service_directory`\nTerraform data source block to set or update the directory_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `directory_id` field.\n', args=[]),
