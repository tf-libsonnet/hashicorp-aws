...
{
  '#':: d.pkg(name='route53_resolver_firewall_rule_group', url='', help='`route53_resolver_firewall_rule_group` represents the `aws_route53_resolver_firewall_rule_group` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withFirewallRuleGroupId':: d.fn(help='`aws.route53_resolver_firewall_rule_group.withFirewallRuleGroupId` constructs a mixin object that can be merged into the `route53_resolver_firewall_rule_group`\nTerraform data source block to set or update the firewall_rule_group_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `firewall_rule_group_id` field.\n', args=[]),
