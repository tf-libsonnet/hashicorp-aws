...
{
  '#':: d.pkg(name='kinesis_stream_consumer', url='', help='`kinesis_stream_consumer` represents the `aws_kinesis_stream_consumer` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.kinesis_stream_consumer.withArn` constructs a mixin object that can be merged into the `kinesis_stream_consumer`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
