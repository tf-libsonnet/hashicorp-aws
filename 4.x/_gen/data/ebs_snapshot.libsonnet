...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFilter':: d.fn(help='`aws.ebs_snapshot.withFilter` constructs a mixin object that can be merged into the `ebs_snapshot`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.ebs_snapshot.withFilterMixin` constructs a mixin object that can be merged into the `ebs_snapshot`\nTerraform data source block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ebs_snapshot.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withMostRecent':: d.fn(help='`aws.ebs_snapshot.withMostRecent` constructs a mixin object that can be merged into the `ebs_snapshot`\nTerraform data source block to set or update the most_recent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `most_recent` field.\n', args=[]),
  ...
  '#withOwners':: d.fn(help='`aws.ebs_snapshot.withOwners` constructs a mixin object that can be merged into the `ebs_snapshot`\nTerraform data source block to set or update the owners field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owners` field.\n', args=[]),
  ...
  '#withRestorableByUserIds':: d.fn(help='`aws.ebs_snapshot.withRestorableByUserIds` constructs a mixin object that can be merged into the `ebs_snapshot`\nTerraform data source block to set or update the restorable_by_user_ids field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `restorable_by_user_ids` field.\n', args=[]),
  ...
  '#withSnapshotIds':: d.fn(help='`aws.ebs_snapshot.withSnapshotIds` constructs a mixin object that can be merged into the `ebs_snapshot`\nTerraform data source block to set or update the snapshot_ids field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `snapshot_ids` field.\n', args=[]),
