...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withUserPoolId':: d.fn(help='`aws.cognito_user_pool_signing_certificate.withUserPoolId` constructs a mixin object that can be merged into the `cognito_user_pool_signing_certificate`\nTerraform data source block to set or update the user_pool_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_pool_id` field.\n', args=[]),
