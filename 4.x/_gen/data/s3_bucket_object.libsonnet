...
{
  '#':: d.pkg(name='s3_bucket_object', url='', help='`s3_bucket_object` represents the `aws_s3_bucket_object` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withRange':: d.fn(help='`aws.s3_bucket_object.withRange` constructs a mixin object that can be merged into the `s3_bucket_object`\nTerraform data source block to set or update the range field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `range` field.\n', args=[]),
  ...
  '#withVersionId':: d.fn(help='`aws.s3_bucket_object.withVersionId` constructs a mixin object that can be merged into the `s3_bucket_object`\nTerraform data source block to set or update the version_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version_id` field.\n', args=[]),
