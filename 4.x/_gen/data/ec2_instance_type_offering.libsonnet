...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFilter':: d.fn(help='`aws.ec2_instance_type_offering.withFilter` constructs a mixin object that can be merged into the `ec2_instance_type_offering`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.ec2_instance_type_offering.withFilterMixin` constructs a mixin object that can be merged into the `ec2_instance_type_offering`\nTerraform data source block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ec2_instance_type_offering.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withLocationType':: d.fn(help='`aws.ec2_instance_type_offering.withLocationType` constructs a mixin object that can be merged into the `ec2_instance_type_offering`\nTerraform data source block to set or update the location_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location_type` field.\n', args=[]),
  ...
  '#withPreferredInstanceTypes':: d.fn(help='`aws.ec2_instance_type_offering.withPreferredInstanceTypes` constructs a mixin object that can be merged into the `ec2_instance_type_offering`\nTerraform data source block to set or update the preferred_instance_types field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `preferred_instance_types` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.ec2_instance_type_offering.withTimeouts` constructs a mixin object that can be merged into the `ec2_instance_type_offering`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.ec2_instance_type_offering.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_instance_type_offering`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.ec2_instance_type_offering.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
