...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withExcludeCompliantResources':: d.fn(help='`aws.resourcegroupstaggingapi_resources.withExcludeCompliantResources` constructs a mixin object that can be merged into the `resourcegroupstaggingapi_resources`\nTerraform data source block to set or update the exclude_compliant_resources field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `exclude_compliant_resources` field.\n', args=[]),
  ...
  '#withIncludeComplianceDetails':: d.fn(help='`aws.resourcegroupstaggingapi_resources.withIncludeComplianceDetails` constructs a mixin object that can be merged into the `resourcegroupstaggingapi_resources`\nTerraform data source block to set or update the include_compliance_details field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_compliance_details` field.\n', args=[]),
  ...
  '#withResourceArnList':: d.fn(help='`aws.resourcegroupstaggingapi_resources.withResourceArnList` constructs a mixin object that can be merged into the `resourcegroupstaggingapi_resources`\nTerraform data source block to set or update the resource_arn_list field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn_list` field.\n', args=[]),
  ...
  '#withResourceTypeFilters':: d.fn(help='`aws.resourcegroupstaggingapi_resources.withResourceTypeFilters` constructs a mixin object that can be merged into the `resourcegroupstaggingapi_resources`\nTerraform data source block to set or update the resource_type_filters field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_type_filters` field.\n', args=[]),
  ...
  '#withTagFilter':: d.fn(help='`aws.resourcegroupstaggingapi_resources.withTagFilter` constructs a mixin object that can be merged into the `resourcegroupstaggingapi_resources`\nTerraform data source block to set or update the tag_filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag_filter` field.\n', args=[]),
  ...
  '#withTagFilterMixin':: d.fn(help='`aws.resourcegroupstaggingapi_resources.withTagFilterMixin` constructs a mixin object that can be merged into the `resourcegroupstaggingapi_resources`\nTerraform data source block to set or update the tag_filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.resourcegroupstaggingapi_resources.withTagFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag_filter` field.\n', args=[]),
