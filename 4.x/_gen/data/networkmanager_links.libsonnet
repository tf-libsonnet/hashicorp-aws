...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGlobalNetworkId':: d.fn(help='`aws.networkmanager_links.withGlobalNetworkId` constructs a mixin object that can be merged into the `networkmanager_links`\nTerraform data source block to set or update the global_network_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `global_network_id` field.\n', args=[]),
  ...
  '#withProviderName':: d.fn(help='`aws.networkmanager_links.withProviderName` constructs a mixin object that can be merged into the `networkmanager_links`\nTerraform data source block to set or update the provider_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_name` field.\n', args=[]),
  ...
  '#withSiteId':: d.fn(help='`aws.networkmanager_links.withSiteId` constructs a mixin object that can be merged into the `networkmanager_links`\nTerraform data source block to set or update the site_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `site_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.networkmanager_links.withTags` constructs a mixin object that can be merged into the `networkmanager_links`\nTerraform data source block to set or update the tags field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withType':: d.fn(help='`aws.networkmanager_links.withType` constructs a mixin object that can be merged into the `networkmanager_links`\nTerraform data source block to set or update the type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type` field.\n', args=[]),
