...
{
  '#':: d.pkg(name='db_event_categories', url='', help='`db_event_categories` represents the `aws_db_event_categories` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withSourceType':: d.fn(help='`aws.db_event_categories.withSourceType` constructs a mixin object that can be merged into the `db_event_categories`\nTerraform data source block to set or update the source_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_type` field.\n', args=[]),
