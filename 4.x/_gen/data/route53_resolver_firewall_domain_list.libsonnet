...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFirewallDomainListId':: d.fn(help='`aws.route53_resolver_firewall_domain_list.withFirewallDomainListId` constructs a mixin object that can be merged into the `route53_resolver_firewall_domain_list`\nTerraform data source block to set or update the firewall_domain_list_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `firewall_domain_list_id` field.\n', args=[]),
