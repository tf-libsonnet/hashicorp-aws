...
{
  '#':: d.pkg(name='iam_instance_profile', url='', help='`iam_instance_profile` represents the `aws_iam_instance_profile` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
