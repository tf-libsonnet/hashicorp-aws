...
{
  '#':: d.pkg(name='lex_slot_type', url='', help='`lex_slot_type` represents the `aws_lex_slot_type` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withVersion':: d.fn(help='`aws.lex_slot_type.withVersion` constructs a mixin object that can be merged into the `lex_slot_type`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
