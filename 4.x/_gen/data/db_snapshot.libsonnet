...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDbSnapshotIdentifier':: d.fn(help='`aws.db_snapshot.withDbSnapshotIdentifier` constructs a mixin object that can be merged into the `db_snapshot`\nTerraform data source block to set or update the db_snapshot_identifier field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_snapshot_identifier` field.\n', args=[]),
  ...
  '#withIncludePublic':: d.fn(help='`aws.db_snapshot.withIncludePublic` constructs a mixin object that can be merged into the `db_snapshot`\nTerraform data source block to set or update the include_public field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_public` field.\n', args=[]),
  ...
  '#withIncludeShared':: d.fn(help='`aws.db_snapshot.withIncludeShared` constructs a mixin object that can be merged into the `db_snapshot`\nTerraform data source block to set or update the include_shared field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_shared` field.\n', args=[]),
  ...
  '#withMostRecent':: d.fn(help='`aws.db_snapshot.withMostRecent` constructs a mixin object that can be merged into the `db_snapshot`\nTerraform data source block to set or update the most_recent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `most_recent` field.\n', args=[]),
  ...
  '#withSnapshotType':: d.fn(help='`aws.db_snapshot.withSnapshotType` constructs a mixin object that can be merged into the `db_snapshot`\nTerraform data source block to set or update the snapshot_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `snapshot_type` field.\n', args=[]),
