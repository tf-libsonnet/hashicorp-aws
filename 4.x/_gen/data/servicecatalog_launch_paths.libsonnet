...
{
  '#':: d.pkg(name='servicecatalog_launch_paths', url='', help='`servicecatalog_launch_paths` represents the `aws_servicecatalog_launch_paths` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withAcceptLanguage':: d.fn(help='`aws.servicecatalog_launch_paths.withAcceptLanguage` constructs a mixin object that can be merged into the `servicecatalog_launch_paths`\nTerraform data source block to set or update the accept_language field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `accept_language` field.\n', args=[]),
  ...
  '#withProductId':: d.fn(help='`aws.servicecatalog_launch_paths.withProductId` constructs a mixin object that can be merged into the `servicecatalog_launch_paths`\nTerraform data source block to set or update the product_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `product_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.servicecatalog_launch_paths.withTimeouts` constructs a mixin object that can be merged into the `servicecatalog_launch_paths`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.servicecatalog_launch_paths.withTimeoutsMixin` constructs a mixin object that can be merged into the `servicecatalog_launch_paths`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.servicecatalog_launch_paths.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
