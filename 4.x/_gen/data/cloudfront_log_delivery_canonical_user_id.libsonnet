...
{
  '#':: d.pkg(name='cloudfront_log_delivery_canonical_user_id', url='', help='`cloudfront_log_delivery_canonical_user_id` represents the `aws_cloudfront_log_delivery_canonical_user_id` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withRegion':: d.fn(help='`aws.cloudfront_log_delivery_canonical_user_id.withRegion` constructs a mixin object that can be merged into the `cloudfront_log_delivery_canonical_user_id`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
