...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutoCreate':: d.fn(help='`aws.redshift_cluster_credentials.withAutoCreate` constructs a mixin object that can be merged into the `redshift_cluster_credentials`\nTerraform data source block to set or update the auto_create field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_create` field.\n', args=[]),
  ...
  '#withClusterIdentifier':: d.fn(help='`aws.redshift_cluster_credentials.withClusterIdentifier` constructs a mixin object that can be merged into the `redshift_cluster_credentials`\nTerraform data source block to set or update the cluster_identifier field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_identifier` field.\n', args=[]),
  ...
  '#withDbGroups':: d.fn(help='`aws.redshift_cluster_credentials.withDbGroups` constructs a mixin object that can be merged into the `redshift_cluster_credentials`\nTerraform data source block to set or update the db_groups field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_groups` field.\n', args=[]),
  ...
  '#withDbName':: d.fn(help='`aws.redshift_cluster_credentials.withDbName` constructs a mixin object that can be merged into the `redshift_cluster_credentials`\nTerraform data source block to set or update the db_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_name` field.\n', args=[]),
  ...
  '#withDbUser':: d.fn(help='`aws.redshift_cluster_credentials.withDbUser` constructs a mixin object that can be merged into the `redshift_cluster_credentials`\nTerraform data source block to set or update the db_user field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_user` field.\n', args=[]),
  ...
  '#withDurationSeconds':: d.fn(help='`aws.redshift_cluster_credentials.withDurationSeconds` constructs a mixin object that can be merged into the `redshift_cluster_credentials`\nTerraform data source block to set or update the duration_seconds field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `duration_seconds` field.\n', args=[]),
