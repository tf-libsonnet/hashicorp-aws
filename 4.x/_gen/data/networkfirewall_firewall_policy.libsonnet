...
{
  '#':: d.pkg(name='networkfirewall_firewall_policy', url='', help='`networkfirewall_firewall_policy` represents the `aws_networkfirewall_firewall_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.networkfirewall_firewall_policy.withArn` constructs a mixin object that can be merged into the `networkfirewall_firewall_policy`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
