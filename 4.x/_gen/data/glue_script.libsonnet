...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDagEdge':: d.fn(help='`aws.glue_script.withDagEdge` constructs a mixin object that can be merged into the `glue_script`\nTerraform data source block to set or update the dag_edge field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dag_edge` field.\n', args=[]),
  ...
  '#withDagEdgeMixin':: d.fn(help='`aws.glue_script.withDagEdgeMixin` constructs a mixin object that can be merged into the `glue_script`\nTerraform data source block to set or update the dag_edge field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_script.withDagEdge](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dag_edge` field.\n', args=[]),
  ...
  '#withDagNode':: d.fn(help='`aws.glue_script.withDagNode` constructs a mixin object that can be merged into the `glue_script`\nTerraform data source block to set or update the dag_node field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dag_node` field.\n', args=[]),
  ...
  '#withDagNodeMixin':: d.fn(help='`aws.glue_script.withDagNodeMixin` constructs a mixin object that can be merged into the `glue_script`\nTerraform data source block to set or update the dag_node field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_script.withDagNode](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dag_node` field.\n', args=[]),
  ...
  '#withLanguage':: d.fn(help='`aws.glue_script.withLanguage` constructs a mixin object that can be merged into the `glue_script`\nTerraform data source block to set or update the language field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `language` field.\n', args=[]),
