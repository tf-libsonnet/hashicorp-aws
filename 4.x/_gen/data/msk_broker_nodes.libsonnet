...
{
  '#':: d.pkg(name='msk_broker_nodes', url='', help='`msk_broker_nodes` represents the `aws_msk_broker_nodes` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withClusterArn':: d.fn(help='`aws.msk_broker_nodes.withClusterArn` constructs a mixin object that can be merged into the `msk_broker_nodes`\nTerraform data source block to set or update the cluster_arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_arn` field.\n', args=[]),
