...
{
  '#':: d.pkg(name='elasticache_cluster', url='', help='`elasticache_cluster` represents the `aws_elasticache_cluster` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
