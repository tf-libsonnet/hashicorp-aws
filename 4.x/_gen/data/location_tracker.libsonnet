...
{
  '#':: d.pkg(name='location_tracker', url='', help='`location_tracker` represents the `aws_location_tracker` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
