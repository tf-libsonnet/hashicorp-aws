...
{
  '#':: d.pkg(name='wafv2_web_acl', url='', help='`wafv2_web_acl` represents the `aws_wafv2_web_acl` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.wafv2_web_acl.withName` constructs a mixin object that can be merged into the `wafv2_web_acl`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScope':: d.fn(help='`aws.wafv2_web_acl.withScope` constructs a mixin object that can be merged into the `wafv2_web_acl`\nTerraform data source block to set or update the scope field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
