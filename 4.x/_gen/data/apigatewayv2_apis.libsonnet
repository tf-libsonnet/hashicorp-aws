...
{
  '#':: d.pkg(name='apigatewayv2_apis', url='', help='`apigatewayv2_apis` represents the `aws_apigatewayv2_apis` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.apigatewayv2_apis.withName` constructs a mixin object that can be merged into the `apigatewayv2_apis`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProtocolType':: d.fn(help='`aws.apigatewayv2_apis.withProtocolType` constructs a mixin object that can be merged into the `apigatewayv2_apis`\nTerraform data source block to set or update the protocol_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `protocol_type` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.apigatewayv2_apis.withTags` constructs a mixin object that can be merged into the `apigatewayv2_apis`\nTerraform data source block to set or update the tags field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
