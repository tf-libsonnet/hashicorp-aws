...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMostRecent':: d.fn(help='`aws.elastic_beanstalk_solution_stack.withMostRecent` constructs a mixin object that can be merged into the `elastic_beanstalk_solution_stack`\nTerraform data source block to set or update the most_recent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `most_recent` field.\n', args=[]),
  ...
  '#withNameRegex':: d.fn(help='`aws.elastic_beanstalk_solution_stack.withNameRegex` constructs a mixin object that can be merged into the `elastic_beanstalk_solution_stack`\nTerraform data source block to set or update the name_regex field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_regex` field.\n', args=[]),
