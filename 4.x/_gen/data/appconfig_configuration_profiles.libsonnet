...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationId':: d.fn(help='`aws.appconfig_configuration_profiles.withApplicationId` constructs a mixin object that can be merged into the `appconfig_configuration_profiles`\nTerraform data source block to set or update the application_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_id` field.\n', args=[]),
