...
{
  '#':: d.pkg(name='imagebuilder_components', url='', help='`imagebuilder_components` represents the `aws_imagebuilder_components` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filter:: {
  ...
  '#withFilter':: d.fn(help='`aws.imagebuilder_components.withFilter` constructs a mixin object that can be merged into the `imagebuilder_components`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.imagebuilder_components.withFilterMixin` constructs a mixin object that can be merged into the `imagebuilder_components`\nTerraform data source block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.imagebuilder_components.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withOwner':: d.fn(help='`aws.imagebuilder_components.withOwner` constructs a mixin object that can be merged into the `imagebuilder_components`\nTerraform data source block to set or update the owner field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owner` field.\n', args=[]),
