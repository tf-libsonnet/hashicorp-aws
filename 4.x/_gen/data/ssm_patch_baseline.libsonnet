...
{
  '#':: d.pkg(name='ssm_patch_baseline', url='', help='`ssm_patch_baseline` represents the `aws_ssm_patch_baseline` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDefaultBaseline':: d.fn(help='`aws.ssm_patch_baseline.withDefaultBaseline` constructs a mixin object that can be merged into the `ssm_patch_baseline`\nTerraform data source block to set or update the default_baseline field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_baseline` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`aws.ssm_patch_baseline.withNamePrefix` constructs a mixin object that can be merged into the `ssm_patch_baseline`\nTerraform data source block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withOwner':: d.fn(help='`aws.ssm_patch_baseline.withOwner` constructs a mixin object that can be merged into the `ssm_patch_baseline`\nTerraform data source block to set or update the owner field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owner` field.\n', args=[]),
