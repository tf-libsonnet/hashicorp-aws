...
{
  '#':: d.pkg(name='globalaccelerator_accelerator', url='', help='`globalaccelerator_accelerator` represents the `aws_globalaccelerator_accelerator` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.globalaccelerator_accelerator.withArn` constructs a mixin object that can be merged into the `globalaccelerator_accelerator`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
