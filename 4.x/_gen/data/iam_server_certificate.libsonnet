...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLatest':: d.fn(help='`aws.iam_server_certificate.withLatest` constructs a mixin object that can be merged into the `iam_server_certificate`\nTerraform data source block to set or update the latest field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `latest` field.\n', args=[]),
  ...
  '#withPathPrefix':: d.fn(help='`aws.iam_server_certificate.withPathPrefix` constructs a mixin object that can be merged into the `iam_server_certificate`\nTerraform data source block to set or update the path_prefix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `path_prefix` field.\n', args=[]),
