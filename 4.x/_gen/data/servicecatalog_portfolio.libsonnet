...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAcceptLanguage':: d.fn(help='`aws.servicecatalog_portfolio.withAcceptLanguage` constructs a mixin object that can be merged into the `servicecatalog_portfolio`\nTerraform data source block to set or update the accept_language field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `accept_language` field.\n', args=[]),
