...
{
  '#':: d.pkg(name='oam_link', url='', help='`oam_link` represents the `aws_oam_link` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    type='aws_oam_link',
    label=dataSrcLabel,
    attrs=self.newAttrs(link_identifier=link_identifier, tags=tags),
    _meta=_meta
  ),
  ...
  '#withLinkIdentifier':: d.fn(help='`aws.string.withLinkIdentifier` constructs a mixin object that can be merged into the `string`\nTerraform data source block to set or update the link_identifier field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `link_identifier` field.\n', args=[]),
  withLinkIdentifier(dataSrcLabel, value): {
    data+: {
      aws_oam_link+: {
        [dataSrcLabel]+: {
