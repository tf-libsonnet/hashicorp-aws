...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEngineType':: d.fn(help='`aws.mq_broker_instance_type_offerings.withEngineType` constructs a mixin object that can be merged into the `mq_broker_instance_type_offerings`\nTerraform data source block to set or update the engine_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `engine_type` field.\n', args=[]),
  ...
  '#withHostInstanceType':: d.fn(help='`aws.mq_broker_instance_type_offerings.withHostInstanceType` constructs a mixin object that can be merged into the `mq_broker_instance_type_offerings`\nTerraform data source block to set or update the host_instance_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `host_instance_type` field.\n', args=[]),
  ...
  '#withStorageType':: d.fn(help='`aws.mq_broker_instance_type_offerings.withStorageType` constructs a mixin object that can be merged into the `mq_broker_instance_type_offerings`\nTerraform data source block to set or update the storage_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_type` field.\n', args=[]),
