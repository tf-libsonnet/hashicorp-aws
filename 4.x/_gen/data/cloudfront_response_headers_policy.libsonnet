...
{
  '#':: d.pkg(name='cloudfront_response_headers_policy', url='', help='`cloudfront_response_headers_policy` represents the `aws_cloudfront_response_headers_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
