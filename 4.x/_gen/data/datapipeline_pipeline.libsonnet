...
{
  '#':: d.pkg(name='datapipeline_pipeline', url='', help='`datapipeline_pipeline` represents the `aws_datapipeline_pipeline` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withPipelineId':: d.fn(help='`aws.datapipeline_pipeline.withPipelineId` constructs a mixin object that can be merged into the `datapipeline_pipeline`\nTerraform data source block to set or update the pipeline_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `pipeline_id` field.\n', args=[]),
