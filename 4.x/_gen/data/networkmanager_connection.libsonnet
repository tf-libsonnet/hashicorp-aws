...
{
  '#':: d.pkg(name='networkmanager_connection', url='', help='`networkmanager_connection` represents the `aws_networkmanager_connection` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withConnectionId':: d.fn(help='`aws.networkmanager_connection.withConnectionId` constructs a mixin object that can be merged into the `networkmanager_connection`\nTerraform data source block to set or update the connection_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_id` field.\n', args=[]),
