...
{
  '#':: d.pkg(name='cognito_user_pool_clients', url='', help='`cognito_user_pool_clients` represents the `aws_cognito_user_pool_clients` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withUserPoolId':: d.fn(help='`aws.cognito_user_pool_clients.withUserPoolId` constructs a mixin object that can be merged into the `cognito_user_pool_clients`\nTerraform data source block to set or update the user_pool_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_pool_id` field.\n', args=[]),
