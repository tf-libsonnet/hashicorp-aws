...
{
  '#':: d.pkg(name='cloudformation_export', url='', help='`cloudformation_export` represents the `aws_cloudformation_export` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.cloudformation_export.withName` constructs a mixin object that can be merged into the `cloudformation_export`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
