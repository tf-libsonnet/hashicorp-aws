...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRouterTypeIdentifier':: d.fn(help='`aws.dx_router_configuration.withRouterTypeIdentifier` constructs a mixin object that can be merged into the `dx_router_configuration`\nTerraform data source block to set or update the router_type_identifier field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `router_type_identifier` field.\n', args=[]),
  ...
  '#withVirtualInterfaceId':: d.fn(help='`aws.dx_router_configuration.withVirtualInterfaceId` constructs a mixin object that can be merged into the `dx_router_configuration`\nTerraform data source block to set or update the virtual_interface_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_interface_id` field.\n', args=[]),
