...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDiskNode':: d.fn(help='`aws.storagegateway_local_disk.withDiskNode` constructs a mixin object that can be merged into the `storagegateway_local_disk`\nTerraform data source block to set or update the disk_node field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_node` field.\n', args=[]),
  ...
  '#withDiskPath':: d.fn(help='`aws.storagegateway_local_disk.withDiskPath` constructs a mixin object that can be merged into the `storagegateway_local_disk`\nTerraform data source block to set or update the disk_path field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_path` field.\n', args=[]),
  ...
  '#withGatewayArn':: d.fn(help='`aws.storagegateway_local_disk.withGatewayArn` constructs a mixin object that can be merged into the `storagegateway_local_disk`\nTerraform data source block to set or update the gateway_arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway_arn` field.\n', args=[]),
