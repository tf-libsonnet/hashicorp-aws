...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withArn':: d.fn(help='`aws.outposts_asset.withArn` constructs a mixin object that can be merged into the `outposts_asset`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
  ...
  '#withAssetId':: d.fn(help='`aws.outposts_asset.withAssetId` constructs a mixin object that can be merged into the `outposts_asset`\nTerraform data source block to set or update the asset_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `asset_id` field.\n', args=[]),
