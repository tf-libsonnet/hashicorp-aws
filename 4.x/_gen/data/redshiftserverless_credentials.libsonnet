...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDbName':: d.fn(help='`aws.redshiftserverless_credentials.withDbName` constructs a mixin object that can be merged into the `redshiftserverless_credentials`\nTerraform data source block to set or update the db_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_name` field.\n', args=[]),
  ...
  '#withDurationSeconds':: d.fn(help='`aws.redshiftserverless_credentials.withDurationSeconds` constructs a mixin object that can be merged into the `redshiftserverless_credentials`\nTerraform data source block to set or update the duration_seconds field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `duration_seconds` field.\n', args=[]),
  ...
  '#withWorkgroupName':: d.fn(help='`aws.redshiftserverless_credentials.withWorkgroupName` constructs a mixin object that can be merged into the `redshiftserverless_credentials`\nTerraform data source block to set or update the workgroup_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workgroup_name` field.\n', args=[]),
