...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withComments':: d.fn(help='`aws.cloudfront_origin_access_identities.withComments` constructs a mixin object that can be merged into the `cloudfront_origin_access_identities`\nTerraform data source block to set or update the comments field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `comments` field.\n', args=[]),
