...
{
  '#':: d.pkg(name='outposts_outpost', url='', help='`outposts_outpost` represents the `aws_outposts_outpost` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.outposts_outpost.withArn` constructs a mixin object that can be merged into the `outposts_outpost`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.outposts_outpost.withName` constructs a mixin object that can be merged into the `outposts_outpost`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withOwnerId':: d.fn(help='`aws.outposts_outpost.withOwnerId` constructs a mixin object that can be merged into the `outposts_outpost`\nTerraform data source block to set or update the owner_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owner_id` field.\n', args=[]),
