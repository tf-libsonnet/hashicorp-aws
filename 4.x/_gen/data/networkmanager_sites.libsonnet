...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGlobalNetworkId':: d.fn(help='`aws.networkmanager_sites.withGlobalNetworkId` constructs a mixin object that can be merged into the `networkmanager_sites`\nTerraform data source block to set or update the global_network_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `global_network_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.networkmanager_sites.withTags` constructs a mixin object that can be merged into the `networkmanager_sites`\nTerraform data source block to set or update the tags field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
