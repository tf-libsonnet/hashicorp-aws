...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFilter':: d.fn(help='`aws.ec2_transit_gateway_attachment.withFilter` constructs a mixin object that can be merged into the `ec2_transit_gateway_attachment`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.ec2_transit_gateway_attachment.withFilterMixin` constructs a mixin object that can be merged into the `ec2_transit_gateway_attachment`\nTerraform data source block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ec2_transit_gateway_attachment.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.ec2_transit_gateway_attachment.withTags` constructs a mixin object that can be merged into the `ec2_transit_gateway_attachment`\nTerraform data source block to set or update the tags field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTransitGatewayAttachmentId':: d.fn(help='`aws.ec2_transit_gateway_attachment.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_attachment`\nTerraform data source block to set or update the transit_gateway_attachment_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_attachment_id` field.\n', args=[]),
