...
{
  '#':: d.pkg(name='iam_group', url='', help='`iam_group` represents the `aws_iam_group` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
