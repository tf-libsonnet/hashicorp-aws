...
{
  '#':: d.pkg(name='elastic_beanstalk_hosted_zone', url='', help='`elastic_beanstalk_hosted_zone` represents the `aws_elastic_beanstalk_hosted_zone` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withRegion':: d.fn(help='`aws.elastic_beanstalk_hosted_zone.withRegion` constructs a mixin object that can be merged into the `elastic_beanstalk_hosted_zone`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
