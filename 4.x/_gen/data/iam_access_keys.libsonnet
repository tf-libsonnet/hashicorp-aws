...
{
  '#':: d.pkg(name='iam_access_keys', url='', help='`iam_access_keys` represents the `aws_iam_access_keys` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
