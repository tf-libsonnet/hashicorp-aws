...
{
  '#':: d.pkg(name='lambda_code_signing_config', url='', help='`lambda_code_signing_config` represents the `aws_lambda_code_signing_config` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.lambda_code_signing_config.withArn` constructs a mixin object that can be merged into the `lambda_code_signing_config`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
