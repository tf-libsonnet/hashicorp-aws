...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAssociationId':: d.fn(help='`aws.connect_instance_storage_config.withAssociationId` constructs a mixin object that can be merged into the `connect_instance_storage_config`\nTerraform data source block to set or update the association_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `association_id` field.\n', args=[]),
