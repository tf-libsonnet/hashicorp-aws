...
{
  '#':: d.pkg(name='workspaces_bundle', url='', help='`workspaces_bundle` represents the `aws_workspaces_bundle` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withBundleId':: d.fn(help='`aws.workspaces_bundle.withBundleId` constructs a mixin object that can be merged into the `workspaces_bundle`\nTerraform data source block to set or update the bundle_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bundle_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.workspaces_bundle.withName` constructs a mixin object that can be merged into the `workspaces_bundle`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withOwner':: d.fn(help='`aws.workspaces_bundle.withOwner` constructs a mixin object that can be merged into the `workspaces_bundle`\nTerraform data source block to set or update the owner field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owner` field.\n', args=[]),
