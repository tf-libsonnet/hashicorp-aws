...
{
  '#':: d.pkg(name='s3_bucket_objects', url='', help='`s3_bucket_objects` represents the `aws_s3_bucket_objects` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withBucket':: d.fn(help='`aws.s3_bucket_objects.withBucket` constructs a mixin object that can be merged into the `s3_bucket_objects`\nTerraform data source block to set or update the bucket field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withDelimiter':: d.fn(help='`aws.s3_bucket_objects.withDelimiter` constructs a mixin object that can be merged into the `s3_bucket_objects`\nTerraform data source block to set or update the delimiter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delimiter` field.\n', args=[]),
  ...
  '#withEncodingType':: d.fn(help='`aws.s3_bucket_objects.withEncodingType` constructs a mixin object that can be merged into the `s3_bucket_objects`\nTerraform data source block to set or update the encoding_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encoding_type` field.\n', args=[]),
  ...
  '#withFetchOwner':: d.fn(help='`aws.s3_bucket_objects.withFetchOwner` constructs a mixin object that can be merged into the `s3_bucket_objects`\nTerraform data source block to set or update the fetch_owner field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fetch_owner` field.\n', args=[]),
  ...
  '#withMaxKeys':: d.fn(help='`aws.s3_bucket_objects.withMaxKeys` constructs a mixin object that can be merged into the `s3_bucket_objects`\nTerraform data source block to set or update the max_keys field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `max_keys` field.\n', args=[]),
  ...
  '#withPrefix':: d.fn(help='`aws.s3_bucket_objects.withPrefix` constructs a mixin object that can be merged into the `s3_bucket_objects`\nTerraform data source block to set or update the prefix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `prefix` field.\n', args=[]),
  ...
  '#withStartAfter':: d.fn(help='`aws.s3_bucket_objects.withStartAfter` constructs a mixin object that can be merged into the `s3_bucket_objects`\nTerraform data source block to set or update the start_after field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `start_after` field.\n', args=[]),
