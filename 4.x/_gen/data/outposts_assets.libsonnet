...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withArn':: d.fn(help='`aws.outposts_assets.withArn` constructs a mixin object that can be merged into the `outposts_assets`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
  ...
  '#withHostIdFilter':: d.fn(help='`aws.outposts_assets.withHostIdFilter` constructs a mixin object that can be merged into the `outposts_assets`\nTerraform data source block to set or update the host_id_filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `host_id_filter` field.\n', args=[]),
  ...
  '#withStatusIdFilter':: d.fn(help='`aws.outposts_assets.withStatusIdFilter` constructs a mixin object that can be merged into the `outposts_assets`\nTerraform data source block to set or update the status_id_filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status_id_filter` field.\n', args=[]),
