...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withArn':: d.fn(help='`aws.outposts_outpost_instance_type.withArn` constructs a mixin object that can be merged into the `outposts_outpost_instance_type`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
  ...
  '#withInstanceType':: d.fn(help='`aws.outposts_outpost_instance_type.withInstanceType` constructs a mixin object that can be merged into the `outposts_outpost_instance_type`\nTerraform data source block to set or update the instance_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_type` field.\n', args=[]),
  ...
  '#withPreferredInstanceTypes':: d.fn(help='`aws.outposts_outpost_instance_type.withPreferredInstanceTypes` constructs a mixin object that can be merged into the `outposts_outpost_instance_type`\nTerraform data source block to set or update the preferred_instance_types field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `preferred_instance_types` field.\n', args=[]),
