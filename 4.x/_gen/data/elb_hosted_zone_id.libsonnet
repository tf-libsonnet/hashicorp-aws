...
{
  '#':: d.pkg(name='elb_hosted_zone_id', url='', help='`elb_hosted_zone_id` represents the `aws_elb_hosted_zone_id` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withRegion':: d.fn(help='`aws.elb_hosted_zone_id.withRegion` constructs a mixin object that can be merged into the `elb_hosted_zone_id`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
