...
{
  '#':: d.pkg(name='organizations_organizational_units', url='', help='`organizations_organizational_units` represents the `aws_organizations_organizational_units` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withParentId':: d.fn(help='`aws.organizations_organizational_units.withParentId` constructs a mixin object that can be merged into the `organizations_organizational_units`\nTerraform data source block to set or update the parent_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent_id` field.\n', args=[]),
