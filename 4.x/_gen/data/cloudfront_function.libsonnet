...
{
  '#':: d.pkg(name='cloudfront_function', url='', help='`cloudfront_function` represents the `aws_cloudfront_function` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withStage':: d.fn(help='`aws.cloudfront_function.withStage` constructs a mixin object that can be merged into the `cloudfront_function`\nTerraform data source block to set or update the stage field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage` field.\n', args=[]),
