...
{
  '#':: d.pkg(name='networkmanager_connections', url='', help='`networkmanager_connections` represents the `aws_networkmanager_connections` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDeviceId':: d.fn(help='`aws.networkmanager_connections.withDeviceId` constructs a mixin object that can be merged into the `networkmanager_connections`\nTerraform data source block to set or update the device_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `device_id` field.\n', args=[]),
  ...
  '#withGlobalNetworkId':: d.fn(help='`aws.networkmanager_connections.withGlobalNetworkId` constructs a mixin object that can be merged into the `networkmanager_connections`\nTerraform data source block to set or update the global_network_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `global_network_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.networkmanager_connections.withTags` constructs a mixin object that can be merged into the `networkmanager_connections`\nTerraform data source block to set or update the tags field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
