...
{
  '#':: d.pkg(name='neptune_orderable_db_instance', url='', help='`neptune_orderable_db_instance` represents the `aws_neptune_orderable_db_instance` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withEngine':: d.fn(help='`aws.neptune_orderable_db_instance.withEngine` constructs a mixin object that can be merged into the `neptune_orderable_db_instance`\nTerraform data source block to set or update the engine field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `engine` field.\n', args=[]),
  ...
  '#withEngineVersion':: d.fn(help='`aws.neptune_orderable_db_instance.withEngineVersion` constructs a mixin object that can be merged into the `neptune_orderable_db_instance`\nTerraform data source block to set or update the engine_version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `engine_version` field.\n', args=[]),
  ...
  '#withInstanceClass':: d.fn(help='`aws.neptune_orderable_db_instance.withInstanceClass` constructs a mixin object that can be merged into the `neptune_orderable_db_instance`\nTerraform data source block to set or update the instance_class field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_class` field.\n', args=[]),
  ...
  '#withLicenseModel':: d.fn(help='`aws.neptune_orderable_db_instance.withLicenseModel` constructs a mixin object that can be merged into the `neptune_orderable_db_instance`\nTerraform data source block to set or update the license_model field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `license_model` field.\n', args=[]),
  ...
  '#withPreferredInstanceClasses':: d.fn(help='`aws.neptune_orderable_db_instance.withPreferredInstanceClasses` constructs a mixin object that can be merged into the `neptune_orderable_db_instance`\nTerraform data source block to set or update the preferred_instance_classes field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `preferred_instance_classes` field.\n', args=[]),
  ...
  '#withVpc':: d.fn(help='`aws.neptune_orderable_db_instance.withVpc` constructs a mixin object that can be merged into the `neptune_orderable_db_instance`\nTerraform data source block to set or update the vpc field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc` field.\n', args=[]),
