...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withServices':: d.fn(help='`aws.ip_ranges.withServices` constructs a mixin object that can be merged into the `ip_ranges`\nTerraform data source block to set or update the services field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `services` field.\n', args=[]),
  ...
  '#withUrl':: d.fn(help='`aws.ip_ranges.withUrl` constructs a mixin object that can be merged into the `ip_ranges`\nTerraform data source block to set or update the url field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `url` field.\n', args=[]),
