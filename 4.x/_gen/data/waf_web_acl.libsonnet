...
{
  '#':: d.pkg(name='waf_web_acl', url='', help='`waf_web_acl` represents the `aws_waf_web_acl` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
