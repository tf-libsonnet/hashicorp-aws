...
{
  '#':: d.pkg(name='route53_resolver_rules', url='', help='`route53_resolver_rules` represents the `aws_route53_resolver_rules` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withNameRegex':: d.fn(help='`aws.route53_resolver_rules.withNameRegex` constructs a mixin object that can be merged into the `route53_resolver_rules`\nTerraform data source block to set or update the name_regex field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_regex` field.\n', args=[]),
  ...
  '#withOwnerId':: d.fn(help='`aws.route53_resolver_rules.withOwnerId` constructs a mixin object that can be merged into the `route53_resolver_rules`\nTerraform data source block to set or update the owner_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owner_id` field.\n', args=[]),
  ...
  '#withResolverEndpointId':: d.fn(help='`aws.route53_resolver_rules.withResolverEndpointId` constructs a mixin object that can be merged into the `route53_resolver_rules`\nTerraform data source block to set or update the resolver_endpoint_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resolver_endpoint_id` field.\n', args=[]),
  ...
  '#withRuleType':: d.fn(help='`aws.route53_resolver_rules.withRuleType` constructs a mixin object that can be merged into the `route53_resolver_rules`\nTerraform data source block to set or update the rule_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rule_type` field.\n', args=[]),
  ...
  '#withShareStatus':: d.fn(help='`aws.route53_resolver_rules.withShareStatus` constructs a mixin object that can be merged into the `route53_resolver_rules`\nTerraform data source block to set or update the share_status field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `share_status` field.\n', args=[]),
