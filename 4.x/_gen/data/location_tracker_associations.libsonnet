...
{
  '#':: d.pkg(name='location_tracker_associations', url='', help='`location_tracker_associations` represents the `aws_location_tracker_associations` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withTrackerName':: d.fn(help='`aws.location_tracker_associations.withTrackerName` constructs a mixin object that can be merged into the `location_tracker_associations`\nTerraform data source block to set or update the tracker_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tracker_name` field.\n', args=[]),
