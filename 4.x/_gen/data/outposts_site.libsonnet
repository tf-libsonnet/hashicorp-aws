...
{
  '#':: d.pkg(name='outposts_site', url='', help='`outposts_site` represents the `aws_outposts_site` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.outposts_site.withName` constructs a mixin object that can be merged into the `outposts_site`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
