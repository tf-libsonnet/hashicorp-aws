...
{
  '#':: d.pkg(name='emrcontainers_virtual_cluster', url='', help='`emrcontainers_virtual_cluster` represents the `aws_emrcontainers_virtual_cluster` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withVirtualClusterId':: d.fn(help='`aws.emrcontainers_virtual_cluster.withVirtualClusterId` constructs a mixin object that can be merged into the `emrcontainers_virtual_cluster`\nTerraform data source block to set or update the virtual_cluster_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_cluster_id` field.\n', args=[]),
