...
{
  '#':: d.pkg(name='waf_ipset', url='', help='`waf_ipset` represents the `aws_waf_ipset` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
