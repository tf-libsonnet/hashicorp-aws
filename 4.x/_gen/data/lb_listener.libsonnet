...
{
  '#':: d.pkg(name='lb_listener', url='', help='`lb_listener` represents the `aws_lb_listener` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.lb_listener.withArn` constructs a mixin object that can be merged into the `lb_listener`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
