...
{
  '#':: d.pkg(name='msk_kafka_version', url='', help='`msk_kafka_version` represents the `aws_msk_kafka_version` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withPreferredVersions':: d.fn(help='`aws.msk_kafka_version.withPreferredVersions` constructs a mixin object that can be merged into the `msk_kafka_version`\nTerraform data source block to set or update the preferred_versions field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `preferred_versions` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`aws.msk_kafka_version.withVersion` constructs a mixin object that can be merged into the `msk_kafka_version`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
