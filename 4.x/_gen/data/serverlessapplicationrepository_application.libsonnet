...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationId':: d.fn(help='`aws.serverlessapplicationrepository_application.withApplicationId` constructs a mixin object that can be merged into the `serverlessapplicationrepository_application`\nTerraform data source block to set or update the application_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_id` field.\n', args=[]),
  ...
  '#withSemanticVersion':: d.fn(help='`aws.serverlessapplicationrepository_application.withSemanticVersion` constructs a mixin object that can be merged into the `serverlessapplicationrepository_application`\nTerraform data source block to set or update the semantic_version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `semantic_version` field.\n', args=[]),
