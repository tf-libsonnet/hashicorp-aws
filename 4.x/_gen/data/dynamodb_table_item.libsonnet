...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withExpressionAttributeNames':: d.fn(help='`aws.dynamodb_table_item.withExpressionAttributeNames` constructs a mixin object that can be merged into the `dynamodb_table_item`\nTerraform data source block to set or update the expression_attribute_names field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expression_attribute_names` field.\n', args=[]),
  ...
  '#withKey':: d.fn(help='`aws.dynamodb_table_item.withKey` constructs a mixin object that can be merged into the `dynamodb_table_item`\nTerraform data source block to set or update the key field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key` field.\n', args=[]),
  ...
  '#withProjectionExpression':: d.fn(help='`aws.dynamodb_table_item.withProjectionExpression` constructs a mixin object that can be merged into the `dynamodb_table_item`\nTerraform data source block to set or update the projection_expression field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `projection_expression` field.\n', args=[]),
  ...
  '#withTableName':: d.fn(help='`aws.dynamodb_table_item.withTableName` constructs a mixin object that can be merged into the `dynamodb_table_item`\nTerraform data source block to set or update the table_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_name` field.\n', args=[]),
