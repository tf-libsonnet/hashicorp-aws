...
{
  '#':: d.pkg(name='networkmanager_device', url='', help='`networkmanager_device` represents the `aws_networkmanager_device` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDeviceId':: d.fn(help='`aws.networkmanager_device.withDeviceId` constructs a mixin object that can be merged into the `networkmanager_device`\nTerraform data source block to set or update the device_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `device_id` field.\n', args=[]),
