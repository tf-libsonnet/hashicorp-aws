...
{
  '#':: d.pkg(name='apigatewayv2_api', url='', help='`apigatewayv2_api` represents the `aws_apigatewayv2_api` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withApiId':: d.fn(help='`aws.apigatewayv2_api.withApiId` constructs a mixin object that can be merged into the `apigatewayv2_api`\nTerraform data source block to set or update the api_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_id` field.\n', args=[]),
