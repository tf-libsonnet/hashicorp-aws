...
{
  '#':: d.pkg(name='networkmanager_global_network', url='', help='`networkmanager_global_network` represents the `aws_networkmanager_global_network` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withGlobalNetworkId':: d.fn(help='`aws.networkmanager_global_network.withGlobalNetworkId` constructs a mixin object that can be merged into the `networkmanager_global_network`\nTerraform data source block to set or update the global_network_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `global_network_id` field.\n', args=[]),
