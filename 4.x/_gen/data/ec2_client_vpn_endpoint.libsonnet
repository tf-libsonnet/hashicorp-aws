...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClientVpnEndpointId':: d.fn(help='`aws.ec2_client_vpn_endpoint.withClientVpnEndpointId` constructs a mixin object that can be merged into the `ec2_client_vpn_endpoint`\nTerraform data source block to set or update the client_vpn_endpoint_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_vpn_endpoint_id` field.\n', args=[]),
  ...
  '#withFilter':: d.fn(help='`aws.ec2_client_vpn_endpoint.withFilter` constructs a mixin object that can be merged into the `ec2_client_vpn_endpoint`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.ec2_client_vpn_endpoint.withFilterMixin` constructs a mixin object that can be merged into the `ec2_client_vpn_endpoint`\nTerraform data source block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ec2_client_vpn_endpoint.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.ec2_client_vpn_endpoint.withTimeouts` constructs a mixin object that can be merged into the `ec2_client_vpn_endpoint`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.ec2_client_vpn_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_client_vpn_endpoint`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.ec2_client_vpn_endpoint.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
