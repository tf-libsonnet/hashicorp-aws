...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withContactFlowModuleId':: d.fn(help='`aws.connect_contact_flow_module.withContactFlowModuleId` constructs a mixin object that can be merged into the `connect_contact_flow_module`\nTerraform data source block to set or update the contact_flow_module_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `contact_flow_module_id` field.\n', args=[]),
