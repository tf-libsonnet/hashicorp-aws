...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  rule:: {
    ...
    '#new':: d.fn(help='\n`aws.route53_traffic_policy_document.rule.new` constructs a new object with attributes and blocks configured for the `rule`\nTerraform sub block.\n\n\n\n**Args**:\n  - `type` (`string`):  When `null`, the `type` field will be omitted from the resulting object.\n  - `geo_proximity_location` (`list[obj]`):  When `null`, the `geo_proximity_location` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.geo_proximity_location.new](#fn-route53_traffic_policy_documentgeo_proximity_locationnew) constructor.\n  - `items` (`list[obj]`):  When `null`, the `items` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.items.new](#fn-route53_traffic_policy_documentitemsnew) constructor.\n  - `location` (`list[obj]`):  When `null`, the `location` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.location.new](#fn-route53_traffic_policy_documentlocationnew) constructor.\n  - `primary` (`list[obj]`):  When `null`, the `primary` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.primary.new](#fn-route53_traffic_policy_documentprimarynew) constructor.\n  - `region` (`list[obj]`):  When `null`, the `region` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.region.new](#fn-route53_traffic_policy_documentregionnew) constructor.\n  - `secondary` (`list[obj]`):  When `null`, the `secondary` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.route53_traffic_policy_document.rule.secondary.new](#fn-route53_traffic_policy_documentsecondarynew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `rule` sub block.\n', args=[]),
    new(
