...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFilters':: d.fn(help='`aws.emr_release_labels.withFilters` constructs a mixin object that can be merged into the `emr_release_labels`\nTerraform data source block to set or update the filters field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filters` field.\n', args=[]),
  ...
  '#withFiltersMixin':: d.fn(help='`aws.emr_release_labels.withFiltersMixin` constructs a mixin object that can be merged into the `emr_release_labels`\nTerraform data source block to set or update the filters field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.emr_release_labels.withFilters](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filters` field.\n', args=[]),
