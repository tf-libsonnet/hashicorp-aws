...
{
  '#':: d.pkg(name='emr_release_labels', url='', help='`emr_release_labels` represents the `aws_emr_release_labels` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filters:: {
