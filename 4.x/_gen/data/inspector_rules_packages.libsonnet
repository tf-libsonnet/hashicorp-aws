...
{
  '#':: d.pkg(name='inspector_rules_packages', url='', help='`inspector_rules_packages` represents the `aws_inspector_rules_packages` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
