...
{
  '#':: d.pkg(name='ecr_repository', url='', help='`ecr_repository` represents the `aws_ecr_repository` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withRegistryId':: d.fn(help='`aws.ecr_repository.withRegistryId` constructs a mixin object that can be merged into the `ecr_repository`\nTerraform data source block to set or update the registry_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `registry_id` field.\n', args=[]),
