...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAction':: d.fn(help='`aws.route53_resolver_firewall_rules.withAction` constructs a mixin object that can be merged into the `route53_resolver_firewall_rules`\nTerraform data source block to set or update the action field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `action` field.\n', args=[]),
  ...
  '#withFirewallRuleGroupId':: d.fn(help='`aws.route53_resolver_firewall_rules.withFirewallRuleGroupId` constructs a mixin object that can be merged into the `route53_resolver_firewall_rules`\nTerraform data source block to set or update the firewall_rule_group_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `firewall_rule_group_id` field.\n', args=[]),
  ...
  '#withPriority':: d.fn(help='`aws.route53_resolver_firewall_rules.withPriority` constructs a mixin object that can be merged into the `route53_resolver_firewall_rules`\nTerraform data source block to set or update the priority field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `priority` field.\n', args=[]),
