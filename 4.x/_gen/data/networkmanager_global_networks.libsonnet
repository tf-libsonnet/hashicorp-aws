...
{
  '#':: d.pkg(name='networkmanager_global_networks', url='', help='`networkmanager_global_networks` represents the `aws_networkmanager_global_networks` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withTags':: d.fn(help='`aws.networkmanager_global_networks.withTags` constructs a mixin object that can be merged into the `networkmanager_global_networks`\nTerraform data source block to set or update the tags field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
