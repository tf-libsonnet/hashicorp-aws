...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  statement:: {
    ...
    operation:: {
      ...
      '#new':: d.fn(help='\n`aws.cloudwatch_log_data_protection_policy_document.statement.operation.new` constructs a new object with attributes and blocks configured for the `operation`\nTerraform sub block.\n\n\n\n**Args**:\n  - `audit` (`list[obj]`):  When `null`, the `audit` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.cloudwatch_log_data_protection_policy_document.statement.operation.audit.new](#fn-operationauditnew) constructor.\n  - `deidentify` (`list[obj]`):  When `null`, the `deidentify` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.cloudwatch_log_data_protection_policy_document.statement.operation.deidentify.new](#fn-operationdeidentifynew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `operation` sub block.\n', args=[]),
      new(
        audit=null,
        deidentify=null
      ):: std.prune(a={
  ...
  '#withDescription':: d.fn(help='`aws.cloudwatch_log_data_protection_policy_document.withDescription` constructs a mixin object that can be merged into the `cloudwatch_log_data_protection_policy_document`\nTerraform data source block to set or update the description field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudwatch_log_data_protection_policy_document.withName` constructs a mixin object that can be merged into the `cloudwatch_log_data_protection_policy_document`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withStatement':: d.fn(help='`aws.cloudwatch_log_data_protection_policy_document.withStatement` constructs a mixin object that can be merged into the `cloudwatch_log_data_protection_policy_document`\nTerraform data source block to set or update the statement field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `statement` field.\n', args=[]),
  ...
  '#withStatementMixin':: d.fn(help='`aws.cloudwatch_log_data_protection_policy_document.withStatementMixin` constructs a mixin object that can be merged into the `cloudwatch_log_data_protection_policy_document`\nTerraform data source block to set or update the statement field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudwatch_log_data_protection_policy_document.withStatement](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `statement` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`aws.cloudwatch_log_data_protection_policy_document.withVersion` constructs a mixin object that can be merged into the `cloudwatch_log_data_protection_policy_document`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
