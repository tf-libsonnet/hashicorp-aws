...
{
  '#':: d.pkg(name='service_discovery_http_namespace', url='', help='`service_discovery_http_namespace` represents the `aws_service_discovery_http_namespace` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
