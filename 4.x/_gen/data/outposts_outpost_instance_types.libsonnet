...
{
  '#':: d.pkg(name='outposts_outpost_instance_types', url='', help='`outposts_outpost_instance_types` represents the `aws_outposts_outpost_instance_types` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.outposts_outpost_instance_types.withArn` constructs a mixin object that can be merged into the `outposts_outpost_instance_types`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
