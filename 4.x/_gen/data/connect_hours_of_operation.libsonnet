...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHoursOfOperationId':: d.fn(help='`aws.connect_hours_of_operation.withHoursOfOperationId` constructs a mixin object that can be merged into the `connect_hours_of_operation`\nTerraform data source block to set or update the hours_of_operation_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hours_of_operation_id` field.\n', args=[]),
