...
{
  '#':: d.pkg(name='ssoadmin_instances', url='', help='`ssoadmin_instances` represents the `aws_ssoadmin_instances` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
