...
{
  '#':: d.pkg(name='cognito_user_pools', url='', help='`cognito_user_pools` represents the `aws_cognito_user_pools` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.cognito_user_pools.withName` constructs a mixin object that can be merged into the `cognito_user_pools`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
