...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPath':: d.fn(help='`aws.ssm_parameters_by_path.withPath` constructs a mixin object that can be merged into the `ssm_parameters_by_path`\nTerraform data source block to set or update the path field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `path` field.\n', args=[]),
  ...
  '#withRecursive':: d.fn(help='`aws.ssm_parameters_by_path.withRecursive` constructs a mixin object that can be merged into the `ssm_parameters_by_path`\nTerraform data source block to set or update the recursive field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `recursive` field.\n', args=[]),
  ...
  '#withWithDecryption':: d.fn(help='`aws.ssm_parameters_by_path.withWithDecryption` constructs a mixin object that can be merged into the `ssm_parameters_by_path`\nTerraform data source block to set or update the with_decryption field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `with_decryption` field.\n', args=[]),
