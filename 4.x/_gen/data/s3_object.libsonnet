...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRange':: d.fn(help='`aws.s3_object.withRange` constructs a mixin object that can be merged into the `s3_object`\nTerraform data source block to set or update the range field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `range` field.\n', args=[]),
