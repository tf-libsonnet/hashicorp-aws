...
{
  '#':: d.pkg(name='iam_session_context', url='', help='`iam_session_context` represents the `aws_iam_session_context` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.iam_session_context.withArn` constructs a mixin object that can be merged into the `iam_session_context`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
