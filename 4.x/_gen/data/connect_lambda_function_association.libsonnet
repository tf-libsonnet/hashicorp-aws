...
{
  '#':: d.pkg(name='connect_lambda_function_association', url='', help='`connect_lambda_function_association` represents the `aws_connect_lambda_function_association` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withFunctionArn':: d.fn(help='`aws.connect_lambda_function_association.withFunctionArn` constructs a mixin object that can be merged into the `connect_lambda_function_association`\nTerraform data source block to set or update the function_arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `function_arn` field.\n', args=[]),
  ...
  '#withInstanceId':: d.fn(help='`aws.connect_lambda_function_association.withInstanceId` constructs a mixin object that can be merged into the `connect_lambda_function_association`\nTerraform data source block to set or update the instance_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_id` field.\n', args=[]),
