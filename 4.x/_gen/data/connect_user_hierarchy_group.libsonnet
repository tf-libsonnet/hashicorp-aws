...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHierarchyGroupId':: d.fn(help='`aws.connect_user_hierarchy_group.withHierarchyGroupId` constructs a mixin object that can be merged into the `connect_user_hierarchy_group`\nTerraform data source block to set or update the hierarchy_group_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hierarchy_group_id` field.\n', args=[]),
