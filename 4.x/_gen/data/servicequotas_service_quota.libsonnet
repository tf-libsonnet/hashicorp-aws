...
{
  '#':: d.pkg(name='servicequotas_service_quota', url='', help='`servicequotas_service_quota` represents the `aws_servicequotas_service_quota` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withQuotaCode':: d.fn(help='`aws.servicequotas_service_quota.withQuotaCode` constructs a mixin object that can be merged into the `servicequotas_service_quota`\nTerraform data source block to set or update the quota_code field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `quota_code` field.\n', args=[]),
  ...
  '#withQuotaName':: d.fn(help='`aws.servicequotas_service_quota.withQuotaName` constructs a mixin object that can be merged into the `servicequotas_service_quota`\nTerraform data source block to set or update the quota_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `quota_name` field.\n', args=[]),
  ...
  '#withServiceCode':: d.fn(help='`aws.servicequotas_service_quota.withServiceCode` constructs a mixin object that can be merged into the `servicequotas_service_quota`\nTerraform data source block to set or update the service_code field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_code` field.\n', args=[]),
