...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMountTargetId':: d.fn(help='`aws.efs_mount_target.withMountTargetId` constructs a mixin object that can be merged into the `efs_mount_target`\nTerraform data source block to set or update the mount_target_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mount_target_id` field.\n', args=[]),
