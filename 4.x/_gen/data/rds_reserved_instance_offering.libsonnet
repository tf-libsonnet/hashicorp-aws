...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDbInstanceClass':: d.fn(help='`aws.rds_reserved_instance_offering.withDbInstanceClass` constructs a mixin object that can be merged into the `rds_reserved_instance_offering`\nTerraform data source block to set or update the db_instance_class field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_instance_class` field.\n', args=[]),
  ...
  '#withDuration':: d.fn(help='`aws.rds_reserved_instance_offering.withDuration` constructs a mixin object that can be merged into the `rds_reserved_instance_offering`\nTerraform data source block to set or update the duration field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `duration` field.\n', args=[]),
  ...
  '#withMultiAz':: d.fn(help='`aws.rds_reserved_instance_offering.withMultiAz` constructs a mixin object that can be merged into the `rds_reserved_instance_offering`\nTerraform data source block to set or update the multi_az field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `multi_az` field.\n', args=[]),
  ...
  '#withOfferingType':: d.fn(help='`aws.rds_reserved_instance_offering.withOfferingType` constructs a mixin object that can be merged into the `rds_reserved_instance_offering`\nTerraform data source block to set or update the offering_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `offering_type` field.\n', args=[]),
  ...
  '#withProductDescription':: d.fn(help='`aws.rds_reserved_instance_offering.withProductDescription` constructs a mixin object that can be merged into the `rds_reserved_instance_offering`\nTerraform data source block to set or update the product_description field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `product_description` field.\n', args=[]),
