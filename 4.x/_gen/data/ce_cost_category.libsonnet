...
{
  '#':: d.pkg(name='ce_cost_category', url='', help='`ce_cost_category` represents the `aws_ce_cost_category` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
