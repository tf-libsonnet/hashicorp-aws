...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDnsSuffix':: d.fn(help='`aws.sagemaker_prebuilt_ecr_image.withDnsSuffix` constructs a mixin object that can be merged into the `sagemaker_prebuilt_ecr_image`\nTerraform data source block to set or update the dns_suffix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dns_suffix` field.\n', args=[]),
  ...
  '#withImageTag':: d.fn(help='`aws.sagemaker_prebuilt_ecr_image.withImageTag` constructs a mixin object that can be merged into the `sagemaker_prebuilt_ecr_image`\nTerraform data source block to set or update the image_tag field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `image_tag` field.\n', args=[]),
  ...
  '#withRegion':: d.fn(help='`aws.sagemaker_prebuilt_ecr_image.withRegion` constructs a mixin object that can be merged into the `sagemaker_prebuilt_ecr_image`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
  ...
  '#withRepositoryName':: d.fn(help='`aws.sagemaker_prebuilt_ecr_image.withRepositoryName` constructs a mixin object that can be merged into the `sagemaker_prebuilt_ecr_image`\nTerraform data source block to set or update the repository_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository_name` field.\n', args=[]),
