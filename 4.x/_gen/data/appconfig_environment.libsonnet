...
{
  '#':: d.pkg(name='appconfig_environment', url='', help='`appconfig_environment` represents the `aws_appconfig_environment` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withEnvironmentId':: d.fn(help='`aws.appconfig_environment.withEnvironmentId` constructs a mixin object that can be merged into the `appconfig_environment`\nTerraform data source block to set or update the environment_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `environment_id` field.\n', args=[]),
