...
{
  '#':: d.pkg(name='wafv2_rule_group', url='', help='`wafv2_rule_group` represents the `aws_wafv2_rule_group` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.wafv2_rule_group.withName` constructs a mixin object that can be merged into the `wafv2_rule_group`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScope':: d.fn(help='`aws.wafv2_rule_group.withScope` constructs a mixin object that can be merged into the `wafv2_rule_group`\nTerraform data source block to set or update the scope field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
