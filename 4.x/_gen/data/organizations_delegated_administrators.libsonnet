...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withServicePrincipal':: d.fn(help='`aws.organizations_delegated_administrators.withServicePrincipal` constructs a mixin object that can be merged into the `organizations_delegated_administrators`\nTerraform data source block to set or update the service_principal field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_principal` field.\n', args=[]),
