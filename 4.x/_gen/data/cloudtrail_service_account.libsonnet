...
{
  '#':: d.pkg(name='cloudtrail_service_account', url='', help='`cloudtrail_service_account` represents the `aws_cloudtrail_service_account` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withRegion':: d.fn(help='`aws.cloudtrail_service_account.withRegion` constructs a mixin object that can be merged into the `cloudtrail_service_account`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
