...
{
  '#':: d.pkg(name='mskconnect_connector', url='', help='`mskconnect_connector` represents the `aws_mskconnect_connector` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
