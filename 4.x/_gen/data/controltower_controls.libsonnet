...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withTargetIdentifier':: d.fn(help='`aws.controltower_controls.withTargetIdentifier` constructs a mixin object that can be merged into the `controltower_controls`\nTerraform data source block to set or update the target_identifier field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_identifier` field.\n', args=[]),
