...
{
  '#':: d.pkg(name='transfer_server', url='', help='`transfer_server` represents the `aws_transfer_server` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
