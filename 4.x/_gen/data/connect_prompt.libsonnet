...
{
  '#':: d.pkg(name='connect_prompt', url='', help='`connect_prompt` represents the `aws_connect_prompt` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.connect_prompt.withName` constructs a mixin object that can be merged into the `connect_prompt`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
