...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstanceId':: d.fn(help='`aws.connect_bot_association.withInstanceId` constructs a mixin object that can be merged into the `connect_bot_association`\nTerraform data source block to set or update the instance_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_id` field.\n', args=[]),
  ...
  '#withLexBot':: d.fn(help='`aws.connect_bot_association.withLexBot` constructs a mixin object that can be merged into the `connect_bot_association`\nTerraform data source block to set or update the lex_bot field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lex_bot` field.\n', args=[]),
  ...
  '#withLexBotMixin':: d.fn(help='`aws.connect_bot_association.withLexBotMixin` constructs a mixin object that can be merged into the `connect_bot_association`\nTerraform data source block to set or update the lex_bot field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.connect_bot_association.withLexBot](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lex_bot` field.\n', args=[]),
