...
{
  '#':: d.pkg(name='connect_bot_association', url='', help='`connect_bot_association` represents the `aws_connect_bot_association` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  lex_bot:: {
