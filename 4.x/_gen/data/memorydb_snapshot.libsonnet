...
{
  '#':: d.pkg(name='memorydb_snapshot', url='', help='`memorydb_snapshot` represents the `aws_memorydb_snapshot` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
