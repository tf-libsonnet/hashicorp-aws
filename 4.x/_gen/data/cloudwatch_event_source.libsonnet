...
{
  '#':: d.pkg(name='cloudwatch_event_source', url='', help='`cloudwatch_event_source` represents the `aws_cloudwatch_event_source` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withNamePrefix':: d.fn(help='`aws.cloudwatch_event_source.withNamePrefix` constructs a mixin object that can be merged into the `cloudwatch_event_source`\nTerraform data source block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
