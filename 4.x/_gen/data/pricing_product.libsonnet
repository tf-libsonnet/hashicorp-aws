...
{
  '#':: d.pkg(name='pricing_product', url='', help='`pricing_product` represents the `aws_pricing_product` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  filters:: {
  ...
  '#withFilters':: d.fn(help='`aws.pricing_product.withFilters` constructs a mixin object that can be merged into the `pricing_product`\nTerraform data source block to set or update the filters field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filters` field.\n', args=[]),
  ...
  '#withFiltersMixin':: d.fn(help='`aws.pricing_product.withFiltersMixin` constructs a mixin object that can be merged into the `pricing_product`\nTerraform data source block to set or update the filters field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.pricing_product.withFilters](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filters` field.\n', args=[]),
  ...
  '#withServiceCode':: d.fn(help='`aws.pricing_product.withServiceCode` constructs a mixin object that can be merged into the `pricing_product`\nTerraform data source block to set or update the service_code field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_code` field.\n', args=[]),
