...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKeyId':: d.fn(help='`aws.kms_public_key.withKeyId` constructs a mixin object that can be merged into the `kms_public_key`\nTerraform data source block to set or update the key_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_id` field.\n', args=[]),
