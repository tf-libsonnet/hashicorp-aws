...
{
  '#':: d.pkg(name='db_proxy', url='', help='`db_proxy` represents the `aws_db_proxy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
