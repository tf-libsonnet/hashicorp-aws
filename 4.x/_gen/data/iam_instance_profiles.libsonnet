...
{
  '#':: d.pkg(name='iam_instance_profiles', url='', help='`iam_instance_profiles` represents the `aws_iam_instance_profiles` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withRoleName':: d.fn(help='`aws.iam_instance_profiles.withRoleName` constructs a mixin object that can be merged into the `iam_instance_profiles`\nTerraform data source block to set or update the role_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_name` field.\n', args=[]),
