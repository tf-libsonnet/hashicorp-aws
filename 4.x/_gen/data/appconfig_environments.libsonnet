...
{
  '#':: d.pkg(name='appconfig_environments', url='', help='`appconfig_environments` represents the `aws_appconfig_environments` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withApplicationId':: d.fn(help='`aws.appconfig_environments.withApplicationId` constructs a mixin object that can be merged into the `appconfig_environments`\nTerraform data source block to set or update the application_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_id` field.\n', args=[]),
