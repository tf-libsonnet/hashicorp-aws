...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiId':: d.fn(help='`aws.apigatewayv2_export.withApiId` constructs a mixin object that can be merged into the `apigatewayv2_export`\nTerraform data source block to set or update the api_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_id` field.\n', args=[]),
  ...
  '#withExportVersion':: d.fn(help='`aws.apigatewayv2_export.withExportVersion` constructs a mixin object that can be merged into the `apigatewayv2_export`\nTerraform data source block to set or update the export_version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `export_version` field.\n', args=[]),
  ...
  '#withIncludeExtensions':: d.fn(help='`aws.apigatewayv2_export.withIncludeExtensions` constructs a mixin object that can be merged into the `apigatewayv2_export`\nTerraform data source block to set or update the include_extensions field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_extensions` field.\n', args=[]),
  ...
  '#withOutputType':: d.fn(help='`aws.apigatewayv2_export.withOutputType` constructs a mixin object that can be merged into the `apigatewayv2_export`\nTerraform data source block to set or update the output_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `output_type` field.\n', args=[]),
  ...
  '#withSpecification':: d.fn(help='`aws.apigatewayv2_export.withSpecification` constructs a mixin object that can be merged into the `apigatewayv2_export`\nTerraform data source block to set or update the specification field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `specification` field.\n', args=[]),
  ...
  '#withStageName':: d.fn(help='`aws.apigatewayv2_export.withStageName` constructs a mixin object that can be merged into the `apigatewayv2_export`\nTerraform data source block to set or update the stage_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage_name` field.\n', args=[]),
