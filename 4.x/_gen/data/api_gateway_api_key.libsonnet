...
{
  '#':: d.pkg(name='api_gateway_api_key', url='', help='`api_gateway_api_key` represents the `aws_api_gateway_api_key` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
