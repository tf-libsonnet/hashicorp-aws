...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFilter':: d.fn(help='`aws.route_table.withFilter` constructs a mixin object that can be merged into the `route_table`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.route_table.withFilterMixin` constructs a mixin object that can be merged into the `route_table`\nTerraform data source block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.route_table.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withGatewayId':: d.fn(help='`aws.route_table.withGatewayId` constructs a mixin object that can be merged into the `route_table`\nTerraform data source block to set or update the gateway_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway_id` field.\n', args=[]),
  ...
  '#withRouteTableId':: d.fn(help='`aws.route_table.withRouteTableId` constructs a mixin object that can be merged into the `route_table`\nTerraform data source block to set or update the route_table_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `route_table_id` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`aws.route_table.withSubnetId` constructs a mixin object that can be merged into the `route_table`\nTerraform data source block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
