...
{
  '#':: d.pkg(name='waf_subscribed_rule_group', url='', help='`waf_subscribed_rule_group` represents the `aws_waf_subscribed_rule_group` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withMetricName':: d.fn(help='`aws.waf_subscribed_rule_group.withMetricName` constructs a mixin object that can be merged into the `waf_subscribed_rule_group`\nTerraform data source block to set or update the metric_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metric_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.waf_subscribed_rule_group.withName` constructs a mixin object that can be merged into the `waf_subscribed_rule_group`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
