...
{
  '#':: d.pkg(name='iam_policy', url='', help='`iam_policy` represents the `aws_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.iam_policy.withArn` constructs a mixin object that can be merged into the `iam_policy`\nTerraform data source block to set or update the arn field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
  ...
  '#withPathPrefix':: d.fn(help='`aws.iam_policy.withPathPrefix` constructs a mixin object that can be merged into the `iam_policy`\nTerraform data source block to set or update the path_prefix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `path_prefix` field.\n', args=[]),
