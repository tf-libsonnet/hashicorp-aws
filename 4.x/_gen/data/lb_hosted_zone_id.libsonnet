...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLoadBalancerType':: d.fn(help='`aws.lb_hosted_zone_id.withLoadBalancerType` constructs a mixin object that can be merged into the `lb_hosted_zone_id`\nTerraform data source block to set or update the load_balancer_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load_balancer_type` field.\n', args=[]),
  ...
  '#withRegion':: d.fn(help='`aws.lb_hosted_zone_id.withRegion` constructs a mixin object that can be merged into the `lb_hosted_zone_id`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
