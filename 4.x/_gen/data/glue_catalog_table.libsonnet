...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withQueryAsOfTime':: d.fn(help='`aws.glue_catalog_table.withQueryAsOfTime` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform data source block to set or update the query_as_of_time field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `query_as_of_time` field.\n', args=[]),
  ...
  '#withTransactionId':: d.fn(help='`aws.glue_catalog_table.withTransactionId` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform data source block to set or update the transaction_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transaction_id` field.\n', args=[]),
