...
{
  '#':: d.pkg(name='organizations_delegated_services', url='', help='`organizations_delegated_services` represents the `aws_organizations_delegated_services` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withAccountId':: d.fn(help='`aws.organizations_delegated_services.withAccountId` constructs a mixin object that can be merged into the `organizations_delegated_services`\nTerraform data source block to set or update the account_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
