...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBgpAsn':: d.fn(help='`aws.ec2_transit_gateway_connect_peer.withBgpAsn` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect_peer`\nTerraform resource block to set or update the bgp_asn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bgp_asn` field.\n', args=[]),
  ...
  '#withInsideCidrBlocks':: d.fn(help='`aws.ec2_transit_gateway_connect_peer.withInsideCidrBlocks` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect_peer`\nTerraform resource block to set or update the inside_cidr_blocks field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `inside_cidr_blocks` field.\n', args=[]),
  ...
  '#withPeerAddress':: d.fn(help='`aws.ec2_transit_gateway_connect_peer.withPeerAddress` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect_peer`\nTerraform resource block to set or update the peer_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `peer_address` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ec2_transit_gateway_connect_peer.withTagsAll` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect_peer`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTransitGatewayAddress':: d.fn(help='`aws.ec2_transit_gateway_connect_peer.withTransitGatewayAddress` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect_peer`\nTerraform resource block to set or update the transit_gateway_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_address` field.\n', args=[]),
  ...
  '#withTransitGatewayAttachmentId':: d.fn(help='`aws.ec2_transit_gateway_connect_peer.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_connect_peer`\nTerraform resource block to set or update the transit_gateway_attachment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_attachment_id` field.\n', args=[]),
