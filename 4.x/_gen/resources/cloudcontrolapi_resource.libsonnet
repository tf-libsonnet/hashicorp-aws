...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDesiredState':: d.fn(help='`aws.cloudcontrolapi_resource.withDesiredState` constructs a mixin object that can be merged into the `cloudcontrolapi_resource`\nTerraform resource block to set or update the desired_state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `desired_state` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.cloudcontrolapi_resource.withRoleArn` constructs a mixin object that can be merged into the `cloudcontrolapi_resource`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
  ...
  '#withSchema':: d.fn(help='`aws.cloudcontrolapi_resource.withSchema` constructs a mixin object that can be merged into the `cloudcontrolapi_resource`\nTerraform resource block to set or update the schema field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schema` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.cloudcontrolapi_resource.withTimeouts` constructs a mixin object that can be merged into the `cloudcontrolapi_resource`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.cloudcontrolapi_resource.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudcontrolapi_resource`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.cloudcontrolapi_resource.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTypeName':: d.fn(help='`aws.cloudcontrolapi_resource.withTypeName` constructs a mixin object that can be merged into the `cloudcontrolapi_resource`\nTerraform resource block to set or update the type_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type_name` field.\n', args=[]),
  ...
  '#withTypeVersionId':: d.fn(help='`aws.cloudcontrolapi_resource.withTypeVersionId` constructs a mixin object that can be merged into the `cloudcontrolapi_resource`\nTerraform resource block to set or update the type_version_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type_version_id` field.\n', args=[]),
