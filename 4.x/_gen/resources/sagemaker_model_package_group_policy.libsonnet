...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withModelPackageGroupName':: d.fn(help='`aws.sagemaker_model_package_group_policy.withModelPackageGroupName` constructs a mixin object that can be merged into the `sagemaker_model_package_group_policy`\nTerraform resource block to set or update the model_package_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `model_package_group_name` field.\n', args=[]),
  ...
  '#withResourcePolicy':: d.fn(help='`aws.sagemaker_model_package_group_policy.withResourcePolicy` constructs a mixin object that can be merged into the `sagemaker_model_package_group_policy`\nTerraform resource block to set or update the resource_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_policy` field.\n', args=[]),
