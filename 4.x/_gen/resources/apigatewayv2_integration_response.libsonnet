...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiId':: d.fn(help='`aws.apigatewayv2_integration_response.withApiId` constructs a mixin object that can be merged into the `apigatewayv2_integration_response`\nTerraform resource block to set or update the api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_id` field.\n', args=[]),
  ...
  '#withContentHandlingStrategy':: d.fn(help='`aws.apigatewayv2_integration_response.withContentHandlingStrategy` constructs a mixin object that can be merged into the `apigatewayv2_integration_response`\nTerraform resource block to set or update the content_handling_strategy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content_handling_strategy` field.\n', args=[]),
  ...
  '#withIntegrationId':: d.fn(help='`aws.apigatewayv2_integration_response.withIntegrationId` constructs a mixin object that can be merged into the `apigatewayv2_integration_response`\nTerraform resource block to set or update the integration_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `integration_id` field.\n', args=[]),
  ...
  '#withIntegrationResponseKey':: d.fn(help='`aws.apigatewayv2_integration_response.withIntegrationResponseKey` constructs a mixin object that can be merged into the `apigatewayv2_integration_response`\nTerraform resource block to set or update the integration_response_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `integration_response_key` field.\n', args=[]),
  ...
  '#withResponseTemplates':: d.fn(help='`aws.apigatewayv2_integration_response.withResponseTemplates` constructs a mixin object that can be merged into the `apigatewayv2_integration_response`\nTerraform resource block to set or update the response_templates field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `response_templates` field.\n', args=[]),
  ...
  '#withTemplateSelectionExpression':: d.fn(help='`aws.apigatewayv2_integration_response.withTemplateSelectionExpression` constructs a mixin object that can be merged into the `apigatewayv2_integration_response`\nTerraform resource block to set or update the template_selection_expression field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_selection_expression` field.\n', args=[]),
