...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGeoMatchConstraint':: d.fn(help='`aws.waf_geo_match_set.withGeoMatchConstraint` constructs a mixin object that can be merged into the `waf_geo_match_set`\nTerraform resource block to set or update the geo_match_constraint field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `geo_match_constraint` field.\n', args=[]),
  ...
  '#withGeoMatchConstraintMixin':: d.fn(help='`aws.waf_geo_match_set.withGeoMatchConstraintMixin` constructs a mixin object that can be merged into the `waf_geo_match_set`\nTerraform resource block to set or update the geo_match_constraint field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.waf_geo_match_set.withGeoMatchConstraint](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `geo_match_constraint` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.waf_geo_match_set.withName` constructs a mixin object that can be merged into the `waf_geo_match_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
