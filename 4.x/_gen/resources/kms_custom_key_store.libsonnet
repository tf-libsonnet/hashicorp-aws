...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCloudHsmClusterId':: d.fn(help='`aws.kms_custom_key_store.withCloudHsmClusterId` constructs a mixin object that can be merged into the `kms_custom_key_store`\nTerraform resource block to set or update the cloud_hsm_cluster_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cloud_hsm_cluster_id` field.\n', args=[]),
  ...
  '#withKeyStorePassword':: d.fn(help='`aws.kms_custom_key_store.withKeyStorePassword` constructs a mixin object that can be merged into the `kms_custom_key_store`\nTerraform resource block to set or update the key_store_password field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_store_password` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.kms_custom_key_store.withTimeouts` constructs a mixin object that can be merged into the `kms_custom_key_store`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.kms_custom_key_store.withTimeoutsMixin` constructs a mixin object that can be merged into the `kms_custom_key_store`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.kms_custom_key_store.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTrustAnchorCertificate':: d.fn(help='`aws.kms_custom_key_store.withTrustAnchorCertificate` constructs a mixin object that can be merged into the `kms_custom_key_store`\nTerraform resource block to set or update the trust_anchor_certificate field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `trust_anchor_certificate` field.\n', args=[]),
