...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withUserGroupId':: d.fn(help='`aws.elasticache_user_group_association.withUserGroupId` constructs a mixin object that can be merged into the `elasticache_user_group_association`\nTerraform resource block to set or update the user_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_group_id` field.\n', args=[]),
  ...
  '#withUserId':: d.fn(help='`aws.elasticache_user_group_association.withUserId` constructs a mixin object that can be merged into the `elasticache_user_group_association`\nTerraform resource block to set or update the user_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_id` field.\n', args=[]),
