...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKmsKeyId':: d.fn(help='`aws.db_instance_automated_backups_replication.withKmsKeyId` constructs a mixin object that can be merged into the `db_instance_automated_backups_replication`\nTerraform resource block to set or update the kms_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_id` field.\n', args=[]),
  ...
  '#withPreSignedUrl':: d.fn(help='`aws.db_instance_automated_backups_replication.withPreSignedUrl` constructs a mixin object that can be merged into the `db_instance_automated_backups_replication`\nTerraform resource block to set or update the pre_signed_url field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `pre_signed_url` field.\n', args=[]),
  ...
  '#withRetentionPeriod':: d.fn(help='`aws.db_instance_automated_backups_replication.withRetentionPeriod` constructs a mixin object that can be merged into the `db_instance_automated_backups_replication`\nTerraform resource block to set or update the retention_period field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention_period` field.\n', args=[]),
  ...
  '#withSourceDbInstanceArn':: d.fn(help='`aws.db_instance_automated_backups_replication.withSourceDbInstanceArn` constructs a mixin object that can be merged into the `db_instance_automated_backups_replication`\nTerraform resource block to set or update the source_db_instance_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_db_instance_arn` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.db_instance_automated_backups_replication.withTimeouts` constructs a mixin object that can be merged into the `db_instance_automated_backups_replication`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.db_instance_automated_backups_replication.withTimeoutsMixin` constructs a mixin object that can be merged into the `db_instance_automated_backups_replication`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.db_instance_automated_backups_replication.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
