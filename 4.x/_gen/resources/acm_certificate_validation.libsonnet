...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateArn':: d.fn(help='`aws.acm_certificate_validation.withCertificateArn` constructs a mixin object that can be merged into the `acm_certificate_validation`\nTerraform resource block to set or update the certificate_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_arn` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.acm_certificate_validation.withTimeouts` constructs a mixin object that can be merged into the `acm_certificate_validation`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.acm_certificate_validation.withTimeoutsMixin` constructs a mixin object that can be merged into the `acm_certificate_validation`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.acm_certificate_validation.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withValidationRecordFqdns':: d.fn(help='`aws.acm_certificate_validation.withValidationRecordFqdns` constructs a mixin object that can be merged into the `acm_certificate_validation`\nTerraform resource block to set or update the validation_record_fqdns field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `validation_record_fqdns` field.\n', args=[]),
