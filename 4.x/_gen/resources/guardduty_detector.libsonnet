...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDatasources':: d.fn(help='`aws.guardduty_detector.withDatasources` constructs a mixin object that can be merged into the `guardduty_detector`\nTerraform resource block to set or update the datasources field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `datasources` field.\n', args=[]),
  ...
  '#withDatasourcesMixin':: d.fn(help='`aws.guardduty_detector.withDatasourcesMixin` constructs a mixin object that can be merged into the `guardduty_detector`\nTerraform resource block to set or update the datasources field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.guardduty_detector.withDatasources](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `datasources` field.\n', args=[]),
  ...
  '#withEnable':: d.fn(help='`aws.guardduty_detector.withEnable` constructs a mixin object that can be merged into the `guardduty_detector`\nTerraform resource block to set or update the enable field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable` field.\n', args=[]),
  ...
  '#withFindingPublishingFrequency':: d.fn(help='`aws.guardduty_detector.withFindingPublishingFrequency` constructs a mixin object that can be merged into the `guardduty_detector`\nTerraform resource block to set or update the finding_publishing_frequency field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `finding_publishing_frequency` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.guardduty_detector.withTags` constructs a mixin object that can be merged into the `guardduty_detector`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.guardduty_detector.withTagsAll` constructs a mixin object that can be merged into the `guardduty_detector`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
