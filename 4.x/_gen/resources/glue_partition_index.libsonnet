...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCatalogId':: d.fn(help='`aws.glue_partition_index.withCatalogId` constructs a mixin object that can be merged into the `glue_partition_index`\nTerraform resource block to set or update the catalog_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `catalog_id` field.\n', args=[]),
  ...
  '#withDatabaseName':: d.fn(help='`aws.glue_partition_index.withDatabaseName` constructs a mixin object that can be merged into the `glue_partition_index`\nTerraform resource block to set or update the database_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database_name` field.\n', args=[]),
  ...
  '#withPartitionIndex':: d.fn(help='`aws.glue_partition_index.withPartitionIndex` constructs a mixin object that can be merged into the `glue_partition_index`\nTerraform resource block to set or update the partition_index field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_index` field.\n', args=[]),
  ...
  '#withPartitionIndexMixin':: d.fn(help='`aws.glue_partition_index.withPartitionIndexMixin` constructs a mixin object that can be merged into the `glue_partition_index`\nTerraform resource block to set or update the partition_index field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_partition_index.withPartitionIndex](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_index` field.\n', args=[]),
  ...
  '#withTableName':: d.fn(help='`aws.glue_partition_index.withTableName` constructs a mixin object that can be merged into the `glue_partition_index`\nTerraform resource block to set or update the table_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.glue_partition_index.withTimeouts` constructs a mixin object that can be merged into the `glue_partition_index`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.glue_partition_index.withTimeoutsMixin` constructs a mixin object that can be merged into the `glue_partition_index`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.glue_partition_index.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
