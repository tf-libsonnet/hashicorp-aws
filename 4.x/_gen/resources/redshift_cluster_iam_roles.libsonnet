...
{
  '#':: d.pkg(name='redshift_cluster_iam_roles', url='', help='`redshift_cluster_iam_roles` represents the `aws_redshift_cluster_iam_roles` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withClusterIdentifier':: d.fn(help='`aws.redshift_cluster_iam_roles.withClusterIdentifier` constructs a mixin object that can be merged into the `redshift_cluster_iam_roles`\nTerraform resource block to set or update the cluster_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_identifier` field.\n', args=[]),
  ...
  '#withDefaultIamRoleArn':: d.fn(help='`aws.redshift_cluster_iam_roles.withDefaultIamRoleArn` constructs a mixin object that can be merged into the `redshift_cluster_iam_roles`\nTerraform resource block to set or update the default_iam_role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_iam_role_arn` field.\n', args=[]),
  ...
  '#withIamRoleArns':: d.fn(help='`aws.redshift_cluster_iam_roles.withIamRoleArns` constructs a mixin object that can be merged into the `redshift_cluster_iam_roles`\nTerraform resource block to set or update the iam_role_arns field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `iam_role_arns` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.redshift_cluster_iam_roles.withTimeouts` constructs a mixin object that can be merged into the `redshift_cluster_iam_roles`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.redshift_cluster_iam_roles.withTimeoutsMixin` constructs a mixin object that can be merged into the `redshift_cluster_iam_roles`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.redshift_cluster_iam_roles.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
