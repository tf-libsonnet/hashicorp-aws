...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.sagemaker_image.withDescription` constructs a mixin object that can be merged into the `sagemaker_image`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`aws.sagemaker_image.withDisplayName` constructs a mixin object that can be merged into the `sagemaker_image`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withImageName':: d.fn(help='`aws.sagemaker_image.withImageName` constructs a mixin object that can be merged into the `sagemaker_image`\nTerraform resource block to set or update the image_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `image_name` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.sagemaker_image.withRoleArn` constructs a mixin object that can be merged into the `sagemaker_image`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.sagemaker_image.withTags` constructs a mixin object that can be merged into the `sagemaker_image`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.sagemaker_image.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_image`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
