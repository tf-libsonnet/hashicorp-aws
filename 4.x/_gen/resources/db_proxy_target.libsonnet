...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDbClusterIdentifier':: d.fn(help='`aws.db_proxy_target.withDbClusterIdentifier` constructs a mixin object that can be merged into the `db_proxy_target`\nTerraform resource block to set or update the db_cluster_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_cluster_identifier` field.\n', args=[]),
  ...
  '#withDbInstanceIdentifier':: d.fn(help='`aws.db_proxy_target.withDbInstanceIdentifier` constructs a mixin object that can be merged into the `db_proxy_target`\nTerraform resource block to set or update the db_instance_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_instance_identifier` field.\n', args=[]),
  ...
  '#withDbProxyName':: d.fn(help='`aws.db_proxy_target.withDbProxyName` constructs a mixin object that can be merged into the `db_proxy_target`\nTerraform resource block to set or update the db_proxy_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_proxy_name` field.\n', args=[]),
  ...
  '#withTargetGroupName':: d.fn(help='`aws.db_proxy_target.withTargetGroupName` constructs a mixin object that can be merged into the `db_proxy_target`\nTerraform resource block to set or update the target_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_group_name` field.\n', args=[]),
