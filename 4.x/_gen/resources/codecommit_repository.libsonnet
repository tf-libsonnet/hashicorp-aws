...
{
  '#':: d.pkg(name='codecommit_repository', url='', help='`codecommit_repository` represents the `aws_codecommit_repository` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDefaultBranch':: d.fn(help='`aws.codecommit_repository.withDefaultBranch` constructs a mixin object that can be merged into the `codecommit_repository`\nTerraform resource block to set or update the default_branch field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_branch` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.codecommit_repository.withDescription` constructs a mixin object that can be merged into the `codecommit_repository`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withRepositoryName':: d.fn(help='`aws.codecommit_repository.withRepositoryName` constructs a mixin object that can be merged into the `codecommit_repository`\nTerraform resource block to set or update the repository_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.codecommit_repository.withTags` constructs a mixin object that can be merged into the `codecommit_repository`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.codecommit_repository.withTagsAll` constructs a mixin object that can be merged into the `codecommit_repository`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
