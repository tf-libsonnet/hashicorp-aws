...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCallingRegions':: d.fn(help='`aws.chime_voice_connector_termination.withCallingRegions` constructs a mixin object that can be merged into the `chime_voice_connector_termination`\nTerraform resource block to set or update the calling_regions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `calling_regions` field.\n', args=[]),
  ...
  '#withCidrAllowList':: d.fn(help='`aws.chime_voice_connector_termination.withCidrAllowList` constructs a mixin object that can be merged into the `chime_voice_connector_termination`\nTerraform resource block to set or update the cidr_allow_list field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cidr_allow_list` field.\n', args=[]),
  ...
  '#withCpsLimit':: d.fn(help='`aws.chime_voice_connector_termination.withCpsLimit` constructs a mixin object that can be merged into the `chime_voice_connector_termination`\nTerraform resource block to set or update the cps_limit field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cps_limit` field.\n', args=[]),
  ...
  '#withDefaultPhoneNumber':: d.fn(help='`aws.chime_voice_connector_termination.withDefaultPhoneNumber` constructs a mixin object that can be merged into the `chime_voice_connector_termination`\nTerraform resource block to set or update the default_phone_number field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_phone_number` field.\n', args=[]),
  ...
  '#withDisabled':: d.fn(help='`aws.chime_voice_connector_termination.withDisabled` constructs a mixin object that can be merged into the `chime_voice_connector_termination`\nTerraform resource block to set or update the disabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disabled` field.\n', args=[]),
  ...
  '#withVoiceConnectorId':: d.fn(help='`aws.chime_voice_connector_termination.withVoiceConnectorId` constructs a mixin object that can be merged into the `chime_voice_connector_termination`\nTerraform resource block to set or update the voice_connector_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `voice_connector_id` field.\n', args=[]),
