...
{
  '#':: d.pkg(name='iot_policy_attachment', url='', help='`iot_policy_attachment` represents the `aws_iot_policy_attachment` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPolicy':: d.fn(help='`aws.iot_policy_attachment.withPolicy` constructs a mixin object that can be merged into the `iot_policy_attachment`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withTarget':: d.fn(help='`aws.iot_policy_attachment.withTarget` constructs a mixin object that can be merged into the `iot_policy_attachment`\nTerraform resource block to set or update the target field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target` field.\n', args=[]),
