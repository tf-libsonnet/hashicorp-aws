...
{
  '#':: d.pkg(name='ec2_transit_gateway_route_table_association', url='', help='`ec2_transit_gateway_route_table_association` represents the `aws_ec2_transit_gateway_route_table_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withTransitGatewayAttachmentId':: d.fn(help='`aws.ec2_transit_gateway_route_table_association.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_route_table_association`\nTerraform resource block to set or update the transit_gateway_attachment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_attachment_id` field.\n', args=[]),
  ...
  '#withTransitGatewayRouteTableId':: d.fn(help='`aws.ec2_transit_gateway_route_table_association.withTransitGatewayRouteTableId` constructs a mixin object that can be merged into the `ec2_transit_gateway_route_table_association`\nTerraform resource block to set or update the transit_gateway_route_table_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_route_table_id` field.\n', args=[]),
