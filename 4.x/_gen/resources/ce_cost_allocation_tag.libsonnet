...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStatus':: d.fn(help='`aws.ce_cost_allocation_tag.withStatus` constructs a mixin object that can be merged into the `ce_cost_allocation_tag`\nTerraform resource block to set or update the status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
  ...
  '#withTagKey':: d.fn(help='`aws.ce_cost_allocation_tag.withTagKey` constructs a mixin object that can be merged into the `ce_cost_allocation_tag`\nTerraform resource block to set or update the tag_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag_key` field.\n', args=[]),
