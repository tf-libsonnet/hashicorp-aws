...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEcrRepositoryPrefix':: d.fn(help='`aws.ecr_pull_through_cache_rule.withEcrRepositoryPrefix` constructs a mixin object that can be merged into the `ecr_pull_through_cache_rule`\nTerraform resource block to set or update the ecr_repository_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ecr_repository_prefix` field.\n', args=[]),
  ...
  '#withUpstreamRegistryUrl':: d.fn(help='`aws.ecr_pull_through_cache_rule.withUpstreamRegistryUrl` constructs a mixin object that can be merged into the `ecr_pull_through_cache_rule`\nTerraform resource block to set or update the upstream_registry_url field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `upstream_registry_url` field.\n', args=[]),
