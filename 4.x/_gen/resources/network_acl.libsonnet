...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIngress':: d.fn(help='`aws.network_acl.withIngress` constructs a mixin object that can be merged into the `network_acl`\nTerraform resource block to set or update the ingress field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ingress` field.\n', args=[]),
  ...
  '#withSubnetIds':: d.fn(help='`aws.network_acl.withSubnetIds` constructs a mixin object that can be merged into the `network_acl`\nTerraform resource block to set or update the subnet_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_ids` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.network_acl.withTags` constructs a mixin object that can be merged into the `network_acl`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.network_acl.withTagsAll` constructs a mixin object that can be merged into the `network_acl`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withVpcId':: d.fn(help='`aws.network_acl.withVpcId` constructs a mixin object that can be merged into the `network_acl`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
