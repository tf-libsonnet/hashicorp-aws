...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucket':: d.fn(help='`aws.s3_bucket_logging.withBucket` constructs a mixin object that can be merged into the `s3_bucket_logging`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withExpectedBucketOwner':: d.fn(help='`aws.s3_bucket_logging.withExpectedBucketOwner` constructs a mixin object that can be merged into the `s3_bucket_logging`\nTerraform resource block to set or update the expected_bucket_owner field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expected_bucket_owner` field.\n', args=[]),
  ...
  '#withTargetBucket':: d.fn(help='`aws.s3_bucket_logging.withTargetBucket` constructs a mixin object that can be merged into the `s3_bucket_logging`\nTerraform resource block to set or update the target_bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_bucket` field.\n', args=[]),
  ...
  '#withTargetGrant':: d.fn(help='`aws.s3_bucket_logging.withTargetGrant` constructs a mixin object that can be merged into the `s3_bucket_logging`\nTerraform resource block to set or update the target_grant field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_grant` field.\n', args=[]),
  ...
  '#withTargetGrantMixin':: d.fn(help='`aws.s3_bucket_logging.withTargetGrantMixin` constructs a mixin object that can be merged into the `s3_bucket_logging`\nTerraform resource block to set or update the target_grant field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3_bucket_logging.withTargetGrant](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_grant` field.\n', args=[]),
  ...
  '#withTargetPrefix':: d.fn(help='`aws.s3_bucket_logging.withTargetPrefix` constructs a mixin object that can be merged into the `s3_bucket_logging`\nTerraform resource block to set or update the target_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_prefix` field.\n', args=[]),
