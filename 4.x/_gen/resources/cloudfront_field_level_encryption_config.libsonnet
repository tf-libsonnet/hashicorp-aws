...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withComment':: d.fn(help='`aws.cloudfront_field_level_encryption_config.withComment` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_config`\nTerraform resource block to set or update the comment field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `comment` field.\n', args=[]),
  ...
  '#withContentTypeProfileConfig':: d.fn(help='`aws.cloudfront_field_level_encryption_config.withContentTypeProfileConfig` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_config`\nTerraform resource block to set or update the content_type_profile_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content_type_profile_config` field.\n', args=[]),
  ...
  '#withContentTypeProfileConfigMixin':: d.fn(help='`aws.cloudfront_field_level_encryption_config.withContentTypeProfileConfigMixin` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_config`\nTerraform resource block to set or update the content_type_profile_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudfront_field_level_encryption_config.withContentTypeProfileConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content_type_profile_config` field.\n', args=[]),
  ...
  '#withQueryArgProfileConfig':: d.fn(help='`aws.cloudfront_field_level_encryption_config.withQueryArgProfileConfig` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_config`\nTerraform resource block to set or update the query_arg_profile_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `query_arg_profile_config` field.\n', args=[]),
  ...
  '#withQueryArgProfileConfigMixin':: d.fn(help='`aws.cloudfront_field_level_encryption_config.withQueryArgProfileConfigMixin` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_config`\nTerraform resource block to set or update the query_arg_profile_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudfront_field_level_encryption_config.withQueryArgProfileConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `query_arg_profile_config` field.\n', args=[]),
