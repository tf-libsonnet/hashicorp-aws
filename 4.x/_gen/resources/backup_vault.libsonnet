...
{
  '#':: d.pkg(name='backup_vault', url='', help='`backup_vault` represents the `aws_backup_vault` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withForceDestroy':: d.fn(help='`aws.backup_vault.withForceDestroy` constructs a mixin object that can be merged into the `backup_vault`\nTerraform resource block to set or update the force_destroy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `force_destroy` field.\n', args=[]),
  ...
  '#withKmsKeyArn':: d.fn(help='`aws.backup_vault.withKmsKeyArn` constructs a mixin object that can be merged into the `backup_vault`\nTerraform resource block to set or update the kms_key_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_arn` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.backup_vault.withTagsAll` constructs a mixin object that can be merged into the `backup_vault`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.backup_vault.withTimeouts` constructs a mixin object that can be merged into the `backup_vault`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.backup_vault.withTimeoutsMixin` constructs a mixin object that can be merged into the `backup_vault`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.backup_vault.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
