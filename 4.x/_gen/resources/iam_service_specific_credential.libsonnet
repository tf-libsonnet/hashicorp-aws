...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withServiceName':: d.fn(help='`aws.iam_service_specific_credential.withServiceName` constructs a mixin object that can be merged into the `iam_service_specific_credential`\nTerraform resource block to set or update the service_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_name` field.\n', args=[]),
  ...
  '#withStatus':: d.fn(help='`aws.iam_service_specific_credential.withStatus` constructs a mixin object that can be merged into the `iam_service_specific_credential`\nTerraform resource block to set or update the status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
  ...
  '#withUserName':: d.fn(help='`aws.iam_service_specific_credential.withUserName` constructs a mixin object that can be merged into the `iam_service_specific_credential`\nTerraform resource block to set or update the user_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_name` field.\n', args=[]),
