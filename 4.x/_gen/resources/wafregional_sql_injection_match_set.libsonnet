...
{
  '#':: d.pkg(name='wafregional_sql_injection_match_set', url='', help='`wafregional_sql_injection_match_set` represents the `aws_wafregional_sql_injection_match_set` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.wafregional_sql_injection_match_set.withName` constructs a mixin object that can be merged into the `wafregional_sql_injection_match_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSqlInjectionMatchTuple':: d.fn(help='`aws.wafregional_sql_injection_match_set.withSqlInjectionMatchTuple` constructs a mixin object that can be merged into the `wafregional_sql_injection_match_set`\nTerraform resource block to set or update the sql_injection_match_tuple field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sql_injection_match_tuple` field.\n', args=[]),
  ...
  '#withSqlInjectionMatchTupleMixin':: d.fn(help='`aws.wafregional_sql_injection_match_set.withSqlInjectionMatchTupleMixin` constructs a mixin object that can be merged into the `wafregional_sql_injection_match_set`\nTerraform resource block to set or update the sql_injection_match_tuple field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.wafregional_sql_injection_match_set.withSqlInjectionMatchTuple](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sql_injection_match_tuple` field.\n', args=[]),
