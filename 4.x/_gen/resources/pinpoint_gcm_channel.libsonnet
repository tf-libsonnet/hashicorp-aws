...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiKey':: d.fn(help='`aws.pinpoint_gcm_channel.withApiKey` constructs a mixin object that can be merged into the `pinpoint_gcm_channel`\nTerraform resource block to set or update the api_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_key` field.\n', args=[]),
  ...
  '#withApplicationId':: d.fn(help='`aws.pinpoint_gcm_channel.withApplicationId` constructs a mixin object that can be merged into the `pinpoint_gcm_channel`\nTerraform resource block to set or update the application_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_id` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`aws.pinpoint_gcm_channel.withEnabled` constructs a mixin object that can be merged into the `pinpoint_gcm_channel`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
