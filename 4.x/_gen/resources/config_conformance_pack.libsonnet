...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeliveryS3Bucket':: d.fn(help='`aws.config_conformance_pack.withDeliveryS3Bucket` constructs a mixin object that can be merged into the `config_conformance_pack`\nTerraform resource block to set or update the delivery_s3_bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delivery_s3_bucket` field.\n', args=[]),
  ...
  '#withDeliveryS3KeyPrefix':: d.fn(help='`aws.config_conformance_pack.withDeliveryS3KeyPrefix` constructs a mixin object that can be merged into the `config_conformance_pack`\nTerraform resource block to set or update the delivery_s3_key_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delivery_s3_key_prefix` field.\n', args=[]),
  ...
  '#withInputParameter':: d.fn(help='`aws.config_conformance_pack.withInputParameter` constructs a mixin object that can be merged into the `config_conformance_pack`\nTerraform resource block to set or update the input_parameter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `input_parameter` field.\n', args=[]),
  ...
  '#withInputParameterMixin':: d.fn(help='`aws.config_conformance_pack.withInputParameterMixin` constructs a mixin object that can be merged into the `config_conformance_pack`\nTerraform resource block to set or update the input_parameter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.config_conformance_pack.withInputParameter](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `input_parameter` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.config_conformance_pack.withName` constructs a mixin object that can be merged into the `config_conformance_pack`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTemplateBody':: d.fn(help='`aws.config_conformance_pack.withTemplateBody` constructs a mixin object that can be merged into the `config_conformance_pack`\nTerraform resource block to set or update the template_body field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_body` field.\n', args=[]),
  ...
  '#withTemplateS3Uri':: d.fn(help='`aws.config_conformance_pack.withTemplateS3Uri` constructs a mixin object that can be merged into the `config_conformance_pack`\nTerraform resource block to set or update the template_s3_uri field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_s3_uri` field.\n', args=[]),
