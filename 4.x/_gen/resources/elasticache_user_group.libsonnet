...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withArn':: d.fn(help='`aws.elasticache_user_group.withArn` constructs a mixin object that can be merged into the `elasticache_user_group`\nTerraform resource block to set or update the arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
  ...
  '#withEngine':: d.fn(help='`aws.elasticache_user_group.withEngine` constructs a mixin object that can be merged into the `elasticache_user_group`\nTerraform resource block to set or update the engine field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `engine` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.elasticache_user_group.withTags` constructs a mixin object that can be merged into the `elasticache_user_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.elasticache_user_group.withTagsAll` constructs a mixin object that can be merged into the `elasticache_user_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withUserGroupId':: d.fn(help='`aws.elasticache_user_group.withUserGroupId` constructs a mixin object that can be merged into the `elasticache_user_group`\nTerraform resource block to set or update the user_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_group_id` field.\n', args=[]),
  ...
  '#withUserIds':: d.fn(help='`aws.elasticache_user_group.withUserIds` constructs a mixin object that can be merged into the `elasticache_user_group`\nTerraform resource block to set or update the user_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_ids` field.\n', args=[]),
