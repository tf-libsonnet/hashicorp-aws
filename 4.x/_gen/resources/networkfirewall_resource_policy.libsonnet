...
{
  '#':: d.pkg(name='networkfirewall_resource_policy', url='', help='`networkfirewall_resource_policy` represents the `aws_networkfirewall_resource_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPolicy':: d.fn(help='`aws.networkfirewall_resource_policy.withPolicy` constructs a mixin object that can be merged into the `networkfirewall_resource_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withResourceArn':: d.fn(help='`aws.networkfirewall_resource_policy.withResourceArn` constructs a mixin object that can be merged into the `networkfirewall_resource_policy`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
