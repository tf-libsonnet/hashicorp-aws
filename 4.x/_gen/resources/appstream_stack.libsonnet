...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    streaming_experience_settings=null,
    tags=null,
    tags_all=null,
    user_settings=null,
    _meta={}
  ...
  '#withStreamingExperienceSettingsMixin':: d.fn(help='`aws.list[obj].withStreamingExperienceSettingsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the streaming_experience_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withStreamingExperienceSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `streaming_experience_settings` field.\n', args=[]),
  withStreamingExperienceSettingsMixin(resourceLabel, value): {
    resource+: {
      aws_appstream_stack+: {
        [resourceLabel]+: {
          streaming_experience_settings+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
