...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiId':: d.fn(help='`aws.api_gateway_base_path_mapping.withApiId` constructs a mixin object that can be merged into the `api_gateway_base_path_mapping`\nTerraform resource block to set or update the api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_id` field.\n', args=[]),
  ...
  '#withBasePath':: d.fn(help='`aws.api_gateway_base_path_mapping.withBasePath` constructs a mixin object that can be merged into the `api_gateway_base_path_mapping`\nTerraform resource block to set or update the base_path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `base_path` field.\n', args=[]),
  ...
  '#withDomainName':: d.fn(help='`aws.api_gateway_base_path_mapping.withDomainName` constructs a mixin object that can be merged into the `api_gateway_base_path_mapping`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withStageName':: d.fn(help='`aws.api_gateway_base_path_mapping.withStageName` constructs a mixin object that can be merged into the `api_gateway_base_path_mapping`\nTerraform resource block to set or update the stage_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage_name` field.\n', args=[]),
