...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroupIds':: d.fn(help='`aws.grafana_role_association.withGroupIds` constructs a mixin object that can be merged into the `grafana_role_association`\nTerraform resource block to set or update the group_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_ids` field.\n', args=[]),
  ...
  '#withRole':: d.fn(help='`aws.grafana_role_association.withRole` constructs a mixin object that can be merged into the `grafana_role_association`\nTerraform resource block to set or update the role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.grafana_role_association.withTimeouts` constructs a mixin object that can be merged into the `grafana_role_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.grafana_role_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `grafana_role_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.grafana_role_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withUserIds':: d.fn(help='`aws.grafana_role_association.withUserIds` constructs a mixin object that can be merged into the `grafana_role_association`\nTerraform resource block to set or update the user_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_ids` field.\n', args=[]),
  ...
  '#withWorkspaceId':: d.fn(help='`aws.grafana_role_association.withWorkspaceId` constructs a mixin object that can be merged into the `grafana_role_association`\nTerraform resource block to set or update the workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workspace_id` field.\n', args=[]),
