...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.workspaces_ip_group.withDescription` constructs a mixin object that can be merged into the `workspaces_ip_group`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.workspaces_ip_group.withName` constructs a mixin object that can be merged into the `workspaces_ip_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRules':: d.fn(help='`aws.workspaces_ip_group.withRules` constructs a mixin object that can be merged into the `workspaces_ip_group`\nTerraform resource block to set or update the rules field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rules` field.\n', args=[]),
  ...
  '#withRulesMixin':: d.fn(help='`aws.workspaces_ip_group.withRulesMixin` constructs a mixin object that can be merged into the `workspaces_ip_group`\nTerraform resource block to set or update the rules field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.workspaces_ip_group.withRules](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rules` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.workspaces_ip_group.withTags` constructs a mixin object that can be merged into the `workspaces_ip_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.workspaces_ip_group.withTagsAll` constructs a mixin object that can be merged into the `workspaces_ip_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
