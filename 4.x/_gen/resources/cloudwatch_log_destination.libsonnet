...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.cloudwatch_log_destination.withName` constructs a mixin object that can be merged into the `cloudwatch_log_destination`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.cloudwatch_log_destination.withRoleArn` constructs a mixin object that can be merged into the `cloudwatch_log_destination`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.cloudwatch_log_destination.withTags` constructs a mixin object that can be merged into the `cloudwatch_log_destination`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.cloudwatch_log_destination.withTagsAll` constructs a mixin object that can be merged into the `cloudwatch_log_destination`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTargetArn':: d.fn(help='`aws.cloudwatch_log_destination.withTargetArn` constructs a mixin object that can be merged into the `cloudwatch_log_destination`\nTerraform resource block to set or update the target_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_arn` field.\n', args=[]),
