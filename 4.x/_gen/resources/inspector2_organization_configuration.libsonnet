...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutoEnable':: d.fn(help='`aws.inspector2_organization_configuration.withAutoEnable` constructs a mixin object that can be merged into the `inspector2_organization_configuration`\nTerraform resource block to set or update the auto_enable field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_enable` field.\n', args=[]),
  ...
  '#withAutoEnableMixin':: d.fn(help='`aws.inspector2_organization_configuration.withAutoEnableMixin` constructs a mixin object that can be merged into the `inspector2_organization_configuration`\nTerraform resource block to set or update the auto_enable field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.inspector2_organization_configuration.withAutoEnable](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_enable` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.inspector2_organization_configuration.withTimeouts` constructs a mixin object that can be merged into the `inspector2_organization_configuration`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.inspector2_organization_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `inspector2_organization_configuration`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.inspector2_organization_configuration.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
