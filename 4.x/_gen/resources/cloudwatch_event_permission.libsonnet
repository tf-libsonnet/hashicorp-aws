...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAction':: d.fn(help='`aws.cloudwatch_event_permission.withAction` constructs a mixin object that can be merged into the `cloudwatch_event_permission`\nTerraform resource block to set or update the action field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `action` field.\n', args=[]),
  ...
  '#withCondition':: d.fn(help='`aws.cloudwatch_event_permission.withCondition` constructs a mixin object that can be merged into the `cloudwatch_event_permission`\nTerraform resource block to set or update the condition field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withConditionMixin':: d.fn(help='`aws.cloudwatch_event_permission.withConditionMixin` constructs a mixin object that can be merged into the `cloudwatch_event_permission`\nTerraform resource block to set or update the condition field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudwatch_event_permission.withCondition](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withEventBusName':: d.fn(help='`aws.cloudwatch_event_permission.withEventBusName` constructs a mixin object that can be merged into the `cloudwatch_event_permission`\nTerraform resource block to set or update the event_bus_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_bus_name` field.\n', args=[]),
  ...
  '#withPrincipal':: d.fn(help='`aws.cloudwatch_event_permission.withPrincipal` constructs a mixin object that can be merged into the `cloudwatch_event_permission`\nTerraform resource block to set or update the principal field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal` field.\n', args=[]),
  ...
  '#withStatementId':: d.fn(help='`aws.cloudwatch_event_permission.withStatementId` constructs a mixin object that can be merged into the `cloudwatch_event_permission`\nTerraform resource block to set or update the statement_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `statement_id` field.\n', args=[]),
