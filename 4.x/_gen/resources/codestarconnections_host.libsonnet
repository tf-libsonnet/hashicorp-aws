...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.codestarconnections_host.withName` constructs a mixin object that can be merged into the `codestarconnections_host`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProviderEndpoint':: d.fn(help='`aws.codestarconnections_host.withProviderEndpoint` constructs a mixin object that can be merged into the `codestarconnections_host`\nTerraform resource block to set or update the provider_endpoint field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_endpoint` field.\n', args=[]),
  ...
  '#withProviderType':: d.fn(help='`aws.codestarconnections_host.withProviderType` constructs a mixin object that can be merged into the `codestarconnections_host`\nTerraform resource block to set or update the provider_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_type` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.codestarconnections_host.withTimeouts` constructs a mixin object that can be merged into the `codestarconnections_host`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.codestarconnections_host.withTimeoutsMixin` constructs a mixin object that can be merged into the `codestarconnections_host`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.codestarconnections_host.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpcConfiguration':: d.fn(help='`aws.codestarconnections_host.withVpcConfiguration` constructs a mixin object that can be merged into the `codestarconnections_host`\nTerraform resource block to set or update the vpc_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_configuration` field.\n', args=[]),
  ...
  '#withVpcConfigurationMixin':: d.fn(help='`aws.codestarconnections_host.withVpcConfigurationMixin` constructs a mixin object that can be merged into the `codestarconnections_host`\nTerraform resource block to set or update the vpc_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.codestarconnections_host.withVpcConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_configuration` field.\n', args=[]),
