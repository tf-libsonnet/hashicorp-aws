...
{
  '#':: d.pkg(name='opsworks_haproxy_layer', url='', help='`opsworks_haproxy_layer` represents the `aws_opsworks_haproxy_layer` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  cloudwatch_configuration:: {
    ...
    '#new':: d.fn(help='\n`aws.opsworks_haproxy_layer.cloudwatch_configuration.new` constructs a new object with attributes and blocks configured for the `cloudwatch_configuration`\nTerraform sub block.\n\n\n\n**Args**:\n  - `enabled` (`bool`):  When `null`, the `enabled` field will be omitted from the resulting object.\n  - `log_streams` (`list[obj]`):  When `null`, the `log_streams` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opsworks_haproxy_layer.cloudwatch_configuration.log_streams.new](#fn-cloudwatchconfigurationlogstreamsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `cloudwatch_configuration` sub block.\n', args=[]),
    new(
      enabled=null,
      log_streams=null
    ):: std.prune(a={
  ...
  load_based_auto_scaling:: {
    ...
    '#new':: d.fn(help='\n`aws.opsworks_haproxy_layer.load_based_auto_scaling.new` constructs a new object with attributes and blocks configured for the `load_based_auto_scaling`\nTerraform sub block.\n\n\n\n**Args**:\n  - `enable` (`bool`):  When `null`, the `enable` field will be omitted from the resulting object.\n  - `downscaling` (`list[obj]`):  When `null`, the `downscaling` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opsworks_haproxy_layer.load_based_auto_scaling.downscaling.new](#fn-loadbasedautoscalingdownscalingnew) constructor.\n  - `upscaling` (`list[obj]`):  When `null`, the `upscaling` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opsworks_haproxy_layer.load_based_auto_scaling.upscaling.new](#fn-loadbasedautoscalingupscalingnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `load_based_auto_scaling` sub block.\n', args=[]),
    new(
      downscaling=null,
      enable=null,
      upscaling=null
  ...
  '#withAutoAssignElasticIps':: d.fn(help='`aws.opsworks_haproxy_layer.withAutoAssignElasticIps` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the auto_assign_elastic_ips field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_assign_elastic_ips` field.\n', args=[]),
  ...
  '#withAutoAssignPublicIps':: d.fn(help='`aws.opsworks_haproxy_layer.withAutoAssignPublicIps` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the auto_assign_public_ips field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_assign_public_ips` field.\n', args=[]),
  ...
  '#withAutoHealing':: d.fn(help='`aws.opsworks_haproxy_layer.withAutoHealing` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the auto_healing field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_healing` field.\n', args=[]),
  ...
  '#withCloudwatchConfiguration':: d.fn(help='`aws.opsworks_haproxy_layer.withCloudwatchConfiguration` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the cloudwatch_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cloudwatch_configuration` field.\n', args=[]),
  ...
  '#withCloudwatchConfigurationMixin':: d.fn(help='`aws.opsworks_haproxy_layer.withCloudwatchConfigurationMixin` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the cloudwatch_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.opsworks_haproxy_layer.withCloudwatchConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cloudwatch_configuration` field.\n', args=[]),
  ...
  '#withCustomConfigureRecipes':: d.fn(help='`aws.opsworks_haproxy_layer.withCustomConfigureRecipes` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the custom_configure_recipes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_configure_recipes` field.\n', args=[]),
  ...
  '#withCustomDeployRecipes':: d.fn(help='`aws.opsworks_haproxy_layer.withCustomDeployRecipes` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the custom_deploy_recipes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_deploy_recipes` field.\n', args=[]),
  ...
  '#withCustomInstanceProfileArn':: d.fn(help='`aws.opsworks_haproxy_layer.withCustomInstanceProfileArn` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the custom_instance_profile_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_instance_profile_arn` field.\n', args=[]),
  ...
  '#withCustomJson':: d.fn(help='`aws.opsworks_haproxy_layer.withCustomJson` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the custom_json field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_json` field.\n', args=[]),
  ...
  '#withCustomSecurityGroupIds':: d.fn(help='`aws.opsworks_haproxy_layer.withCustomSecurityGroupIds` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the custom_security_group_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_security_group_ids` field.\n', args=[]),
  ...
  '#withCustomSetupRecipes':: d.fn(help='`aws.opsworks_haproxy_layer.withCustomSetupRecipes` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the custom_setup_recipes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_setup_recipes` field.\n', args=[]),
  ...
  '#withCustomShutdownRecipes':: d.fn(help='`aws.opsworks_haproxy_layer.withCustomShutdownRecipes` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the custom_shutdown_recipes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_shutdown_recipes` field.\n', args=[]),
  ...
  '#withCustomUndeployRecipes':: d.fn(help='`aws.opsworks_haproxy_layer.withCustomUndeployRecipes` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the custom_undeploy_recipes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_undeploy_recipes` field.\n', args=[]),
  ...
  '#withDrainElbOnShutdown':: d.fn(help='`aws.opsworks_haproxy_layer.withDrainElbOnShutdown` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the drain_elb_on_shutdown field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `drain_elb_on_shutdown` field.\n', args=[]),
  ...
  '#withEbsVolume':: d.fn(help='`aws.opsworks_haproxy_layer.withEbsVolume` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the ebs_volume field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ebs_volume` field.\n', args=[]),
  ...
  '#withEbsVolumeMixin':: d.fn(help='`aws.opsworks_haproxy_layer.withEbsVolumeMixin` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the ebs_volume field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.opsworks_haproxy_layer.withEbsVolume](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ebs_volume` field.\n', args=[]),
  ...
  '#withElasticLoadBalancer':: d.fn(help='`aws.opsworks_haproxy_layer.withElasticLoadBalancer` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the elastic_load_balancer field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `elastic_load_balancer` field.\n', args=[]),
  ...
  '#withHealthcheckMethod':: d.fn(help='`aws.opsworks_haproxy_layer.withHealthcheckMethod` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the healthcheck_method field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `healthcheck_method` field.\n', args=[]),
  withHealthcheckMethod(resourceLabel, value):: {
    resource+: {
      aws_opsworks_haproxy_layer+: {
        [resourceLabel]+: {
  ...
  '#withHealthcheckUrl':: d.fn(help='`aws.opsworks_haproxy_layer.withHealthcheckUrl` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the healthcheck_url field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `healthcheck_url` field.\n', args=[]),
  withHealthcheckUrl(resourceLabel, value):: {
    resource+: {
      aws_opsworks_haproxy_layer+: {
        [resourceLabel]+: {
  ...
  '#withInstallUpdatesOnBoot':: d.fn(help='`aws.opsworks_haproxy_layer.withInstallUpdatesOnBoot` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the install_updates_on_boot field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `install_updates_on_boot` field.\n', args=[]),
  ...
  '#withInstanceShutdownTimeout':: d.fn(help='`aws.opsworks_haproxy_layer.withInstanceShutdownTimeout` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the instance_shutdown_timeout field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_shutdown_timeout` field.\n', args=[]),
  ...
  '#withLoadBasedAutoScaling':: d.fn(help='`aws.opsworks_haproxy_layer.withLoadBasedAutoScaling` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the load_based_auto_scaling field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load_based_auto_scaling` field.\n', args=[]),
  ...
  '#withLoadBasedAutoScalingMixin':: d.fn(help='`aws.opsworks_haproxy_layer.withLoadBasedAutoScalingMixin` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the load_based_auto_scaling field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.opsworks_haproxy_layer.withLoadBasedAutoScaling](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load_based_auto_scaling` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.opsworks_haproxy_layer.withName` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withStackId':: d.fn(help='`aws.opsworks_haproxy_layer.withStackId` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the stack_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stack_id` field.\n', args=[]),
  ...
  '#withStatsEnabled':: d.fn(help='`aws.opsworks_haproxy_layer.withStatsEnabled` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the stats_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stats_enabled` field.\n', args=[]),
  withStatsEnabled(resourceLabel, value):: {
    resource+: {
      aws_opsworks_haproxy_layer+: {
        [resourceLabel]+: {
          stats_enabled: value,
  ...
  '#withStatsPassword':: d.fn(help='`aws.opsworks_haproxy_layer.withStatsPassword` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the stats_password field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stats_password` field.\n', args=[]),
  withStatsPassword(resourceLabel, value):: {
    resource+: {
      aws_opsworks_haproxy_layer+: {
        [resourceLabel]+: {
  ...
  '#withStatsUrl':: d.fn(help='`aws.opsworks_haproxy_layer.withStatsUrl` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the stats_url field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stats_url` field.\n', args=[]),
  withStatsUrl(resourceLabel, value):: {
    resource+: {
      aws_opsworks_haproxy_layer+: {
        [resourceLabel]+: {
          stats_url: value,
  ...
  '#withStatsUser':: d.fn(help='`aws.opsworks_haproxy_layer.withStatsUser` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the stats_user field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stats_user` field.\n', args=[]),
  withStatsUser(resourceLabel, value):: {
    resource+: {
      aws_opsworks_haproxy_layer+: {
        [resourceLabel]+: {
          stats_user: value,
  ...
  '#withSystemPackages':: d.fn(help='`aws.opsworks_haproxy_layer.withSystemPackages` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the system_packages field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `system_packages` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.opsworks_haproxy_layer.withTags` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.opsworks_haproxy_layer.withTagsAll` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withUseEbsOptimizedInstances':: d.fn(help='`aws.opsworks_haproxy_layer.withUseEbsOptimizedInstances` constructs a mixin object that can be merged into the `opsworks_haproxy_layer`\nTerraform resource block to set or update the use_ebs_optimized_instances field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `use_ebs_optimized_instances` field.\n', args=[]),
