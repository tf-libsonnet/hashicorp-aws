...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSecretBinary':: d.fn(help='`aws.secretsmanager_secret_version.withSecretBinary` constructs a mixin object that can be merged into the `secretsmanager_secret_version`\nTerraform resource block to set or update the secret_binary field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret_binary` field.\n', args=[]),
  ...
  '#withSecretString':: d.fn(help='`aws.secretsmanager_secret_version.withSecretString` constructs a mixin object that can be merged into the `secretsmanager_secret_version`\nTerraform resource block to set or update the secret_string field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret_string` field.\n', args=[]),
  ...
  '#withVersionStages':: d.fn(help='`aws.secretsmanager_secret_version.withVersionStages` constructs a mixin object that can be merged into the `secretsmanager_secret_version`\nTerraform resource block to set or update the version_stages field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version_stages` field.\n', args=[]),
