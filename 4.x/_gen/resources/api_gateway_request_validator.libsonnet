...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.api_gateway_request_validator.withName` constructs a mixin object that can be merged into the `api_gateway_request_validator`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRestApiId':: d.fn(help='`aws.api_gateway_request_validator.withRestApiId` constructs a mixin object that can be merged into the `api_gateway_request_validator`\nTerraform resource block to set or update the rest_api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rest_api_id` field.\n', args=[]),
  ...
  '#withValidateRequestBody':: d.fn(help='`aws.api_gateway_request_validator.withValidateRequestBody` constructs a mixin object that can be merged into the `api_gateway_request_validator`\nTerraform resource block to set or update the validate_request_body field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `validate_request_body` field.\n', args=[]),
  ...
  '#withValidateRequestParameters':: d.fn(help='`aws.api_gateway_request_validator.withValidateRequestParameters` constructs a mixin object that can be merged into the `api_gateway_request_validator`\nTerraform resource block to set or update the validate_request_parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `validate_request_parameters` field.\n', args=[]),
