...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiId':: d.fn(help='`aws.apigatewayv2_model.withApiId` constructs a mixin object that can be merged into the `apigatewayv2_model`\nTerraform resource block to set or update the api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_id` field.\n', args=[]),
  ...
  '#withContentType':: d.fn(help='`aws.apigatewayv2_model.withContentType` constructs a mixin object that can be merged into the `apigatewayv2_model`\nTerraform resource block to set or update the content_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content_type` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.apigatewayv2_model.withDescription` constructs a mixin object that can be merged into the `apigatewayv2_model`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.apigatewayv2_model.withName` constructs a mixin object that can be merged into the `apigatewayv2_model`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSchema':: d.fn(help='`aws.apigatewayv2_model.withSchema` constructs a mixin object that can be merged into the `apigatewayv2_model`\nTerraform resource block to set or update the schema field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schema` field.\n', args=[]),
