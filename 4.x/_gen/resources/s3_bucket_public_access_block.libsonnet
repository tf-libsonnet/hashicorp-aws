...
{
  '#':: d.pkg(name='s3_bucket_public_access_block', url='', help='`s3_bucket_public_access_block` represents the `aws_s3_bucket_public_access_block` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBlockPublicAcls':: d.fn(help='`aws.s3_bucket_public_access_block.withBlockPublicAcls` constructs a mixin object that can be merged into the `s3_bucket_public_access_block`\nTerraform resource block to set or update the block_public_acls field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `block_public_acls` field.\n', args=[]),
  ...
  '#withBlockPublicPolicy':: d.fn(help='`aws.s3_bucket_public_access_block.withBlockPublicPolicy` constructs a mixin object that can be merged into the `s3_bucket_public_access_block`\nTerraform resource block to set or update the block_public_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `block_public_policy` field.\n', args=[]),
  ...
  '#withBucket':: d.fn(help='`aws.s3_bucket_public_access_block.withBucket` constructs a mixin object that can be merged into the `s3_bucket_public_access_block`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withIgnorePublicAcls':: d.fn(help='`aws.s3_bucket_public_access_block.withIgnorePublicAcls` constructs a mixin object that can be merged into the `s3_bucket_public_access_block`\nTerraform resource block to set or update the ignore_public_acls field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ignore_public_acls` field.\n', args=[]),
  ...
  '#withRestrictPublicBuckets':: d.fn(help='`aws.s3_bucket_public_access_block.withRestrictPublicBuckets` constructs a mixin object that can be merged into the `s3_bucket_public_access_block`\nTerraform resource block to set or update the restrict_public_buckets field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `restrict_public_buckets` field.\n', args=[]),
