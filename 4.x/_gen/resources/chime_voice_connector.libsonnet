...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAwsRegion':: d.fn(help='`aws.chime_voice_connector.withAwsRegion` constructs a mixin object that can be merged into the `chime_voice_connector`\nTerraform resource block to set or update the aws_region field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `aws_region` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.chime_voice_connector.withName` constructs a mixin object that can be merged into the `chime_voice_connector`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRequireEncryption':: d.fn(help='`aws.chime_voice_connector.withRequireEncryption` constructs a mixin object that can be merged into the `chime_voice_connector`\nTerraform resource block to set or update the require_encryption field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `require_encryption` field.\n', args=[]),
