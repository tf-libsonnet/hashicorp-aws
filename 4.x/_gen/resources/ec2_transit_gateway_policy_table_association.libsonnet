...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withTransitGatewayAttachmentId':: d.fn(help='`aws.ec2_transit_gateway_policy_table_association.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_policy_table_association`\nTerraform resource block to set or update the transit_gateway_attachment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_attachment_id` field.\n', args=[]),
  ...
  '#withTransitGatewayPolicyTableId':: d.fn(help='`aws.ec2_transit_gateway_policy_table_association.withTransitGatewayPolicyTableId` constructs a mixin object that can be merged into the `ec2_transit_gateway_policy_table_association`\nTerraform resource block to set or update the transit_gateway_policy_table_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_policy_table_id` field.\n', args=[]),
