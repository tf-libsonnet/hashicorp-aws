...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAcceptanceRequired':: d.fn(help='`aws.vpc_endpoint_service.withAcceptanceRequired` constructs a mixin object that can be merged into the `vpc_endpoint_service`\nTerraform resource block to set or update the acceptance_required field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `acceptance_required` field.\n', args=[]),
  ...
  '#withAllowedPrincipals':: d.fn(help='`aws.vpc_endpoint_service.withAllowedPrincipals` constructs a mixin object that can be merged into the `vpc_endpoint_service`\nTerraform resource block to set or update the allowed_principals field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `allowed_principals` field.\n', args=[]),
  ...
  '#withGatewayLoadBalancerArns':: d.fn(help='`aws.vpc_endpoint_service.withGatewayLoadBalancerArns` constructs a mixin object that can be merged into the `vpc_endpoint_service`\nTerraform resource block to set or update the gateway_load_balancer_arns field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway_load_balancer_arns` field.\n', args=[]),
  ...
  '#withNetworkLoadBalancerArns':: d.fn(help='`aws.vpc_endpoint_service.withNetworkLoadBalancerArns` constructs a mixin object that can be merged into the `vpc_endpoint_service`\nTerraform resource block to set or update the network_load_balancer_arns field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_load_balancer_arns` field.\n', args=[]),
  ...
  '#withPrivateDnsName':: d.fn(help='`aws.vpc_endpoint_service.withPrivateDnsName` constructs a mixin object that can be merged into the `vpc_endpoint_service`\nTerraform resource block to set or update the private_dns_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_dns_name` field.\n', args=[]),
  ...
  '#withSupportedIpAddressTypes':: d.fn(help='`aws.vpc_endpoint_service.withSupportedIpAddressTypes` constructs a mixin object that can be merged into the `vpc_endpoint_service`\nTerraform resource block to set or update the supported_ip_address_types field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `supported_ip_address_types` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.vpc_endpoint_service.withTagsAll` constructs a mixin object that can be merged into the `vpc_endpoint_service`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
