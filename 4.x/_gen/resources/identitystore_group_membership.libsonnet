...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroupId':: d.fn(help='`aws.identitystore_group_membership.withGroupId` constructs a mixin object that can be merged into the `identitystore_group_membership`\nTerraform resource block to set or update the group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_id` field.\n', args=[]),
  ...
  '#withIdentityStoreId':: d.fn(help='`aws.identitystore_group_membership.withIdentityStoreId` constructs a mixin object that can be merged into the `identitystore_group_membership`\nTerraform resource block to set or update the identity_store_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity_store_id` field.\n', args=[]),
  ...
  '#withMemberId':: d.fn(help='`aws.identitystore_group_membership.withMemberId` constructs a mixin object that can be merged into the `identitystore_group_membership`\nTerraform resource block to set or update the member_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `member_id` field.\n', args=[]),
