...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCatalogId':: d.fn(help='`aws.lakeformation_lf_tag.withCatalogId` constructs a mixin object that can be merged into the `lakeformation_lf_tag`\nTerraform resource block to set or update the catalog_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `catalog_id` field.\n', args=[]),
  ...
  '#withKey':: d.fn(help='`aws.lakeformation_lf_tag.withKey` constructs a mixin object that can be merged into the `lakeformation_lf_tag`\nTerraform resource block to set or update the key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key` field.\n', args=[]),
  ...
  '#withValues':: d.fn(help='`aws.lakeformation_lf_tag.withValues` constructs a mixin object that can be merged into the `lakeformation_lf_tag`\nTerraform resource block to set or update the values field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `values` field.\n', args=[]),
