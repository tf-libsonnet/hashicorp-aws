...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMaxCapacity':: d.fn(help='`aws.appautoscaling_target.withMaxCapacity` constructs a mixin object that can be merged into the `appautoscaling_target`\nTerraform resource block to set or update the max_capacity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `max_capacity` field.\n', args=[]),
  ...
  '#withMinCapacity':: d.fn(help='`aws.appautoscaling_target.withMinCapacity` constructs a mixin object that can be merged into the `appautoscaling_target`\nTerraform resource block to set or update the min_capacity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `min_capacity` field.\n', args=[]),
  ...
  '#withResourceId':: d.fn(help='`aws.appautoscaling_target.withResourceId` constructs a mixin object that can be merged into the `appautoscaling_target`\nTerraform resource block to set or update the resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_id` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.appautoscaling_target.withRoleArn` constructs a mixin object that can be merged into the `appautoscaling_target`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
  ...
  '#withScalableDimension':: d.fn(help='`aws.appautoscaling_target.withScalableDimension` constructs a mixin object that can be merged into the `appautoscaling_target`\nTerraform resource block to set or update the scalable_dimension field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scalable_dimension` field.\n', args=[]),
  ...
  '#withServiceNamespace':: d.fn(help='`aws.appautoscaling_target.withServiceNamespace` constructs a mixin object that can be merged into the `appautoscaling_target`\nTerraform resource block to set or update the service_namespace field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_namespace` field.\n', args=[]),
