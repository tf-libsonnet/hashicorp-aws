...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.wafv2_ip_set.withDescription` constructs a mixin object that can be merged into the `wafv2_ip_set`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withIpAddressVersion':: d.fn(help='`aws.wafv2_ip_set.withIpAddressVersion` constructs a mixin object that can be merged into the `wafv2_ip_set`\nTerraform resource block to set or update the ip_address_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_address_version` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.wafv2_ip_set.withName` constructs a mixin object that can be merged into the `wafv2_ip_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScope':: d.fn(help='`aws.wafv2_ip_set.withScope` constructs a mixin object that can be merged into the `wafv2_ip_set`\nTerraform resource block to set or update the scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.wafv2_ip_set.withTags` constructs a mixin object that can be merged into the `wafv2_ip_set`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.wafv2_ip_set.withTagsAll` constructs a mixin object that can be merged into the `wafv2_ip_set`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
