...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDhcpOptionsId':: d.fn(help='`aws.vpc_dhcp_options_association.withDhcpOptionsId` constructs a mixin object that can be merged into the `vpc_dhcp_options_association`\nTerraform resource block to set or update the dhcp_options_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dhcp_options_id` field.\n', args=[]),
  ...
  '#withVpcId':: d.fn(help='`aws.vpc_dhcp_options_association.withVpcId` constructs a mixin object that can be merged into the `vpc_dhcp_options_association`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
