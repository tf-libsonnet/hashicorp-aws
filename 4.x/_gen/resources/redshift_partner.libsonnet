...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`aws.redshift_partner.withAccountId` constructs a mixin object that can be merged into the `redshift_partner`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withClusterIdentifier':: d.fn(help='`aws.redshift_partner.withClusterIdentifier` constructs a mixin object that can be merged into the `redshift_partner`\nTerraform resource block to set or update the cluster_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_identifier` field.\n', args=[]),
  ...
  '#withDatabaseName':: d.fn(help='`aws.redshift_partner.withDatabaseName` constructs a mixin object that can be merged into the `redshift_partner`\nTerraform resource block to set or update the database_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database_name` field.\n', args=[]),
  ...
  '#withPartnerName':: d.fn(help='`aws.redshift_partner.withPartnerName` constructs a mixin object that can be merged into the `redshift_partner`\nTerraform resource block to set or update the partner_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partner_name` field.\n', args=[]),
