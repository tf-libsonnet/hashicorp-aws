...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIdentityPoolId':: d.fn(help='`aws.cognito_identity_pool_roles_attachment.withIdentityPoolId` constructs a mixin object that can be merged into the `cognito_identity_pool_roles_attachment`\nTerraform resource block to set or update the identity_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity_pool_id` field.\n', args=[]),
  ...
  '#withRoleMapping':: d.fn(help='`aws.cognito_identity_pool_roles_attachment.withRoleMapping` constructs a mixin object that can be merged into the `cognito_identity_pool_roles_attachment`\nTerraform resource block to set or update the role_mapping field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_mapping` field.\n', args=[]),
  ...
  '#withRoleMappingMixin':: d.fn(help='`aws.cognito_identity_pool_roles_attachment.withRoleMappingMixin` constructs a mixin object that can be merged into the `cognito_identity_pool_roles_attachment`\nTerraform resource block to set or update the role_mapping field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cognito_identity_pool_roles_attachment.withRoleMapping](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_mapping` field.\n', args=[]),
  ...
  '#withRoles':: d.fn(help='`aws.cognito_identity_pool_roles_attachment.withRoles` constructs a mixin object that can be merged into the `cognito_identity_pool_roles_attachment`\nTerraform resource block to set or update the roles field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `roles` field.\n', args=[]),
