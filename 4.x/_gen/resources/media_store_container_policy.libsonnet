...
{
  '#':: d.pkg(name='media_store_container_policy', url='', help='`media_store_container_policy` represents the `aws_media_store_container_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withContainerName':: d.fn(help='`aws.media_store_container_policy.withContainerName` constructs a mixin object that can be merged into the `media_store_container_policy`\nTerraform resource block to set or update the container_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `container_name` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.media_store_container_policy.withPolicy` constructs a mixin object that can be merged into the `media_store_container_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
