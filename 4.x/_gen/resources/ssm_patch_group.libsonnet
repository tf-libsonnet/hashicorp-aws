...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBaselineId':: d.fn(help='`aws.ssm_patch_group.withBaselineId` constructs a mixin object that can be merged into the `ssm_patch_group`\nTerraform resource block to set or update the baseline_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `baseline_id` field.\n', args=[]),
  ...
  '#withPatchGroup':: d.fn(help='`aws.ssm_patch_group.withPatchGroup` constructs a mixin object that can be merged into the `ssm_patch_group`\nTerraform resource block to set or update the patch_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `patch_group` field.\n', args=[]),
