...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.redshift_security_group.withDescription` constructs a mixin object that can be merged into the `redshift_security_group`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withIngress':: d.fn(help='`aws.redshift_security_group.withIngress` constructs a mixin object that can be merged into the `redshift_security_group`\nTerraform resource block to set or update the ingress field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ingress` field.\n', args=[]),
  ...
  '#withIngressMixin':: d.fn(help='`aws.redshift_security_group.withIngressMixin` constructs a mixin object that can be merged into the `redshift_security_group`\nTerraform resource block to set or update the ingress field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.redshift_security_group.withIngress](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ingress` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.redshift_security_group.withName` constructs a mixin object that can be merged into the `redshift_security_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
