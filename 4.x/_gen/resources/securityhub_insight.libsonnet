...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFilters':: d.fn(help='`aws.securityhub_insight.withFilters` constructs a mixin object that can be merged into the `securityhub_insight`\nTerraform resource block to set or update the filters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filters` field.\n', args=[]),
  ...
  '#withFiltersMixin':: d.fn(help='`aws.securityhub_insight.withFiltersMixin` constructs a mixin object that can be merged into the `securityhub_insight`\nTerraform resource block to set or update the filters field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.securityhub_insight.withFilters](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filters` field.\n', args=[]),
  ...
  '#withGroupByAttribute':: d.fn(help='`aws.securityhub_insight.withGroupByAttribute` constructs a mixin object that can be merged into the `securityhub_insight`\nTerraform resource block to set or update the group_by_attribute field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_by_attribute` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.securityhub_insight.withName` constructs a mixin object that can be merged into the `securityhub_insight`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
