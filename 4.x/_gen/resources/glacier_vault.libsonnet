...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.glacier_vault.withName` constructs a mixin object that can be merged into the `glacier_vault`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNotification':: d.fn(help='`aws.glacier_vault.withNotification` constructs a mixin object that can be merged into the `glacier_vault`\nTerraform resource block to set or update the notification field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `notification` field.\n', args=[]),
  ...
  '#withNotificationMixin':: d.fn(help='`aws.glacier_vault.withNotificationMixin` constructs a mixin object that can be merged into the `glacier_vault`\nTerraform resource block to set or update the notification field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glacier_vault.withNotification](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `notification` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.glacier_vault.withTags` constructs a mixin object that can be merged into the `glacier_vault`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.glacier_vault.withTagsAll` constructs a mixin object that can be merged into the `glacier_vault`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
