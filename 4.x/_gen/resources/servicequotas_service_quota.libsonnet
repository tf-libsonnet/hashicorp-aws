...
{
  '#':: d.pkg(name='servicequotas_service_quota', url='', help='`servicequotas_service_quota` represents the `aws_servicequotas_service_quota` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withValue':: d.fn(help='`aws.servicequotas_service_quota.withValue` constructs a mixin object that can be merged into the `servicequotas_service_quota`\nTerraform resource block to set or update the value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value` field.\n', args=[]),
