...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEgress':: d.fn(help='`aws.default_security_group.withEgress` constructs a mixin object that can be merged into the `default_security_group`\nTerraform resource block to set or update the egress field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `egress` field.\n', args=[]),
  ...
  '#withIngress':: d.fn(help='`aws.default_security_group.withIngress` constructs a mixin object that can be merged into the `default_security_group`\nTerraform resource block to set or update the ingress field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ingress` field.\n', args=[]),
  ...
  '#withRevokeRulesOnDelete':: d.fn(help='`aws.default_security_group.withRevokeRulesOnDelete` constructs a mixin object that can be merged into the `default_security_group`\nTerraform resource block to set or update the revoke_rules_on_delete field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `revoke_rules_on_delete` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.default_security_group.withTags` constructs a mixin object that can be merged into the `default_security_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.default_security_group.withTagsAll` constructs a mixin object that can be merged into the `default_security_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withVpcId':: d.fn(help='`aws.default_security_group.withVpcId` constructs a mixin object that can be merged into the `default_security_group`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
