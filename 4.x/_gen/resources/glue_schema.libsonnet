...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDataFormat':: d.fn(help='`aws.glue_schema.withDataFormat` constructs a mixin object that can be merged into the `glue_schema`\nTerraform resource block to set or update the data_format field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `data_format` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.glue_schema.withDescription` constructs a mixin object that can be merged into the `glue_schema`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withRegistryArn':: d.fn(help='`aws.glue_schema.withRegistryArn` constructs a mixin object that can be merged into the `glue_schema`\nTerraform resource block to set or update the registry_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `registry_arn` field.\n', args=[]),
  ...
  '#withSchemaDefinition':: d.fn(help='`aws.glue_schema.withSchemaDefinition` constructs a mixin object that can be merged into the `glue_schema`\nTerraform resource block to set or update the schema_definition field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schema_definition` field.\n', args=[]),
  ...
  '#withSchemaName':: d.fn(help='`aws.glue_schema.withSchemaName` constructs a mixin object that can be merged into the `glue_schema`\nTerraform resource block to set or update the schema_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schema_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.glue_schema.withTags` constructs a mixin object that can be merged into the `glue_schema`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.glue_schema.withTagsAll` constructs a mixin object that can be merged into the `glue_schema`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
