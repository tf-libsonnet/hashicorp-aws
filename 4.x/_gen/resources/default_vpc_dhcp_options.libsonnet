...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withOwnerId':: d.fn(help='`aws.default_vpc_dhcp_options.withOwnerId` constructs a mixin object that can be merged into the `default_vpc_dhcp_options`\nTerraform resource block to set or update the owner_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owner_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.default_vpc_dhcp_options.withTags` constructs a mixin object that can be merged into the `default_vpc_dhcp_options`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.default_vpc_dhcp_options.withTagsAll` constructs a mixin object that can be merged into the `default_vpc_dhcp_options`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
