...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPrincipal':: d.fn(help='`aws.iot_thing_principal_attachment.withPrincipal` constructs a mixin object that can be merged into the `iot_thing_principal_attachment`\nTerraform resource block to set or update the principal field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal` field.\n', args=[]),
  ...
  '#withThing':: d.fn(help='`aws.iot_thing_principal_attachment.withThing` constructs a mixin object that can be merged into the `iot_thing_principal_attachment`\nTerraform resource block to set or update the thing field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `thing` field.\n', args=[]),
