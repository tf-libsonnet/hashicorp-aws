...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClientVpnEndpointId':: d.fn(help='`aws.ec2_client_vpn_network_association.withClientVpnEndpointId` constructs a mixin object that can be merged into the `ec2_client_vpn_network_association`\nTerraform resource block to set or update the client_vpn_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_vpn_endpoint_id` field.\n', args=[]),
  ...
  '#withSecurityGroups':: d.fn(help='`aws.ec2_client_vpn_network_association.withSecurityGroups` constructs a mixin object that can be merged into the `ec2_client_vpn_network_association`\nTerraform resource block to set or update the security_groups field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_groups` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`aws.ec2_client_vpn_network_association.withSubnetId` constructs a mixin object that can be merged into the `ec2_client_vpn_network_association`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.ec2_client_vpn_network_association.withTimeouts` constructs a mixin object that can be merged into the `ec2_client_vpn_network_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.ec2_client_vpn_network_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_client_vpn_network_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.ec2_client_vpn_network_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
