...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIdentifier':: d.fn(help='`aws.cognito_resource_server.withIdentifier` constructs a mixin object that can be merged into the `cognito_resource_server`\nTerraform resource block to set or update the identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identifier` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cognito_resource_server.withName` constructs a mixin object that can be merged into the `cognito_resource_server`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScope':: d.fn(help='`aws.cognito_resource_server.withScope` constructs a mixin object that can be merged into the `cognito_resource_server`\nTerraform resource block to set or update the scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
  ...
  '#withScopeMixin':: d.fn(help='`aws.cognito_resource_server.withScopeMixin` constructs a mixin object that can be merged into the `cognito_resource_server`\nTerraform resource block to set or update the scope field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cognito_resource_server.withScope](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
  ...
  '#withUserPoolId':: d.fn(help='`aws.cognito_resource_server.withUserPoolId` constructs a mixin object that can be merged into the `cognito_resource_server`\nTerraform resource block to set or update the user_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_pool_id` field.\n', args=[]),
