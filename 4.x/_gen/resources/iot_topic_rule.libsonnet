...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  error_action:: {
    ...
    dynamodbv2:: {
      '#new':: d.fn(help='\n`aws.iot_topic_rule.error_action.dynamodbv2.new` constructs a new object with attributes and blocks configured for the `dynamodbv2`\nTerraform sub block.\n\n\n\n**Args**:\n  - `role_arn` (`string`): \n  - `put_item` (`list[obj]`):  When `null`, the `put_item` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.error_action.dynamodbv2.put_item.new](#fn-dynamodbv2put_itemnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `dynamodbv2` sub block.\n', args=[]),
      new(
        role_arn,
        put_item=null
      ):: std.prune(a={
  ...
  '#new':: d.fn(help="\n`aws.iot_topic_rule.new` injects a new `aws_iot_topic_rule` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.iot_topic_rule.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.iot_topic_rule` using the reference:\n\n    $._ref.aws_iot_topic_rule.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_iot_topic_rule.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `enabled` (`bool`): \n  - `name` (`string`): \n  - `sql` (`string`): \n  - `sql_version` (`string`): \n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `tags_all` (`obj`):  When `null`, the `tags_all` field will be omitted from the resulting object.\n  - `cloudwatch_alarm` (`list[obj]`):  When `null`, the `cloudwatch_alarm` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.cloudwatch_alarm.new](#fn-iot_topic_rulecloudwatch_alarmnew) constructor.\n  - `cloudwatch_logs` (`list[obj]`):  When `null`, the `cloudwatch_logs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.cloudwatch_logs.new](#fn-iot_topic_rulecloudwatch_logsnew) constructor.\n  - `cloudwatch_metric` (`list[obj]`):  When `null`, the `cloudwatch_metric` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.cloudwatch_metric.new](#fn-iot_topic_rulecloudwatch_metricnew) constructor.\n  - `dynamodb` (`list[obj]`):  When `null`, the `dynamodb` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.dynamodb.new](#fn-iot_topic_ruledynamodbnew) constructor.\n  - `dynamodbv2` (`list[obj]`):  When `null`, the `dynamodbv2` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.dynamodbv2.new](#fn-iot_topic_ruledynamodbv2new) constructor.\n  - `elasticsearch` (`list[obj]`):  When `null`, the `elasticsearch` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.elasticsearch.new](#fn-iot_topic_ruleelasticsearchnew) constructor.\n  - `error_action` (`list[obj]`):  When `null`, the `error_action` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.error_action.new](#fn-iot_topic_ruleerror_actionnew) constructor.\n  - `firehose` (`list[obj]`):  When `null`, the `firehose` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.firehose.new](#fn-iot_topic_rulefirehosenew) constructor.\n  - `http` (`list[obj]`):  When `null`, the `http` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.http.new](#fn-iot_topic_rulehttpnew) constructor.\n  - `iot_analytics` (`list[obj]`):  When `null`, the `iot_analytics` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.iot_analytics.new](#fn-iot_topic_ruleiot_analyticsnew) constructor.\n  - `iot_events` (`list[obj]`):  When `null`, the `iot_events` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.iot_events.new](#fn-iot_topic_ruleiot_eventsnew) constructor.\n  - `kafka` (`list[obj]`):  When `null`, the `kafka` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.kafka.new](#fn-iot_topic_rulekafkanew) constructor.\n  - `kinesis` (`list[obj]`):  When `null`, the `kinesis` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.kinesis.new](#fn-iot_topic_rulekinesisnew) constructor.\n  - `lambda` (`list[obj]`):  When `null`, the `lambda` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.lambda.new](#fn-iot_topic_rulelambdanew) constructor.\n  - `republish` (`list[obj]`):  When `null`, the `republish` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.republish.new](#fn-iot_topic_rulerepublishnew) constructor.\n  - `s3` (`list[obj]`):  When `null`, the `s3` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.s3.new](#fn-iot_topic_rules3new) constructor.\n  - `sns` (`list[obj]`):  When `null`, the `sns` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.sns.new](#fn-iot_topic_rulesnsnew) constructor.\n  - `sqs` (`list[obj]`):  When `null`, the `sqs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.sqs.new](#fn-iot_topic_rulesqsnew) constructor.\n  - `step_functions` (`list[obj]`):  When `null`, the `step_functions` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.step_functions.new](#fn-iot_topic_rulestep_functionsnew) constructor.\n  - `timestream` (`list[obj]`):  When `null`, the `timestream` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.iot_topic_rule.timestream.new](#fn-iot_topic_ruletimestreamnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    enabled,
    name,
