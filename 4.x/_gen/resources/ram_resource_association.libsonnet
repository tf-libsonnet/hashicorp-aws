...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withResourceArn':: d.fn(help='`aws.ram_resource_association.withResourceArn` constructs a mixin object that can be merged into the `ram_resource_association`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
  ...
  '#withResourceShareArn':: d.fn(help='`aws.ram_resource_association.withResourceShareArn` constructs a mixin object that can be merged into the `ram_resource_association`\nTerraform resource block to set or update the resource_share_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_share_arn` field.\n', args=[]),
