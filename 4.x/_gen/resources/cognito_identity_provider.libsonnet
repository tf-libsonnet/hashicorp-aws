...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAttributeMapping':: d.fn(help='`aws.cognito_identity_provider.withAttributeMapping` constructs a mixin object that can be merged into the `cognito_identity_provider`\nTerraform resource block to set or update the attribute_mapping field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `attribute_mapping` field.\n', args=[]),
  ...
  '#withIdpIdentifiers':: d.fn(help='`aws.cognito_identity_provider.withIdpIdentifiers` constructs a mixin object that can be merged into the `cognito_identity_provider`\nTerraform resource block to set or update the idp_identifiers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `idp_identifiers` field.\n', args=[]),
  ...
  '#withProviderDetails':: d.fn(help='`aws.cognito_identity_provider.withProviderDetails` constructs a mixin object that can be merged into the `cognito_identity_provider`\nTerraform resource block to set or update the provider_details field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_details` field.\n', args=[]),
  ...
  '#withProviderName':: d.fn(help='`aws.cognito_identity_provider.withProviderName` constructs a mixin object that can be merged into the `cognito_identity_provider`\nTerraform resource block to set or update the provider_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_name` field.\n', args=[]),
  ...
  '#withProviderType':: d.fn(help='`aws.cognito_identity_provider.withProviderType` constructs a mixin object that can be merged into the `cognito_identity_provider`\nTerraform resource block to set or update the provider_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_type` field.\n', args=[]),
  ...
  '#withUserPoolId':: d.fn(help='`aws.cognito_identity_provider.withUserPoolId` constructs a mixin object that can be merged into the `cognito_identity_provider`\nTerraform resource block to set or update the user_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_pool_id` field.\n', args=[]),
