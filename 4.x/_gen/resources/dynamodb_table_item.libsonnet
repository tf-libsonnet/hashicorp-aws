...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHashKey':: d.fn(help='`aws.dynamodb_table_item.withHashKey` constructs a mixin object that can be merged into the `dynamodb_table_item`\nTerraform resource block to set or update the hash_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hash_key` field.\n', args=[]),
  ...
  '#withItem':: d.fn(help='`aws.dynamodb_table_item.withItem` constructs a mixin object that can be merged into the `dynamodb_table_item`\nTerraform resource block to set or update the item field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `item` field.\n', args=[]),
  ...
  '#withRangeKey':: d.fn(help='`aws.dynamodb_table_item.withRangeKey` constructs a mixin object that can be merged into the `dynamodb_table_item`\nTerraform resource block to set or update the range_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `range_key` field.\n', args=[]),
