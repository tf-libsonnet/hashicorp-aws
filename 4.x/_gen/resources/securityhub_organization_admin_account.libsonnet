...
{
  '#':: d.pkg(name='securityhub_organization_admin_account', url='', help='`securityhub_organization_admin_account` represents the `aws_securityhub_organization_admin_account` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withAdminAccountId':: d.fn(help='`aws.securityhub_organization_admin_account.withAdminAccountId` constructs a mixin object that can be merged into the `securityhub_organization_admin_account`\nTerraform resource block to set or update the admin_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `admin_account_id` field.\n', args=[]),
