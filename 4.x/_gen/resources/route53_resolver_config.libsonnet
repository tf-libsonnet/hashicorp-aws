...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutodefinedReverseFlag':: d.fn(help='`aws.route53_resolver_config.withAutodefinedReverseFlag` constructs a mixin object that can be merged into the `route53_resolver_config`\nTerraform resource block to set or update the autodefined_reverse_flag field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `autodefined_reverse_flag` field.\n', args=[]),
  ...
  '#withResourceId':: d.fn(help='`aws.route53_resolver_config.withResourceId` constructs a mixin object that can be merged into the `route53_resolver_config`\nTerraform resource block to set or update the resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_id` field.\n', args=[]),
