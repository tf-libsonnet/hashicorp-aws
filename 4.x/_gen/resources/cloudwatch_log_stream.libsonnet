...
{
  '#':: d.pkg(name='cloudwatch_log_stream', url='', help='`cloudwatch_log_stream` represents the `aws_cloudwatch_log_stream` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withLogGroupName':: d.fn(help='`aws.cloudwatch_log_stream.withLogGroupName` constructs a mixin object that can be merged into the `cloudwatch_log_stream`\nTerraform resource block to set or update the log_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `log_group_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudwatch_log_stream.withName` constructs a mixin object that can be merged into the `cloudwatch_log_stream`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
