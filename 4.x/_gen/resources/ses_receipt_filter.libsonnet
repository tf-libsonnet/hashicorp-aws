...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCidr':: d.fn(help='`aws.ses_receipt_filter.withCidr` constructs a mixin object that can be merged into the `ses_receipt_filter`\nTerraform resource block to set or update the cidr field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cidr` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.ses_receipt_filter.withName` constructs a mixin object that can be merged into the `ses_receipt_filter`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.ses_receipt_filter.withPolicy` constructs a mixin object that can be merged into the `ses_receipt_filter`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
