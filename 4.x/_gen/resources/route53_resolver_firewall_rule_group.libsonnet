...
{
  '#':: d.pkg(name='route53_resolver_firewall_rule_group', url='', help='`route53_resolver_firewall_rule_group` represents the `aws_route53_resolver_firewall_rule_group` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.route53_resolver_firewall_rule_group.withName` constructs a mixin object that can be merged into the `route53_resolver_firewall_rule_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.route53_resolver_firewall_rule_group.withTags` constructs a mixin object that can be merged into the `route53_resolver_firewall_rule_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.route53_resolver_firewall_rule_group.withTagsAll` constructs a mixin object that can be merged into the `route53_resolver_firewall_rule_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
