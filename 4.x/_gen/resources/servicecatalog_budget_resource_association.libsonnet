...
{
  '#':: d.pkg(name='servicecatalog_budget_resource_association', url='', help='`servicecatalog_budget_resource_association` represents the `aws_servicecatalog_budget_resource_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBudgetName':: d.fn(help='`aws.servicecatalog_budget_resource_association.withBudgetName` constructs a mixin object that can be merged into the `servicecatalog_budget_resource_association`\nTerraform resource block to set or update the budget_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `budget_name` field.\n', args=[]),
  ...
  '#withResourceId':: d.fn(help='`aws.servicecatalog_budget_resource_association.withResourceId` constructs a mixin object that can be merged into the `servicecatalog_budget_resource_association`\nTerraform resource block to set or update the resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.servicecatalog_budget_resource_association.withTimeouts` constructs a mixin object that can be merged into the `servicecatalog_budget_resource_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.servicecatalog_budget_resource_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `servicecatalog_budget_resource_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.servicecatalog_budget_resource_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
