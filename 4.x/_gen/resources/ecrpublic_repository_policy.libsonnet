...
{
  '#':: d.pkg(name='ecrpublic_repository_policy', url='', help='`ecrpublic_repository_policy` represents the `aws_ecrpublic_repository_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPolicy':: d.fn(help='`aws.ecrpublic_repository_policy.withPolicy` constructs a mixin object that can be merged into the `ecrpublic_repository_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withRepositoryName':: d.fn(help='`aws.ecrpublic_repository_policy.withRepositoryName` constructs a mixin object that can be merged into the `ecrpublic_repository_policy`\nTerraform resource block to set or update the repository_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository_name` field.\n', args=[]),
