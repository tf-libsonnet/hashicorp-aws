...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.securityhub_action_target.withDescription` constructs a mixin object that can be merged into the `securityhub_action_target`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withIdentifier':: d.fn(help='`aws.securityhub_action_target.withIdentifier` constructs a mixin object that can be merged into the `securityhub_action_target`\nTerraform resource block to set or update the identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identifier` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.securityhub_action_target.withName` constructs a mixin object that can be merged into the `securityhub_action_target`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
