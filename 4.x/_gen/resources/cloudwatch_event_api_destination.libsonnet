...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConnectionArn':: d.fn(help='`aws.cloudwatch_event_api_destination.withConnectionArn` constructs a mixin object that can be merged into the `cloudwatch_event_api_destination`\nTerraform resource block to set or update the connection_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_arn` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.cloudwatch_event_api_destination.withDescription` constructs a mixin object that can be merged into the `cloudwatch_event_api_destination`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withHttpMethod':: d.fn(help='`aws.cloudwatch_event_api_destination.withHttpMethod` constructs a mixin object that can be merged into the `cloudwatch_event_api_destination`\nTerraform resource block to set or update the http_method field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `http_method` field.\n', args=[]),
  ...
  '#withInvocationEndpoint':: d.fn(help='`aws.cloudwatch_event_api_destination.withInvocationEndpoint` constructs a mixin object that can be merged into the `cloudwatch_event_api_destination`\nTerraform resource block to set or update the invocation_endpoint field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `invocation_endpoint` field.\n', args=[]),
  ...
  '#withInvocationRateLimitPerSecond':: d.fn(help='`aws.cloudwatch_event_api_destination.withInvocationRateLimitPerSecond` constructs a mixin object that can be merged into the `cloudwatch_event_api_destination`\nTerraform resource block to set or update the invocation_rate_limit_per_second field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `invocation_rate_limit_per_second` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudwatch_event_api_destination.withName` constructs a mixin object that can be merged into the `cloudwatch_event_api_destination`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
