...
{
  '#':: d.pkg(name='directory_service_log_subscription', url='', help='`directory_service_log_subscription` represents the `aws_directory_service_log_subscription` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDirectoryId':: d.fn(help='`aws.directory_service_log_subscription.withDirectoryId` constructs a mixin object that can be merged into the `directory_service_log_subscription`\nTerraform resource block to set or update the directory_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `directory_id` field.\n', args=[]),
  ...
  '#withLogGroupName':: d.fn(help='`aws.directory_service_log_subscription.withLogGroupName` constructs a mixin object that can be merged into the `directory_service_log_subscription`\nTerraform resource block to set or update the log_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `log_group_name` field.\n', args=[]),
