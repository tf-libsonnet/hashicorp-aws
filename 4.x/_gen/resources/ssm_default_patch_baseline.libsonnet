...
{
  '#':: d.pkg(name='ssm_default_patch_baseline', url='', help='`ssm_default_patch_baseline` represents the `aws_ssm_default_patch_baseline` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBaselineId':: d.fn(help='`aws.ssm_default_patch_baseline.withBaselineId` constructs a mixin object that can be merged into the `ssm_default_patch_baseline`\nTerraform resource block to set or update the baseline_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `baseline_id` field.\n', args=[]),
  ...
  '#withOperatingSystem':: d.fn(help='`aws.ssm_default_patch_baseline.withOperatingSystem` constructs a mixin object that can be merged into the `ssm_default_patch_baseline`\nTerraform resource block to set or update the operating_system field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `operating_system` field.\n', args=[]),
