...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIpv6CidrBlock':: d.fn(help='`aws.vpc_ipv6_cidr_block_association.withIpv6CidrBlock` constructs a mixin object that can be merged into the `vpc_ipv6_cidr_block_association`\nTerraform resource block to set or update the ipv6_cidr_block field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ipv6_cidr_block` field.\n', args=[]),
  ...
  '#withIpv6IpamPoolId':: d.fn(help='`aws.vpc_ipv6_cidr_block_association.withIpv6IpamPoolId` constructs a mixin object that can be merged into the `vpc_ipv6_cidr_block_association`\nTerraform resource block to set or update the ipv6_ipam_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ipv6_ipam_pool_id` field.\n', args=[]),
  ...
  '#withIpv6NetmaskLength':: d.fn(help='`aws.vpc_ipv6_cidr_block_association.withIpv6NetmaskLength` constructs a mixin object that can be merged into the `vpc_ipv6_cidr_block_association`\nTerraform resource block to set or update the ipv6_netmask_length field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ipv6_netmask_length` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.vpc_ipv6_cidr_block_association.withTimeouts` constructs a mixin object that can be merged into the `vpc_ipv6_cidr_block_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.vpc_ipv6_cidr_block_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpc_ipv6_cidr_block_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.vpc_ipv6_cidr_block_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpcId':: d.fn(help='`aws.vpc_ipv6_cidr_block_association.withVpcId` constructs a mixin object that can be merged into the `vpc_ipv6_cidr_block_association`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
