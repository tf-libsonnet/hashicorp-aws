...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppId':: d.fn(help='`aws.amplify_webhook.withAppId` constructs a mixin object that can be merged into the `amplify_webhook`\nTerraform resource block to set or update the app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_id` field.\n', args=[]),
  ...
  '#withBranchName':: d.fn(help='`aws.amplify_webhook.withBranchName` constructs a mixin object that can be merged into the `amplify_webhook`\nTerraform resource block to set or update the branch_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `branch_name` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.amplify_webhook.withDescription` constructs a mixin object that can be merged into the `amplify_webhook`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
