...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccessPolicy':: d.fn(help='`aws.cloudsearch_domain_service_access_policy.withAccessPolicy` constructs a mixin object that can be merged into the `cloudsearch_domain_service_access_policy`\nTerraform resource block to set or update the access_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `access_policy` field.\n', args=[]),
  ...
  '#withDomainName':: d.fn(help='`aws.cloudsearch_domain_service_access_policy.withDomainName` constructs a mixin object that can be merged into the `cloudsearch_domain_service_access_policy`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.cloudsearch_domain_service_access_policy.withTimeouts` constructs a mixin object that can be merged into the `cloudsearch_domain_service_access_policy`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.cloudsearch_domain_service_access_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudsearch_domain_service_access_policy`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.cloudsearch_domain_service_access_policy.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
