...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.lex_slot_type.withDescription` constructs a mixin object that can be merged into the `lex_slot_type`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEnumerationValue':: d.fn(help='`aws.lex_slot_type.withEnumerationValue` constructs a mixin object that can be merged into the `lex_slot_type`\nTerraform resource block to set or update the enumeration_value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enumeration_value` field.\n', args=[]),
  ...
  '#withEnumerationValueMixin':: d.fn(help='`aws.lex_slot_type.withEnumerationValueMixin` constructs a mixin object that can be merged into the `lex_slot_type`\nTerraform resource block to set or update the enumeration_value field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.lex_slot_type.withEnumerationValue](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enumeration_value` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.lex_slot_type.withName` constructs a mixin object that can be merged into the `lex_slot_type`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.lex_slot_type.withTimeouts` constructs a mixin object that can be merged into the `lex_slot_type`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.lex_slot_type.withTimeoutsMixin` constructs a mixin object that can be merged into the `lex_slot_type`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.lex_slot_type.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withValueSelectionStrategy':: d.fn(help='`aws.lex_slot_type.withValueSelectionStrategy` constructs a mixin object that can be merged into the `lex_slot_type`\nTerraform resource block to set or update the value_selection_strategy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value_selection_strategy` field.\n', args=[]),
