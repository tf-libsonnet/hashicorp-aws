...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroupName':: d.fn(help='`aws.cognito_user_in_group.withGroupName` constructs a mixin object that can be merged into the `cognito_user_in_group`\nTerraform resource block to set or update the group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_name` field.\n', args=[]),
  ...
  '#withUserPoolId':: d.fn(help='`aws.cognito_user_in_group.withUserPoolId` constructs a mixin object that can be merged into the `cognito_user_in_group`\nTerraform resource block to set or update the user_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_pool_id` field.\n', args=[]),
  ...
  '#withUsername':: d.fn(help='`aws.cognito_user_in_group.withUsername` constructs a mixin object that can be merged into the `cognito_user_in_group`\nTerraform resource block to set or update the username field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `username` field.\n', args=[]),
