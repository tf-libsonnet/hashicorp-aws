...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKeyId':: d.fn(help='`aws.xray_encryption_config.withKeyId` constructs a mixin object that can be merged into the `xray_encryption_config`\nTerraform resource block to set or update the key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_id` field.\n', args=[]),
  ...
  '#withType':: d.fn(help='`aws.xray_encryption_config.withType` constructs a mixin object that can be merged into the `xray_encryption_config`\nTerraform resource block to set or update the type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type` field.\n', args=[]),
