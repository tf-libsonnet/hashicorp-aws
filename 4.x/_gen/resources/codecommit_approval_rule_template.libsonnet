...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withContent':: d.fn(help='`aws.codecommit_approval_rule_template.withContent` constructs a mixin object that can be merged into the `codecommit_approval_rule_template`\nTerraform resource block to set or update the content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.codecommit_approval_rule_template.withDescription` constructs a mixin object that can be merged into the `codecommit_approval_rule_template`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.codecommit_approval_rule_template.withName` constructs a mixin object that can be merged into the `codecommit_approval_rule_template`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
