...
{
  '#':: d.pkg(name='lightsail_static_ip', url='', help='`lightsail_static_ip` represents the `aws_lightsail_static_ip` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.lightsail_static_ip.withName` constructs a mixin object that can be merged into the `lightsail_static_ip`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
