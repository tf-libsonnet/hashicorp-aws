...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBranchFilter':: d.fn(help='`aws.codebuild_webhook.withBranchFilter` constructs a mixin object that can be merged into the `codebuild_webhook`\nTerraform resource block to set or update the branch_filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `branch_filter` field.\n', args=[]),
  ...
  '#withBuildType':: d.fn(help='`aws.codebuild_webhook.withBuildType` constructs a mixin object that can be merged into the `codebuild_webhook`\nTerraform resource block to set or update the build_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `build_type` field.\n', args=[]),
  ...
  '#withFilterGroup':: d.fn(help='`aws.codebuild_webhook.withFilterGroup` constructs a mixin object that can be merged into the `codebuild_webhook`\nTerraform resource block to set or update the filter_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter_group` field.\n', args=[]),
  ...
  '#withFilterGroupMixin':: d.fn(help='`aws.codebuild_webhook.withFilterGroupMixin` constructs a mixin object that can be merged into the `codebuild_webhook`\nTerraform resource block to set or update the filter_group field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.codebuild_webhook.withFilterGroup](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter_group` field.\n', args=[]),
  ...
  '#withProjectName':: d.fn(help='`aws.codebuild_webhook.withProjectName` constructs a mixin object that can be merged into the `codebuild_webhook`\nTerraform resource block to set or update the project_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project_name` field.\n', args=[]),
