...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGlobalTableArn':: d.fn(help='`aws.dynamodb_table_replica.withGlobalTableArn` constructs a mixin object that can be merged into the `dynamodb_table_replica`\nTerraform resource block to set or update the global_table_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `global_table_arn` field.\n', args=[]),
  ...
  '#withKmsKeyArn':: d.fn(help='`aws.dynamodb_table_replica.withKmsKeyArn` constructs a mixin object that can be merged into the `dynamodb_table_replica`\nTerraform resource block to set or update the kms_key_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_arn` field.\n', args=[]),
  ...
  '#withPointInTimeRecovery':: d.fn(help='`aws.dynamodb_table_replica.withPointInTimeRecovery` constructs a mixin object that can be merged into the `dynamodb_table_replica`\nTerraform resource block to set or update the point_in_time_recovery field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `point_in_time_recovery` field.\n', args=[]),
  ...
  '#withTableClassOverride':: d.fn(help='`aws.dynamodb_table_replica.withTableClassOverride` constructs a mixin object that can be merged into the `dynamodb_table_replica`\nTerraform resource block to set or update the table_class_override field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_class_override` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.dynamodb_table_replica.withTags` constructs a mixin object that can be merged into the `dynamodb_table_replica`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.dynamodb_table_replica.withTagsAll` constructs a mixin object that can be merged into the `dynamodb_table_replica`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.dynamodb_table_replica.withTimeouts` constructs a mixin object that can be merged into the `dynamodb_table_replica`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.dynamodb_table_replica.withTimeoutsMixin` constructs a mixin object that can be merged into the `dynamodb_table_replica`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.dynamodb_table_replica.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
