...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstanceName':: d.fn(help='`aws.lightsail_instance_public_ports.withInstanceName` constructs a mixin object that can be merged into the `lightsail_instance_public_ports`\nTerraform resource block to set or update the instance_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_name` field.\n', args=[]),
  ...
  '#withPortInfo':: d.fn(help='`aws.lightsail_instance_public_ports.withPortInfo` constructs a mixin object that can be merged into the `lightsail_instance_public_ports`\nTerraform resource block to set or update the port_info field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `port_info` field.\n', args=[]),
  ...
  '#withPortInfoMixin':: d.fn(help='`aws.lightsail_instance_public_ports.withPortInfoMixin` constructs a mixin object that can be merged into the `lightsail_instance_public_ports`\nTerraform resource block to set or update the port_info field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.lightsail_instance_public_ports.withPortInfo](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `port_info` field.\n', args=[]),
