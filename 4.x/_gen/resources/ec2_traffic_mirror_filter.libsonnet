...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.ec2_traffic_mirror_filter.withDescription` constructs a mixin object that can be merged into the `ec2_traffic_mirror_filter`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withNetworkServices':: d.fn(help='`aws.ec2_traffic_mirror_filter.withNetworkServices` constructs a mixin object that can be merged into the `ec2_traffic_mirror_filter`\nTerraform resource block to set or update the network_services field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_services` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.ec2_traffic_mirror_filter.withTags` constructs a mixin object that can be merged into the `ec2_traffic_mirror_filter`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ec2_traffic_mirror_filter.withTagsAll` constructs a mixin object that can be merged into the `ec2_traffic_mirror_filter`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
