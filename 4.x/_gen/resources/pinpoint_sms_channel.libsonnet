...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationId':: d.fn(help='`aws.pinpoint_sms_channel.withApplicationId` constructs a mixin object that can be merged into the `pinpoint_sms_channel`\nTerraform resource block to set or update the application_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_id` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`aws.pinpoint_sms_channel.withEnabled` constructs a mixin object that can be merged into the `pinpoint_sms_channel`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withSenderId':: d.fn(help='`aws.pinpoint_sms_channel.withSenderId` constructs a mixin object that can be merged into the `pinpoint_sms_channel`\nTerraform resource block to set or update the sender_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sender_id` field.\n', args=[]),
  ...
  '#withShortCode':: d.fn(help='`aws.pinpoint_sms_channel.withShortCode` constructs a mixin object that can be merged into the `pinpoint_sms_channel`\nTerraform resource block to set or update the short_code field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `short_code` field.\n', args=[]),
