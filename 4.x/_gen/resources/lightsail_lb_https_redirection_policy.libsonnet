...
{
  '#':: d.pkg(name='lightsail_lb_https_redirection_policy', url='', help='`lightsail_lb_https_redirection_policy` represents the `aws_lightsail_lb_https_redirection_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withEnabled':: d.fn(help='`aws.lightsail_lb_https_redirection_policy.withEnabled` constructs a mixin object that can be merged into the `lightsail_lb_https_redirection_policy`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withLbName':: d.fn(help='`aws.lightsail_lb_https_redirection_policy.withLbName` constructs a mixin object that can be merged into the `lightsail_lb_https_redirection_policy`\nTerraform resource block to set or update the lb_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lb_name` field.\n', args=[]),
