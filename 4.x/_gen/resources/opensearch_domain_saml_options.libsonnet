...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomainName':: d.fn(help='`aws.opensearch_domain_saml_options.withDomainName` constructs a mixin object that can be merged into the `opensearch_domain_saml_options`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withSamlOptions':: d.fn(help='`aws.opensearch_domain_saml_options.withSamlOptions` constructs a mixin object that can be merged into the `opensearch_domain_saml_options`\nTerraform resource block to set or update the saml_options field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `saml_options` field.\n', args=[]),
  ...
  '#withSamlOptionsMixin':: d.fn(help='`aws.opensearch_domain_saml_options.withSamlOptionsMixin` constructs a mixin object that can be merged into the `opensearch_domain_saml_options`\nTerraform resource block to set or update the saml_options field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.opensearch_domain_saml_options.withSamlOptions](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `saml_options` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.opensearch_domain_saml_options.withTimeouts` constructs a mixin object that can be merged into the `opensearch_domain_saml_options`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.opensearch_domain_saml_options.withTimeoutsMixin` constructs a mixin object that can be merged into the `opensearch_domain_saml_options`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.opensearch_domain_saml_options.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
