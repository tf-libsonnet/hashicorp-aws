...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.opensearch_domain_saml_options.new` injects a new `aws_opensearch_domain_saml_options` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.opensearch_domain_saml_options.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.opensearch_domain_saml_options` using the reference:\n\n    $._ref.aws_opensearch_domain_saml_options.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_opensearch_domain_saml_options.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `domain_name` (`string`): \n  - `saml_options` (`list[obj]`):  When `null`, the `saml_options` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opensearch_domain_saml_options.saml_options.new](#fn-opensearch_domain_saml_optionssaml_optionsnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.opensearch_domain_saml_options.timeouts.new](#fn-opensearch_domain_saml_optionstimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    domain_name,
    saml_options=null,
