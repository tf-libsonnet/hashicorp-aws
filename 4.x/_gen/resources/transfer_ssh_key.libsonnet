...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBody':: d.fn(help='`aws.transfer_ssh_key.withBody` constructs a mixin object that can be merged into the `transfer_ssh_key`\nTerraform resource block to set or update the body field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `body` field.\n', args=[]),
  ...
  '#withServerId':: d.fn(help='`aws.transfer_ssh_key.withServerId` constructs a mixin object that can be merged into the `transfer_ssh_key`\nTerraform resource block to set or update the server_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_id` field.\n', args=[]),
  ...
  '#withUserName':: d.fn(help='`aws.transfer_ssh_key.withUserName` constructs a mixin object that can be merged into the `transfer_ssh_key`\nTerraform resource block to set or update the user_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_name` field.\n', args=[]),
