...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.glue_workflow.withDescription` constructs a mixin object that can be merged into the `glue_workflow`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withMaxConcurrentRuns':: d.fn(help='`aws.glue_workflow.withMaxConcurrentRuns` constructs a mixin object that can be merged into the `glue_workflow`\nTerraform resource block to set or update the max_concurrent_runs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `max_concurrent_runs` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.glue_workflow.withName` constructs a mixin object that can be merged into the `glue_workflow`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.glue_workflow.withTags` constructs a mixin object that can be merged into the `glue_workflow`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.glue_workflow.withTagsAll` constructs a mixin object that can be merged into the `glue_workflow`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
