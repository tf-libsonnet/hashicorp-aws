...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNetworkInterfaceId':: d.fn(help='`aws.network_interface_sg_attachment.withNetworkInterfaceId` constructs a mixin object that can be merged into the `network_interface_sg_attachment`\nTerraform resource block to set or update the network_interface_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_interface_id` field.\n', args=[]),
  ...
  '#withSecurityGroupId':: d.fn(help='`aws.network_interface_sg_attachment.withSecurityGroupId` constructs a mixin object that can be merged into the `network_interface_sg_attachment`\nTerraform resource block to set or update the security_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_group_id` field.\n', args=[]),
