...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCatalogId':: d.fn(help='`aws.glue_partition.withCatalogId` constructs a mixin object that can be merged into the `glue_partition`\nTerraform resource block to set or update the catalog_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `catalog_id` field.\n', args=[]),
  ...
  '#withDatabaseName':: d.fn(help='`aws.glue_partition.withDatabaseName` constructs a mixin object that can be merged into the `glue_partition`\nTerraform resource block to set or update the database_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database_name` field.\n', args=[]),
  ...
  '#withParameters':: d.fn(help='`aws.glue_partition.withParameters` constructs a mixin object that can be merged into the `glue_partition`\nTerraform resource block to set or update the parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters` field.\n', args=[]),
  ...
  '#withPartitionValues':: d.fn(help='`aws.glue_partition.withPartitionValues` constructs a mixin object that can be merged into the `glue_partition`\nTerraform resource block to set or update the partition_values field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_values` field.\n', args=[]),
  ...
  '#withStorageDescriptor':: d.fn(help='`aws.glue_partition.withStorageDescriptor` constructs a mixin object that can be merged into the `glue_partition`\nTerraform resource block to set or update the storage_descriptor field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_descriptor` field.\n', args=[]),
  ...
  '#withStorageDescriptorMixin':: d.fn(help='`aws.glue_partition.withStorageDescriptorMixin` constructs a mixin object that can be merged into the `glue_partition`\nTerraform resource block to set or update the storage_descriptor field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_partition.withStorageDescriptor](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_descriptor` field.\n', args=[]),
  ...
  '#withTableName':: d.fn(help='`aws.glue_partition.withTableName` constructs a mixin object that can be merged into the `glue_partition`\nTerraform resource block to set or update the table_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_name` field.\n', args=[]),
