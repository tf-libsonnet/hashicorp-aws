...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKeyName':: d.fn(help='`aws.grafana_workspace_api_key.withKeyName` constructs a mixin object that can be merged into the `grafana_workspace_api_key`\nTerraform resource block to set or update the key_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_name` field.\n', args=[]),
  ...
  '#withKeyRole':: d.fn(help='`aws.grafana_workspace_api_key.withKeyRole` constructs a mixin object that can be merged into the `grafana_workspace_api_key`\nTerraform resource block to set or update the key_role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_role` field.\n', args=[]),
  ...
  '#withSecondsToLive':: d.fn(help='`aws.grafana_workspace_api_key.withSecondsToLive` constructs a mixin object that can be merged into the `grafana_workspace_api_key`\nTerraform resource block to set or update the seconds_to_live field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `seconds_to_live` field.\n', args=[]),
  ...
  '#withWorkspaceId':: d.fn(help='`aws.grafana_workspace_api_key.withWorkspaceId` constructs a mixin object that can be merged into the `grafana_workspace_api_key`\nTerraform resource block to set or update the workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workspace_id` field.\n', args=[]),
