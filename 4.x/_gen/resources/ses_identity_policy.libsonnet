...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIdentity':: d.fn(help='`aws.ses_identity_policy.withIdentity` constructs a mixin object that can be merged into the `ses_identity_policy`\nTerraform resource block to set or update the identity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.ses_identity_policy.withName` constructs a mixin object that can be merged into the `ses_identity_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.ses_identity_policy.withPolicy` constructs a mixin object that can be merged into the `ses_identity_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
