...
{
  '#':: d.pkg(name='dx_hosted_private_virtual_interface_accepter', url='', help='`dx_hosted_private_virtual_interface_accepter` represents the `aws_dx_hosted_private_virtual_interface_accepter` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDxGatewayId':: d.fn(help='`aws.dx_hosted_private_virtual_interface_accepter.withDxGatewayId` constructs a mixin object that can be merged into the `dx_hosted_private_virtual_interface_accepter`\nTerraform resource block to set or update the dx_gateway_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dx_gateway_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.dx_hosted_private_virtual_interface_accepter.withTags` constructs a mixin object that can be merged into the `dx_hosted_private_virtual_interface_accepter`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.dx_hosted_private_virtual_interface_accepter.withTagsAll` constructs a mixin object that can be merged into the `dx_hosted_private_virtual_interface_accepter`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.dx_hosted_private_virtual_interface_accepter.withTimeouts` constructs a mixin object that can be merged into the `dx_hosted_private_virtual_interface_accepter`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.dx_hosted_private_virtual_interface_accepter.withTimeoutsMixin` constructs a mixin object that can be merged into the `dx_hosted_private_virtual_interface_accepter`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.dx_hosted_private_virtual_interface_accepter.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVirtualInterfaceId':: d.fn(help='`aws.dx_hosted_private_virtual_interface_accepter.withVirtualInterfaceId` constructs a mixin object that can be merged into the `dx_hosted_private_virtual_interface_accepter`\nTerraform resource block to set or update the virtual_interface_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_interface_id` field.\n', args=[]),
  ...
  '#withVpnGatewayId':: d.fn(help='`aws.dx_hosted_private_virtual_interface_accepter.withVpnGatewayId` constructs a mixin object that can be merged into the `dx_hosted_private_virtual_interface_accepter`\nTerraform resource block to set or update the vpn_gateway_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpn_gateway_id` field.\n', args=[]),
