...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.dynamodb_global_table.withName` constructs a mixin object that can be merged into the `dynamodb_global_table`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withReplica':: d.fn(help='`aws.dynamodb_global_table.withReplica` constructs a mixin object that can be merged into the `dynamodb_global_table`\nTerraform resource block to set or update the replica field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `replica` field.\n', args=[]),
  ...
  '#withReplicaMixin':: d.fn(help='`aws.dynamodb_global_table.withReplicaMixin` constructs a mixin object that can be merged into the `dynamodb_global_table`\nTerraform resource block to set or update the replica field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.dynamodb_global_table.withReplica](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `replica` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.dynamodb_global_table.withTimeouts` constructs a mixin object that can be merged into the `dynamodb_global_table`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.dynamodb_global_table.withTimeoutsMixin` constructs a mixin object that can be merged into the `dynamodb_global_table`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.dynamodb_global_table.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
