...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.waf_xss_match_set.withName` constructs a mixin object that can be merged into the `waf_xss_match_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withXssMatchTuples':: d.fn(help='`aws.waf_xss_match_set.withXssMatchTuples` constructs a mixin object that can be merged into the `waf_xss_match_set`\nTerraform resource block to set or update the xss_match_tuples field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `xss_match_tuples` field.\n', args=[]),
  ...
  '#withXssMatchTuplesMixin':: d.fn(help='`aws.waf_xss_match_set.withXssMatchTuplesMixin` constructs a mixin object that can be merged into the `waf_xss_match_set`\nTerraform resource block to set or update the xss_match_tuples field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.waf_xss_match_set.withXssMatchTuples](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `xss_match_tuples` field.\n', args=[]),
