...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  activated_rule:: {
    ...
    '#new':: d.fn(help='\n`aws.waf_rule_group.activated_rule.new` constructs a new object with attributes and blocks configured for the `activated_rule`\nTerraform sub block.\n\n\n\n**Args**:\n  - `priority` (`number`): \n  - `rule_id` (`string`): \n  - `type` (`string`):  When `null`, the `type` field will be omitted from the resulting object.\n  - `action` (`list[obj]`):  When `null`, the `action` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.waf_rule_group.activated_rule.action.new](#fn-actionnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `activated_rule` sub block.\n', args=[]),
    new(
      priority,
      rule_id,
      action=null,
