...
{
  '#':: d.pkg(name='waf_rule_group', url='', help='`waf_rule_group` represents the `aws_waf_rule_group` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  activated_rule:: {
    action:: {
  ...
  '#withActivatedRule':: d.fn(help='`aws.waf_rule_group.withActivatedRule` constructs a mixin object that can be merged into the `waf_rule_group`\nTerraform resource block to set or update the activated_rule field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `activated_rule` field.\n', args=[]),
  ...
  '#withActivatedRuleMixin':: d.fn(help='`aws.waf_rule_group.withActivatedRuleMixin` constructs a mixin object that can be merged into the `waf_rule_group`\nTerraform resource block to set or update the activated_rule field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.waf_rule_group.withActivatedRule](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `activated_rule` field.\n', args=[]),
  ...
  '#withMetricName':: d.fn(help='`aws.waf_rule_group.withMetricName` constructs a mixin object that can be merged into the `waf_rule_group`\nTerraform resource block to set or update the metric_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metric_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.waf_rule_group.withName` constructs a mixin object that can be merged into the `waf_rule_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.waf_rule_group.withTags` constructs a mixin object that can be merged into the `waf_rule_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.waf_rule_group.withTagsAll` constructs a mixin object that can be merged into the `waf_rule_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
