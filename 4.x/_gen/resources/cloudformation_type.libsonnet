...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withExecutionRoleArn':: d.fn(help='`aws.cloudformation_type.withExecutionRoleArn` constructs a mixin object that can be merged into the `cloudformation_type`\nTerraform resource block to set or update the execution_role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `execution_role_arn` field.\n', args=[]),
  ...
  '#withLoggingConfig':: d.fn(help='`aws.cloudformation_type.withLoggingConfig` constructs a mixin object that can be merged into the `cloudformation_type`\nTerraform resource block to set or update the logging_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_config` field.\n', args=[]),
  ...
  '#withLoggingConfigMixin':: d.fn(help='`aws.cloudformation_type.withLoggingConfigMixin` constructs a mixin object that can be merged into the `cloudformation_type`\nTerraform resource block to set or update the logging_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudformation_type.withLoggingConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_config` field.\n', args=[]),
  ...
  '#withSchemaHandlerPackage':: d.fn(help='`aws.cloudformation_type.withSchemaHandlerPackage` constructs a mixin object that can be merged into the `cloudformation_type`\nTerraform resource block to set or update the schema_handler_package field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schema_handler_package` field.\n', args=[]),
  ...
  '#withType':: d.fn(help='`aws.cloudformation_type.withType` constructs a mixin object that can be merged into the `cloudformation_type`\nTerraform resource block to set or update the type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type` field.\n', args=[]),
  ...
  '#withTypeName':: d.fn(help='`aws.cloudformation_type.withTypeName` constructs a mixin object that can be merged into the `cloudformation_type`\nTerraform resource block to set or update the type_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type_name` field.\n', args=[]),
