...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBackupVaultName':: d.fn(help='`aws.backup_vault_policy.withBackupVaultName` constructs a mixin object that can be merged into the `backup_vault_policy`\nTerraform resource block to set or update the backup_vault_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup_vault_name` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.backup_vault_policy.withPolicy` constructs a mixin object that can be merged into the `backup_vault_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
