...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLicenseType':: d.fn(help='`aws.grafana_license_association.withLicenseType` constructs a mixin object that can be merged into the `grafana_license_association`\nTerraform resource block to set or update the license_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `license_type` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.grafana_license_association.withTimeouts` constructs a mixin object that can be merged into the `grafana_license_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.grafana_license_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `grafana_license_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.grafana_license_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withWorkspaceId':: d.fn(help='`aws.grafana_license_association.withWorkspaceId` constructs a mixin object that can be merged into the `grafana_license_association`\nTerraform resource block to set or update the workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workspace_id` field.\n', args=[]),
