...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFirewallArn':: d.fn(help='`aws.networkfirewall_logging_configuration.withFirewallArn` constructs a mixin object that can be merged into the `networkfirewall_logging_configuration`\nTerraform resource block to set or update the firewall_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `firewall_arn` field.\n', args=[]),
  ...
  '#withLoggingConfiguration':: d.fn(help='`aws.networkfirewall_logging_configuration.withLoggingConfiguration` constructs a mixin object that can be merged into the `networkfirewall_logging_configuration`\nTerraform resource block to set or update the logging_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_configuration` field.\n', args=[]),
  ...
  '#withLoggingConfigurationMixin':: d.fn(help='`aws.networkfirewall_logging_configuration.withLoggingConfigurationMixin` constructs a mixin object that can be merged into the `networkfirewall_logging_configuration`\nTerraform resource block to set or update the logging_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.networkfirewall_logging_configuration.withLoggingConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_configuration` field.\n', args=[]),
