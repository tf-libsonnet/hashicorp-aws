...
{
  '#':: d.pkg(name='service_discovery_private_dns_namespace', url='', help='`service_discovery_private_dns_namespace` represents the `aws_service_discovery_private_dns_namespace` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`aws.service_discovery_private_dns_namespace.withDescription` constructs a mixin object that can be merged into the `service_discovery_private_dns_namespace`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.service_discovery_private_dns_namespace.withName` constructs a mixin object that can be merged into the `service_discovery_private_dns_namespace`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.service_discovery_private_dns_namespace.withTags` constructs a mixin object that can be merged into the `service_discovery_private_dns_namespace`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.service_discovery_private_dns_namespace.withTagsAll` constructs a mixin object that can be merged into the `service_discovery_private_dns_namespace`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withVpc':: d.fn(help='`aws.service_discovery_private_dns_namespace.withVpc` constructs a mixin object that can be merged into the `service_discovery_private_dns_namespace`\nTerraform resource block to set or update the vpc field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc` field.\n', args=[]),
