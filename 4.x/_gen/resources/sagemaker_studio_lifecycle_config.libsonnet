...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStudioLifecycleConfigAppType':: d.fn(help='`aws.sagemaker_studio_lifecycle_config.withStudioLifecycleConfigAppType` constructs a mixin object that can be merged into the `sagemaker_studio_lifecycle_config`\nTerraform resource block to set or update the studio_lifecycle_config_app_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `studio_lifecycle_config_app_type` field.\n', args=[]),
  ...
  '#withStudioLifecycleConfigContent':: d.fn(help='`aws.sagemaker_studio_lifecycle_config.withStudioLifecycleConfigContent` constructs a mixin object that can be merged into the `sagemaker_studio_lifecycle_config`\nTerraform resource block to set or update the studio_lifecycle_config_content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `studio_lifecycle_config_content` field.\n', args=[]),
  ...
  '#withStudioLifecycleConfigName':: d.fn(help='`aws.sagemaker_studio_lifecycle_config.withStudioLifecycleConfigName` constructs a mixin object that can be merged into the `sagemaker_studio_lifecycle_config`\nTerraform resource block to set or update the studio_lifecycle_config_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `studio_lifecycle_config_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.sagemaker_studio_lifecycle_config.withTags` constructs a mixin object that can be merged into the `sagemaker_studio_lifecycle_config`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.sagemaker_studio_lifecycle_config.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_studio_lifecycle_config`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
