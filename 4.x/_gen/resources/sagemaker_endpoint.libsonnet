...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  deployment_config:: {
    auto_rollback_configuration:: {
      ...
      '#new':: d.fn(help='\n`aws.sagemaker_endpoint.deployment_config.auto_rollback_configuration.new` constructs a new object with attributes and blocks configured for the `auto_rollback_configuration`\nTerraform sub block.\n\n\n\n**Args**:\n  - `alarms` (`list[obj]`):  When `null`, the `alarms` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.sagemaker_endpoint.deployment_config.auto_rollback_configuration.alarms.new](#fn-autorollbackconfigurationalarmsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `auto_rollback_configuration` sub block.\n', args=[]),
      new(
        alarms=null
      ):: std.prune(a={
        alarms: alarms,
  ...
  '#withDeploymentConfig':: d.fn(help='`aws.sagemaker_endpoint.withDeploymentConfig` constructs a mixin object that can be merged into the `sagemaker_endpoint`\nTerraform resource block to set or update the deployment_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deployment_config` field.\n', args=[]),
  ...
  '#withDeploymentConfigMixin':: d.fn(help='`aws.sagemaker_endpoint.withDeploymentConfigMixin` constructs a mixin object that can be merged into the `sagemaker_endpoint`\nTerraform resource block to set or update the deployment_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.sagemaker_endpoint.withDeploymentConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deployment_config` field.\n', args=[]),
  ...
  '#withEndpointConfigName':: d.fn(help='`aws.sagemaker_endpoint.withEndpointConfigName` constructs a mixin object that can be merged into the `sagemaker_endpoint`\nTerraform resource block to set or update the endpoint_config_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_config_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.sagemaker_endpoint.withName` constructs a mixin object that can be merged into the `sagemaker_endpoint`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.sagemaker_endpoint.withTags` constructs a mixin object that can be merged into the `sagemaker_endpoint`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.sagemaker_endpoint.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_endpoint`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
