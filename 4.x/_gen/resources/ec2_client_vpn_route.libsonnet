...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClientVpnEndpointId':: d.fn(help='`aws.ec2_client_vpn_route.withClientVpnEndpointId` constructs a mixin object that can be merged into the `ec2_client_vpn_route`\nTerraform resource block to set or update the client_vpn_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_vpn_endpoint_id` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.ec2_client_vpn_route.withDescription` constructs a mixin object that can be merged into the `ec2_client_vpn_route`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDestinationCidrBlock':: d.fn(help='`aws.ec2_client_vpn_route.withDestinationCidrBlock` constructs a mixin object that can be merged into the `ec2_client_vpn_route`\nTerraform resource block to set or update the destination_cidr_block field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_cidr_block` field.\n', args=[]),
  ...
  '#withTargetVpcSubnetId':: d.fn(help='`aws.ec2_client_vpn_route.withTargetVpcSubnetId` constructs a mixin object that can be merged into the `ec2_client_vpn_route`\nTerraform resource block to set or update the target_vpc_subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_vpc_subnet_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.ec2_client_vpn_route.withTimeouts` constructs a mixin object that can be merged into the `ec2_client_vpn_route`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.ec2_client_vpn_route.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_client_vpn_route`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.ec2_client_vpn_route.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
