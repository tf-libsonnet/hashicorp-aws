...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.cognito_user_group.withDescription` constructs a mixin object that can be merged into the `cognito_user_group`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cognito_user_group.withName` constructs a mixin object that can be merged into the `cognito_user_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPrecedence':: d.fn(help='`aws.cognito_user_group.withPrecedence` constructs a mixin object that can be merged into the `cognito_user_group`\nTerraform resource block to set or update the precedence field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `precedence` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.cognito_user_group.withRoleArn` constructs a mixin object that can be merged into the `cognito_user_group`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
  ...
  '#withUserPoolId':: d.fn(help='`aws.cognito_user_group.withUserPoolId` constructs a mixin object that can be merged into the `cognito_user_group`\nTerraform resource block to set or update the user_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_pool_id` field.\n', args=[]),
