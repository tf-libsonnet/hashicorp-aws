...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstanceArn':: d.fn(help='`aws.ssoadmin_account_assignment.withInstanceArn` constructs a mixin object that can be merged into the `ssoadmin_account_assignment`\nTerraform resource block to set or update the instance_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_arn` field.\n', args=[]),
  ...
  '#withPermissionSetArn':: d.fn(help='`aws.ssoadmin_account_assignment.withPermissionSetArn` constructs a mixin object that can be merged into the `ssoadmin_account_assignment`\nTerraform resource block to set or update the permission_set_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permission_set_arn` field.\n', args=[]),
  ...
  '#withPrincipalId':: d.fn(help='`aws.ssoadmin_account_assignment.withPrincipalId` constructs a mixin object that can be merged into the `ssoadmin_account_assignment`\nTerraform resource block to set or update the principal_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal_id` field.\n', args=[]),
  ...
  '#withPrincipalType':: d.fn(help='`aws.ssoadmin_account_assignment.withPrincipalType` constructs a mixin object that can be merged into the `ssoadmin_account_assignment`\nTerraform resource block to set or update the principal_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal_type` field.\n', args=[]),
  ...
  '#withTargetId':: d.fn(help='`aws.ssoadmin_account_assignment.withTargetId` constructs a mixin object that can be merged into the `ssoadmin_account_assignment`\nTerraform resource block to set or update the target_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_id` field.\n', args=[]),
  ...
  '#withTargetType':: d.fn(help='`aws.ssoadmin_account_assignment.withTargetType` constructs a mixin object that can be merged into the `ssoadmin_account_assignment`\nTerraform resource block to set or update the target_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_type` field.\n', args=[]),
