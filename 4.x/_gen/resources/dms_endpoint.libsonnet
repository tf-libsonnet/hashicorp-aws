...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.dms_endpoint.new` injects a new `aws_dms_endpoint` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.dms_endpoint.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.dms_endpoint` using the reference:\n\n    $._ref.aws_dms_endpoint.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_dms_endpoint.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `certificate_arn` (`string`):  When `null`, the `certificate_arn` field will be omitted from the resulting object.\n  - `database_name` (`string`):  When `null`, the `database_name` field will be omitted from the resulting object.\n  - `endpoint_id` (`string`): \n  - `endpoint_type` (`string`): \n  - `engine_name` (`string`): \n  - `extra_connection_attributes` (`string`):  When `null`, the `extra_connection_attributes` field will be omitted from the resulting object.\n  - `kms_key_arn` (`string`):  When `null`, the `kms_key_arn` field will be omitted from the resulting object.\n  - `password` (`string`):  When `null`, the `password` field will be omitted from the resulting object.\n  - `port` (`number`):  When `null`, the `port` field will be omitted from the resulting object.\n  - `secrets_manager_access_role_arn` (`string`):  When `null`, the `secrets_manager_access_role_arn` field will be omitted from the resulting object.\n  - `secrets_manager_arn` (`string`):  When `null`, the `secrets_manager_arn` field will be omitted from the resulting object.\n  - `server_name` (`string`):  When `null`, the `server_name` field will be omitted from the resulting object.\n  - `service_access_role` (`string`):  When `null`, the `service_access_role` field will be omitted from the resulting object.\n  - `ssl_mode` (`string`):  When `null`, the `ssl_mode` field will be omitted from the resulting object.\n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `tags_all` (`obj`):  When `null`, the `tags_all` field will be omitted from the resulting object.\n  - `username` (`string`):  When `null`, the `username` field will be omitted from the resulting object.\n  - `elasticsearch_settings` (`list[obj]`):  When `null`, the `elasticsearch_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_endpoint.elasticsearch_settings.new](#fn-dmsendpointelasticsearchsettingsnew) constructor.\n  - `kafka_settings` (`list[obj]`):  When `null`, the `kafka_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_endpoint.kafka_settings.new](#fn-dmsendpointkafkasettingsnew) constructor.\n  - `kinesis_settings` (`list[obj]`):  When `null`, the `kinesis_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_endpoint.kinesis_settings.new](#fn-dmsendpointkinesissettingsnew) constructor.\n  - `mongodb_settings` (`list[obj]`):  When `null`, the `mongodb_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_endpoint.mongodb_settings.new](#fn-dmsendpointmongodbsettingsnew) constructor.\n  - `redis_settings` (`list[obj]`):  When `null`, the `redis_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_endpoint.redis_settings.new](#fn-dmsendpointredissettingsnew) constructor.\n  - `redshift_settings` (`list[obj]`):  When `null`, the `redshift_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_endpoint.redshift_settings.new](#fn-dmsendpointredshiftsettingsnew) constructor.\n  - `s3_settings` (`list[obj]`):  When `null`, the `s3_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_endpoint.s3_settings.new](#fn-dmsendpoints3settingsnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.dms_endpoint.timeouts.new](#fn-dmsendpointtimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    endpoint_id,
    endpoint_type,
  ...
  '#withDatabaseName':: d.fn(help='`aws.dms_endpoint.withDatabaseName` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the database_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database_name` field.\n', args=[]),
  ...
  '#withElasticsearchSettings':: d.fn(help='`aws.dms_endpoint.withElasticsearchSettings` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the elasticsearch_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `elasticsearch_settings` field.\n', args=[]),
  ...
  '#withElasticsearchSettingsMixin':: d.fn(help='`aws.dms_endpoint.withElasticsearchSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the elasticsearch_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.dms_endpoint.withElasticsearchSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `elasticsearch_settings` field.\n', args=[]),
  ...
  '#withEndpointId':: d.fn(help='`aws.dms_endpoint.withEndpointId` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_id` field.\n', args=[]),
  ...
  '#withEndpointType':: d.fn(help='`aws.dms_endpoint.withEndpointType` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the endpoint_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_type` field.\n', args=[]),
  ...
  '#withEngineName':: d.fn(help='`aws.dms_endpoint.withEngineName` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the engine_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `engine_name` field.\n', args=[]),
  ...
  '#withExtraConnectionAttributes':: d.fn(help='`aws.dms_endpoint.withExtraConnectionAttributes` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the extra_connection_attributes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `extra_connection_attributes` field.\n', args=[]),
  ...
  '#withKafkaSettings':: d.fn(help='`aws.dms_endpoint.withKafkaSettings` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the kafka_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kafka_settings` field.\n', args=[]),
  ...
  '#withKafkaSettingsMixin':: d.fn(help='`aws.dms_endpoint.withKafkaSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the kafka_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.dms_endpoint.withKafkaSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kafka_settings` field.\n', args=[]),
  ...
  '#withKinesisSettings':: d.fn(help='`aws.dms_endpoint.withKinesisSettings` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the kinesis_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kinesis_settings` field.\n', args=[]),
  ...
  '#withKinesisSettingsMixin':: d.fn(help='`aws.dms_endpoint.withKinesisSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the kinesis_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.dms_endpoint.withKinesisSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kinesis_settings` field.\n', args=[]),
  ...
  '#withKmsKeyArn':: d.fn(help='`aws.dms_endpoint.withKmsKeyArn` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the kms_key_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_arn` field.\n', args=[]),
  ...
  '#withMongodbSettings':: d.fn(help='`aws.dms_endpoint.withMongodbSettings` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the mongodb_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mongodb_settings` field.\n', args=[]),
  ...
  '#withMongodbSettingsMixin':: d.fn(help='`aws.dms_endpoint.withMongodbSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the mongodb_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.dms_endpoint.withMongodbSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mongodb_settings` field.\n', args=[]),
  ...
  '#withPassword':: d.fn(help='`aws.dms_endpoint.withPassword` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the password field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `password` field.\n', args=[]),
  ...
  '#withPort':: d.fn(help='`aws.dms_endpoint.withPort` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the port field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `port` field.\n', args=[]),
  ...
  '#withRedisSettings':: d.fn(help='`aws.dms_endpoint.withRedisSettings` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the redis_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `redis_settings` field.\n', args=[]),
  ...
  '#withRedisSettingsMixin':: d.fn(help='`aws.dms_endpoint.withRedisSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the redis_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.dms_endpoint.withRedisSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `redis_settings` field.\n', args=[]),
  ...
  '#withRedshiftSettings':: d.fn(help='`aws.dms_endpoint.withRedshiftSettings` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the redshift_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `redshift_settings` field.\n', args=[]),
  ...
  '#withRedshiftSettingsMixin':: d.fn(help='`aws.dms_endpoint.withRedshiftSettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the redshift_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.dms_endpoint.withRedshiftSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `redshift_settings` field.\n', args=[]),
  ...
  '#withS3Settings':: d.fn(help='`aws.dms_endpoint.withS3Settings` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the s3_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_settings` field.\n', args=[]),
  ...
  '#withS3SettingsMixin':: d.fn(help='`aws.dms_endpoint.withS3SettingsMixin` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the s3_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.dms_endpoint.withS3Settings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_settings` field.\n', args=[]),
  ...
  '#withSecretsManagerAccessRoleArn':: d.fn(help='`aws.dms_endpoint.withSecretsManagerAccessRoleArn` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the secrets_manager_access_role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secrets_manager_access_role_arn` field.\n', args=[]),
  ...
  '#withSecretsManagerArn':: d.fn(help='`aws.dms_endpoint.withSecretsManagerArn` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the secrets_manager_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secrets_manager_arn` field.\n', args=[]),
  ...
  '#withServerName':: d.fn(help='`aws.dms_endpoint.withServerName` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the server_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_name` field.\n', args=[]),
  ...
  '#withServiceAccessRole':: d.fn(help='`aws.dms_endpoint.withServiceAccessRole` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the service_access_role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_access_role` field.\n', args=[]),
  ...
  '#withSslMode':: d.fn(help='`aws.dms_endpoint.withSslMode` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the ssl_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ssl_mode` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.dms_endpoint.withTags` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.dms_endpoint.withTagsAll` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.dms_endpoint.withTimeouts` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.dms_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.dms_endpoint.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withUsername':: d.fn(help='`aws.dms_endpoint.withUsername` constructs a mixin object that can be merged into the `dms_endpoint`\nTerraform resource block to set or update the username field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `username` field.\n', args=[]),
