...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLicenseConfigurationArn':: d.fn(help='`aws.licensemanager_association.withLicenseConfigurationArn` constructs a mixin object that can be merged into the `licensemanager_association`\nTerraform resource block to set or update the license_configuration_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `license_configuration_arn` field.\n', args=[]),
  ...
  '#withResourceArn':: d.fn(help='`aws.licensemanager_association.withResourceArn` constructs a mixin object that can be merged into the `licensemanager_association`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
