...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDirectoryName':: d.fn(help='`aws.appstream_directory_config.withDirectoryName` constructs a mixin object that can be merged into the `appstream_directory_config`\nTerraform resource block to set or update the directory_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `directory_name` field.\n', args=[]),
  ...
  '#withOrganizationalUnitDistinguishedNames':: d.fn(help='`aws.appstream_directory_config.withOrganizationalUnitDistinguishedNames` constructs a mixin object that can be merged into the `appstream_directory_config`\nTerraform resource block to set or update the organizational_unit_distinguished_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organizational_unit_distinguished_names` field.\n', args=[]),
  ...
  '#withServiceAccountCredentials':: d.fn(help='`aws.appstream_directory_config.withServiceAccountCredentials` constructs a mixin object that can be merged into the `appstream_directory_config`\nTerraform resource block to set or update the service_account_credentials field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_account_credentials` field.\n', args=[]),
  ...
  '#withServiceAccountCredentialsMixin':: d.fn(help='`aws.appstream_directory_config.withServiceAccountCredentialsMixin` constructs a mixin object that can be merged into the `appstream_directory_config`\nTerraform resource block to set or update the service_account_credentials field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.appstream_directory_config.withServiceAccountCredentials](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_account_credentials` field.\n', args=[]),
