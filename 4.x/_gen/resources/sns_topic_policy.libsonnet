...
{
  '#':: d.pkg(name='sns_topic_policy', url='', help='`sns_topic_policy` represents the `aws_sns_topic_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withArn':: d.fn(help='`aws.sns_topic_policy.withArn` constructs a mixin object that can be merged into the `sns_topic_policy`\nTerraform resource block to set or update the arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.sns_topic_policy.withPolicy` constructs a mixin object that can be merged into the `sns_topic_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
