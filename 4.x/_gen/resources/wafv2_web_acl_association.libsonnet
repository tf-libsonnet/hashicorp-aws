...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withResourceArn':: d.fn(help='`aws.wafv2_web_acl_association.withResourceArn` constructs a mixin object that can be merged into the `wafv2_web_acl_association`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
  ...
  '#withWebAclArn':: d.fn(help='`aws.wafv2_web_acl_association.withWebAclArn` constructs a mixin object that can be merged into the `wafv2_web_acl_association`\nTerraform resource block to set or update the web_acl_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `web_acl_arn` field.\n', args=[]),
