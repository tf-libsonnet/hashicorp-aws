...
{
  '#':: d.pkg(name='memorydb_parameter_group', url='', help='`memorydb_parameter_group` represents the `aws_memorydb_parameter_group` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`aws.memorydb_parameter_group.withDescription` constructs a mixin object that can be merged into the `memorydb_parameter_group`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withFamily':: d.fn(help='`aws.memorydb_parameter_group.withFamily` constructs a mixin object that can be merged into the `memorydb_parameter_group`\nTerraform resource block to set or update the family field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `family` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`aws.memorydb_parameter_group.withNamePrefix` constructs a mixin object that can be merged into the `memorydb_parameter_group`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withParameter':: d.fn(help='`aws.memorydb_parameter_group.withParameter` constructs a mixin object that can be merged into the `memorydb_parameter_group`\nTerraform resource block to set or update the parameter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameter` field.\n', args=[]),
  ...
  '#withParameterMixin':: d.fn(help='`aws.memorydb_parameter_group.withParameterMixin` constructs a mixin object that can be merged into the `memorydb_parameter_group`\nTerraform resource block to set or update the parameter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.memorydb_parameter_group.withParameter](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameter` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.memorydb_parameter_group.withTagsAll` constructs a mixin object that can be merged into the `memorydb_parameter_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
