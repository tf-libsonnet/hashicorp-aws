...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.lambda_alias.withDescription` constructs a mixin object that can be merged into the `lambda_alias`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withFunctionName':: d.fn(help='`aws.lambda_alias.withFunctionName` constructs a mixin object that can be merged into the `lambda_alias`\nTerraform resource block to set or update the function_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `function_name` field.\n', args=[]),
  ...
  '#withFunctionVersion':: d.fn(help='`aws.lambda_alias.withFunctionVersion` constructs a mixin object that can be merged into the `lambda_alias`\nTerraform resource block to set or update the function_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `function_version` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.lambda_alias.withName` constructs a mixin object that can be merged into the `lambda_alias`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRoutingConfig':: d.fn(help='`aws.lambda_alias.withRoutingConfig` constructs a mixin object that can be merged into the `lambda_alias`\nTerraform resource block to set or update the routing_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `routing_config` field.\n', args=[]),
  ...
  '#withRoutingConfigMixin':: d.fn(help='`aws.lambda_alias.withRoutingConfigMixin` constructs a mixin object that can be merged into the `lambda_alias`\nTerraform resource block to set or update the routing_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.lambda_alias.withRoutingConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `routing_config` field.\n', args=[]),
