...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withObservabilityConfigurationName':: d.fn(help='`aws.apprunner_observability_configuration.withObservabilityConfigurationName` constructs a mixin object that can be merged into the `apprunner_observability_configuration`\nTerraform resource block to set or update the observability_configuration_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `observability_configuration_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.apprunner_observability_configuration.withTags` constructs a mixin object that can be merged into the `apprunner_observability_configuration`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.apprunner_observability_configuration.withTagsAll` constructs a mixin object that can be merged into the `apprunner_observability_configuration`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTraceConfiguration':: d.fn(help='`aws.apprunner_observability_configuration.withTraceConfiguration` constructs a mixin object that can be merged into the `apprunner_observability_configuration`\nTerraform resource block to set or update the trace_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `trace_configuration` field.\n', args=[]),
  ...
  '#withTraceConfigurationMixin':: d.fn(help='`aws.apprunner_observability_configuration.withTraceConfigurationMixin` constructs a mixin object that can be merged into the `apprunner_observability_configuration`\nTerraform resource block to set or update the trace_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.apprunner_observability_configuration.withTraceConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `trace_configuration` field.\n', args=[]),
