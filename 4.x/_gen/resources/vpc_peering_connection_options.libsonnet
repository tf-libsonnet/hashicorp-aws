...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccepter':: d.fn(help='`aws.vpc_peering_connection_options.withAccepter` constructs a mixin object that can be merged into the `vpc_peering_connection_options`\nTerraform resource block to set or update the accepter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `accepter` field.\n', args=[]),
  ...
  '#withAccepterMixin':: d.fn(help='`aws.vpc_peering_connection_options.withAccepterMixin` constructs a mixin object that can be merged into the `vpc_peering_connection_options`\nTerraform resource block to set or update the accepter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.vpc_peering_connection_options.withAccepter](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `accepter` field.\n', args=[]),
  ...
  '#withRequester':: d.fn(help='`aws.vpc_peering_connection_options.withRequester` constructs a mixin object that can be merged into the `vpc_peering_connection_options`\nTerraform resource block to set or update the requester field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `requester` field.\n', args=[]),
  ...
  '#withRequesterMixin':: d.fn(help='`aws.vpc_peering_connection_options.withRequesterMixin` constructs a mixin object that can be merged into the `vpc_peering_connection_options`\nTerraform resource block to set or update the requester field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.vpc_peering_connection_options.withRequester](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `requester` field.\n', args=[]),
  ...
  '#withVpcPeeringConnectionId':: d.fn(help='`aws.vpc_peering_connection_options.withVpcPeeringConnectionId` constructs a mixin object that can be merged into the `vpc_peering_connection_options`\nTerraform resource block to set or update the vpc_peering_connection_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_peering_connection_id` field.\n', args=[]),
