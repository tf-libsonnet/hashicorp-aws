...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withShareArn':: d.fn(help='`aws.ram_resource_share_accepter.withShareArn` constructs a mixin object that can be merged into the `ram_resource_share_accepter`\nTerraform resource block to set or update the share_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `share_arn` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.ram_resource_share_accepter.withTimeouts` constructs a mixin object that can be merged into the `ram_resource_share_accepter`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.ram_resource_share_accepter.withTimeoutsMixin` constructs a mixin object that can be merged into the `ram_resource_share_accepter`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.ram_resource_share_accepter.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
