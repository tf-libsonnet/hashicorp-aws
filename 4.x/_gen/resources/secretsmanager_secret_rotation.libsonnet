...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRotationLambdaArn':: d.fn(help='`aws.secretsmanager_secret_rotation.withRotationLambdaArn` constructs a mixin object that can be merged into the `secretsmanager_secret_rotation`\nTerraform resource block to set or update the rotation_lambda_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rotation_lambda_arn` field.\n', args=[]),
  ...
  '#withRotationRules':: d.fn(help='`aws.secretsmanager_secret_rotation.withRotationRules` constructs a mixin object that can be merged into the `secretsmanager_secret_rotation`\nTerraform resource block to set or update the rotation_rules field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rotation_rules` field.\n', args=[]),
  ...
  '#withRotationRulesMixin':: d.fn(help='`aws.secretsmanager_secret_rotation.withRotationRulesMixin` constructs a mixin object that can be merged into the `secretsmanager_secret_rotation`\nTerraform resource block to set or update the rotation_rules field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.secretsmanager_secret_rotation.withRotationRules](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rotation_rules` field.\n', args=[]),
  ...
  '#withSecretId':: d.fn(help='`aws.secretsmanager_secret_rotation.withSecretId` constructs a mixin object that can be merged into the `secretsmanager_secret_rotation`\nTerraform resource block to set or update the secret_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret_id` field.\n', args=[]),
