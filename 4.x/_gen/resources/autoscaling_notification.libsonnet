...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroupNames':: d.fn(help='`aws.autoscaling_notification.withGroupNames` constructs a mixin object that can be merged into the `autoscaling_notification`\nTerraform resource block to set or update the group_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_names` field.\n', args=[]),
  ...
  '#withNotifications':: d.fn(help='`aws.autoscaling_notification.withNotifications` constructs a mixin object that can be merged into the `autoscaling_notification`\nTerraform resource block to set or update the notifications field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `notifications` field.\n', args=[]),
  ...
  '#withTopicArn':: d.fn(help='`aws.autoscaling_notification.withTopicArn` constructs a mixin object that can be merged into the `autoscaling_notification`\nTerraform resource block to set or update the topic_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `topic_arn` field.\n', args=[]),
