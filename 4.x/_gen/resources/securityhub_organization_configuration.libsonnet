...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutoEnable':: d.fn(help='`aws.securityhub_organization_configuration.withAutoEnable` constructs a mixin object that can be merged into the `securityhub_organization_configuration`\nTerraform resource block to set or update the auto_enable field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_enable` field.\n', args=[]),
