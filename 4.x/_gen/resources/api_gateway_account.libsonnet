...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCloudwatchRoleArn':: d.fn(help='`aws.api_gateway_account.withCloudwatchRoleArn` constructs a mixin object that can be merged into the `api_gateway_account`\nTerraform resource block to set or update the cloudwatch_role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cloudwatch_role_arn` field.\n', args=[]),
