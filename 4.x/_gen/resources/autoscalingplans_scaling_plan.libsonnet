...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.autoscalingplans_scaling_plan.new` injects a new `aws_autoscalingplans_scaling_plan` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.autoscalingplans_scaling_plan.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.autoscalingplans_scaling_plan` using the reference:\n\n    $._ref.aws_autoscalingplans_scaling_plan.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_autoscalingplans_scaling_plan.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `name` (`string`): \n  - `application_source` (`list[obj]`):  When `null`, the `application_source` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.autoscalingplans_scaling_plan.application_source.new](#fn-autoscalingplansscalingplanapplicationsourcenew) constructor.\n  - `scaling_instruction` (`list[obj]`):  When `null`, the `scaling_instruction` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.autoscalingplans_scaling_plan.scaling_instruction.new](#fn-autoscalingplansscalingplanscalinginstructionnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    name,
  ...
  '#withApplicationSource':: d.fn(help='`aws.autoscalingplans_scaling_plan.withApplicationSource` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`\nTerraform resource block to set or update the application_source field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_source` field.\n', args=[]),
  ...
  '#withApplicationSourceMixin':: d.fn(help='`aws.autoscalingplans_scaling_plan.withApplicationSourceMixin` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`\nTerraform resource block to set or update the application_source field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.autoscalingplans_scaling_plan.withApplicationSource](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_source` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.autoscalingplans_scaling_plan.withName` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScalingInstruction':: d.fn(help='`aws.autoscalingplans_scaling_plan.withScalingInstruction` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`\nTerraform resource block to set or update the scaling_instruction field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scaling_instruction` field.\n', args=[]),
  ...
  '#withScalingInstructionMixin':: d.fn(help='`aws.autoscalingplans_scaling_plan.withScalingInstructionMixin` constructs a mixin object that can be merged into the `autoscalingplans_scaling_plan`\nTerraform resource block to set or update the scaling_instruction field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.autoscalingplans_scaling_plan.withScalingInstruction](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scaling_instruction` field.\n', args=[]),
