...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withActions':: d.fn(help='`aws.acmpca_permission.withActions` constructs a mixin object that can be merged into the `acmpca_permission`\nTerraform resource block to set or update the actions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `actions` field.\n', args=[]),
  ...
  '#withCertificateAuthorityArn':: d.fn(help='`aws.acmpca_permission.withCertificateAuthorityArn` constructs a mixin object that can be merged into the `acmpca_permission`\nTerraform resource block to set or update the certificate_authority_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_authority_arn` field.\n', args=[]),
  ...
  '#withPrincipal':: d.fn(help='`aws.acmpca_permission.withPrincipal` constructs a mixin object that can be merged into the `acmpca_permission`\nTerraform resource block to set or update the principal field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal` field.\n', args=[]),
  ...
  '#withSourceAccount':: d.fn(help='`aws.acmpca_permission.withSourceAccount` constructs a mixin object that can be merged into the `acmpca_permission`\nTerraform resource block to set or update the source_account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_account` field.\n', args=[]),
