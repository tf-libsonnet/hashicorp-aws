...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDatabase':: d.fn(help='`aws.athena_named_query.withDatabase` constructs a mixin object that can be merged into the `athena_named_query`\nTerraform resource block to set or update the database field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.athena_named_query.withDescription` constructs a mixin object that can be merged into the `athena_named_query`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.athena_named_query.withName` constructs a mixin object that can be merged into the `athena_named_query`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withQuery':: d.fn(help='`aws.athena_named_query.withQuery` constructs a mixin object that can be merged into the `athena_named_query`\nTerraform resource block to set or update the query field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `query` field.\n', args=[]),
  ...
  '#withWorkgroup':: d.fn(help='`aws.athena_named_query.withWorkgroup` constructs a mixin object that can be merged into the `athena_named_query`\nTerraform resource block to set or update the workgroup field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workgroup` field.\n', args=[]),
