...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAttribute':: d.fn(help='`aws.lb_ssl_negotiation_policy.withAttribute` constructs a mixin object that can be merged into the `lb_ssl_negotiation_policy`\nTerraform resource block to set or update the attribute field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `attribute` field.\n', args=[]),
  ...
  '#withAttributeMixin':: d.fn(help='`aws.lb_ssl_negotiation_policy.withAttributeMixin` constructs a mixin object that can be merged into the `lb_ssl_negotiation_policy`\nTerraform resource block to set or update the attribute field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.lb_ssl_negotiation_policy.withAttribute](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `attribute` field.\n', args=[]),
  ...
  '#withLbPort':: d.fn(help='`aws.lb_ssl_negotiation_policy.withLbPort` constructs a mixin object that can be merged into the `lb_ssl_negotiation_policy`\nTerraform resource block to set or update the lb_port field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lb_port` field.\n', args=[]),
  ...
  '#withLoadBalancer':: d.fn(help='`aws.lb_ssl_negotiation_policy.withLoadBalancer` constructs a mixin object that can be merged into the `lb_ssl_negotiation_policy`\nTerraform resource block to set or update the load_balancer field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load_balancer` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.lb_ssl_negotiation_policy.withName` constructs a mixin object that can be merged into the `lb_ssl_negotiation_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
