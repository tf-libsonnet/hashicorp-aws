...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeleteReports':: d.fn(help='`aws.codebuild_report_group.withDeleteReports` constructs a mixin object that can be merged into the `codebuild_report_group`\nTerraform resource block to set or update the delete_reports field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delete_reports` field.\n', args=[]),
  ...
  '#withExportConfig':: d.fn(help='`aws.codebuild_report_group.withExportConfig` constructs a mixin object that can be merged into the `codebuild_report_group`\nTerraform resource block to set or update the export_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `export_config` field.\n', args=[]),
  ...
  '#withExportConfigMixin':: d.fn(help='`aws.codebuild_report_group.withExportConfigMixin` constructs a mixin object that can be merged into the `codebuild_report_group`\nTerraform resource block to set or update the export_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.codebuild_report_group.withExportConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `export_config` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.codebuild_report_group.withName` constructs a mixin object that can be merged into the `codebuild_report_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.codebuild_report_group.withTags` constructs a mixin object that can be merged into the `codebuild_report_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.codebuild_report_group.withTagsAll` constructs a mixin object that can be merged into the `codebuild_report_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withType':: d.fn(help='`aws.codebuild_report_group.withType` constructs a mixin object that can be merged into the `codebuild_report_group`\nTerraform resource block to set or update the type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type` field.\n', args=[]),
