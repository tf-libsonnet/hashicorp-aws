...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstanceId':: d.fn(help='`aws.connect_user_hierarchy_group.withInstanceId` constructs a mixin object that can be merged into the `connect_user_hierarchy_group`\nTerraform resource block to set or update the instance_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.connect_user_hierarchy_group.withName` constructs a mixin object that can be merged into the `connect_user_hierarchy_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withParentGroupId':: d.fn(help='`aws.connect_user_hierarchy_group.withParentGroupId` constructs a mixin object that can be merged into the `connect_user_hierarchy_group`\nTerraform resource block to set or update the parent_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent_group_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.connect_user_hierarchy_group.withTags` constructs a mixin object that can be merged into the `connect_user_hierarchy_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.connect_user_hierarchy_group.withTagsAll` constructs a mixin object that can be merged into the `connect_user_hierarchy_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
