...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateArn':: d.fn(help='`aws.cognito_user_pool_domain.withCertificateArn` constructs a mixin object that can be merged into the `cognito_user_pool_domain`\nTerraform resource block to set or update the certificate_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_arn` field.\n', args=[]),
  ...
  '#withDomain':: d.fn(help='`aws.cognito_user_pool_domain.withDomain` constructs a mixin object that can be merged into the `cognito_user_pool_domain`\nTerraform resource block to set or update the domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain` field.\n', args=[]),
  ...
  '#withUserPoolId':: d.fn(help='`aws.cognito_user_pool_domain.withUserPoolId` constructs a mixin object that can be merged into the `cognito_user_pool_domain`\nTerraform resource block to set or update the user_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_pool_id` field.\n', args=[]),
