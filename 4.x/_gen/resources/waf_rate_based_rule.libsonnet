...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMetricName':: d.fn(help='`aws.waf_rate_based_rule.withMetricName` constructs a mixin object that can be merged into the `waf_rate_based_rule`\nTerraform resource block to set or update the metric_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metric_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.waf_rate_based_rule.withName` constructs a mixin object that can be merged into the `waf_rate_based_rule`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPredicates':: d.fn(help='`aws.waf_rate_based_rule.withPredicates` constructs a mixin object that can be merged into the `waf_rate_based_rule`\nTerraform resource block to set or update the predicates field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `predicates` field.\n', args=[]),
  ...
  '#withPredicatesMixin':: d.fn(help='`aws.waf_rate_based_rule.withPredicatesMixin` constructs a mixin object that can be merged into the `waf_rate_based_rule`\nTerraform resource block to set or update the predicates field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.waf_rate_based_rule.withPredicates](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `predicates` field.\n', args=[]),
  ...
  '#withRateKey':: d.fn(help='`aws.waf_rate_based_rule.withRateKey` constructs a mixin object that can be merged into the `waf_rate_based_rule`\nTerraform resource block to set or update the rate_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rate_key` field.\n', args=[]),
  ...
  '#withRateLimit':: d.fn(help='`aws.waf_rate_based_rule.withRateLimit` constructs a mixin object that can be merged into the `waf_rate_based_rule`\nTerraform resource block to set or update the rate_limit field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rate_limit` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.waf_rate_based_rule.withTags` constructs a mixin object that can be merged into the `waf_rate_based_rule`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.waf_rate_based_rule.withTagsAll` constructs a mixin object that can be merged into the `waf_rate_based_rule`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
