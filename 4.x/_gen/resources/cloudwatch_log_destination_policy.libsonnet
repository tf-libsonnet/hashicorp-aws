...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccessPolicy':: d.fn(help='`aws.cloudwatch_log_destination_policy.withAccessPolicy` constructs a mixin object that can be merged into the `cloudwatch_log_destination_policy`\nTerraform resource block to set or update the access_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `access_policy` field.\n', args=[]),
  ...
  '#withDestinationName':: d.fn(help='`aws.cloudwatch_log_destination_policy.withDestinationName` constructs a mixin object that can be merged into the `cloudwatch_log_destination_policy`\nTerraform resource block to set or update the destination_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_name` field.\n', args=[]),
  ...
  '#withForceUpdate':: d.fn(help='`aws.cloudwatch_log_destination_policy.withForceUpdate` constructs a mixin object that can be merged into the `cloudwatch_log_destination_policy`\nTerraform resource block to set or update the force_update field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `force_update` field.\n', args=[]),
