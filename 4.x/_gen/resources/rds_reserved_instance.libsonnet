...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstanceCount':: d.fn(help='`aws.rds_reserved_instance.withInstanceCount` constructs a mixin object that can be merged into the `rds_reserved_instance`\nTerraform resource block to set or update the instance_count field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_count` field.\n', args=[]),
  ...
  '#withOfferingId':: d.fn(help='`aws.rds_reserved_instance.withOfferingId` constructs a mixin object that can be merged into the `rds_reserved_instance`\nTerraform resource block to set or update the offering_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `offering_id` field.\n', args=[]),
  ...
  '#withReservationId':: d.fn(help='`aws.rds_reserved_instance.withReservationId` constructs a mixin object that can be merged into the `rds_reserved_instance`\nTerraform resource block to set or update the reservation_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `reservation_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.rds_reserved_instance.withTags` constructs a mixin object that can be merged into the `rds_reserved_instance`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.rds_reserved_instance.withTagsAll` constructs a mixin object that can be merged into the `rds_reserved_instance`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.rds_reserved_instance.withTimeouts` constructs a mixin object that can be merged into the `rds_reserved_instance`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.rds_reserved_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `rds_reserved_instance`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.rds_reserved_instance.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
