...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGlobalSettings':: d.fn(help='`aws.backup_global_settings.withGlobalSettings` constructs a mixin object that can be merged into the `backup_global_settings`\nTerraform resource block to set or update the global_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `global_settings` field.\n', args=[]),
