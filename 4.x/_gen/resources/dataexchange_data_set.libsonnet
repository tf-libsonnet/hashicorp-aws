...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAssetType':: d.fn(help='`aws.dataexchange_data_set.withAssetType` constructs a mixin object that can be merged into the `dataexchange_data_set`\nTerraform resource block to set or update the asset_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `asset_type` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.dataexchange_data_set.withDescription` constructs a mixin object that can be merged into the `dataexchange_data_set`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.dataexchange_data_set.withName` constructs a mixin object that can be merged into the `dataexchange_data_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.dataexchange_data_set.withTags` constructs a mixin object that can be merged into the `dataexchange_data_set`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.dataexchange_data_set.withTagsAll` constructs a mixin object that can be merged into the `dataexchange_data_set`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
