...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeletionWindowInDays':: d.fn(help='`aws.kms_replica_key.withDeletionWindowInDays` constructs a mixin object that can be merged into the `kms_replica_key`\nTerraform resource block to set or update the deletion_window_in_days field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deletion_window_in_days` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.kms_replica_key.withDescription` constructs a mixin object that can be merged into the `kms_replica_key`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`aws.kms_replica_key.withEnabled` constructs a mixin object that can be merged into the `kms_replica_key`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.kms_replica_key.withPolicy` constructs a mixin object that can be merged into the `kms_replica_key`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withPrimaryKeyArn':: d.fn(help='`aws.kms_replica_key.withPrimaryKeyArn` constructs a mixin object that can be merged into the `kms_replica_key`\nTerraform resource block to set or update the primary_key_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `primary_key_arn` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.kms_replica_key.withTags` constructs a mixin object that can be merged into the `kms_replica_key`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.kms_replica_key.withTagsAll` constructs a mixin object that can be merged into the `kms_replica_key`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
