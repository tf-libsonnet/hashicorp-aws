...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAvailabilityZone':: d.fn(help='`aws.cloudhsm_v2_hsm.withAvailabilityZone` constructs a mixin object that can be merged into the `cloudhsm_v2_hsm`\nTerraform resource block to set or update the availability_zone field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `availability_zone` field.\n', args=[]),
  ...
  '#withClusterId':: d.fn(help='`aws.cloudhsm_v2_hsm.withClusterId` constructs a mixin object that can be merged into the `cloudhsm_v2_hsm`\nTerraform resource block to set or update the cluster_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_id` field.\n', args=[]),
  ...
  '#withIpAddress':: d.fn(help='`aws.cloudhsm_v2_hsm.withIpAddress` constructs a mixin object that can be merged into the `cloudhsm_v2_hsm`\nTerraform resource block to set or update the ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_address` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`aws.cloudhsm_v2_hsm.withSubnetId` constructs a mixin object that can be merged into the `cloudhsm_v2_hsm`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.cloudhsm_v2_hsm.withTimeouts` constructs a mixin object that can be merged into the `cloudhsm_v2_hsm`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.cloudhsm_v2_hsm.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudhsm_v2_hsm`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.cloudhsm_v2_hsm.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
