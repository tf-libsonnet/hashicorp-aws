...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppversionLifecycle':: d.fn(help='`aws.elastic_beanstalk_application.withAppversionLifecycle` constructs a mixin object that can be merged into the `elastic_beanstalk_application`\nTerraform resource block to set or update the appversion_lifecycle field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `appversion_lifecycle` field.\n', args=[]),
  ...
  '#withAppversionLifecycleMixin':: d.fn(help='`aws.elastic_beanstalk_application.withAppversionLifecycleMixin` constructs a mixin object that can be merged into the `elastic_beanstalk_application`\nTerraform resource block to set or update the appversion_lifecycle field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.elastic_beanstalk_application.withAppversionLifecycle](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `appversion_lifecycle` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.elastic_beanstalk_application.withDescription` constructs a mixin object that can be merged into the `elastic_beanstalk_application`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.elastic_beanstalk_application.withName` constructs a mixin object that can be merged into the `elastic_beanstalk_application`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.elastic_beanstalk_application.withTags` constructs a mixin object that can be merged into the `elastic_beanstalk_application`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.elastic_beanstalk_application.withTagsAll` constructs a mixin object that can be merged into the `elastic_beanstalk_application`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
