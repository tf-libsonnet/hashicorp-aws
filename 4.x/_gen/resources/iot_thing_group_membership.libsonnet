...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withOverrideDynamicGroup':: d.fn(help='`aws.iot_thing_group_membership.withOverrideDynamicGroup` constructs a mixin object that can be merged into the `iot_thing_group_membership`\nTerraform resource block to set or update the override_dynamic_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `override_dynamic_group` field.\n', args=[]),
  ...
  '#withThingGroupName':: d.fn(help='`aws.iot_thing_group_membership.withThingGroupName` constructs a mixin object that can be merged into the `iot_thing_group_membership`\nTerraform resource block to set or update the thing_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `thing_group_name` field.\n', args=[]),
  ...
  '#withThingName':: d.fn(help='`aws.iot_thing_group_membership.withThingName` constructs a mixin object that can be merged into the `iot_thing_group_membership`\nTerraform resource block to set or update the thing_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `thing_name` field.\n', args=[]),
