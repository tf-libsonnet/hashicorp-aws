...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiId':: d.fn(help='`aws.appsync_domain_name_api_association.withApiId` constructs a mixin object that can be merged into the `appsync_domain_name_api_association`\nTerraform resource block to set or update the api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_id` field.\n', args=[]),
  ...
  '#withDomainName':: d.fn(help='`aws.appsync_domain_name_api_association.withDomainName` constructs a mixin object that can be merged into the `appsync_domain_name_api_association`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
