...
{
  '#':: d.pkg(name='wafregional_regex_pattern_set', url='', help='`wafregional_regex_pattern_set` represents the `aws_wafregional_regex_pattern_set` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.wafregional_regex_pattern_set.withName` constructs a mixin object that can be merged into the `wafregional_regex_pattern_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRegexPatternStrings':: d.fn(help='`aws.wafregional_regex_pattern_set.withRegexPatternStrings` constructs a mixin object that can be merged into the `wafregional_regex_pattern_set`\nTerraform resource block to set or update the regex_pattern_strings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `regex_pattern_strings` field.\n', args=[]),
