...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBandwidth':: d.fn(help='`aws.dx_hosted_connection.withBandwidth` constructs a mixin object that can be merged into the `dx_hosted_connection`\nTerraform resource block to set or update the bandwidth field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bandwidth` field.\n', args=[]),
  ...
  '#withConnectionId':: d.fn(help='`aws.dx_hosted_connection.withConnectionId` constructs a mixin object that can be merged into the `dx_hosted_connection`\nTerraform resource block to set or update the connection_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.dx_hosted_connection.withName` constructs a mixin object that can be merged into the `dx_hosted_connection`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withOwnerAccountId':: d.fn(help='`aws.dx_hosted_connection.withOwnerAccountId` constructs a mixin object that can be merged into the `dx_hosted_connection`\nTerraform resource block to set or update the owner_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owner_account_id` field.\n', args=[]),
  ...
  '#withVlan':: d.fn(help='`aws.dx_hosted_connection.withVlan` constructs a mixin object that can be merged into the `dx_hosted_connection`\nTerraform resource block to set or update the vlan field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vlan` field.\n', args=[]),
