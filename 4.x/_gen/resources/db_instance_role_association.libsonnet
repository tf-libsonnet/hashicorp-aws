...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDbInstanceIdentifier':: d.fn(help='`aws.db_instance_role_association.withDbInstanceIdentifier` constructs a mixin object that can be merged into the `db_instance_role_association`\nTerraform resource block to set or update the db_instance_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_instance_identifier` field.\n', args=[]),
  ...
  '#withFeatureName':: d.fn(help='`aws.db_instance_role_association.withFeatureName` constructs a mixin object that can be merged into the `db_instance_role_association`\nTerraform resource block to set or update the feature_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `feature_name` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.db_instance_role_association.withRoleArn` constructs a mixin object that can be merged into the `db_instance_role_association`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
