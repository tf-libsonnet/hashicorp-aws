...
{
  '#':: d.pkg(name='redshift_snapshot_copy_grant', url='', help='`redshift_snapshot_copy_grant` represents the `aws_redshift_snapshot_copy_grant` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withKmsKeyId':: d.fn(help='`aws.redshift_snapshot_copy_grant.withKmsKeyId` constructs a mixin object that can be merged into the `redshift_snapshot_copy_grant`\nTerraform resource block to set or update the kms_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_id` field.\n', args=[]),
  ...
  '#withSnapshotCopyGrantName':: d.fn(help='`aws.redshift_snapshot_copy_grant.withSnapshotCopyGrantName` constructs a mixin object that can be merged into the `redshift_snapshot_copy_grant`\nTerraform resource block to set or update the snapshot_copy_grant_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `snapshot_copy_grant_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.redshift_snapshot_copy_grant.withTags` constructs a mixin object that can be merged into the `redshift_snapshot_copy_grant`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.redshift_snapshot_copy_grant.withTagsAll` constructs a mixin object that can be merged into the `redshift_snapshot_copy_grant`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
