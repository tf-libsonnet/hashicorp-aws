...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAmount':: d.fn(help='`aws.redshiftserverless_usage_limit.withAmount` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`\nTerraform resource block to set or update the amount field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `amount` field.\n', args=[]),
  ...
  '#withBreachAction':: d.fn(help='`aws.redshiftserverless_usage_limit.withBreachAction` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`\nTerraform resource block to set or update the breach_action field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `breach_action` field.\n', args=[]),
  ...
  '#withPeriod':: d.fn(help='`aws.redshiftserverless_usage_limit.withPeriod` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`\nTerraform resource block to set or update the period field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `period` field.\n', args=[]),
  ...
  '#withResourceArn':: d.fn(help='`aws.redshiftserverless_usage_limit.withResourceArn` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
  ...
  '#withUsageType':: d.fn(help='`aws.redshiftserverless_usage_limit.withUsageType` constructs a mixin object that can be merged into the `redshiftserverless_usage_limit`\nTerraform resource block to set or update the usage_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `usage_type` field.\n', args=[]),
