...
{
  '#':: d.pkg(name='route53recoverycontrolconfig_cluster', url='', help='`route53recoverycontrolconfig_cluster` represents the `aws_route53recoverycontrolconfig_cluster` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.route53recoverycontrolconfig_cluster.withName` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_cluster`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
