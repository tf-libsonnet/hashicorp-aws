...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withComment':: d.fn(help='`aws.route53_traffic_policy.withComment` constructs a mixin object that can be merged into the `route53_traffic_policy`\nTerraform resource block to set or update the comment field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `comment` field.\n', args=[]),
  ...
  '#withDocument':: d.fn(help='`aws.route53_traffic_policy.withDocument` constructs a mixin object that can be merged into the `route53_traffic_policy`\nTerraform resource block to set or update the document field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `document` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.route53_traffic_policy.withName` constructs a mixin object that can be merged into the `route53_traffic_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
