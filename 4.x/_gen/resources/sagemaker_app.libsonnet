...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppType':: d.fn(help='`aws.sagemaker_app.withAppType` constructs a mixin object that can be merged into the `sagemaker_app`\nTerraform resource block to set or update the app_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_type` field.\n', args=[]),
  ...
  '#withDomainId':: d.fn(help='`aws.sagemaker_app.withDomainId` constructs a mixin object that can be merged into the `sagemaker_app`\nTerraform resource block to set or update the domain_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_id` field.\n', args=[]),
  ...
  '#withResourceSpec':: d.fn(help='`aws.sagemaker_app.withResourceSpec` constructs a mixin object that can be merged into the `sagemaker_app`\nTerraform resource block to set or update the resource_spec field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_spec` field.\n', args=[]),
  ...
  '#withResourceSpecMixin':: d.fn(help='`aws.sagemaker_app.withResourceSpecMixin` constructs a mixin object that can be merged into the `sagemaker_app`\nTerraform resource block to set or update the resource_spec field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.sagemaker_app.withResourceSpec](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_spec` field.\n', args=[]),
  ...
  '#withSpaceName':: d.fn(help='`aws.sagemaker_app.withSpaceName` constructs a mixin object that can be merged into the `sagemaker_app`\nTerraform resource block to set or update the space_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `space_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.sagemaker_app.withTags` constructs a mixin object that can be merged into the `sagemaker_app`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.sagemaker_app.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_app`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withUserProfileName':: d.fn(help='`aws.sagemaker_app.withUserProfileName` constructs a mixin object that can be merged into the `sagemaker_app`\nTerraform resource block to set or update the user_profile_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_profile_name` field.\n', args=[]),
