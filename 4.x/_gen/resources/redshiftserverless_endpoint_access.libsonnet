...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEndpointName':: d.fn(help='`aws.redshiftserverless_endpoint_access.withEndpointName` constructs a mixin object that can be merged into the `redshiftserverless_endpoint_access`\nTerraform resource block to set or update the endpoint_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_name` field.\n', args=[]),
  ...
  '#withSubnetIds':: d.fn(help='`aws.redshiftserverless_endpoint_access.withSubnetIds` constructs a mixin object that can be merged into the `redshiftserverless_endpoint_access`\nTerraform resource block to set or update the subnet_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_ids` field.\n', args=[]),
  ...
  '#withVpcSecurityGroupIds':: d.fn(help='`aws.redshiftserverless_endpoint_access.withVpcSecurityGroupIds` constructs a mixin object that can be merged into the `redshiftserverless_endpoint_access`\nTerraform resource block to set or update the vpc_security_group_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_security_group_ids` field.\n', args=[]),
  ...
  '#withWorkgroupName':: d.fn(help='`aws.redshiftserverless_endpoint_access.withWorkgroupName` constructs a mixin object that can be merged into the `redshiftserverless_endpoint_access`\nTerraform resource block to set or update the workgroup_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workgroup_name` field.\n', args=[]),
