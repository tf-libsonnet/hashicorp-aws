...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPrincipalArn':: d.fn(help='`aws.vpc_endpoint_service_allowed_principal.withPrincipalArn` constructs a mixin object that can be merged into the `vpc_endpoint_service_allowed_principal`\nTerraform resource block to set or update the principal_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal_arn` field.\n', args=[]),
  ...
  '#withVpcEndpointServiceId':: d.fn(help='`aws.vpc_endpoint_service_allowed_principal.withVpcEndpointServiceId` constructs a mixin object that can be merged into the `vpc_endpoint_service_allowed_principal`\nTerraform resource block to set or update the vpc_endpoint_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_endpoint_service_id` field.\n', args=[]),
