...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.glue_catalog_table.new` injects a new `aws_glue_catalog_table` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.glue_catalog_table.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.glue_catalog_table` using the reference:\n\n    $._ref.aws_glue_catalog_table.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_glue_catalog_table.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `catalog_id` (`string`):  When `null`, the `catalog_id` field will be omitted from the resulting object.\n  - `database_name` (`string`): \n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `owner` (`string`):  When `null`, the `owner` field will be omitted from the resulting object.\n  - `parameters` (`obj`):  When `null`, the `parameters` field will be omitted from the resulting object.\n  - `retention` (`number`):  When `null`, the `retention` field will be omitted from the resulting object.\n  - `table_type` (`string`):  When `null`, the `table_type` field will be omitted from the resulting object.\n  - `view_expanded_text` (`string`):  When `null`, the `view_expanded_text` field will be omitted from the resulting object.\n  - `view_original_text` (`string`):  When `null`, the `view_original_text` field will be omitted from the resulting object.\n  - `partition_index` (`list[obj]`):  When `null`, the `partition_index` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.partition_index.new](#fn-gluecatalogtablepartitionindexnew) constructor.\n  - `partition_keys` (`list[obj]`):  When `null`, the `partition_keys` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.partition_keys.new](#fn-gluecatalogtablepartitionkeysnew) constructor.\n  - `storage_descriptor` (`list[obj]`):  When `null`, the `storage_descriptor` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.storage_descriptor.new](#fn-gluecatalogtablestoragedescriptornew) constructor.\n  - `target_table` (`list[obj]`):  When `null`, the `target_table` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.target_table.new](#fn-gluecatalogtabletargettablenew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    database_name,
    name,
  ...
  storage_descriptor:: {
    ...
    '#new':: d.fn(help='\n`aws.glue_catalog_table.storage_descriptor.new` constructs a new object with attributes and blocks configured for the `storage_descriptor`\nTerraform sub block.\n\n\n\n**Args**:\n  - `bucket_columns` (`list`):  When `null`, the `bucket_columns` field will be omitted from the resulting object.\n  - `compressed` (`bool`):  When `null`, the `compressed` field will be omitted from the resulting object.\n  - `input_format` (`string`):  When `null`, the `input_format` field will be omitted from the resulting object.\n  - `location` (`string`):  When `null`, the `location` field will be omitted from the resulting object.\n  - `number_of_buckets` (`number`):  When `null`, the `number_of_buckets` field will be omitted from the resulting object.\n  - `output_format` (`string`):  When `null`, the `output_format` field will be omitted from the resulting object.\n  - `parameters` (`obj`):  When `null`, the `parameters` field will be omitted from the resulting object.\n  - `stored_as_sub_directories` (`bool`):  When `null`, the `stored_as_sub_directories` field will be omitted from the resulting object.\n  - `columns` (`list[obj]`):  When `null`, the `columns` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.storage_descriptor.columns.new](#fn-storagedescriptorcolumnsnew) constructor.\n  - `schema_reference` (`list[obj]`):  When `null`, the `schema_reference` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.storage_descriptor.schema_reference.new](#fn-storagedescriptorschemareferencenew) constructor.\n  - `ser_de_info` (`list[obj]`):  When `null`, the `ser_de_info` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.storage_descriptor.ser_de_info.new](#fn-storagedescriptorserdeinfonew) constructor.\n  - `skewed_info` (`list[obj]`):  When `null`, the `skewed_info` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.storage_descriptor.skewed_info.new](#fn-storagedescriptorskewedinfonew) constructor.\n  - `sort_columns` (`list[obj]`):  When `null`, the `sort_columns` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_catalog_table.storage_descriptor.sort_columns.new](#fn-storagedescriptorsortcolumnsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `storage_descriptor` sub block.\n', args=[]),
    new(
      bucket_columns=null,
      columns=null,
      compressed=null,
  ...
  '#withCatalogId':: d.fn(help='`aws.glue_catalog_table.withCatalogId` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the catalog_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `catalog_id` field.\n', args=[]),
  ...
  '#withDatabaseName':: d.fn(help='`aws.glue_catalog_table.withDatabaseName` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the database_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database_name` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.glue_catalog_table.withDescription` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.glue_catalog_table.withName` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withOwner':: d.fn(help='`aws.glue_catalog_table.withOwner` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the owner field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `owner` field.\n', args=[]),
  ...
  '#withParameters':: d.fn(help='`aws.glue_catalog_table.withParameters` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters` field.\n', args=[]),
  ...
  '#withPartitionIndex':: d.fn(help='`aws.glue_catalog_table.withPartitionIndex` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the partition_index field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_index` field.\n', args=[]),
  ...
  '#withPartitionIndexMixin':: d.fn(help='`aws.glue_catalog_table.withPartitionIndexMixin` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the partition_index field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_catalog_table.withPartitionIndex](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_index` field.\n', args=[]),
  ...
  '#withPartitionKeys':: d.fn(help='`aws.glue_catalog_table.withPartitionKeys` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the partition_keys field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_keys` field.\n', args=[]),
  ...
  '#withPartitionKeysMixin':: d.fn(help='`aws.glue_catalog_table.withPartitionKeysMixin` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the partition_keys field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_catalog_table.withPartitionKeys](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_keys` field.\n', args=[]),
  ...
  '#withRetention':: d.fn(help='`aws.glue_catalog_table.withRetention` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the retention field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention` field.\n', args=[]),
  ...
  '#withStorageDescriptor':: d.fn(help='`aws.glue_catalog_table.withStorageDescriptor` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the storage_descriptor field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_descriptor` field.\n', args=[]),
  ...
  '#withStorageDescriptorMixin':: d.fn(help='`aws.glue_catalog_table.withStorageDescriptorMixin` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the storage_descriptor field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_catalog_table.withStorageDescriptor](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_descriptor` field.\n', args=[]),
  ...
  '#withTableType':: d.fn(help='`aws.glue_catalog_table.withTableType` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the table_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_type` field.\n', args=[]),
  ...
  '#withTargetTable':: d.fn(help='`aws.glue_catalog_table.withTargetTable` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the target_table field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_table` field.\n', args=[]),
  ...
  '#withTargetTableMixin':: d.fn(help='`aws.glue_catalog_table.withTargetTableMixin` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the target_table field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_catalog_table.withTargetTable](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_table` field.\n', args=[]),
  ...
  '#withViewExpandedText':: d.fn(help='`aws.glue_catalog_table.withViewExpandedText` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the view_expanded_text field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `view_expanded_text` field.\n', args=[]),
  ...
  '#withViewOriginalText':: d.fn(help='`aws.glue_catalog_table.withViewOriginalText` constructs a mixin object that can be merged into the `glue_catalog_table`\nTerraform resource block to set or update the view_original_text field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `view_original_text` field.\n', args=[]),
