...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  activated_rule:: {
    ...
    '#new':: d.fn(help='\n`aws.wafregional_rule_group.activated_rule.new` constructs a new object with attributes and blocks configured for the `activated_rule`\nTerraform sub block.\n\n\n\n**Args**:\n  - `priority` (`number`): \n  - `rule_id` (`string`): \n  - `type` (`string`):  When `null`, the `type` field will be omitted from the resulting object.\n  - `action` (`list[obj]`):  When `null`, the `action` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.wafregional_rule_group.activated_rule.action.new](#fn-activatedruleactionnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `activated_rule` sub block.\n', args=[]),
    new(
      priority,
      rule_id,
      action=null,
  ...
  '#withActivatedRule':: d.fn(help='`aws.wafregional_rule_group.withActivatedRule` constructs a mixin object that can be merged into the `wafregional_rule_group`\nTerraform resource block to set or update the activated_rule field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `activated_rule` field.\n', args=[]),
  ...
  '#withActivatedRuleMixin':: d.fn(help='`aws.wafregional_rule_group.withActivatedRuleMixin` constructs a mixin object that can be merged into the `wafregional_rule_group`\nTerraform resource block to set or update the activated_rule field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.wafregional_rule_group.withActivatedRule](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `activated_rule` field.\n', args=[]),
  ...
  '#withMetricName':: d.fn(help='`aws.wafregional_rule_group.withMetricName` constructs a mixin object that can be merged into the `wafregional_rule_group`\nTerraform resource block to set or update the metric_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metric_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.wafregional_rule_group.withName` constructs a mixin object that can be merged into the `wafregional_rule_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.wafregional_rule_group.withTags` constructs a mixin object that can be merged into the `wafregional_rule_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.wafregional_rule_group.withTagsAll` constructs a mixin object that can be merged into the `wafregional_rule_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
