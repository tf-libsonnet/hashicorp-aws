...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEventSourceName':: d.fn(help='`aws.cloudwatch_event_bus.withEventSourceName` constructs a mixin object that can be merged into the `cloudwatch_event_bus`\nTerraform resource block to set or update the event_source_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_source_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudwatch_event_bus.withName` constructs a mixin object that can be merged into the `cloudwatch_event_bus`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.cloudwatch_event_bus.withTags` constructs a mixin object that can be merged into the `cloudwatch_event_bus`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.cloudwatch_event_bus.withTagsAll` constructs a mixin object that can be merged into the `cloudwatch_event_bus`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
