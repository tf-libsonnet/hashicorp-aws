...
{
  '#':: d.pkg(name='iam_virtual_mfa_device', url='', help='`iam_virtual_mfa_device` represents the `aws_iam_virtual_mfa_device` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPath':: d.fn(help='`aws.iam_virtual_mfa_device.withPath` constructs a mixin object that can be merged into the `iam_virtual_mfa_device`\nTerraform resource block to set or update the path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `path` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.iam_virtual_mfa_device.withTags` constructs a mixin object that can be merged into the `iam_virtual_mfa_device`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.iam_virtual_mfa_device.withTagsAll` constructs a mixin object that can be merged into the `iam_virtual_mfa_device`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withVirtualMfaDeviceName':: d.fn(help='`aws.iam_virtual_mfa_device.withVirtualMfaDeviceName` constructs a mixin object that can be merged into the `iam_virtual_mfa_device`\nTerraform resource block to set or update the virtual_mfa_device_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_mfa_device_name` field.\n', args=[]),
