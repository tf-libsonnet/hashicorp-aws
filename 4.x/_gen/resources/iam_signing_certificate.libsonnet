...
{
  '#':: d.pkg(name='iam_signing_certificate', url='', help='`iam_signing_certificate` represents the `aws_iam_signing_certificate` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCertificateBody':: d.fn(help='`aws.iam_signing_certificate.withCertificateBody` constructs a mixin object that can be merged into the `iam_signing_certificate`\nTerraform resource block to set or update the certificate_body field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_body` field.\n', args=[]),
  ...
  '#withStatus':: d.fn(help='`aws.iam_signing_certificate.withStatus` constructs a mixin object that can be merged into the `iam_signing_certificate`\nTerraform resource block to set or update the status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
  ...
  '#withUserName':: d.fn(help='`aws.iam_signing_certificate.withUserName` constructs a mixin object that can be merged into the `iam_signing_certificate`\nTerraform resource block to set or update the user_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_name` field.\n', args=[]),
