...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  protocol:: {
    ...
    nfs:: {
      ...
      '#new':: d.fn(help='\n`aws.datasync_location_fsx_openzfs_file_system.protocol.nfs.new` constructs a new object with attributes and blocks configured for the `nfs`\nTerraform sub block.\n\n\n\n**Args**:\n  - `mount_options` (`list[obj]`):  When `null`, the `mount_options` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.datasync_location_fsx_openzfs_file_system.protocol.nfs.mount_options.new](#fn-nfsmountoptionsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `nfs` sub block.\n', args=[]),
      new(
        mount_options=null
      ):: std.prune(a={
  ...
  '#withFsxFilesystemArn':: d.fn(help='`aws.datasync_location_fsx_openzfs_file_system.withFsxFilesystemArn` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`\nTerraform resource block to set or update the fsx_filesystem_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fsx_filesystem_arn` field.\n', args=[]),
  ...
  '#withProtocol':: d.fn(help='`aws.datasync_location_fsx_openzfs_file_system.withProtocol` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`\nTerraform resource block to set or update the protocol field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `protocol` field.\n', args=[]),
  ...
  '#withProtocolMixin':: d.fn(help='`aws.datasync_location_fsx_openzfs_file_system.withProtocolMixin` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`\nTerraform resource block to set or update the protocol field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.datasync_location_fsx_openzfs_file_system.withProtocol](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `protocol` field.\n', args=[]),
  ...
  '#withSecurityGroupArns':: d.fn(help='`aws.datasync_location_fsx_openzfs_file_system.withSecurityGroupArns` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`\nTerraform resource block to set or update the security_group_arns field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_group_arns` field.\n', args=[]),
  ...
  '#withSubdirectory':: d.fn(help='`aws.datasync_location_fsx_openzfs_file_system.withSubdirectory` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`\nTerraform resource block to set or update the subdirectory field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subdirectory` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.datasync_location_fsx_openzfs_file_system.withTags` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.datasync_location_fsx_openzfs_file_system.withTagsAll` constructs a mixin object that can be merged into the `datasync_location_fsx_openzfs_file_system`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
