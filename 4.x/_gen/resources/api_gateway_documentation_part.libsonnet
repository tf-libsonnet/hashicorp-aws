...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLocation':: d.fn(help='`aws.api_gateway_documentation_part.withLocation` constructs a mixin object that can be merged into the `api_gateway_documentation_part`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withLocationMixin':: d.fn(help='`aws.api_gateway_documentation_part.withLocationMixin` constructs a mixin object that can be merged into the `api_gateway_documentation_part`\nTerraform resource block to set or update the location field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.api_gateway_documentation_part.withLocation](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withProperties':: d.fn(help='`aws.api_gateway_documentation_part.withProperties` constructs a mixin object that can be merged into the `api_gateway_documentation_part`\nTerraform resource block to set or update the properties field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `properties` field.\n', args=[]),
  ...
  '#withRestApiId':: d.fn(help='`aws.api_gateway_documentation_part.withRestApiId` constructs a mixin object that can be merged into the `api_gateway_documentation_part`\nTerraform resource block to set or update the rest_api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rest_api_id` field.\n', args=[]),
