...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCompleteLock':: d.fn(help='`aws.glacier_vault_lock.withCompleteLock` constructs a mixin object that can be merged into the `glacier_vault_lock`\nTerraform resource block to set or update the complete_lock field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `complete_lock` field.\n', args=[]),
  ...
  '#withIgnoreDeletionError':: d.fn(help='`aws.glacier_vault_lock.withIgnoreDeletionError` constructs a mixin object that can be merged into the `glacier_vault_lock`\nTerraform resource block to set or update the ignore_deletion_error field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ignore_deletion_error` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.glacier_vault_lock.withPolicy` constructs a mixin object that can be merged into the `glacier_vault_lock`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withVaultName':: d.fn(help='`aws.glacier_vault_lock.withVaultName` constructs a mixin object that can be merged into the `glacier_vault_lock`\nTerraform resource block to set or update the vault_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vault_name` field.\n', args=[]),
