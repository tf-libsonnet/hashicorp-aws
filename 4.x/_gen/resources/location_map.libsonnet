...
{
  '#':: d.pkg(name='location_map', url='', help='`location_map` represents the `aws_location_map` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  configuration:: {
  ...
  '#withConfigurationMixin':: d.fn(help='`aws.location_map.withConfigurationMixin` constructs a mixin object that can be merged into the `location_map`\nTerraform resource block to set or update the configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.location_map.withConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `configuration` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.location_map.withDescription` constructs a mixin object that can be merged into the `location_map`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withMapName':: d.fn(help='`aws.location_map.withMapName` constructs a mixin object that can be merged into the `location_map`\nTerraform resource block to set or update the map_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `map_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.location_map.withTags` constructs a mixin object that can be merged into the `location_map`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.location_map.withTagsAll` constructs a mixin object that can be merged into the `location_map`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
