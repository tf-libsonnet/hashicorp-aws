...
{
  '#':: d.pkg(name='dx_connection_association', url='', help='`dx_connection_association` represents the `aws_dx_connection_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withConnectionId':: d.fn(help='`aws.dx_connection_association.withConnectionId` constructs a mixin object that can be merged into the `dx_connection_association`\nTerraform resource block to set or update the connection_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_id` field.\n', args=[]),
  ...
  '#withLagId':: d.fn(help='`aws.dx_connection_association.withLagId` constructs a mixin object that can be merged into the `dx_connection_association`\nTerraform resource block to set or update the lag_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lag_id` field.\n', args=[]),
