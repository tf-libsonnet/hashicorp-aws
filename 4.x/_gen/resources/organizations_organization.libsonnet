...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAwsServiceAccessPrincipals':: d.fn(help='`aws.organizations_organization.withAwsServiceAccessPrincipals` constructs a mixin object that can be merged into the `organizations_organization`\nTerraform resource block to set or update the aws_service_access_principals field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `aws_service_access_principals` field.\n', args=[]),
  ...
  '#withEnabledPolicyTypes':: d.fn(help='`aws.organizations_organization.withEnabledPolicyTypes` constructs a mixin object that can be merged into the `organizations_organization`\nTerraform resource block to set or update the enabled_policy_types field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled_policy_types` field.\n', args=[]),
  ...
  '#withFeatureSet':: d.fn(help='`aws.organizations_organization.withFeatureSet` constructs a mixin object that can be merged into the `organizations_organization`\nTerraform resource block to set or update the feature_set field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `feature_set` field.\n', args=[]),
