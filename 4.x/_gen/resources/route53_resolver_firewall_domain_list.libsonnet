...
{
  '#':: d.pkg(name='route53_resolver_firewall_domain_list', url='', help='`route53_resolver_firewall_domain_list` represents the `aws_route53_resolver_firewall_domain_list` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDomains':: d.fn(help='`aws.route53_resolver_firewall_domain_list.withDomains` constructs a mixin object that can be merged into the `route53_resolver_firewall_domain_list`\nTerraform resource block to set or update the domains field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domains` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.route53_resolver_firewall_domain_list.withName` constructs a mixin object that can be merged into the `route53_resolver_firewall_domain_list`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.route53_resolver_firewall_domain_list.withTags` constructs a mixin object that can be merged into the `route53_resolver_firewall_domain_list`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.route53_resolver_firewall_domain_list.withTagsAll` constructs a mixin object that can be merged into the `route53_resolver_firewall_domain_list`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
