...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroupName':: d.fn(help='`aws.ec2_availability_zone_group.withGroupName` constructs a mixin object that can be merged into the `ec2_availability_zone_group`\nTerraform resource block to set or update the group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_name` field.\n', args=[]),
  ...
  '#withOptInStatus':: d.fn(help='`aws.ec2_availability_zone_group.withOptInStatus` constructs a mixin object that can be merged into the `ec2_availability_zone_group`\nTerraform resource block to set or update the opt_in_status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `opt_in_status` field.\n', args=[]),
