...
{
  '#':: d.pkg(name='network_acl_association', url='', help='`network_acl_association` represents the `aws_network_acl_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withNetworkAclId':: d.fn(help='`aws.network_acl_association.withNetworkAclId` constructs a mixin object that can be merged into the `network_acl_association`\nTerraform resource block to set or update the network_acl_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_acl_id` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`aws.network_acl_association.withSubnetId` constructs a mixin object that can be merged into the `network_acl_association`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
