...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFsxFilesystemArn':: d.fn(help='`aws.datasync_location_fsx_lustre_file_system.withFsxFilesystemArn` constructs a mixin object that can be merged into the `datasync_location_fsx_lustre_file_system`\nTerraform resource block to set or update the fsx_filesystem_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fsx_filesystem_arn` field.\n', args=[]),
  ...
  '#withSecurityGroupArns':: d.fn(help='`aws.datasync_location_fsx_lustre_file_system.withSecurityGroupArns` constructs a mixin object that can be merged into the `datasync_location_fsx_lustre_file_system`\nTerraform resource block to set or update the security_group_arns field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_group_arns` field.\n', args=[]),
  ...
  '#withSubdirectory':: d.fn(help='`aws.datasync_location_fsx_lustre_file_system.withSubdirectory` constructs a mixin object that can be merged into the `datasync_location_fsx_lustre_file_system`\nTerraform resource block to set or update the subdirectory field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subdirectory` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.datasync_location_fsx_lustre_file_system.withTags` constructs a mixin object that can be merged into the `datasync_location_fsx_lustre_file_system`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.datasync_location_fsx_lustre_file_system.withTagsAll` constructs a mixin object that can be merged into the `datasync_location_fsx_lustre_file_system`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
