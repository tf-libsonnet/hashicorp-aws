  ...
  s3_job_definition:: {
    bucket_criteria:: {
      excludes:: {
        ...
        '#new':: d.fn(help='\n`aws.macie2_classification_job.s3_job_definition.bucket_criteria.excludes.new` constructs a new object with attributes and blocks configured for the `excludes`\nTerraform sub block.\n\n\n\n**Args**:\n  - `and` (`list[obj]`):  When `null`, the `and` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.bucket_criteria.excludes.and.new](#fn-s3_job_definitionbucket_criteriaandnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `excludes` sub block.\n', args=[]),
        new(
          and=null
        ):: std.prune(a={
          and: and,
      ...
      includes:: {
        ...
        '#new':: d.fn(help='\n`aws.macie2_classification_job.s3_job_definition.bucket_criteria.includes.new` constructs a new object with attributes and blocks configured for the `includes`\nTerraform sub block.\n\n\n\n**Args**:\n  - `and` (`list[obj]`):  When `null`, the `and` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.bucket_criteria.includes.and.new](#fn-s3_job_definitionbucket_criteriaandnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `includes` sub block.\n', args=[]),
        new(
          and=null
        ):: std.prune(a={
          and: and,
      ...
      '#new':: d.fn(help='\n`aws.macie2_classification_job.s3_job_definition.bucket_criteria.new` constructs a new object with attributes and blocks configured for the `bucket_criteria`\nTerraform sub block.\n\n\n\n**Args**:\n  - `excludes` (`list[obj]`):  When `null`, the `excludes` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.bucket_criteria.excludes.new](#fn-s3_job_definitionexcludesnew) constructor.\n  - `includes` (`list[obj]`):  When `null`, the `includes` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.bucket_criteria.includes.new](#fn-s3_job_definitionincludesnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `bucket_criteria` sub block.\n', args=[]),
      new(
        excludes=null,
        includes=null
      ):: std.prune(a={
    ...
    '#new':: d.fn(help='\n`aws.macie2_classification_job.s3_job_definition.new` constructs a new object with attributes and blocks configured for the `s3_job_definition`\nTerraform sub block.\n\n\n\n**Args**:\n  - `bucket_criteria` (`list[obj]`):  When `null`, the `bucket_criteria` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.bucket_criteria.new](#fn-bucket_criterianew) constructor.\n  - `bucket_definitions` (`list[obj]`):  When `null`, the `bucket_definitions` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.bucket_definitions.new](#fn-bucket_definitionsnew) constructor.\n  - `scoping` (`list[obj]`):  When `null`, the `scoping` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.scoping.new](#fn-scopingnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `s3_job_definition` sub block.\n', args=[]),
    new(
    ...
    scoping:: {
      excludes:: {
        ...
        '#new':: d.fn(help='\n`aws.macie2_classification_job.s3_job_definition.scoping.excludes.new` constructs a new object with attributes and blocks configured for the `excludes`\nTerraform sub block.\n\n\n\n**Args**:\n  - `and` (`list[obj]`):  When `null`, the `and` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.scoping.excludes.and.new](#fn-s3_job_definitionscopingandnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `excludes` sub block.\n', args=[]),
        new(
          and=null
        ):: std.prune(a={
          and: and,
      ...
      includes:: {
        ...
        '#new':: d.fn(help='\n`aws.macie2_classification_job.s3_job_definition.scoping.includes.new` constructs a new object with attributes and blocks configured for the `includes`\nTerraform sub block.\n\n\n\n**Args**:\n  - `and` (`list[obj]`):  When `null`, the `and` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.scoping.includes.and.new](#fn-s3_job_definitionscopingandnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `includes` sub block.\n', args=[]),
        new(
          and=null
        ):: std.prune(a={
          and: and,
      ...
      '#new':: d.fn(help='\n`aws.macie2_classification_job.s3_job_definition.scoping.new` constructs a new object with attributes and blocks configured for the `scoping`\nTerraform sub block.\n\n\n\n**Args**:\n  - `excludes` (`list[obj]`):  When `null`, the `excludes` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.scoping.excludes.new](#fn-s3_job_definitionexcludesnew) constructor.\n  - `includes` (`list[obj]`):  When `null`, the `includes` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.scoping.includes.new](#fn-s3_job_definitionincludesnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `scoping` sub block.\n', args=[]),
      new(
        excludes=null,
        includes=null
      ):: std.prune(a={
