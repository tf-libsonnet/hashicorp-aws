...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  s3_job_definition:: {
    bucket_criteria:: {
      ...
      '#new':: d.fn(help='\n`aws.macie2_classification_job.s3_job_definition.bucket_criteria.new` constructs a new object with attributes and blocks configured for the `bucket_criteria`\nTerraform sub block.\n\n\n\n**Args**:\n  - `excludes` (`list[obj]`):  When `null`, the `excludes` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.bucket_criteria.excludes.new](#fn-bucket_criteriaexcludesnew) constructor.\n  - `includes` (`list[obj]`):  When `null`, the `includes` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.macie2_classification_job.s3_job_definition.bucket_criteria.includes.new](#fn-bucket_criteriaincludesnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `bucket_criteria` sub block.\n', args=[]),
      new(
        excludes=null,
        includes=null
      ):: std.prune(a={
