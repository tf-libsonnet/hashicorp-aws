...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNamespaceName':: d.fn(help='`aws.redshiftserverless_snapshot.withNamespaceName` constructs a mixin object that can be merged into the `redshiftserverless_snapshot`\nTerraform resource block to set or update the namespace_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `namespace_name` field.\n', args=[]),
  ...
  '#withRetentionPeriod':: d.fn(help='`aws.redshiftserverless_snapshot.withRetentionPeriod` constructs a mixin object that can be merged into the `redshiftserverless_snapshot`\nTerraform resource block to set or update the retention_period field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention_period` field.\n', args=[]),
  ...
  '#withSnapshotName':: d.fn(help='`aws.redshiftserverless_snapshot.withSnapshotName` constructs a mixin object that can be merged into the `redshiftserverless_snapshot`\nTerraform resource block to set or update the snapshot_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `snapshot_name` field.\n', args=[]),
