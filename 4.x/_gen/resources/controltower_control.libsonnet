...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withControlIdentifier':: d.fn(help='`aws.controltower_control.withControlIdentifier` constructs a mixin object that can be merged into the `controltower_control`\nTerraform resource block to set or update the control_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `control_identifier` field.\n', args=[]),
  ...
  '#withTargetIdentifier':: d.fn(help='`aws.controltower_control.withTargetIdentifier` constructs a mixin object that can be merged into the `controltower_control`\nTerraform resource block to set or update the target_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_identifier` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.controltower_control.withTimeouts` constructs a mixin object that can be merged into the `controltower_control`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.controltower_control.withTimeoutsMixin` constructs a mixin object that can be merged into the `controltower_control`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.controltower_control.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
