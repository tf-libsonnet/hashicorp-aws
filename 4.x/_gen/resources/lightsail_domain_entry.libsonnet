...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomainName':: d.fn(help='`aws.lightsail_domain_entry.withDomainName` constructs a mixin object that can be merged into the `lightsail_domain_entry`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withIsAlias':: d.fn(help='`aws.lightsail_domain_entry.withIsAlias` constructs a mixin object that can be merged into the `lightsail_domain_entry`\nTerraform resource block to set or update the is_alias field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `is_alias` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.lightsail_domain_entry.withName` constructs a mixin object that can be merged into the `lightsail_domain_entry`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTarget':: d.fn(help='`aws.lightsail_domain_entry.withTarget` constructs a mixin object that can be merged into the `lightsail_domain_entry`\nTerraform resource block to set or update the target field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target` field.\n', args=[]),
  ...
  '#withType':: d.fn(help='`aws.lightsail_domain_entry.withType` constructs a mixin object that can be merged into the `lightsail_domain_entry`\nTerraform resource block to set or update the type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type` field.\n', args=[]),
