...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDevice':: d.fn(help='`aws.sagemaker_device.withDevice` constructs a mixin object that can be merged into the `sagemaker_device`\nTerraform resource block to set or update the device field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `device` field.\n', args=[]),
  ...
  '#withDeviceFleetName':: d.fn(help='`aws.sagemaker_device.withDeviceFleetName` constructs a mixin object that can be merged into the `sagemaker_device`\nTerraform resource block to set or update the device_fleet_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `device_fleet_name` field.\n', args=[]),
  ...
  '#withDeviceMixin':: d.fn(help='`aws.sagemaker_device.withDeviceMixin` constructs a mixin object that can be merged into the `sagemaker_device`\nTerraform resource block to set or update the device field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.sagemaker_device.withDevice](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `device` field.\n', args=[]),
