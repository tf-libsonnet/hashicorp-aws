...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDefaultSenderId':: d.fn(help='`aws.sns_sms_preferences.withDefaultSenderId` constructs a mixin object that can be merged into the `sns_sms_preferences`\nTerraform resource block to set or update the default_sender_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_sender_id` field.\n', args=[]),
  ...
  '#withDefaultSmsType':: d.fn(help='`aws.sns_sms_preferences.withDefaultSmsType` constructs a mixin object that can be merged into the `sns_sms_preferences`\nTerraform resource block to set or update the default_sms_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_sms_type` field.\n', args=[]),
  ...
  '#withDeliveryStatusIamRoleArn':: d.fn(help='`aws.sns_sms_preferences.withDeliveryStatusIamRoleArn` constructs a mixin object that can be merged into the `sns_sms_preferences`\nTerraform resource block to set or update the delivery_status_iam_role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delivery_status_iam_role_arn` field.\n', args=[]),
  ...
  '#withDeliveryStatusSuccessSamplingRate':: d.fn(help='`aws.sns_sms_preferences.withDeliveryStatusSuccessSamplingRate` constructs a mixin object that can be merged into the `sns_sms_preferences`\nTerraform resource block to set or update the delivery_status_success_sampling_rate field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delivery_status_success_sampling_rate` field.\n', args=[]),
  ...
  '#withMonthlySpendLimit':: d.fn(help='`aws.sns_sms_preferences.withMonthlySpendLimit` constructs a mixin object that can be merged into the `sns_sms_preferences`\nTerraform resource block to set or update the monthly_spend_limit field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monthly_spend_limit` field.\n', args=[]),
  ...
  '#withUsageReportS3Bucket':: d.fn(help='`aws.sns_sms_preferences.withUsageReportS3Bucket` constructs a mixin object that can be merged into the `sns_sms_preferences`\nTerraform resource block to set or update the usage_report_s3_bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `usage_report_s3_bucket` field.\n', args=[]),
