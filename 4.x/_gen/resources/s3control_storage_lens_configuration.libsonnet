...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  storage_lens_configuration:: {
    ...
    '#new':: d.fn(help='\n`aws.s3control_storage_lens_configuration.storage_lens_configuration.new` constructs a new object with attributes and blocks configured for the `storage_lens_configuration`\nTerraform sub block.\n\n\n\n**Args**:\n  - `enabled` (`bool`): \n  - `account_level` (`list[obj]`):  When `null`, the `account_level` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.s3control_storage_lens_configuration.storage_lens_configuration.account_level.new](#fn-storagelensconfigurationaccountlevelnew) constructor.\n  - `aws_org` (`list[obj]`):  When `null`, the `aws_org` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.s3control_storage_lens_configuration.storage_lens_configuration.aws_org.new](#fn-storagelensconfigurationawsorgnew) constructor.\n  - `data_export` (`list[obj]`):  When `null`, the `data_export` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.s3control_storage_lens_configuration.storage_lens_configuration.data_export.new](#fn-storagelensconfigurationdataexportnew) constructor.\n  - `exclude` (`list[obj]`):  When `null`, the `exclude` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.s3control_storage_lens_configuration.storage_lens_configuration.exclude.new](#fn-storagelensconfigurationexcludenew) constructor.\n  - `include` (`list[obj]`):  When `null`, the `include` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.s3control_storage_lens_configuration.storage_lens_configuration.include.new](#fn-storagelensconfigurationincludenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `storage_lens_configuration` sub block.\n', args=[]),
    new(
      enabled,
      account_level=null,
      aws_org=null,
  ...
  '#withAccountId':: d.fn(help='`aws.s3control_storage_lens_configuration.withAccountId` constructs a mixin object that can be merged into the `s3control_storage_lens_configuration`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withConfigId':: d.fn(help='`aws.s3control_storage_lens_configuration.withConfigId` constructs a mixin object that can be merged into the `s3control_storage_lens_configuration`\nTerraform resource block to set or update the config_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `config_id` field.\n', args=[]),
  ...
  '#withStorageLensConfiguration':: d.fn(help='`aws.s3control_storage_lens_configuration.withStorageLensConfiguration` constructs a mixin object that can be merged into the `s3control_storage_lens_configuration`\nTerraform resource block to set or update the storage_lens_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_lens_configuration` field.\n', args=[]),
  ...
  '#withStorageLensConfigurationMixin':: d.fn(help='`aws.s3control_storage_lens_configuration.withStorageLensConfigurationMixin` constructs a mixin object that can be merged into the `s3control_storage_lens_configuration`\nTerraform resource block to set or update the storage_lens_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3control_storage_lens_configuration.withStorageLensConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_lens_configuration` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.s3control_storage_lens_configuration.withTags` constructs a mixin object that can be merged into the `s3control_storage_lens_configuration`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.s3control_storage_lens_configuration.withTagsAll` constructs a mixin object that can be merged into the `s3control_storage_lens_configuration`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
