...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  hierarchy_structure:: {
    ...
    '#new':: d.fn(help='\n`aws.connect_user_hierarchy_structure.hierarchy_structure.new` constructs a new object with attributes and blocks configured for the `hierarchy_structure`\nTerraform sub block.\n\n\n\n**Args**:\n  - `level_five` (`list[obj]`):  When `null`, the `level_five` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_five.new](#fn-connect_user_hierarchy_structurelevel_fivenew) constructor.\n  - `level_four` (`list[obj]`):  When `null`, the `level_four` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_four.new](#fn-connect_user_hierarchy_structurelevel_fournew) constructor.\n  - `level_one` (`list[obj]`):  When `null`, the `level_one` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_one.new](#fn-connect_user_hierarchy_structurelevel_onenew) constructor.\n  - `level_three` (`list[obj]`):  When `null`, the `level_three` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_three.new](#fn-connect_user_hierarchy_structurelevel_threenew) constructor.\n  - `level_two` (`list[obj]`):  When `null`, the `level_two` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_two.new](#fn-connect_user_hierarchy_structurelevel_twonew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `hierarchy_structure` sub block.\n', args=[]),
    new(
      level_five=null,
      level_four=null,
      level_one=null,
  ...
  '#withHierarchyStructureMixin':: d.fn(help='`aws.list[obj].withHierarchyStructureMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the hierarchy_structure field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withHierarchyStructure](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `hierarchy_structure` field.\n', args=[]),
