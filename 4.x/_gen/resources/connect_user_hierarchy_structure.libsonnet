...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  hierarchy_structure:: {
    ...
    '#new':: d.fn(help='\n`aws.connect_user_hierarchy_structure.hierarchy_structure.new` constructs a new object with attributes and blocks configured for the `hierarchy_structure`\nTerraform sub block.\n\n\n\n**Args**:\n  - `level_five` (`list[obj]`):  When `null`, the `level_five` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_five.new](#fn-level_fivenew) constructor.\n  - `level_four` (`list[obj]`):  When `null`, the `level_four` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_four.new](#fn-level_fournew) constructor.\n  - `level_one` (`list[obj]`):  When `null`, the `level_one` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_one.new](#fn-level_onenew) constructor.\n  - `level_three` (`list[obj]`):  When `null`, the `level_three` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_three.new](#fn-level_threenew) constructor.\n  - `level_two` (`list[obj]`):  When `null`, the `level_two` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_user_hierarchy_structure.hierarchy_structure.level_two.new](#fn-level_twonew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `hierarchy_structure` sub block.\n', args=[]),
    new(
      level_five=null,
      level_four=null,
      level_one=null,
