...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHostArn':: d.fn(help='`aws.codestarconnections_connection.withHostArn` constructs a mixin object that can be merged into the `codestarconnections_connection`\nTerraform resource block to set or update the host_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `host_arn` field.\n', args=[]),
  ...
  '#withProviderType':: d.fn(help='`aws.codestarconnections_connection.withProviderType` constructs a mixin object that can be merged into the `codestarconnections_connection`\nTerraform resource block to set or update the provider_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_type` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.codestarconnections_connection.withTagsAll` constructs a mixin object that can be merged into the `codestarconnections_connection`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
