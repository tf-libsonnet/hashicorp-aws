...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccessPointArn':: d.fn(help='`aws.s3control_access_point_policy.withAccessPointArn` constructs a mixin object that can be merged into the `s3control_access_point_policy`\nTerraform resource block to set or update the access_point_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `access_point_arn` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.s3control_access_point_policy.withPolicy` constructs a mixin object that can be merged into the `s3control_access_point_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
