...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withContext':: d.fn(help='`aws.kms_ciphertext.withContext` constructs a mixin object that can be merged into the `kms_ciphertext`\nTerraform resource block to set or update the context field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `context` field.\n', args=[]),
  ...
  '#withKeyId':: d.fn(help='`aws.kms_ciphertext.withKeyId` constructs a mixin object that can be merged into the `kms_ciphertext`\nTerraform resource block to set or update the key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_id` field.\n', args=[]),
  ...
  '#withPlaintext':: d.fn(help='`aws.kms_ciphertext.withPlaintext` constructs a mixin object that can be merged into the `kms_ciphertext`\nTerraform resource block to set or update the plaintext field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `plaintext` field.\n', args=[]),
