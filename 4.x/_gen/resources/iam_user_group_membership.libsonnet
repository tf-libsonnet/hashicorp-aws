...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroups':: d.fn(help='`aws.iam_user_group_membership.withGroups` constructs a mixin object that can be merged into the `iam_user_group_membership`\nTerraform resource block to set or update the groups field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `groups` field.\n', args=[]),
  ...
  '#withUser':: d.fn(help='`aws.iam_user_group_membership.withUser` constructs a mixin object that can be merged into the `iam_user_group_membership`\nTerraform resource block to set or update the user field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user` field.\n', args=[]),
