...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  storage_config:: {
    ...
    '#new':: d.fn(help='\n`aws.connect_instance_storage_config.storage_config.new` constructs a new object with attributes and blocks configured for the `storage_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `storage_type` (`string`): \n  - `kinesis_firehose_config` (`list[obj]`):  When `null`, the `kinesis_firehose_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_instance_storage_config.storage_config.kinesis_firehose_config.new](#fn-storageconfigkinesisfirehoseconfignew) constructor.\n  - `kinesis_stream_config` (`list[obj]`):  When `null`, the `kinesis_stream_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_instance_storage_config.storage_config.kinesis_stream_config.new](#fn-storageconfigkinesisstreamconfignew) constructor.\n  - `kinesis_video_stream_config` (`list[obj]`):  When `null`, the `kinesis_video_stream_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_instance_storage_config.storage_config.kinesis_video_stream_config.new](#fn-storageconfigkinesisvideostreamconfignew) constructor.\n  - `s3_config` (`list[obj]`):  When `null`, the `s3_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_instance_storage_config.storage_config.s3_config.new](#fn-storageconfigs3confignew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `storage_config` sub block.\n', args=[]),
    new(
      storage_type,
  ...
  '#withInstanceId':: d.fn(help='`aws.connect_instance_storage_config.withInstanceId` constructs a mixin object that can be merged into the `connect_instance_storage_config`\nTerraform resource block to set or update the instance_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_id` field.\n', args=[]),
  ...
  '#withResourceType':: d.fn(help='`aws.connect_instance_storage_config.withResourceType` constructs a mixin object that can be merged into the `connect_instance_storage_config`\nTerraform resource block to set or update the resource_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_type` field.\n', args=[]),
  ...
  '#withStorageConfig':: d.fn(help='`aws.connect_instance_storage_config.withStorageConfig` constructs a mixin object that can be merged into the `connect_instance_storage_config`\nTerraform resource block to set or update the storage_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_config` field.\n', args=[]),
  ...
  '#withStorageConfigMixin':: d.fn(help='`aws.connect_instance_storage_config.withStorageConfigMixin` constructs a mixin object that can be merged into the `connect_instance_storage_config`\nTerraform resource block to set or update the storage_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.connect_instance_storage_config.withStorageConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_config` field.\n', args=[]),
