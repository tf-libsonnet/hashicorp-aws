...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuthParameters':: d.fn(help='`aws.cloudwatch_event_connection.withAuthParameters` constructs a mixin object that can be merged into the `cloudwatch_event_connection`\nTerraform resource block to set or update the auth_parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auth_parameters` field.\n', args=[]),
  ...
  '#withAuthParametersMixin':: d.fn(help='`aws.cloudwatch_event_connection.withAuthParametersMixin` constructs a mixin object that can be merged into the `cloudwatch_event_connection`\nTerraform resource block to set or update the auth_parameters field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudwatch_event_connection.withAuthParameters](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auth_parameters` field.\n', args=[]),
  ...
  '#withAuthorizationType':: d.fn(help='`aws.cloudwatch_event_connection.withAuthorizationType` constructs a mixin object that can be merged into the `cloudwatch_event_connection`\nTerraform resource block to set or update the authorization_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authorization_type` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.cloudwatch_event_connection.withDescription` constructs a mixin object that can be merged into the `cloudwatch_event_connection`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
