...
{
  '#':: d.pkg(name='shield_protection', url='', help='`shield_protection` represents the `aws_shield_protection` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.shield_protection.withName` constructs a mixin object that can be merged into the `shield_protection`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceArn':: d.fn(help='`aws.shield_protection.withResourceArn` constructs a mixin object that can be merged into the `shield_protection`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.shield_protection.withTags` constructs a mixin object that can be merged into the `shield_protection`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.shield_protection.withTagsAll` constructs a mixin object that can be merged into the `shield_protection`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
