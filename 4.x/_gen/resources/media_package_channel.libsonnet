...
{
  '#':: d.pkg(name='media_package_channel', url='', help='`media_package_channel` represents the `aws_media_package_channel` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withChannelId':: d.fn(help='`aws.media_package_channel.withChannelId` constructs a mixin object that can be merged into the `media_package_channel`\nTerraform resource block to set or update the channel_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `channel_id` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.media_package_channel.withDescription` constructs a mixin object that can be merged into the `media_package_channel`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.media_package_channel.withTags` constructs a mixin object that can be merged into the `media_package_channel`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.media_package_channel.withTagsAll` constructs a mixin object that can be merged into the `media_package_channel`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
