...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIpSetDescriptorsMixin':: d.fn(help='`aws.waf_ipset.withIpSetDescriptorsMixin` constructs a mixin object that can be merged into the `waf_ipset`\nTerraform resource block to set or update the ip_set_descriptors field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.waf_ipset.withIpSetDescriptors](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_set_descriptors` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.waf_ipset.withName` constructs a mixin object that can be merged into the `waf_ipset`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
