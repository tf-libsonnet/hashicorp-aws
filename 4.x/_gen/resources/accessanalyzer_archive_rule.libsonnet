...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAnalyzerName':: d.fn(help='`aws.accessanalyzer_archive_rule.withAnalyzerName` constructs a mixin object that can be merged into the `accessanalyzer_archive_rule`\nTerraform resource block to set or update the analyzer_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `analyzer_name` field.\n', args=[]),
  ...
  '#withFilter':: d.fn(help='`aws.accessanalyzer_archive_rule.withFilter` constructs a mixin object that can be merged into the `accessanalyzer_archive_rule`\nTerraform resource block to set or update the filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.accessanalyzer_archive_rule.withFilterMixin` constructs a mixin object that can be merged into the `accessanalyzer_archive_rule`\nTerraform resource block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.accessanalyzer_archive_rule.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withRuleName':: d.fn(help='`aws.accessanalyzer_archive_rule.withRuleName` constructs a mixin object that can be merged into the `accessanalyzer_archive_rule`\nTerraform resource block to set or update the rule_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rule_name` field.\n', args=[]),
