...
{
  '#':: d.pkg(name='route53recoveryreadiness_readiness_check', url='', help='`route53recoveryreadiness_readiness_check` represents the `aws_route53recoveryreadiness_readiness_check` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withReadinessCheckName':: d.fn(help='`aws.route53recoveryreadiness_readiness_check.withReadinessCheckName` constructs a mixin object that can be merged into the `route53recoveryreadiness_readiness_check`\nTerraform resource block to set or update the readiness_check_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `readiness_check_name` field.\n', args=[]),
  ...
  '#withResourceSetName':: d.fn(help='`aws.route53recoveryreadiness_readiness_check.withResourceSetName` constructs a mixin object that can be merged into the `route53recoveryreadiness_readiness_check`\nTerraform resource block to set or update the resource_set_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_set_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.route53recoveryreadiness_readiness_check.withTags` constructs a mixin object that can be merged into the `route53recoveryreadiness_readiness_check`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.route53recoveryreadiness_readiness_check.withTagsAll` constructs a mixin object that can be merged into the `route53recoveryreadiness_readiness_check`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.route53recoveryreadiness_readiness_check.withTimeouts` constructs a mixin object that can be merged into the `route53recoveryreadiness_readiness_check`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.route53recoveryreadiness_readiness_check.withTimeoutsMixin` constructs a mixin object that can be merged into the `route53recoveryreadiness_readiness_check`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.route53recoveryreadiness_readiness_check.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
