...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRepositoryName':: d.fn(help='`aws.codecommit_trigger.withRepositoryName` constructs a mixin object that can be merged into the `codecommit_trigger`\nTerraform resource block to set or update the repository_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository_name` field.\n', args=[]),
  ...
  '#withTrigger':: d.fn(help='`aws.codecommit_trigger.withTrigger` constructs a mixin object that can be merged into the `codecommit_trigger`\nTerraform resource block to set or update the trigger field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `trigger` field.\n', args=[]),
  ...
  '#withTriggerMixin':: d.fn(help='`aws.codecommit_trigger.withTriggerMixin` constructs a mixin object that can be merged into the `codecommit_trigger`\nTerraform resource block to set or update the trigger field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.codecommit_trigger.withTrigger](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `trigger` field.\n', args=[]),
