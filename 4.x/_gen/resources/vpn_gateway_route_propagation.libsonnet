...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRouteTableId':: d.fn(help='`aws.vpn_gateway_route_propagation.withRouteTableId` constructs a mixin object that can be merged into the `vpn_gateway_route_propagation`\nTerraform resource block to set or update the route_table_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `route_table_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.vpn_gateway_route_propagation.withTimeouts` constructs a mixin object that can be merged into the `vpn_gateway_route_propagation`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.vpn_gateway_route_propagation.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpn_gateway_route_propagation`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.vpn_gateway_route_propagation.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpnGatewayId':: d.fn(help='`aws.vpn_gateway_route_propagation.withVpnGatewayId` constructs a mixin object that can be merged into the `vpn_gateway_route_propagation`\nTerraform resource block to set or update the vpn_gateway_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpn_gateway_id` field.\n', args=[]),
