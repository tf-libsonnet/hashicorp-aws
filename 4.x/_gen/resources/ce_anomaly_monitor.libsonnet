...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMonitorDimension':: d.fn(help='`aws.ce_anomaly_monitor.withMonitorDimension` constructs a mixin object that can be merged into the `ce_anomaly_monitor`\nTerraform resource block to set or update the monitor_dimension field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitor_dimension` field.\n', args=[]),
  ...
  '#withMonitorSpecification':: d.fn(help='`aws.ce_anomaly_monitor.withMonitorSpecification` constructs a mixin object that can be merged into the `ce_anomaly_monitor`\nTerraform resource block to set or update the monitor_specification field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitor_specification` field.\n', args=[]),
  ...
  '#withMonitorType':: d.fn(help='`aws.ce_anomaly_monitor.withMonitorType` constructs a mixin object that can be merged into the `ce_anomaly_monitor`\nTerraform resource block to set or update the monitor_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitor_type` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.ce_anomaly_monitor.withName` constructs a mixin object that can be merged into the `ce_anomaly_monitor`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.ce_anomaly_monitor.withTags` constructs a mixin object that can be merged into the `ce_anomaly_monitor`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ce_anomaly_monitor.withTagsAll` constructs a mixin object that can be merged into the `ce_anomaly_monitor`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
