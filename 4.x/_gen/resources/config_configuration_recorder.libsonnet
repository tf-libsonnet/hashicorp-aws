...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.config_configuration_recorder.withName` constructs a mixin object that can be merged into the `config_configuration_recorder`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRecordingGroup':: d.fn(help='`aws.config_configuration_recorder.withRecordingGroup` constructs a mixin object that can be merged into the `config_configuration_recorder`\nTerraform resource block to set or update the recording_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `recording_group` field.\n', args=[]),
  ...
  '#withRecordingGroupMixin':: d.fn(help='`aws.config_configuration_recorder.withRecordingGroupMixin` constructs a mixin object that can be merged into the `config_configuration_recorder`\nTerraform resource block to set or update the recording_group field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.config_configuration_recorder.withRecordingGroup](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `recording_group` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.config_configuration_recorder.withRoleArn` constructs a mixin object that can be merged into the `config_configuration_recorder`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
