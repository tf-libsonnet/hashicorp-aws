...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAvailabilityZone':: d.fn(help='`aws.lightsail_disk.withAvailabilityZone` constructs a mixin object that can be merged into the `lightsail_disk`\nTerraform resource block to set or update the availability_zone field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `availability_zone` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.lightsail_disk.withName` constructs a mixin object that can be merged into the `lightsail_disk`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSizeInGb':: d.fn(help='`aws.lightsail_disk.withSizeInGb` constructs a mixin object that can be merged into the `lightsail_disk`\nTerraform resource block to set or update the size_in_gb field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `size_in_gb` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.lightsail_disk.withTags` constructs a mixin object that can be merged into the `lightsail_disk`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.lightsail_disk.withTagsAll` constructs a mixin object that can be merged into the `lightsail_disk`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
