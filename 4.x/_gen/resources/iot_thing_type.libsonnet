...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeprecated':: d.fn(help='`aws.iot_thing_type.withDeprecated` constructs a mixin object that can be merged into the `iot_thing_type`\nTerraform resource block to set or update the deprecated field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deprecated` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.iot_thing_type.withName` constructs a mixin object that can be merged into the `iot_thing_type`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProperties':: d.fn(help='`aws.iot_thing_type.withProperties` constructs a mixin object that can be merged into the `iot_thing_type`\nTerraform resource block to set or update the properties field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `properties` field.\n', args=[]),
  ...
  '#withPropertiesMixin':: d.fn(help='`aws.iot_thing_type.withPropertiesMixin` constructs a mixin object that can be merged into the `iot_thing_type`\nTerraform resource block to set or update the properties field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.iot_thing_type.withProperties](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `properties` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.iot_thing_type.withTags` constructs a mixin object that can be merged into the `iot_thing_type`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.iot_thing_type.withTagsAll` constructs a mixin object that can be merged into the `iot_thing_type`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
