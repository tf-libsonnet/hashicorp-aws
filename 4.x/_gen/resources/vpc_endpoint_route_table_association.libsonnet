...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRouteTableId':: d.fn(help='`aws.vpc_endpoint_route_table_association.withRouteTableId` constructs a mixin object that can be merged into the `vpc_endpoint_route_table_association`\nTerraform resource block to set or update the route_table_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `route_table_id` field.\n', args=[]),
  ...
  '#withVpcEndpointId':: d.fn(help='`aws.vpc_endpoint_route_table_association.withVpcEndpointId` constructs a mixin object that can be merged into the `vpc_endpoint_route_table_association`\nTerraform resource block to set or update the vpc_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_endpoint_id` field.\n', args=[]),
