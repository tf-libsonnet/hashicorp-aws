...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDestinationCidrBlock':: d.fn(help='`aws.vpn_connection_route.withDestinationCidrBlock` constructs a mixin object that can be merged into the `vpn_connection_route`\nTerraform resource block to set or update the destination_cidr_block field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_cidr_block` field.\n', args=[]),
  ...
  '#withVpnConnectionId':: d.fn(help='`aws.vpn_connection_route.withVpnConnectionId` constructs a mixin object that can be merged into the `vpn_connection_route`\nTerraform resource block to set or update the vpn_connection_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpn_connection_id` field.\n', args=[]),
