...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstanceArn':: d.fn(help='`aws.ssoadmin_permissions_boundary_attachment.withInstanceArn` constructs a mixin object that can be merged into the `ssoadmin_permissions_boundary_attachment`\nTerraform resource block to set or update the instance_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_arn` field.\n', args=[]),
  ...
  '#withPermissionSetArn':: d.fn(help='`aws.ssoadmin_permissions_boundary_attachment.withPermissionSetArn` constructs a mixin object that can be merged into the `ssoadmin_permissions_boundary_attachment`\nTerraform resource block to set or update the permission_set_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permission_set_arn` field.\n', args=[]),
  ...
  '#withPermissionsBoundary':: d.fn(help='`aws.ssoadmin_permissions_boundary_attachment.withPermissionsBoundary` constructs a mixin object that can be merged into the `ssoadmin_permissions_boundary_attachment`\nTerraform resource block to set or update the permissions_boundary field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permissions_boundary` field.\n', args=[]),
  ...
  '#withPermissionsBoundaryMixin':: d.fn(help='`aws.ssoadmin_permissions_boundary_attachment.withPermissionsBoundaryMixin` constructs a mixin object that can be merged into the `ssoadmin_permissions_boundary_attachment`\nTerraform resource block to set or update the permissions_boundary field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ssoadmin_permissions_boundary_attachment.withPermissionsBoundary](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permissions_boundary` field.\n', args=[]),
