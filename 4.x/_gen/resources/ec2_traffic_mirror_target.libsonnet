...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.ec2_traffic_mirror_target.withDescription` constructs a mixin object that can be merged into the `ec2_traffic_mirror_target`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withGatewayLoadBalancerEndpointId':: d.fn(help='`aws.ec2_traffic_mirror_target.withGatewayLoadBalancerEndpointId` constructs a mixin object that can be merged into the `ec2_traffic_mirror_target`\nTerraform resource block to set or update the gateway_load_balancer_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway_load_balancer_endpoint_id` field.\n', args=[]),
  ...
  '#withNetworkInterfaceId':: d.fn(help='`aws.ec2_traffic_mirror_target.withNetworkInterfaceId` constructs a mixin object that can be merged into the `ec2_traffic_mirror_target`\nTerraform resource block to set or update the network_interface_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_interface_id` field.\n', args=[]),
  ...
  '#withNetworkLoadBalancerArn':: d.fn(help='`aws.ec2_traffic_mirror_target.withNetworkLoadBalancerArn` constructs a mixin object that can be merged into the `ec2_traffic_mirror_target`\nTerraform resource block to set or update the network_load_balancer_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_load_balancer_arn` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.ec2_traffic_mirror_target.withTags` constructs a mixin object that can be merged into the `ec2_traffic_mirror_target`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ec2_traffic_mirror_target.withTagsAll` constructs a mixin object that can be merged into the `ec2_traffic_mirror_target`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
