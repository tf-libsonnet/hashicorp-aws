...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppId':: d.fn(help='`aws.amplify_domain_association.withAppId` constructs a mixin object that can be merged into the `amplify_domain_association`\nTerraform resource block to set or update the app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_id` field.\n', args=[]),
  ...
  '#withDomainName':: d.fn(help='`aws.amplify_domain_association.withDomainName` constructs a mixin object that can be merged into the `amplify_domain_association`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withSubDomain':: d.fn(help='`aws.amplify_domain_association.withSubDomain` constructs a mixin object that can be merged into the `amplify_domain_association`\nTerraform resource block to set or update the sub_domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sub_domain` field.\n', args=[]),
  ...
  '#withSubDomainMixin':: d.fn(help='`aws.amplify_domain_association.withSubDomainMixin` constructs a mixin object that can be merged into the `amplify_domain_association`\nTerraform resource block to set or update the sub_domain field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.amplify_domain_association.withSubDomain](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sub_domain` field.\n', args=[]),
  ...
  '#withWaitForVerification':: d.fn(help='`aws.amplify_domain_association.withWaitForVerification` constructs a mixin object that can be merged into the `amplify_domain_association`\nTerraform resource block to set or update the wait_for_verification field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `wait_for_verification` field.\n', args=[]),
