...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeviceId':: d.fn(help='`aws.networkmanager_transit_gateway_connect_peer_association.withDeviceId` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_connect_peer_association`\nTerraform resource block to set or update the device_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `device_id` field.\n', args=[]),
  ...
  '#withGlobalNetworkId':: d.fn(help='`aws.networkmanager_transit_gateway_connect_peer_association.withGlobalNetworkId` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_connect_peer_association`\nTerraform resource block to set or update the global_network_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `global_network_id` field.\n', args=[]),
  ...
  '#withLinkId':: d.fn(help='`aws.networkmanager_transit_gateway_connect_peer_association.withLinkId` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_connect_peer_association`\nTerraform resource block to set or update the link_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `link_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.networkmanager_transit_gateway_connect_peer_association.withTimeouts` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_connect_peer_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.networkmanager_transit_gateway_connect_peer_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_connect_peer_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.networkmanager_transit_gateway_connect_peer_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTransitGatewayConnectPeerArn':: d.fn(help='`aws.networkmanager_transit_gateway_connect_peer_association.withTransitGatewayConnectPeerArn` constructs a mixin object that can be merged into the `networkmanager_transit_gateway_connect_peer_association`\nTerraform resource block to set or update the transit_gateway_connect_peer_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_connect_peer_arn` field.\n', args=[]),
