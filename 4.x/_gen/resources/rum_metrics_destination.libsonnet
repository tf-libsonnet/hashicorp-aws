...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppMonitorName':: d.fn(help='`aws.rum_metrics_destination.withAppMonitorName` constructs a mixin object that can be merged into the `rum_metrics_destination`\nTerraform resource block to set or update the app_monitor_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_monitor_name` field.\n', args=[]),
  ...
  '#withDestination':: d.fn(help='`aws.rum_metrics_destination.withDestination` constructs a mixin object that can be merged into the `rum_metrics_destination`\nTerraform resource block to set or update the destination field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination` field.\n', args=[]),
  ...
  '#withDestinationArn':: d.fn(help='`aws.rum_metrics_destination.withDestinationArn` constructs a mixin object that can be merged into the `rum_metrics_destination`\nTerraform resource block to set or update the destination_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_arn` field.\n', args=[]),
  ...
  '#withIamRoleArn':: d.fn(help='`aws.rum_metrics_destination.withIamRoleArn` constructs a mixin object that can be merged into the `rum_metrics_destination`\nTerraform resource block to set or update the iam_role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `iam_role_arn` field.\n', args=[]),
