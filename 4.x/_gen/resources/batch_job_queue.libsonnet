...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withComputeEnvironments':: d.fn(help='`aws.batch_job_queue.withComputeEnvironments` constructs a mixin object that can be merged into the `batch_job_queue`\nTerraform resource block to set or update the compute_environments field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `compute_environments` field.\n', args=[]),
  ...
  '#withPriority':: d.fn(help='`aws.batch_job_queue.withPriority` constructs a mixin object that can be merged into the `batch_job_queue`\nTerraform resource block to set or update the priority field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `priority` field.\n', args=[]),
  ...
  '#withSchedulingPolicyArn':: d.fn(help='`aws.batch_job_queue.withSchedulingPolicyArn` constructs a mixin object that can be merged into the `batch_job_queue`\nTerraform resource block to set or update the scheduling_policy_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scheduling_policy_arn` field.\n', args=[]),
  ...
  '#withState':: d.fn(help='`aws.batch_job_queue.withState` constructs a mixin object that can be merged into the `batch_job_queue`\nTerraform resource block to set or update the state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `state` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.batch_job_queue.withTagsAll` constructs a mixin object that can be merged into the `batch_job_queue`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
