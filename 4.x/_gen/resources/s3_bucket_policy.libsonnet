...
{
  '#':: d.pkg(name='s3_bucket_policy', url='', help='`s3_bucket_policy` represents the `aws_s3_bucket_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBucket':: d.fn(help='`aws.s3_bucket_policy.withBucket` constructs a mixin object that can be merged into the `s3_bucket_policy`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.s3_bucket_policy.withPolicy` constructs a mixin object that can be merged into the `s3_bucket_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
