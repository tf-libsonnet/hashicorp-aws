...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIpSetDescriptor':: d.fn(help='`aws.wafregional_ipset.withIpSetDescriptor` constructs a mixin object that can be merged into the `wafregional_ipset`\nTerraform resource block to set or update the ip_set_descriptor field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_set_descriptor` field.\n', args=[]),
  ...
  '#withIpSetDescriptorMixin':: d.fn(help='`aws.wafregional_ipset.withIpSetDescriptorMixin` constructs a mixin object that can be merged into the `wafregional_ipset`\nTerraform resource block to set or update the ip_set_descriptor field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.wafregional_ipset.withIpSetDescriptor](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_set_descriptor` field.\n', args=[]),
