...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.route53_resolver_rule_association.withName` constructs a mixin object that can be merged into the `route53_resolver_rule_association`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResolverRuleId':: d.fn(help='`aws.route53_resolver_rule_association.withResolverRuleId` constructs a mixin object that can be merged into the `route53_resolver_rule_association`\nTerraform resource block to set or update the resolver_rule_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resolver_rule_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.route53_resolver_rule_association.withTimeouts` constructs a mixin object that can be merged into the `route53_resolver_rule_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.route53_resolver_rule_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `route53_resolver_rule_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.route53_resolver_rule_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpcId':: d.fn(help='`aws.route53_resolver_rule_association.withVpcId` constructs a mixin object that can be merged into the `route53_resolver_rule_association`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
