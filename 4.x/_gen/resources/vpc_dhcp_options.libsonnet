...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomainName':: d.fn(help='`aws.vpc_dhcp_options.withDomainName` constructs a mixin object that can be merged into the `vpc_dhcp_options`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withDomainNameServers':: d.fn(help='`aws.vpc_dhcp_options.withDomainNameServers` constructs a mixin object that can be merged into the `vpc_dhcp_options`\nTerraform resource block to set or update the domain_name_servers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name_servers` field.\n', args=[]),
  ...
  '#withNetbiosNameServers':: d.fn(help='`aws.vpc_dhcp_options.withNetbiosNameServers` constructs a mixin object that can be merged into the `vpc_dhcp_options`\nTerraform resource block to set or update the netbios_name_servers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `netbios_name_servers` field.\n', args=[]),
  ...
  '#withNetbiosNodeType':: d.fn(help='`aws.vpc_dhcp_options.withNetbiosNodeType` constructs a mixin object that can be merged into the `vpc_dhcp_options`\nTerraform resource block to set or update the netbios_node_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `netbios_node_type` field.\n', args=[]),
  ...
  '#withNtpServers':: d.fn(help='`aws.vpc_dhcp_options.withNtpServers` constructs a mixin object that can be merged into the `vpc_dhcp_options`\nTerraform resource block to set or update the ntp_servers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ntp_servers` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.vpc_dhcp_options.withTagsAll` constructs a mixin object that can be merged into the `vpc_dhcp_options`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
