...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDbClusterIdentifier':: d.fn(help='`aws.neptune_cluster_snapshot.withDbClusterIdentifier` constructs a mixin object that can be merged into the `neptune_cluster_snapshot`\nTerraform resource block to set or update the db_cluster_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_cluster_identifier` field.\n', args=[]),
  ...
  '#withDbClusterSnapshotIdentifier':: d.fn(help='`aws.neptune_cluster_snapshot.withDbClusterSnapshotIdentifier` constructs a mixin object that can be merged into the `neptune_cluster_snapshot`\nTerraform resource block to set or update the db_cluster_snapshot_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_cluster_snapshot_identifier` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.neptune_cluster_snapshot.withTimeouts` constructs a mixin object that can be merged into the `neptune_cluster_snapshot`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.neptune_cluster_snapshot.withTimeoutsMixin` constructs a mixin object that can be merged into the `neptune_cluster_snapshot`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.neptune_cluster_snapshot.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
