...
{
  '#':: d.pkg(name='iam_role_policy_attachment', url='', help='`iam_role_policy_attachment` represents the `aws_iam_role_policy_attachment` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPolicyArn':: d.fn(help='`aws.iam_role_policy_attachment.withPolicyArn` constructs a mixin object that can be merged into the `iam_role_policy_attachment`\nTerraform resource block to set or update the policy_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_arn` field.\n', args=[]),
  ...
  '#withRole':: d.fn(help='`aws.iam_role_policy_attachment.withRole` constructs a mixin object that can be merged into the `iam_role_policy_attachment`\nTerraform resource block to set or update the role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role` field.\n', args=[]),
