...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCidr':: d.fn(help='`aws.vpc_ipam_pool_cidr_allocation.withCidr` constructs a mixin object that can be merged into the `vpc_ipam_pool_cidr_allocation`\nTerraform resource block to set or update the cidr field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cidr` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.vpc_ipam_pool_cidr_allocation.withDescription` constructs a mixin object that can be merged into the `vpc_ipam_pool_cidr_allocation`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDisallowedCidrs':: d.fn(help='`aws.vpc_ipam_pool_cidr_allocation.withDisallowedCidrs` constructs a mixin object that can be merged into the `vpc_ipam_pool_cidr_allocation`\nTerraform resource block to set or update the disallowed_cidrs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disallowed_cidrs` field.\n', args=[]),
  ...
  '#withIpamPoolId':: d.fn(help='`aws.vpc_ipam_pool_cidr_allocation.withIpamPoolId` constructs a mixin object that can be merged into the `vpc_ipam_pool_cidr_allocation`\nTerraform resource block to set or update the ipam_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ipam_pool_id` field.\n', args=[]),
  ...
  '#withNetmaskLength':: d.fn(help='`aws.vpc_ipam_pool_cidr_allocation.withNetmaskLength` constructs a mixin object that can be merged into the `vpc_ipam_pool_cidr_allocation`\nTerraform resource block to set or update the netmask_length field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `netmask_length` field.\n', args=[]),
