...
{
  '#':: d.pkg(name='ec2_transit_gateway_peering_attachment_accepter', url='', help='`ec2_transit_gateway_peering_attachment_accepter` represents the `aws_ec2_transit_gateway_peering_attachment_accepter` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withTags':: d.fn(help='`aws.ec2_transit_gateway_peering_attachment_accepter.withTags` constructs a mixin object that can be merged into the `ec2_transit_gateway_peering_attachment_accepter`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ec2_transit_gateway_peering_attachment_accepter.withTagsAll` constructs a mixin object that can be merged into the `ec2_transit_gateway_peering_attachment_accepter`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTransitGatewayAttachmentId':: d.fn(help='`aws.ec2_transit_gateway_peering_attachment_accepter.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_peering_attachment_accepter`\nTerraform resource block to set or update the transit_gateway_attachment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_attachment_id` field.\n', args=[]),
