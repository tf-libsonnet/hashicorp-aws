...
{
  '#':: d.pkg(name='ec2_transit_gateway_prefix_list_reference', url='', help='`ec2_transit_gateway_prefix_list_reference` represents the `aws_ec2_transit_gateway_prefix_list_reference` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBlackhole':: d.fn(help='`aws.ec2_transit_gateway_prefix_list_reference.withBlackhole` constructs a mixin object that can be merged into the `ec2_transit_gateway_prefix_list_reference`\nTerraform resource block to set or update the blackhole field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `blackhole` field.\n', args=[]),
  ...
  '#withPrefixListId':: d.fn(help='`aws.ec2_transit_gateway_prefix_list_reference.withPrefixListId` constructs a mixin object that can be merged into the `ec2_transit_gateway_prefix_list_reference`\nTerraform resource block to set or update the prefix_list_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `prefix_list_id` field.\n', args=[]),
  ...
  '#withTransitGatewayAttachmentId':: d.fn(help='`aws.ec2_transit_gateway_prefix_list_reference.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_prefix_list_reference`\nTerraform resource block to set or update the transit_gateway_attachment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_attachment_id` field.\n', args=[]),
  ...
  '#withTransitGatewayRouteTableId':: d.fn(help='`aws.ec2_transit_gateway_prefix_list_reference.withTransitGatewayRouteTableId` constructs a mixin object that can be merged into the `ec2_transit_gateway_prefix_list_reference`\nTerraform resource block to set or update the transit_gateway_route_table_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_route_table_id` field.\n', args=[]),
