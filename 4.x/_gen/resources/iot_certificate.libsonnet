...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withActive':: d.fn(help='`aws.iot_certificate.withActive` constructs a mixin object that can be merged into the `iot_certificate`\nTerraform resource block to set or update the active field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `active` field.\n', args=[]),
  ...
  '#withCaPem':: d.fn(help='`aws.iot_certificate.withCaPem` constructs a mixin object that can be merged into the `iot_certificate`\nTerraform resource block to set or update the ca_pem field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ca_pem` field.\n', args=[]),
  ...
  '#withCertificatePem':: d.fn(help='`aws.iot_certificate.withCertificatePem` constructs a mixin object that can be merged into the `iot_certificate`\nTerraform resource block to set or update the certificate_pem field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_pem` field.\n', args=[]),
  ...
  '#withCsr':: d.fn(help='`aws.iot_certificate.withCsr` constructs a mixin object that can be merged into the `iot_certificate`\nTerraform resource block to set or update the csr field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `csr` field.\n', args=[]),
