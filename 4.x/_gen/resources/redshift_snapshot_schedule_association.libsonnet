...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterIdentifier':: d.fn(help='`aws.redshift_snapshot_schedule_association.withClusterIdentifier` constructs a mixin object that can be merged into the `redshift_snapshot_schedule_association`\nTerraform resource block to set or update the cluster_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_identifier` field.\n', args=[]),
  ...
  '#withScheduleIdentifier':: d.fn(help='`aws.redshift_snapshot_schedule_association.withScheduleIdentifier` constructs a mixin object that can be merged into the `redshift_snapshot_schedule_association`\nTerraform resource block to set or update the schedule_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schedule_identifier` field.\n', args=[]),
