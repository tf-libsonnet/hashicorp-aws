...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccessGroupId':: d.fn(help='`aws.ec2_client_vpn_authorization_rule.withAccessGroupId` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`\nTerraform resource block to set or update the access_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `access_group_id` field.\n', args=[]),
  ...
  '#withAuthorizeAllGroups':: d.fn(help='`aws.ec2_client_vpn_authorization_rule.withAuthorizeAllGroups` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`\nTerraform resource block to set or update the authorize_all_groups field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authorize_all_groups` field.\n', args=[]),
  ...
  '#withClientVpnEndpointId':: d.fn(help='`aws.ec2_client_vpn_authorization_rule.withClientVpnEndpointId` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`\nTerraform resource block to set or update the client_vpn_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_vpn_endpoint_id` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.ec2_client_vpn_authorization_rule.withDescription` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withTargetNetworkCidr':: d.fn(help='`aws.ec2_client_vpn_authorization_rule.withTargetNetworkCidr` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`\nTerraform resource block to set or update the target_network_cidr field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_network_cidr` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.ec2_client_vpn_authorization_rule.withTimeouts` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.ec2_client_vpn_authorization_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `ec2_client_vpn_authorization_rule`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.ec2_client_vpn_authorization_rule.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
