...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`aws.s3control_object_lambda_access_point.withAccountId` constructs a mixin object that can be merged into the `s3control_object_lambda_access_point`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withConfiguration':: d.fn(help='`aws.s3control_object_lambda_access_point.withConfiguration` constructs a mixin object that can be merged into the `s3control_object_lambda_access_point`\nTerraform resource block to set or update the configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `configuration` field.\n', args=[]),
  ...
  '#withConfigurationMixin':: d.fn(help='`aws.s3control_object_lambda_access_point.withConfigurationMixin` constructs a mixin object that can be merged into the `s3control_object_lambda_access_point`\nTerraform resource block to set or update the configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3control_object_lambda_access_point.withConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `configuration` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.s3control_object_lambda_access_point.withName` constructs a mixin object that can be merged into the `s3control_object_lambda_access_point`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
