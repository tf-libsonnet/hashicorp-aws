...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomain':: d.fn(help='`aws.codeartifact_domain_permissions_policy.withDomain` constructs a mixin object that can be merged into the `codeartifact_domain_permissions_policy`\nTerraform resource block to set or update the domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain` field.\n', args=[]),
  ...
  '#withDomainOwner':: d.fn(help='`aws.codeartifact_domain_permissions_policy.withDomainOwner` constructs a mixin object that can be merged into the `codeartifact_domain_permissions_policy`\nTerraform resource block to set or update the domain_owner field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_owner` field.\n', args=[]),
  ...
  '#withPolicyDocument':: d.fn(help='`aws.codeartifact_domain_permissions_policy.withPolicyDocument` constructs a mixin object that can be merged into the `codeartifact_domain_permissions_policy`\nTerraform resource block to set or update the policy_document field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_document` field.\n', args=[]),
  ...
  '#withPolicyRevision':: d.fn(help='`aws.codeartifact_domain_permissions_policy.withPolicyRevision` constructs a mixin object that can be merged into the `codeartifact_domain_permissions_policy`\nTerraform resource block to set or update the policy_revision field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_revision` field.\n', args=[]),
