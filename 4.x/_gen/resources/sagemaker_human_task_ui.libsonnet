...
{
  '#':: d.pkg(name='sagemaker_human_task_ui', url='', help='`sagemaker_human_task_ui` represents the `aws_sagemaker_human_task_ui` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withHumanTaskUiName':: d.fn(help='`aws.sagemaker_human_task_ui.withHumanTaskUiName` constructs a mixin object that can be merged into the `sagemaker_human_task_ui`\nTerraform resource block to set or update the human_task_ui_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `human_task_ui_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.sagemaker_human_task_ui.withTags` constructs a mixin object that can be merged into the `sagemaker_human_task_ui`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.sagemaker_human_task_ui.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_human_task_ui`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withUiTemplate':: d.fn(help='`aws.sagemaker_human_task_ui.withUiTemplate` constructs a mixin object that can be merged into the `sagemaker_human_task_ui`\nTerraform resource block to set or update the ui_template field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ui_template` field.\n', args=[]),
  ...
  '#withUiTemplateMixin':: d.fn(help='`aws.sagemaker_human_task_ui.withUiTemplateMixin` constructs a mixin object that can be merged into the `sagemaker_human_task_ui`\nTerraform resource block to set or update the ui_template field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.sagemaker_human_task_ui.withUiTemplate](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ui_template` field.\n', args=[]),
