...
{
  '#':: d.pkg(name='vpc_ipam_organization_admin_account', url='', help='`vpc_ipam_organization_admin_account` represents the `aws_vpc_ipam_organization_admin_account` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDelegatedAdminAccountId':: d.fn(help='`aws.vpc_ipam_organization_admin_account.withDelegatedAdminAccountId` constructs a mixin object that can be merged into the `vpc_ipam_organization_admin_account`\nTerraform resource block to set or update the delegated_admin_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delegated_admin_account_id` field.\n', args=[]),
