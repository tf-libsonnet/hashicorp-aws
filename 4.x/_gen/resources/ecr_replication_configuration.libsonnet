...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  replication_configuration:: {
    '#new':: d.fn(help='\n`aws.ecr_replication_configuration.replication_configuration.new` constructs a new object with attributes and blocks configured for the `replication_configuration`\nTerraform sub block.\n\n\n\n**Args**:\n  - `rule` (`list[obj]`):  When `null`, the `rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.ecr_replication_configuration.replication_configuration.rule.new](#fn-replicationconfigurationrulenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `replication_configuration` sub block.\n', args=[]),
    new(
      rule=null
    ):: std.prune(a={
      rule: rule,
  ...
  '#withReplicationConfiguration':: d.fn(help='`aws.ecr_replication_configuration.withReplicationConfiguration` constructs a mixin object that can be merged into the `ecr_replication_configuration`\nTerraform resource block to set or update the replication_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `replication_configuration` field.\n', args=[]),
  ...
  '#withReplicationConfigurationMixin':: d.fn(help='`aws.ecr_replication_configuration.withReplicationConfigurationMixin` constructs a mixin object that can be merged into the `ecr_replication_configuration`\nTerraform resource block to set or update the replication_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ecr_replication_configuration.withReplicationConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `replication_configuration` field.\n', args=[]),
