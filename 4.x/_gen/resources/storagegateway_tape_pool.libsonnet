...
{
  '#':: d.pkg(name='storagegateway_tape_pool', url='', help='`storagegateway_tape_pool` represents the `aws_storagegateway_tape_pool` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPoolName':: d.fn(help='`aws.storagegateway_tape_pool.withPoolName` constructs a mixin object that can be merged into the `storagegateway_tape_pool`\nTerraform resource block to set or update the pool_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `pool_name` field.\n', args=[]),
  ...
  '#withRetentionLockTimeInDays':: d.fn(help='`aws.storagegateway_tape_pool.withRetentionLockTimeInDays` constructs a mixin object that can be merged into the `storagegateway_tape_pool`\nTerraform resource block to set or update the retention_lock_time_in_days field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention_lock_time_in_days` field.\n', args=[]),
  ...
  '#withRetentionLockType':: d.fn(help='`aws.storagegateway_tape_pool.withRetentionLockType` constructs a mixin object that can be merged into the `storagegateway_tape_pool`\nTerraform resource block to set or update the retention_lock_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention_lock_type` field.\n', args=[]),
  ...
  '#withStorageClass':: d.fn(help='`aws.storagegateway_tape_pool.withStorageClass` constructs a mixin object that can be merged into the `storagegateway_tape_pool`\nTerraform resource block to set or update the storage_class field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_class` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.storagegateway_tape_pool.withTags` constructs a mixin object that can be merged into the `storagegateway_tape_pool`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.storagegateway_tape_pool.withTagsAll` constructs a mixin object that can be merged into the `storagegateway_tape_pool`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
