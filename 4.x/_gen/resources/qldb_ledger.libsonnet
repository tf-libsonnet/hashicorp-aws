...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeletionProtection':: d.fn(help='`aws.qldb_ledger.withDeletionProtection` constructs a mixin object that can be merged into the `qldb_ledger`\nTerraform resource block to set or update the deletion_protection field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deletion_protection` field.\n', args=[]),
  ...
  '#withKmsKey':: d.fn(help='`aws.qldb_ledger.withKmsKey` constructs a mixin object that can be merged into the `qldb_ledger`\nTerraform resource block to set or update the kms_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.qldb_ledger.withName` constructs a mixin object that can be merged into the `qldb_ledger`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPermissionsMode':: d.fn(help='`aws.qldb_ledger.withPermissionsMode` constructs a mixin object that can be merged into the `qldb_ledger`\nTerraform resource block to set or update the permissions_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permissions_mode` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.qldb_ledger.withTags` constructs a mixin object that can be merged into the `qldb_ledger`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.qldb_ledger.withTagsAll` constructs a mixin object that can be merged into the `qldb_ledger`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
