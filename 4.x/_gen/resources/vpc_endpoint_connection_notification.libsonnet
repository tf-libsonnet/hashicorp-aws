...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConnectionEvents':: d.fn(help='`aws.vpc_endpoint_connection_notification.withConnectionEvents` constructs a mixin object that can be merged into the `vpc_endpoint_connection_notification`\nTerraform resource block to set or update the connection_events field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_events` field.\n', args=[]),
  ...
  '#withConnectionNotificationArn':: d.fn(help='`aws.vpc_endpoint_connection_notification.withConnectionNotificationArn` constructs a mixin object that can be merged into the `vpc_endpoint_connection_notification`\nTerraform resource block to set or update the connection_notification_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_notification_arn` field.\n', args=[]),
  ...
  '#withVpcEndpointId':: d.fn(help='`aws.vpc_endpoint_connection_notification.withVpcEndpointId` constructs a mixin object that can be merged into the `vpc_endpoint_connection_notification`\nTerraform resource block to set or update the vpc_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_endpoint_id` field.\n', args=[]),
  ...
  '#withVpcEndpointServiceId':: d.fn(help='`aws.vpc_endpoint_connection_notification.withVpcEndpointServiceId` constructs a mixin object that can be merged into the `vpc_endpoint_connection_notification`\nTerraform resource block to set or update the vpc_endpoint_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_endpoint_service_id` field.\n', args=[]),
