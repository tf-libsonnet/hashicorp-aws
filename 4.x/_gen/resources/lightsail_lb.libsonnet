...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstancePort':: d.fn(help='`aws.lightsail_lb.withInstancePort` constructs a mixin object that can be merged into the `lightsail_lb`\nTerraform resource block to set or update the instance_port field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_port` field.\n', args=[]),
  ...
  '#withIpAddressType':: d.fn(help='`aws.lightsail_lb.withIpAddressType` constructs a mixin object that can be merged into the `lightsail_lb`\nTerraform resource block to set or update the ip_address_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_address_type` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.lightsail_lb.withName` constructs a mixin object that can be merged into the `lightsail_lb`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.lightsail_lb.withTags` constructs a mixin object that can be merged into the `lightsail_lb`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.lightsail_lb.withTagsAll` constructs a mixin object that can be merged into the `lightsail_lb`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
