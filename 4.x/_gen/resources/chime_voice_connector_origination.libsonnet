...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDisabled':: d.fn(help='`aws.chime_voice_connector_origination.withDisabled` constructs a mixin object that can be merged into the `chime_voice_connector_origination`\nTerraform resource block to set or update the disabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disabled` field.\n', args=[]),
  ...
  '#withRoute':: d.fn(help='`aws.chime_voice_connector_origination.withRoute` constructs a mixin object that can be merged into the `chime_voice_connector_origination`\nTerraform resource block to set or update the route field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `route` field.\n', args=[]),
  ...
  '#withRouteMixin':: d.fn(help='`aws.chime_voice_connector_origination.withRouteMixin` constructs a mixin object that can be merged into the `chime_voice_connector_origination`\nTerraform resource block to set or update the route field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.chime_voice_connector_origination.withRoute](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `route` field.\n', args=[]),
  ...
  '#withVoiceConnectorId':: d.fn(help='`aws.chime_voice_connector_origination.withVoiceConnectorId` constructs a mixin object that can be merged into the `chime_voice_connector_origination`\nTerraform resource block to set or update the voice_connector_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `voice_connector_id` field.\n', args=[]),
