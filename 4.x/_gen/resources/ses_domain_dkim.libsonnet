...
{
  '#':: d.pkg(name='ses_domain_dkim', url='', help='`ses_domain_dkim` represents the `aws_ses_domain_dkim` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDomain':: d.fn(help='`aws.ses_domain_dkim.withDomain` constructs a mixin object that can be merged into the `ses_domain_dkim`\nTerraform resource block to set or update the domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain` field.\n', args=[]),
