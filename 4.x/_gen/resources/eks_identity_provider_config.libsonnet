...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterName':: d.fn(help='`aws.eks_identity_provider_config.withClusterName` constructs a mixin object that can be merged into the `eks_identity_provider_config`\nTerraform resource block to set or update the cluster_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_name` field.\n', args=[]),
  ...
  '#withOidc':: d.fn(help='`aws.eks_identity_provider_config.withOidc` constructs a mixin object that can be merged into the `eks_identity_provider_config`\nTerraform resource block to set or update the oidc field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `oidc` field.\n', args=[]),
  ...
  '#withOidcMixin':: d.fn(help='`aws.eks_identity_provider_config.withOidcMixin` constructs a mixin object that can be merged into the `eks_identity_provider_config`\nTerraform resource block to set or update the oidc field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.eks_identity_provider_config.withOidc](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `oidc` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.eks_identity_provider_config.withTags` constructs a mixin object that can be merged into the `eks_identity_provider_config`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.eks_identity_provider_config.withTagsAll` constructs a mixin object that can be merged into the `eks_identity_provider_config`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.eks_identity_provider_config.withTimeouts` constructs a mixin object that can be merged into the `eks_identity_provider_config`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.eks_identity_provider_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `eks_identity_provider_config`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.eks_identity_provider_config.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
