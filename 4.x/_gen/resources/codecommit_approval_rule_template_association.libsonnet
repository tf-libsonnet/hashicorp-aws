...
{
  '#':: d.pkg(name='codecommit_approval_rule_template_association', url='', help='`codecommit_approval_rule_template_association` represents the `aws_codecommit_approval_rule_template_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withApprovalRuleTemplateName':: d.fn(help='`aws.codecommit_approval_rule_template_association.withApprovalRuleTemplateName` constructs a mixin object that can be merged into the `codecommit_approval_rule_template_association`\nTerraform resource block to set or update the approval_rule_template_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `approval_rule_template_name` field.\n', args=[]),
  ...
  '#withRepositoryName':: d.fn(help='`aws.codecommit_approval_rule_template_association.withRepositoryName` constructs a mixin object that can be merged into the `codecommit_approval_rule_template_association`\nTerraform resource block to set or update the repository_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository_name` field.\n', args=[]),
