...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAwsServiceName':: d.fn(help='`aws.iam_service_linked_role.withAwsServiceName` constructs a mixin object that can be merged into the `iam_service_linked_role`\nTerraform resource block to set or update the aws_service_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `aws_service_name` field.\n', args=[]),
  ...
  '#withCustomSuffix':: d.fn(help='`aws.iam_service_linked_role.withCustomSuffix` constructs a mixin object that can be merged into the `iam_service_linked_role`\nTerraform resource block to set or update the custom_suffix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_suffix` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.iam_service_linked_role.withDescription` constructs a mixin object that can be merged into the `iam_service_linked_role`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.iam_service_linked_role.withTags` constructs a mixin object that can be merged into the `iam_service_linked_role`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.iam_service_linked_role.withTagsAll` constructs a mixin object that can be merged into the `iam_service_linked_role`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
