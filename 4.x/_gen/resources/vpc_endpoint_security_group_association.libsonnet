...
{
  '#':: d.pkg(name='vpc_endpoint_security_group_association', url='', help='`vpc_endpoint_security_group_association` represents the `aws_vpc_endpoint_security_group_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withReplaceDefaultAssociation':: d.fn(help='`aws.vpc_endpoint_security_group_association.withReplaceDefaultAssociation` constructs a mixin object that can be merged into the `vpc_endpoint_security_group_association`\nTerraform resource block to set or update the replace_default_association field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `replace_default_association` field.\n', args=[]),
  ...
  '#withSecurityGroupId':: d.fn(help='`aws.vpc_endpoint_security_group_association.withSecurityGroupId` constructs a mixin object that can be merged into the `vpc_endpoint_security_group_association`\nTerraform resource block to set or update the security_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_group_id` field.\n', args=[]),
  ...
  '#withVpcEndpointId':: d.fn(help='`aws.vpc_endpoint_security_group_association.withVpcEndpointId` constructs a mixin object that can be merged into the `vpc_endpoint_security_group_association`\nTerraform resource block to set or update the vpc_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_endpoint_id` field.\n', args=[]),
