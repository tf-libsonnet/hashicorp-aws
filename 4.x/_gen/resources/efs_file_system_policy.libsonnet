...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBypassPolicyLockoutSafetyCheck':: d.fn(help='`aws.efs_file_system_policy.withBypassPolicyLockoutSafetyCheck` constructs a mixin object that can be merged into the `efs_file_system_policy`\nTerraform resource block to set or update the bypass_policy_lockout_safety_check field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bypass_policy_lockout_safety_check` field.\n', args=[]),
  ...
  '#withFileSystemId':: d.fn(help='`aws.efs_file_system_policy.withFileSystemId` constructs a mixin object that can be merged into the `efs_file_system_policy`\nTerraform resource block to set or update the file_system_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `file_system_id` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.efs_file_system_policy.withPolicy` constructs a mixin object that can be merged into the `efs_file_system_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
