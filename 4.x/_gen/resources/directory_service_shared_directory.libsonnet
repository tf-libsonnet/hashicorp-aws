...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDirectoryId':: d.fn(help='`aws.directory_service_shared_directory.withDirectoryId` constructs a mixin object that can be merged into the `directory_service_shared_directory`\nTerraform resource block to set or update the directory_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `directory_id` field.\n', args=[]),
  ...
  '#withMethod':: d.fn(help='`aws.directory_service_shared_directory.withMethod` constructs a mixin object that can be merged into the `directory_service_shared_directory`\nTerraform resource block to set or update the method field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `method` field.\n', args=[]),
  ...
  '#withNotes':: d.fn(help='`aws.directory_service_shared_directory.withNotes` constructs a mixin object that can be merged into the `directory_service_shared_directory`\nTerraform resource block to set or update the notes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `notes` field.\n', args=[]),
  ...
  '#withTarget':: d.fn(help='`aws.directory_service_shared_directory.withTarget` constructs a mixin object that can be merged into the `directory_service_shared_directory`\nTerraform resource block to set or update the target field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target` field.\n', args=[]),
  ...
  '#withTargetMixin':: d.fn(help='`aws.directory_service_shared_directory.withTargetMixin` constructs a mixin object that can be merged into the `directory_service_shared_directory`\nTerraform resource block to set or update the target field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.directory_service_shared_directory.withTarget](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.directory_service_shared_directory.withTimeouts` constructs a mixin object that can be merged into the `directory_service_shared_directory`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.directory_service_shared_directory.withTimeoutsMixin` constructs a mixin object that can be merged into the `directory_service_shared_directory`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.directory_service_shared_directory.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
