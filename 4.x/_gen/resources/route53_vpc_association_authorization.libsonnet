...
{
  '#':: d.pkg(name='route53_vpc_association_authorization', url='', help='`route53_vpc_association_authorization` represents the `aws_route53_vpc_association_authorization` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withVpcId':: d.fn(help='`aws.route53_vpc_association_authorization.withVpcId` constructs a mixin object that can be merged into the `route53_vpc_association_authorization`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
  ...
  '#withVpcRegion':: d.fn(help='`aws.route53_vpc_association_authorization.withVpcRegion` constructs a mixin object that can be merged into the `route53_vpc_association_authorization`\nTerraform resource block to set or update the vpc_region field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_region` field.\n', args=[]),
  ...
  '#withZoneId':: d.fn(help='`aws.route53_vpc_association_authorization.withZoneId` constructs a mixin object that can be merged into the `route53_vpc_association_authorization`\nTerraform resource block to set or update the zone_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `zone_id` field.\n', args=[]),
