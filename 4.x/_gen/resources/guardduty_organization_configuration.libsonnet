...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutoEnable':: d.fn(help='`aws.guardduty_organization_configuration.withAutoEnable` constructs a mixin object that can be merged into the `guardduty_organization_configuration`\nTerraform resource block to set or update the auto_enable field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_enable` field.\n', args=[]),
  ...
  '#withDatasources':: d.fn(help='`aws.guardduty_organization_configuration.withDatasources` constructs a mixin object that can be merged into the `guardduty_organization_configuration`\nTerraform resource block to set or update the datasources field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `datasources` field.\n', args=[]),
  ...
  '#withDatasourcesMixin':: d.fn(help='`aws.guardduty_organization_configuration.withDatasourcesMixin` constructs a mixin object that can be merged into the `guardduty_organization_configuration`\nTerraform resource block to set or update the datasources field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.guardduty_organization_configuration.withDatasources](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `datasources` field.\n', args=[]),
  ...
  '#withDetectorId':: d.fn(help='`aws.guardduty_organization_configuration.withDetectorId` constructs a mixin object that can be merged into the `guardduty_organization_configuration`\nTerraform resource block to set or update the detector_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `detector_id` field.\n', args=[]),
