...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLanguageCode':: d.fn(help='`aws.transcribe_vocabulary_filter.withLanguageCode` constructs a mixin object that can be merged into the `transcribe_vocabulary_filter`\nTerraform resource block to set or update the language_code field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `language_code` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.transcribe_vocabulary_filter.withTags` constructs a mixin object that can be merged into the `transcribe_vocabulary_filter`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.transcribe_vocabulary_filter.withTagsAll` constructs a mixin object that can be merged into the `transcribe_vocabulary_filter`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withVocabularyFilterFileUri':: d.fn(help='`aws.transcribe_vocabulary_filter.withVocabularyFilterFileUri` constructs a mixin object that can be merged into the `transcribe_vocabulary_filter`\nTerraform resource block to set or update the vocabulary_filter_file_uri field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vocabulary_filter_file_uri` field.\n', args=[]),
  ...
  '#withVocabularyFilterName':: d.fn(help='`aws.transcribe_vocabulary_filter.withVocabularyFilterName` constructs a mixin object that can be merged into the `transcribe_vocabulary_filter`\nTerraform resource block to set or update the vocabulary_filter_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vocabulary_filter_name` field.\n', args=[]),
  ...
  '#withWords':: d.fn(help='`aws.transcribe_vocabulary_filter.withWords` constructs a mixin object that can be merged into the `transcribe_vocabulary_filter`\nTerraform resource block to set or update the words field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `words` field.\n', args=[]),
