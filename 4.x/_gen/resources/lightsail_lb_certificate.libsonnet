...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomainName':: d.fn(help='`aws.lightsail_lb_certificate.withDomainName` constructs a mixin object that can be merged into the `lightsail_lb_certificate`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withLbName':: d.fn(help='`aws.lightsail_lb_certificate.withLbName` constructs a mixin object that can be merged into the `lightsail_lb_certificate`\nTerraform resource block to set or update the lb_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lb_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.lightsail_lb_certificate.withName` constructs a mixin object that can be merged into the `lightsail_lb_certificate`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSubjectAlternativeNames':: d.fn(help='`aws.lightsail_lb_certificate.withSubjectAlternativeNames` constructs a mixin object that can be merged into the `lightsail_lb_certificate`\nTerraform resource block to set or update the subject_alternative_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subject_alternative_names` field.\n', args=[]),
