...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNamePrefix':: d.fn(help='`aws.memorydb_acl.withNamePrefix` constructs a mixin object that can be merged into the `memorydb_acl`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.memorydb_acl.withTagsAll` constructs a mixin object that can be merged into the `memorydb_acl`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withUserNames':: d.fn(help='`aws.memorydb_acl.withUserNames` constructs a mixin object that can be merged into the `memorydb_acl`\nTerraform resource block to set or update the user_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_names` field.\n', args=[]),
