...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDestination':: d.fn(help='`aws.efs_replication_configuration.withDestination` constructs a mixin object that can be merged into the `efs_replication_configuration`\nTerraform resource block to set or update the destination field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination` field.\n', args=[]),
  ...
  '#withDestinationMixin':: d.fn(help='`aws.efs_replication_configuration.withDestinationMixin` constructs a mixin object that can be merged into the `efs_replication_configuration`\nTerraform resource block to set or update the destination field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.efs_replication_configuration.withDestination](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination` field.\n', args=[]),
  ...
  '#withSourceFileSystemId':: d.fn(help='`aws.efs_replication_configuration.withSourceFileSystemId` constructs a mixin object that can be merged into the `efs_replication_configuration`\nTerraform resource block to set or update the source_file_system_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_file_system_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.efs_replication_configuration.withTimeouts` constructs a mixin object that can be merged into the `efs_replication_configuration`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.efs_replication_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `efs_replication_configuration`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.efs_replication_configuration.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
