...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateName':: d.fn(help='`aws.lightsail_lb_certificate_attachment.withCertificateName` constructs a mixin object that can be merged into the `lightsail_lb_certificate_attachment`\nTerraform resource block to set or update the certificate_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_name` field.\n', args=[]),
  ...
  '#withLbName':: d.fn(help='`aws.lightsail_lb_certificate_attachment.withLbName` constructs a mixin object that can be merged into the `lightsail_lb_certificate_attachment`\nTerraform resource block to set or update the lb_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lb_name` field.\n', args=[]),
