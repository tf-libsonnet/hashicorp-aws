...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`aws.s3control_multi_region_access_point.withAccountId` constructs a mixin object that can be merged into the `s3control_multi_region_access_point`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withDetails':: d.fn(help='`aws.s3control_multi_region_access_point.withDetails` constructs a mixin object that can be merged into the `s3control_multi_region_access_point`\nTerraform resource block to set or update the details field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `details` field.\n', args=[]),
  ...
  '#withDetailsMixin':: d.fn(help='`aws.s3control_multi_region_access_point.withDetailsMixin` constructs a mixin object that can be merged into the `s3control_multi_region_access_point`\nTerraform resource block to set or update the details field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3control_multi_region_access_point.withDetails](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `details` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.s3control_multi_region_access_point.withTimeouts` constructs a mixin object that can be merged into the `s3control_multi_region_access_point`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.s3control_multi_region_access_point.withTimeoutsMixin` constructs a mixin object that can be merged into the `s3control_multi_region_access_point`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.s3control_multi_region_access_point.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
