...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKey':: d.fn(help='`aws.ec2_tag.withKey` constructs a mixin object that can be merged into the `ec2_tag`\nTerraform resource block to set or update the key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key` field.\n', args=[]),
  ...
  '#withResourceId':: d.fn(help='`aws.ec2_tag.withResourceId` constructs a mixin object that can be merged into the `ec2_tag`\nTerraform resource block to set or update the resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_id` field.\n', args=[]),
  ...
  '#withValue':: d.fn(help='`aws.ec2_tag.withValue` constructs a mixin object that can be merged into the `ec2_tag`\nTerraform resource block to set or update the value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value` field.\n', args=[]),
