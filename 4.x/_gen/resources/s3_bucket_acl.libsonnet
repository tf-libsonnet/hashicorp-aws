...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccessControlPolicyMixin':: d.fn(help='`aws.s3_bucket_acl.withAccessControlPolicyMixin` constructs a mixin object that can be merged into the `s3_bucket_acl`\nTerraform resource block to set or update the access_control_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3_bucket_acl.withAccessControlPolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `access_control_policy` field.\n', args=[]),
  ...
  '#withAcl':: d.fn(help='`aws.s3_bucket_acl.withAcl` constructs a mixin object that can be merged into the `s3_bucket_acl`\nTerraform resource block to set or update the acl field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `acl` field.\n', args=[]),
  ...
  '#withBucket':: d.fn(help='`aws.s3_bucket_acl.withBucket` constructs a mixin object that can be merged into the `s3_bucket_acl`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withExpectedBucketOwner':: d.fn(help='`aws.s3_bucket_acl.withExpectedBucketOwner` constructs a mixin object that can be merged into the `s3_bucket_acl`\nTerraform resource block to set or update the expected_bucket_owner field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expected_bucket_owner` field.\n', args=[]),
