...
{
  '#':: d.pkg(name='schemas_discoverer', url='', help='`schemas_discoverer` represents the `aws_schemas_discoverer` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`aws.schemas_discoverer.withDescription` constructs a mixin object that can be merged into the `schemas_discoverer`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withSourceArn':: d.fn(help='`aws.schemas_discoverer.withSourceArn` constructs a mixin object that can be merged into the `schemas_discoverer`\nTerraform resource block to set or update the source_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_arn` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.schemas_discoverer.withTags` constructs a mixin object that can be merged into the `schemas_discoverer`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.schemas_discoverer.withTagsAll` constructs a mixin object that can be merged into the `schemas_discoverer`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
