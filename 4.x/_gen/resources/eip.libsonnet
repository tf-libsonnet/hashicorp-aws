...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAssociateWithPrivateIp':: d.fn(help='`aws.eip.withAssociateWithPrivateIp` constructs a mixin object that can be merged into the `eip`\nTerraform resource block to set or update the associate_with_private_ip field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `associate_with_private_ip` field.\n', args=[]),
  ...
  '#withInstance':: d.fn(help='`aws.eip.withInstance` constructs a mixin object that can be merged into the `eip`\nTerraform resource block to set or update the instance field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance` field.\n', args=[]),
  ...
  '#withNetworkBorderGroup':: d.fn(help='`aws.eip.withNetworkBorderGroup` constructs a mixin object that can be merged into the `eip`\nTerraform resource block to set or update the network_border_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_border_group` field.\n', args=[]),
  ...
  '#withPublicIpv4Pool':: d.fn(help='`aws.eip.withPublicIpv4Pool` constructs a mixin object that can be merged into the `eip`\nTerraform resource block to set or update the public_ipv4_pool field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_ipv4_pool` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.eip.withTags` constructs a mixin object that can be merged into the `eip`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.eip.withTagsAll` constructs a mixin object that can be merged into the `eip`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.eip.withTimeouts` constructs a mixin object that can be merged into the `eip`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.eip.withTimeoutsMixin` constructs a mixin object that can be merged into the `eip`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.eip.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
