...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAvailabilityZone':: d.fn(help='`aws.lb_target_group_attachment.withAvailabilityZone` constructs a mixin object that can be merged into the `lb_target_group_attachment`\nTerraform resource block to set or update the availability_zone field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `availability_zone` field.\n', args=[]),
  ...
  '#withPort':: d.fn(help='`aws.lb_target_group_attachment.withPort` constructs a mixin object that can be merged into the `lb_target_group_attachment`\nTerraform resource block to set or update the port field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `port` field.\n', args=[]),
  ...
  '#withTargetGroupArn':: d.fn(help='`aws.lb_target_group_attachment.withTargetGroupArn` constructs a mixin object that can be merged into the `lb_target_group_attachment`\nTerraform resource block to set or update the target_group_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_group_arn` field.\n', args=[]),
  ...
  '#withTargetId':: d.fn(help='`aws.lb_target_group_attachment.withTargetId` constructs a mixin object that can be merged into the `lb_target_group_attachment`\nTerraform resource block to set or update the target_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_id` field.\n', args=[]),
