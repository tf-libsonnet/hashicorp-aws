...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccount':: d.fn(help='`aws.redshift_endpoint_authorization.withAccount` constructs a mixin object that can be merged into the `redshift_endpoint_authorization`\nTerraform resource block to set or update the account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account` field.\n', args=[]),
  ...
  '#withClusterIdentifier':: d.fn(help='`aws.redshift_endpoint_authorization.withClusterIdentifier` constructs a mixin object that can be merged into the `redshift_endpoint_authorization`\nTerraform resource block to set or update the cluster_identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_identifier` field.\n', args=[]),
  ...
  '#withForceDelete':: d.fn(help='`aws.redshift_endpoint_authorization.withForceDelete` constructs a mixin object that can be merged into the `redshift_endpoint_authorization`\nTerraform resource block to set or update the force_delete field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `force_delete` field.\n', args=[]),
  ...
  '#withVpcIds':: d.fn(help='`aws.redshift_endpoint_authorization.withVpcIds` constructs a mixin object that can be merged into the `redshift_endpoint_authorization`\nTerraform resource block to set or update the vpc_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_ids` field.\n', args=[]),
