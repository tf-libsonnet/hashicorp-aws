...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEmailForwardingEnabled':: d.fn(help='`aws.sesv2_email_identity_feedback_attributes.withEmailForwardingEnabled` constructs a mixin object that can be merged into the `sesv2_email_identity_feedback_attributes`\nTerraform resource block to set or update the email_forwarding_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `email_forwarding_enabled` field.\n', args=[]),
  ...
  '#withEmailIdentity':: d.fn(help='`aws.sesv2_email_identity_feedback_attributes.withEmailIdentity` constructs a mixin object that can be merged into the `sesv2_email_identity_feedback_attributes`\nTerraform resource block to set or update the email_identity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `email_identity` field.\n', args=[]),
