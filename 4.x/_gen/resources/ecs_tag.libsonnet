...
{
  '#':: d.pkg(name='ecs_tag', url='', help='`ecs_tag` represents the `aws_ecs_tag` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withKey':: d.fn(help='`aws.ecs_tag.withKey` constructs a mixin object that can be merged into the `ecs_tag`\nTerraform resource block to set or update the key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key` field.\n', args=[]),
  ...
  '#withResourceArn':: d.fn(help='`aws.ecs_tag.withResourceArn` constructs a mixin object that can be merged into the `ecs_tag`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
  ...
  '#withValue':: d.fn(help='`aws.ecs_tag.withValue` constructs a mixin object that can be merged into the `ecs_tag`\nTerraform resource block to set or update the value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value` field.\n', args=[]),
