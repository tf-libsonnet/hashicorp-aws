...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEncoding':: d.fn(help='`aws.iam_user_ssh_key.withEncoding` constructs a mixin object that can be merged into the `iam_user_ssh_key`\nTerraform resource block to set or update the encoding field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encoding` field.\n', args=[]),
  ...
  '#withPublicKey':: d.fn(help='`aws.iam_user_ssh_key.withPublicKey` constructs a mixin object that can be merged into the `iam_user_ssh_key`\nTerraform resource block to set or update the public_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_key` field.\n', args=[]),
  ...
  '#withStatus':: d.fn(help='`aws.iam_user_ssh_key.withStatus` constructs a mixin object that can be merged into the `iam_user_ssh_key`\nTerraform resource block to set or update the status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
  ...
  '#withUsername':: d.fn(help='`aws.iam_user_ssh_key.withUsername` constructs a mixin object that can be merged into the `iam_user_ssh_key`\nTerraform resource block to set or update the username field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `username` field.\n', args=[]),
