...
{
  '#':: d.pkg(name='globalaccelerator_custom_routing_listener', url='', help='`globalaccelerator_custom_routing_listener` represents the `aws_globalaccelerator_custom_routing_listener` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(accelerator_arn=accelerator_arn, port_range=port_range, timeouts=timeouts),
    _meta=_meta
  ),
