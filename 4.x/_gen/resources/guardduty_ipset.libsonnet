...
{
  '#':: d.pkg(name='guardduty_ipset', url='', help='`guardduty_ipset` represents the `aws_guardduty_ipset` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withActivate':: d.fn(help='`aws.guardduty_ipset.withActivate` constructs a mixin object that can be merged into the `guardduty_ipset`\nTerraform resource block to set or update the activate field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `activate` field.\n', args=[]),
  ...
  '#withDetectorId':: d.fn(help='`aws.guardduty_ipset.withDetectorId` constructs a mixin object that can be merged into the `guardduty_ipset`\nTerraform resource block to set or update the detector_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `detector_id` field.\n', args=[]),
  ...
  '#withFormat':: d.fn(help='`aws.guardduty_ipset.withFormat` constructs a mixin object that can be merged into the `guardduty_ipset`\nTerraform resource block to set or update the format field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `format` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`aws.guardduty_ipset.withLocation` constructs a mixin object that can be merged into the `guardduty_ipset`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.guardduty_ipset.withName` constructs a mixin object that can be merged into the `guardduty_ipset`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.guardduty_ipset.withTags` constructs a mixin object that can be merged into the `guardduty_ipset`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.guardduty_ipset.withTagsAll` constructs a mixin object that can be merged into the `guardduty_ipset`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
