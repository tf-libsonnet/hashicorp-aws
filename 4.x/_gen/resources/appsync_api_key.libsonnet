...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiId':: d.fn(help='`aws.appsync_api_key.withApiId` constructs a mixin object that can be merged into the `appsync_api_key`\nTerraform resource block to set or update the api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_id` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.appsync_api_key.withDescription` constructs a mixin object that can be merged into the `appsync_api_key`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withExpires':: d.fn(help='`aws.appsync_api_key.withExpires` constructs a mixin object that can be merged into the `appsync_api_key`\nTerraform resource block to set or update the expires field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expires` field.\n', args=[]),
