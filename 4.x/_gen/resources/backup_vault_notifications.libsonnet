...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBackupVaultEvents':: d.fn(help='`aws.backup_vault_notifications.withBackupVaultEvents` constructs a mixin object that can be merged into the `backup_vault_notifications`\nTerraform resource block to set or update the backup_vault_events field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup_vault_events` field.\n', args=[]),
  ...
  '#withBackupVaultName':: d.fn(help='`aws.backup_vault_notifications.withBackupVaultName` constructs a mixin object that can be merged into the `backup_vault_notifications`\nTerraform resource block to set or update the backup_vault_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup_vault_name` field.\n', args=[]),
  ...
  '#withSnsTopicArn':: d.fn(help='`aws.backup_vault_notifications.withSnsTopicArn` constructs a mixin object that can be merged into the `backup_vault_notifications`\nTerraform resource block to set or update the sns_topic_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sns_topic_arn` field.\n', args=[]),
