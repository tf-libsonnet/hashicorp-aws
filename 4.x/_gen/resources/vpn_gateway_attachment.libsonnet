...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withVpcId':: d.fn(help='`aws.vpn_gateway_attachment.withVpcId` constructs a mixin object that can be merged into the `vpn_gateway_attachment`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
  ...
  '#withVpnGatewayId':: d.fn(help='`aws.vpn_gateway_attachment.withVpnGatewayId` constructs a mixin object that can be merged into the `vpn_gateway_attachment`\nTerraform resource block to set or update the vpn_gateway_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpn_gateway_id` field.\n', args=[]),
