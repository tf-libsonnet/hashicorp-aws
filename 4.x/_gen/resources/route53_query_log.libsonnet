...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCloudwatchLogGroupArn':: d.fn(help='`aws.route53_query_log.withCloudwatchLogGroupArn` constructs a mixin object that can be merged into the `route53_query_log`\nTerraform resource block to set or update the cloudwatch_log_group_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cloudwatch_log_group_arn` field.\n', args=[]),
  ...
  '#withZoneId':: d.fn(help='`aws.route53_query_log.withZoneId` constructs a mixin object that can be merged into the `route53_query_log`\nTerraform resource block to set or update the zone_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `zone_id` field.\n', args=[]),
