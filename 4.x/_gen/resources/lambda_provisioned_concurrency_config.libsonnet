...
{
  '#':: d.pkg(name='lambda_provisioned_concurrency_config', url='', help='`lambda_provisioned_concurrency_config` represents the `aws_lambda_provisioned_concurrency_config` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withFunctionName':: d.fn(help='`aws.lambda_provisioned_concurrency_config.withFunctionName` constructs a mixin object that can be merged into the `lambda_provisioned_concurrency_config`\nTerraform resource block to set or update the function_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `function_name` field.\n', args=[]),
  ...
  '#withProvisionedConcurrentExecutions':: d.fn(help='`aws.lambda_provisioned_concurrency_config.withProvisionedConcurrentExecutions` constructs a mixin object that can be merged into the `lambda_provisioned_concurrency_config`\nTerraform resource block to set or update the provisioned_concurrent_executions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provisioned_concurrent_executions` field.\n', args=[]),
  ...
  '#withQualifier':: d.fn(help='`aws.lambda_provisioned_concurrency_config.withQualifier` constructs a mixin object that can be merged into the `lambda_provisioned_concurrency_config`\nTerraform resource block to set or update the qualifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `qualifier` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.lambda_provisioned_concurrency_config.withTimeouts` constructs a mixin object that can be merged into the `lambda_provisioned_concurrency_config`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.lambda_provisioned_concurrency_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `lambda_provisioned_concurrency_config`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.lambda_provisioned_concurrency_config.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
