...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSpec':: d.fn(help='`aws.appmesh_mesh.withSpec` constructs a mixin object that can be merged into the `appmesh_mesh`\nTerraform resource block to set or update the spec field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spec` field.\n', args=[]),
  ...
  '#withSpecMixin':: d.fn(help='`aws.appmesh_mesh.withSpecMixin` constructs a mixin object that can be merged into the `appmesh_mesh`\nTerraform resource block to set or update the spec field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.appmesh_mesh.withSpec](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spec` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.appmesh_mesh.withTagsAll` constructs a mixin object that can be merged into the `appmesh_mesh`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
