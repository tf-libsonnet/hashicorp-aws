...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDiskId':: d.fn(help='`aws.storagegateway_working_storage.withDiskId` constructs a mixin object that can be merged into the `storagegateway_working_storage`\nTerraform resource block to set or update the disk_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_id` field.\n', args=[]),
  ...
  '#withGatewayArn':: d.fn(help='`aws.storagegateway_working_storage.withGatewayArn` constructs a mixin object that can be merged into the `storagegateway_working_storage`\nTerraform resource block to set or update the gateway_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway_arn` field.\n', args=[]),
