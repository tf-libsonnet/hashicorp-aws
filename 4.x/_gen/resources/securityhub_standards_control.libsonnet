...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withControlStatus':: d.fn(help='`aws.securityhub_standards_control.withControlStatus` constructs a mixin object that can be merged into the `securityhub_standards_control`\nTerraform resource block to set or update the control_status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `control_status` field.\n', args=[]),
  ...
  '#withDisabledReason':: d.fn(help='`aws.securityhub_standards_control.withDisabledReason` constructs a mixin object that can be merged into the `securityhub_standards_control`\nTerraform resource block to set or update the disabled_reason field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disabled_reason` field.\n', args=[]),
  ...
  '#withStandardsControlArn':: d.fn(help='`aws.securityhub_standards_control.withStandardsControlArn` constructs a mixin object that can be merged into the `securityhub_standards_control`\nTerraform resource block to set or update the standards_control_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `standards_control_arn` field.\n', args=[]),
