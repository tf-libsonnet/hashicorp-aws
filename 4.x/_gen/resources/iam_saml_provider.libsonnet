...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.iam_saml_provider.withName` constructs a mixin object that can be merged into the `iam_saml_provider`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSamlMetadataDocument':: d.fn(help='`aws.iam_saml_provider.withSamlMetadataDocument` constructs a mixin object that can be merged into the `iam_saml_provider`\nTerraform resource block to set or update the saml_metadata_document field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `saml_metadata_document` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.iam_saml_provider.withTagsAll` constructs a mixin object that can be merged into the `iam_saml_provider`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
