...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStreamArn':: d.fn(help='`aws.dynamodb_kinesis_streaming_destination.withStreamArn` constructs a mixin object that can be merged into the `dynamodb_kinesis_streaming_destination`\nTerraform resource block to set or update the stream_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stream_arn` field.\n', args=[]),
  ...
  '#withTableName':: d.fn(help='`aws.dynamodb_kinesis_streaming_destination.withTableName` constructs a mixin object that can be merged into the `dynamodb_kinesis_streaming_destination`\nTerraform resource block to set or update the table_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_name` field.\n', args=[]),
