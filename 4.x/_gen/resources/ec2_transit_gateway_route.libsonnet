...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBlackhole':: d.fn(help='`aws.ec2_transit_gateway_route.withBlackhole` constructs a mixin object that can be merged into the `ec2_transit_gateway_route`\nTerraform resource block to set or update the blackhole field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `blackhole` field.\n', args=[]),
  ...
  '#withDestinationCidrBlock':: d.fn(help='`aws.ec2_transit_gateway_route.withDestinationCidrBlock` constructs a mixin object that can be merged into the `ec2_transit_gateway_route`\nTerraform resource block to set or update the destination_cidr_block field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_cidr_block` field.\n', args=[]),
  ...
  '#withTransitGatewayAttachmentId':: d.fn(help='`aws.ec2_transit_gateway_route.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_route`\nTerraform resource block to set or update the transit_gateway_attachment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_attachment_id` field.\n', args=[]),
  ...
  '#withTransitGatewayRouteTableId':: d.fn(help='`aws.ec2_transit_gateway_route.withTransitGatewayRouteTableId` constructs a mixin object that can be merged into the `ec2_transit_gateway_route`\nTerraform resource block to set or update the transit_gateway_route_table_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_route_table_id` field.\n', args=[]),
