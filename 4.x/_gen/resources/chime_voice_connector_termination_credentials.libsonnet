...
{
  '#':: d.pkg(name='chime_voice_connector_termination_credentials', url='', help='`chime_voice_connector_termination_credentials` represents the `aws_chime_voice_connector_termination_credentials` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  credentials:: {
  ...
  '#withCredentials':: d.fn(help='`aws.chime_voice_connector_termination_credentials.withCredentials` constructs a mixin object that can be merged into the `chime_voice_connector_termination_credentials`\nTerraform resource block to set or update the credentials field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `credentials` field.\n', args=[]),
  ...
  '#withCredentialsMixin':: d.fn(help='`aws.chime_voice_connector_termination_credentials.withCredentialsMixin` constructs a mixin object that can be merged into the `chime_voice_connector_termination_credentials`\nTerraform resource block to set or update the credentials field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.chime_voice_connector_termination_credentials.withCredentials](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `credentials` field.\n', args=[]),
  ...
  '#withVoiceConnectorId':: d.fn(help='`aws.chime_voice_connector_termination_credentials.withVoiceConnectorId` constructs a mixin object that can be merged into the `chime_voice_connector_termination_credentials`\nTerraform resource block to set or update the voice_connector_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `voice_connector_id` field.\n', args=[]),
