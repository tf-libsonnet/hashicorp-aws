...
{
  '#':: d.pkg(name='sqs_queue_redrive_policy', url='', help='`sqs_queue_redrive_policy` represents the `aws_sqs_queue_redrive_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withQueueUrl':: d.fn(help='`aws.sqs_queue_redrive_policy.withQueueUrl` constructs a mixin object that can be merged into the `sqs_queue_redrive_policy`\nTerraform resource block to set or update the queue_url field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `queue_url` field.\n', args=[]),
  ...
  '#withRedrivePolicy':: d.fn(help='`aws.sqs_queue_redrive_policy.withRedrivePolicy` constructs a mixin object that can be merged into the `sqs_queue_redrive_policy`\nTerraform resource block to set or update the redrive_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `redrive_policy` field.\n', args=[]),
