...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPeerAccountId':: d.fn(help='`aws.ec2_transit_gateway_peering_attachment.withPeerAccountId` constructs a mixin object that can be merged into the `ec2_transit_gateway_peering_attachment`\nTerraform resource block to set or update the peer_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `peer_account_id` field.\n', args=[]),
  ...
  '#withPeerRegion':: d.fn(help='`aws.ec2_transit_gateway_peering_attachment.withPeerRegion` constructs a mixin object that can be merged into the `ec2_transit_gateway_peering_attachment`\nTerraform resource block to set or update the peer_region field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `peer_region` field.\n', args=[]),
  ...
  '#withPeerTransitGatewayId':: d.fn(help='`aws.ec2_transit_gateway_peering_attachment.withPeerTransitGatewayId` constructs a mixin object that can be merged into the `ec2_transit_gateway_peering_attachment`\nTerraform resource block to set or update the peer_transit_gateway_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `peer_transit_gateway_id` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ec2_transit_gateway_peering_attachment.withTagsAll` constructs a mixin object that can be merged into the `ec2_transit_gateway_peering_attachment`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTransitGatewayId':: d.fn(help='`aws.ec2_transit_gateway_peering_attachment.withTransitGatewayId` constructs a mixin object that can be merged into the `ec2_transit_gateway_peering_attachment`\nTerraform resource block to set or update the transit_gateway_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_id` field.\n', args=[]),
