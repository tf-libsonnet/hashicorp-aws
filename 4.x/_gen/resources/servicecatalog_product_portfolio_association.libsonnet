...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAcceptLanguage':: d.fn(help='`aws.servicecatalog_product_portfolio_association.withAcceptLanguage` constructs a mixin object that can be merged into the `servicecatalog_product_portfolio_association`\nTerraform resource block to set or update the accept_language field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `accept_language` field.\n', args=[]),
  ...
  '#withPortfolioId':: d.fn(help='`aws.servicecatalog_product_portfolio_association.withPortfolioId` constructs a mixin object that can be merged into the `servicecatalog_product_portfolio_association`\nTerraform resource block to set or update the portfolio_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `portfolio_id` field.\n', args=[]),
  ...
  '#withProductId':: d.fn(help='`aws.servicecatalog_product_portfolio_association.withProductId` constructs a mixin object that can be merged into the `servicecatalog_product_portfolio_association`\nTerraform resource block to set or update the product_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `product_id` field.\n', args=[]),
  ...
  '#withSourcePortfolioId':: d.fn(help='`aws.servicecatalog_product_portfolio_association.withSourcePortfolioId` constructs a mixin object that can be merged into the `servicecatalog_product_portfolio_association`\nTerraform resource block to set or update the source_portfolio_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_portfolio_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.servicecatalog_product_portfolio_association.withTimeouts` constructs a mixin object that can be merged into the `servicecatalog_product_portfolio_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.servicecatalog_product_portfolio_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `servicecatalog_product_portfolio_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.servicecatalog_product_portfolio_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
