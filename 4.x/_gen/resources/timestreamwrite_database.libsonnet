...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDatabaseName':: d.fn(help='`aws.timestreamwrite_database.withDatabaseName` constructs a mixin object that can be merged into the `timestreamwrite_database`\nTerraform resource block to set or update the database_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database_name` field.\n', args=[]),
  ...
  '#withKmsKeyId':: d.fn(help='`aws.timestreamwrite_database.withKmsKeyId` constructs a mixin object that can be merged into the `timestreamwrite_database`\nTerraform resource block to set or update the kms_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.timestreamwrite_database.withTags` constructs a mixin object that can be merged into the `timestreamwrite_database`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.timestreamwrite_database.withTagsAll` constructs a mixin object that can be merged into the `timestreamwrite_database`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
