...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDistributionId':: d.fn(help='`aws.cloudfront_monitoring_subscription.withDistributionId` constructs a mixin object that can be merged into the `cloudfront_monitoring_subscription`\nTerraform resource block to set or update the distribution_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `distribution_id` field.\n', args=[]),
  ...
  '#withMonitoringSubscription':: d.fn(help='`aws.cloudfront_monitoring_subscription.withMonitoringSubscription` constructs a mixin object that can be merged into the `cloudfront_monitoring_subscription`\nTerraform resource block to set or update the monitoring_subscription field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitoring_subscription` field.\n', args=[]),
  ...
  '#withMonitoringSubscriptionMixin':: d.fn(help='`aws.cloudfront_monitoring_subscription.withMonitoringSubscriptionMixin` constructs a mixin object that can be merged into the `cloudfront_monitoring_subscription`\nTerraform resource block to set or update the monitoring_subscription field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudfront_monitoring_subscription.withMonitoringSubscription](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitoring_subscription` field.\n', args=[]),
