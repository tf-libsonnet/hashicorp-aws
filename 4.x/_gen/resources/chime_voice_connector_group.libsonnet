...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConnector':: d.fn(help='`aws.chime_voice_connector_group.withConnector` constructs a mixin object that can be merged into the `chime_voice_connector_group`\nTerraform resource block to set or update the connector field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connector` field.\n', args=[]),
  ...
  '#withConnectorMixin':: d.fn(help='`aws.chime_voice_connector_group.withConnectorMixin` constructs a mixin object that can be merged into the `chime_voice_connector_group`\nTerraform resource block to set or update the connector field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.chime_voice_connector_group.withConnector](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connector` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.chime_voice_connector_group.withName` constructs a mixin object that can be merged into the `chime_voice_connector_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
