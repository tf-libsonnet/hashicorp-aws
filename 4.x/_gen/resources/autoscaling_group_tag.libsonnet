...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutoscalingGroupName':: d.fn(help='`aws.autoscaling_group_tag.withAutoscalingGroupName` constructs a mixin object that can be merged into the `autoscaling_group_tag`\nTerraform resource block to set or update the autoscaling_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `autoscaling_group_name` field.\n', args=[]),
  ...
  '#withTag':: d.fn(help='`aws.autoscaling_group_tag.withTag` constructs a mixin object that can be merged into the `autoscaling_group_tag`\nTerraform resource block to set or update the tag field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag` field.\n', args=[]),
  ...
  '#withTagMixin':: d.fn(help='`aws.autoscaling_group_tag.withTagMixin` constructs a mixin object that can be merged into the `autoscaling_group_tag`\nTerraform resource block to set or update the tag field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.autoscaling_group_tag.withTag](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag` field.\n', args=[]),
