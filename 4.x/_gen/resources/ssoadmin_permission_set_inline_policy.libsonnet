...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInlinePolicy':: d.fn(help='`aws.ssoadmin_permission_set_inline_policy.withInlinePolicy` constructs a mixin object that can be merged into the `ssoadmin_permission_set_inline_policy`\nTerraform resource block to set or update the inline_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `inline_policy` field.\n', args=[]),
  ...
  '#withInstanceArn':: d.fn(help='`aws.ssoadmin_permission_set_inline_policy.withInstanceArn` constructs a mixin object that can be merged into the `ssoadmin_permission_set_inline_policy`\nTerraform resource block to set or update the instance_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_arn` field.\n', args=[]),
  ...
  '#withPermissionSetArn':: d.fn(help='`aws.ssoadmin_permission_set_inline_policy.withPermissionSetArn` constructs a mixin object that can be merged into the `ssoadmin_permission_set_inline_policy`\nTerraform resource block to set or update the permission_set_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permission_set_arn` field.\n', args=[]),
