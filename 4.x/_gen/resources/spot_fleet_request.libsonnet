...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  launch_template_config:: {
    ...
    '#new':: d.fn(help='\n`aws.spot_fleet_request.launch_template_config.new` constructs a new object with attributes and blocks configured for the `launch_template_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `launch_template_specification` (`list[obj]`):  When `null`, the `launch_template_specification` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.spot_fleet_request.launch_template_config.launch_template_specification.new](#fn-spot_fleet_requestlaunch_template_specificationnew) constructor.\n  - `overrides` (`list[obj]`):  When `null`, the `overrides` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.spot_fleet_request.launch_template_config.overrides.new](#fn-spot_fleet_requestoverridesnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `launch_template_config` sub block.\n', args=[]),
    new(
