...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBehaviorOnMxFailure':: d.fn(help='`aws.ses_domain_mail_from.withBehaviorOnMxFailure` constructs a mixin object that can be merged into the `ses_domain_mail_from`\nTerraform resource block to set or update the behavior_on_mx_failure field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `behavior_on_mx_failure` field.\n', args=[]),
  ...
  '#withDomain':: d.fn(help='`aws.ses_domain_mail_from.withDomain` constructs a mixin object that can be merged into the `ses_domain_mail_from`\nTerraform resource block to set or update the domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain` field.\n', args=[]),
  ...
  '#withMailFromDomain':: d.fn(help='`aws.ses_domain_mail_from.withMailFromDomain` constructs a mixin object that can be merged into the `ses_domain_mail_from`\nTerraform resource block to set or update the mail_from_domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mail_from_domain` field.\n', args=[]),
