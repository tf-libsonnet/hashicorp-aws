...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withProductArn':: d.fn(help='`aws.securityhub_product_subscription.withProductArn` constructs a mixin object that can be merged into the `securityhub_product_subscription`\nTerraform resource block to set or update the product_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `product_arn` field.\n', args=[]),
