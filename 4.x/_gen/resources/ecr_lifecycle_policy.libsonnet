...
{
  '#':: d.pkg(name='ecr_lifecycle_policy', url='', help='`ecr_lifecycle_policy` represents the `aws_ecr_lifecycle_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPolicy':: d.fn(help='`aws.ecr_lifecycle_policy.withPolicy` constructs a mixin object that can be merged into the `ecr_lifecycle_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withRepository':: d.fn(help='`aws.ecr_lifecycle_policy.withRepository` constructs a mixin object that can be merged into the `ecr_lifecycle_policy`\nTerraform resource block to set or update the repository field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository` field.\n', args=[]),
