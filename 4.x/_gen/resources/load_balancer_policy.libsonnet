...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLoadBalancerName':: d.fn(help='`aws.load_balancer_policy.withLoadBalancerName` constructs a mixin object that can be merged into the `load_balancer_policy`\nTerraform resource block to set or update the load_balancer_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load_balancer_name` field.\n', args=[]),
  ...
  '#withPolicyAttribute':: d.fn(help='`aws.load_balancer_policy.withPolicyAttribute` constructs a mixin object that can be merged into the `load_balancer_policy`\nTerraform resource block to set or update the policy_attribute field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_attribute` field.\n', args=[]),
  ...
  '#withPolicyAttributeMixin':: d.fn(help='`aws.load_balancer_policy.withPolicyAttributeMixin` constructs a mixin object that can be merged into the `load_balancer_policy`\nTerraform resource block to set or update the policy_attribute field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.load_balancer_policy.withPolicyAttribute](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_attribute` field.\n', args=[]),
  ...
  '#withPolicyName':: d.fn(help='`aws.load_balancer_policy.withPolicyName` constructs a mixin object that can be merged into the `load_balancer_policy`\nTerraform resource block to set or update the policy_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_name` field.\n', args=[]),
  ...
  '#withPolicyTypeName':: d.fn(help='`aws.load_balancer_policy.withPolicyTypeName` constructs a mixin object that can be merged into the `load_balancer_policy`\nTerraform resource block to set or update the policy_type_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_type_name` field.\n', args=[]),
