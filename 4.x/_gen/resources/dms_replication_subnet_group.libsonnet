...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withReplicationSubnetGroupDescription':: d.fn(help='`aws.dms_replication_subnet_group.withReplicationSubnetGroupDescription` constructs a mixin object that can be merged into the `dms_replication_subnet_group`\nTerraform resource block to set or update the replication_subnet_group_description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `replication_subnet_group_description` field.\n', args=[]),
  ...
  '#withReplicationSubnetGroupId':: d.fn(help='`aws.dms_replication_subnet_group.withReplicationSubnetGroupId` constructs a mixin object that can be merged into the `dms_replication_subnet_group`\nTerraform resource block to set or update the replication_subnet_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `replication_subnet_group_id` field.\n', args=[]),
  ...
  '#withSubnetIds':: d.fn(help='`aws.dms_replication_subnet_group.withSubnetIds` constructs a mixin object that can be merged into the `dms_replication_subnet_group`\nTerraform resource block to set or update the subnet_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_ids` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.dms_replication_subnet_group.withTags` constructs a mixin object that can be merged into the `dms_replication_subnet_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.dms_replication_subnet_group.withTagsAll` constructs a mixin object that can be merged into the `dms_replication_subnet_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
