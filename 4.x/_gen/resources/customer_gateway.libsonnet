...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBgpAsn':: d.fn(help='`aws.customer_gateway.withBgpAsn` constructs a mixin object that can be merged into the `customer_gateway`\nTerraform resource block to set or update the bgp_asn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bgp_asn` field.\n', args=[]),
  ...
  '#withCertificateArn':: d.fn(help='`aws.customer_gateway.withCertificateArn` constructs a mixin object that can be merged into the `customer_gateway`\nTerraform resource block to set or update the certificate_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_arn` field.\n', args=[]),
  ...
  '#withDeviceName':: d.fn(help='`aws.customer_gateway.withDeviceName` constructs a mixin object that can be merged into the `customer_gateway`\nTerraform resource block to set or update the device_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `device_name` field.\n', args=[]),
  ...
  '#withIpAddress':: d.fn(help='`aws.customer_gateway.withIpAddress` constructs a mixin object that can be merged into the `customer_gateway`\nTerraform resource block to set or update the ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_address` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.customer_gateway.withTagsAll` constructs a mixin object that can be merged into the `customer_gateway`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withType':: d.fn(help='`aws.customer_gateway.withType` constructs a mixin object that can be merged into the `customer_gateway`\nTerraform resource block to set or update the type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type` field.\n', args=[]),
