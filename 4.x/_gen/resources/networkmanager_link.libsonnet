...
{
  '#':: d.pkg(name='networkmanager_link', url='', help='`networkmanager_link` represents the `aws_networkmanager_link` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  bandwidth:: {
    '#new':: d.fn(help='\n`aws.networkmanager_link.bandwidth.new` constructs a new object with attributes and blocks configured for the `bandwidth`\nTerraform sub block.\n\n\n\n**Args**:\n  - `download_speed` (`number`): Set the `download_speed` field on the resulting object. When `null`, the `download_speed` field will be omitted from the resulting object.\n  - `upload_speed` (`number`): Set the `upload_speed` field on the resulting object. When `null`, the `upload_speed` field will be omitted from the resulting object.\n\n**Returns**:\n  - An attribute object that represents the `bandwidth` sub block.\n', args=[]),
    new(
      download_speed=null,
      upload_speed=null
    ):: std.prune(a={
  ...
  '#withBandwidthMixin':: d.fn(help='`aws.list[obj].withBandwidthMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the bandwidth field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withBandwidth](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `bandwidth` field.\n', args=[]),
