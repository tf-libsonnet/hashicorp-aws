...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withVpcEndpointId':: d.fn(help='`aws.vpc_endpoint_connection_accepter.withVpcEndpointId` constructs a mixin object that can be merged into the `vpc_endpoint_connection_accepter`\nTerraform resource block to set or update the vpc_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_endpoint_id` field.\n', args=[]),
  ...
  '#withVpcEndpointServiceId':: d.fn(help='`aws.vpc_endpoint_connection_accepter.withVpcEndpointServiceId` constructs a mixin object that can be merged into the `vpc_endpoint_connection_accepter`\nTerraform resource block to set or update the vpc_endpoint_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_endpoint_service_id` field.\n', args=[]),
