...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDestinationConfig':: d.fn(help='`aws.lambda_function_event_invoke_config.withDestinationConfig` constructs a mixin object that can be merged into the `lambda_function_event_invoke_config`\nTerraform resource block to set or update the destination_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_config` field.\n', args=[]),
  ...
  '#withDestinationConfigMixin':: d.fn(help='`aws.lambda_function_event_invoke_config.withDestinationConfigMixin` constructs a mixin object that can be merged into the `lambda_function_event_invoke_config`\nTerraform resource block to set or update the destination_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.lambda_function_event_invoke_config.withDestinationConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_config` field.\n', args=[]),
  ...
  '#withFunctionName':: d.fn(help='`aws.lambda_function_event_invoke_config.withFunctionName` constructs a mixin object that can be merged into the `lambda_function_event_invoke_config`\nTerraform resource block to set or update the function_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `function_name` field.\n', args=[]),
  ...
  '#withMaximumEventAgeInSeconds':: d.fn(help='`aws.lambda_function_event_invoke_config.withMaximumEventAgeInSeconds` constructs a mixin object that can be merged into the `lambda_function_event_invoke_config`\nTerraform resource block to set or update the maximum_event_age_in_seconds field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `maximum_event_age_in_seconds` field.\n', args=[]),
  ...
  '#withMaximumRetryAttempts':: d.fn(help='`aws.lambda_function_event_invoke_config.withMaximumRetryAttempts` constructs a mixin object that can be merged into the `lambda_function_event_invoke_config`\nTerraform resource block to set or update the maximum_retry_attempts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `maximum_retry_attempts` field.\n', args=[]),
  ...
  '#withQualifier':: d.fn(help='`aws.lambda_function_event_invoke_config.withQualifier` constructs a mixin object that can be merged into the `lambda_function_event_invoke_config`\nTerraform resource block to set or update the qualifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `qualifier` field.\n', args=[]),
