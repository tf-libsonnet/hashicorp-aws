...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucket':: d.fn(help='`aws.s3control_bucket_policy.withBucket` constructs a mixin object that can be merged into the `s3control_bucket_policy`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.s3control_bucket_policy.withPolicy` constructs a mixin object that can be merged into the `s3control_bucket_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
