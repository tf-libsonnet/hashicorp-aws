...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstancePorts':: d.fn(help='`aws.proxy_protocol_policy.withInstancePorts` constructs a mixin object that can be merged into the `proxy_protocol_policy`\nTerraform resource block to set or update the instance_ports field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_ports` field.\n', args=[]),
  ...
  '#withLoadBalancer':: d.fn(help='`aws.proxy_protocol_policy.withLoadBalancer` constructs a mixin object that can be merged into the `proxy_protocol_policy`\nTerraform resource block to set or update the load_balancer field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load_balancer` field.\n', args=[]),
