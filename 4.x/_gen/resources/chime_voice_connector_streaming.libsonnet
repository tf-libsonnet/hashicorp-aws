...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDataRetention':: d.fn(help='`aws.chime_voice_connector_streaming.withDataRetention` constructs a mixin object that can be merged into the `chime_voice_connector_streaming`\nTerraform resource block to set or update the data_retention field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `data_retention` field.\n', args=[]),
  ...
  '#withDisabled':: d.fn(help='`aws.chime_voice_connector_streaming.withDisabled` constructs a mixin object that can be merged into the `chime_voice_connector_streaming`\nTerraform resource block to set or update the disabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disabled` field.\n', args=[]),
  ...
  '#withStreamingNotificationTargets':: d.fn(help='`aws.chime_voice_connector_streaming.withStreamingNotificationTargets` constructs a mixin object that can be merged into the `chime_voice_connector_streaming`\nTerraform resource block to set or update the streaming_notification_targets field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `streaming_notification_targets` field.\n', args=[]),
  ...
  '#withVoiceConnectorId':: d.fn(help='`aws.chime_voice_connector_streaming.withVoiceConnectorId` constructs a mixin object that can be merged into the `chime_voice_connector_streaming`\nTerraform resource block to set or update the voice_connector_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `voice_connector_id` field.\n', args=[]),
