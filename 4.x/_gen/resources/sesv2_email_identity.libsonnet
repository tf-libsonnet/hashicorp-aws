...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConfigurationSetName':: d.fn(help='`aws.sesv2_email_identity.withConfigurationSetName` constructs a mixin object that can be merged into the `sesv2_email_identity`\nTerraform resource block to set or update the configuration_set_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `configuration_set_name` field.\n', args=[]),
  ...
  '#withDkimSigningAttributes':: d.fn(help='`aws.sesv2_email_identity.withDkimSigningAttributes` constructs a mixin object that can be merged into the `sesv2_email_identity`\nTerraform resource block to set or update the dkim_signing_attributes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dkim_signing_attributes` field.\n', args=[]),
  ...
  '#withDkimSigningAttributesMixin':: d.fn(help='`aws.sesv2_email_identity.withDkimSigningAttributesMixin` constructs a mixin object that can be merged into the `sesv2_email_identity`\nTerraform resource block to set or update the dkim_signing_attributes field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.sesv2_email_identity.withDkimSigningAttributes](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dkim_signing_attributes` field.\n', args=[]),
  ...
  '#withEmailIdentity':: d.fn(help='`aws.sesv2_email_identity.withEmailIdentity` constructs a mixin object that can be merged into the `sesv2_email_identity`\nTerraform resource block to set or update the email_identity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `email_identity` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.sesv2_email_identity.withTags` constructs a mixin object that can be merged into the `sesv2_email_identity`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.sesv2_email_identity.withTagsAll` constructs a mixin object that can be merged into the `sesv2_email_identity`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
