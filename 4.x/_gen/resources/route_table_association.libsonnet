...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGatewayId':: d.fn(help='`aws.route_table_association.withGatewayId` constructs a mixin object that can be merged into the `route_table_association`\nTerraform resource block to set or update the gateway_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway_id` field.\n', args=[]),
  ...
  '#withRouteTableId':: d.fn(help='`aws.route_table_association.withRouteTableId` constructs a mixin object that can be merged into the `route_table_association`\nTerraform resource block to set or update the route_table_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `route_table_id` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`aws.route_table_association.withSubnetId` constructs a mixin object that can be merged into the `route_table_association`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
