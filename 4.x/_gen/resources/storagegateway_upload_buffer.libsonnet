...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDiskId':: d.fn(help='`aws.storagegateway_upload_buffer.withDiskId` constructs a mixin object that can be merged into the `storagegateway_upload_buffer`\nTerraform resource block to set or update the disk_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_id` field.\n', args=[]),
  ...
  '#withDiskPath':: d.fn(help='`aws.storagegateway_upload_buffer.withDiskPath` constructs a mixin object that can be merged into the `storagegateway_upload_buffer`\nTerraform resource block to set or update the disk_path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_path` field.\n', args=[]),
  ...
  '#withGatewayArn':: d.fn(help='`aws.storagegateway_upload_buffer.withGatewayArn` constructs a mixin object that can be merged into the `storagegateway_upload_buffer`\nTerraform resource block to set or update the gateway_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway_arn` field.\n', args=[]),
