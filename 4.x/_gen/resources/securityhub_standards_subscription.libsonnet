...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStandardsArn':: d.fn(help='`aws.securityhub_standards_subscription.withStandardsArn` constructs a mixin object that can be merged into the `securityhub_standards_subscription`\nTerraform resource block to set or update the standards_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `standards_arn` field.\n', args=[]),
