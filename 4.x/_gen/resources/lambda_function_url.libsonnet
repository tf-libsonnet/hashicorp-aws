...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuthorizationType':: d.fn(help='`aws.lambda_function_url.withAuthorizationType` constructs a mixin object that can be merged into the `lambda_function_url`\nTerraform resource block to set or update the authorization_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authorization_type` field.\n', args=[]),
  ...
  '#withCors':: d.fn(help='`aws.lambda_function_url.withCors` constructs a mixin object that can be merged into the `lambda_function_url`\nTerraform resource block to set or update the cors field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cors` field.\n', args=[]),
  ...
  '#withCorsMixin':: d.fn(help='`aws.lambda_function_url.withCorsMixin` constructs a mixin object that can be merged into the `lambda_function_url`\nTerraform resource block to set or update the cors field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.lambda_function_url.withCors](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cors` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.lambda_function_url.withTimeouts` constructs a mixin object that can be merged into the `lambda_function_url`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.lambda_function_url.withTimeoutsMixin` constructs a mixin object that can be merged into the `lambda_function_url`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.lambda_function_url.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
