...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationName':: d.fn(help='`aws.kinesisanalyticsv2_application_snapshot.withApplicationName` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application_snapshot`\nTerraform resource block to set or update the application_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_name` field.\n', args=[]),
  ...
  '#withSnapshotName':: d.fn(help='`aws.kinesisanalyticsv2_application_snapshot.withSnapshotName` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application_snapshot`\nTerraform resource block to set or update the snapshot_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `snapshot_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.kinesisanalyticsv2_application_snapshot.withTimeouts` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application_snapshot`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.kinesisanalyticsv2_application_snapshot.withTimeoutsMixin` constructs a mixin object that can be merged into the `kinesisanalyticsv2_application_snapshot`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.kinesisanalyticsv2_application_snapshot.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
