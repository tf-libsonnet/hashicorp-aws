...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCode':: d.fn(help='`aws.cloudfront_function.withCode` constructs a mixin object that can be merged into the `cloudfront_function`\nTerraform resource block to set or update the code field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `code` field.\n', args=[]),
  ...
  '#withComment':: d.fn(help='`aws.cloudfront_function.withComment` constructs a mixin object that can be merged into the `cloudfront_function`\nTerraform resource block to set or update the comment field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `comment` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudfront_function.withName` constructs a mixin object that can be merged into the `cloudfront_function`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPublish':: d.fn(help='`aws.cloudfront_function.withPublish` constructs a mixin object that can be merged into the `cloudfront_function`\nTerraform resource block to set or update the publish field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `publish` field.\n', args=[]),
  ...
  '#withRuntime':: d.fn(help='`aws.cloudfront_function.withRuntime` constructs a mixin object that can be merged into the `cloudfront_function`\nTerraform resource block to set or update the runtime field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `runtime` field.\n', args=[]),
