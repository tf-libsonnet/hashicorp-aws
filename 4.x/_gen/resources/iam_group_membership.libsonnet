...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroup':: d.fn(help='`aws.iam_group_membership.withGroup` constructs a mixin object that can be merged into the `iam_group_membership`\nTerraform resource block to set or update the group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.iam_group_membership.withName` constructs a mixin object that can be merged into the `iam_group_membership`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withUsers':: d.fn(help='`aws.iam_group_membership.withUsers` constructs a mixin object that can be merged into the `iam_group_membership`\nTerraform resource block to set or update the users field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `users` field.\n', args=[]),
