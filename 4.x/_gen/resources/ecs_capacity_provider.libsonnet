...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutoScalingGroupProvider':: d.fn(help='`aws.ecs_capacity_provider.withAutoScalingGroupProvider` constructs a mixin object that can be merged into the `ecs_capacity_provider`\nTerraform resource block to set or update the auto_scaling_group_provider field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_scaling_group_provider` field.\n', args=[]),
  ...
  '#withAutoScalingGroupProviderMixin':: d.fn(help='`aws.ecs_capacity_provider.withAutoScalingGroupProviderMixin` constructs a mixin object that can be merged into the `ecs_capacity_provider`\nTerraform resource block to set or update the auto_scaling_group_provider field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ecs_capacity_provider.withAutoScalingGroupProvider](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_scaling_group_provider` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.ecs_capacity_provider.withName` constructs a mixin object that can be merged into the `ecs_capacity_provider`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.ecs_capacity_provider.withTags` constructs a mixin object that can be merged into the `ecs_capacity_provider`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ecs_capacity_provider.withTagsAll` constructs a mixin object that can be merged into the `ecs_capacity_provider`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
