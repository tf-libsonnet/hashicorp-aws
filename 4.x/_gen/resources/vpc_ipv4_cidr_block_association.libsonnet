...
{
  '#':: d.pkg(name='vpc_ipv4_cidr_block_association', url='', help='`vpc_ipv4_cidr_block_association` represents the `aws_vpc_ipv4_cidr_block_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCidrBlock':: d.fn(help='`aws.vpc_ipv4_cidr_block_association.withCidrBlock` constructs a mixin object that can be merged into the `vpc_ipv4_cidr_block_association`\nTerraform resource block to set or update the cidr_block field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cidr_block` field.\n', args=[]),
  ...
  '#withIpv4IpamPoolId':: d.fn(help='`aws.vpc_ipv4_cidr_block_association.withIpv4IpamPoolId` constructs a mixin object that can be merged into the `vpc_ipv4_cidr_block_association`\nTerraform resource block to set or update the ipv4_ipam_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ipv4_ipam_pool_id` field.\n', args=[]),
  ...
  '#withIpv4NetmaskLength':: d.fn(help='`aws.vpc_ipv4_cidr_block_association.withIpv4NetmaskLength` constructs a mixin object that can be merged into the `vpc_ipv4_cidr_block_association`\nTerraform resource block to set or update the ipv4_netmask_length field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ipv4_netmask_length` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.vpc_ipv4_cidr_block_association.withTimeouts` constructs a mixin object that can be merged into the `vpc_ipv4_cidr_block_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.vpc_ipv4_cidr_block_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpc_ipv4_cidr_block_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.vpc_ipv4_cidr_block_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpcId':: d.fn(help='`aws.vpc_ipv4_cidr_block_association.withVpcId` constructs a mixin object that can be merged into the `vpc_ipv4_cidr_block_association`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
