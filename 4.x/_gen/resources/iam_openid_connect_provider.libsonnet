...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClientIdList':: d.fn(help='`aws.iam_openid_connect_provider.withClientIdList` constructs a mixin object that can be merged into the `iam_openid_connect_provider`\nTerraform resource block to set or update the client_id_list field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_id_list` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.iam_openid_connect_provider.withTags` constructs a mixin object that can be merged into the `iam_openid_connect_provider`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.iam_openid_connect_provider.withTagsAll` constructs a mixin object that can be merged into the `iam_openid_connect_provider`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withThumbprintList':: d.fn(help='`aws.iam_openid_connect_provider.withThumbprintList` constructs a mixin object that can be merged into the `iam_openid_connect_provider`\nTerraform resource block to set or update the thumbprint_list field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `thumbprint_list` field.\n', args=[]),
  ...
  '#withUrl':: d.fn(help='`aws.iam_openid_connect_provider.withUrl` constructs a mixin object that can be merged into the `iam_openid_connect_provider`\nTerraform resource block to set or update the url field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `url` field.\n', args=[]),
