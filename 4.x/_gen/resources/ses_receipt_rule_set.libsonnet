...
{
  '#':: d.pkg(name='ses_receipt_rule_set', url='', help='`ses_receipt_rule_set` represents the `aws_ses_receipt_rule_set` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withRuleSetName':: d.fn(help='`aws.ses_receipt_rule_set.withRuleSetName` constructs a mixin object that can be merged into the `ses_receipt_rule_set`\nTerraform resource block to set or update the rule_set_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rule_set_name` field.\n', args=[]),
