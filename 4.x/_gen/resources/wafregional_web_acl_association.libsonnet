...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withResourceArn':: d.fn(help='`aws.wafregional_web_acl_association.withResourceArn` constructs a mixin object that can be merged into the `wafregional_web_acl_association`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
  ...
  '#withWebAclId':: d.fn(help='`aws.wafregional_web_acl_association.withWebAclId` constructs a mixin object that can be merged into the `wafregional_web_acl_association`\nTerraform resource block to set or update the web_acl_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `web_acl_id` field.\n', args=[]),
