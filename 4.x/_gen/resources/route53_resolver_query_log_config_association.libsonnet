...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withResolverQueryLogConfigId':: d.fn(help='`aws.route53_resolver_query_log_config_association.withResolverQueryLogConfigId` constructs a mixin object that can be merged into the `route53_resolver_query_log_config_association`\nTerraform resource block to set or update the resolver_query_log_config_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resolver_query_log_config_id` field.\n', args=[]),
  ...
  '#withResourceId':: d.fn(help='`aws.route53_resolver_query_log_config_association.withResourceId` constructs a mixin object that can be merged into the `route53_resolver_query_log_config_association`\nTerraform resource block to set or update the resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_id` field.\n', args=[]),
