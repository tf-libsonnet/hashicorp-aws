...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFileSystemId':: d.fn(help='`aws.efs_mount_target.withFileSystemId` constructs a mixin object that can be merged into the `efs_mount_target`\nTerraform resource block to set or update the file_system_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `file_system_id` field.\n', args=[]),
  ...
  '#withIpAddress':: d.fn(help='`aws.efs_mount_target.withIpAddress` constructs a mixin object that can be merged into the `efs_mount_target`\nTerraform resource block to set or update the ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_address` field.\n', args=[]),
  ...
  '#withSecurityGroups':: d.fn(help='`aws.efs_mount_target.withSecurityGroups` constructs a mixin object that can be merged into the `efs_mount_target`\nTerraform resource block to set or update the security_groups field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_groups` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`aws.efs_mount_target.withSubnetId` constructs a mixin object that can be merged into the `efs_mount_target`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
