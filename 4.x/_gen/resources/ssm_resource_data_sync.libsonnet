...
{
  '#':: d.pkg(name='ssm_resource_data_sync', url='', help='`ssm_resource_data_sync` represents the `aws_ssm_resource_data_sync` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.ssm_resource_data_sync.withName` constructs a mixin object that can be merged into the `ssm_resource_data_sync`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withS3Destination':: d.fn(help='`aws.ssm_resource_data_sync.withS3Destination` constructs a mixin object that can be merged into the `ssm_resource_data_sync`\nTerraform resource block to set or update the s3_destination field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_destination` field.\n', args=[]),
  ...
  '#withS3DestinationMixin':: d.fn(help='`aws.ssm_resource_data_sync.withS3DestinationMixin` constructs a mixin object that can be merged into the `ssm_resource_data_sync`\nTerraform resource block to set or update the s3_destination field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ssm_resource_data_sync.withS3Destination](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_destination` field.\n', args=[]),
