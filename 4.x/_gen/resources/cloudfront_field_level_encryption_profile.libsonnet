...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withComment':: d.fn(help='`aws.cloudfront_field_level_encryption_profile.withComment` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_profile`\nTerraform resource block to set or update the comment field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `comment` field.\n', args=[]),
  ...
  '#withEncryptionEntities':: d.fn(help='`aws.cloudfront_field_level_encryption_profile.withEncryptionEntities` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_profile`\nTerraform resource block to set or update the encryption_entities field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encryption_entities` field.\n', args=[]),
  ...
  '#withEncryptionEntitiesMixin':: d.fn(help='`aws.cloudfront_field_level_encryption_profile.withEncryptionEntitiesMixin` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_profile`\nTerraform resource block to set or update the encryption_entities field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudfront_field_level_encryption_profile.withEncryptionEntities](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encryption_entities` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudfront_field_level_encryption_profile.withName` constructs a mixin object that can be merged into the `cloudfront_field_level_encryption_profile`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
