...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnableHybrid':: d.fn(help='`aws.glue_resource_policy.withEnableHybrid` constructs a mixin object that can be merged into the `glue_resource_policy`\nTerraform resource block to set or update the enable_hybrid field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_hybrid` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.glue_resource_policy.withPolicy` constructs a mixin object that can be merged into the `glue_resource_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
