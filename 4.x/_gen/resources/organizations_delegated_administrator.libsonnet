...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`aws.organizations_delegated_administrator.withAccountId` constructs a mixin object that can be merged into the `organizations_delegated_administrator`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withServicePrincipal':: d.fn(help='`aws.organizations_delegated_administrator.withServicePrincipal` constructs a mixin object that can be merged into the `organizations_delegated_administrator`\nTerraform resource block to set or update the service_principal field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_principal` field.\n', args=[]),
