...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStatus':: d.fn(help='`aws.sagemaker_servicecatalog_portfolio_status.withStatus` constructs a mixin object that can be merged into the `sagemaker_servicecatalog_portfolio_status`\nTerraform resource block to set or update the status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
