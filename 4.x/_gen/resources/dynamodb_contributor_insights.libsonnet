...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIndexName':: d.fn(help='`aws.dynamodb_contributor_insights.withIndexName` constructs a mixin object that can be merged into the `dynamodb_contributor_insights`\nTerraform resource block to set or update the index_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `index_name` field.\n', args=[]),
  ...
  '#withTableName':: d.fn(help='`aws.dynamodb_contributor_insights.withTableName` constructs a mixin object that can be merged into the `dynamodb_contributor_insights`\nTerraform resource block to set or update the table_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.dynamodb_contributor_insights.withTimeouts` constructs a mixin object that can be merged into the `dynamodb_contributor_insights`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.dynamodb_contributor_insights.withTimeoutsMixin` constructs a mixin object that can be merged into the `dynamodb_contributor_insights`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.dynamodb_contributor_insights.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
