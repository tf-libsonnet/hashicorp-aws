...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAdminAccountId':: d.fn(help='`aws.guardduty_organization_admin_account.withAdminAccountId` constructs a mixin object that can be merged into the `guardduty_organization_admin_account`\nTerraform resource block to set or update the admin_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `admin_account_id` field.\n', args=[]),
