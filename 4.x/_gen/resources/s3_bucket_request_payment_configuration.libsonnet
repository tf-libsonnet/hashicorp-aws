...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucket':: d.fn(help='`aws.s3_bucket_request_payment_configuration.withBucket` constructs a mixin object that can be merged into the `s3_bucket_request_payment_configuration`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withExpectedBucketOwner':: d.fn(help='`aws.s3_bucket_request_payment_configuration.withExpectedBucketOwner` constructs a mixin object that can be merged into the `s3_bucket_request_payment_configuration`\nTerraform resource block to set or update the expected_bucket_owner field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expected_bucket_owner` field.\n', args=[]),
  ...
  '#withPayer':: d.fn(help='`aws.s3_bucket_request_payment_configuration.withPayer` constructs a mixin object that can be merged into the `s3_bucket_request_payment_configuration`\nTerraform resource block to set or update the payer field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `payer` field.\n', args=[]),
