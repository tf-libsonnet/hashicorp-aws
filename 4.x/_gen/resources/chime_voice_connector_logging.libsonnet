...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnableMediaMetricLogs':: d.fn(help='`aws.chime_voice_connector_logging.withEnableMediaMetricLogs` constructs a mixin object that can be merged into the `chime_voice_connector_logging`\nTerraform resource block to set or update the enable_media_metric_logs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_media_metric_logs` field.\n', args=[]),
  ...
  '#withEnableSipLogs':: d.fn(help='`aws.chime_voice_connector_logging.withEnableSipLogs` constructs a mixin object that can be merged into the `chime_voice_connector_logging`\nTerraform resource block to set or update the enable_sip_logs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_sip_logs` field.\n', args=[]),
  ...
  '#withVoiceConnectorId':: d.fn(help='`aws.chime_voice_connector_logging.withVoiceConnectorId` constructs a mixin object that can be merged into the `chime_voice_connector_logging`\nTerraform resource block to set or update the voice_connector_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `voice_connector_id` field.\n', args=[]),
