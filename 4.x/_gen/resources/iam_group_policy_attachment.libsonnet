...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroup':: d.fn(help='`aws.iam_group_policy_attachment.withGroup` constructs a mixin object that can be merged into the `iam_group_policy_attachment`\nTerraform resource block to set or update the group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group` field.\n', args=[]),
  ...
  '#withPolicyArn':: d.fn(help='`aws.iam_group_policy_attachment.withPolicyArn` constructs a mixin object that can be merged into the `iam_group_policy_attachment`\nTerraform resource block to set or update the policy_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_arn` field.\n', args=[]),
