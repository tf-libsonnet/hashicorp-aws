...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationId':: d.fn(help='`aws.pinpoint_event_stream.withApplicationId` constructs a mixin object that can be merged into the `pinpoint_event_stream`\nTerraform resource block to set or update the application_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_id` field.\n', args=[]),
  ...
  '#withDestinationStreamArn':: d.fn(help='`aws.pinpoint_event_stream.withDestinationStreamArn` constructs a mixin object that can be merged into the `pinpoint_event_stream`\nTerraform resource block to set or update the destination_stream_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_stream_arn` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.pinpoint_event_stream.withRoleArn` constructs a mixin object that can be merged into the `pinpoint_event_stream`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
