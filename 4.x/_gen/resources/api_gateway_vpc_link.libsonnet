...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.api_gateway_vpc_link.withDescription` constructs a mixin object that can be merged into the `api_gateway_vpc_link`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.api_gateway_vpc_link.withName` constructs a mixin object that can be merged into the `api_gateway_vpc_link`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.api_gateway_vpc_link.withTags` constructs a mixin object that can be merged into the `api_gateway_vpc_link`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.api_gateway_vpc_link.withTagsAll` constructs a mixin object that can be merged into the `api_gateway_vpc_link`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTargetArns':: d.fn(help='`aws.api_gateway_vpc_link.withTargetArns` constructs a mixin object that can be merged into the `api_gateway_vpc_link`\nTerraform resource block to set or update the target_arns field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_arns` field.\n', args=[]),
