...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  encoder_settings:: {
    ...
    '#new':: d.fn(help='\n`aws.medialive_channel.encoder_settings.new` constructs a new object with attributes and blocks configured for the `encoder_settings`\nTerraform sub block.\n\n\n\n**Args**:\n  - `audio_descriptions` (`list[obj]`):  When `null`, the `audio_descriptions` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.audio_descriptions.new](#fn-encodersettingsaudiodescriptionsnew) constructor.\n  - `avail_blanking` (`list[obj]`):  When `null`, the `avail_blanking` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.avail_blanking.new](#fn-encodersettingsavailblankingnew) constructor.\n  - `output_groups` (`list[obj]`):  When `null`, the `output_groups` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.output_groups.new](#fn-encodersettingsoutputgroupsnew) constructor.\n  - `timecode_config` (`list[obj]`):  When `null`, the `timecode_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.timecode_config.new](#fn-encodersettingstimecodeconfignew) constructor.\n  - `video_descriptions` (`list[obj]`):  When `null`, the `video_descriptions` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.video_descriptions.new](#fn-encodersettingsvideodescriptionsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `encoder_settings` sub block.\n', args=[]),
    new(
      ...
      outputs:: {
        ...
        output_settings:: {
          ...
          udp_output_settings:: {
            ...
            '#new':: d.fn(help='\n`aws.medialive_channel.encoder_settings.output_groups.outputs.output_settings.udp_output_settings.new` constructs a new object with attributes and blocks configured for the `udp_output_settings`\nTerraform sub block.\n\n\n\n**Args**:\n  - `buffer_msec` (`number`):  When `null`, the `buffer_msec` field will be omitted from the resulting object.\n  - `container_settings` (`list[obj]`):  When `null`, the `container_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.output_groups.outputs.output_settings.udp_output_settings.container_settings.new](#fn-udpoutputsettingscontainersettingsnew) constructor.\n  - `destination` (`list[obj]`):  When `null`, the `destination` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.output_groups.outputs.output_settings.udp_output_settings.destination.new](#fn-udpoutputsettingsdestinationnew) constructor.\n  - `fec_output_settings` (`list[obj]`):  When `null`, the `fec_output_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.output_groups.outputs.output_settings.udp_output_settings.fec_output_settings.new](#fn-udpoutputsettingsfecoutputsettingsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `udp_output_settings` sub block.\n', args=[]),
            new(
              buffer_msec=null,
              container_settings=null,
              destination=null,
  ...
  '#new':: d.fn(help="\n`aws.medialive_channel.new` injects a new `aws_medialive_channel` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.medialive_channel.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.medialive_channel` using the reference:\n\n    $._ref.aws_medialive_channel.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_medialive_channel.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `channel_class` (`string`): \n  - `log_level` (`string`):  When `null`, the `log_level` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `role_arn` (`string`):  When `null`, the `role_arn` field will be omitted from the resulting object.\n  - `start_channel` (`bool`):  When `null`, the `start_channel` field will be omitted from the resulting object.\n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `tags_all` (`obj`):  When `null`, the `tags_all` field will be omitted from the resulting object.\n  - `cdi_input_specification` (`list[obj]`):  When `null`, the `cdi_input_specification` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.cdi_input_specification.new](#fn-medialivechannelcdiinputspecificationnew) constructor.\n  - `destinations` (`list[obj]`):  When `null`, the `destinations` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.destinations.new](#fn-medialivechanneldestinationsnew) constructor.\n  - `encoder_settings` (`list[obj]`):  When `null`, the `encoder_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.encoder_settings.new](#fn-medialivechannelencodersettingsnew) constructor.\n  - `input_attachments` (`list[obj]`):  When `null`, the `input_attachments` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.input_attachments.new](#fn-medialivechannelinputattachmentsnew) constructor.\n  - `input_specification` (`list[obj]`):  When `null`, the `input_specification` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.input_specification.new](#fn-medialivechannelinputspecificationnew) constructor.\n  - `maintenance` (`list[obj]`):  When `null`, the `maintenance` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.maintenance.new](#fn-medialivechannelmaintenancenew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.timeouts.new](#fn-medialivechanneltimeoutsnew) constructor.\n  - `vpc` (`list[obj]`):  When `null`, the `vpc` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.medialive_channel.vpc.new](#fn-medialivechannelvpcnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    channel_class,
    name,
  ...
  '#withCdiInputSpecification':: d.fn(help='`aws.medialive_channel.withCdiInputSpecification` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the cdi_input_specification field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cdi_input_specification` field.\n', args=[]),
  ...
  '#withCdiInputSpecificationMixin':: d.fn(help='`aws.medialive_channel.withCdiInputSpecificationMixin` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the cdi_input_specification field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.medialive_channel.withCdiInputSpecification](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cdi_input_specification` field.\n', args=[]),
  ...
  '#withChannelClass':: d.fn(help='`aws.medialive_channel.withChannelClass` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the channel_class field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `channel_class` field.\n', args=[]),
  ...
  '#withDestinations':: d.fn(help='`aws.medialive_channel.withDestinations` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the destinations field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destinations` field.\n', args=[]),
  ...
  '#withDestinationsMixin':: d.fn(help='`aws.medialive_channel.withDestinationsMixin` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the destinations field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.medialive_channel.withDestinations](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destinations` field.\n', args=[]),
  ...
  '#withEncoderSettings':: d.fn(help='`aws.medialive_channel.withEncoderSettings` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the encoder_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encoder_settings` field.\n', args=[]),
  ...
  '#withEncoderSettingsMixin':: d.fn(help='`aws.medialive_channel.withEncoderSettingsMixin` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the encoder_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.medialive_channel.withEncoderSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encoder_settings` field.\n', args=[]),
  ...
  '#withInputAttachments':: d.fn(help='`aws.medialive_channel.withInputAttachments` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the input_attachments field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `input_attachments` field.\n', args=[]),
  ...
  '#withInputAttachmentsMixin':: d.fn(help='`aws.medialive_channel.withInputAttachmentsMixin` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the input_attachments field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.medialive_channel.withInputAttachments](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `input_attachments` field.\n', args=[]),
  ...
  '#withInputSpecification':: d.fn(help='`aws.medialive_channel.withInputSpecification` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the input_specification field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `input_specification` field.\n', args=[]),
  ...
  '#withInputSpecificationMixin':: d.fn(help='`aws.medialive_channel.withInputSpecificationMixin` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the input_specification field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.medialive_channel.withInputSpecification](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `input_specification` field.\n', args=[]),
  ...
  '#withLogLevel':: d.fn(help='`aws.medialive_channel.withLogLevel` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the log_level field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `log_level` field.\n', args=[]),
  ...
  '#withMaintenance':: d.fn(help='`aws.medialive_channel.withMaintenance` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the maintenance field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `maintenance` field.\n', args=[]),
  ...
  '#withMaintenanceMixin':: d.fn(help='`aws.medialive_channel.withMaintenanceMixin` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the maintenance field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.medialive_channel.withMaintenance](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `maintenance` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.medialive_channel.withName` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.medialive_channel.withRoleArn` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
  ...
  '#withStartChannel':: d.fn(help='`aws.medialive_channel.withStartChannel` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the start_channel field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `start_channel` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.medialive_channel.withTags` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.medialive_channel.withTagsAll` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.medialive_channel.withTimeouts` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.medialive_channel.withTimeoutsMixin` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.medialive_channel.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpc':: d.fn(help='`aws.medialive_channel.withVpc` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the vpc field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc` field.\n', args=[]),
  ...
  '#withVpcMixin':: d.fn(help='`aws.medialive_channel.withVpcMixin` constructs a mixin object that can be merged into the `medialive_channel`\nTerraform resource block to set or update the vpc field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.medialive_channel.withVpc](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc` field.\n', args=[]),
