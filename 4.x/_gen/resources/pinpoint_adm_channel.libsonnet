...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationId':: d.fn(help='`aws.pinpoint_adm_channel.withApplicationId` constructs a mixin object that can be merged into the `pinpoint_adm_channel`\nTerraform resource block to set or update the application_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_id` field.\n', args=[]),
  ...
  '#withClientId':: d.fn(help='`aws.pinpoint_adm_channel.withClientId` constructs a mixin object that can be merged into the `pinpoint_adm_channel`\nTerraform resource block to set or update the client_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_id` field.\n', args=[]),
  ...
  '#withClientSecret':: d.fn(help='`aws.pinpoint_adm_channel.withClientSecret` constructs a mixin object that can be merged into the `pinpoint_adm_channel`\nTerraform resource block to set or update the client_secret field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_secret` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`aws.pinpoint_adm_channel.withEnabled` constructs a mixin object that can be merged into the `pinpoint_adm_channel`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
