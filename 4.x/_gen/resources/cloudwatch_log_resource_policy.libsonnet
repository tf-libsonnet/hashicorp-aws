...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPolicyDocument':: d.fn(help='`aws.cloudwatch_log_resource_policy.withPolicyDocument` constructs a mixin object that can be merged into the `cloudwatch_log_resource_policy`\nTerraform resource block to set or update the policy_document field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_document` field.\n', args=[]),
  ...
  '#withPolicyName':: d.fn(help='`aws.cloudwatch_log_resource_policy.withPolicyName` constructs a mixin object that can be merged into the `cloudwatch_log_resource_policy`\nTerraform resource block to set or update the policy_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_name` field.\n', args=[]),
