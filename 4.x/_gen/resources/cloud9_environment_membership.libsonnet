...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnvironmentId':: d.fn(help='`aws.cloud9_environment_membership.withEnvironmentId` constructs a mixin object that can be merged into the `cloud9_environment_membership`\nTerraform resource block to set or update the environment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `environment_id` field.\n', args=[]),
  ...
  '#withPermissions':: d.fn(help='`aws.cloud9_environment_membership.withPermissions` constructs a mixin object that can be merged into the `cloud9_environment_membership`\nTerraform resource block to set or update the permissions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permissions` field.\n', args=[]),
  ...
  '#withUserArn':: d.fn(help='`aws.cloud9_environment_membership.withUserArn` constructs a mixin object that can be merged into the `cloud9_environment_membership`\nTerraform resource block to set or update the user_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_arn` field.\n', args=[]),
