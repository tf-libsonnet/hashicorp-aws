...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPolicy':: d.fn(help='`aws.sqs_queue_policy.withPolicy` constructs a mixin object that can be merged into the `sqs_queue_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withQueueUrl':: d.fn(help='`aws.sqs_queue_policy.withQueueUrl` constructs a mixin object that can be merged into the `sqs_queue_policy`\nTerraform resource block to set or update the queue_url field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `queue_url` field.\n', args=[]),
