...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterArn':: d.fn(help='`aws.msk_scram_secret_association.withClusterArn` constructs a mixin object that can be merged into the `msk_scram_secret_association`\nTerraform resource block to set or update the cluster_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_arn` field.\n', args=[]),
  ...
  '#withSecretArnList':: d.fn(help='`aws.msk_scram_secret_association.withSecretArnList` constructs a mixin object that can be merged into the `msk_scram_secret_association`\nTerraform resource block to set or update the secret_arn_list field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret_arn_list` field.\n', args=[]),
