...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCookieName':: d.fn(help='`aws.app_cookie_stickiness_policy.withCookieName` constructs a mixin object that can be merged into the `app_cookie_stickiness_policy`\nTerraform resource block to set or update the cookie_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cookie_name` field.\n', args=[]),
  ...
  '#withLbPort':: d.fn(help='`aws.app_cookie_stickiness_policy.withLbPort` constructs a mixin object that can be merged into the `app_cookie_stickiness_policy`\nTerraform resource block to set or update the lb_port field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lb_port` field.\n', args=[]),
  ...
  '#withLoadBalancer':: d.fn(help='`aws.app_cookie_stickiness_policy.withLoadBalancer` constructs a mixin object that can be merged into the `app_cookie_stickiness_policy`\nTerraform resource block to set or update the load_balancer field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load_balancer` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.app_cookie_stickiness_policy.withName` constructs a mixin object that can be merged into the `app_cookie_stickiness_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
