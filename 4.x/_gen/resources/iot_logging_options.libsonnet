...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDefaultLogLevel':: d.fn(help='`aws.iot_logging_options.withDefaultLogLevel` constructs a mixin object that can be merged into the `iot_logging_options`\nTerraform resource block to set or update the default_log_level field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_log_level` field.\n', args=[]),
  ...
  '#withDisableAllLogs':: d.fn(help='`aws.iot_logging_options.withDisableAllLogs` constructs a mixin object that can be merged into the `iot_logging_options`\nTerraform resource block to set or update the disable_all_logs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disable_all_logs` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.iot_logging_options.withRoleArn` constructs a mixin object that can be merged into the `iot_logging_options`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
