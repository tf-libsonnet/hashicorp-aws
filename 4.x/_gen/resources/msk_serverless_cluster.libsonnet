...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  client_authentication:: {
    '#new':: d.fn(help='\n`aws.msk_serverless_cluster.client_authentication.new` constructs a new object with attributes and blocks configured for the `client_authentication`\nTerraform sub block.\n\n\n\n**Args**:\n  - `sasl` (`list[obj]`):  When `null`, the `sasl` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_serverless_cluster.client_authentication.sasl.new](#fn-clientauthenticationsaslnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `client_authentication` sub block.\n', args=[]),
    new(
      sasl=null
    ):: std.prune(a={
      sasl: sasl,
  ...
  '#withClientAuthentication':: d.fn(help='`aws.msk_serverless_cluster.withClientAuthentication` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the client_authentication field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_authentication` field.\n', args=[]),
  ...
  '#withClientAuthenticationMixin':: d.fn(help='`aws.msk_serverless_cluster.withClientAuthenticationMixin` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the client_authentication field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.msk_serverless_cluster.withClientAuthentication](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_authentication` field.\n', args=[]),
  ...
  '#withClusterName':: d.fn(help='`aws.msk_serverless_cluster.withClusterName` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the cluster_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.msk_serverless_cluster.withTags` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.msk_serverless_cluster.withTagsAll` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.msk_serverless_cluster.withTimeouts` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.msk_serverless_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.msk_serverless_cluster.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpcConfig':: d.fn(help='`aws.msk_serverless_cluster.withVpcConfig` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the vpc_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_config` field.\n', args=[]),
  ...
  '#withVpcConfigMixin':: d.fn(help='`aws.msk_serverless_cluster.withVpcConfigMixin` constructs a mixin object that can be merged into the `msk_serverless_cluster`\nTerraform resource block to set or update the vpc_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.msk_serverless_cluster.withVpcConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_config` field.\n', args=[]),
