...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplication':: d.fn(help='`aws.elastic_beanstalk_configuration_template.withApplication` constructs a mixin object that can be merged into the `elastic_beanstalk_configuration_template`\nTerraform resource block to set or update the application field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.elastic_beanstalk_configuration_template.withDescription` constructs a mixin object that can be merged into the `elastic_beanstalk_configuration_template`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEnvironmentId':: d.fn(help='`aws.elastic_beanstalk_configuration_template.withEnvironmentId` constructs a mixin object that can be merged into the `elastic_beanstalk_configuration_template`\nTerraform resource block to set or update the environment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `environment_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.elastic_beanstalk_configuration_template.withName` constructs a mixin object that can be merged into the `elastic_beanstalk_configuration_template`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSetting':: d.fn(help='`aws.elastic_beanstalk_configuration_template.withSetting` constructs a mixin object that can be merged into the `elastic_beanstalk_configuration_template`\nTerraform resource block to set or update the setting field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `setting` field.\n', args=[]),
  ...
  '#withSettingMixin':: d.fn(help='`aws.elastic_beanstalk_configuration_template.withSettingMixin` constructs a mixin object that can be merged into the `elastic_beanstalk_configuration_template`\nTerraform resource block to set or update the setting field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.elastic_beanstalk_configuration_template.withSetting](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `setting` field.\n', args=[]),
  ...
  '#withSolutionStackName':: d.fn(help='`aws.elastic_beanstalk_configuration_template.withSolutionStackName` constructs a mixin object that can be merged into the `elastic_beanstalk_configuration_template`\nTerraform resource block to set or update the solution_stack_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `solution_stack_name` field.\n', args=[]),
