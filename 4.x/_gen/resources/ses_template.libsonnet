...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.ses_template.withName` constructs a mixin object that can be merged into the `ses_template`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSubject':: d.fn(help='`aws.ses_template.withSubject` constructs a mixin object that can be merged into the `ses_template`\nTerraform resource block to set or update the subject field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subject` field.\n', args=[]),
  ...
  '#withText':: d.fn(help='`aws.ses_template.withText` constructs a mixin object that can be merged into the `ses_template`\nTerraform resource block to set or update the text field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `text` field.\n', args=[]),
