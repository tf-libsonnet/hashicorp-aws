...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAlias':: d.fn(help='`aws.iot_role_alias.withAlias` constructs a mixin object that can be merged into the `iot_role_alias`\nTerraform resource block to set or update the alias field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `alias` field.\n', args=[]),
  ...
  '#withCredentialDuration':: d.fn(help='`aws.iot_role_alias.withCredentialDuration` constructs a mixin object that can be merged into the `iot_role_alias`\nTerraform resource block to set or update the credential_duration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `credential_duration` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.iot_role_alias.withRoleArn` constructs a mixin object that can be merged into the `iot_role_alias`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
