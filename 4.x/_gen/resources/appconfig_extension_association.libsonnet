...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withExtensionArn':: d.fn(help='`aws.appconfig_extension_association.withExtensionArn` constructs a mixin object that can be merged into the `appconfig_extension_association`\nTerraform resource block to set or update the extension_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `extension_arn` field.\n', args=[]),
  ...
  '#withParameters':: d.fn(help='`aws.appconfig_extension_association.withParameters` constructs a mixin object that can be merged into the `appconfig_extension_association`\nTerraform resource block to set or update the parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters` field.\n', args=[]),
  ...
  '#withResourceArn':: d.fn(help='`aws.appconfig_extension_association.withResourceArn` constructs a mixin object that can be merged into the `appconfig_extension_association`\nTerraform resource block to set or update the resource_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_arn` field.\n', args=[]),
