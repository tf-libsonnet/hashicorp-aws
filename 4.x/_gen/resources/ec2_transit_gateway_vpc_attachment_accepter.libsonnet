...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withTags':: d.fn(help='`aws.ec2_transit_gateway_vpc_attachment_accepter.withTags` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ec2_transit_gateway_vpc_attachment_accepter.withTagsAll` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTransitGatewayAttachmentId':: d.fn(help='`aws.ec2_transit_gateway_vpc_attachment_accepter.withTransitGatewayAttachmentId` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`\nTerraform resource block to set or update the transit_gateway_attachment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_attachment_id` field.\n', args=[]),
  ...
  '#withTransitGatewayDefaultRouteTableAssociation':: d.fn(help='`aws.ec2_transit_gateway_vpc_attachment_accepter.withTransitGatewayDefaultRouteTableAssociation` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`\nTerraform resource block to set or update the transit_gateway_default_route_table_association field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_default_route_table_association` field.\n', args=[]),
  ...
  '#withTransitGatewayDefaultRouteTablePropagation':: d.fn(help='`aws.ec2_transit_gateway_vpc_attachment_accepter.withTransitGatewayDefaultRouteTablePropagation` constructs a mixin object that can be merged into the `ec2_transit_gateway_vpc_attachment_accepter`\nTerraform resource block to set or update the transit_gateway_default_route_table_propagation field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_default_route_table_propagation` field.\n', args=[]),
