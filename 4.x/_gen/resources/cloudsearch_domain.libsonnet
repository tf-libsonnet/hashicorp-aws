...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.cloudsearch_domain.new` injects a new `aws_cloudsearch_domain` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.cloudsearch_domain.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.cloudsearch_domain` using the reference:\n\n    $._ref.aws_cloudsearch_domain.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_cloudsearch_domain.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `multi_az` (`bool`):  When `null`, the `multi_az` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `endpoint_options` (`list[obj]`):  When `null`, the `endpoint_options` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.cloudsearch_domain.endpoint_options.new](#fn-cloudsearchdomainendpointoptionsnew) constructor.\n  - `index_field` (`list[obj]`):  When `null`, the `index_field` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.cloudsearch_domain.index_field.new](#fn-cloudsearchdomainindexfieldnew) constructor.\n  - `scaling_parameters` (`list[obj]`):  When `null`, the `scaling_parameters` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.cloudsearch_domain.scaling_parameters.new](#fn-cloudsearchdomainscalingparametersnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.cloudsearch_domain.timeouts.new](#fn-cloudsearchdomaintimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    name,
  ...
  '#withEndpointOptions':: d.fn(help='`aws.cloudsearch_domain.withEndpointOptions` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the endpoint_options field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_options` field.\n', args=[]),
  ...
  '#withEndpointOptionsMixin':: d.fn(help='`aws.cloudsearch_domain.withEndpointOptionsMixin` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the endpoint_options field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudsearch_domain.withEndpointOptions](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_options` field.\n', args=[]),
  ...
  '#withIndexField':: d.fn(help='`aws.cloudsearch_domain.withIndexField` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the index_field field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `index_field` field.\n', args=[]),
  ...
  '#withIndexFieldMixin':: d.fn(help='`aws.cloudsearch_domain.withIndexFieldMixin` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the index_field field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudsearch_domain.withIndexField](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `index_field` field.\n', args=[]),
  ...
  '#withMultiAz':: d.fn(help='`aws.cloudsearch_domain.withMultiAz` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the multi_az field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `multi_az` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudsearch_domain.withName` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScalingParameters':: d.fn(help='`aws.cloudsearch_domain.withScalingParameters` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the scaling_parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scaling_parameters` field.\n', args=[]),
  ...
  '#withScalingParametersMixin':: d.fn(help='`aws.cloudsearch_domain.withScalingParametersMixin` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the scaling_parameters field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudsearch_domain.withScalingParameters](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scaling_parameters` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.cloudsearch_domain.withTimeouts` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.cloudsearch_domain.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudsearch_domain`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.cloudsearch_domain.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
