...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.api_gateway_deployment.withDescription` constructs a mixin object that can be merged into the `api_gateway_deployment`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withRestApiId':: d.fn(help='`aws.api_gateway_deployment.withRestApiId` constructs a mixin object that can be merged into the `api_gateway_deployment`\nTerraform resource block to set or update the rest_api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rest_api_id` field.\n', args=[]),
  ...
  '#withStageDescription':: d.fn(help='`aws.api_gateway_deployment.withStageDescription` constructs a mixin object that can be merged into the `api_gateway_deployment`\nTerraform resource block to set or update the stage_description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage_description` field.\n', args=[]),
  ...
  '#withStageName':: d.fn(help='`aws.api_gateway_deployment.withStageName` constructs a mixin object that can be merged into the `api_gateway_deployment`\nTerraform resource block to set or update the stage_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage_name` field.\n', args=[]),
  ...
  '#withTriggers':: d.fn(help='`aws.api_gateway_deployment.withTriggers` constructs a mixin object that can be merged into the `api_gateway_deployment`\nTerraform resource block to set or update the triggers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `triggers` field.\n', args=[]),
  ...
  '#withVariables':: d.fn(help='`aws.api_gateway_deployment.withVariables` constructs a mixin object that can be merged into the `api_gateway_deployment`\nTerraform resource block to set or update the variables field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `variables` field.\n', args=[]),
