...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIncludeLinkedAccountsMetrics':: d.fn(help='`aws.bool.withIncludeLinkedAccountsMetrics` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the include_linked_accounts_metrics field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `include_linked_accounts_metrics` field.\n', args=[]),
  withIncludeLinkedAccountsMetrics(resourceLabel, value): {
    resource+: {
      aws_cloudwatch_metric_stream+: {
        [resourceLabel]+: {
