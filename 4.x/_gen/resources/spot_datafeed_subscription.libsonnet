...
{
  '#':: d.pkg(name='spot_datafeed_subscription', url='', help='`spot_datafeed_subscription` represents the `aws_spot_datafeed_subscription` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBucket':: d.fn(help='`aws.spot_datafeed_subscription.withBucket` constructs a mixin object that can be merged into the `spot_datafeed_subscription`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withPrefix':: d.fn(help='`aws.spot_datafeed_subscription.withPrefix` constructs a mixin object that can be merged into the `spot_datafeed_subscription`\nTerraform resource block to set or update the prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `prefix` field.\n', args=[]),
