...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterArn':: d.fn(help='`aws.route53recoverycontrolconfig_routing_control.withClusterArn` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_routing_control`\nTerraform resource block to set or update the cluster_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_arn` field.\n', args=[]),
  ...
  '#withControlPanelArn':: d.fn(help='`aws.route53recoverycontrolconfig_routing_control.withControlPanelArn` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_routing_control`\nTerraform resource block to set or update the control_panel_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `control_panel_arn` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.route53recoverycontrolconfig_routing_control.withName` constructs a mixin object that can be merged into the `route53recoverycontrolconfig_routing_control`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
