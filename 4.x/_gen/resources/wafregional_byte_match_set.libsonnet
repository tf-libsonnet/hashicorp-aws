...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withByteMatchTuples':: d.fn(help='`aws.wafregional_byte_match_set.withByteMatchTuples` constructs a mixin object that can be merged into the `wafregional_byte_match_set`\nTerraform resource block to set or update the byte_match_tuples field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `byte_match_tuples` field.\n', args=[]),
  ...
  '#withByteMatchTuplesMixin':: d.fn(help='`aws.wafregional_byte_match_set.withByteMatchTuplesMixin` constructs a mixin object that can be merged into the `wafregional_byte_match_set`\nTerraform resource block to set or update the byte_match_tuples field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.wafregional_byte_match_set.withByteMatchTuples](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `byte_match_tuples` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.wafregional_byte_match_set.withName` constructs a mixin object that can be merged into the `wafregional_byte_match_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
