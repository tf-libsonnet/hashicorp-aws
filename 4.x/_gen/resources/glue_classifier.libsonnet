...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.glue_classifier.new` injects a new `aws_glue_classifier` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.glue_classifier.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.glue_classifier` using the reference:\n\n    $._ref.aws_glue_classifier.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_glue_classifier.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `name` (`string`): \n  - `csv_classifier` (`list[obj]`):  When `null`, the `csv_classifier` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_classifier.csv_classifier.new](#fn-glue_classifiercsv_classifiernew) constructor.\n  - `grok_classifier` (`list[obj]`):  When `null`, the `grok_classifier` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_classifier.grok_classifier.new](#fn-glue_classifiergrok_classifiernew) constructor.\n  - `json_classifier` (`list[obj]`):  When `null`, the `json_classifier` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_classifier.json_classifier.new](#fn-glue_classifierjson_classifiernew) constructor.\n  - `xml_classifier` (`list[obj]`):  When `null`, the `xml_classifier` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.glue_classifier.xml_classifier.new](#fn-glue_classifierxml_classifiernew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    name,
    csv_classifier=null,
