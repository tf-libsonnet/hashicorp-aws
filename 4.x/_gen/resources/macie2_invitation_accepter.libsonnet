...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAdministratorAccountId':: d.fn(help='`aws.macie2_invitation_accepter.withAdministratorAccountId` constructs a mixin object that can be merged into the `macie2_invitation_accepter`\nTerraform resource block to set or update the administrator_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `administrator_account_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.macie2_invitation_accepter.withTimeouts` constructs a mixin object that can be merged into the `macie2_invitation_accepter`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.macie2_invitation_accepter.withTimeoutsMixin` constructs a mixin object that can be merged into the `macie2_invitation_accepter`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.macie2_invitation_accepter.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
