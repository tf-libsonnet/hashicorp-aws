...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterId':: d.fn(help='`aws.emr_managed_scaling_policy.withClusterId` constructs a mixin object that can be merged into the `emr_managed_scaling_policy`\nTerraform resource block to set or update the cluster_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_id` field.\n', args=[]),
  ...
  '#withComputeLimits':: d.fn(help='`aws.emr_managed_scaling_policy.withComputeLimits` constructs a mixin object that can be merged into the `emr_managed_scaling_policy`\nTerraform resource block to set or update the compute_limits field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `compute_limits` field.\n', args=[]),
  ...
  '#withComputeLimitsMixin':: d.fn(help='`aws.emr_managed_scaling_policy.withComputeLimitsMixin` constructs a mixin object that can be merged into the `emr_managed_scaling_policy`\nTerraform resource block to set or update the compute_limits field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.emr_managed_scaling_policy.withComputeLimits](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `compute_limits` field.\n', args=[]),
