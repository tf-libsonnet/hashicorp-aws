...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`aws.ami_launch_permission.withAccountId` constructs a mixin object that can be merged into the `ami_launch_permission`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withGroup':: d.fn(help='`aws.ami_launch_permission.withGroup` constructs a mixin object that can be merged into the `ami_launch_permission`\nTerraform resource block to set or update the group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group` field.\n', args=[]),
  ...
  '#withImageId':: d.fn(help='`aws.ami_launch_permission.withImageId` constructs a mixin object that can be merged into the `ami_launch_permission`\nTerraform resource block to set or update the image_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `image_id` field.\n', args=[]),
  ...
  '#withOrganizationArn':: d.fn(help='`aws.ami_launch_permission.withOrganizationArn` constructs a mixin object that can be merged into the `ami_launch_permission`\nTerraform resource block to set or update the organization_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organization_arn` field.\n', args=[]),
  ...
  '#withOrganizationalUnitArn':: d.fn(help='`aws.ami_launch_permission.withOrganizationalUnitArn` constructs a mixin object that can be merged into the `ami_launch_permission`\nTerraform resource block to set or update the organizational_unit_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organizational_unit_arn` field.\n', args=[]),
