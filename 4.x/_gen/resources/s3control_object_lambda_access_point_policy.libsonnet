...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`aws.s3control_object_lambda_access_point_policy.withAccountId` constructs a mixin object that can be merged into the `s3control_object_lambda_access_point_policy`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.s3control_object_lambda_access_point_policy.withName` constructs a mixin object that can be merged into the `s3control_object_lambda_access_point_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.s3control_object_lambda_access_point_policy.withPolicy` constructs a mixin object that can be merged into the `s3control_object_lambda_access_point_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
