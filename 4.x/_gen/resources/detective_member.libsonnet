...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`aws.detective_member.withAccountId` constructs a mixin object that can be merged into the `detective_member`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withDisableEmailNotification':: d.fn(help='`aws.detective_member.withDisableEmailNotification` constructs a mixin object that can be merged into the `detective_member`\nTerraform resource block to set or update the disable_email_notification field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disable_email_notification` field.\n', args=[]),
  ...
  '#withEmailAddress':: d.fn(help='`aws.detective_member.withEmailAddress` constructs a mixin object that can be merged into the `detective_member`\nTerraform resource block to set or update the email_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `email_address` field.\n', args=[]),
  ...
  '#withGraphArn':: d.fn(help='`aws.detective_member.withGraphArn` constructs a mixin object that can be merged into the `detective_member`\nTerraform resource block to set or update the graph_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `graph_arn` field.\n', args=[]),
  ...
  '#withMessage':: d.fn(help='`aws.detective_member.withMessage` constructs a mixin object that can be merged into the `detective_member`\nTerraform resource block to set or update the message field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `message` field.\n', args=[]),
