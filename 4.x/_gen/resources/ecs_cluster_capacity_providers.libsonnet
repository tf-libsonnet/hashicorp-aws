...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCapacityProviders':: d.fn(help='`aws.ecs_cluster_capacity_providers.withCapacityProviders` constructs a mixin object that can be merged into the `ecs_cluster_capacity_providers`\nTerraform resource block to set or update the capacity_providers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `capacity_providers` field.\n', args=[]),
  ...
  '#withClusterName':: d.fn(help='`aws.ecs_cluster_capacity_providers.withClusterName` constructs a mixin object that can be merged into the `ecs_cluster_capacity_providers`\nTerraform resource block to set or update the cluster_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_name` field.\n', args=[]),
  ...
  '#withDefaultCapacityProviderStrategy':: d.fn(help='`aws.ecs_cluster_capacity_providers.withDefaultCapacityProviderStrategy` constructs a mixin object that can be merged into the `ecs_cluster_capacity_providers`\nTerraform resource block to set or update the default_capacity_provider_strategy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_capacity_provider_strategy` field.\n', args=[]),
  ...
  '#withDefaultCapacityProviderStrategyMixin':: d.fn(help='`aws.ecs_cluster_capacity_providers.withDefaultCapacityProviderStrategyMixin` constructs a mixin object that can be merged into the `ecs_cluster_capacity_providers`\nTerraform resource block to set or update the default_capacity_provider_strategy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ecs_cluster_capacity_providers.withDefaultCapacityProviderStrategy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_capacity_provider_strategy` field.\n', args=[]),
