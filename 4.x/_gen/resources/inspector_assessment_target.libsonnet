...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.inspector_assessment_target.withName` constructs a mixin object that can be merged into the `inspector_assessment_target`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupArn':: d.fn(help='`aws.inspector_assessment_target.withResourceGroupArn` constructs a mixin object that can be merged into the `inspector_assessment_target`\nTerraform resource block to set or update the resource_group_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_arn` field.\n', args=[]),
