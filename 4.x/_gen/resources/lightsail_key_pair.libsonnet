...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.lightsail_key_pair.withName` constructs a mixin object that can be merged into the `lightsail_key_pair`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`aws.lightsail_key_pair.withNamePrefix` constructs a mixin object that can be merged into the `lightsail_key_pair`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withPgpKey':: d.fn(help='`aws.lightsail_key_pair.withPgpKey` constructs a mixin object that can be merged into the `lightsail_key_pair`\nTerraform resource block to set or update the pgp_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `pgp_key` field.\n', args=[]),
  ...
  '#withPublicKey':: d.fn(help='`aws.lightsail_key_pair.withPublicKey` constructs a mixin object that can be merged into the `lightsail_key_pair`\nTerraform resource block to set or update the public_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_key` field.\n', args=[]),
