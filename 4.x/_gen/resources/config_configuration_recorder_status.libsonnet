...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIsEnabled':: d.fn(help='`aws.config_configuration_recorder_status.withIsEnabled` constructs a mixin object that can be merged into the `config_configuration_recorder_status`\nTerraform resource block to set or update the is_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `is_enabled` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.config_configuration_recorder_status.withName` constructs a mixin object that can be merged into the `config_configuration_recorder_status`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
