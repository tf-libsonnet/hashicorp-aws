...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.signer_signing_profile.withName` constructs a mixin object that can be merged into the `signer_signing_profile`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`aws.signer_signing_profile.withNamePrefix` constructs a mixin object that can be merged into the `signer_signing_profile`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withPlatformId':: d.fn(help='`aws.signer_signing_profile.withPlatformId` constructs a mixin object that can be merged into the `signer_signing_profile`\nTerraform resource block to set or update the platform_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `platform_id` field.\n', args=[]),
  ...
  '#withSignatureValidityPeriod':: d.fn(help='`aws.signer_signing_profile.withSignatureValidityPeriod` constructs a mixin object that can be merged into the `signer_signing_profile`\nTerraform resource block to set or update the signature_validity_period field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `signature_validity_period` field.\n', args=[]),
  ...
  '#withSignatureValidityPeriodMixin':: d.fn(help='`aws.signer_signing_profile.withSignatureValidityPeriodMixin` constructs a mixin object that can be merged into the `signer_signing_profile`\nTerraform resource block to set or update the signature_validity_period field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.signer_signing_profile.withSignatureValidityPeriod](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `signature_validity_period` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.signer_signing_profile.withTags` constructs a mixin object that can be merged into the `signer_signing_profile`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.signer_signing_profile.withTagsAll` constructs a mixin object that can be merged into the `signer_signing_profile`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
