...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIdentity':: d.fn(help='`aws.ses_identity_notification_topic.withIdentity` constructs a mixin object that can be merged into the `ses_identity_notification_topic`\nTerraform resource block to set or update the identity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity` field.\n', args=[]),
  ...
  '#withIncludeOriginalHeaders':: d.fn(help='`aws.ses_identity_notification_topic.withIncludeOriginalHeaders` constructs a mixin object that can be merged into the `ses_identity_notification_topic`\nTerraform resource block to set or update the include_original_headers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_original_headers` field.\n', args=[]),
  ...
  '#withNotificationType':: d.fn(help='`aws.ses_identity_notification_topic.withNotificationType` constructs a mixin object that can be merged into the `ses_identity_notification_topic`\nTerraform resource block to set or update the notification_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `notification_type` field.\n', args=[]),
  ...
  '#withTopicArn':: d.fn(help='`aws.ses_identity_notification_topic.withTopicArn` constructs a mixin object that can be merged into the `ses_identity_notification_topic`\nTerraform resource block to set or update the topic_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `topic_arn` field.\n', args=[]),
