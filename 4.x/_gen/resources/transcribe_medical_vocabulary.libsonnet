...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLanguageCode':: d.fn(help='`aws.transcribe_medical_vocabulary.withLanguageCode` constructs a mixin object that can be merged into the `transcribe_medical_vocabulary`\nTerraform resource block to set or update the language_code field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `language_code` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.transcribe_medical_vocabulary.withTags` constructs a mixin object that can be merged into the `transcribe_medical_vocabulary`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.transcribe_medical_vocabulary.withTagsAll` constructs a mixin object that can be merged into the `transcribe_medical_vocabulary`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.transcribe_medical_vocabulary.withTimeouts` constructs a mixin object that can be merged into the `transcribe_medical_vocabulary`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.transcribe_medical_vocabulary.withTimeoutsMixin` constructs a mixin object that can be merged into the `transcribe_medical_vocabulary`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.transcribe_medical_vocabulary.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVocabularyFileUri':: d.fn(help='`aws.transcribe_medical_vocabulary.withVocabularyFileUri` constructs a mixin object that can be merged into the `transcribe_medical_vocabulary`\nTerraform resource block to set or update the vocabulary_file_uri field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vocabulary_file_uri` field.\n', args=[]),
  ...
  '#withVocabularyName':: d.fn(help='`aws.transcribe_medical_vocabulary.withVocabularyName` constructs a mixin object that can be merged into the `transcribe_medical_vocabulary`\nTerraform resource block to set or update the vocabulary_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vocabulary_name` field.\n', args=[]),
