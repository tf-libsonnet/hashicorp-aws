...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.mskconnect_worker_configuration.withDescription` constructs a mixin object that can be merged into the `mskconnect_worker_configuration`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.mskconnect_worker_configuration.withName` constructs a mixin object that can be merged into the `mskconnect_worker_configuration`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPropertiesFileContent':: d.fn(help='`aws.mskconnect_worker_configuration.withPropertiesFileContent` constructs a mixin object that can be merged into the `mskconnect_worker_configuration`\nTerraform resource block to set or update the properties_file_content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `properties_file_content` field.\n', args=[]),
