...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConnectivityType':: d.fn(help='`aws.nat_gateway.withConnectivityType` constructs a mixin object that can be merged into the `nat_gateway`\nTerraform resource block to set or update the connectivity_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connectivity_type` field.\n', args=[]),
  ...
  '#withPrivateIp':: d.fn(help='`aws.nat_gateway.withPrivateIp` constructs a mixin object that can be merged into the `nat_gateway`\nTerraform resource block to set or update the private_ip field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_ip` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.nat_gateway.withTagsAll` constructs a mixin object that can be merged into the `nat_gateway`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
