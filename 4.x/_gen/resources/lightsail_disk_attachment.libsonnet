...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDiskName':: d.fn(help='`aws.lightsail_disk_attachment.withDiskName` constructs a mixin object that can be merged into the `lightsail_disk_attachment`\nTerraform resource block to set or update the disk_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_name` field.\n', args=[]),
  ...
  '#withDiskPath':: d.fn(help='`aws.lightsail_disk_attachment.withDiskPath` constructs a mixin object that can be merged into the `lightsail_disk_attachment`\nTerraform resource block to set or update the disk_path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_path` field.\n', args=[]),
  ...
  '#withInstanceName':: d.fn(help='`aws.lightsail_disk_attachment.withInstanceName` constructs a mixin object that can be merged into the `lightsail_disk_attachment`\nTerraform resource block to set or update the instance_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_name` field.\n', args=[]),
