...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.organizations_organizational_unit.withName` constructs a mixin object that can be merged into the `organizations_organizational_unit`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withParentId':: d.fn(help='`aws.organizations_organizational_unit.withParentId` constructs a mixin object that can be merged into the `organizations_organizational_unit`\nTerraform resource block to set or update the parent_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent_id` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.organizations_organizational_unit.withTags` constructs a mixin object that can be merged into the `organizations_organizational_unit`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.organizations_organizational_unit.withTagsAll` constructs a mixin object that can be merged into the `organizations_organizational_unit`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
