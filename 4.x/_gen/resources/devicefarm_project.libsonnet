...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDefaultJobTimeoutMinutes':: d.fn(help='`aws.devicefarm_project.withDefaultJobTimeoutMinutes` constructs a mixin object that can be merged into the `devicefarm_project`\nTerraform resource block to set or update the default_job_timeout_minutes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_job_timeout_minutes` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.devicefarm_project.withName` constructs a mixin object that can be merged into the `devicefarm_project`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.devicefarm_project.withTags` constructs a mixin object that can be merged into the `devicefarm_project`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.devicefarm_project.withTagsAll` constructs a mixin object that can be merged into the `devicefarm_project`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
