...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDefaultJobTimeoutMinutes':: d.fn(help='`aws.number.withDefaultJobTimeoutMinutes` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the default_job_timeout_minutes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `default_job_timeout_minutes` field.\n', args=[]),
