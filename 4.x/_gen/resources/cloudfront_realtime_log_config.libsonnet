...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEndpoint':: d.fn(help='`aws.cloudfront_realtime_log_config.withEndpoint` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`\nTerraform resource block to set or update the endpoint field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint` field.\n', args=[]),
  ...
  '#withEndpointMixin':: d.fn(help='`aws.cloudfront_realtime_log_config.withEndpointMixin` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`\nTerraform resource block to set or update the endpoint field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.cloudfront_realtime_log_config.withEndpoint](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint` field.\n', args=[]),
  ...
  '#withFields':: d.fn(help='`aws.cloudfront_realtime_log_config.withFields` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`\nTerraform resource block to set or update the fields field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fields` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudfront_realtime_log_config.withName` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSamplingRate':: d.fn(help='`aws.cloudfront_realtime_log_config.withSamplingRate` constructs a mixin object that can be merged into the `cloudfront_realtime_log_config`\nTerraform resource block to set or update the sampling_rate field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sampling_rate` field.\n', args=[]),
