...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.waf_regex_pattern_set.withName` constructs a mixin object that can be merged into the `waf_regex_pattern_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRegexPatternStrings':: d.fn(help='`aws.waf_regex_pattern_set.withRegexPatternStrings` constructs a mixin object that can be merged into the `waf_regex_pattern_set`\nTerraform resource block to set or update the regex_pattern_strings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `regex_pattern_strings` field.\n', args=[]),
