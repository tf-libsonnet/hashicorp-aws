...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuthenticationType':: d.fn(help='`aws.appstream_user_stack_association.withAuthenticationType` constructs a mixin object that can be merged into the `appstream_user_stack_association`\nTerraform resource block to set or update the authentication_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authentication_type` field.\n', args=[]),
  ...
  '#withSendEmailNotification':: d.fn(help='`aws.appstream_user_stack_association.withSendEmailNotification` constructs a mixin object that can be merged into the `appstream_user_stack_association`\nTerraform resource block to set or update the send_email_notification field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `send_email_notification` field.\n', args=[]),
  ...
  '#withStackName':: d.fn(help='`aws.appstream_user_stack_association.withStackName` constructs a mixin object that can be merged into the `appstream_user_stack_association`\nTerraform resource block to set or update the stack_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stack_name` field.\n', args=[]),
  ...
  '#withUserName':: d.fn(help='`aws.appstream_user_stack_association.withUserName` constructs a mixin object that can be merged into the `appstream_user_stack_association`\nTerraform resource block to set or update the user_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_name` field.\n', args=[]),
