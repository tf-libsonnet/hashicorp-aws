...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCatalogData':: d.fn(help='`aws.ecrpublic_repository.withCatalogData` constructs a mixin object that can be merged into the `ecrpublic_repository`\nTerraform resource block to set or update the catalog_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `catalog_data` field.\n', args=[]),
  ...
  '#withCatalogDataMixin':: d.fn(help='`aws.ecrpublic_repository.withCatalogDataMixin` constructs a mixin object that can be merged into the `ecrpublic_repository`\nTerraform resource block to set or update the catalog_data field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ecrpublic_repository.withCatalogData](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `catalog_data` field.\n', args=[]),
  ...
  '#withForceDestroy':: d.fn(help='`aws.ecrpublic_repository.withForceDestroy` constructs a mixin object that can be merged into the `ecrpublic_repository`\nTerraform resource block to set or update the force_destroy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `force_destroy` field.\n', args=[]),
  ...
  '#withRepositoryName':: d.fn(help='`aws.ecrpublic_repository.withRepositoryName` constructs a mixin object that can be merged into the `ecrpublic_repository`\nTerraform resource block to set or update the repository_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.ecrpublic_repository.withTags` constructs a mixin object that can be merged into the `ecrpublic_repository`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ecrpublic_repository.withTagsAll` constructs a mixin object that can be merged into the `ecrpublic_repository`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.ecrpublic_repository.withTimeouts` constructs a mixin object that can be merged into the `ecrpublic_repository`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.ecrpublic_repository.withTimeoutsMixin` constructs a mixin object that can be merged into the `ecrpublic_repository`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.ecrpublic_repository.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
