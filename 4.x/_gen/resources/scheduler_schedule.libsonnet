...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  target:: {
    ...
    '#new':: d.fn(help='\n`aws.scheduler_schedule.target.new` constructs a new object with attributes and blocks configured for the `target`\nTerraform sub block.\n\n\n\n**Args**:\n  - `arn` (`string`): \n  - `input` (`string`):  When `null`, the `input` field will be omitted from the resulting object.\n  - `role_arn` (`string`): \n  - `dead_letter_config` (`list[obj]`):  When `null`, the `dead_letter_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.scheduler_schedule.target.dead_letter_config.new](#fn-targetdeadletterconfignew) constructor.\n  - `ecs_parameters` (`list[obj]`):  When `null`, the `ecs_parameters` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.scheduler_schedule.target.ecs_parameters.new](#fn-targetecsparametersnew) constructor.\n  - `eventbridge_parameters` (`list[obj]`):  When `null`, the `eventbridge_parameters` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.scheduler_schedule.target.eventbridge_parameters.new](#fn-targeteventbridgeparametersnew) constructor.\n  - `kinesis_parameters` (`list[obj]`):  When `null`, the `kinesis_parameters` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.scheduler_schedule.target.kinesis_parameters.new](#fn-targetkinesisparametersnew) constructor.\n  - `retry_policy` (`list[obj]`):  When `null`, the `retry_policy` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.scheduler_schedule.target.retry_policy.new](#fn-targetretrypolicynew) constructor.\n  - `sagemaker_pipeline_parameters` (`list[obj]`):  When `null`, the `sagemaker_pipeline_parameters` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.scheduler_schedule.target.sagemaker_pipeline_parameters.new](#fn-targetsagemakerpipelineparametersnew) constructor.\n  - `sqs_parameters` (`list[obj]`):  When `null`, the `sqs_parameters` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.scheduler_schedule.target.sqs_parameters.new](#fn-targetsqsparametersnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `target` sub block.\n', args=[]),
    new(
      arn,
      role_arn,
  ...
  '#withDescription':: d.fn(help='`aws.scheduler_schedule.withDescription` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEndDate':: d.fn(help='`aws.scheduler_schedule.withEndDate` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the end_date field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `end_date` field.\n', args=[]),
  ...
  '#withFlexibleTimeWindow':: d.fn(help='`aws.scheduler_schedule.withFlexibleTimeWindow` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the flexible_time_window field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `flexible_time_window` field.\n', args=[]),
  ...
  '#withFlexibleTimeWindowMixin':: d.fn(help='`aws.scheduler_schedule.withFlexibleTimeWindowMixin` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the flexible_time_window field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.scheduler_schedule.withFlexibleTimeWindow](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `flexible_time_window` field.\n', args=[]),
  ...
  '#withGroupName':: d.fn(help='`aws.scheduler_schedule.withGroupName` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_name` field.\n', args=[]),
  ...
  '#withKmsKeyArn':: d.fn(help='`aws.scheduler_schedule.withKmsKeyArn` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the kms_key_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_arn` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.scheduler_schedule.withName` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`aws.scheduler_schedule.withNamePrefix` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withScheduleExpression':: d.fn(help='`aws.scheduler_schedule.withScheduleExpression` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the schedule_expression field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schedule_expression` field.\n', args=[]),
  ...
  '#withScheduleExpressionTimezone':: d.fn(help='`aws.scheduler_schedule.withScheduleExpressionTimezone` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the schedule_expression_timezone field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schedule_expression_timezone` field.\n', args=[]),
  ...
  '#withStartDate':: d.fn(help='`aws.scheduler_schedule.withStartDate` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the start_date field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `start_date` field.\n', args=[]),
  ...
  '#withState':: d.fn(help='`aws.scheduler_schedule.withState` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `state` field.\n', args=[]),
  ...
  '#withTarget':: d.fn(help='`aws.scheduler_schedule.withTarget` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the target field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target` field.\n', args=[]),
  ...
  '#withTargetMixin':: d.fn(help='`aws.scheduler_schedule.withTargetMixin` constructs a mixin object that can be merged into the `scheduler_schedule`\nTerraform resource block to set or update the target field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.scheduler_schedule.withTarget](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target` field.\n', args=[]),
