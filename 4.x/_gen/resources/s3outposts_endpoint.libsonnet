...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withOutpostId':: d.fn(help='`aws.s3outposts_endpoint.withOutpostId` constructs a mixin object that can be merged into the `s3outposts_endpoint`\nTerraform resource block to set or update the outpost_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `outpost_id` field.\n', args=[]),
  ...
  '#withSecurityGroupId':: d.fn(help='`aws.s3outposts_endpoint.withSecurityGroupId` constructs a mixin object that can be merged into the `s3outposts_endpoint`\nTerraform resource block to set or update the security_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_group_id` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`aws.s3outposts_endpoint.withSubnetId` constructs a mixin object that can be merged into the `s3outposts_endpoint`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
