...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  broker_node_group_info:: {
    ...
    '#new':: d.fn(help='\n`aws.msk_cluster.broker_node_group_info.new` constructs a new object with attributes and blocks configured for the `broker_node_group_info`\nTerraform sub block.\n\n\n\n**Args**:\n  - `az_distribution` (`string`):  When `null`, the `az_distribution` field will be omitted from the resulting object.\n  - `client_subnets` (`list`): \n  - `ebs_volume_size` (`number`):  When `null`, the `ebs_volume_size` field will be omitted from the resulting object.\n  - `instance_type` (`string`): \n  - `security_groups` (`list`): \n  - `connectivity_info` (`list[obj]`):  When `null`, the `connectivity_info` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.broker_node_group_info.connectivity_info.new](#fn-connectivity_infonew) constructor.\n  - `storage_info` (`list[obj]`):  When `null`, the `storage_info` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.broker_node_group_info.storage_info.new](#fn-storage_infonew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `broker_node_group_info` sub block.\n', args=[]),
    new(
      client_subnets,
      instance_type,
      security_groups,
  ...
  client_authentication:: {
    '#new':: d.fn(help='\n`aws.msk_cluster.client_authentication.new` constructs a new object with attributes and blocks configured for the `client_authentication`\nTerraform sub block.\n\n\n\n**Args**:\n  - `unauthenticated` (`bool`):  When `null`, the `unauthenticated` field will be omitted from the resulting object.\n  - `sasl` (`list[obj]`):  When `null`, the `sasl` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.client_authentication.sasl.new](#fn-saslnew) constructor.\n  - `tls` (`list[obj]`):  When `null`, the `tls` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.client_authentication.tls.new](#fn-tlsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `client_authentication` sub block.\n', args=[]),
    new(
      sasl=null,
      tls=null,
  ...
  logging_info:: {
    broker_logs:: {
      ...
      '#new':: d.fn(help='\n`aws.msk_cluster.logging_info.broker_logs.new` constructs a new object with attributes and blocks configured for the `broker_logs`\nTerraform sub block.\n\n\n\n**Args**:\n  - `cloudwatch_logs` (`list[obj]`):  When `null`, the `cloudwatch_logs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.logging_info.broker_logs.cloudwatch_logs.new](#fn-logging_infocloudwatch_logsnew) constructor.\n  - `firehose` (`list[obj]`):  When `null`, the `firehose` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.logging_info.broker_logs.firehose.new](#fn-logging_infofirehosenew) constructor.\n  - `s3` (`list[obj]`):  When `null`, the `s3` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.logging_info.broker_logs.s3.new](#fn-logging_infos3new) constructor.\n\n**Returns**:\n  - An attribute object that represents the `broker_logs` sub block.\n', args=[]),
      new(
    ...
    '#new':: d.fn(help='\n`aws.msk_cluster.logging_info.new` constructs a new object with attributes and blocks configured for the `logging_info`\nTerraform sub block.\n\n\n\n**Args**:\n  - `broker_logs` (`list[obj]`):  When `null`, the `broker_logs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.logging_info.broker_logs.new](#fn-broker_logsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `logging_info` sub block.\n', args=[]),
    new(
      broker_logs=null
    ):: std.prune(a={
  ...
  open_monitoring:: {
    '#new':: d.fn(help='\n`aws.msk_cluster.open_monitoring.new` constructs a new object with attributes and blocks configured for the `open_monitoring`\nTerraform sub block.\n\n\n\n**Args**:\n  - `prometheus` (`list[obj]`):  When `null`, the `prometheus` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.open_monitoring.prometheus.new](#fn-prometheusnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `open_monitoring` sub block.\n', args=[]),
    new(
      prometheus=null
    ):: std.prune(a={
    ...
    prometheus:: {
      ...
      '#new':: d.fn(help='\n`aws.msk_cluster.open_monitoring.prometheus.new` constructs a new object with attributes and blocks configured for the `prometheus`\nTerraform sub block.\n\n\n\n**Args**:\n  - `jmx_exporter` (`list[obj]`):  When `null`, the `jmx_exporter` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.open_monitoring.prometheus.jmx_exporter.new](#fn-open_monitoringjmx_exporternew) constructor.\n  - `node_exporter` (`list[obj]`):  When `null`, the `node_exporter` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.msk_cluster.open_monitoring.prometheus.node_exporter.new](#fn-open_monitoringnode_exporternew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `prometheus` sub block.\n', args=[]),
      new(
        jmx_exporter=null,
        node_exporter=null
      ):: std.prune(a={
