...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRule':: d.fn(help='`aws.ecr_registry_scanning_configuration.withRule` constructs a mixin object that can be merged into the `ecr_registry_scanning_configuration`\nTerraform resource block to set or update the rule field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rule` field.\n', args=[]),
  ...
  '#withRuleMixin':: d.fn(help='`aws.ecr_registry_scanning_configuration.withRuleMixin` constructs a mixin object that can be merged into the `ecr_registry_scanning_configuration`\nTerraform resource block to set or update the rule field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ecr_registry_scanning_configuration.withRule](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rule` field.\n', args=[]),
  ...
  '#withScanType':: d.fn(help='`aws.ecr_registry_scanning_configuration.withScanType` constructs a mixin object that can be merged into the `ecr_registry_scanning_configuration`\nTerraform resource block to set or update the scan_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scan_type` field.\n', args=[]),
