...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDestinationArn':: d.fn(help='`aws.cloudwatch_log_subscription_filter.withDestinationArn` constructs a mixin object that can be merged into the `cloudwatch_log_subscription_filter`\nTerraform resource block to set or update the destination_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_arn` field.\n', args=[]),
  ...
  '#withDistribution':: d.fn(help='`aws.cloudwatch_log_subscription_filter.withDistribution` constructs a mixin object that can be merged into the `cloudwatch_log_subscription_filter`\nTerraform resource block to set or update the distribution field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `distribution` field.\n', args=[]),
  ...
  '#withFilterPattern':: d.fn(help='`aws.cloudwatch_log_subscription_filter.withFilterPattern` constructs a mixin object that can be merged into the `cloudwatch_log_subscription_filter`\nTerraform resource block to set or update the filter_pattern field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter_pattern` field.\n', args=[]),
  ...
  '#withLogGroupName':: d.fn(help='`aws.cloudwatch_log_subscription_filter.withLogGroupName` constructs a mixin object that can be merged into the `cloudwatch_log_subscription_filter`\nTerraform resource block to set or update the log_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `log_group_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudwatch_log_subscription_filter.withName` constructs a mixin object that can be merged into the `cloudwatch_log_subscription_filter`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.cloudwatch_log_subscription_filter.withRoleArn` constructs a mixin object that can be merged into the `cloudwatch_log_subscription_filter`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
