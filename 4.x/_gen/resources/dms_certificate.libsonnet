...
{
  '#':: d.pkg(name='dms_certificate', url='', help='`dms_certificate` represents the `aws_dms_certificate` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCertificateId':: d.fn(help='`aws.dms_certificate.withCertificateId` constructs a mixin object that can be merged into the `dms_certificate`\nTerraform resource block to set or update the certificate_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_id` field.\n', args=[]),
  ...
  '#withCertificatePem':: d.fn(help='`aws.dms_certificate.withCertificatePem` constructs a mixin object that can be merged into the `dms_certificate`\nTerraform resource block to set or update the certificate_pem field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_pem` field.\n', args=[]),
  ...
  '#withCertificateWallet':: d.fn(help='`aws.dms_certificate.withCertificateWallet` constructs a mixin object that can be merged into the `dms_certificate`\nTerraform resource block to set or update the certificate_wallet field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_wallet` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.dms_certificate.withTags` constructs a mixin object that can be merged into the `dms_certificate`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.dms_certificate.withTagsAll` constructs a mixin object that can be merged into the `dms_certificate`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
