...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppImageConfigName':: d.fn(help='`aws.sagemaker_app_image_config.withAppImageConfigName` constructs a mixin object that can be merged into the `sagemaker_app_image_config`\nTerraform resource block to set or update the app_image_config_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_image_config_name` field.\n', args=[]),
  ...
  '#withKernelGatewayImageConfig':: d.fn(help='`aws.sagemaker_app_image_config.withKernelGatewayImageConfig` constructs a mixin object that can be merged into the `sagemaker_app_image_config`\nTerraform resource block to set or update the kernel_gateway_image_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kernel_gateway_image_config` field.\n', args=[]),
  ...
  '#withKernelGatewayImageConfigMixin':: d.fn(help='`aws.sagemaker_app_image_config.withKernelGatewayImageConfigMixin` constructs a mixin object that can be merged into the `sagemaker_app_image_config`\nTerraform resource block to set or update the kernel_gateway_image_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.sagemaker_app_image_config.withKernelGatewayImageConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kernel_gateway_image_config` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.sagemaker_app_image_config.withTags` constructs a mixin object that can be merged into the `sagemaker_app_image_config`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.sagemaker_app_image_config.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_app_image_config`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
