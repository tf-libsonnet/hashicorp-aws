...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMeshName':: d.fn(help='`aws.appmesh_virtual_router.withMeshName` constructs a mixin object that can be merged into the `appmesh_virtual_router`\nTerraform resource block to set or update the mesh_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mesh_name` field.\n', args=[]),
  ...
  '#withMeshOwner':: d.fn(help='`aws.appmesh_virtual_router.withMeshOwner` constructs a mixin object that can be merged into the `appmesh_virtual_router`\nTerraform resource block to set or update the mesh_owner field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mesh_owner` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.appmesh_virtual_router.withName` constructs a mixin object that can be merged into the `appmesh_virtual_router`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSpec':: d.fn(help='`aws.appmesh_virtual_router.withSpec` constructs a mixin object that can be merged into the `appmesh_virtual_router`\nTerraform resource block to set or update the spec field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spec` field.\n', args=[]),
  ...
  '#withSpecMixin':: d.fn(help='`aws.appmesh_virtual_router.withSpecMixin` constructs a mixin object that can be merged into the `appmesh_virtual_router`\nTerraform resource block to set or update the spec field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.appmesh_virtual_router.withSpec](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spec` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.appmesh_virtual_router.withTags` constructs a mixin object that can be merged into the `appmesh_virtual_router`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.appmesh_virtual_router.withTagsAll` constructs a mixin object that can be merged into the `appmesh_virtual_router`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
