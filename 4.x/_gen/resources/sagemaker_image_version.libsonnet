...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBaseImage':: d.fn(help='`aws.sagemaker_image_version.withBaseImage` constructs a mixin object that can be merged into the `sagemaker_image_version`\nTerraform resource block to set or update the base_image field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `base_image` field.\n', args=[]),
  ...
  '#withImageName':: d.fn(help='`aws.sagemaker_image_version.withImageName` constructs a mixin object that can be merged into the `sagemaker_image_version`\nTerraform resource block to set or update the image_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `image_name` field.\n', args=[]),
