...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBlockPublicPolicy':: d.fn(help='`aws.secretsmanager_secret_policy.withBlockPublicPolicy` constructs a mixin object that can be merged into the `secretsmanager_secret_policy`\nTerraform resource block to set or update the block_public_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `block_public_policy` field.\n', args=[]),
  ...
  '#withPolicy':: d.fn(help='`aws.secretsmanager_secret_policy.withPolicy` constructs a mixin object that can be merged into the `secretsmanager_secret_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withSecretArn':: d.fn(help='`aws.secretsmanager_secret_policy.withSecretArn` constructs a mixin object that can be merged into the `secretsmanager_secret_policy`\nTerraform resource block to set or update the secret_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret_arn` field.\n', args=[]),
