...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateAuthorityArn':: d.fn(help='`aws.acmpca_certificate.withCertificateAuthorityArn` constructs a mixin object that can be merged into the `acmpca_certificate`\nTerraform resource block to set or update the certificate_authority_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_authority_arn` field.\n', args=[]),
  ...
  '#withCertificateSigningRequest':: d.fn(help='`aws.acmpca_certificate.withCertificateSigningRequest` constructs a mixin object that can be merged into the `acmpca_certificate`\nTerraform resource block to set or update the certificate_signing_request field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_signing_request` field.\n', args=[]),
  ...
  '#withSigningAlgorithm':: d.fn(help='`aws.acmpca_certificate.withSigningAlgorithm` constructs a mixin object that can be merged into the `acmpca_certificate`\nTerraform resource block to set or update the signing_algorithm field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `signing_algorithm` field.\n', args=[]),
  ...
  '#withTemplateArn':: d.fn(help='`aws.acmpca_certificate.withTemplateArn` constructs a mixin object that can be merged into the `acmpca_certificate`\nTerraform resource block to set or update the template_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_arn` field.\n', args=[]),
  ...
  '#withValidity':: d.fn(help='`aws.acmpca_certificate.withValidity` constructs a mixin object that can be merged into the `acmpca_certificate`\nTerraform resource block to set or update the validity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `validity` field.\n', args=[]),
  ...
  '#withValidityMixin':: d.fn(help='`aws.acmpca_certificate.withValidityMixin` constructs a mixin object that can be merged into the `acmpca_certificate`\nTerraform resource block to set or update the validity field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.acmpca_certificate.withValidity](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `validity` field.\n', args=[]),
