...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAllowSelfManagement':: d.fn(help='`aws.opsworks_user_profile.withAllowSelfManagement` constructs a mixin object that can be merged into the `opsworks_user_profile`\nTerraform resource block to set or update the allow_self_management field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `allow_self_management` field.\n', args=[]),
  ...
  '#withSshPublicKey':: d.fn(help='`aws.opsworks_user_profile.withSshPublicKey` constructs a mixin object that can be merged into the `opsworks_user_profile`\nTerraform resource block to set or update the ssh_public_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ssh_public_key` field.\n', args=[]),
  ...
  '#withSshUsername':: d.fn(help='`aws.opsworks_user_profile.withSshUsername` constructs a mixin object that can be merged into the `opsworks_user_profile`\nTerraform resource block to set or update the ssh_username field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ssh_username` field.\n', args=[]),
  ...
  '#withUserArn':: d.fn(help='`aws.opsworks_user_profile.withUserArn` constructs a mixin object that can be merged into the `opsworks_user_profile`\nTerraform resource block to set or update the user_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_arn` field.\n', args=[]),
