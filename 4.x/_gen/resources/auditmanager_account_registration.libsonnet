...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDelegatedAdminAccount':: d.fn(help='`aws.auditmanager_account_registration.withDelegatedAdminAccount` constructs a mixin object that can be merged into the `auditmanager_account_registration`\nTerraform resource block to set or update the delegated_admin_account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delegated_admin_account` field.\n', args=[]),
  ...
  '#withDeregisterOnDestroy':: d.fn(help='`aws.auditmanager_account_registration.withDeregisterOnDestroy` constructs a mixin object that can be merged into the `auditmanager_account_registration`\nTerraform resource block to set or update the deregister_on_destroy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deregister_on_destroy` field.\n', args=[]),
  ...
  '#withKmsKey':: d.fn(help='`aws.auditmanager_account_registration.withKmsKey` constructs a mixin object that can be merged into the `auditmanager_account_registration`\nTerraform resource block to set or update the kms_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key` field.\n', args=[]),
