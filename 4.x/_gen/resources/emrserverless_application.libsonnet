...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withImageConfigurationMixin':: d.fn(help='`aws.list[obj].withImageConfigurationMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the image_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.list[obj].withImageConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `image_configuration` field.\n', args=[]),
  withImageConfigurationMixin(resourceLabel, value): {
    resource+: {
      aws_emrserverless_application+: {
        [resourceLabel]+: {
          image_configuration+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
