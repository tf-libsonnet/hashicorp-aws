...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomain':: d.fn(help='`aws.codeartifact_domain.withDomain` constructs a mixin object that can be merged into the `codeartifact_domain`\nTerraform resource block to set or update the domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain` field.\n', args=[]),
  ...
  '#withEncryptionKey':: d.fn(help='`aws.codeartifact_domain.withEncryptionKey` constructs a mixin object that can be merged into the `codeartifact_domain`\nTerraform resource block to set or update the encryption_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encryption_key` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.codeartifact_domain.withTags` constructs a mixin object that can be merged into the `codeartifact_domain`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.codeartifact_domain.withTagsAll` constructs a mixin object that can be merged into the `codeartifact_domain`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
