...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withContentType':: d.fn(help='`aws.devicefarm_upload.withContentType` constructs a mixin object that can be merged into the `devicefarm_upload`\nTerraform resource block to set or update the content_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content_type` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.devicefarm_upload.withName` constructs a mixin object that can be merged into the `devicefarm_upload`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProjectArn':: d.fn(help='`aws.devicefarm_upload.withProjectArn` constructs a mixin object that can be merged into the `devicefarm_upload`\nTerraform resource block to set or update the project_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project_arn` field.\n', args=[]),
  ...
  '#withType':: d.fn(help='`aws.devicefarm_upload.withType` constructs a mixin object that can be merged into the `devicefarm_upload`\nTerraform resource block to set or update the type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type` field.\n', args=[]),
