...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBackupPolicy':: d.fn(help='`aws.efs_backup_policy.withBackupPolicy` constructs a mixin object that can be merged into the `efs_backup_policy`\nTerraform resource block to set or update the backup_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup_policy` field.\n', args=[]),
  ...
  '#withBackupPolicyMixin':: d.fn(help='`aws.efs_backup_policy.withBackupPolicyMixin` constructs a mixin object that can be merged into the `efs_backup_policy`\nTerraform resource block to set or update the backup_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.efs_backup_policy.withBackupPolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup_policy` field.\n', args=[]),
  ...
  '#withFileSystemId':: d.fn(help='`aws.efs_backup_policy.withFileSystemId` constructs a mixin object that can be merged into the `efs_backup_policy`\nTerraform resource block to set or update the file_system_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `file_system_id` field.\n', args=[]),
