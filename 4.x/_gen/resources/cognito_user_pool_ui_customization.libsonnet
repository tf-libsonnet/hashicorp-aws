...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClientId':: d.fn(help='`aws.cognito_user_pool_ui_customization.withClientId` constructs a mixin object that can be merged into the `cognito_user_pool_ui_customization`\nTerraform resource block to set or update the client_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_id` field.\n', args=[]),
  ...
  '#withCss':: d.fn(help='`aws.cognito_user_pool_ui_customization.withCss` constructs a mixin object that can be merged into the `cognito_user_pool_ui_customization`\nTerraform resource block to set or update the css field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `css` field.\n', args=[]),
  ...
  '#withImageFile':: d.fn(help='`aws.cognito_user_pool_ui_customization.withImageFile` constructs a mixin object that can be merged into the `cognito_user_pool_ui_customization`\nTerraform resource block to set or update the image_file field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `image_file` field.\n', args=[]),
  ...
  '#withUserPoolId':: d.fn(help='`aws.cognito_user_pool_ui_customization.withUserPoolId` constructs a mixin object that can be merged into the `cognito_user_pool_ui_customization`\nTerraform resource block to set or update the user_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_pool_id` field.\n', args=[]),
