...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomainName':: d.fn(help='`aws.apprunner_custom_domain_association.withDomainName` constructs a mixin object that can be merged into the `apprunner_custom_domain_association`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withEnableWwwSubdomain':: d.fn(help='`aws.apprunner_custom_domain_association.withEnableWwwSubdomain` constructs a mixin object that can be merged into the `apprunner_custom_domain_association`\nTerraform resource block to set or update the enable_www_subdomain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_www_subdomain` field.\n', args=[]),
  ...
  '#withServiceArn':: d.fn(help='`aws.apprunner_custom_domain_association.withServiceArn` constructs a mixin object that can be merged into the `apprunner_custom_domain_association`\nTerraform resource block to set or update the service_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_arn` field.\n', args=[]),
