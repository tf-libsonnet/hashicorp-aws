...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCidrBlock':: d.fn(help='`aws.ec2_subnet_cidr_reservation.withCidrBlock` constructs a mixin object that can be merged into the `ec2_subnet_cidr_reservation`\nTerraform resource block to set or update the cidr_block field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cidr_block` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.ec2_subnet_cidr_reservation.withDescription` constructs a mixin object that can be merged into the `ec2_subnet_cidr_reservation`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withReservationType':: d.fn(help='`aws.ec2_subnet_cidr_reservation.withReservationType` constructs a mixin object that can be merged into the `ec2_subnet_cidr_reservation`\nTerraform resource block to set or update the reservation_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `reservation_type` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`aws.ec2_subnet_cidr_reservation.withSubnetId` constructs a mixin object that can be merged into the `ec2_subnet_cidr_reservation`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
