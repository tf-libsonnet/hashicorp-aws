...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPolicy':: d.fn(help='`aws.api_gateway_rest_api_policy.withPolicy` constructs a mixin object that can be merged into the `api_gateway_rest_api_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withRestApiId':: d.fn(help='`aws.api_gateway_rest_api_policy.withRestApiId` constructs a mixin object that can be merged into the `api_gateway_rest_api_policy`\nTerraform resource block to set or update the rest_api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rest_api_id` field.\n', args=[]),
