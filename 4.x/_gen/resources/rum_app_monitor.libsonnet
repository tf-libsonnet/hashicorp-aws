...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppMonitorConfiguration':: d.fn(help='`aws.rum_app_monitor.withAppMonitorConfiguration` constructs a mixin object that can be merged into the `rum_app_monitor`\nTerraform resource block to set or update the app_monitor_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_monitor_configuration` field.\n', args=[]),
  ...
  '#withAppMonitorConfigurationMixin':: d.fn(help='`aws.rum_app_monitor.withAppMonitorConfigurationMixin` constructs a mixin object that can be merged into the `rum_app_monitor`\nTerraform resource block to set or update the app_monitor_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.rum_app_monitor.withAppMonitorConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_monitor_configuration` field.\n', args=[]),
  ...
  '#withCwLogEnabled':: d.fn(help='`aws.rum_app_monitor.withCwLogEnabled` constructs a mixin object that can be merged into the `rum_app_monitor`\nTerraform resource block to set or update the cw_log_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cw_log_enabled` field.\n', args=[]),
  ...
  '#withDomain':: d.fn(help='`aws.rum_app_monitor.withDomain` constructs a mixin object that can be merged into the `rum_app_monitor`\nTerraform resource block to set or update the domain field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.rum_app_monitor.withName` constructs a mixin object that can be merged into the `rum_app_monitor`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.rum_app_monitor.withTags` constructs a mixin object that can be merged into the `rum_app_monitor`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.rum_app_monitor.withTagsAll` constructs a mixin object that can be merged into the `rum_app_monitor`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
