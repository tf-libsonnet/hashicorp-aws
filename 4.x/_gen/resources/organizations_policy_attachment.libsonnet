...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPolicyId':: d.fn(help='`aws.organizations_policy_attachment.withPolicyId` constructs a mixin object that can be merged into the `organizations_policy_attachment`\nTerraform resource block to set or update the policy_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_id` field.\n', args=[]),
  ...
  '#withTargetId':: d.fn(help='`aws.organizations_policy_attachment.withTargetId` constructs a mixin object that can be merged into the `organizations_policy_attachment`\nTerraform resource block to set or update the target_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_id` field.\n', args=[]),
