...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstancePort':: d.fn(help='`aws.load_balancer_backend_server_policy.withInstancePort` constructs a mixin object that can be merged into the `load_balancer_backend_server_policy`\nTerraform resource block to set or update the instance_port field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_port` field.\n', args=[]),
  ...
  '#withLoadBalancerName':: d.fn(help='`aws.load_balancer_backend_server_policy.withLoadBalancerName` constructs a mixin object that can be merged into the `load_balancer_backend_server_policy`\nTerraform resource block to set or update the load_balancer_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load_balancer_name` field.\n', args=[]),
  ...
  '#withPolicyNames':: d.fn(help='`aws.load_balancer_backend_server_policy.withPolicyNames` constructs a mixin object that can be merged into the `load_balancer_backend_server_policy`\nTerraform resource block to set or update the policy_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_names` field.\n', args=[]),
