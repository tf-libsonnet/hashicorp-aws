...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBandwidth':: d.fn(help='`aws.dx_connection.withBandwidth` constructs a mixin object that can be merged into the `dx_connection`\nTerraform resource block to set or update the bandwidth field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bandwidth` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`aws.dx_connection.withLocation` constructs a mixin object that can be merged into the `dx_connection`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withProviderName':: d.fn(help='`aws.dx_connection.withProviderName` constructs a mixin object that can be merged into the `dx_connection`\nTerraform resource block to set or update the provider_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_name` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.dx_connection.withTagsAll` constructs a mixin object that can be merged into the `dx_connection`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
