...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAlias':: d.fn(help='`aws.prometheus_workspace.withAlias` constructs a mixin object that can be merged into the `prometheus_workspace`\nTerraform resource block to set or update the alias field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `alias` field.\n', args=[]),
  ...
  '#withLoggingConfiguration':: d.fn(help='`aws.prometheus_workspace.withLoggingConfiguration` constructs a mixin object that can be merged into the `prometheus_workspace`\nTerraform resource block to set or update the logging_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_configuration` field.\n', args=[]),
  ...
  '#withLoggingConfigurationMixin':: d.fn(help='`aws.prometheus_workspace.withLoggingConfigurationMixin` constructs a mixin object that can be merged into the `prometheus_workspace`\nTerraform resource block to set or update the logging_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.prometheus_workspace.withLoggingConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_configuration` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.prometheus_workspace.withTagsAll` constructs a mixin object that can be merged into the `prometheus_workspace`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
