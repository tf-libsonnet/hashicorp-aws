...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucket':: d.fn(help='`aws.s3control_bucket_lifecycle_configuration.withBucket` constructs a mixin object that can be merged into the `s3control_bucket_lifecycle_configuration`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withRule':: d.fn(help='`aws.s3control_bucket_lifecycle_configuration.withRule` constructs a mixin object that can be merged into the `s3control_bucket_lifecycle_configuration`\nTerraform resource block to set or update the rule field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rule` field.\n', args=[]),
  ...
  '#withRuleMixin':: d.fn(help='`aws.s3control_bucket_lifecycle_configuration.withRuleMixin` constructs a mixin object that can be merged into the `s3control_bucket_lifecycle_configuration`\nTerraform resource block to set or update the rule field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3control_bucket_lifecycle_configuration.withRule](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rule` field.\n', args=[]),
