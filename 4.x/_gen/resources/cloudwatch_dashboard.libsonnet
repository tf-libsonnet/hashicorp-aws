...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDashboardBody':: d.fn(help='`aws.cloudwatch_dashboard.withDashboardBody` constructs a mixin object that can be merged into the `cloudwatch_dashboard`\nTerraform resource block to set or update the dashboard_body field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dashboard_body` field.\n', args=[]),
  ...
  '#withDashboardName':: d.fn(help='`aws.cloudwatch_dashboard.withDashboardName` constructs a mixin object that can be merged into the `cloudwatch_dashboard`\nTerraform resource block to set or update the dashboard_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dashboard_name` field.\n', args=[]),
