...
{
  '#':: d.pkg(name='neptune_subnet_group', url='', help='`neptune_subnet_group` represents the `aws_neptune_subnet_group` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`aws.neptune_subnet_group.withDescription` constructs a mixin object that can be merged into the `neptune_subnet_group`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.neptune_subnet_group.withName` constructs a mixin object that can be merged into the `neptune_subnet_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`aws.neptune_subnet_group.withNamePrefix` constructs a mixin object that can be merged into the `neptune_subnet_group`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withSubnetIds':: d.fn(help='`aws.neptune_subnet_group.withSubnetIds` constructs a mixin object that can be merged into the `neptune_subnet_group`\nTerraform resource block to set or update the subnet_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_ids` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.neptune_subnet_group.withTags` constructs a mixin object that can be merged into the `neptune_subnet_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.neptune_subnet_group.withTagsAll` constructs a mixin object that can be merged into the `neptune_subnet_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
