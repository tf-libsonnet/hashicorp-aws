...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLinkingMode':: d.fn(help='`aws.securityhub_finding_aggregator.withLinkingMode` constructs a mixin object that can be merged into the `securityhub_finding_aggregator`\nTerraform resource block to set or update the linking_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `linking_mode` field.\n', args=[]),
  ...
  '#withSpecifiedRegions':: d.fn(help='`aws.securityhub_finding_aggregator.withSpecifiedRegions` constructs a mixin object that can be merged into the `securityhub_finding_aggregator`\nTerraform resource block to set or update the specified_regions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `specified_regions` field.\n', args=[]),
