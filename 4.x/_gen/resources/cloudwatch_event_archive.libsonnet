...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.cloudwatch_event_archive.withDescription` constructs a mixin object that can be merged into the `cloudwatch_event_archive`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEventPattern':: d.fn(help='`aws.cloudwatch_event_archive.withEventPattern` constructs a mixin object that can be merged into the `cloudwatch_event_archive`\nTerraform resource block to set or update the event_pattern field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_pattern` field.\n', args=[]),
  ...
  '#withEventSourceArn':: d.fn(help='`aws.cloudwatch_event_archive.withEventSourceArn` constructs a mixin object that can be merged into the `cloudwatch_event_archive`\nTerraform resource block to set or update the event_source_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_source_arn` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudwatch_event_archive.withName` constructs a mixin object that can be merged into the `cloudwatch_event_archive`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRetentionDays':: d.fn(help='`aws.cloudwatch_event_archive.withRetentionDays` constructs a mixin object that can be merged into the `cloudwatch_event_archive`\nTerraform resource block to set or update the retention_days field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention_days` field.\n', args=[]),
