...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuthenticationProfileContent':: d.fn(help='`aws.redshift_authentication_profile.withAuthenticationProfileContent` constructs a mixin object that can be merged into the `redshift_authentication_profile`\nTerraform resource block to set or update the authentication_profile_content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authentication_profile_content` field.\n', args=[]),
  ...
  '#withAuthenticationProfileName':: d.fn(help='`aws.redshift_authentication_profile.withAuthenticationProfileName` constructs a mixin object that can be merged into the `redshift_authentication_profile`\nTerraform resource block to set or update the authentication_profile_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authentication_profile_name` field.\n', args=[]),
