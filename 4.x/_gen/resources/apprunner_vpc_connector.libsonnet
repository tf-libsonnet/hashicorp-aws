...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSecurityGroups':: d.fn(help='`aws.apprunner_vpc_connector.withSecurityGroups` constructs a mixin object that can be merged into the `apprunner_vpc_connector`\nTerraform resource block to set or update the security_groups field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_groups` field.\n', args=[]),
  ...
  '#withSubnets':: d.fn(help='`aws.apprunner_vpc_connector.withSubnets` constructs a mixin object that can be merged into the `apprunner_vpc_connector`\nTerraform resource block to set or update the subnets field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnets` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.apprunner_vpc_connector.withTags` constructs a mixin object that can be merged into the `apprunner_vpc_connector`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.apprunner_vpc_connector.withTagsAll` constructs a mixin object that can be merged into the `apprunner_vpc_connector`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
  ...
  '#withVpcConnectorName':: d.fn(help='`aws.apprunner_vpc_connector.withVpcConnectorName` constructs a mixin object that can be merged into the `apprunner_vpc_connector`\nTerraform resource block to set or update the vpc_connector_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_connector_name` field.\n', args=[]),
