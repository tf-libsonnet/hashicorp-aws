...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCidr':: d.fn(help='`aws.ec2_managed_prefix_list_entry.withCidr` constructs a mixin object that can be merged into the `ec2_managed_prefix_list_entry`\nTerraform resource block to set or update the cidr field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cidr` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.ec2_managed_prefix_list_entry.withDescription` constructs a mixin object that can be merged into the `ec2_managed_prefix_list_entry`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withPrefixListId':: d.fn(help='`aws.ec2_managed_prefix_list_entry.withPrefixListId` constructs a mixin object that can be merged into the `ec2_managed_prefix_list_entry`\nTerraform resource block to set or update the prefix_list_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `prefix_list_id` field.\n', args=[]),
