...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.msk_configuration.withDescription` constructs a mixin object that can be merged into the `msk_configuration`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withKafkaVersions':: d.fn(help='`aws.msk_configuration.withKafkaVersions` constructs a mixin object that can be merged into the `msk_configuration`\nTerraform resource block to set or update the kafka_versions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kafka_versions` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.msk_configuration.withName` constructs a mixin object that can be merged into the `msk_configuration`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withServerProperties':: d.fn(help='`aws.msk_configuration.withServerProperties` constructs a mixin object that can be merged into the `msk_configuration`\nTerraform resource block to set or update the server_properties field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_properties` field.\n', args=[]),
