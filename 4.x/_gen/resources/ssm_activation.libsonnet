...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.ssm_activation.withDescription` constructs a mixin object that can be merged into the `ssm_activation`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withExpirationDate':: d.fn(help='`aws.ssm_activation.withExpirationDate` constructs a mixin object that can be merged into the `ssm_activation`\nTerraform resource block to set or update the expiration_date field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expiration_date` field.\n', args=[]),
  ...
  '#withIamRole':: d.fn(help='`aws.ssm_activation.withIamRole` constructs a mixin object that can be merged into the `ssm_activation`\nTerraform resource block to set or update the iam_role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `iam_role` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.ssm_activation.withName` constructs a mixin object that can be merged into the `ssm_activation`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRegistrationLimit':: d.fn(help='`aws.ssm_activation.withRegistrationLimit` constructs a mixin object that can be merged into the `ssm_activation`\nTerraform resource block to set or update the registration_limit field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `registration_limit` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.ssm_activation.withTags` constructs a mixin object that can be merged into the `ssm_activation`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ssm_activation.withTagsAll` constructs a mixin object that can be merged into the `ssm_activation`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
