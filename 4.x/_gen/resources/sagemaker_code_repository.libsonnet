...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCodeRepositoryName':: d.fn(help='`aws.sagemaker_code_repository.withCodeRepositoryName` constructs a mixin object that can be merged into the `sagemaker_code_repository`\nTerraform resource block to set or update the code_repository_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `code_repository_name` field.\n', args=[]),
  ...
  '#withGitConfig':: d.fn(help='`aws.sagemaker_code_repository.withGitConfig` constructs a mixin object that can be merged into the `sagemaker_code_repository`\nTerraform resource block to set or update the git_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `git_config` field.\n', args=[]),
  ...
  '#withGitConfigMixin':: d.fn(help='`aws.sagemaker_code_repository.withGitConfigMixin` constructs a mixin object that can be merged into the `sagemaker_code_repository`\nTerraform resource block to set or update the git_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.sagemaker_code_repository.withGitConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `git_config` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.sagemaker_code_repository.withTags` constructs a mixin object that can be merged into the `sagemaker_code_repository`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.sagemaker_code_repository.withTagsAll` constructs a mixin object that can be merged into the `sagemaker_code_repository`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
