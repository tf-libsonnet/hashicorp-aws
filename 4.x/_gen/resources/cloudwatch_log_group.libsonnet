...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKmsKeyId':: d.fn(help='`aws.cloudwatch_log_group.withKmsKeyId` constructs a mixin object that can be merged into the `cloudwatch_log_group`\nTerraform resource block to set or update the kms_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_id` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`aws.cloudwatch_log_group.withNamePrefix` constructs a mixin object that can be merged into the `cloudwatch_log_group`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withRetentionInDays':: d.fn(help='`aws.cloudwatch_log_group.withRetentionInDays` constructs a mixin object that can be merged into the `cloudwatch_log_group`\nTerraform resource block to set or update the retention_in_days field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention_in_days` field.\n', args=[]),
  ...
  '#withSkipDestroy':: d.fn(help='`aws.cloudwatch_log_group.withSkipDestroy` constructs a mixin object that can be merged into the `cloudwatch_log_group`\nTerraform resource block to set or update the skip_destroy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `skip_destroy` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.cloudwatch_log_group.withTagsAll` constructs a mixin object that can be merged into the `cloudwatch_log_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
