...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withComment':: d.fn(help='`aws.cloudfront_public_key.withComment` constructs a mixin object that can be merged into the `cloudfront_public_key`\nTerraform resource block to set or update the comment field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `comment` field.\n', args=[]),
  ...
  '#withEncodedKey':: d.fn(help='`aws.cloudfront_public_key.withEncodedKey` constructs a mixin object that can be merged into the `cloudfront_public_key`\nTerraform resource block to set or update the encoded_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encoded_key` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.cloudfront_public_key.withName` constructs a mixin object that can be merged into the `cloudfront_public_key`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`aws.cloudfront_public_key.withNamePrefix` constructs a mixin object that can be merged into the `cloudfront_public_key`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
