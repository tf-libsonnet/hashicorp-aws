...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.config_delivery_channel.withName` constructs a mixin object that can be merged into the `config_delivery_channel`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withS3BucketName':: d.fn(help='`aws.config_delivery_channel.withS3BucketName` constructs a mixin object that can be merged into the `config_delivery_channel`\nTerraform resource block to set or update the s3_bucket_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_bucket_name` field.\n', args=[]),
  ...
  '#withS3KeyPrefix':: d.fn(help='`aws.config_delivery_channel.withS3KeyPrefix` constructs a mixin object that can be merged into the `config_delivery_channel`\nTerraform resource block to set or update the s3_key_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_key_prefix` field.\n', args=[]),
  ...
  '#withS3KmsKeyArn':: d.fn(help='`aws.config_delivery_channel.withS3KmsKeyArn` constructs a mixin object that can be merged into the `config_delivery_channel`\nTerraform resource block to set or update the s3_kms_key_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_kms_key_arn` field.\n', args=[]),
  ...
  '#withSnapshotDeliveryProperties':: d.fn(help='`aws.config_delivery_channel.withSnapshotDeliveryProperties` constructs a mixin object that can be merged into the `config_delivery_channel`\nTerraform resource block to set or update the snapshot_delivery_properties field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `snapshot_delivery_properties` field.\n', args=[]),
  ...
  '#withSnapshotDeliveryPropertiesMixin':: d.fn(help='`aws.config_delivery_channel.withSnapshotDeliveryPropertiesMixin` constructs a mixin object that can be merged into the `config_delivery_channel`\nTerraform resource block to set or update the snapshot_delivery_properties field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.config_delivery_channel.withSnapshotDeliveryProperties](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `snapshot_delivery_properties` field.\n', args=[]),
  ...
  '#withSnsTopicArn':: d.fn(help='`aws.config_delivery_channel.withSnsTopicArn` constructs a mixin object that can be merged into the `config_delivery_channel`\nTerraform resource block to set or update the sns_topic_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sns_topic_arn` field.\n', args=[]),
