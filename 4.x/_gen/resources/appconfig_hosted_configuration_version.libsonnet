...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationId':: d.fn(help='`aws.appconfig_hosted_configuration_version.withApplicationId` constructs a mixin object that can be merged into the `appconfig_hosted_configuration_version`\nTerraform resource block to set or update the application_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_id` field.\n', args=[]),
  ...
  '#withConfigurationProfileId':: d.fn(help='`aws.appconfig_hosted_configuration_version.withConfigurationProfileId` constructs a mixin object that can be merged into the `appconfig_hosted_configuration_version`\nTerraform resource block to set or update the configuration_profile_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `configuration_profile_id` field.\n', args=[]),
  ...
  '#withContent':: d.fn(help='`aws.appconfig_hosted_configuration_version.withContent` constructs a mixin object that can be merged into the `appconfig_hosted_configuration_version`\nTerraform resource block to set or update the content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content` field.\n', args=[]),
  ...
  '#withContentType':: d.fn(help='`aws.appconfig_hosted_configuration_version.withContentType` constructs a mixin object that can be merged into the `appconfig_hosted_configuration_version`\nTerraform resource block to set or update the content_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content_type` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.appconfig_hosted_configuration_version.withDescription` constructs a mixin object that can be merged into the `appconfig_hosted_configuration_version`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
