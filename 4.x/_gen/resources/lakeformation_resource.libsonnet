...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withArn':: d.fn(help='`aws.lakeformation_resource.withArn` constructs a mixin object that can be merged into the `lakeformation_resource`\nTerraform resource block to set or update the arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `arn` field.\n', args=[]),
  ...
  '#withRoleArn':: d.fn(help='`aws.lakeformation_resource.withRoleArn` constructs a mixin object that can be merged into the `lakeformation_resource`\nTerraform resource block to set or update the role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_arn` field.\n', args=[]),
