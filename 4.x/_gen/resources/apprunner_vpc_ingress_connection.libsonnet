...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIngressVpcConfiguration':: d.fn(help='`aws.apprunner_vpc_ingress_connection.withIngressVpcConfiguration` constructs a mixin object that can be merged into the `apprunner_vpc_ingress_connection`\nTerraform resource block to set or update the ingress_vpc_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ingress_vpc_configuration` field.\n', args=[]),
  ...
  '#withIngressVpcConfigurationMixin':: d.fn(help='`aws.apprunner_vpc_ingress_connection.withIngressVpcConfigurationMixin` constructs a mixin object that can be merged into the `apprunner_vpc_ingress_connection`\nTerraform resource block to set or update the ingress_vpc_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.apprunner_vpc_ingress_connection.withIngressVpcConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ingress_vpc_configuration` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.apprunner_vpc_ingress_connection.withName` constructs a mixin object that can be merged into the `apprunner_vpc_ingress_connection`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withServiceArn':: d.fn(help='`aws.apprunner_vpc_ingress_connection.withServiceArn` constructs a mixin object that can be merged into the `apprunner_vpc_ingress_connection`\nTerraform resource block to set or update the service_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_arn` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.apprunner_vpc_ingress_connection.withTags` constructs a mixin object that can be merged into the `apprunner_vpc_ingress_connection`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.apprunner_vpc_ingress_connection.withTagsAll` constructs a mixin object that can be merged into the `apprunner_vpc_ingress_connection`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
