...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucket':: d.fn(help='`aws.s3_bucket_analytics_configuration.withBucket` constructs a mixin object that can be merged into the `s3_bucket_analytics_configuration`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withFilter':: d.fn(help='`aws.s3_bucket_analytics_configuration.withFilter` constructs a mixin object that can be merged into the `s3_bucket_analytics_configuration`\nTerraform resource block to set or update the filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFilterMixin':: d.fn(help='`aws.s3_bucket_analytics_configuration.withFilterMixin` constructs a mixin object that can be merged into the `s3_bucket_analytics_configuration`\nTerraform resource block to set or update the filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3_bucket_analytics_configuration.withFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.s3_bucket_analytics_configuration.withName` constructs a mixin object that can be merged into the `s3_bucket_analytics_configuration`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withStorageClassAnalysis':: d.fn(help='`aws.s3_bucket_analytics_configuration.withStorageClassAnalysis` constructs a mixin object that can be merged into the `s3_bucket_analytics_configuration`\nTerraform resource block to set or update the storage_class_analysis field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_class_analysis` field.\n', args=[]),
  ...
  '#withStorageClassAnalysisMixin':: d.fn(help='`aws.s3_bucket_analytics_configuration.withStorageClassAnalysisMixin` constructs a mixin object that can be merged into the `s3_bucket_analytics_configuration`\nTerraform resource block to set or update the storage_class_analysis field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3_bucket_analytics_configuration.withStorageClassAnalysis](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_class_analysis` field.\n', args=[]),
