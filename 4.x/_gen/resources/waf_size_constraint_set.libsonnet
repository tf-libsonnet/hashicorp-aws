...
{
  '#':: d.pkg(name='waf_size_constraint_set', url='', help='`waf_size_constraint_set` represents the `aws_waf_size_constraint_set` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`aws.waf_size_constraint_set.withName` constructs a mixin object that can be merged into the `waf_size_constraint_set`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSizeConstraints':: d.fn(help='`aws.waf_size_constraint_set.withSizeConstraints` constructs a mixin object that can be merged into the `waf_size_constraint_set`\nTerraform resource block to set or update the size_constraints field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `size_constraints` field.\n', args=[]),
  ...
  '#withSizeConstraintsMixin':: d.fn(help='`aws.waf_size_constraint_set.withSizeConstraintsMixin` constructs a mixin object that can be merged into the `waf_size_constraint_set`\nTerraform resource block to set or update the size_constraints field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.waf_size_constraint_set.withSizeConstraints](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `size_constraints` field.\n', args=[]),
