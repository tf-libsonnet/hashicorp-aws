...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAvailabilityZone':: d.fn(help='`aws.ec2_host.withAvailabilityZone` constructs a mixin object that can be merged into the `ec2_host`\nTerraform resource block to set or update the availability_zone field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `availability_zone` field.\n', args=[]),
  ...
  '#withInstanceType':: d.fn(help='`aws.ec2_host.withInstanceType` constructs a mixin object that can be merged into the `ec2_host`\nTerraform resource block to set or update the instance_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_type` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ec2_host.withTagsAll` constructs a mixin object that can be merged into the `ec2_host`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
