...
{
  '#':: d.pkg(name='detective_invitation_accepter', url='', help='`detective_invitation_accepter` represents the `aws_detective_invitation_accepter` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withGraphArn':: d.fn(help='`aws.detective_invitation_accepter.withGraphArn` constructs a mixin object that can be merged into the `detective_invitation_accepter`\nTerraform resource block to set or update the graph_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `graph_arn` field.\n', args=[]),
