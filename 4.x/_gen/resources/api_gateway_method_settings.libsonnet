...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMethodPath':: d.fn(help='`aws.api_gateway_method_settings.withMethodPath` constructs a mixin object that can be merged into the `api_gateway_method_settings`\nTerraform resource block to set or update the method_path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `method_path` field.\n', args=[]),
  ...
  '#withRestApiId':: d.fn(help='`aws.api_gateway_method_settings.withRestApiId` constructs a mixin object that can be merged into the `api_gateway_method_settings`\nTerraform resource block to set or update the rest_api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rest_api_id` field.\n', args=[]),
  ...
  '#withSettings':: d.fn(help='`aws.api_gateway_method_settings.withSettings` constructs a mixin object that can be merged into the `api_gateway_method_settings`\nTerraform resource block to set or update the settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `settings` field.\n', args=[]),
  ...
  '#withSettingsMixin':: d.fn(help='`aws.api_gateway_method_settings.withSettingsMixin` constructs a mixin object that can be merged into the `api_gateway_method_settings`\nTerraform resource block to set or update the settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.api_gateway_method_settings.withSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `settings` field.\n', args=[]),
  ...
  '#withStageName':: d.fn(help='`aws.api_gateway_method_settings.withStageName` constructs a mixin object that can be merged into the `api_gateway_method_settings`\nTerraform resource block to set or update the stage_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage_name` field.\n', args=[]),
