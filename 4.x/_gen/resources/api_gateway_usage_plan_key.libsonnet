...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKeyId':: d.fn(help='`aws.api_gateway_usage_plan_key.withKeyId` constructs a mixin object that can be merged into the `api_gateway_usage_plan_key`\nTerraform resource block to set or update the key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_id` field.\n', args=[]),
  ...
  '#withKeyType':: d.fn(help='`aws.api_gateway_usage_plan_key.withKeyType` constructs a mixin object that can be merged into the `api_gateway_usage_plan_key`\nTerraform resource block to set or update the key_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_type` field.\n', args=[]),
  ...
  '#withUsagePlanId':: d.fn(help='`aws.api_gateway_usage_plan_key.withUsagePlanId` constructs a mixin object that can be merged into the `api_gateway_usage_plan_key`\nTerraform resource block to set or update the usage_plan_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `usage_plan_id` field.\n', args=[]),
