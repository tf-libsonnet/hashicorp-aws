...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAllocationId':: d.fn(help='`aws.eip_association.withAllocationId` constructs a mixin object that can be merged into the `eip_association`\nTerraform resource block to set or update the allocation_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `allocation_id` field.\n', args=[]),
  ...
  '#withAllowReassociation':: d.fn(help='`aws.eip_association.withAllowReassociation` constructs a mixin object that can be merged into the `eip_association`\nTerraform resource block to set or update the allow_reassociation field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `allow_reassociation` field.\n', args=[]),
  ...
  '#withInstanceId':: d.fn(help='`aws.eip_association.withInstanceId` constructs a mixin object that can be merged into the `eip_association`\nTerraform resource block to set or update the instance_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_id` field.\n', args=[]),
  ...
  '#withNetworkInterfaceId':: d.fn(help='`aws.eip_association.withNetworkInterfaceId` constructs a mixin object that can be merged into the `eip_association`\nTerraform resource block to set or update the network_interface_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_interface_id` field.\n', args=[]),
  ...
  '#withPrivateIpAddress':: d.fn(help='`aws.eip_association.withPrivateIpAddress` constructs a mixin object that can be merged into the `eip_association`\nTerraform resource block to set or update the private_ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_ip_address` field.\n', args=[]),
  ...
  '#withPublicIp':: d.fn(help='`aws.eip_association.withPublicIp` constructs a mixin object that can be merged into the `eip_association`\nTerraform resource block to set or update the public_ip field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_ip` field.\n', args=[]),
