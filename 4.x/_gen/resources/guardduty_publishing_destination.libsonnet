...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDestinationArn':: d.fn(help='`aws.guardduty_publishing_destination.withDestinationArn` constructs a mixin object that can be merged into the `guardduty_publishing_destination`\nTerraform resource block to set or update the destination_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_arn` field.\n', args=[]),
  ...
  '#withDestinationType':: d.fn(help='`aws.guardduty_publishing_destination.withDestinationType` constructs a mixin object that can be merged into the `guardduty_publishing_destination`\nTerraform resource block to set or update the destination_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination_type` field.\n', args=[]),
  ...
  '#withDetectorId':: d.fn(help='`aws.guardduty_publishing_destination.withDetectorId` constructs a mixin object that can be merged into the `guardduty_publishing_destination`\nTerraform resource block to set or update the detector_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `detector_id` field.\n', args=[]),
  ...
  '#withKmsKeyArn':: d.fn(help='`aws.guardduty_publishing_destination.withKmsKeyArn` constructs a mixin object that can be merged into the `guardduty_publishing_destination`\nTerraform resource block to set or update the kms_key_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_arn` field.\n', args=[]),
