...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  input_data_config:: {
    ...
    '#new':: d.fn(help='\n`aws.comprehend_entity_recognizer.input_data_config.new` constructs a new object with attributes and blocks configured for the `input_data_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `data_format` (`string`):  When `null`, the `data_format` field will be omitted from the resulting object.\n  - `annotations` (`list[obj]`):  When `null`, the `annotations` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.comprehend_entity_recognizer.input_data_config.annotations.new](#fn-comprehend_entity_recognizerannotationsnew) constructor.\n  - `augmented_manifests` (`list[obj]`):  When `null`, the `augmented_manifests` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.comprehend_entity_recognizer.input_data_config.augmented_manifests.new](#fn-comprehend_entity_recognizeraugmented_manifestsnew) constructor.\n  - `documents` (`list[obj]`):  When `null`, the `documents` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.comprehend_entity_recognizer.input_data_config.documents.new](#fn-comprehend_entity_recognizerdocumentsnew) constructor.\n  - `entity_list` (`list[obj]`):  When `null`, the `entity_list` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.comprehend_entity_recognizer.input_data_config.entity_list.new](#fn-comprehend_entity_recognizerentity_listnew) constructor.\n  - `entity_types` (`list[obj]`):  When `null`, the `entity_types` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.comprehend_entity_recognizer.input_data_config.entity_types.new](#fn-comprehend_entity_recognizerentity_typesnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `input_data_config` sub block.\n', args=[]),
    new(
      annotations=null,
