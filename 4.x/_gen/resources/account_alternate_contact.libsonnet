...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`aws.account_alternate_contact.withAccountId` constructs a mixin object that can be merged into the `account_alternate_contact`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withAlternateContactType':: d.fn(help='`aws.account_alternate_contact.withAlternateContactType` constructs a mixin object that can be merged into the `account_alternate_contact`\nTerraform resource block to set or update the alternate_contact_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `alternate_contact_type` field.\n', args=[]),
  ...
  '#withEmailAddress':: d.fn(help='`aws.account_alternate_contact.withEmailAddress` constructs a mixin object that can be merged into the `account_alternate_contact`\nTerraform resource block to set or update the email_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `email_address` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.account_alternate_contact.withName` constructs a mixin object that can be merged into the `account_alternate_contact`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPhoneNumber':: d.fn(help='`aws.account_alternate_contact.withPhoneNumber` constructs a mixin object that can be merged into the `account_alternate_contact`\nTerraform resource block to set or update the phone_number field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `phone_number` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.account_alternate_contact.withTimeouts` constructs a mixin object that can be merged into the `account_alternate_contact`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.account_alternate_contact.withTimeoutsMixin` constructs a mixin object that can be merged into the `account_alternate_contact`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.account_alternate_contact.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTitle':: d.fn(help='`aws.account_alternate_contact.withTitle` constructs a mixin object that can be merged into the `account_alternate_contact`\nTerraform resource block to set or update the title field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `title` field.\n', args=[]),
