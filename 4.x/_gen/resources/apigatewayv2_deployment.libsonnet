...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiId':: d.fn(help='`aws.apigatewayv2_deployment.withApiId` constructs a mixin object that can be merged into the `apigatewayv2_deployment`\nTerraform resource block to set or update the api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_id` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.apigatewayv2_deployment.withDescription` constructs a mixin object that can be merged into the `apigatewayv2_deployment`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withTriggers':: d.fn(help='`aws.apigatewayv2_deployment.withTriggers` constructs a mixin object that can be merged into the `apigatewayv2_deployment`\nTerraform resource block to set or update the triggers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `triggers` field.\n', args=[]),
