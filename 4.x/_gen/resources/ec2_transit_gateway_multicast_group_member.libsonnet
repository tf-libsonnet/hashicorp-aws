...
{
  '#':: d.pkg(name='ec2_transit_gateway_multicast_group_member', url='', help='`ec2_transit_gateway_multicast_group_member` represents the `aws_ec2_transit_gateway_multicast_group_member` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withGroupIpAddress':: d.fn(help='`aws.ec2_transit_gateway_multicast_group_member.withGroupIpAddress` constructs a mixin object that can be merged into the `ec2_transit_gateway_multicast_group_member`\nTerraform resource block to set or update the group_ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_ip_address` field.\n', args=[]),
  ...
  '#withNetworkInterfaceId':: d.fn(help='`aws.ec2_transit_gateway_multicast_group_member.withNetworkInterfaceId` constructs a mixin object that can be merged into the `ec2_transit_gateway_multicast_group_member`\nTerraform resource block to set or update the network_interface_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_interface_id` field.\n', args=[]),
  ...
  '#withTransitGatewayMulticastDomainId':: d.fn(help='`aws.ec2_transit_gateway_multicast_group_member.withTransitGatewayMulticastDomainId` constructs a mixin object that can be merged into the `ec2_transit_gateway_multicast_group_member`\nTerraform resource block to set or update the transit_gateway_multicast_domain_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transit_gateway_multicast_domain_id` field.\n', args=[]),
