...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConnectionPoolConfig':: d.fn(help='`aws.db_proxy_default_target_group.withConnectionPoolConfig` constructs a mixin object that can be merged into the `db_proxy_default_target_group`\nTerraform resource block to set or update the connection_pool_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_pool_config` field.\n', args=[]),
  ...
  '#withConnectionPoolConfigMixin':: d.fn(help='`aws.db_proxy_default_target_group.withConnectionPoolConfigMixin` constructs a mixin object that can be merged into the `db_proxy_default_target_group`\nTerraform resource block to set or update the connection_pool_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.db_proxy_default_target_group.withConnectionPoolConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_pool_config` field.\n', args=[]),
  ...
  '#withDbProxyName':: d.fn(help='`aws.db_proxy_default_target_group.withDbProxyName` constructs a mixin object that can be merged into the `db_proxy_default_target_group`\nTerraform resource block to set or update the db_proxy_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `db_proxy_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.db_proxy_default_target_group.withTimeouts` constructs a mixin object that can be merged into the `db_proxy_default_target_group`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.db_proxy_default_target_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `db_proxy_default_target_group`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.db_proxy_default_target_group.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
