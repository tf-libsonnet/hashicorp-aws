...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConnectionName':: d.fn(help='`aws.apprunner_connection.withConnectionName` constructs a mixin object that can be merged into the `apprunner_connection`\nTerraform resource block to set or update the connection_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_name` field.\n', args=[]),
  ...
  '#withProviderType':: d.fn(help='`aws.apprunner_connection.withProviderType` constructs a mixin object that can be merged into the `apprunner_connection`\nTerraform resource block to set or update the provider_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `provider_type` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.apprunner_connection.withTags` constructs a mixin object that can be merged into the `apprunner_connection`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.apprunner_connection.withTagsAll` constructs a mixin object that can be merged into the `apprunner_connection`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
