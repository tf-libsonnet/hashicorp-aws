...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstanceName':: d.fn(help='`aws.lightsail_static_ip_attachment.withInstanceName` constructs a mixin object that can be merged into the `lightsail_static_ip_attachment`\nTerraform resource block to set or update the instance_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_name` field.\n', args=[]),
  ...
  '#withStaticIpName':: d.fn(help='`aws.lightsail_static_ip_attachment.withStaticIpName` constructs a mixin object that can be merged into the `lightsail_static_ip_attachment`\nTerraform resource block to set or update the static_ip_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `static_ip_name` field.\n', args=[]),
