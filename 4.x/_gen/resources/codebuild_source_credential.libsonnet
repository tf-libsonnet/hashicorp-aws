...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuthType':: d.fn(help='`aws.codebuild_source_credential.withAuthType` constructs a mixin object that can be merged into the `codebuild_source_credential`\nTerraform resource block to set or update the auth_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auth_type` field.\n', args=[]),
  ...
  '#withServerType':: d.fn(help='`aws.codebuild_source_credential.withServerType` constructs a mixin object that can be merged into the `codebuild_source_credential`\nTerraform resource block to set or update the server_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_type` field.\n', args=[]),
  ...
  '#withToken':: d.fn(help='`aws.codebuild_source_credential.withToken` constructs a mixin object that can be merged into the `codebuild_source_credential`\nTerraform resource block to set or update the token field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `token` field.\n', args=[]),
  ...
  '#withUserName':: d.fn(help='`aws.codebuild_source_credential.withUserName` constructs a mixin object that can be merged into the `codebuild_source_credential`\nTerraform resource block to set or update the user_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_name` field.\n', args=[]),
