...
{
  '#':: d.pkg(name='servicecatalog_tag_option', url='', help='`servicecatalog_tag_option` represents the `aws_servicecatalog_tag_option` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withActive':: d.fn(help='`aws.servicecatalog_tag_option.withActive` constructs a mixin object that can be merged into the `servicecatalog_tag_option`\nTerraform resource block to set or update the active field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `active` field.\n', args=[]),
  ...
  '#withKey':: d.fn(help='`aws.servicecatalog_tag_option.withKey` constructs a mixin object that can be merged into the `servicecatalog_tag_option`\nTerraform resource block to set or update the key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.servicecatalog_tag_option.withTimeouts` constructs a mixin object that can be merged into the `servicecatalog_tag_option`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.servicecatalog_tag_option.withTimeoutsMixin` constructs a mixin object that can be merged into the `servicecatalog_tag_option`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.servicecatalog_tag_option.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withValue':: d.fn(help='`aws.servicecatalog_tag_option.withValue` constructs a mixin object that can be merged into the `servicecatalog_tag_option`\nTerraform resource block to set or update the value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value` field.\n', args=[]),
