...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`aws.api_gateway_documentation_version.withDescription` constructs a mixin object that can be merged into the `api_gateway_documentation_version`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withRestApiId':: d.fn(help='`aws.api_gateway_documentation_version.withRestApiId` constructs a mixin object that can be merged into the `api_gateway_documentation_version`\nTerraform resource block to set or update the rest_api_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rest_api_id` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`aws.api_gateway_documentation_version.withVersion` constructs a mixin object that can be merged into the `api_gateway_documentation_version`\nTerraform resource block to set or update the version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
