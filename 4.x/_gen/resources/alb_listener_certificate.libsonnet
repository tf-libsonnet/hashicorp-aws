...
{
  '#':: d.pkg(name='alb_listener_certificate', url='', help='`alb_listener_certificate` represents the `aws_alb_listener_certificate` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCertificateArn':: d.fn(help='`aws.alb_listener_certificate.withCertificateArn` constructs a mixin object that can be merged into the `alb_listener_certificate`\nTerraform resource block to set or update the certificate_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_arn` field.\n', args=[]),
  ...
  '#withListenerArn':: d.fn(help='`aws.alb_listener_certificate.withListenerArn` constructs a mixin object that can be merged into the `alb_listener_certificate`\nTerraform resource block to set or update the listener_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `listener_arn` field.\n', args=[]),
