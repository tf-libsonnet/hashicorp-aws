...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPolicy':: d.fn(help='`aws.vpc_endpoint_policy.withPolicy` constructs a mixin object that can be merged into the `vpc_endpoint_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.vpc_endpoint_policy.withTimeouts` constructs a mixin object that can be merged into the `vpc_endpoint_policy`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.vpc_endpoint_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpc_endpoint_policy`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.vpc_endpoint_policy.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpcEndpointId':: d.fn(help='`aws.vpc_endpoint_policy.withVpcEndpointId` constructs a mixin object that can be merged into the `vpc_endpoint_policy`\nTerraform resource block to set or update the vpc_endpoint_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_endpoint_id` field.\n', args=[]),
