...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPgpKey':: d.fn(help='`aws.iam_access_key.withPgpKey` constructs a mixin object that can be merged into the `iam_access_key`\nTerraform resource block to set or update the pgp_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `pgp_key` field.\n', args=[]),
  ...
  '#withStatus':: d.fn(help='`aws.iam_access_key.withStatus` constructs a mixin object that can be merged into the `iam_access_key`\nTerraform resource block to set or update the status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
  ...
  '#withUser':: d.fn(help='`aws.iam_access_key.withUser` constructs a mixin object that can be merged into the `iam_access_key`\nTerraform resource block to set or update the user field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user` field.\n', args=[]),
