...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAwsAccountId':: d.fn(help='`aws.quicksight_group_membership.withAwsAccountId` constructs a mixin object that can be merged into the `quicksight_group_membership`\nTerraform resource block to set or update the aws_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `aws_account_id` field.\n', args=[]),
  ...
  '#withGroupName':: d.fn(help='`aws.quicksight_group_membership.withGroupName` constructs a mixin object that can be merged into the `quicksight_group_membership`\nTerraform resource block to set or update the group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group_name` field.\n', args=[]),
  ...
  '#withMemberName':: d.fn(help='`aws.quicksight_group_membership.withMemberName` constructs a mixin object that can be merged into the `quicksight_group_membership`\nTerraform resource block to set or update the member_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `member_name` field.\n', args=[]),
  ...
  '#withNamespace':: d.fn(help='`aws.quicksight_group_membership.withNamespace` constructs a mixin object that can be merged into the `quicksight_group_membership`\nTerraform resource block to set or update the namespace field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `namespace` field.\n', args=[]),
