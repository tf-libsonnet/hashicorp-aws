...
{
  '#':: d.pkg(name='schemas_registry_policy', url='', help='`schemas_registry_policy` represents the `aws_schemas_registry_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPolicy':: d.fn(help='`aws.schemas_registry_policy.withPolicy` constructs a mixin object that can be merged into the `schemas_registry_policy`\nTerraform resource block to set or update the policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy` field.\n', args=[]),
  ...
  '#withRegistryName':: d.fn(help='`aws.schemas_registry_policy.withRegistryName` constructs a mixin object that can be merged into the `schemas_registry_policy`\nTerraform resource block to set or update the registry_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `registry_name` field.\n', args=[]),
