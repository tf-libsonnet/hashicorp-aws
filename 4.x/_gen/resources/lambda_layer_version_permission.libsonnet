...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAction':: d.fn(help='`aws.lambda_layer_version_permission.withAction` constructs a mixin object that can be merged into the `lambda_layer_version_permission`\nTerraform resource block to set or update the action field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `action` field.\n', args=[]),
  ...
  '#withLayerName':: d.fn(help='`aws.lambda_layer_version_permission.withLayerName` constructs a mixin object that can be merged into the `lambda_layer_version_permission`\nTerraform resource block to set or update the layer_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `layer_name` field.\n', args=[]),
  ...
  '#withOrganizationId':: d.fn(help='`aws.lambda_layer_version_permission.withOrganizationId` constructs a mixin object that can be merged into the `lambda_layer_version_permission`\nTerraform resource block to set or update the organization_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organization_id` field.\n', args=[]),
  ...
  '#withPrincipal':: d.fn(help='`aws.lambda_layer_version_permission.withPrincipal` constructs a mixin object that can be merged into the `lambda_layer_version_permission`\nTerraform resource block to set or update the principal field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal` field.\n', args=[]),
  ...
  '#withStatementId':: d.fn(help='`aws.lambda_layer_version_permission.withStatementId` constructs a mixin object that can be merged into the `lambda_layer_version_permission`\nTerraform resource block to set or update the statement_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `statement_id` field.\n', args=[]),
  ...
  '#withVersionNumber':: d.fn(help='`aws.lambda_layer_version_permission.withVersionNumber` constructs a mixin object that can be merged into the `lambda_layer_version_permission`\nTerraform resource block to set or update the version_number field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version_number` field.\n', args=[]),
