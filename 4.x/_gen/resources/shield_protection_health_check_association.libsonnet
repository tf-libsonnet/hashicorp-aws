...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHealthCheckArn':: d.fn(help='`aws.shield_protection_health_check_association.withHealthCheckArn` constructs a mixin object that can be merged into the `shield_protection_health_check_association`\nTerraform resource block to set or update the health_check_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `health_check_arn` field.\n', args=[]),
  ...
  '#withShieldProtectionId':: d.fn(help='`aws.shield_protection_health_check_association.withShieldProtectionId` constructs a mixin object that can be merged into the `shield_protection_health_check_association`\nTerraform resource block to set or update the shield_protection_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `shield_protection_id` field.\n', args=[]),
