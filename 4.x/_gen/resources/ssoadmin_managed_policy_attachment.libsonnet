...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstanceArn':: d.fn(help='`aws.ssoadmin_managed_policy_attachment.withInstanceArn` constructs a mixin object that can be merged into the `ssoadmin_managed_policy_attachment`\nTerraform resource block to set or update the instance_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_arn` field.\n', args=[]),
  ...
  '#withManagedPolicyArn':: d.fn(help='`aws.ssoadmin_managed_policy_attachment.withManagedPolicyArn` constructs a mixin object that can be merged into the `ssoadmin_managed_policy_attachment`\nTerraform resource block to set or update the managed_policy_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `managed_policy_arn` field.\n', args=[]),
  ...
  '#withPermissionSetArn':: d.fn(help='`aws.ssoadmin_managed_policy_attachment.withPermissionSetArn` constructs a mixin object that can be merged into the `ssoadmin_managed_policy_attachment`\nTerraform resource block to set or update the permission_set_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permission_set_arn` field.\n', args=[]),
