...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucket':: d.fn(help='`aws.s3_bucket_versioning.withBucket` constructs a mixin object that can be merged into the `s3_bucket_versioning`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withExpectedBucketOwner':: d.fn(help='`aws.s3_bucket_versioning.withExpectedBucketOwner` constructs a mixin object that can be merged into the `s3_bucket_versioning`\nTerraform resource block to set or update the expected_bucket_owner field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expected_bucket_owner` field.\n', args=[]),
  ...
  '#withMfa':: d.fn(help='`aws.s3_bucket_versioning.withMfa` constructs a mixin object that can be merged into the `s3_bucket_versioning`\nTerraform resource block to set or update the mfa field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mfa` field.\n', args=[]),
  ...
  '#withVersioningConfiguration':: d.fn(help='`aws.s3_bucket_versioning.withVersioningConfiguration` constructs a mixin object that can be merged into the `s3_bucket_versioning`\nTerraform resource block to set or update the versioning_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `versioning_configuration` field.\n', args=[]),
  ...
  '#withVersioningConfigurationMixin':: d.fn(help='`aws.s3_bucket_versioning.withVersioningConfigurationMixin` constructs a mixin object that can be merged into the `s3_bucket_versioning`\nTerraform resource block to set or update the versioning_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.s3_bucket_versioning.withVersioningConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `versioning_configuration` field.\n', args=[]),
