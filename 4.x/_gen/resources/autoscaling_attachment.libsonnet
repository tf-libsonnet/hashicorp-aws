...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAlbTargetGroupArn':: d.fn(help='`aws.autoscaling_attachment.withAlbTargetGroupArn` constructs a mixin object that can be merged into the `autoscaling_attachment`\nTerraform resource block to set or update the alb_target_group_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `alb_target_group_arn` field.\n', args=[]),
  ...
  '#withAutoscalingGroupName':: d.fn(help='`aws.autoscaling_attachment.withAutoscalingGroupName` constructs a mixin object that can be merged into the `autoscaling_attachment`\nTerraform resource block to set or update the autoscaling_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `autoscaling_group_name` field.\n', args=[]),
  ...
  '#withElb':: d.fn(help='`aws.autoscaling_attachment.withElb` constructs a mixin object that can be merged into the `autoscaling_attachment`\nTerraform resource block to set or update the elb field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `elb` field.\n', args=[]),
  ...
  '#withLbTargetGroupArn':: d.fn(help='`aws.autoscaling_attachment.withLbTargetGroupArn` constructs a mixin object that can be merged into the `autoscaling_attachment`\nTerraform resource block to set or update the lb_target_group_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lb_target_group_arn` field.\n', args=[]),
