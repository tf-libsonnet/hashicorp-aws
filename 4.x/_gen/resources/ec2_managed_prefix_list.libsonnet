...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAddressFamily':: d.fn(help='`aws.ec2_managed_prefix_list.withAddressFamily` constructs a mixin object that can be merged into the `ec2_managed_prefix_list`\nTerraform resource block to set or update the address_family field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `address_family` field.\n', args=[]),
  ...
  '#withEntry':: d.fn(help='`aws.ec2_managed_prefix_list.withEntry` constructs a mixin object that can be merged into the `ec2_managed_prefix_list`\nTerraform resource block to set or update the entry field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entry` field.\n', args=[]),
  ...
  '#withEntryMixin':: d.fn(help='`aws.ec2_managed_prefix_list.withEntryMixin` constructs a mixin object that can be merged into the `ec2_managed_prefix_list`\nTerraform resource block to set or update the entry field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.ec2_managed_prefix_list.withEntry](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entry` field.\n', args=[]),
  ...
  '#withMaxEntries':: d.fn(help='`aws.ec2_managed_prefix_list.withMaxEntries` constructs a mixin object that can be merged into the `ec2_managed_prefix_list`\nTerraform resource block to set or update the max_entries field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `max_entries` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.ec2_managed_prefix_list.withTagsAll` constructs a mixin object that can be merged into the `ec2_managed_prefix_list`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
