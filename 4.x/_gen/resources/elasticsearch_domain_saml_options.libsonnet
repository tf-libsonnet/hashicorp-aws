...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.elasticsearch_domain_saml_options.new` injects a new `aws_elasticsearch_domain_saml_options` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.elasticsearch_domain_saml_options.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.elasticsearch_domain_saml_options` using the reference:\n\n    $._ref.aws_elasticsearch_domain_saml_options.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_elasticsearch_domain_saml_options.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `domain_name` (`string`): \n  - `saml_options` (`list[obj]`):  When `null`, the `saml_options` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.elasticsearch_domain_saml_options.saml_options.new](#fn-elasticsearchdomainsamloptionssamloptionsnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.elasticsearch_domain_saml_options.timeouts.new](#fn-elasticsearchdomainsamloptionstimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    domain_name,
    saml_options=null,
  ...
  '#withDomainName':: d.fn(help='`aws.elasticsearch_domain_saml_options.withDomainName` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withSamlOptions':: d.fn(help='`aws.elasticsearch_domain_saml_options.withSamlOptions` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`\nTerraform resource block to set or update the saml_options field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `saml_options` field.\n', args=[]),
  ...
  '#withSamlOptionsMixin':: d.fn(help='`aws.elasticsearch_domain_saml_options.withSamlOptionsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`\nTerraform resource block to set or update the saml_options field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.elasticsearch_domain_saml_options.withSamlOptions](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `saml_options` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`aws.elasticsearch_domain_saml_options.withTimeouts` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`aws.elasticsearch_domain_saml_options.withTimeoutsMixin` constructs a mixin object that can be merged into the `elasticsearch_domain_saml_options`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [aws.elasticsearch_domain_saml_options.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
