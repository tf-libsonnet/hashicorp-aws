...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEncryptionConfiguration':: d.fn(help='`aws.glue_security_configuration.withEncryptionConfiguration` constructs a mixin object that can be merged into the `glue_security_configuration`\nTerraform resource block to set or update the encryption_configuration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encryption_configuration` field.\n', args=[]),
  ...
  '#withEncryptionConfigurationMixin':: d.fn(help='`aws.glue_security_configuration.withEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `glue_security_configuration`\nTerraform resource block to set or update the encryption_configuration field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.glue_security_configuration.withEncryptionConfiguration](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encryption_configuration` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.glue_security_configuration.withName` constructs a mixin object that can be merged into the `glue_security_configuration`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
