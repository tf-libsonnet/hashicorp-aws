...
{
  '#':: d.pkg(name='auditmanager_assessment_report', url='', help='`auditmanager_assessment_report` represents the `aws_auditmanager_assessment_report` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(assessment_id=assessment_id, description=description, name=name),
    _meta=_meta
  ),
