...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHostedZoneId':: d.fn(help='`aws.route53_key_signing_key.withHostedZoneId` constructs a mixin object that can be merged into the `route53_key_signing_key`\nTerraform resource block to set or update the hosted_zone_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hosted_zone_id` field.\n', args=[]),
  ...
  '#withKeyManagementServiceArn':: d.fn(help='`aws.route53_key_signing_key.withKeyManagementServiceArn` constructs a mixin object that can be merged into the `route53_key_signing_key`\nTerraform resource block to set or update the key_management_service_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_management_service_arn` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`aws.route53_key_signing_key.withName` constructs a mixin object that can be merged into the `route53_key_signing_key`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withStatus':: d.fn(help='`aws.route53_key_signing_key.withStatus` constructs a mixin object that can be merged into the `route53_key_signing_key`\nTerraform resource block to set or update the status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
