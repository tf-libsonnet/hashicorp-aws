...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDestination':: d.fn(help='`aws.vpc_network_performance_metric_subscription.withDestination` constructs a mixin object that can be merged into the `vpc_network_performance_metric_subscription`\nTerraform resource block to set or update the destination field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination` field.\n', args=[]),
  ...
  '#withMetric':: d.fn(help='`aws.vpc_network_performance_metric_subscription.withMetric` constructs a mixin object that can be merged into the `vpc_network_performance_metric_subscription`\nTerraform resource block to set or update the metric field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metric` field.\n', args=[]),
  ...
  '#withSource':: d.fn(help='`aws.vpc_network_performance_metric_subscription.withSource` constructs a mixin object that can be merged into the `vpc_network_performance_metric_subscription`\nTerraform resource block to set or update the source field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source` field.\n', args=[]),
  ...
  '#withStatistic':: d.fn(help='`aws.vpc_network_performance_metric_subscription.withStatistic` constructs a mixin object that can be merged into the `vpc_network_performance_metric_subscription`\nTerraform resource block to set or update the statistic field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `statistic` field.\n', args=[]),
