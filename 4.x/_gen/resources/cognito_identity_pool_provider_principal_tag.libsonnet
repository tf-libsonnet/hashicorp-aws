...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIdentityPoolId':: d.fn(help='`aws.cognito_identity_pool_provider_principal_tag.withIdentityPoolId` constructs a mixin object that can be merged into the `cognito_identity_pool_provider_principal_tag`\nTerraform resource block to set or update the identity_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity_pool_id` field.\n', args=[]),
  ...
  '#withIdentityProviderName':: d.fn(help='`aws.cognito_identity_pool_provider_principal_tag.withIdentityProviderName` constructs a mixin object that can be merged into the `cognito_identity_pool_provider_principal_tag`\nTerraform resource block to set or update the identity_provider_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity_provider_name` field.\n', args=[]),
  ...
  '#withPrincipalTags':: d.fn(help='`aws.cognito_identity_pool_provider_principal_tag.withPrincipalTags` constructs a mixin object that can be merged into the `cognito_identity_pool_provider_principal_tag`\nTerraform resource block to set or update the principal_tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal_tags` field.\n', args=[]),
  ...
  '#withUseDefaults':: d.fn(help='`aws.cognito_identity_pool_provider_principal_tag.withUseDefaults` constructs a mixin object that can be merged into the `cognito_identity_pool_provider_principal_tag`\nTerraform resource block to set or update the use_defaults field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `use_defaults` field.\n', args=[]),
