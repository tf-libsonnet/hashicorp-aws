...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppId':: d.fn(help='`aws.amplify_backend_environment.withAppId` constructs a mixin object that can be merged into the `amplify_backend_environment`\nTerraform resource block to set or update the app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_id` field.\n', args=[]),
  ...
  '#withDeploymentArtifacts':: d.fn(help='`aws.amplify_backend_environment.withDeploymentArtifacts` constructs a mixin object that can be merged into the `amplify_backend_environment`\nTerraform resource block to set or update the deployment_artifacts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deployment_artifacts` field.\n', args=[]),
  ...
  '#withEnvironmentName':: d.fn(help='`aws.amplify_backend_environment.withEnvironmentName` constructs a mixin object that can be merged into the `amplify_backend_environment`\nTerraform resource block to set or update the environment_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `environment_name` field.\n', args=[]),
  ...
  '#withStackName':: d.fn(help='`aws.amplify_backend_environment.withStackName` constructs a mixin object that can be merged into the `amplify_backend_environment`\nTerraform resource block to set or update the stack_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stack_name` field.\n', args=[]),
