...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateArn':: d.fn(help='`aws.appsync_domain_name.withCertificateArn` constructs a mixin object that can be merged into the `appsync_domain_name`\nTerraform resource block to set or update the certificate_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_arn` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.appsync_domain_name.withDescription` constructs a mixin object that can be merged into the `appsync_domain_name`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDomainName':: d.fn(help='`aws.appsync_domain_name.withDomainName` constructs a mixin object that can be merged into the `appsync_domain_name`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
