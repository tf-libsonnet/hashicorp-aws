...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withS3Destination':: d.fn(help='`aws.macie2_classification_export_configuration.withS3Destination` constructs a mixin object that can be merged into the `macie2_classification_export_configuration`\nTerraform resource block to set or update the s3_destination field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_destination` field.\n', args=[]),
  ...
  '#withS3DestinationMixin':: d.fn(help='`aws.macie2_classification_export_configuration.withS3DestinationMixin` constructs a mixin object that can be merged into the `macie2_classification_export_configuration`\nTerraform resource block to set or update the s3_destination field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.macie2_classification_export_configuration.withS3Destination](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `s3_destination` field.\n', args=[]),
