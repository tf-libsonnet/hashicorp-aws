...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withVpcId':: d.fn(help='`aws.route53_zone_association.withVpcId` constructs a mixin object that can be merged into the `route53_zone_association`\nTerraform resource block to set or update the vpc_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_id` field.\n', args=[]),
  ...
  '#withVpcRegion':: d.fn(help='`aws.route53_zone_association.withVpcRegion` constructs a mixin object that can be merged into the `route53_zone_association`\nTerraform resource block to set or update the vpc_region field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpc_region` field.\n', args=[]),
  ...
  '#withZoneId':: d.fn(help='`aws.route53_zone_association.withZoneId` constructs a mixin object that can be merged into the `route53_zone_association`\nTerraform resource block to set or update the zone_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `zone_id` field.\n', args=[]),
