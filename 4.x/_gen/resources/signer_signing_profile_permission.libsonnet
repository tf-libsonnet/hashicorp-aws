...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAction':: d.fn(help='`aws.signer_signing_profile_permission.withAction` constructs a mixin object that can be merged into the `signer_signing_profile_permission`\nTerraform resource block to set or update the action field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `action` field.\n', args=[]),
  ...
  '#withPrincipal':: d.fn(help='`aws.signer_signing_profile_permission.withPrincipal` constructs a mixin object that can be merged into the `signer_signing_profile_permission`\nTerraform resource block to set or update the principal field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal` field.\n', args=[]),
  ...
  '#withProfileName':: d.fn(help='`aws.signer_signing_profile_permission.withProfileName` constructs a mixin object that can be merged into the `signer_signing_profile_permission`\nTerraform resource block to set or update the profile_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `profile_name` field.\n', args=[]),
  ...
  '#withProfileVersion':: d.fn(help='`aws.signer_signing_profile_permission.withProfileVersion` constructs a mixin object that can be merged into the `signer_signing_profile_permission`\nTerraform resource block to set or update the profile_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `profile_version` field.\n', args=[]),
  ...
  '#withStatementId':: d.fn(help='`aws.signer_signing_profile_permission.withStatementId` constructs a mixin object that can be merged into the `signer_signing_profile_permission`\nTerraform resource block to set or update the statement_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `statement_id` field.\n', args=[]),
  ...
  '#withStatementIdPrefix':: d.fn(help='`aws.signer_signing_profile_permission.withStatementIdPrefix` constructs a mixin object that can be merged into the `signer_signing_profile_permission`\nTerraform resource block to set or update the statement_id_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `statement_id_prefix` field.\n', args=[]),
