...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withParentId':: d.fn(help='`aws.api_gateway_resource.withParentId` constructs a mixin object that can be merged into the `api_gateway_resource`\nTerraform resource block to set or update the parent_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent_id` field.\n', args=[]),
  ...
  '#withPathPart':: d.fn(help='`aws.api_gateway_resource.withPathPart` constructs a mixin object that can be merged into the `api_gateway_resource`\nTerraform resource block to set or update the path_part field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `path_part` field.\n', args=[]),
