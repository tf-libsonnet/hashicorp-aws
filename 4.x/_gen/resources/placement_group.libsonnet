...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`aws.placement_group.withName` constructs a mixin object that can be merged into the `placement_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPartitionCount':: d.fn(help='`aws.placement_group.withPartitionCount` constructs a mixin object that can be merged into the `placement_group`\nTerraform resource block to set or update the partition_count field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_count` field.\n', args=[]),
  ...
  '#withSpreadLevel':: d.fn(help='`aws.placement_group.withSpreadLevel` constructs a mixin object that can be merged into the `placement_group`\nTerraform resource block to set or update the spread_level field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spread_level` field.\n', args=[]),
  ...
  '#withStrategy':: d.fn(help='`aws.placement_group.withStrategy` constructs a mixin object that can be merged into the `placement_group`\nTerraform resource block to set or update the strategy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `strategy` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`aws.placement_group.withTags` constructs a mixin object that can be merged into the `placement_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.placement_group.withTagsAll` constructs a mixin object that can be merged into the `placement_group`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
