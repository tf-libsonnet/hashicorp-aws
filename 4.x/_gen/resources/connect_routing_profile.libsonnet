...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`aws.connect_routing_profile.new` injects a new `aws_connect_routing_profile` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    aws.connect_routing_profile.new('some_id')\n\nYou can get the reference to the `id` field of the created `aws.connect_routing_profile` using the reference:\n\n    $._ref.aws_connect_routing_profile.some_id.get('id')\n\nThis is the same as directly entering `\"${ aws_connect_routing_profile.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `default_outbound_queue_id` (`string`): \n  - `description` (`string`): \n  - `instance_id` (`string`): \n  - `name` (`string`): \n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `tags_all` (`obj`):  When `null`, the `tags_all` field will be omitted from the resulting object.\n  - `media_concurrencies` (`list[obj]`):  When `null`, the `media_concurrencies` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_routing_profile.media_concurrencies.new](#fn-connectroutingprofilemediaconcurrenciesnew) constructor.\n  - `queue_configs` (`list[obj]`):  When `null`, the `queue_configs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [aws.connect_routing_profile.queue_configs.new](#fn-connectroutingprofilequeueconfigsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
  ...
  '#withDefaultOutboundQueueId':: d.fn(help='`aws.connect_routing_profile.withDefaultOutboundQueueId` constructs a mixin object that can be merged into the `connect_routing_profile`\nTerraform resource block to set or update the default_outbound_queue_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_outbound_queue_id` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`aws.connect_routing_profile.withDescription` constructs a mixin object that can be merged into the `connect_routing_profile`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withMediaConcurrencies':: d.fn(help='`aws.connect_routing_profile.withMediaConcurrencies` constructs a mixin object that can be merged into the `connect_routing_profile`\nTerraform resource block to set or update the media_concurrencies field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `media_concurrencies` field.\n', args=[]),
  ...
  '#withMediaConcurrenciesMixin':: d.fn(help='`aws.connect_routing_profile.withMediaConcurrenciesMixin` constructs a mixin object that can be merged into the `connect_routing_profile`\nTerraform resource block to set or update the media_concurrencies field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.connect_routing_profile.withMediaConcurrencies](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `media_concurrencies` field.\n', args=[]),
  ...
  '#withQueueConfigs':: d.fn(help='`aws.connect_routing_profile.withQueueConfigs` constructs a mixin object that can be merged into the `connect_routing_profile`\nTerraform resource block to set or update the queue_configs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `queue_configs` field.\n', args=[]),
  ...
  '#withQueueConfigsMixin':: d.fn(help='`aws.connect_routing_profile.withQueueConfigsMixin` constructs a mixin object that can be merged into the `connect_routing_profile`\nTerraform resource block to set or update the queue_configs field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [aws.connect_routing_profile.withQueueConfigs](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `queue_configs` field.\n', args=[]),
  ...
  '#withTagsAll':: d.fn(help='`aws.connect_routing_profile.withTagsAll` constructs a mixin object that can be merged into the `connect_routing_profile`\nTerraform resource block to set or update the tags_all field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags_all` field.\n', args=[]),
